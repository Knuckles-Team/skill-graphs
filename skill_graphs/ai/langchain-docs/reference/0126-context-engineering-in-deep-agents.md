...
See [Customization](/oss/javascript/deepagents/customization#middleware) for the [default middleware stack](/oss/javascript/deepagents/customization#default-stack-main-agent) and for adding [custom middleware](/oss/javascript/langchain/middleware). See the [LangChain context engineering](/oss/javascript/langchain/context-engineering#system-prompt) guide for examples.
