...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * Examples
    ...
    * Data & Analytics
      ...
      * RAG  [ RAG  ](https://ai.pydantic.dev/examples/rag/)
...
## Example Code
[With Pydantic AI Gateway](https://ai.pydantic.dev/examples/rag/#__tabbed_3_1)[Directly to Provider API](https://ai.pydantic.dev/examples/rag/#__tabbed_3_2)
