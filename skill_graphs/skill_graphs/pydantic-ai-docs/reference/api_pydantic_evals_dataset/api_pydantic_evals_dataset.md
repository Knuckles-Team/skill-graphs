[ Skip to content ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evalsdataset)
...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * API Reference
    ...
    * pydantic_evals
      * pydantic_evals.dataset  [ pydantic_evals.dataset  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/)
        * [ dataset  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset)
        * [ InputsT  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.InputsT)
        * [ OutputT  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.OutputT)
        * [ MetadataT  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.MetadataT)
        * [ DEFAULT_DATASET_PATH  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.DEFAULT_DATASET_PATH)
        * [ DEFAULT_SCHEMA_PATH_TEMPLATE  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.DEFAULT_SCHEMA_PATH_TEMPLATE)
        * [ Case  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Case)
          * [ __init__  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Case.__init__)
          * [ name  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Case.name)
          * [ inputs  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Case.inputs)
          * [ metadata  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Case.metadata)
          * [ expected_output  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Case.expected_output)
          * [ evaluators  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Case.evaluators)
        * [ Dataset  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset)
          * [ name  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset.name)
          * [ cases  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset.cases)
          * [ evaluators  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset.evaluators)
          * [ report_evaluators  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset.report_evaluators)
          * [ __init__  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset.__init__)
          * [ evaluate  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset.evaluate)
          * [ evaluate_sync  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset.evaluate_sync)
          * [ add_case  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset.add_case)
          * [ add_evaluator  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset.add_evaluator)
          * [ from_file  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset.from_file)
          * [ from_text  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset.from_text)
          * [ from_dict  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset.from_dict)
          * [ to_file  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset.to_file)
          * [ model_json_schema_with_evaluators  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset.model_json_schema_with_evaluators)
        * [ set_eval_attribute  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.set_eval_attribute)
        * [ increment_eval_metric  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.increment_eval_metric)
  ...
  * [ Dataset  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset)
    ...
    * [ from_dict  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset.from_dict)
    * [ to_file  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset.to_file)
    * [ model_json_schema_with_evaluators  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset.model_json_schema_with_evaluators "model_json_schema_with_evaluators")
  * [ set_eval_attribute  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.set_eval_attribute)
  * [ increment_eval_metric  ](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.increment_eval_metric)
