[ Skip to content ](https://ai.pydantic.dev/evals/evaluators/custom/#custom-evaluators)
...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * Pydantic Evals
    ...
    * Evaluators
      ...
      * Custom Evaluators  [ Custom Evaluators  ](https://ai.pydantic.dev/evals/evaluators/custom/)
        * [ Basic Custom Evaluator  ](https://ai.pydantic.dev/evals/evaluators/custom/#basic-custom-evaluator)
        * [ EvaluatorContext  ](https://ai.pydantic.dev/evals/evaluators/custom/#evaluatorcontext)
        * [ Evaluator Parameters  ](https://ai.pydantic.dev/evals/evaluators/custom/#evaluator-parameters)
        * [ Return Types  ](https://ai.pydantic.dev/evals/evaluators/custom/#return-types)
          * [ Boolean Assertions  ](https://ai.pydantic.dev/evals/evaluators/custom/#boolean-assertions)
          * [ Numeric Scores  ](https://ai.pydantic.dev/evals/evaluators/custom/#numeric-scores)
          * [ String Labels  ](https://ai.pydantic.dev/evals/evaluators/custom/#string-labels)
          * [ With Reasons  ](https://ai.pydantic.dev/evals/evaluators/custom/#with-reasons)
          * [ Multiple Results  ](https://ai.pydantic.dev/evals/evaluators/custom/#multiple-results)
          * [ Conditional Results  ](https://ai.pydantic.dev/evals/evaluators/custom/#conditional-results)
        * [ Async Evaluators  ](https://ai.pydantic.dev/evals/evaluators/custom/#async-evaluators)
        * [ Using Metadata  ](https://ai.pydantic.dev/evals/evaluators/custom/#using-metadata)
        * [ Using Metrics  ](https://ai.pydantic.dev/evals/evaluators/custom/#using-metrics)
        * [ Generic Type Parameters  ](https://ai.pydantic.dev/evals/evaluators/custom/#generic-type-parameters)
        * [ Custom Evaluation Names  ](https://ai.pydantic.dev/evals/evaluators/custom/#custom-evaluation-names)
        * [ Real-World Examples  ](https://ai.pydantic.dev/evals/evaluators/custom/#real-world-examples)
          * [ SQL Validation  ](https://ai.pydantic.dev/evals/evaluators/custom/#sql-validation)
          * [ Code Execution  ](https://ai.pydantic.dev/evals/evaluators/custom/#code-execution)
          * [ External API Validation  ](https://ai.pydantic.dev/evals/evaluators/custom/#external-api-validation)
        * [ Testing Evaluators  ](https://ai.pydantic.dev/evals/evaluators/custom/#testing-evaluators)
        * [ Best Practices  ](https://ai.pydantic.dev/evals/evaluators/custom/#best-practices)
          * [ 1. Keep Evaluators Focused  ](https://ai.pydantic.dev/evals/evaluators/custom/#1-keep-evaluators-focused)
          * [ 2. Handle Missing Data Gracefully  ](https://ai.pydantic.dev/evals/evaluators/custom/#2-handle-missing-data-gracefully)
          * [ 3. Provide Helpful Reasons  ](https://ai.pydantic.dev/evals/evaluators/custom/#3-provide-helpful-reasons)
          * [ 4. Use Timeouts for External Calls  ](https://ai.pydantic.dev/evals/evaluators/custom/#4-use-timeouts-for-external-calls)
        * [ Next Steps  ](https://ai.pydantic.dev/evals/evaluators/custom/#next-steps)
...
All evaluators inherit from [`Evaluator`](https://ai.pydantic.dev/api/pydantic_evals/evaluators/#pydantic_evals.evaluators.Evaluator "Evaluator
...
**Key Points:**
  ...
  * Return `bool`, `int`, `float`, `str`, [`EvaluationReason`](https://ai.pydantic.dev/api/pydantic_evals/evaluators/#pydantic_evals.evaluators.EvaluationReason "EvaluationReason
...
The [`EvaluatorOutput`](https://ai.pydantic.dev/api/pydantic_evals/evaluators/#pydantic_evals.evaluators.EvaluatorOutput "EvaluatorOutput
...
See [Metrics & Attributes Guide](https://ai.pydantic.dev/evals/how-to/metrics-attributes/) for more.
...
## Next Steps
  * **[Report Evaluators](https://ai.pydantic.dev/evals/evaluators/report-evaluators/)** - Experiment-wide analyses (confusion matrices, PR curves, custom tables)
  * **[Span-Based Evaluation](https://ai.pydantic.dev/evals/evaluators/span-based/)** - Using OpenTelemetry spans
  * **[Examples](https://ai.pydantic.dev/evals/examples/simple-validation/)** - Practical examples
