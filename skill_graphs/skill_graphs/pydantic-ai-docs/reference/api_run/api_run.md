[ Skip to content ](https://ai.pydantic.dev/api/run/#pydantic_airun)
...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * API Reference
    * pydantic_ai
      ...
      * pydantic_ai.run  [ pydantic_ai.run  ](https://ai.pydantic.dev/api/run/)
        * [ run  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run)
        * [ AgentRun  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRun)
          * [ ctx  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRun.ctx)
          * [ next_node  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRun.next_node)
          * [ result  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRun.result)
          * [ all_messages  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRun.all_messages)
          * [ all_messages_json  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRun.all_messages_json)
          * [ new_messages  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRun.new_messages)
          * [ new_messages_json  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRun.new_messages_json)
          * [ __aiter__  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRun.__aiter__)
          * [ __anext__  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRun.__anext__)
          * [ next  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRun.next)
          * [ usage  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRun.usage)
          * [ metadata  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRun.metadata)
          * [ run_id  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRun.run_id)
        * [ AgentRunResult  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRunResult)
          * [ output  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRunResult.output)
          * [ all_messages  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRunResult.all_messages)
          * [ all_messages_json  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRunResult.all_messages_json)
          * [ new_messages  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRunResult.new_messages)
          * [ new_messages_json  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRunResult.new_messages_json)
          * [ response  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRunResult.response)
          * [ usage  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRunResult.usage)
          * [ timestamp  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRunResult.timestamp)
          * [ metadata  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRunResult.metadata)
          * [ run_id  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRunResult.run_id)
        * [ AgentRunResultEvent  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRunResultEvent)
          * [ result  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRunResultEvent.result)
          * [ event_kind  ](https://ai.pydantic.dev/api/run/#pydantic_ai.run.AgentRunResultEvent.event_kind)
