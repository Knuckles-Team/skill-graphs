...
__init__(
   ...
   \(pydantic_ai.models.KnownModelName\)"),
    limiter: (
         | ConcurrencyLimit[](https://ai.pydantic.dev/api/concurrency/#pydantic_ai.ConcurrencyLimit "pydantic_ai.concurrency.ConcurrencyLimit") | AbstractConcurrencyLimiter[](https://ai.pydantic.dev/api/concurrency/#pydantic_ai.AbstractConcurrencyLimiter "pydantic_ai.concurrency.AbstractConcurrencyLimiter")
    ),
)
...
Name | Type | Description | Default
---|---|---|---
`source` |  |  Identifier for observability (e.g., 'model:gpt-4o'). |  _required_
Source code in `pydantic_ai_slim/pydantic_ai/concurrency.py`
```
50
51
...
Name | Type | Description | Default
---|---|---|---
`max_running` |  |  Maximum number of concurrent operations. |  _required_
`max_queued` |  |  Maximum queue depth before raising ConcurrencyLimitExceeded. |  `None`
`name` |  |  Optional name for this limiter, used for observability when sharing a limiter across multiple models or agents. |  `None`
...
```
from_limit(
    limit:  | ConcurrencyLimit[](https://ai.pydantic.dev/api/concurrency/#pydantic_ai.ConcurrencyLimit "pydantic_ai.concurrency.ConcurrencyLimit"),
    *,
    name:  | None = None,
    tracer: Tracer | None = None
) ->
...
Name | Type | Description | Default
---|---|---|---
`limit` |  `ConcurrencyLimit[](https://ai.pydantic.dev/api/concurrency/#pydantic_ai.ConcurrencyLimit "pydantic_ai.concurrency.ConcurrencyLimit")` |  Either an int for simple limiting or a ConcurrencyLimit for full config. |  _required_
`name` |  |  Optional name for this limiter, used for observability. |  `None`
`tracer` |  `Tracer | None` |  OpenTelemetry tracer for span creation. |  `None`
Returns:
Type | Description
---|---
...
Name | Type | Description | Default
---|---|---|---
`source` |  |  Identifier for the source of this acquisition (e.g., 'agent:my-agent' or 'model:gpt-4'). |  _required_
Source code in `pydantic_ai_slim/pydantic_ai/concurrency.py`
```
171
172
...
Name | Type | Description | Default
---|---|---|---
`max_running` |  |  Maximum number of concurrent operations allowed. |  _required_
`max_queued` |  |  Maximum number of operations waiting in the queue. If None, the queue is unlimited. If exceeded, raises `ConcurrencyLimitExceeded`. |  `None`
Source code in `pydantic_ai_slim/pydantic_ai/concurrency.py`
```
65
66
