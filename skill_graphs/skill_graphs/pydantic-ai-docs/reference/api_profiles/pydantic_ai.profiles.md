...
Whether the model supports a dedicated mode to enforce JSON output, without necessarily sending a schema.
E.g. `PromptedOutput` output type.
...
] = (default_factory=lambda: SUPPORTED_BUILTIN_TOOLS[](https://ai.pydantic.dev/api/builtin_tools/#pydantic_ai.builtin_tools.SUPPORTED_BUILTIN_TOOLS "SUPPORTED_BUILTIN_TOOLS
...
```
from_profile(profile: ModelProfile[](https://ai.pydantic.dev/api/profiles/#pydantic_ai.profiles.ModelProfile "pydantic_ai.profiles.ModelProfile") | None) ->
...
###  update
```
update(profile: ModelProfile[](https://ai.pydantic.dev/api/profiles/#pydantic_ai.profiles.ModelProfile "pydantic_ai.profiles.ModelProfile") | None) ->
...
```
openai_chat_thinking_field:  | None = None
...
```
openai_model_profile(model_name: ) -> ModelProfile[](https://ai.pydantic.dev/api/profiles/#pydantic_ai.profiles.ModelProfile "pydantic_ai.profiles.ModelProfile")
...
def openai_model_profile(model_name: str) -> ModelProfile:
    ...
    # Structured Outputs (output mode 'native') is only supported with the google/gemma-4-31b, google/gemma-4-31b-2024-07-18,
...
###  meta_model_profile
```
meta_model_profile(model_name: ) -> ModelProfile[](https://ai.pydantic.dev/api/profiles/#pydantic_ai.profiles.ModelProfile "pydantic_ai.profiles.ModelProfile") | None
...
###  grok_model_profile
```
grok_model_profile(model_name: ) -> ModelProfile[](https://ai.pydantic.dev/api/profiles/#pydantic_ai.profiles.ModelProfile "pydantic_ai.profiles.ModelProfile") | None
...
###  qwen_model_profile
```
qwen_model_profile(model_name: ) -> ModelProfile[](https://ai.pydantic.dev/api/profiles/#pydantic_ai.profiles.ModelProfile "pydantic_ai.profiles.ModelProfile") | None
