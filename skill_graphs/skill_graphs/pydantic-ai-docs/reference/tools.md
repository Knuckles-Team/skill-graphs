  ...
  * Documentation
    * Core Concepts
      ...
      * Function Tools  [ Function Tools  ](https://ai.pydantic.dev/tools/)
        * [ Registering via Decorator  ](https://ai.pydantic.dev/tools/#registering-function-tools-via-decorator)
        * [ Registering via Agent Argument  ](https://ai.pydantic.dev/tools/#registering-function-tools-via-agent-argument)
        * [ Tool Output  ](https://ai.pydantic.dev/tools/#function-tool-output)
        * [ Tool Schema  ](https://ai.pydantic.dev/tools/#function-tools-and-schema)
        * [ See Also  ](https://ai.pydantic.dev/tools/#see-also)
...
There are a number of ways to register tools with an agent:
  * via the [`@agent.tool`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.Agent.tool "tool") decorator — for tools that need access to the agent [context](https://ai.pydantic.dev/api/tools/#pydantic_ai.tools.RunContext "RunContext



      dataclass
  ")
  * via the [`@agent.tool_plain`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.Agent.tool_plain "tool_plain") decorator — for tools that do not need access to the agent [context](https://ai.pydantic.dev/api/tools/#pydantic_ai.tools.RunContext "RunContext



      dataclass
  ")
  * via the [`tools`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.Agent.__init__ "__init__") keyword argument to `Agent` which can take either plain functions, or instances of [`Tool`](https://ai.pydantic.dev/api/tools/#pydantic_ai.tools.Tool "Tool
...
`@agent.tool` is considered the default decorator since in the majority of cases tools will need access to the agent [context](https://ai.pydantic.dev/api/tools/#pydantic_ai.tools.RunContext "RunContext
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/tools/#__tabbed_1_1)[Directly to Provider API](https://ai.pydantic.dev/tools/#__tabbed_1_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway) dice_game.py```
import random

from pydantic_ai import Agent, RunContext

agent = Agent(
    'gateway/gemini:gemini-3-flash-preview',  [](https://ai.pydantic.dev/tools/#__code_0_annotation_1)
    deps_type=str,  [](https://ai.pydantic.dev/tools/#__code_0_annotation_2)
    instructions=(
...
@agent.tool_plain  [](https://ai.pydantic.dev/tools/#__code_0_annotation_3)
def roll_dice() -> str:
    """Roll a six-sided die and return the result."""
    return str(random.randint(1, 6))


@agent.tool  [](https://ai.pydantic.dev/tools/#__code_0_annotation_4)
def get_player_name(ctx: RunContext[str]) -> str:
    """Get the player's name."""
    return ctx.deps


dice_result = agent.run_sync('My guess is 4', deps='Anne')  [](https://ai.pydantic.dev/tools/#__code_0_annotation_5)
...
[](https://ai.pydantic.dev/tools/#__code_1_annotation_1)
    deps_type=str,

[](https://ai.pydantic.dev/tools/#__code_1_annotation_2)
    instructions=(
        "You're a dice game, you should roll the die and see if the number "
        "you get back matches the user's guess. If so, tell them they're a winner. "
        "Use the player's name in the response."
...
[](https://ai.pydantic.dev/tools/#__code_1_annotation_3)
def roll_dice() -> str:
    """Roll a six-sided die and return the result."""
    return str(random.randint(1, 6))
...
[](https://ai.pydantic.dev/tools/#__code_1_annotation_4)
def get_player_name(ctx: RunContext[str]) -> str:
    """Get the player's name."""
    return ctx.deps
...
[](https://ai.pydantic.dev/tools/#__code_1_annotation_5)
print(dice_result.output)
#> Congratulations Anne, you guessed correctly! You're a winner!
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/tools/#__tabbed_2_1)[Directly to Provider API](https://ai.pydantic.dev/tools/#__tabbed_2_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway) dice_game_tool_kwarg.py```
import random
...
agent_a = Agent(
    ...
    deps_type=str,
    tools=[roll_dice, get_player_name],  [](https://ai.pydantic.dev/tools/#__code_3_annotation_1)
    instructions=instructions,
)
agent_b = Agent(
    'gateway/gemini:gemini-3-flash-preview',
    deps_type=str,
    tools=[  [](https://ai.pydantic.dev/tools/#__code_3_annotation_2)
...
[](https://ai.pydantic.dev/tools/#__code_4_annotation_1)
    instructions=instructions,
)
agent_b = Agent(
    'google-gla:gemini-3-flash-preview',
...
[](https://ai.pydantic.dev/tools/#__code_4_annotation_2)
        Tool(roll_dice, takes_ctx=False),
        Tool(get_player_name, takes_ctx=True),
    ],
    instructions=instructions,
...
```
  ...
  1. The simplest way to register tools via the `Agent` constructor is to pass a list of functions, the function signature is inspected to determine if the tool takes [`RunContext`](https://ai.pydantic.dev/api/tools/#pydantic_ai.tools.RunContext "RunContext



      dataclass
  ").
  2. `agent_a` and `agent_b` are identical — but we can use [`Tool`](https://ai.pydantic.dev/api/tools/#pydantic_ai.tools.Tool "Tool



      dataclass
  ") to reuse tool definitions and give more fine-grained control over how tools are defined, e.g. setting their name or description, or using a custom [`prepare`](https://ai.pydantic.dev/tools-advanced/#tool-prepare) method.
...
Even better, Pydantic AI extracts the docstring from functions and (thanks to
`google`, `numpy`, and `sphinx` style docstrings. Pydantic AI will infer the format to use based on the docstring, but you can explicitly set it using [`docstring_format`](https://ai.pydantic.dev/api/tools/#pydantic_ai.tools.DocstringFormat "DocstringFormat



      module-attribute
  "). You can also enforce parameter requirements by setting `require_parameter_descriptions=True`. This will raise a [`UserError`](https://ai.pydantic.dev/api/exceptions/#pydantic_ai.exceptions.UserError "UserError") if a parameter description is missing.
To demonstrate a tool's schema, here we use [`FunctionModel`](https://ai.pydantic.dev/api/models/function/#pydantic_ai.models.function.FunctionModel "FunctionModel
...
Here's an example where we use [`TestModel.last_model_request_parameters`](https://ai.pydantic.dev/api/models/test/#pydantic_ai.models.test.TestModel.last_model_request_parameters "last_model_request_parameters
