...
```
HuggingFaceModelName =  | LatestHuggingFaceModelNames[](https://ai.pydantic.dev/api/models/huggingface/#pydantic_ai.models.huggingface.LatestHuggingFaceModelNames "LatestHuggingFaceModelNames
...
You can browse available models
...
---|---|---|---
`model_name` |  |  The name of the Model to use. You can browse available models  |  _required_
