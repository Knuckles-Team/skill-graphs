[ Skip to content ](https://ai.pydantic.dev/api/models/outlines/#pydantic_aimodelsoutlines)
...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * API Reference
    * pydantic_ai
      ...
      * pydantic_ai.models.outlines  [ pydantic_ai.models.outlines  ](https://ai.pydantic.dev/api/models/outlines/)
        * [ Setup  ](https://ai.pydantic.dev/api/models/outlines/#setup)
          * [ outlines  ](https://ai.pydantic.dev/api/models/outlines/#pydantic_ai.models.outlines)
          * [ OutlinesModel  ](https://ai.pydantic.dev/api/models/outlines/#pydantic_ai.models.outlines.OutlinesModel)
            * [ __init__  ](https://ai.pydantic.dev/api/models/outlines/#pydantic_ai.models.outlines.OutlinesModel.__init__)
            * [ from_transformers  ](https://ai.pydantic.dev/api/models/outlines/#pydantic_ai.models.outlines.OutlinesModel.from_transformers)
            * [ from_llamacpp  ](https://ai.pydantic.dev/api/models/outlines/#pydantic_ai.models.outlines.OutlinesModel.from_llamacpp)
            * [ from_mlxlm  ](https://ai.pydantic.dev/api/models/outlines/#pydantic_ai.models.outlines.OutlinesModel.from_mlxlm)
            * [ from_sglang  ](https://ai.pydantic.dev/api/models/outlines/#pydantic_ai.models.outlines.OutlinesModel.from_sglang)
            * [ from_vllm_offline  ](https://ai.pydantic.dev/api/models/outlines/#pydantic_ai.models.outlines.OutlinesModel.from_vllm_offline)
            * [ format_inference_kwargs  ](https://ai.pydantic.dev/api/models/outlines/#pydantic_ai.models.outlines.OutlinesModel.format_inference_kwargs)
          * [ OutlinesStreamedResponse  ](https://ai.pydantic.dev/api/models/outlines/#pydantic_ai.models.outlines.OutlinesStreamedResponse)
            * [ model_name  ](https://ai.pydantic.dev/api/models/outlines/#pydantic_ai.models.outlines.OutlinesStreamedResponse.model_name)
            * [ provider_name  ](https://ai.pydantic.dev/api/models/outlines/#pydantic_ai.models.outlines.OutlinesStreamedResponse.provider_name)
            * [ provider_url  ](https://ai.pydantic.dev/api/models/outlines/#pydantic_ai.models.outlines.OutlinesStreamedResponse.provider_url)
            * [ timestamp  ](https://ai.pydantic.dev/api/models/outlines/#pydantic_ai.models.outlines.OutlinesStreamedResponse.timestamp)
