...
`model_name` |  |  The name of the model. If not provided, a name is generated from the function names. |  `None`
...
```
function_tools: [ToolDefinition[](https://ai.pydantic.dev/api/tools/#pydantic_ai.tools.ToolDefinition "ToolDefinition
...
```
output_tools: [ToolDefinition[](https://ai.pydantic.dev/api/tools/#pydantic_ai.tools.ToolDefinition "ToolDefinition
...
```
DeltaToolCalls:  = [, DeltaToolCall[](https://ai.pydantic.dev/api/models/function/#pydantic_ai.models.function.DeltaToolCall "DeltaToolCall
...
```
DeltaThinkingCalls:  = [, DeltaThinkingPart[](https://ai.pydantic.dev/api/models/function/#pydantic_ai.models.function.DeltaThinkingPart "DeltaThinkingPart
...
FunctionDef:  = [
   ...
   \(pydantic_ai.models.function.AgentInfo\)")],
    ModelResponse[](https://ai.pydantic.dev/api/messages/#pydantic_ai.messages.ModelResponse "ModelResponse
      ...
      dataclass
   \(pydantic_ai.messages.ModelResponse\)") | [ModelResponse[](https://ai.pydantic.dev/api/messages/#pydantic_ai.messages.ModelResponse "ModelResponse
