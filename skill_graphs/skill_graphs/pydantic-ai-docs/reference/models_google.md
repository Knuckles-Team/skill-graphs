      ...
      * Google  [ Google  ](https://ai.pydantic.dev/models/google/)
        ...
        * [ Configuration  ](https://ai.pydantic.dev/models/google/#configuration)
          ...
          * [ Vertex AI (Enterprise/Cloud)  ](https://ai.pydantic.dev/models/google/#vertex-ai-enterprisecloud)
            ...
            * [ API Key  ](https://ai.pydantic.dev/models/google/#api-key)
            * [ Customizing Location or Project  ](https://ai.pydantic.dev/models/google/#customizing-location-or-project)
            * [ Model Garden  ](https://ai.pydantic.dev/models/google/#model-garden)
        * [ Custom HTTP Client  ](https://ai.pydantic.dev/models/google/#custom-http-client)
        ...
        * [ Model settings  ](https://ai.pydantic.dev/models/google/#model-settings)
          * [ Configure thinking  ](https://ai.pydantic.dev/models/google/#configure-thinking)
          * [ Safety settings  ](https://ai.pydantic.dev/models/google/#safety-settings)
          * [ Logprobs  ](https://ai.pydantic.dev/models/google/#logprobs)
...
# Google
The `GoogleModel` is a model that uses the
## Install
...
## Configuration
`GoogleModel` lets you use Google's Gemini models through their `generativelanguage.googleapis.com`) or `*-aiplatform.googleapis.com`).
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/models/google/#__tabbed_2_1)[Directly to Provider API](https://ai.pydantic.dev/models/google/#__tabbed_2_2)
...
If you have the `GoogleProvider` in Vertex AI mode by name:
[With Pydantic AI Gateway](https://ai.pydantic.dev/models/google/#__tabbed_3_1)[Directly to Provider API](https://ai.pydantic.dev/models/google/#__tabbed_3_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway)```
from pydantic_ai import Agent
...
#### API Key
To use Vertex AI with an API key,
```
export GOOGLE_API_KEY=your-api-key
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/models/google/#__tabbed_4_1)[Directly to Provider API](https://ai.pydantic.dev/models/google/#__tabbed_4_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway)```
from pydantic_ai import Agent
...
#### Model Garden
You can access models from the `generateContent` API and are available under your GCP project, including but not limited to Gemini, using one of the following `model_name` patterns:
...
See the [input documentation](https://ai.pydantic.dev/input/) for more details and examples.
## Model settings
You can customize model behavior using [`GoogleModelSettings`](https://ai.pydantic.dev/api/models/google/#pydantic_ai.models.google.GoogleModelSettings "GoogleModelSettings"):
```
...
See the
### Logprobs
You can return logprobs from the model in your response by setting `google_logprobs` and `google_top_logprobs` in the [`GoogleModelSettings`](https://ai.pydantic.dev/api/models/google/#pydantic_ai.models.google.GoogleModelSettings "GoogleModelSettings").
