[ Skip to content ](https://ai.pydantic.dev/evals/how-to/dataset-management/#dataset-management)
...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * Pydantic Evals
    ...
    * How-To Guides
      ...
      * Dataset Management  [ Dataset Management  ](https://ai.pydantic.dev/evals/how-to/dataset-management/)
        * [ Creating Datasets  ](https://ai.pydantic.dev/evals/how-to/dataset-management/#creating-datasets)
          * [ From Code  ](https://ai.pydantic.dev/evals/how-to/dataset-management/#from-code)
          * [ Adding Cases Dynamically  ](https://ai.pydantic.dev/evals/how-to/dataset-management/#adding-cases-dynamically)
        * [ Saving Datasets  ](https://ai.pydantic.dev/evals/how-to/dataset-management/#saving-datasets)
          * [ Save to YAML  ](https://ai.pydantic.dev/evals/how-to/dataset-management/#save-to-yaml)
          * [ Save to JSON  ](https://ai.pydantic.dev/evals/how-to/dataset-management/#save-to-json)
          * [ Custom Schema Path  ](https://ai.pydantic.dev/evals/how-to/dataset-management/#custom-schema-path)
        * [ Loading Datasets  ](https://ai.pydantic.dev/evals/how-to/dataset-management/#loading-datasets)
          * [ From YAML/JSON  ](https://ai.pydantic.dev/evals/how-to/dataset-management/#from-yamljson)
          * [ From String  ](https://ai.pydantic.dev/evals/how-to/dataset-management/#from-string)
          * [ From Dict  ](https://ai.pydantic.dev/evals/how-to/dataset-management/#from-dict)
          * [ With Custom Evaluators  ](https://ai.pydantic.dev/evals/how-to/dataset-management/#with-custom-evaluators)
        * [ Generating Datasets  ](https://ai.pydantic.dev/evals/how-to/dataset-management/#generating-datasets)
        * [ Type-Safe Datasets  ](https://ai.pydantic.dev/evals/how-to/dataset-management/#type-safe-datasets)
        * [ Schema Generation  ](https://ai.pydantic.dev/evals/how-to/dataset-management/#schema-generation)
        * [ Best Practices  ](https://ai.pydantic.dev/evals/how-to/dataset-management/#best-practices)
          * [ 1. Use Clear Names  ](https://ai.pydantic.dev/evals/how-to/dataset-management/#1-use-clear-names)
          * [ 2. Organize by Difficulty  ](https://ai.pydantic.dev/evals/how-to/dataset-management/#2-organize-by-difficulty)
          * [ 3. Start Small, Grow Gradually  ](https://ai.pydantic.dev/evals/how-to/dataset-management/#3-start-small-grow-gradually)
          * [ 4. Use Case-specific Evaluators Where Appropriate  ](https://ai.pydantic.dev/evals/how-to/dataset-management/#4-use-case-specific-evaluators-where-appropriate)
          * [ 5. Separate Datasets by Purpose  ](https://ai.pydantic.dev/evals/how-to/dataset-management/#5-separate-datasets-by-purpose)
        * [ Next Steps  ](https://ai.pydantic.dev/evals/how-to/dataset-management/#next-steps)
...
For complete details on serialization formats, JSON schema generation, and custom evaluators, see [Dataset Serialization](https://ai.pydantic.dev/evals/how-to/dataset-serialization/).
### Save to YAML
```
from typing import Any
...
For complete details on serialization with custom evaluators, see [Dataset Serialization](https://ai.pydantic.dev/evals/how-to/dataset-serialization/).
## Generating Datasets
Pydantic Evals allows you to generate test datasets using LLMs with [`generate_dataset`](https://ai.pydantic.dev/api/pydantic_evals/generation/#pydantic_evals.generation.generate_dataset "generate_dataset
...
class QuestionInputs(BaseModel, use_attribute_docstrings=True):  [](https://ai.pydantic.dev/evals/how-to/dataset-management/#__code_10_annotation_1)
...
class AnswerOutput(BaseModel, use_attribute_docstrings=True):  [](https://ai.pydantic.dev/evals/how-to/dataset-management/#__code_10_annotation_2)
...
class MetadataType(BaseModel, use_attribute_docstrings=True):  [](https://ai.pydantic.dev/evals/how-to/dataset-management/#__code_10_annotation_3)
...
async def main():
    dataset = await generate_dataset(  [](https://ai.pydantic.dev/evals/how-to/dataset-management/#__code_10_annotation_4)
    ...
    dataset.to_file(output_file)  [](https://ai.pydantic.dev/evals/how-to/dataset-management/#__code_10_annotation_5)
...
async def main():
    dataset = await generate_dataset(  [](https://ai.pydantic.dev/evals/how-to/dataset-management/#__code_11_annotation_1)
        dataset_type=Dataset[QuestionInputs, AnswerOutput, MetadataType],
        n_examples=2,
        extra_instructions="""
        Generate question-answer pairs about world capitals and landmarks.
    ...
    dataset.to_file(output_file)  [](https://ai.pydantic.dev/evals/how-to/dataset-management/#__code_11_annotation_2)
    print(output_file.read_text(encoding='utf-8'))
    """
    {
...
Case-specific evaluators let different cases have different evaluation criteria, which is essential for comprehensive "test coverage". Rather than trying to write one-size-fits-all evaluators, you can specify exactly what "good" looks like for each scenario. This is particularly powerful with [`LLMJudge`](https://ai.pydantic.dev/api/pydantic_evals/evaluators/#pydantic_evals.evaluators.LLMJudge "LLMJudge



      dataclass
  ") evaluators where you can describe nuanced requirements per case, making it easy to build and maintain golden datasets. See [Case-specific evaluators](https://ai.pydantic.dev/evals/evaluators/overview/#case-specific-evaluators) for detailed guidance.
...
## Next Steps
  * **[Dataset Serialization](https://ai.pydantic.dev/evals/how-to/dataset-serialization/)** - In-depth guide to saving and loading datasets
  * **[Generating Datasets](https://ai.pydantic.dev/evals/how-to/dataset-management/#generating-datasets)** - Use LLMs to generate test cases
  * **[Examples: Simple Validation](https://ai.pydantic.dev/evals/examples/simple-validation/)** - Practical examples
