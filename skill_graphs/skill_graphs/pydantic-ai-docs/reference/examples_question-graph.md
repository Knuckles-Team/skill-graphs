...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * Examples
    ...
    * Complex Workflows
      ...
      * Question Graph  [ Question Graph  ](https://ai.pydantic.dev/examples/question-graph/)
...
## Example Code
[With Pydantic AI Gateway](https://ai.pydantic.dev/examples/question-graph/#__tabbed_2_1)[Directly to Provider API](https://ai.pydantic.dev/examples/question-graph/#__tabbed_2_2)
