...
By default, this returns the Server-Sent Events content type (`text/event-stream`). If a subclass supports other types as well, it should consider `self.accept` in [`encode_event()`](https://ai.pydantic.dev/api/ui/base/#pydantic_ai.ui.UIEventStream.encode_event "encode_event



      abstractmethod
  ") and return the resulting content type.
####  encode_event `abstractmethod`
```
encode_event(event: EventT) ->
...
This method dispatches to specific hooks and `handle_*` methods that subclasses can override: - [`before_stream()`](https://ai.pydantic.dev/api/ui/base/#pydantic_ai.ui.UIEventStream.before_stream "before_stream



      async
  ") - [`after_stream()`](https://ai.pydantic.dev/api/ui/base/#pydantic_ai.ui.UIEventStream.after_stream "after_stream



      async
  ") - [`on_error()`](https://ai.pydantic.dev/api/ui/base/#pydantic_ai.ui.UIEventStream.on_error "on_error



      async
  ") - [`before_request()`](https://ai.pydantic.dev/api/ui/base/#pydantic_ai.ui.UIEventStream.before_request "before_request



      async
  ") - [`after_request()`](https://ai.pydantic.dev/api/ui/base/#pydantic_ai.ui.UIEventStream.after_request "after_request



      async
  ") - [`before_response()`](https://ai.pydantic.dev/api/ui/base/#pydantic_ai.ui.UIEventStream.before_response "before_response



      async
  ") - [`after_response()`](https://ai.pydantic.dev/api/ui/base/#pydantic_ai.ui.UIEventStream.after_response "after_response



      async
  ") - [`handle_event()`](https://ai.pydantic.dev/api/ui/base/#pydantic_ai.ui.UIEventStream.handle_event "handle_event
...
####  handle_event `async`
```
handle_event(event: NativeEvent[](https://ai.pydantic.dev/api/ui/base/#pydantic_ai.ui.NativeEvent "NativeEvent



      module-attribute
   \(pydantic_ai.ui._event_stream.NativeEvent\)")) -> [EventT]
