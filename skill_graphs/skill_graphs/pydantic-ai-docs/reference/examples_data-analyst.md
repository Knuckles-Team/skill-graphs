[ Skip to content ](https://ai.pydantic.dev/examples/data-analyst/#data-analyst)
...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * Examples
    ...
    * Data & Analytics
      ...
      * Data Analyst  [ Data Analyst  ](https://ai.pydantic.dev/examples/data-analyst/)
        * [ Running the Example  ](https://ai.pydantic.dev/examples/data-analyst/#running-the-example)
        * [ Example Code  ](https://ai.pydantic.dev/examples/data-analyst/#example-code)
        * [ Appendix  ](https://ai.pydantic.dev/examples/data-analyst/#appendix)
          * [ Choosing a Model  ](https://ai.pydantic.dev/examples/data-analyst/#choosing-a-model)
  ...
  * [ Appendix  ](https://ai.pydantic.dev/examples/data-analyst/#appendix)
  ...
  3. [ Data & Analytics  ](https://ai.pydantic.dev/examples/sql-gen/)
...
With Pydantic AI, you can use a [dependencies object](https://ai.pydantic.dev/dependencies/) to store the result from one tool and use it in another tool.
In this example, we'll build an agent that analyzes the
Demonstrates:
...
[pip](https://ai.pydantic.dev/examples/data-analyst/#__tabbed_1_1)[uv](https://ai.pydantic.dev/examples/data-analyst/#__tabbed_1_2)
```
...
## Example Code
[With Pydantic AI Gateway](https://ai.pydantic.dev/examples/data-analyst/#__tabbed_2_1)[Directly to Provider API](https://ai.pydantic.dev/examples/data-analyst/#__tabbed_2_2)
