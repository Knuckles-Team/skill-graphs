[ Skip to content ](https://ai.pydantic.dev/examples/setup/#examples)
...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * Examples
    * Setup  [ Setup  ](https://ai.pydantic.dev/examples/setup/)
      * [ Usage  ](https://ai.pydantic.dev/examples/setup/#usage)
        * [ Installing required dependencies  ](https://ai.pydantic.dev/examples/setup/#installing-required-dependencies)
        * [ Setting model environment variables  ](https://ai.pydantic.dev/examples/setup/#setting-model-environment-variables)
        * [ Running Examples  ](https://ai.pydantic.dev/examples/setup/#running-examples)
    * Getting Started
...
## Usage
These examples are distributed with `pydantic-ai` so you can run them either by cloning the `pydantic-ai` from PyPI with `pip` or `uv`.
### Installing required dependencies
Either way you'll need to install extra dependencies to run some examples, you just need to install the `examples` optional dependency group.
If you've installed `pydantic-ai` via pip/uv, you can install the extra dependencies with:
[pip](https://ai.pydantic.dev/examples/setup/#__tabbed_1_1)[uv](https://ai.pydantic.dev/examples/setup/#__tabbed_1_2)
```
...
[OpenAI](https://ai.pydantic.dev/examples/setup/#__tabbed_2_1)[Google Gemini](https://ai.pydantic.dev/examples/setup/#__tabbed_2_2)
```
...
[pip](https://ai.pydantic.dev/examples/setup/#__tabbed_3_1)[uv](https://ai.pydantic.dev/examples/setup/#__tabbed_3_2)
```
...
[pip](https://ai.pydantic.dev/examples/setup/#__tabbed_4_1)[uv](https://ai.pydantic.dev/examples/setup/#__tabbed_4_2)
```
...
[pip](https://ai.pydantic.dev/examples/setup/#__tabbed_5_1)[uv](https://ai.pydantic.dev/examples/setup/#__tabbed_5_2)
```
