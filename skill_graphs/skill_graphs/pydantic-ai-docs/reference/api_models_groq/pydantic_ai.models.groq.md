...
```
GroqModelName = (
     | ProductionGroqModelNames[](https://ai.pydantic.dev/api/models/groq/#pydantic_ai.models.groq.ProductionGroqModelNames "ProductionGroqModelNames
...
```
groq_reasoning_format: ['hidden', 'raw', 'parsed']
...
__init__(
    ...
    *,
    provider: (
        ["groq", "gateway"] | Provider[](https://ai.pydantic.dev/api/providers/#pydantic_ai.providers.Provider "pydantic_ai.providers.Provider")[AsyncGroq]
    ) = "groq",
    profile: ModelProfileSpec | None = None,
...
`model_name` |  `GroqModelName[](https://ai.pydantic.dev/api/models/groq/#pydantic_ai.models.groq.GroqModelName "GroqModelName
      ...
      module-attribute
   \(pydantic_ai.models.groq.GroqModelName\)")` |  The name of the Groq model to use. List of model names available  |  _required_
