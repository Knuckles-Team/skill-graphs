[ Skip to content ](https://ai.pydantic.dev/version-policy/#version-policy)
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * Project
    ...
    * Version policy  [ Version policy  ](https://ai.pydantic.dev/version-policy/)
      * [ Version Policy  ](https://ai.pydantic.dev/version-policy/#version-policy)
      * [ Beta Features  ](https://ai.pydantic.dev/version-policy/#beta-features)
      * [ Support for Python versions  ](https://ai.pydantic.dev/version-policy/#support-for-python-versions)
...
The following changes will **NOT** be considered breaking changes, and may occur in minor releases:
  ...
  * Adding new [message parts](https://ai.pydantic.dev/api/messages/#pydantic_ai.messages), [stream events](https://ai.pydantic.dev/api/messages/#pydantic_ai.messages.AgentStreamEvent "AgentStreamEvent



      module-attribute
  "), or optional fields (including fields with default values) on existing message (part) and event types. Always code defensively when consuming message parts or event streams, and use the [`ModelMessagesTypeAdapter`](https://ai.pydantic.dev/api/messages/#pydantic_ai.messages.ModelMessagesTypeAdapter "ModelMessagesTypeAdapter



      module-attribute
  ") to (de)serialize message histories.
  * Changing OpenTelemetry span attributes. Because different [observability platforms](https://ai.pydantic.dev/logfire/#using-opentelemetry) support different versions of the [instrumentation version](https://ai.pydantic.dev/logfire/#configuring-data-format), but the default version may change in a minor release. Span attributes for [Pydantic Evals](https://ai.pydantic.dev/evals/) may also change as we iterate on Evals support in [Pydantic Logfire](https://logfire.pydantic.dev/docs/guides/web-ui/evals/).
