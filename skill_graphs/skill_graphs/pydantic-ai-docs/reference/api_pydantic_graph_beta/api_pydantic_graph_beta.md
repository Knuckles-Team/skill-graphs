[ Skip to content ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graphbeta)
...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * API Reference
    ...
    * pydantic_graph
      ...
      * Beta API
        * pydantic_graph.beta  [ pydantic_graph.beta  ](https://ai.pydantic.dev/api/pydantic_graph/beta/)
          * [ beta  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta)
          * [ Graph  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.Graph)
            * [ name  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.Graph.name)
            * [ state_type  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.Graph.state_type)
            * [ deps_type  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.Graph.deps_type)
            * [ input_type  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.Graph.input_type)
            * [ output_type  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.Graph.output_type)
            * [ auto_instrument  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.Graph.auto_instrument)
            * [ nodes  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.Graph.nodes)
            * [ edges_by_source  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.Graph.edges_by_source)
            * [ parent_forks  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.Graph.parent_forks)
            * [ intermediate_join_nodes  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.Graph.intermediate_join_nodes)
            * [ get_parent_fork  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.Graph.get_parent_fork)
            * [ is_final_join  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.Graph.is_final_join)
            * [ run  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.Graph.run)
            * [ iter  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.Graph.iter)
            * [ render  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.Graph.render)
            * [ __str__  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.Graph.__str__)
          * [ GraphBuilder  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.GraphBuilder)
            * [ name  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.GraphBuilder.name)
            * [ state_type  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.GraphBuilder.state_type)
            * [ deps_type  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.GraphBuilder.deps_type)
            * [ input_type  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.GraphBuilder.input_type)
            * [ output_type  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.GraphBuilder.output_type)
            * [ auto_instrument  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.GraphBuilder.auto_instrument)
            * [ __init__  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.GraphBuilder.__init__)
            * [ start_node  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.GraphBuilder.start_node)
            * [ end_node  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.GraphBuilder.end_node)
            * [ step  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.GraphBuilder.step)
            * [ stream  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.GraphBuilder.stream)
            * [ add  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.GraphBuilder.add)
            * [ add_edge  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.GraphBuilder.add_edge)
            * [ add_mapping_edge  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.GraphBuilder.add_mapping_edge)
            * [ edge_from  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.GraphBuilder.edge_from)
            * [ decision  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.GraphBuilder.decision)
            * [ match  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.GraphBuilder.match)
            * [ match_node  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.GraphBuilder.match_node)
            * [ node  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.GraphBuilder.node)
            * [ build  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.GraphBuilder.build)
          * [ EndNode  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.EndNode)
            * [ id  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.EndNode.id)
          * [ StartNode  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.StartNode)
            * [ id  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.StartNode.id)
          * [ StepContext  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.StepContext)
            * [ inputs  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.StepContext.inputs)
          * [ StepNode  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.StepNode)
            * [ step  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.StepNode.step)
            * [ inputs  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.StepNode.inputs)
            * [ run  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.StepNode.run)
          * [ TypeExpression  ](https://ai.pydantic.dev/api/pydantic_graph/beta/#pydantic_graph.beta.TypeExpression)
