...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * API Reference
    ...
    * pydantic_graph
      ...
      * pydantic_graph.exceptions  [ pydantic_graph.exceptions  ](https://ai.pydantic.dev/api/pydantic_graph/exceptions/)
        ...
        * [ GraphBuildingError  ](https://ai.pydantic.dev/api/pydantic_graph/exceptions/#pydantic_graph.exceptions.GraphBuildingError)
          * [ message  ](https://ai.pydantic.dev/api/pydantic_graph/exceptions/#pydantic_graph.exceptions.GraphBuildingError.message)
        * [ GraphValidationError  ](https://ai.pydantic.dev/api/pydantic_graph/exceptions/#pydantic_graph.exceptions.GraphValidationError)
          * [ message  ](https://ai.pydantic.dev/api/pydantic_graph/exceptions/#pydantic_graph.exceptions.GraphValidationError.message)
...
Bases: `GraphRuntimeError[](https://ai.pydantic.dev/api/pydantic_graph/exceptions/#pydantic_graph.exceptions.GraphRuntimeError "GraphRuntimeError \(pydantic_graph.exceptions.GraphRuntimeError\)")`
...
####  check `classmethod`
```
check(status: SnapshotStatus[](https://ai.pydantic.dev/api/pydantic_graph/persistence/#pydantic_graph.persistence.SnapshotStatus "SnapshotStatus



      module-attribute
   \(pydantic_graph.persistence.SnapshotStatus\)")) -> None
