[ Skip to content ](https://ai.pydantic.dev/api/models/xai/#pydantic_aimodelsxai)
...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * API Reference
    * pydantic_ai
      ...
      * pydantic_ai.models.xai  [ pydantic_ai.models.xai  ](https://ai.pydantic.dev/api/models/xai/)
        * [ Setup  ](https://ai.pydantic.dev/api/models/xai/#setup)
          * [ xai  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai)
          * [ XaiModelName  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModelName)
          * [ XaiModelSettings  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModelSettings)
            * [ xai_logprobs  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModelSettings.xai_logprobs)
            * [ xai_top_logprobs  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModelSettings.xai_top_logprobs)
            * [ xai_user  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModelSettings.xai_user)
            * [ xai_store_messages  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModelSettings.xai_store_messages)
            * [ xai_previous_response_id  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModelSettings.xai_previous_response_id)
            * [ xai_include_encrypted_content  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModelSettings.xai_include_encrypted_content)
            * [ xai_include_code_execution_output  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModelSettings.xai_include_code_execution_output)
            * [ xai_include_web_search_output  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModelSettings.xai_include_web_search_output)
            * [ xai_include_inline_citations  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModelSettings.xai_include_inline_citations)
            * [ xai_include_mcp_output  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModelSettings.xai_include_mcp_output)
          * [ XaiModel  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModel)
            * [ __init__  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModel.__init__)
            * [ model_name  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModel.model_name)
            * [ system  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModel.system)
            * [ supported_builtin_tools  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModel.supported_builtin_tools)
            * [ request  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModel.request)
            * [ request_stream  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModel.request_stream)
          * [ XaiStreamedResponse  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiStreamedResponse)
            * [ system  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiStreamedResponse.system)
            * [ provider_url  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiStreamedResponse.provider_url)
            * [ model_name  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiStreamedResponse.model_name)
            * [ provider_name  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiStreamedResponse.provider_name)
            * [ timestamp  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiStreamedResponse.timestamp)
  ...
  * [ Setup  ](https://ai.pydantic.dev/api/models/xai/#setup)
    ...
    * [ XaiModelSettings  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModelSettings)
      ...
      * [ xai_store_messages  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModelSettings.xai_store_messages)
      * [ xai_previous_response_id  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModelSettings.xai_previous_response_id)
      * [ xai_include_encrypted_content  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModelSettings.xai_include_encrypted_content "xai_include_encrypted_content")
      * [ xai_include_code_execution_output  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModelSettings.xai_include_code_execution_output "xai_include_code_execution_output")
      * [ xai_include_web_search_output  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModelSettings.xai_include_web_search_output "xai_include_web_search_output")
      * [ xai_include_inline_citations  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModelSettings.xai_include_inline_citations)
      * [ xai_include_mcp_output  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModelSettings.xai_include_mcp_output)
    * [ XaiModel  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModel)
      * [ __init__  ](https://ai.pydantic.dev/api/models/xai/#pydantic_ai.models.xai.XaiModel.__init__)
