...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * Examples
    ...
    * Complex Workflows
      * Flight booking  [ Flight booking  ](https://ai.pydantic.dev/examples/flight-booking/)
  ...
  * [ Example Code  ](https://ai.pydantic.dev/examples/flight-booking/#example-code)
  ...
  3. [ Complex Workflows  ](https://ai.pydantic.dev/examples/flight-booking/)
...
## Example Code
[With Pydantic AI Gateway](https://ai.pydantic.dev/examples/flight-booking/#__tabbed_2_1)[Directly to Provider API](https://ai.pydantic.dev/examples/flight-booking/#__tabbed_2_2)
