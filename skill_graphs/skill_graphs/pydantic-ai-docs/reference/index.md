[ Skip to content ](https://ai.pydantic.dev/#pydantic-ai)
...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  * Pydantic AI  [ Pydantic AI  ](https://ai.pydantic.dev/)
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/#__tabbed_1_1)[Directly to Provider API](https://ai.pydantic.dev/#__tabbed_1_2)
...
agent = Agent(  [](https://ai.pydantic.dev/#__code_0_annotation_1)
    ...
    instructions='Be concise, reply with one sentence.',  [](https://ai.pydantic.dev/#__code_0_annotation_2)
)
...
```
  ...
  1. We configure the agent to use [Anthropic's Claude Sonnet 4.6](https://ai.pydantic.dev/api/models/anthropic/) model, but you can also set the model when running the agent.
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/#__tabbed_2_1)[Directly to Provider API](https://ai.pydantic.dev/#__tabbed_2_2)
...
@dataclass
class SupportDependencies:  [](https://ai.pydantic.dev/#__code_2_annotation_3)
    customer_id: int
    db: DatabaseConn  [](https://ai.pydantic.dev/#__code_2_annotation_12)


class SupportOutput(BaseModel):  [](https://ai.pydantic.dev/#__code_2_annotation_13)
    support_advice: str = Field(description='Advice returned to the customer')
    block_card: bool = Field(description="Whether to block the customer's card")
    risk: int = Field(description='Risk level of query', ge=0, le=10)


support_agent = Agent(  [](https://ai.pydantic.dev/#__code_2_annotation_1)
    'gateway/openai:gpt-5.2',  [](https://ai.pydantic.dev/#__code_2_annotation_2)
    deps_type=SupportDependencies,
    output_type=SupportOutput,  [](https://ai.pydantic.dev/#__code_2_annotation_9)
    instructions=(  [](https://ai.pydantic.dev/#__code_2_annotation_4)
...
@support_agent.instructions  [](https://ai.pydantic.dev/#__code_2_annotation_5)
async def add_customer_name(ctx: RunContext[SupportDependencies]) -> str:
    customer_name = await ctx.deps.db.customer_name(id=ctx.deps.customer_id)
    return f"The customer's name is {customer_name!r}"


@support_agent.tool  [](https://ai.pydantic.dev/#__code_2_annotation_6)
async def customer_balance(
    ctx: RunContext[SupportDependencies], include_pending: bool
) -> float:
    """Returns the customer's current account balance."""  [](https://ai.pydantic.dev/#__code_2_annotation_7)
...
...  [](https://ai.pydantic.dev/#__code_2_annotation_11)


async def main():
    deps = SupportDependencies(customer_id=123, db=DatabaseConn())
    result = await support_agent.run('What is my balance?', deps=deps)  [](https://ai.pydantic.dev/#__code_2_annotation_8)
    print(result.output)  [](https://ai.pydantic.dev/#__code_2_annotation_10)
    """
...
[](https://ai.pydantic.dev/#__code_3_annotation_3)
    customer_id: int
    db: DatabaseConn

[](https://ai.pydantic.dev/#__code_3_annotation_12)


class SupportOutput(BaseModel):

[](https://ai.pydantic.dev/#__code_3_annotation_13)
    support_advice: str = Field(description='Advice returned to the customer')
    block_card: bool = Field(description="Whether to block the customer's card")
    risk: int = Field(description='Risk level of query', ge=0, le=10)
...
[](https://ai.pydantic.dev/#__code_3_annotation_1)
    'openai:gpt-5.2',

[](https://ai.pydantic.dev/#__code_3_annotation_2)
    deps_type=SupportDependencies,
    output_type=SupportOutput,

[](https://ai.pydantic.dev/#__code_3_annotation_9)
    instructions=(

[](https://ai.pydantic.dev/#__code_3_annotation_4)
        'You are a support agent in our bank, give the '
        'customer support and judge the risk level of their query.'
    ),
)
...
[](https://ai.pydantic.dev/#__code_3_annotation_5)
async def add_customer_name(ctx: RunContext[SupportDependencies]) -> str:
    customer_name = await ctx.deps.db.customer_name(id=ctx.deps.customer_id)
    return f"The customer's name is {customer_name!r}"
...
[](https://ai.pydantic.dev/#__code_3_annotation_6)
async def customer_balance(
    ctx: RunContext[SupportDependencies], include_pending: bool
) -> float:
    """Returns the customer's current account balance."""

[](https://ai.pydantic.dev/#__code_3_annotation_7)
    return await ctx.deps.db.customer_balance(
        id=ctx.deps.customer_id,
        include_pending=include_pending,
    )
...
[](https://ai.pydantic.dev/#__code_3_annotation_11)
...
[](https://ai.pydantic.dev/#__code_3_annotation_8)
    print(result.output)

[](https://ai.pydantic.dev/#__code_3_annotation_10)
    """
    support_advice='Hello John, your current account balance, including pending transactions, is $123.45.' block_card=False risk=1
    """
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/#__tabbed_3_1)[Directly to Provider API](https://ai.pydantic.dev/#__tabbed_3_2)
...
logfire.configure()  [](https://ai.pydantic.dev/#__code_4_annotation_1)
logfire.instrument_pydantic_ai()  [](https://ai.pydantic.dev/#__code_4_annotation_2)
logfire.instrument_sqlite3()  [](https://ai.pydantic.dev/#__code_4_annotation_3)
...
[](https://ai.pydantic.dev/#__code_5_annotation_1)
logfire.instrument_pydantic_ai()

[](https://ai.pydantic.dev/#__code_5_annotation_2)
logfire.instrument_sqlite3()

[](https://ai.pydantic.dev/#__code_5_annotation_3)
...
```
  ...
  3. In our demo, `DatabaseConn` uses [`logfire.instrument_sqlite3()`](https://logfire.pydantic.dev/docs/integrations/databases/sqlite3/) is used to log the database queries.
...
[Docs](https://logfire.pydantic.dev/docs/)[](https://logfire.pydantic.dev/docs/join-slack/)
...
Two formats are available:
  * [`llms.txt`](https://ai.pydantic.dev/llms.txt): a file containing a brief description of the project, along with links to the different sections of the documentation. The structure of this file is described in details
...
Join [Slack](https://logfire.pydantic.dev/docs/join-slack/) or file an issue on
