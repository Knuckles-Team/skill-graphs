[ Skip to content ](https://ai.pydantic.dev/models/cerebras/#cerebras)
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * Documentation
    ...
    * Models & Providers
      ...
      * Cerebras  [ Cerebras  ](https://ai.pydantic.dev/models/cerebras/)
        * [ Install  ](https://ai.pydantic.dev/models/cerebras/#install)
        * [ Configuration  ](https://ai.pydantic.dev/models/cerebras/#configuration)
        * [ Environment variable  ](https://ai.pydantic.dev/models/cerebras/#environment-variable)
        * [ provider argument  ](https://ai.pydantic.dev/models/cerebras/#provider-argument)
...
[pip](https://ai.pydantic.dev/models/cerebras/#__tabbed_1_1)[uv](https://ai.pydantic.dev/models/cerebras/#__tabbed_1_2)
```
