  ...
  * Documentation
    ...
    * Models & Providers
      ...
      * Bedrock  [ Bedrock  ](https://ai.pydantic.dev/models/bedrock/)
        ...
        * [ Prompt Caching  ](https://ai.pydantic.dev/models/bedrock/#prompt-caching)
          * [ Example 1: Automatic Message Caching  ](https://ai.pydantic.dev/models/bedrock/#example-1-automatic-message-caching)
          * [ Example 2: Comprehensive Caching Strategy  ](https://ai.pydantic.dev/models/bedrock/#example-2-comprehensive-caching-strategy)
          * [ Example 3: Fine-Grained Control with CachePoint  ](https://ai.pydantic.dev/models/bedrock/#example-3-fine-grained-control-with-cachepoint)
          * [ Accessing Cache Usage Statistics  ](https://ai.pydantic.dev/models/bedrock/#accessing-cache-usage-statistics)
          * [ Cache Point Limits  ](https://ai.pydantic.dev/models/bedrock/#cache-point-limits)
            * [ How Cache Points Are Allocated  ](https://ai.pydantic.dev/models/bedrock/#how-cache-points-are-allocated)
            * [ Automatic Cache Point Limiting  ](https://ai.pydantic.dev/models/bedrock/#automatic-cache-point-limiting)
        * [ provider argument  ](https://ai.pydantic.dev/models/bedrock/#provider-argument)
        * [ Using AWS Application Inference Profiles  ](https://ai.pydantic.dev/models/bedrock/#using-aws-application-inference-profiles)
        * [ Configuring Retries  ](https://ai.pydantic.dev/models/bedrock/#configuring-retries)
          * [ Retry Modes  ](https://ai.pydantic.dev/models/bedrock/#retry-modes)
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/models/bedrock/#__tabbed_2_1)[Directly to Provider API](https://ai.pydantic.dev/models/bedrock/#__tabbed_2_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway)```
from pydantic_ai import Agent

agent = Agent('gateway/bedrock:anthropic.claude-sonnet-4-5-20250929-v1:0')
...
...
You can customize the Bedrock Runtime API calls by adding additional parameters, such as [`BedrockModelSettings`](https://ai.pydantic.dev/api/models/bedrock/#pydantic_ai.models.bedrock.BedrockModelSettings "BedrockModelSettings").
...
## Prompt Caching
Bedrock supports
  1. **Cache User Messages with[`CachePoint`](https://ai.pydantic.dev/api/messages/#pydantic_ai.messages.CachePoint "CachePoint



      dataclass
  ")** : Insert a `CachePoint` marker to cache everything before it in the current user message.
  2. **Cache System Instructions** : Enable [`BedrockModelSettings.bedrock_cache_instructions`](https://ai.pydantic.dev/api/models/bedrock/#pydantic_ai.models.bedrock.BedrockModelSettings.bedrock_cache_instructions "bedrock_cache_instructions



      instance-attribute
  ") to append a cache point after the system prompt.
  3. **Cache Tool Definitions** : Enable [`BedrockModelSettings.bedrock_cache_tool_definitions`](https://ai.pydantic.dev/api/models/bedrock/#pydantic_ai.models.bedrock.BedrockModelSettings.bedrock_cache_tool_definitions "bedrock_cache_tool_definitions



      instance-attribute
  ") to cache your tool schemas.
  4. **Cache All Messages** : Set [`BedrockModelSettings.bedrock_cache_messages`](https://ai.pydantic.dev/api/models/bedrock/#pydantic_ai.models.bedrock.BedrockModelSettings.bedrock_cache_messages "bedrock_cache_messages
...
AWS only serves cached content once a segment crosses the provider-specific minimum token thresholds (see the
### Example 1: Automatic Message Caching
Use `bedrock_cache_messages` to automatically cache the last user message:
[With Pydantic AI Gateway](https://ai.pydantic.dev/models/bedrock/#__tabbed_3_1)[Directly to Provider API](https://ai.pydantic.dev/models/bedrock/#__tabbed_3_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway)```
from pydantic_ai import Agent
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/models/bedrock/#__tabbed_4_1)[Directly to Provider API](https://ai.pydantic.dev/models/bedrock/#__tabbed_4_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway)```
...
Access cache usage statistics via [`RequestUsage`](https://ai.pydantic.dev/api/usage/#pydantic_ai.usage.RequestUsage "RequestUsage



      dataclass
  "):
[With Pydantic AI Gateway](https://ai.pydantic.dev/models/bedrock/#__tabbed_5_1)[Directly to Provider API](https://ai.pydantic.dev/models/bedrock/#__tabbed_5_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway)```
from pydantic_ai import Agent, CachePoint
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/models/bedrock/#__tabbed_6_1)[Directly to Provider API](https://ai.pydantic.dev/models/bedrock/#__tabbed_6_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway)```
from pydantic_ai import Agent, CachePoint
from pydantic_ai.models.bedrock import BedrockModelSettings
...
AWS Bedrock supports [model profile](https://ai.pydantic.dev/models/overview/#models-and-providers) to ensure Pydantic AI can correctly identify model capabilities (streaming, tool use, caching, etc.) while still using the custom inference profile for cost tracking.
Without explicit configuration, an inference profile ARN like `arn:aws:bedrock:us-east-2:*****:application-inference-profile/****` doesn't contain enough information for Pydantic AI to determine the underlying model. You can work around this by:
  1. Passing the inference profile ARN as the model name to [`BedrockConverseModel`](https://ai.pydantic.dev/api/models/bedrock/#pydantic_ai.models.bedrock.BedrockConverseModel "BedrockConverseModel
...
For more details on boto3 retry configuration, see the
Note
