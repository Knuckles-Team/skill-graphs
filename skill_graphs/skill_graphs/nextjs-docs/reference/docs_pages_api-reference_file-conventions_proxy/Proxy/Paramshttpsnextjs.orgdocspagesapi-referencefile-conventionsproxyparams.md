...
> **Good to know** :
>   * `NextRequest` is a type that represents incoming HTTP requests in Next.js Proxy, whereas [`NextResponse`](https://nextjs.org/docs/pages/api-reference/file-conventions/proxy#nextresponse) is a class used to manipulate and send back HTTP responses.
>
