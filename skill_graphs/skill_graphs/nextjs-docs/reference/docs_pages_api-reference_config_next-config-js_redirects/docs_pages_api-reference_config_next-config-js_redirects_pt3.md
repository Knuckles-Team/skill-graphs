...
On this page
  ...
  * [Other Redirects](https://nextjs.org/docs/pages/api-reference/config/next-config-js/redirects#other-redirects)
  * [Version History](https://nextjs.org/docs/pages/api-reference/config/next-config-js/redirects#version-history)


Scroll to top
[Configuration](https://nextjs.org/docs/pages/api-reference/config)[next.config.js Options](https://nextjs.org/docs/pages/api-reference/config/next-config-js)redirects
Copy page
