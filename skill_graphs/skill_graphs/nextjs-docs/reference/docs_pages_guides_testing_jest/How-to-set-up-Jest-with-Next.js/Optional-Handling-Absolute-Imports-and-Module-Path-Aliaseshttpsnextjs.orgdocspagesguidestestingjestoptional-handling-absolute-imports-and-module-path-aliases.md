## Optional: Handling Absolute Imports and Module Path Aliases[](https://nextjs.org/docs/pages/guides/testing/jest#optional-handling-absolute-imports-and-module-path-aliases)
