...
`app/shop/[...slug]/page.js` | `/shop/1/2` | `{ slug: ['1', '2'] }`
    * `searchParams` - An object containing the current URL's
URL | `searchParams`
---|---
`/shop?a=1` | `{ a: '1' }`
...
You can connect a Facebook app or Facebook account to your webpage for certain Facebook Social Plugins
...
While the Metadata API doesn't directly support these hints, you can use new `<head>` of the document.
