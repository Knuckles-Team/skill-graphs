...
On this page
  ...
  * [CSS Modules](https://nextjs.org/docs/pages/guides/post-css#css-modules)
  * [Customizing Plugins](https://nextjs.org/docs/pages/guides/post-css#customizing-plugins)


Scroll to top
[Pages Router](https://nextjs.org/docs/pages)[Guides](https://nextjs.org/docs/pages/guides)PostCSS
Copy page
