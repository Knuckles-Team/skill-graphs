...
On this page
  ...
  * [Version History](https://nextjs.org/docs/pages/guides/content-security-policy#version-history)


Scroll to top
[Pages Router](https://nextjs.org/docs/pages)[Guides](https://nextjs.org/docs/pages/guides)Content Security Policy
Copy page
