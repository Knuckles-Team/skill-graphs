...
On this page
  ...
  * [Version History](https://nextjs.org/docs/pages/api-reference/config/next-config-js/turbopack#version-history)


Scroll to top
[Configuration](https://nextjs.org/docs/pages/api-reference/config)[next.config.js Options](https://nextjs.org/docs/pages/api-reference/config/next-config-js)turbopack
Copy page
