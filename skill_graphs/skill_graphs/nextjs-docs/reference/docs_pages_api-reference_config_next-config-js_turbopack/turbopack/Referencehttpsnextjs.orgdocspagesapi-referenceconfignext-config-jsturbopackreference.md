## Reference[](https://nextjs.org/docs/pages/api-reference/config/next-config-js/turbopack#reference)
### Options[](https://nextjs.org/docs/pages/api-reference/config/next-config-js/turbopack#options)
...
### Supported loaders[](https://nextjs.org/docs/pages/api-reference/config/next-config-js/turbopack#supported-loaders)
...
#### Missing Webpack loader features[](https://nextjs.org/docs/pages/api-reference/config/next-config-js/turbopack#missing-webpack-loader-features)
Turbopack uses the
**Module loading:**
