## API Reference[](https://nextjs.org/docs/pages/api-reference/config/next-config-js/adapterPath#api-reference)
###  `modifyConfig(config, context)`[](https://nextjs.org/docs/pages/api-reference/config/next-config-js/adapterPath#modifyconfigconfig-context)
...
###  `onBuildComplete(context)`[](https://nextjs.org/docs/pages/api-reference/config/next-config-js/adapterPath#onbuildcompletecontext)
