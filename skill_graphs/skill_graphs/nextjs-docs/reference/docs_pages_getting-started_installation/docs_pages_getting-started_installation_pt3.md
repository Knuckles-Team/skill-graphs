...
On this page
  * [System requirements](https://nextjs.org/docs/pages/getting-started/installation#system-requirements)
  ...
  * [Run the development server](https://nextjs.org/docs/pages/getting-started/installation#run-the-development-server)
  * [Set up TypeScript](https://nextjs.org/docs/pages/getting-started/installation#set-up-typescript)
...
Scroll to top
[Pages Router](https://nextjs.org/docs/pages)[Getting Started](https://nextjs.org/docs/pages/getting-started)Installation
Copy page
