...
`v10.2.1` |  `tsconfig.json`.
[PreviouswebVitalsAttribution](https://nextjs.org/docs/app/api-reference/config/next-config-js/webVitalsAttribution)[NextESLint](https://nextjs.org/docs/app/api-reference/config/eslint)
Was this helpful?
Send
* * *
* * *
