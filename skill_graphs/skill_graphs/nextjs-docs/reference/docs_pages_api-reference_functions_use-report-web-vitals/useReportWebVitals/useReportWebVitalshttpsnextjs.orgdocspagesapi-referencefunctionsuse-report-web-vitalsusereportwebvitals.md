...
The `metric` object passed as the hook's argument consists of a number of properties:
  ...
  * `name`: The name of the performance metric. Possible values include names of [Web Vitals](https://nextjs.org/docs/pages/api-reference/functions/use-report-web-vitals#web-vitals) metrics (TTFB, FCP, LCP, FID, CLS) specific to a web application.
