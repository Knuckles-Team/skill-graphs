...
`12.0.0` to `12.22.0` which is the first version of Node.js with native ES Modules support.
`17.0.2`. To upgrade you can run the following command in the terminal:
Terminal
```
...
In order to prioritize transforms that will help you adopt SWC, please provide your `.babelrc` on
