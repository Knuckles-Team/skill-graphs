...
On this page
  ...
  * [Sharing code](https://nextjs.org/docs/pages/guides/multi-zones#sharing-code)


Scroll to top
[Pages Router](https://nextjs.org/docs/pages)[Guides](https://nextjs.org/docs/pages/guides)Multi-Zones
Copy page
