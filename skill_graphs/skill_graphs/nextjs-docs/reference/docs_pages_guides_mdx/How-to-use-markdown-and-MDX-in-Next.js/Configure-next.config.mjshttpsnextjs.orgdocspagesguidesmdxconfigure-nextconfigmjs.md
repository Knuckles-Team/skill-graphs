## Configure `next.config.mjs`[](https://nextjs.org/docs/pages/guides/mdx#configure-nextconfigmjs)
...
### Handling `.md` files[](https://nextjs.org/docs/pages/guides/mdx#handling-md-files)
