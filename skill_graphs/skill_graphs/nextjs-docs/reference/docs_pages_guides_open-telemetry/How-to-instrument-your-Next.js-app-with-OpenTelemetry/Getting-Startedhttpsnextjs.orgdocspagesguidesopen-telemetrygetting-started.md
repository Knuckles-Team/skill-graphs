## Getting Started[](https://nextjs.org/docs/pages/guides/open-telemetry#getting-started)
...
### Using `@vercel/otel`[](https://nextjs.org/docs/pages/guides/open-telemetry#using-vercelotel)
...
### Manual OpenTelemetry configuration[](https://nextjs.org/docs/pages/guides/open-telemetry#manual-opentelemetry-configuration)
