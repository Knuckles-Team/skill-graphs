## Exports[](https://nextjs.org/docs/pages/api-reference/file-conventions/instrumentation#exports)
###  `register` (optional)[](https://nextjs.org/docs/pages/api-reference/file-conventions/instrumentation#register-optional)
...
###  `onRequestError` (optional)[](https://nextjs.org/docs/pages/api-reference/file-conventions/instrumentation#onrequesterror-optional)
...
#### Parameters[](https://nextjs.org/docs/pages/api-reference/file-conventions/instrumentation#parameters)
...
### Specifying the runtime[](https://nextjs.org/docs/pages/api-reference/file-conventions/instrumentation#specifying-the-runtime)
