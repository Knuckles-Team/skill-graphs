## Using App Router together with Pages Router[](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#using-app-router-together-with-pages-router)
