...
### Cleaning the `distDir` is now a default[](https://nextjs.org/docs/pages/guides/upgrading/version-11#cleaning-the-distdir-is-now-a-default)
The build output directory (defaults to `.next`) is now cleared by default except for the Next.js caches. You can refer to
...
###  `PORT` is now supported for `next dev` and `next start`[](https://nextjs.org/docs/pages/guides/upgrading/version-11#port-is-now-supported-for-next-dev-and-next-start)
...
###  `next.config.js` customization to import images[](https://nextjs.org/docs/pages/guides/upgrading/version-11#nextconfigjs-customization-to-import-images)
...
### Remove `super.componentDidCatch()` from `pages/_app.js`[](https://nextjs.org/docs/pages/guides/upgrading/version-11#remove-supercomponentdidcatch-from-pages_appjs)
...
### Remove `Container` from `pages/_app.js`[](https://nextjs.org/docs/pages/guides/upgrading/version-11#remove-container-from-pages_appjs)
...
### Remove `props.url` usage from page components[](https://nextjs.org/docs/pages/guides/upgrading/version-11#remove-propsurl-usage-from-page-components)
...
### Remove `unsized` property on `next/image`[](https://nextjs.org/docs/pages/guides/upgrading/version-11#remove-unsized-property-on-nextimage)
...
### Remove `modules` property on `next/dynamic`[](https://nextjs.org/docs/pages/guides/upgrading/version-11#remove-modules-property-on-nextdynamic)
...
### Remove `Head.rewind`[](https://nextjs.org/docs/pages/guides/upgrading/version-11#remove-headrewind)
...
### Moment.js locales excluded by default[](https://nextjs.org/docs/pages/guides/upgrading/version-11#momentjs-locales-excluded-by-default)
...
### Update usage of `router.events`[](https://nextjs.org/docs/pages/guides/upgrading/version-11#update-usage-of-routerevents)
