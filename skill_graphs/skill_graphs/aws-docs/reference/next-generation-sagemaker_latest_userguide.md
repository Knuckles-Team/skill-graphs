...
Dismiss
[Skip to main content](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html#skip-link)
[English](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html "Language Selector. Currently set to: English")
[Preferences ](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html)
[Contact Us](https://aws.amazon.com/contact-us/?cmpid=docs_headercta_contactus)
[Feedback](https://docs.aws.amazon.com/feedback/doc-feedback.html?hidden_service_name=SageMaker&topic_url=https%3A%2F%2Fdocs.aws.amazon.com%2Fnext-generation-sagemaker%2Flatest%2Fuserguide%2Fgetting-started-sagemaker-gdc-s3.html)
[![AWS Documentation](https://docs.aws.amazon.com/assets/r/images/aws_logo_light.svg)](https://docs.aws.amazon.com)
[Get started](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html)
[Service guides](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html)
[Developer tools](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html)
[AI resources](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html)
...
### User Guide
  ...
  * [Prerequisites](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/prerequisites.html)
  * [Setting up Amazon SageMaker](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/setting-up.html)
  * [Get started uploading and querying data](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/upload-query.html)
  * [Get started importing and querying Glue Data Catalog and S3 data](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html)
  * [Get started using EMR Serverless](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/emr-serverless.html)
  * [Get started using Amazon Bedrock](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-use-amazon-bedrock-ide.html)
  * [Get started with Amazon S3 Tables](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/s3-tables-integration.html)
  * [Get started using lakehouse access controls](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/lakehouse-athena-federated-queries.html)
  * [Get started fine-tuning models](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-training.html)
  * [API Documentation for Amazon SageMaker](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/api-docs.html)
  * [Document history](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/doc-history.html)


  1. [Documentation](https://docs.aws.amazon.com/index.html)
  2. ...
  3. [Amazon Sagemaker](https://docs.aws.amazon.com/next-generation-sagemaker/index.html)
  4. User Guide


  1. [Documentation](https://docs.aws.amazon.com/index.html)
  2. [Amazon Sagemaker](https://docs.aws.amazon.com/next-generation-sagemaker/index.html)
  3. User Guide
...
[](https://docs.aws.amazon.com/pdfs/next-generation-sagemaker/latest/userguide/next-generation-sagemaker-ug.pdf#getting-started-sagemaker-gdc-s3)
[](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/next-generation-sagemaker-ug.rss)
Focus mode
Get started with importing and querying data sets for AWS Glue Data Catalog and Amazon S3 in Amazon SageMaker Unified Studio - Amazon SageMaker
[](https://docs.aws.amazon.com/pdfs/next-generation-sagemaker/latest/userguide/next-generation-sagemaker-ug.pdf#getting-started-sagemaker-gdc-s3 "Open PDF")
[Documentation](https://docs.aws.amazon.com/index.html)[Amazon Sagemaker](https://docs.aws.amazon.com/next-generation-sagemaker/index.html)[User Guide](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/what-is-sagemaker.html)
[Prerequisites](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html#gdc-s3-glue-prerequisites)[Step 1: Connect to an AWS Glue Data Catalog](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html#w2aac19c17)[Step 2: Get started with importing S3 data](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html#gdc-s3-gdc-bucket)[Step 3: Get started with the query editor](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html#gdc-s3-query-editor)
...
###### Topics
  * [Prerequisites](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html#gdc-s3-glue-prerequisites)
  * [Step 1: Connect to an AWS Glue Data Catalog](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html#w2aac19c17)
  * [Step 2: Get started with importing S3 data](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html#gdc-s3-gdc-bucket)
  * [Step 3: Get started with the query editor](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html#gdc-s3-query-editor)


## Prerequisites
The following prerequisites are required for this getting started procedure.
  * Create a project with an **All capabilities** project profile. This project profile sets up your project with access to S3 and Athena resources. There is more information about how to create a new project in the topic [Setting up Amazon SageMaker AI](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/setting-up.html#create-new-project).
  * A project role is created automatically when the project is created in SageMaker Unified Studio. You will make a note of the project role as detailed in the prerequisites below.
...
You must set up a user or role as the Lake Formation Data Lake administrator for your catalog data. This administrator grants access to data-lake resources.
  1. In [Create a data lake administrator](https://docs.aws.amazon.com/lake-formation/latest/dg/initial-lf-config.html#create-data-lake-admin) in the _AWS Lake Formation Developer Guide_ , follow the instructions to add the `AWSLakeFormationDataAdmin[](https://docs.aws.amazon.com/aws-managed-policy/latest/reference/AWSLakeFormationDataAdmin.html)` managed policy to the user in IAM.
  2. After you add the IAM permission, follow the steps in [Create a data lake administrator](https://docs.aws.amazon.com/lake-formation/latest/dg/initial-lf-config.html#create-data-lake-admin) to add the inline policy granting permission to create the service-linked role.
...
In the following sections of this topic, you will configure permissions using the project role in IAM that was created when you created your SageMaker Unified Studio project. The project role is an IAM role that is created and associated with a new project. This role grants the necessary permissions for users working on the project to use AWS resources, such as Amazon S3, for instance. You will attach a resource-based bucket policy and configure permissions in the lakehouse. Use the following steps to make a note of the IAM project role for your SageMaker Unified Studio project. You will use the role in a procedure that follows when you configure and grant Lake Formation permissions.
  1. Navigate to Amazon SageMaker Uniﬁed Studio using the URL from the Amazon SageMaker management console and log in using your SSO or AWS credentials.
...
![Image showing the project role ARN in the project details](https://docs.aws.amazon.com/images/next-generation-sagemaker/latest/userguide/images/gs-project-role.png)
...
###### To register the S3 location and configure access
  ...
  2. Enter the S3 prefix for Amazon S3 path. For this topic, you must register the following S3 location in order to allow it to be queried: `s3://aws-bigdata-blog/generated_synthetic_reviews/data/product_category=Video_Games`.
...
You will grant database access to the IAM role that is associated with your Amazon SageMaker Unified Studio project. This role is called the project role, and it was created in IAM upon project creation. To access existing AWS Glue Data Catalog databases in Amazon SageMaker Unified Studio, complete the following steps to configure permissions.
  ...
  4. For **IAM users and roles** , choose the **project role**. This is the SageMaker Unified Studio project role that you noted previously in [Make a note of your IAM project role](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html#gdc-s3-gdc-bucket-projectrole).
...
###### To add data and create a Glue table
  1. Access the public S3 bucket to download the sample data. Download the .parquet file named `97dbfb1466264fd993c8cf29ee3b2881_1.snappy.parquet` to your local drive.
...
![Image showing the Upload file screen for adding to Lakehouse data from the S3/external table type](https://docs.aws.amazon.com/images/next-generation-sagemaker/latest/userguide/images/gs-lakehouse-add-data.png)
...
![Image showing the new table titled myreviewtable added to the Lakehouse data](https://docs.aws.amazon.com/images/next-generation-sagemaker/latest/userguide/images/gs-lakehouse-review-table.png)
...
###### To attach the S3 bucket policy to the project role
  ...
  2. Choose the project role that is associated with your Amazon SageMaker Unified Studio project. This role was created automatically when you created your project in Amazon SageMaker Unified Studio. This is the project role that you made a note of previously in [Make a note of your IAM project role](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html#gdc-s3-gdc-bucket-projectrole). Open the project role, such as `arn:aws:iam::ACCOUNT_ID:role/<datazone_usr_role_xxxxxxxxxxxxxx_yyyyyyyyyyyyyy>`.
...
```
  ...
  11. Use the following command in a cell to query the S3 source with the %%pyspark cell magic. This queries the data.
```
...
![Image showing the S3 bucket load and query in Jupyter notebooks](https://docs.aws.amazon.com/images/next-generation-sagemaker/latest/userguide/images/gs-lakehouse-jupyter-spark.png)
...
Before you get started with the query editor, you must have access to Amazon SageMaker Unified Studio and create a project.
  * Navigate to Amazon SageMaker Unified Studio using the URL from your admin and log in using your SSO or [configure credentials with IAM Identity Center](https://docs.aws.amazon.com/sagemaker-unified-studio/latest/userguide/getting-started-access-the-portal.html#getting-started-sign-up).
...
After you create a project, you can use the query editor to write and run queries. Use the following steps to create a table using a SQL query with Athena, query the table, and visualize the results.
  ...
  5. Copy and paste the following SQL query into the editor. The following query will create a table `synthetic_reviews_video_games` and query it.
```
...
The SQL query creates an external table named "synthetic_reviews_video_games" that maps to Amazon product review data stored in Parquet format. The table defines columns for marketplace, customer information, product details, ratings, and review content.
  6. Choose the **Run cell** icon.
When the query finishes running, a Result tab appears below the cell to display the outcome.
![Image showing the query editor running an Athena query on the AWS Glue data](https://docs.aws.amazon.com/images/next-generation-sagemaker/latest/userguide/images/gs-lakehouse-athena-create.png)
...
![Image showing query results in a table format](https://docs.aws.amazon.com/images/next-generation-sagemaker/latest/userguide/images/gs-lakehouse-athena-reviewresult.png)
...
In the **Results** tab, the first ten rows of the table you created are displayed.
  ...
  11. Set up the chart to display a pie chart. Choose **Trace**.
    ...
    2. For **Values** , choose **avg_rating**.
    3. For **Labels** , choose **product_title**.
    4. Choose the download arrow to view the chart.
This displays a pie chart so you can visualize results.
![Image showing pie chart display for the data](https://docs.aws.amazon.com/images/next-generation-sagemaker/latest/userguide/images/gs-lakehouse-athena-visual.png)
...
Get started uploading and querying data
Get started using EMR Serverless
...
If you've got a moment, please tell us how we can make the documentation better.
  * ### On this page
    1. [Prerequisites](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html#gdc-s3-glue-prerequisites)
    2. [Step 1: Connect to an AWS Glue Data Catalog](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html#w2aac19c17)
    3. [Step 2: Get started with importing S3 data](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html#gdc-s3-gdc-bucket)
    4. [Step 3: Get started with the query editor](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html#gdc-s3-query-editor)
  * ### Did this page help you?
Yes
No
[Provide feedback](https://docs.aws.amazon.com/feedback/doc-feedback.html?hidden_service_name=SageMaker&topic_url=https%3A%2F%2Fdocs.aws.amazon.com%2Fnext-generation-sagemaker%2Flatest%2Fuserguide%2Fgetting-started-sagemaker-gdc-s3.html)
...
[Cookie preferences](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html)
...
**conversational-experience-worker.widget.console.aws.amazon.com** refused to connect.
![](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html) ![](https://docs.aws.amazon.com/next-generation-sagemaker/latest/userguide/getting-started-sagemaker-gdc-s3.html)
## Image showing the new table titled myreviewtable added to the Lakehouse data
![Image showing the new table titled myreviewtable added to the Lakehouse data](https://docs.aws.amazon.com/images/next-generation-sagemaker/latest/userguide/images/gs-lakehouse-review-table.png)
Close
## Image showing the project role ARN in the project details
![Image showing the project role ARN in the project details](https://docs.aws.amazon.com/images/next-generation-sagemaker/latest/userguide/images/gs-project-role.png)
Close
## Image showing the Upload file screen for adding to Lakehouse data from the S3/external table type
![Image showing the Upload file screen for adding to Lakehouse data from the S3/external table type](https://docs.aws.amazon.com/images/next-generation-sagemaker/latest/userguide/images/gs-lakehouse-add-data.png)
Close
## Image showing the S3 bucket load and query in Jupyter notebooks
![Image showing the S3 bucket load and query in Jupyter notebooks](https://docs.aws.amazon.com/images/next-generation-sagemaker/latest/userguide/images/gs-lakehouse-jupyter-spark.png)
Close
## Image showing the query editor running an Athena query on the AWS Glue data
![Image showing the query editor running an Athena query on the AWS Glue data](https://docs.aws.amazon.com/images/next-generation-sagemaker/latest/userguide/images/gs-lakehouse-athena-create.png)
Close
## Image showing query results in a table format
![Image showing query results in a table format](https://docs.aws.amazon.com/images/next-generation-sagemaker/latest/userguide/images/gs-lakehouse-athena-reviewresult.png)
Close
## Image showing pie chart display for the data
![Image showing pie chart display for the data](https://docs.aws.amazon.com/images/next-generation-sagemaker/latest/userguide/images/gs-lakehouse-athena-visual.png)
Close
