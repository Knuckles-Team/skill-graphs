...
Dismiss
[Skip to main content](https://docs.aws.amazon.com/vsts/?icmpid=docs_homepage_sdktoolkits#skip-link)
[English](https://docs.aws.amazon.com/vsts/?icmpid=docs_homepage_sdktoolkits "Language Selector. Currently set to: English")
[Preferences ](https://docs.aws.amazon.com/vsts/?icmpid=docs_homepage_sdktoolkits)
[Contact Us](https://aws.amazon.com/contact-us/?cmpid=docs_headercta_contactus)
[Feedback](https://docs.aws.amazon.com/feedback/doc-feedback.html?hidden_service_name=Landing+Pages&topic_url=https%3A%2F%2Fdocs.aws.amazon.com%2Fvsts%2F%3Ficmpid%3Ddocs_homepage_sdktoolkits)
[![AWS Documentation](https://docs.aws.amazon.com/assets/r/images/aws_logo_light.svg)](https://docs.aws.amazon.com)
[Get started](https://docs.aws.amazon.com/vsts/?icmpid=docs_homepage_sdktoolkits)
[Service guides](https://docs.aws.amazon.com/vsts/?icmpid=docs_homepage_sdktoolkits)
[Developer tools](https://docs.aws.amazon.com/vsts/?icmpid=docs_homepage_sdktoolkits)
[AI resources](https://docs.aws.amazon.com/vsts/?icmpid=docs_homepage_sdktoolkits)
...
The AWS Toolkit for Azure DevOps contains tasks you can use in build and release definitions in Azure DevOps to interact with AWS services. The AWS Toolkit for Azure DevOps is available through the Visual Studio Marketplace.
  1. ### [User Guide](https://docs.aws.amazon.com/vsts/latest/userguide/index.html)
Describes the various features of the AWS Toolkit for Azure DevOps and how to use them.
     * [HTML](https://docs.aws.amazon.com/vsts/latest/userguide/index.html)
     * [PDF](https://docs.aws.amazon.com/vsts/latest/userguide/vsts-ug.pdf)
...
[Cookie preferences](https://docs.aws.amazon.com/vsts/?icmpid=docs_homepage_sdktoolkits)
