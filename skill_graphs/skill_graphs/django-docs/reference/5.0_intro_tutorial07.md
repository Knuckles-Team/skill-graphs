...
[Skip to main content](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#main-content)
...
[Documentation](https://docs.djangoproject.com/en/5.0/)
  ...
  * Language: **en**
  * [zh-hans](https://docs.djangoproject.com/zh-hans/5.0/intro/tutorial07/)
  * [pt-br](https://docs.djangoproject.com/pt-br/5.0/intro/tutorial07/)
  * [pl](https://docs.djangoproject.com/pl/5.0/intro/tutorial07/)
  * [ko](https://docs.djangoproject.com/ko/5.0/intro/tutorial07/)
  * [ja](https://docs.djangoproject.com/ja/5.0/intro/tutorial07/)
  * [it](https://docs.djangoproject.com/it/5.0/intro/tutorial07/)
  * [id](https://docs.djangoproject.com/id/5.0/intro/tutorial07/)
  * [fr](https://docs.djangoproject.com/fr/5.0/intro/tutorial07/)
  * [es](https://docs.djangoproject.com/es/5.0/intro/tutorial07/)
  * [el](https://docs.djangoproject.com/el/5.0/intro/tutorial07/)


  * Documentation version: **5.0**
  * [dev](https://docs.djangoproject.com/en/dev/intro/tutorial07/)
  * [6.0](https://docs.djangoproject.com/en/6.0/intro/tutorial07/)
  * [5.2](https://docs.djangoproject.com/en/5.2/intro/tutorial07/)
  * [5.1](https://docs.djangoproject.com/en/5.1/intro/tutorial07/)
  * [4.2](https://docs.djangoproject.com/en/4.2/intro/tutorial07/)
  * [4.1](https://docs.djangoproject.com/en/4.1/intro/tutorial07/)
  * [4.0](https://docs.djangoproject.com/en/4.0/intro/tutorial07/)
  * [3.2](https://docs.djangoproject.com/en/3.2/intro/tutorial07/)
  * [3.1](https://docs.djangoproject.com/en/3.1/intro/tutorial07/)
  * [3.0](https://docs.djangoproject.com/en/3.0/intro/tutorial07/)
  * [2.2](https://docs.djangoproject.com/en/2.2/intro/tutorial07/)
  * [2.1](https://docs.djangoproject.com/en/2.1/intro/tutorial07/)
  * [2.0](https://docs.djangoproject.com/en/2.0/intro/tutorial07/)
  * [1.11](https://docs.djangoproject.com/en/1.11/intro/tutorial07/)
  * [1.10](https://docs.djangoproject.com/en/1.10/intro/tutorial07/)


  * [](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#top)


# Writing your first Django app, part 7[¶](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#writing-your-first-django-app-part-7 "Link to this heading")
This tutorial begins where [Tutorial 6](https://docs.djangoproject.com/en/5.0/intro/tutorial06/) left off. We’re continuing the web-poll application and will focus on customizing Django’s automatically-generated admin site that we first explored in [Tutorial 2](https://docs.djangoproject.com/en/5.0/intro/tutorial02/).
Where to get help:
...
## Customize the admin form[¶](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#customize-the-admin-form "Link to this heading")
...
`polls/admin.py`[¶](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#id1 "Link to this code")
```
...
![Fields have been reordered](https://docs.djangoproject.com/en/5.0/_images/admin07.png)
This isn’t impressive with only two fields, but for admin forms with dozens of fields, choosing an intuitive order is an important usability detail.
And speaking of forms with dozens of fields, you might want to split the form up into fieldsets:
`polls/admin.py`[¶](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#id2 "Link to this code")
```
from django.contrib import admin
...
The first element of each tuple in [`fieldsets`](https://docs.djangoproject.com/en/5.0/ref/contrib/admin/#django.contrib.admin.ModelAdmin.fieldsets "django.contrib.admin.ModelAdmin.fieldsets") is the title of the fieldset. Here’s what our form looks like now:
![Form has fieldsets now](https://docs.djangoproject.com/en/5.0/_images/admin08t.png)
## Adding related objects[¶](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#adding-related-objects "Link to this heading")
...
`polls/admin.py`[¶](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#id3 "Link to this code")
```
from django.contrib import admin
...
![Choice admin page](https://docs.djangoproject.com/en/5.0/_images/admin09.png)
In that form, the “Question” field is a select box containing every question in the database. Django knows that a [`ForeignKey`](https://docs.djangoproject.com/en/5.0/ref/models/fields/#django.db.models.ForeignKey "django.db.models.ForeignKey") should be represented in the admin as a `<select>` box. In our case, only one question exists at this point.
...
`polls/admin.py`[¶](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#id4 "Link to this code")
```
from django.contrib import admin
...
![Add question page now has choices on it](https://docs.djangoproject.com/en/5.0/_images/admin10t.png)
...
![Additional slot added dynamically](https://docs.djangoproject.com/en/5.0/_images/admin14t.png)
...
`polls/admin.py`[¶](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#id5 "Link to this code")
```
...
![Add question page now has more compact choices](https://docs.djangoproject.com/en/5.0/_images/admin11t.png)
...
## Customize the admin change list[¶](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#customize-the-admin-change-list "Link to this heading")
...
`polls/admin.py`[¶](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#id6 "Link to this code")
```
class QuestionAdmin(admin.ModelAdmin):
    # ...
...
For good measure, let’s also include the `was_published_recently()` method from [Tutorial 2](https://docs.djangoproject.com/en/5.0/intro/tutorial02/):
`polls/admin.py`[¶](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#id7 "Link to this code")
```
class QuestionAdmin(admin.ModelAdmin):
    # ...
...
![Polls change list page, updated](https://docs.djangoproject.com/en/5.0/_images/admin12t.png)
...
You can improve that by using the [`display()`](https://docs.djangoproject.com/en/5.0/ref/contrib/admin/#django.contrib.admin.display "django.contrib.admin.display") decorator on that method (in `polls/models.py`), as follows:
`polls/models.py`[¶](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#id8 "Link to this code")
```
from django.contrib import admin
...
For more information on the properties configurable via the decorator, see [`list_display`](https://docs.djangoproject.com/en/5.0/ref/contrib/admin/#django.contrib.admin.ModelAdmin.list_display "django.contrib.admin.ModelAdmin.list_display").
...
![Polls change list page, updated](https://docs.djangoproject.com/en/5.0/_images/admin13t.png)
The type of filter displayed depends on the type of field you’re filtering on. Because `pub_date` is a [`DateTimeField`](https://docs.djangoproject.com/en/5.0/ref/models/fields/#django.db.models.DateTimeField "django.db.models.DateTimeField"), Django knows to give appropriate filter options: “Any date”, “Today”, “Past 7 days”, “This month”, “This year”.
...
## Customize the admin look and feel[¶](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#customize-the-admin-look-and-feel "Link to this heading")
...
### Customizing your _project’s_ templates[¶](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#customizing-your-project-s-templates "Link to this heading")
...
Open your settings file (`mysite/settings.py`, remember) and add a [`DIRS`](https://docs.djangoproject.com/en/5.0/ref/settings/#std-setting-TEMPLATES-DIRS) option in the [`TEMPLATES`](https://docs.djangoproject.com/en/5.0/ref/settings/#std-setting-TEMPLATES) setting:
`mysite/settings.py`[¶](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#id9 "Link to this code")
```
TEMPLATES = [
    {
...
### Customizing your _application’s_ templates[¶](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#customizing-your-application-s-templates "Link to this heading")
Astute readers will ask: But if [`DIRS`](https://docs.djangoproject.com/en/5.0/ref/settings/#std-setting-TEMPLATES-DIRS) was empty by default, how was Django finding the default admin templates? The answer is that, since [`APP_DIRS`](https://docs.djangoproject.com/en/5.0/ref/settings/#std-setting-TEMPLATES-APP_DIRS) is set to `True`, Django automatically looks for a `templates/` subdirectory within each application package, for use as a fallback (don’t forget that `django.contrib.admin` is an application).
...
## Customize the admin index page[¶](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#customize-the-admin-index-page "Link to this heading")
...
When you’re comfortable with the admin, read [part 8 of this tutorial](https://docs.djangoproject.com/en/5.0/intro/tutorial08/) to learn how to use third-party packages.
...
![Support Django!](https://static.djangoproject.com/img/fundraising-heart.cd6bb84ffd33.svg)
  * [ Elvis D'Souza donated to the Django Software Foundation to support Django development. Donate today! ](https://www.djangoproject.com/fundraising/)


### Contents
  * [Writing your first Django app, part 7](https://docs.djangoproject.com/en/5.0/intro/tutorial07/)
    * [Customize the admin form](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#customize-the-admin-form)
    * [Adding related objects](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#adding-related-objects)
    * [Customize the admin change list](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#customize-the-admin-change-list)
    * [Customize the admin look and feel](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#customize-the-admin-look-and-feel)
      * [Customizing your _project’s_ templates](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#customizing-your-project-s-templates)
      * [Customizing your _application’s_ templates](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#customizing-your-application-s-templates)
    * [Customize the admin index page](https://docs.djangoproject.com/en/5.0/intro/tutorial07/#customize-the-admin-index-page)


### Browse
  * Prev: [Writing your first Django app, part 6](https://docs.djangoproject.com/en/5.0/intro/tutorial06/)
  * Next: [Writing your first Django app, part 8](https://docs.djangoproject.com/en/5.0/intro/tutorial08/)
