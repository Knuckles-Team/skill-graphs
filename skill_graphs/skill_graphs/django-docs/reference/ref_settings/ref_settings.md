...
[Skip to main content](https://docs.djangoproject.com/en/5.0/ref/settings/#main-content)
...
[Documentation](https://docs.djangoproject.com/en/5.0/)
  ...
  * Language: **en**
  * [zh-hans](https://docs.djangoproject.com/zh-hans/5.0/ref/settings/)
  * [pt-br](https://docs.djangoproject.com/pt-br/5.0/ref/settings/)
  * [pl](https://docs.djangoproject.com/pl/5.0/ref/settings/)
  * [ko](https://docs.djangoproject.com/ko/5.0/ref/settings/)
  * [ja](https://docs.djangoproject.com/ja/5.0/ref/settings/)
  * [it](https://docs.djangoproject.com/it/5.0/ref/settings/)
  * [id](https://docs.djangoproject.com/id/5.0/ref/settings/)
  * [fr](https://docs.djangoproject.com/fr/5.0/ref/settings/)
  * [es](https://docs.djangoproject.com/es/5.0/ref/settings/)
  * [el](https://docs.djangoproject.com/el/5.0/ref/settings/)


  * Documentation version: **5.0**
  * [dev](https://docs.djangoproject.com/en/dev/ref/settings/)
  * [6.0](https://docs.djangoproject.com/en/6.0/ref/settings/)
  ...
  * [](https://docs.djangoproject.com/en/5.0/ref/settings/#top)
