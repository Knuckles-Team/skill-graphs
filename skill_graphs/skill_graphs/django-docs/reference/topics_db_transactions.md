[Skip to main content](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#main-content)
...
[Documentation](https://docs.djangoproject.com/en/6.0/)
  ...
  * Language: **en**
  * [zh-hans](https://docs.djangoproject.com/zh-hans/6.0/topics/db/transactions/)
  * [sv](https://docs.djangoproject.com/sv/6.0/topics/db/transactions/)
  * [pt-br](https://docs.djangoproject.com/pt-br/6.0/topics/db/transactions/)
  * [pl](https://docs.djangoproject.com/pl/6.0/topics/db/transactions/)
  * [ko](https://docs.djangoproject.com/ko/6.0/topics/db/transactions/)
  * [ja](https://docs.djangoproject.com/ja/6.0/topics/db/transactions/)
  * [it](https://docs.djangoproject.com/it/6.0/topics/db/transactions/)
  * [id](https://docs.djangoproject.com/id/6.0/topics/db/transactions/)
  * [fr](https://docs.djangoproject.com/fr/6.0/topics/db/transactions/)
  * [es](https://docs.djangoproject.com/es/6.0/topics/db/transactions/)
  * [el](https://docs.djangoproject.com/el/6.0/topics/db/transactions/)
  ...
  * [5.0](https://docs.djangoproject.com/en/5.0/topics/db/transactions/)
  ...
  * [](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#top)


# Database transactions[¶](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#module-django.db.transaction "Link to this heading")
...
non_atomic_requests(_using =None_)[¶](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#django.db.transaction.non_atomic_requests "Link to this definition")
...
atomic(_using =None_, _savepoint =True_, _durable =False_)[¶](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#django.db.transaction.atomic "Link to this definition")
...
on_commit(_func_ , _using =None_, _robust =False_)[¶](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#django.db.transaction.on_commit "Link to this definition")
...
get_autocommit(_using =None_)[¶](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#django.db.transaction.get_autocommit "Link to this definition")


set_autocommit(_autocommit_ , _using =None_)[¶](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#django.db.transaction.set_autocommit "Link to this definition")
...
commit(_using =None_)[¶](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#django.db.transaction.commit "Link to this definition")


rollback(_using =None_)[¶](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#django.db.transaction.rollback "Link to this definition")
...
savepoint(_using =None_)[¶](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#django.db.transaction.savepoint "Link to this definition")
...
savepoint_commit(_sid_ , _using =None_)[¶](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#django.db.transaction.savepoint_commit "Link to this definition")

Releases savepoint `sid`. The changes performed since the savepoint was created become part of the transaction.

savepoint_rollback(_sid_ , _using =None_)[¶](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#django.db.transaction.savepoint_rollback "Link to this definition")

Rolls back the transaction to savepoint `sid`.
These functions do nothing if savepoints aren’t supported or if the database is in autocommit mode.
In addition, there’s a utility function:

clean_savepoints(_using =None_)[¶](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#django.db.transaction.clean_savepoints "Link to this definition")
...
get_rollback(_using =None_)[¶](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#django.db.transaction.get_rollback "Link to this definition")


set_rollback(_rollback_ , _using =None_)[¶](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#django.db.transaction.set_rollback "Link to this definition")
...
![Support Django!](https://static.djangoproject.com/img/fundraising-heart.cd6bb84ffd33.svg)
  * [ Adylzhan Khashtamov donated to the Django Software Foundation to support Django development. Donate today! ](https://www.djangoproject.com/fundraising/)


### Contents
  * [Database transactions](https://docs.djangoproject.com/en/6.0/topics/db/transactions/)
    * [Managing database transactions](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#managing-database-transactions)
      * [Django’s default transaction behavior](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#django-s-default-transaction-behavior)
      * [Tying transactions to HTTP requests](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#tying-transactions-to-http-requests)
      * [Controlling transactions explicitly](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#controlling-transactions-explicitly)
    * [Autocommit](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#autocommit)
      * [Why Django uses autocommit](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#why-django-uses-autocommit)
      * [Deactivating transaction management](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#deactivating-transaction-management)
    * [Performing actions after commit](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#performing-actions-after-commit)
      * [Savepoints](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#savepoints)
      * [Order of execution](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#order-of-execution)
      * [Exception handling](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#exception-handling)
      * [Timing of execution](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#timing-of-execution)
      * [Use in tests](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#use-in-tests)
      * [Why no rollback hook?](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#why-no-rollback-hook)
    * [Low-level APIs](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#low-level-apis)
      * [Autocommit](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#managing-autocommit)
      * [Transactions](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#transactions)
      * [Savepoints](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#topics-db-transactions-savepoints)
    * [Database-specific notes](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#database-specific-notes)
      * [Savepoints in SQLite](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#savepoints-in-sqlite)
      * [Transactions in MySQL](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#transactions-in-mysql)
      * [Handling exceptions within PostgreSQL transactions](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#handling-exceptions-within-postgresql-transactions)
        * [Transaction rollback](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#transaction-rollback)
        * [Savepoint rollback](https://docs.djangoproject.com/en/6.0/topics/db/transactions/#savepoint-rollback)


### Browse
  * Prev: [Performing raw SQL queries](https://docs.djangoproject.com/en/6.0/topics/db/sql/)
  * Next: [Multiple databases](https://docs.djangoproject.com/en/6.0/topics/db/multi-db/)
