...
[Skip to main content](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#main-content)
...
[Documentation](https://docs.djangoproject.com/en/5.0/)
  ...
  * Language: **en**
  * [zh-hans](https://docs.djangoproject.com/zh-hans/5.0/topics/db/multi-db/)
  * [pt-br](https://docs.djangoproject.com/pt-br/5.0/topics/db/multi-db/)
  * [pl](https://docs.djangoproject.com/pl/5.0/topics/db/multi-db/)
  * [ko](https://docs.djangoproject.com/ko/5.0/topics/db/multi-db/)
  * [ja](https://docs.djangoproject.com/ja/5.0/topics/db/multi-db/)
  * [it](https://docs.djangoproject.com/it/5.0/topics/db/multi-db/)
  * [id](https://docs.djangoproject.com/id/5.0/topics/db/multi-db/)
  * [fr](https://docs.djangoproject.com/fr/5.0/topics/db/multi-db/)
  * [es](https://docs.djangoproject.com/es/5.0/topics/db/multi-db/)
  * [el](https://docs.djangoproject.com/el/5.0/topics/db/multi-db/)


  * Documentation version: **5.0**
  * [dev](https://docs.djangoproject.com/en/dev/topics/db/multi-db/)
  * [6.0](https://docs.djangoproject.com/en/6.0/topics/db/multi-db/)
  * [5.2](https://docs.djangoproject.com/en/5.2/topics/db/multi-db/)
  * [5.1](https://docs.djangoproject.com/en/5.1/topics/db/multi-db/)
  * [4.2](https://docs.djangoproject.com/en/4.2/topics/db/multi-db/)
  * [4.1](https://docs.djangoproject.com/en/4.1/topics/db/multi-db/)
  * [4.0](https://docs.djangoproject.com/en/4.0/topics/db/multi-db/)
  * [3.2](https://docs.djangoproject.com/en/3.2/topics/db/multi-db/)
  * [3.1](https://docs.djangoproject.com/en/3.1/topics/db/multi-db/)
  * [3.0](https://docs.djangoproject.com/en/3.0/topics/db/multi-db/)
  * [2.2](https://docs.djangoproject.com/en/2.2/topics/db/multi-db/)
  * [2.1](https://docs.djangoproject.com/en/2.1/topics/db/multi-db/)
  * [2.0](https://docs.djangoproject.com/en/2.0/topics/db/multi-db/)
  * [1.11](https://docs.djangoproject.com/en/1.11/topics/db/multi-db/)
  * [1.10](https://docs.djangoproject.com/en/1.10/topics/db/multi-db/)
  * [1.8](https://docs.djangoproject.com/en/1.8/topics/db/multi-db/)


  * [](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#top)


# Multiple databases[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#multiple-databases "Link to this heading")
...
See also
See [Multi-database support](https://docs.djangoproject.com/en/5.0/topics/testing/tools/#testing-multi-db) for information about testing with multiple databases.
## Defining your databases[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#defining-your-databases "Link to this heading")
The first step to using more than one database with Django is to tell Django about the database servers you’ll be using. This is done using the [`DATABASES`](https://docs.djangoproject.com/en/5.0/ref/settings/#std-setting-DATABASES) setting. This setting maps database aliases, which are a way to refer to a specific database throughout Django, to a dictionary of settings for that specific connection. The settings in the inner dictionaries are described fully in the [`DATABASES`](https://docs.djangoproject.com/en/5.0/ref/settings/#std-setting-DATABASES) documentation.
...
If you attempt to access a database that you haven’t defined in your [`DATABASES`](https://docs.djangoproject.com/en/5.0/ref/settings/#std-setting-DATABASES) setting, Django will raise a `django.utils.connection.ConnectionDoesNotExist` exception.
## Synchronizing your databases[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#synchronizing-your-databases "Link to this heading")
The [`migrate`](https://docs.djangoproject.com/en/5.0/ref/django-admin/#django-admin-migrate) management command operates on one database at a time. By default, it operates on the `default` database, but by providing the [`--database`](https://docs.djangoproject.com/en/5.0/ref/django-admin/#cmdoption-migrate-database) option, you can tell it to synchronize a different database. So, to synchronize all models onto all databases in the first example above, you would need to call:
```
$ ./manage.py migrate
...
If you don’t want every application to be synchronized onto a particular database, you can define a [database router](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#topics-db-multi-db-routing) that implements a policy constraining the availability of particular models.
If, as in the second example above, you’ve left the `default` database empty, you must provide a database name each time you run [`migrate`](https://docs.djangoproject.com/en/5.0/ref/django-admin/#django-admin-migrate). Omitting the database name would raise an error. For the second example:
```
$ ./manage.py migrate --database=users
...
### Using other management commands[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#using-other-management-commands "Link to this heading")
Most other `django-admin` commands that interact with the database operate in the same way as [`migrate`](https://docs.djangoproject.com/en/5.0/ref/django-admin/#django-admin-migrate) – they only ever operate on one database at a time, using `--database` to control the database used.
An exception to this rule is the [`makemigrations`](https://docs.djangoproject.com/en/5.0/ref/django-admin/#django-admin-makemigrations) command. It validates the migration history in the databases to catch problems with the existing migration files (which could be caused by editing them) before creating new migrations. By default, it checks only the `default` database, but it consults the [`allow_migrate()`](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#allow_migrate "allow_migrate") method of [routers](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#topics-db-multi-db-routing) if any are installed.
## Automatic database routing[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#automatic-database-routing "Link to this heading")
...
### Database routers[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#database-routers "Link to this heading")
A database Router is a class that provides up to four methods:

db_for_read(_model_ , _** hints_)[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#db_for_read "Link to this definition")

Suggest the database that should be used for read operations for objects of type `model`.
If a database operation is able to provide any additional information that might assist in selecting a database, it will be provided in the `hints` dictionary. Details on valid hints are provided [below](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#topics-db-multi-db-hints).
Returns `None` if there is no suggestion.

db_for_write(_model_ , _** hints_)[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#db_for_write "Link to this definition")

Suggest the database that should be used for writes of objects of type Model.
If a database operation is able to provide any additional information that might assist in selecting a database, it will be provided in the `hints` dictionary. Details on valid hints are provided [below](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#topics-db-multi-db-hints).
Returns `None` if there is no suggestion.

allow_relation(_obj1_ , _obj2_ , _** hints_)[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#allow_relation "Link to this definition")
...
allow_migrate(_db_ , _app_label_ , _model_name =None_, _** hints_)[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#allow_migrate "Link to this definition")
...
`model_name` is set by most migration operations to the value of `model._meta.model_name` (the lowercased version of the model `__name__`) of the model being migrated. Its value is `None` for the [`RunPython`](https://docs.djangoproject.com/en/5.0/ref/migration-operations/#django.db.migrations.operations.RunPython "django.db.migrations.operations.RunPython") and [`RunSQL`](https://docs.djangoproject.com/en/5.0/ref/migration-operations/#django.db.migrations.operations.RunSQL "django.db.migrations.operations.RunSQL") operations unless they provide it using hints.
`hints` are used by certain operations to communicate additional information to the router.
When `model_name` is set, `hints` normally contains the model class under the key `'model'`. Note that it may be a [historical model](https://docs.djangoproject.com/en/5.0/topics/migrations/#historical-models), and thus not have any custom attributes, methods, or managers. You should only rely on `_meta`.
This method can also be used to determine the availability of a model on a given database.
[`makemigrations`](https://docs.djangoproject.com/en/5.0/ref/django-admin/#django-admin-makemigrations) always creates migrations for model changes, but if `allow_migrate()` returns `False`, any migration operations for the `model_name` will be silently skipped when running [`migrate`](https://docs.djangoproject.com/en/5.0/ref/django-admin/#django-admin-migrate) on the `db`. Changing the behavior of `allow_migrate()` for models that already have migrations may result in broken foreign keys, extra tables, or missing tables. When [`makemigrations`](https://docs.djangoproject.com/en/5.0/ref/django-admin/#django-admin-makemigrations) verifies the migration history, it skips databases where no app is allowed to migrate.
...
#### Hints[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#hints "Link to this heading")
...
### Using routers[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#using-routers "Link to this heading")
Database routers are installed using the [`DATABASE_ROUTERS`](https://docs.djangoproject.com/en/5.0/ref/settings/#std-setting-DATABASE_ROUTERS) setting. This setting defines a list of class names, each specifying a router that should be used by the base router (`django.db.router`).
The base router is used by Django’s database operations to allocate database usage. Whenever a query needs to know which database to use, it calls the base router, providing a model and a hint (if available). The base router tries each router class in turn until one returns a database suggestion. If no routers return a suggestion, the base router tries the current [`instance._state.db`](https://docs.djangoproject.com/en/5.0/ref/models/instances/#django.db.models.Model._state "django.db.models.Model._state") of the hint instance. If no hint instance was provided, or [`instance._state.db`](https://docs.djangoproject.com/en/5.0/ref/models/instances/#django.db.models.Model._state "django.db.models.Model._state") is `None`, the base router will allocate the `default` database.
### An example[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#an-example "Link to this heading")
...
This example won’t work if any of the models in `myapp` contain relationships to models outside of the `other` database. [Cross-database relationships](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#no-cross-database-relations) introduce referential integrity problems that Django can’t currently handle.
...
With this setup installed, and all databases migrated as per [Synchronizing your databases](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#synchronizing-multiple-databases), lets run some Django code:
```
...
### Manually selecting a database for a `QuerySet`[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#manually-selecting-a-database-for-a-queryset "Link to this heading")
...
### Selecting a database for `save()`[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#selecting-a-database-for-save "Link to this heading")
...
#### Moving an object from one database to another[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#moving-an-object-from-one-database-to-another "Link to this heading")
...
### Selecting a database to delete from[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#selecting-a-database-to-delete-from "Link to this heading")
...
### Using managers with multiple databases[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#using-managers-with-multiple-databases "Link to this heading")
...
#### Using `get_queryset()` with multiple databases[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#using-get-queryset-with-multiple-databases "Link to this heading")
...
## Exposing multiple databases in Django’s admin interface[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#exposing-multiple-databases-in-django-s-admin-interface "Link to this heading")
...
[`InlineModelAdmin`](https://docs.djangoproject.com/en/5.0/ref/contrib/admin/#django.contrib.admin.InlineModelAdmin "django.contrib.admin.InlineModelAdmin") objects can be handled in a similar fashion. They require three customized methods:
```
...
## Using raw cursors with multiple databases[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#using-raw-cursors-with-multiple-databases "Link to this heading")
...
## Limitations of multiple databases[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#limitations-of-multiple-databases "Link to this heading")
### Cross-database relations[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#cross-database-relations "Link to this heading")
...
### Behavior of contrib apps[¶](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#behavior-of-contrib-apps "Link to this heading")
...
In addition, some objects are automatically created just after [`migrate`](https://docs.djangoproject.com/en/5.0/ref/django-admin/#django-admin-migrate) creates a table to hold them in a database:
  * a default `Site`,
...
![Support Django!](https://static.djangoproject.com/img/fundraising-heart.cd6bb84ffd33.svg)
  * [ Clearbold, LLC donated to the Django Software Foundation to support Django development. Donate today! ](https://www.djangoproject.com/fundraising/)


### Contents
  * [Multiple databases](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/)
    * [Defining your databases](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#defining-your-databases)
    * [Synchronizing your databases](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#synchronizing-your-databases)
      * [Using other management commands](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#using-other-management-commands)
    * [Automatic database routing](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#automatic-database-routing)
      * [Database routers](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#database-routers)
        * [Hints](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#hints)
      * [Using routers](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#using-routers)
      * [An example](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#an-example)
    * [Manually selecting a database](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#manually-selecting-a-database)
      * [Manually selecting a database for a `QuerySet`](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#manually-selecting-a-database-for-a-queryset)
      * [Selecting a database for `save()`](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#selecting-a-database-for-save)
        * [Moving an object from one database to another](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#moving-an-object-from-one-database-to-another)
      * [Selecting a database to delete from](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#selecting-a-database-to-delete-from)
      * [Using managers with multiple databases](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#using-managers-with-multiple-databases)
        * [Using `get_queryset()` with multiple databases](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#using-get-queryset-with-multiple-databases)
    * [Exposing multiple databases in Django’s admin interface](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#exposing-multiple-databases-in-django-s-admin-interface)
    * [Using raw cursors with multiple databases](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#using-raw-cursors-with-multiple-databases)
    * [Limitations of multiple databases](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#limitations-of-multiple-databases)
      * [Cross-database relations](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#cross-database-relations)
      * [Behavior of contrib apps](https://docs.djangoproject.com/en/5.0/topics/db/multi-db/#behavior-of-contrib-apps)


### Browse
  * Prev: [Database transactions](https://docs.djangoproject.com/en/5.0/topics/db/transactions/)
  * Next: [Tablespaces](https://docs.djangoproject.com/en/5.0/topics/db/tablespaces/)
