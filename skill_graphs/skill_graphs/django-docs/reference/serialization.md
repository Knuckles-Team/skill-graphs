...
[Skip to main content](https://docs.djangoproject.com/en/5.0/topics/serialization/#main-content)
...
[Documentation](https://docs.djangoproject.com/en/5.0/)
  ...
  * Language: **en**
  * [zh-hans](https://docs.djangoproject.com/zh-hans/5.0/topics/serialization/)
  * [pt-br](https://docs.djangoproject.com/pt-br/5.0/topics/serialization/)
  * [pl](https://docs.djangoproject.com/pl/5.0/topics/serialization/)
  * [ko](https://docs.djangoproject.com/ko/5.0/topics/serialization/)
  * [ja](https://docs.djangoproject.com/ja/5.0/topics/serialization/)
  * [it](https://docs.djangoproject.com/it/5.0/topics/serialization/)
  * [id](https://docs.djangoproject.com/id/5.0/topics/serialization/)
  * [fr](https://docs.djangoproject.com/fr/5.0/topics/serialization/)
  * [es](https://docs.djangoproject.com/es/5.0/topics/serialization/)
  * [el](https://docs.djangoproject.com/el/5.0/topics/serialization/)


  * Documentation version: **5.0**
  * [dev](https://docs.djangoproject.com/en/dev/topics/serialization/)
  * [6.0](https://docs.djangoproject.com/en/6.0/topics/serialization/)
  * [5.2](https://docs.djangoproject.com/en/5.2/topics/serialization/)
  * [5.1](https://docs.djangoproject.com/en/5.1/topics/serialization/)
  * [4.2](https://docs.djangoproject.com/en/4.2/topics/serialization/)
  * [4.1](https://docs.djangoproject.com/en/4.1/topics/serialization/)
  * [4.0](https://docs.djangoproject.com/en/4.0/topics/serialization/)
  * [3.2](https://docs.djangoproject.com/en/3.2/topics/serialization/)
  * [3.1](https://docs.djangoproject.com/en/3.1/topics/serialization/)
  * [3.0](https://docs.djangoproject.com/en/3.0/topics/serialization/)
  * [2.2](https://docs.djangoproject.com/en/2.2/topics/serialization/)
  * [2.1](https://docs.djangoproject.com/en/2.1/topics/serialization/)
  * [2.0](https://docs.djangoproject.com/en/2.0/topics/serialization/)
  * [1.11](https://docs.djangoproject.com/en/1.11/topics/serialization/)
  * [1.10](https://docs.djangoproject.com/en/1.10/topics/serialization/)
  * [1.8](https://docs.djangoproject.com/en/1.8/topics/serialization/)


  * [](https://docs.djangoproject.com/en/5.0/topics/serialization/#top)


# Serializing Django objects[¶](https://docs.djangoproject.com/en/5.0/topics/serialization/#serializing-django-objects "Link to this heading")
...
See also
If you just want to get some data from your tables into a serialized form, you could use the [`dumpdata`](https://docs.djangoproject.com/en/5.0/ref/django-admin/#django-admin-dumpdata) management command.
## Serializing data[¶](https://docs.djangoproject.com/en/5.0/topics/serialization/#serializing-data "Link to this heading")
...
The arguments to the `serialize` function are the format to serialize the data to (see [Serialization formats](https://docs.djangoproject.com/en/5.0/topics/serialization/#id2)) and a [`QuerySet`](https://docs.djangoproject.com/en/5.0/ref/models/querysets/#django.db.models.query.QuerySet "django.db.models.query.QuerySet") to serialize. (Actually, the second argument can be any iterator that yields Django model instances, but it’ll almost always be a QuerySet).

django.core.serializers.get_serializer(_format_)[¶](https://docs.djangoproject.com/en/5.0/topics/serialization/#django.core.serializers.get_serializer "Link to this definition")
...
This is useful if you want to serialize data directly to a file-like object (which includes an [`HttpResponse`](https://docs.djangoproject.com/en/5.0/ref/request-response/#django.http.HttpResponse "django.http.HttpResponse")):
```
...
Note
Calling [`get_serializer()`](https://docs.djangoproject.com/en/5.0/topics/serialization/#django.core.serializers.get_serializer "django.core.serializers.get_serializer") with an unknown [format](https://docs.djangoproject.com/en/5.0/topics/serialization/#serialization-formats) will raise a `django.core.serializers.SerializerDoesNotExist` exception.
### Subset of fields[¶](https://docs.djangoproject.com/en/5.0/topics/serialization/#subset-of-fields "Link to this heading")
...
### Inherited models[¶](https://docs.djangoproject.com/en/5.0/topics/serialization/#inherited-models "Link to this heading")
If you have a model that is defined using an [abstract base class](https://docs.djangoproject.com/en/5.0/topics/db/models/#abstract-base-classes), you don’t have to do anything special to serialize that model. Call the serializer on the object (or objects) that you want to serialize, and the output will be a complete representation of the serialized object.
However, if you have a model that uses [multi-table inheritance](https://docs.djangoproject.com/en/5.0/topics/db/models/#multi-table-inheritance), you also need to serialize all of the base classes for the model. This is because only the fields that are locally defined on the model will be serialized. For example, consider the following models:
```
...
## Deserializing data[¶](https://docs.djangoproject.com/en/5.0/topics/serialization/#deserializing-data "Link to this heading")
...
However, here it gets slightly complicated. The objects returned by the `deserialize` iterator _aren’t_ regular Django objects. Instead, they are special `DeserializedObject` instances that wrap a created – but unsaved – object and any associated relationship data.
...
## Serialization formats[¶](https://docs.djangoproject.com/en/5.0/topics/serialization/#serialization-formats "Link to this heading")
...
`jsonl` | Serializes to and from
`yaml` | Serializes to YAML (YAML Ain’t a Markup Language). This serializer is only available if
### XML[¶](https://docs.djangoproject.com/en/5.0/topics/serialization/#xml "Link to this heading")
...
Control characters
If the content to be serialized contains control characters that are not accepted in the XML 1.0 standard, the serialization will fail with a
### JSON[¶](https://docs.djangoproject.com/en/5.0/topics/serialization/#serialization-formats-json "Link to this heading")
...
Be aware that not all Django output can be passed unmodified to
```
...
Also note that GeoDjango provides a [customized GeoJSON serializer](https://docs.djangoproject.com/en/5.0/ref/contrib/gis/serializers/).
####  `DjangoJSONEncoder`[¶](https://docs.djangoproject.com/en/5.0/topics/serialization/#djangojsonencoder "Link to this heading")

_class_ django.core.serializers.json.DjangoJSONEncoder[¶](https://docs.djangoproject.com/en/5.0/topics/serialization/#django.core.serializers.json.DjangoJSONEncoder "Link to this definition")
...
A string of the form `YYYY-MM-DD` as defined in
A string of the form `HH:MM:ss.sss` as defined in
...
`Promise` (`django.utils.functional.lazy()` objects),

A string representation of the object.
### JSONL[¶](https://docs.djangoproject.com/en/5.0/topics/serialization/#serialization-formats-jsonl "Link to this heading")
_JSONL_ stands for _JSON Lines_. With this format, objects are separated by new lines, and each line contains a valid JSON object. JSONL serialized data looks like this:
```
...
### YAML[¶](https://docs.djangoproject.com/en/5.0/topics/serialization/#yaml "Link to this heading")
...
## Natural keys[¶](https://docs.djangoproject.com/en/5.0/topics/serialization/#natural-keys "Link to this heading")
...
It is for these reasons that Django provides _natural keys_. A natural key is a tuple of values that can be used to uniquely identify an object instance without using the primary key value.
### Deserialization of natural keys[¶](https://docs.djangoproject.com/en/5.0/topics/serialization/#deserialization-of-natural-keys "Link to this heading")
...
Note
Whatever fields you use for a natural key must be able to uniquely identify an object. This will usually mean that your model will have a uniqueness clause (either `unique=True` on a single field, or a `UniqueConstraint` or `unique_together` over multiple fields) for the field or fields in your natural key. However, uniqueness doesn’t need to be enforced at the database level. If you are certain that a set of fields will be effectively unique, you can still use those fields as a natural key.
...
### Serialization of natural keys[¶](https://docs.djangoproject.com/en/5.0/topics/serialization/#serialization-of-natural-keys "Link to this heading")
...
If you are using [`dumpdata`](https://docs.djangoproject.com/en/5.0/ref/django-admin/#django-admin-dumpdata) to generate serialized data, use the [`dumpdata --natural-foreign`](https://docs.djangoproject.com/en/5.0/ref/django-admin/#cmdoption-dumpdata-natural-foreign) and [`dumpdata --natural-primary`](https://docs.djangoproject.com/en/5.0/ref/django-admin/#cmdoption-dumpdata-natural-primary) command line flags to generate natural keys.
Note
...
Conversely, if (for some strange reason) you want Django to output natural keys during serialization, but _not_ be able to load those key values, just don’t define the `get_by_natural_key()` method.
### Natural keys and forward references[¶](https://docs.djangoproject.com/en/5.0/topics/serialization/#natural-keys-and-forward-references "Link to this heading")
Sometimes when you use [natural foreign keys](https://docs.djangoproject.com/en/5.0/topics/serialization/#topics-serialization-natural-keys) you’ll need to deserialize data where an object has a foreign key referencing another object that hasn’t yet been deserialized. This is called a “forward reference”.
...
### Dependencies during serialization[¶](https://docs.djangoproject.com/en/5.0/topics/serialization/#dependencies-during-serialization "Link to this heading")
...
To help with this, calls to [`dumpdata`](https://docs.djangoproject.com/en/5.0/ref/django-admin/#django-admin-dumpdata) that use the [`dumpdata --natural-foreign`](https://docs.djangoproject.com/en/5.0/ref/django-admin/#cmdoption-dumpdata-natural-foreign) option will serialize any model with a `natural_key()` method before serializing standard primary key objects.
...
### Contents
  * [Serializing Django objects](https://docs.djangoproject.com/en/5.0/topics/serialization/)
    * [Serializing data](https://docs.djangoproject.com/en/5.0/topics/serialization/#serializing-data)
      * [Subset of fields](https://docs.djangoproject.com/en/5.0/topics/serialization/#subset-of-fields)
      * [Inherited models](https://docs.djangoproject.com/en/5.0/topics/serialization/#inherited-models)
    * [Deserializing data](https://docs.djangoproject.com/en/5.0/topics/serialization/#deserializing-data)
    * [Serialization formats](https://docs.djangoproject.com/en/5.0/topics/serialization/#serialization-formats)
      * [XML](https://docs.djangoproject.com/en/5.0/topics/serialization/#xml)
      * [JSON](https://docs.djangoproject.com/en/5.0/topics/serialization/#serialization-formats-json)
        * [`DjangoJSONEncoder`](https://docs.djangoproject.com/en/5.0/topics/serialization/#djangojsonencoder)
      * [JSONL](https://docs.djangoproject.com/en/5.0/topics/serialization/#serialization-formats-jsonl)
      * [YAML](https://docs.djangoproject.com/en/5.0/topics/serialization/#yaml)
    * [Natural keys](https://docs.djangoproject.com/en/5.0/topics/serialization/#natural-keys)
      * [Deserialization of natural keys](https://docs.djangoproject.com/en/5.0/topics/serialization/#deserialization-of-natural-keys)
      * [Serialization of natural keys](https://docs.djangoproject.com/en/5.0/topics/serialization/#serialization-of-natural-keys)
      * [Natural keys and forward references](https://docs.djangoproject.com/en/5.0/topics/serialization/#natural-keys-and-forward-references)
      * [Dependencies during serialization](https://docs.djangoproject.com/en/5.0/topics/serialization/#dependencies-during-serialization)


### Browse
  * Prev: [Performance and optimization](https://docs.djangoproject.com/en/5.0/topics/performance/)
  * Next: [Django settings](https://docs.djangoproject.com/en/5.0/topics/settings/)
