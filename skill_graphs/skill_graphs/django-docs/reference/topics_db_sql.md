...
Manager.raw(_raw_query_ , _params =()_, _translations =None_)[¶](https://docs.djangoproject.com/en/6.0/topics/db/sql/#django.db.models.Manager.raw "Link to this definition")
...
### Adding annotations[¶](https://docs.djangoproject.com/en/6.0/topics/db/sql/#adding-annotations "Link to this heading")
...
You can often avoid using raw SQL to compute annotations by instead using a [Func() expression](https://docs.djangoproject.com/en/6.0/ref/models/expressions/#func-expressions).
...
As discussed in [SQL injection protection](https://docs.djangoproject.com/en/6.0/topics/security/#sql-injection-protection), using the `params` argument and leaving the placeholders unquoted protects you from
...
`connection` and `cursor` mostly implement the standard Python DB-API described in [transaction handling](https://docs.djangoproject.com/en/6.0/topics/db/transactions/).
...
![Support Django!](https://static.djangoproject.com/img/fundraising-heart.cd6bb84ffd33.svg)
  * [ Adam Joseph Cook donated to the Django Software Foundation to support Django development. Donate today! ](https://www.djangoproject.com/fundraising/)
...
### Contents
  * [Performing raw SQL queries](https://docs.djangoproject.com/en/6.0/topics/db/sql/)
    * [Performing raw queries](https://docs.djangoproject.com/en/6.0/topics/db/sql/#performing-raw-queries)
      ...
      * [Adding annotations](https://docs.djangoproject.com/en/6.0/topics/db/sql/#adding-annotations)
