...
[Skip to main content](https://docs.djangoproject.com/en/5.0/ref/unicode/#main-content)
...
[Documentation](https://docs.djangoproject.com/en/5.0/)
  ...
  * Language: **en**
  * [zh-hans](https://docs.djangoproject.com/zh-hans/5.0/ref/unicode/)
  * [pt-br](https://docs.djangoproject.com/pt-br/5.0/ref/unicode/)
  * [pl](https://docs.djangoproject.com/pl/5.0/ref/unicode/)
  * [ko](https://docs.djangoproject.com/ko/5.0/ref/unicode/)
  * [ja](https://docs.djangoproject.com/ja/5.0/ref/unicode/)
  * [it](https://docs.djangoproject.com/it/5.0/ref/unicode/)
  * [id](https://docs.djangoproject.com/id/5.0/ref/unicode/)
  * [fr](https://docs.djangoproject.com/fr/5.0/ref/unicode/)
  * [es](https://docs.djangoproject.com/es/5.0/ref/unicode/)
  * [el](https://docs.djangoproject.com/el/5.0/ref/unicode/)


  * Documentation version: **5.0**
  * [dev](https://docs.djangoproject.com/en/dev/ref/unicode/)
  * [6.0](https://docs.djangoproject.com/en/6.0/ref/unicode/)
  * [5.2](https://docs.djangoproject.com/en/5.2/ref/unicode/)
  * [5.1](https://docs.djangoproject.com/en/5.1/ref/unicode/)
  * [4.2](https://docs.djangoproject.com/en/4.2/ref/unicode/)
  * [4.1](https://docs.djangoproject.com/en/4.1/ref/unicode/)
  * [4.0](https://docs.djangoproject.com/en/4.0/ref/unicode/)
  * [3.2](https://docs.djangoproject.com/en/3.2/ref/unicode/)
  * [3.1](https://docs.djangoproject.com/en/3.1/ref/unicode/)
  * [3.0](https://docs.djangoproject.com/en/3.0/ref/unicode/)
  * [2.2](https://docs.djangoproject.com/en/2.2/ref/unicode/)
  * [2.1](https://docs.djangoproject.com/en/2.1/ref/unicode/)
  * [2.0](https://docs.djangoproject.com/en/2.0/ref/unicode/)
  * [1.11](https://docs.djangoproject.com/en/1.11/ref/unicode/)
  * [1.10](https://docs.djangoproject.com/en/1.10/ref/unicode/)
  * [1.8](https://docs.djangoproject.com/en/1.8/ref/unicode/)


  * [](https://docs.djangoproject.com/en/5.0/ref/unicode/#top)


# Unicode data[¶](https://docs.djangoproject.com/en/5.0/ref/unicode/#unicode-data "Link to this heading")
...
## Creating the database[¶](https://docs.djangoproject.com/en/5.0/ref/unicode/#creating-the-database "Link to this heading")
Make sure your database is configured to be able to store arbitrary string data. Normally, this means giving it an encoding of UTF-8 or UTF-16. If you use a more restrictive encoding – for example, latin1 (iso8859-1) – you won’t be able to store certain characters in the database, and information will be lost.
  * MySQL users, refer to the
  * PostgreSQL users, refer to the
  * Oracle users, refer to the
...
## General string handling[¶](https://docs.djangoproject.com/en/5.0/ref/unicode/#general-string-handling "Link to this heading")
...
Don’t be fooled into thinking that if your [`DEFAULT_CHARSET`](https://docs.djangoproject.com/en/5.0/ref/settings/#std-setting-DEFAULT_CHARSET) setting is set to something other than `'utf-8'` you can use that other encoding in your bytestrings! [`DEFAULT_CHARSET`](https://docs.djangoproject.com/en/5.0/ref/settings/#std-setting-DEFAULT_CHARSET) only applies to the strings generated as the result of template rendering (and email). Django will always assume UTF-8 encoding for internal bytestrings. The reason for this is that the [`DEFAULT_CHARSET`](https://docs.djangoproject.com/en/5.0/ref/settings/#std-setting-DEFAULT_CHARSET) setting is not actually under your control (if you are the application developer). It’s under the control of the person installing and using your application – and if that person chooses a different setting, your code must still continue to work. Ergo, it cannot rely on that setting.
...
### Translated strings[¶](https://docs.djangoproject.com/en/5.0/ref/unicode/#translated-strings "Link to this heading")
...
For more details about lazy translation objects, refer to the [internationalization](https://docs.djangoproject.com/en/5.0/topics/i18n/) documentation.
### Useful utility functions[¶](https://docs.djangoproject.com/en/5.0/ref/unicode/#useful-utility-functions "Link to this heading")
...
#### Conversion functions[¶](https://docs.djangoproject.com/en/5.0/ref/unicode/#conversion-functions "Link to this heading")
The `django.utils.encoding` module contains a few functions that are handy for converting back and forth between strings and bytestrings.
  ...
  * `force_str(s, encoding='utf-8', strings_only=False, errors='strict')` is identical to `smart_str()` in almost all cases. The difference is when the first argument is a [lazy translation](https://docs.djangoproject.com/en/5.0/topics/i18n/translation/#lazy-translations) instance. While `smart_str()` preserves lazy translations, `force_str()` forces those objects to a string (causing the translation to occur). Normally, you’ll want to use `smart_str()`. However, `force_str()` is useful in template tags and filters that absolutely _must_ have a string to work with, not just something that can be converted to a string.
...
#### URI and IRI handling[¶](https://docs.djangoproject.com/en/5.0/ref/unicode/#uri-and-iri-handling "Link to this heading")
Web frameworks have to deal with URLs (which are a type of IRI). One requirement of URLs is that they are encoded using only ASCII characters. However, in an international environment, you might need to construct a URL from an
  * The [`django.utils.encoding.iri_to_uri()`](https://docs.djangoproject.com/en/5.0/ref/utils/#django.utils.encoding.iri_to_uri "django.utils.encoding.iri_to_uri") function, which implements the conversion from IRI to URI as required by
  * The
...
Similarly, Django provides [`django.utils.encoding.uri_to_iri()`](https://docs.djangoproject.com/en/5.0/ref/utils/#django.utils.encoding.uri_to_iri "django.utils.encoding.uri_to_iri") which implements the conversion from URI to IRI as per
...
## Models[¶](https://docs.djangoproject.com/en/5.0/ref/unicode/#models "Link to this heading")
Because all strings are returned from the database as `str` objects, model fields that are character based (CharField, TextField, URLField, etc.) will contain Unicode values when Django retrieves data from the database. This is _always_ the case, even if the data could fit into an ASCII bytestring.
...
### Taking care in `get_absolute_url()`[¶](https://docs.djangoproject.com/en/5.0/ref/unicode/#taking-care-in-get-absolute-url "Link to this heading")
URLs can only contain ASCII characters. If you’re constructing a URL from pieces of data that might be non-ASCII, be careful to encode the results in a way that is suitable for a URL. The [`reverse()`](https://docs.djangoproject.com/en/5.0/ref/urlresolvers/#django.urls.reverse "django.urls.reverse") function handles this for you automatically.
If you’re constructing a URL manually (i.e., _not_ using the `reverse()` function), you’ll need to take care of the encoding yourself. In this case, use the `iri_to_uri()` and `quote()` functions that were documented [above](https://docs.djangoproject.com/en/5.0/ref/unicode/#id1). For example:
```
from urllib.parse import quote
from django.utils.encoding import iri_to_uri
...
## Templates[¶](https://docs.djangoproject.com/en/5.0/ref/unicode/#templates "Link to this heading")
...
But the common case is to read templates from the filesystem. If your template files are not stored with a UTF-8 encoding, adjust the [`TEMPLATES`](https://docs.djangoproject.com/en/5.0/ref/settings/#std-setting-TEMPLATES) setting. The built-in [`django`](https://docs.djangoproject.com/en/5.0/topics/templates/#module-django.template.backends.django "django.template.backends.django") backend provides the `'file_charset'` option to change the encoding used to read files from disk.
The [`DEFAULT_CHARSET`](https://docs.djangoproject.com/en/5.0/ref/settings/#std-setting-DEFAULT_CHARSET) setting controls the encoding of rendered templates. This is set to UTF-8 by default.
### Template tags and filters[¶](https://docs.djangoproject.com/en/5.0/ref/unicode/#template-tags-and-filters "Link to this heading")
...
## Files[¶](https://docs.djangoproject.com/en/5.0/ref/unicode/#files "Link to this heading")
...
## Form submission[¶](https://docs.djangoproject.com/en/5.0/ref/unicode/#form-submission "Link to this heading")
...
By default, the [`DEFAULT_CHARSET`](https://docs.djangoproject.com/en/5.0/ref/settings/#std-setting-DEFAULT_CHARSET) setting is used as the assumed encoding for form data. If you need to change this for a particular form, you can set the `encoding` attribute on an `HttpRequest` instance. For example:
```
...
### Contents
  * [Unicode data](https://docs.djangoproject.com/en/5.0/ref/unicode/)
    ...
    * [General string handling](https://docs.djangoproject.com/en/5.0/ref/unicode/#general-string-handling)
      * [Translated strings](https://docs.djangoproject.com/en/5.0/ref/unicode/#translated-strings)
      * [Useful utility functions](https://docs.djangoproject.com/en/5.0/ref/unicode/#useful-utility-functions)
        * [Conversion functions](https://docs.djangoproject.com/en/5.0/ref/unicode/#conversion-functions)
        * [URI and IRI handling](https://docs.djangoproject.com/en/5.0/ref/unicode/#uri-and-iri-handling)
    * [Models](https://docs.djangoproject.com/en/5.0/ref/unicode/#models)
      * [Taking care in `get_absolute_url()`](https://docs.djangoproject.com/en/5.0/ref/unicode/#taking-care-in-get-absolute-url)
    * [Templates](https://docs.djangoproject.com/en/5.0/ref/unicode/#templates)
      * [Template tags and filters](https://docs.djangoproject.com/en/5.0/ref/unicode/#template-tags-and-filters)
...
### Browse
  * Prev: [`TemplateResponse` and `SimpleTemplateResponse`](https://docs.djangoproject.com/en/5.0/ref/template-response/)
  * Next: [`django.urls` utility functions](https://docs.djangoproject.com/en/5.0/ref/urlresolvers/)
