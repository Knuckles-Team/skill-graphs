## Fields[¶](https://docs.djangoproject.com/en/5.0/topics/db/models/#fields "Link to this heading")
...
### Field types[¶](https://docs.djangoproject.com/en/5.0/topics/db/models/#field-types "Link to this heading")
...
### Field options[¶](https://docs.djangoproject.com/en/5.0/topics/db/models/#field-options "Link to this heading")
...
### Automatic primary key fields[¶](https://docs.djangoproject.com/en/5.0/topics/db/models/#automatic-primary-key-fields "Link to this heading")
...
### Verbose field names[¶](https://docs.djangoproject.com/en/5.0/topics/db/models/#verbose-field-names "Link to this heading")
...
### Relationships[¶](https://docs.djangoproject.com/en/5.0/topics/db/models/#relationships "Link to this heading")
Clearly, the power of relational databases lies in relating tables to each other. Django offers ways to define the three most common types of database relationships: many-to-one, many-to-many and one-to-one.
#### Many-to-one relationships[¶](https://docs.djangoproject.com/en/5.0/topics/db/models/#many-to-one-relationships "Link to this heading")
...
#### Many-to-many relationships[¶](https://docs.djangoproject.com/en/5.0/topics/db/models/#many-to-many-relationships "Link to this heading")
...
#### Extra fields on many-to-many relationships[¶](https://docs.djangoproject.com/en/5.0/topics/db/models/#extra-fields-on-many-to-many-relationships "Link to this heading")
...
#### One-to-one relationships[¶](https://docs.djangoproject.com/en/5.0/topics/db/models/#one-to-one-relationships "Link to this heading")
...
### Models across files[¶](https://docs.djangoproject.com/en/5.0/topics/db/models/#models-across-files "Link to this heading")
...
### Field name restrictions[¶](https://docs.djangoproject.com/en/5.0/topics/db/models/#field-name-restrictions "Link to this heading")
...
### Custom field types[¶](https://docs.djangoproject.com/en/5.0/topics/db/models/#custom-field-types "Link to this heading")
