...
# Node.js v25.8.0 documentation
  * Node.js v25.8.0
  * [](https://nodejs.org/docs/latest/api/embedding.html#toc-picker)
  ...
  * [](https://nodejs.org/docs/latest/api/embedding.html#gtoc-picker)
...
* * *
    ...
    * [Worker threads](https://nodejs.org/docs/latest/api/worker_threads.html)
    * [Zlib](https://nodejs.org/docs/latest/api/zlib.html)
  * [](https://nodejs.org/docs/latest/api/embedding.html#alt-docs)
    1. [25.x ](https://nodejs.org/docs/latest-v25.x/api/embedding.html)
    2. [24.x ](https://nodejs.org/docs/latest-v24.x/api/embedding.html)
    3. [23.x ](https://nodejs.org/docs/latest-v23.x/api/embedding.html)
    4. [22.x **LTS**](https://nodejs.org/docs/latest-v22.x/api/embedding.html)
    5. [21.x ](https://nodejs.org/docs/latest-v21.x/api/embedding.html)
    6. [20.x **LTS**](https://nodejs.org/docs/latest-v20.x/api/embedding.html)
    7. [19.x ](https://nodejs.org/docs/latest-v19.x/api/embedding.html)
    8. [18.x ](https://nodejs.org/docs/latest-v18.x/api/embedding.html)
    9. [17.x ](https://nodejs.org/docs/latest-v17.x/api/embedding.html)
    10. [16.x ](https://nodejs.org/docs/latest-v16.x/api/embedding.html)
    11. [15.x ](https://nodejs.org/docs/latest-v15.x/api/embedding.html)
    12. [14.x ](https://nodejs.org/docs/latest-v14.x/api/embedding.html)
    13. [13.x ](https://nodejs.org/docs/latest-v13.x/api/embedding.html)
    14. [12.x ](https://nodejs.org/docs/latest-v12.x/api/embedding.html)
  * [ ](https://nodejs.org/docs/latest/api/embedding.html#options-picker)
...
Because using Node.js as an embedded library is different from writing code that is executed by Node.js, breaking changes do not follow typical Node.js [deprecation policy](https://nodejs.org/docs/latest/api/deprecations.html) and may occur on each semver-major release without prior warning.
### Example embedding application[#](https://nodejs.org/docs/latest/api/embedding.html#example-embedding-application)
