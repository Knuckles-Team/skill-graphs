[ Skip to content ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color)
What's new — we've launched [Pydantic Logfire](https://pydantic.dev/articles/logfire-announcement) ![🔥](https://cdn.jsdelivr.net/gh/jdecked/twemoji@15.0.3/assets/svg/1f525.svg) to help you monitor and understand your [Pydantic val](https://logfire.pydantic.dev/docs/integrations/pydantic/)
...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * API Documentation
    ...
    * Pydantic Extra Types
      * Color  [ Color  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/)
        * [ color  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color)
        * [ RGBA  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.RGBA)
        * [ Color  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.Color)
          * [ original  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.Color.original)
          * [ as_named  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.Color.as_named)
          * [ as_hex  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.Color.as_hex)
          * [ as_rgb  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.Color.as_rgb)
          * [ as_rgb_tuple  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.Color.as_rgb_tuple)
          * [ as_hsl  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.Color.as_hsl)
          * [ as_hsl_tuple  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.Color.as_hsl_tuple)
        * [ parse_tuple  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.parse_tuple)
        * [ parse_str  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.parse_str)
        * [ ints_to_rgba  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.ints_to_rgba)
        * [ parse_color_value  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.parse_color_value)
        * [ parse_float_alpha  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.parse_float_alpha)
        * [ parse_hsl  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.parse_hsl)
        * [ float_to_255  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.float_to_255)
...
---|---|---|---
`fallback` |  |  If True, falls back to returning the hexadecimal representation of the color instead of raising a ValueError when no named color is found. |  `False`
Returns:
Type | Description
---|---
...
###  as_hex [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.Color.as_hex)
```
as_hex(format: ['short', 'long'] = 'short') ->
...
###  as_rgb_tuple [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.Color.as_rgb_tuple)
```
as_rgb_tuple(*, alpha:  | None = None) -> ColorTuple
...
###  as_hsl_tuple [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.Color.as_hsl_tuple)
```
as_hsl_tuple(*, alpha:  | None = None) -> HslColorTuple
...
##  parse_tuple [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.parse_tuple)
```
parse_tuple(value: [, ...]) -> RGBA[](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.RGBA)
...
Name | Type | Description | Default
---|---|---|---
`value` |  |  A tuple or list. |  _required_
Returns:
Type | Description
---|---
`RGBA[](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.RGBA)` |  An `RGBA` tuple parsed from the input tuple.
Raises:
Type | Description
---|---
`PydanticCustomError[](https://docs.pydantic.dev/latest/api/pydantic_core/#pydantic_core.PydanticCustomError)` |  If tuple is not valid.
Source code in `pydantic_extra_types/color.py`
```
238
239
...
##  parse_str [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.parse_str)
```
parse_str(value: ) -> RGBA[](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.RGBA)
...
Name | Type | Description | Default
---|---|---|---
`value` |  |  A string representing a color. |  _required_
Returns:
Type | Description
---|---
`RGBA[](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.RGBA)` |  An `RGBA` tuple parsed from the input string.
Raises:
Type | Description
---|---
...
Name | Type | Description | Default
---|---|---|---
`r` |  |  An integer or string representing the red color value. |  _required_
`g` |  |  An integer or string representing the green color value. |  _required_
`b` |  |  An integer or string representing the blue color value. |  _required_
`alpha` |  |  A float representing the alpha value. Defaults to None. |  `None`
Returns:
Type | Description
---|---
`RGBA[](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.RGBA)` |  An instance of the `RGBA` class with the corresponding color and alpha values.
Source code in `pydantic_extra_types/color.py`
```
317
318
...
Name | Type | Description | Default
---|---|---|---
`value` |  |  An integer or string color value. |  _required_
`max_val` |  |  Maximum range value. Defaults to 255. |  `255`
Raises:
Type | Description
---|---
`PydanticCustomError[](https://docs.pydantic.dev/latest/api/pydantic_core/#pydantic_core.PydanticCustomError)` |  If the value is not a valid color.
Returns:
Type | Description
---|---
...
Name | Type | Description | Default
---|---|---|---
`value` |  `None | ` |  The input value to parse. |  _required_
Returns:
Type | Description
---|---
...
Type | Description
---|---
`PydanticCustomError[](https://docs.pydantic.dev/latest/api/pydantic_core/#pydantic_core.PydanticCustomError)` |  If the input value cannot be successfully parsed as a float in the expected range.
Source code in `pydantic_extra_types/color.py`
```
372
373
...
Name | Type | Description | Default
---|---|---|---
`h` |  |  The hue value. |  _required_
`h_units` |  |  The unit for hue value. |  _required_
`sat` |  |  The saturation value. |  _required_
`light` |  |  The lightness value. |  _required_
`alpha` |  |  Alpha value. |  `None`
Returns:
Type | Description
---|---
`RGBA[](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/#pydantic_extra_types.color.RGBA)` |  An instance of `RGBA`.
Source code in `pydantic_extra_types/color.py`
```
408
409
...
Name | Type | Description | Default
---|---|---|---
`c` |  |  The float value to be converted. Must be between 0 and 1 (inclusive). |  _required_
Returns:
Type | Description
---|---
