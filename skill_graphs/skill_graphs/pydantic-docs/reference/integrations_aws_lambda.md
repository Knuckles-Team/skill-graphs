[ Skip to content ](https://docs.pydantic.dev/latest/integrations/aws_lambda/#installing-python-libraries-for-aws-lambda-functions)
...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * Integrations
    ...
    * Production Tools
      * AWS Lambda  [ AWS Lambda  ](https://docs.pydantic.dev/latest/integrations/aws_lambda/)
        * [ Installing Python libraries for AWS Lambda functions  ](https://docs.pydantic.dev/latest/integrations/aws_lambda/#installing-python-libraries-for-aws-lambda-functions)
        * [ Installing pydantic for AWS Lambda functions  ](https://docs.pydantic.dev/latest/integrations/aws_lambda/#installing-pydantic-for-aws-lambda-functions)
        * [ Troubleshooting  ](https://docs.pydantic.dev/latest/integrations/aws_lambda/#troubleshooting)
          * [ Missing pydantic_core module  ](https://docs.pydantic.dev/latest/integrations/aws_lambda/#missing-pydantic_core-module)
          * [ No package metadata was found for email-validator  ](https://docs.pydantic.dev/latest/integrations/aws_lambda/#no-package-metadata-was-found-for-email-validator)
        * [ Extra Resources  ](https://docs.pydantic.dev/latest/integrations/aws_lambda/#extra-resources)
          * [ More Debugging Tips  ](https://docs.pydantic.dev/latest/integrations/aws_lambda/#more-debugging-tips)
          * [ Validating event and context data  ](https://docs.pydantic.dev/latest/integrations/aws_lambda/#validating-event-and-context-data)
  * [ Blog  ](https://blog.pydantic.dev/)
  * [ Pydantic People  ](https://docs.pydantic.dev/latest/pydantic_people/)
  ...
  * [ Extra Resources  ](https://docs.pydantic.dev/latest/integrations/aws_lambda/#extra-resources)
  ...
  2. [ Production Tools  ](https://docs.pydantic.dev/latest/integrations/aws_lambda/)
...
## Installing Python libraries for AWS Lambda functions[¶](https://docs.pydantic.dev/latest/integrations/aws_lambda/#installing-python-libraries-for-aws-lambda-functions)
There are many ways to utilize Python libraries in AWS Lambda functions. As outlined in the
  * Using a
  * Using
  * Using a
...
```
pip install \
    --platform manylinux2014_x86_64 \  [](https://docs.pydantic.dev/latest/integrations/aws_lambda/#__code_0_annotation_1)
    --target=<your_package_dir> \  [](https://docs.pydantic.dev/latest/integrations/aws_lambda/#__code_0_annotation_2)
    --implementation cp \  [](https://docs.pydantic.dev/latest/integrations/aws_lambda/#__code_0_annotation_3)
    --python-version 3.10 \  [](https://docs.pydantic.dev/latest/integrations/aws_lambda/#__code_0_annotation_4)
    --only-binary=:all: \  [](https://docs.pydantic.dev/latest/integrations/aws_lambda/#__code_0_annotation_5)
    --upgrade pydantic  [](https://docs.pydantic.dev/latest/integrations/aws_lambda/#__code_0_annotation_6)
...
### No package metadata was found for `email-validator`[¶](https://docs.pydantic.dev/latest/integrations/aws_lambda/#no-package-metadata-was-found-for-email-validator)
Pydantic uses `version` from `importlib.metadata` to `email-validator` is installed. This package versioning mechanism is somewhat incompatible with AWS Lambda, even though it's the industry standard for versioning packages in Python. There are a few ways to fix this issue:
If you're deploying your lambda with the serverless framework, it's likely that the appropriate metadata for the `email-validator` package is not being included in your deployment package. Tools like `slim` setting to false in your `serverless.yml` file:
```
pythonRequirements:
...
You can read more about this fix, and other `slim` settings that might be relevant in this
...
This issue has been reported for other popular python libraries like
## Extra Resources[¶](https://docs.pydantic.dev/latest/integrations/aws_lambda/#extra-resources)
### More Debugging Tips[¶](https://docs.pydantic.dev/latest/integrations/aws_lambda/#more-debugging-tips)
If you're still struggling with installing `pydantic` for your AWS Lambda, you might consult with
### Validating `event` and `context` data[¶](https://docs.pydantic.dev/latest/integrations/aws_lambda/#validating-event-and-context-data)
