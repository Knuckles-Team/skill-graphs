[ Skip to content ](https://docs.pydantic.dev/latest/api/experimental/#experimental-api)
...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * API Documentation
    * Pydantic
      ...
      * Experimental  [ Experimental  ](https://docs.pydantic.dev/latest/api/experimental/)
        * [ Pipeline API  ](https://docs.pydantic.dev/latest/api/experimental/#pipeline-api)
        * [ pipeline  ](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline)
        * [ _Pipeline  ](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)
          * [ transform  ](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.transform)
          * [ validate_as  ](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.validate_as)
          * [ validate_as_deferred  ](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.validate_as_deferred)
          * [ constrain  ](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.constrain)
          * [ predicate  ](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.predicate)
          * [ gt  ](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.gt)
          * [ lt  ](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.lt)
          * [ ge  ](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.ge)
          * [ le  ](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.le)
          * [ len  ](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.len)
          * [ multiple_of  ](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.multiple_of)
          * [ eq  ](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.eq)
          * [ not_eq  ](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.not_eq)
          * [ in_  ](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.in_)
          * [ not_in  ](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.not_in)
          * [ otherwise  ](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.otherwise)
          * [ then  ](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.then)
        * [ Arguments schema API  ](https://docs.pydantic.dev/latest/api/experimental/#arguments-schema-api)
        * [ arguments_schema  ](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.arguments_schema)
        * [ generate_arguments_schema  ](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.arguments_schema.generate_arguments_schema)
    * Pydantic Core
...
# Experimental API[¶](https://docs.pydantic.dev/latest/api/experimental/#experimental-api)
## Pipeline API[¶](https://docs.pydantic.dev/latest/api/experimental/#pipeline-api)
Experimental pipeline API functionality. Be careful with this API, it's subject to change.
##  _Pipeline `dataclass` [¶](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)
```
_Pipeline(_steps: [_Step, ...])
...
transform(
    func: [[_OutT], _NewOutT]
) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _NewOutT]
...
validate_as(
    tp: , *, strict:  = ...
) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, ]
...
###  constrain [¶](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.constrain)
```
constrain(constraint: Ge) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _NewOutGe]

```

```
constrain(constraint: Gt) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _NewOutGt]

```

```
constrain(constraint: Le) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _NewOutLe]

```

```
constrain(constraint: Lt) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _NewOutLt]

```

```
constrain(constraint: Len) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _NewOutLen]
...
constrain(
    constraint: Timezone,
) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _NewOutDatetime]

```

```
constrain(constraint: Predicate) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _OutT]
...
constrain(
    constraint: Interval,
) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _NewOutInterval]

```

```
constrain(constraint: _Eq) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _OutT]

```

```
constrain(constraint: _NotEq) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _OutT]

```

```
constrain(constraint: _In) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _OutT]

```

```
constrain(constraint: _NotIn) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _OutT]
...
```
constrain(constraint: _ConstraintAnnotation) ->
...
###  gt [¶](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.gt)
```
gt(gt: _NewOutGt) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _NewOutGt]
...
###  lt [¶](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.lt)
```
lt(lt: _NewOutLt) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _NewOutLt]
...
###  ge [¶](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.ge)
```
ge(ge: _NewOutGe) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _NewOutGe]
...
###  le [¶](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.le)
```
le(le: _NewOutLe) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _NewOutLe]
...
) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _NewOutLen]
...
) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _NewOutDiv]
...
) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _NewOutMod]

```

```
multiple_of(multiple_of: ) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, ]
...
###  eq [¶](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.eq)
```
eq(value: _OutT) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _OutT]
...
###  not_eq [¶](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.not_eq)
```
not_eq(value: _OutT) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _OutT]
...
###  in_ [¶](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.in_)
```
in_(values: [_OutT]) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _OutT]
...
###  not_in [¶](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline.not_in)
```
not_in(values: [_OutT]) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _OutT]
...
```
otherwise(
    other: _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_OtherIn, _OtherOut]
) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT | _OtherIn, _OutT | _OtherOut]
...
```
then(
    other: _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_OutT, _OtherOut]
) -> _Pipeline[](https://docs.pydantic.dev/latest/api/experimental/#pydantic.experimental.pipeline._Pipeline)[_InT, _OtherOut]
...
---|---|---|---
`func` |  |  The function to generate the schema for. |  _required_
`schema_type` |  |  The type of schema to generate. |  `'arguments-v3'`
`parameters_callback` |  |  A callable that will be invoked for each parameter. The callback should take three required arguments: the index, the name and the type annotation (or `'skip'`, so that the parameter gets excluded from the resulting schema. |  `None`
`config` |  `ConfigDict[](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict) | None` |  The configuration to use. |  `None`
Returns:
Type | Description
---|---
