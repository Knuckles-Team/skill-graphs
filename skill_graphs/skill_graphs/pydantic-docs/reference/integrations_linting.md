[ Skip to content ](https://docs.pydantic.dev/latest/integrations/linting/#flake8-plugin)
...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * Integrations
    ...
    * Dev Tools
      ...
      * Linting  [ Linting  ](https://docs.pydantic.dev/latest/integrations/linting/)
        * [ Flake8 plugin  ](https://docs.pydantic.dev/latest/integrations/linting/#flake8-plugin)
...
# Linting
## Flake8 plugin[¶](https://docs.pydantic.dev/latest/integrations/linting/#flake8-plugin)
If using Flake8 in your project, a
```
