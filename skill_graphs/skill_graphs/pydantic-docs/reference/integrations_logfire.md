[ Skip to content ](https://docs.pydantic.dev/latest/integrations/logfire/#getting-started)
...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * Integrations
    * Pydantic Logfire  [ Pydantic Logfire  ](https://docs.pydantic.dev/latest/integrations/logfire/)
      * [ Getting Started  ](https://docs.pydantic.dev/latest/integrations/logfire/#getting-started)
        * [ Basic Usage  ](https://docs.pydantic.dev/latest/integrations/logfire/#basic-usage)
        * [ Pydantic Instrumentation  ](https://docs.pydantic.dev/latest/integrations/logfire/#pydantic-instrumentation)
...
logfire.configure()  [](https://docs.pydantic.dev/latest/integrations/logfire/#__code_0_annotation_1)
...
logfire.info('user processed: {user!r}', user=user)  [](https://docs.pydantic.dev/latest/integrations/logfire/#__code_0_annotation_2)
...
logfire.configure()
logfire.instrument_pydantic()  [](https://docs.pydantic.dev/latest/integrations/logfire/#__code_1_annotation_1)
