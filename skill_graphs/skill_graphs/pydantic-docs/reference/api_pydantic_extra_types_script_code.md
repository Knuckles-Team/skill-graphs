[ Skip to content ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_script_code/#pydantic_extra_types.script_code)
...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * API Documentation
    ...
    * Pydantic Extra Types
      ...
      * Script Code  [ Script Code  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_script_code/)
        * [ script_code  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_script_code/#pydantic_extra_types.script_code)
        * [ ISO_15924  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_script_code/#pydantic_extra_types.script_code.ISO_15924)
