[ Skip to content ](https://docs.pydantic.dev/latest/concepts/validators/#field-validators)
...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * Concepts
    ...
    * Validators  [ Validators  ](https://docs.pydantic.dev/latest/concepts/validators/)
      * [ Field validators  ](https://docs.pydantic.dev/latest/concepts/validators/#field-validators)
        * [ Which validator pattern to use  ](https://docs.pydantic.dev/latest/concepts/validators/#which-validator-pattern-to-use)
          * [ Using the annotated pattern  ](https://docs.pydantic.dev/latest/concepts/validators/#using-the-annotated-pattern)
          * [ Using the decorator pattern  ](https://docs.pydantic.dev/latest/concepts/validators/#using-the-decorator-pattern)
      * [ Model validators  ](https://docs.pydantic.dev/latest/concepts/validators/#model-validators)
      * [ Raising validation errors  ](https://docs.pydantic.dev/latest/concepts/validators/#raising-validation-errors)
      * [ Validation info  ](https://docs.pydantic.dev/latest/concepts/validators/#validation-info)
        * [ Validation data  ](https://docs.pydantic.dev/latest/concepts/validators/#validation-data)
        * [ Validation context  ](https://docs.pydantic.dev/latest/concepts/validators/#validation-context)
      * [ Ordering of validators  ](https://docs.pydantic.dev/latest/concepts/validators/#ordering-of-validators)
      * [ Special types  ](https://docs.pydantic.dev/latest/concepts/validators/#special-types)
      * [ JSON Schema and field validators  ](https://docs.pydantic.dev/latest/concepts/validators/#json-schema-and-field-validators)
...
* * *
  ...
  * Model validators
* * *
    * [model _before_ validators](https://docs.pydantic.dev/latest/concepts/validators/#model-before-validator)
    * [model _after_ validators](https://docs.pydantic.dev/latest/concepts/validators/#model-after-validator)
    * [model _wrap_ validators](https://docs.pydantic.dev/latest/concepts/validators/#model-wrap-validator)
...
[Annotated pattern](https://docs.pydantic.dev/latest/concepts/validators/#__tabbed_1_1)[Decorator](https://docs.pydantic.dev/latest/concepts/validators/#__tabbed_1_2)
...
def is_even(value: int) -> int:
    ...
    return value  [](https://docs.pydantic.dev/latest/concepts/validators/#__code_0_annotation_1)
...
[](https://docs.pydantic.dev/latest/concepts/validators/#__code_1_annotation_1)
    @classmethod
...
[](https://docs.pydantic.dev/latest/concepts/validators/#__code_1_annotation_2)
...
[Annotated pattern](https://docs.pydantic.dev/latest/concepts/validators/#__tabbed_2_1)[Decorator](https://docs.pydantic.dev/latest/concepts/validators/#__tabbed_2_2)
```
from typing import Annotated
...
[](https://docs.pydantic.dev/latest/concepts/validators/#__code_3_annotation_1)
    @classmethod
...
def ensure_list(value: Any) -> Any:  [](https://docs.pydantic.dev/latest/concepts/validators/#__code_4_annotation_1)
    if not isinstance(value, list):  [](https://docs.pydantic.dev/latest/concepts/validators/#__code_4_annotation_2)
        return [value]
    else:
        return value
...
try:
    ...
    print(err)  [](https://docs.pydantic.dev/latest/concepts/validators/#__code_4_annotation_3)
    """
    1 validation error for Model
    numbers.0
...
[](https://docs.pydantic.dev/latest/concepts/validators/#__code_5_annotation_1)
        if not isinstance(value, list):

[](https://docs.pydantic.dev/latest/concepts/validators/#__code_5_annotation_2)
            return [value]
        else:
            return value
...
[](https://docs.pydantic.dev/latest/concepts/validators/#__code_5_annotation_3)
    """
    1 validation error for Model
    numbers.0
      Input should be a valid integer, unable to parse string as an integer [type=int_parsing, input_value='str', input_type=str]
...
```
    ...
    1. Notice the use of `value`. _Before_ validators take the raw input, which can be anything.
...
[Annotated pattern](https://docs.pydantic.dev/latest/concepts/validators/#__tabbed_4_1)[Decorator](https://docs.pydantic.dev/latest/concepts/validators/#__tabbed_4_2)
```
from typing import Annotated, Any
...
#> number=8
print(Model(number='invalid'))  [](https://docs.pydantic.dev/latest/concepts/validators/#__code_6_annotation_1)
#> number='invalid'
...
[](https://docs.pydantic.dev/latest/concepts/validators/#__code_7_annotation_1)
#> number='invalid'
...
Such validators must be defined with a **mandatory** extra _handler_ parameter: a callable taking the value to be validated as an argument. Internally, this handler will delegate validation of the value to Pydantic. You are free to wrap the call to the handler in a
[Annotated pattern](https://docs.pydantic.dev/latest/concepts/validators/#__tabbed_5_1)[Decorator](https://docs.pydantic.dev/latest/concepts/validators/#__tabbed_5_2)
```
from typing import Any
...
As mentioned in the [fields documentation](https://docs.pydantic.dev/latest/concepts/fields/#validate-default-values), default values of fields are _not_ validated unless configured to do so, and thus custom validators will not be applied as well.
### Which validator pattern to use[¶](https://docs.pydantic.dev/latest/concepts/validators/#which-validator-pattern-to-use)
...
class Model3(BaseModel):
    list_of_even_numbers: list[EvenNumber]  [](https://docs.pydantic.dev/latest/concepts/validators/#__code_10_annotation_1)
...
class UserModel(BaseModel):
    ...
    @classmethod
    def check_card_number_not_present(cls, data: Any) -> Any:  [](https://docs.pydantic.dev/latest/concepts/validators/#__code_13_annotation_1)
        if isinstance(data, dict):  [](https://docs.pydantic.dev/latest/concepts/validators/#__code_13_annotation_2)
...
Both the field and model validators callables (in all modes) can optionally take an extra [`ValidationInfo`](https://docs.pydantic.dev/latest/api/pydantic_core_schema/#pydantic_core.core_schema.ValidationInfo) argument, providing useful extra information, such as:
  ...
  * the current [validation mode](https://docs.pydantic.dev/latest/concepts/models/#validating-data): either `'python'`, `'json'` or `'strings'` (see the [`mode`](https://docs.pydantic.dev/latest/api/pydantic_core_schema/#pydantic_core.core_schema.ValidationInfo.mode) property)
  * the current field name, if using a [field validator](https://docs.pydantic.dev/latest/concepts/validators/#field-validators) (see the [`field_name`](https://docs.pydantic.dev/latest/api/pydantic_core_schema/#pydantic_core.core_schema.ValidationInfo.field_name) property).
...
Warning
As validation is performed in the [order fields are defined](https://docs.pydantic.dev/latest/concepts/models/#field-ordering), you have to make sure you are not accessing a field that hasn't been validated yet. In the code above, for example, the `username` validated value is not available yet, as it is defined _after_ `password_repeat`.
...
It is currently not possible to provide a context when directly instantiating a model (i.e. when calling `Model(...)`). You can work around this through the use of a `__init__` method:
```
...
m = Model(names=['foo', 123])  [](https://docs.pydantic.dev/latest/concepts/validators/#__code_21_annotation_1)
print(m)
#> names=['foo', 123]

```

  * [`ValidateAs`](https://docs.pydantic.dev/latest/api/functional_validators/#pydantic.functional_validators.ValidateAs) can be used to validate an custom type from a type natively supported by Pydantic. This is particularly useful when using custom types with multiple fields.
```
from typing import Annotated
...
As a convenience, Pydantic will use the field type if the argument is not provided (unless you are using a [_plain_](https://docs.pydantic.dev/latest/concepts/validators/#field-plain-validator) validator, in which case `json_schema_input_type` defaults to
