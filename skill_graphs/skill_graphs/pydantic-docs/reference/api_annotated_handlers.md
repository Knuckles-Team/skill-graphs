[ Skip to content ](https://docs.pydantic.dev/latest/api/annotated_handlers/#pydantic.annotated_handlers)
...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * API Documentation
    * Pydantic
      ...
      * Annotated Handlers  [ Annotated Handlers  ](https://docs.pydantic.dev/latest/api/annotated_handlers/)
        * [ annotated_handlers  ](https://docs.pydantic.dev/latest/api/annotated_handlers/#pydantic.annotated_handlers)
        * [ GetJsonSchemaHandler  ](https://docs.pydantic.dev/latest/api/annotated_handlers/#pydantic.annotated_handlers.GetJsonSchemaHandler)
          * [ resolve_ref_schema  ](https://docs.pydantic.dev/latest/api/annotated_handlers/#pydantic.annotated_handlers.GetJsonSchemaHandler.resolve_ref_schema)
        * [ GetCoreSchemaHandler  ](https://docs.pydantic.dev/latest/api/annotated_handlers/#pydantic.annotated_handlers.GetCoreSchemaHandler)
          * [ field_name  ](https://docs.pydantic.dev/latest/api/annotated_handlers/#pydantic.annotated_handlers.GetCoreSchemaHandler.field_name)
          * [ generate_schema  ](https://docs.pydantic.dev/latest/api/annotated_handlers/#pydantic.annotated_handlers.GetCoreSchemaHandler.generate_schema)
          * [ resolve_ref_schema  ](https://docs.pydantic.dev/latest/api/annotated_handlers/#pydantic.annotated_handlers.GetCoreSchemaHandler.resolve_ref_schema)
...
---|---|---
`mode` |  `JsonSchemaMode[](https://docs.pydantic.dev/latest/api/json_schema/#pydantic.json_schema.JsonSchemaMode)` |  Json schema mode, can be `validation` or `serialization`.
###  resolve_ref_schema [¶](https://docs.pydantic.dev/latest/api/annotated_handlers/#pydantic.annotated_handlers.GetJsonSchemaHandler.resolve_ref_schema)
```
resolve_ref_schema(
    maybe_ref_json_schema: JsonSchemaValue[](https://docs.pydantic.dev/latest/api/json_schema/#pydantic.json_schema.JsonSchemaValue),
...
---|---|---|---
`maybe_ref_json_schema` |  `JsonSchemaValue[](https://docs.pydantic.dev/latest/api/json_schema/#pydantic.json_schema.JsonSchemaValue)` |  A JsonSchemaValue which may be a `$ref` schema. |  _required_
Raises:
Type | Description
---|---
...
Name | Type | Description
---|---|---
`JsonSchemaValue` |  `JsonSchemaValue[](https://docs.pydantic.dev/latest/api/json_schema/#pydantic.json_schema.JsonSchemaValue)` |  A JsonSchemaValue that has no `$ref`.
...
###  field_name `property` [¶](https://docs.pydantic.dev/latest/api/annotated_handlers/#pydantic.annotated_handlers.GetCoreSchemaHandler.field_name)
```
field_name:  | None
...
###  generate_schema [¶](https://docs.pydantic.dev/latest/api/annotated_handlers/#pydantic.annotated_handlers.GetCoreSchemaHandler.generate_schema)
```
generate_schema(source_type: ) -> CoreSchema
...
Name | Type | Description | Default
---|---|---|---
`source_type` |  |  The input type. |  _required_
Returns:
Name | Type | Description
---|---|---
