[ Skip to content ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings)
What's new — we've launched [Pydantic Logfire](https://pydantic.dev/articles/logfire-announcement) ![🔥](https://cdn.jsdelivr.net/gh/jdecked/twemoji@15.0.3/assets/svg/1f525.svg) to help you monitor and understand your [Pydanti](https://logfire.pydantic.dev/docs/integrations/pydantic/)
...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * API Documentation
    ...
    * Pydantic Settings  [ Pydantic Settings  ](https://docs.pydantic.dev/latest/api/pydantic_settings/)
      * [ pydantic_settings  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings)
      * [ BaseSettings  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.BaseSettings)
        * [ settings_customise_sources  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.BaseSettings.settings_customise_sources)
      * [ CliApp  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.CliApp)
        * [ run  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.CliApp.run)
        * [ run_subcommand  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.CliApp.run_subcommand)
      * [ SettingsConfigDict  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.SettingsConfigDict)
        * [ pyproject_toml_depth  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.SettingsConfigDict.pyproject_toml_depth)
        * [ pyproject_toml_table_header  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.SettingsConfigDict.pyproject_toml_table_header)
      * [ CliSettingsSource  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.CliSettingsSource)
        * [ root_parser  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.CliSettingsSource.root_parser)
      ...
      * [ PydanticBaseSettingsSource  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.PydanticBaseSettingsSource)
        * [ current_state  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.PydanticBaseSettingsSource.current_state)
        * [ settings_sources_data  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.PydanticBaseSettingsSource.settings_sources_data)
        * [ get_field_value  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.PydanticBaseSettingsSource.get_field_value)
      ...
      * [ SecretsSettingsSource  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.SecretsSettingsSource)
        * [ find_case_path  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.SecretsSettingsSource.find_case_path)
  ...
  * [ PydanticBaseSettingsSource  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.PydanticBaseSettingsSource)
    ...
    * [ prepare_field_value  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.PydanticBaseSettingsSource.prepare_field_value)
    * [ decode_complex_value  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.PydanticBaseSettingsSource.decode_complex_value)
  * [ PyprojectTomlConfigSettingsSource  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.PyprojectTomlConfigSettingsSource "PyprojectTomlConfigSettingsSource")
  * [ SecretsSettingsSource  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.SecretsSettingsSource)
    * [ find_case_path  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.SecretsSettingsSource.find_case_path)
    * [ get_field_value  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.SecretsSettingsSource.get_field_value)
  * [ TomlConfigSettingsSource  ](https://docs.pydantic.dev/latest/api/pydantic_settings/#pydantic_settings.TomlConfigSettingsSource)
