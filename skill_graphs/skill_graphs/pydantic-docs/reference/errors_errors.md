[ Skip to content ](https://docs.pydantic.dev/latest/errors/errors/#error-messages)
What's new — we've launched [Pydantic Logfire](https://pydantic.dev/articles/logfire-announcement) ![🔥](https://cdn.jsdelivr.net/gh/jdecked/twemoji@15.0.3/assets/svg/1f525.svg) to help you monitor and understand your [Pydantic va](https://logfire.pydantic.dev/docs/integrations/pydantic/)
...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * Error Messages
    * Error Handling  [ Error Handling  ](https://docs.pydantic.dev/latest/errors/errors/)
      * [ Error messages  ](https://docs.pydantic.dev/latest/errors/errors/#error-messages)
        * [ Customize error messages  ](https://docs.pydantic.dev/latest/errors/errors/#customize-error-messages)
...
# Error Handling
Pydantic will raise a [`ValidationError`](https://docs.pydantic.dev/latest/api/pydantic_core/#pydantic_core.ValidationError) whenever it finds an error in the data it's validating.
Note
Validation code should not raise the [`ValidationError`](https://docs.pydantic.dev/latest/api/pydantic_core/#pydantic_core.ValidationError) itself, but rather raise a [`ValidationError`](https://docs.pydantic.dev/latest/api/pydantic_core/#pydantic_core.ValidationError).
For more details, refer to the [dedicated section](https://docs.pydantic.dev/latest/concepts/validators/#raising-validation-errors) of the validators documentation.
That [`ValidationError`](https://docs.pydantic.dev/latest/api/pydantic_core/#pydantic_core.ValidationError) will contain information about all the errors and how they happened.
You can access these errors in several ways:
Method | Description
---|---
[`errors()`](https://docs.pydantic.dev/latest/api/pydantic_core/#pydantic_core.ValidationError.errors) | Returns a list of [`ErrorDetails`](https://docs.pydantic.dev/latest/api/pydantic_core/#pydantic_core.ErrorDetails) errors found in the input data.
[`error_count()`](https://docs.pydantic.dev/latest/api/pydantic_core/#pydantic_core.ValidationError.error_count) | Returns the number of errors.
[`json()`](https://docs.pydantic.dev/latest/api/pydantic_core/#pydantic_core.ValidationError.json) | Returns a JSON representation of the list errors.
`str(e)` | Returns a human-readable representation of the errors.
The [`ErrorDetails`](https://docs.pydantic.dev/latest/api/pydantic_core/#pydantic_core.ErrorDetails) object is a dictionary. It contains the following:
Property | Description
---|---
[`ctx`](https://docs.pydantic.dev/latest/api/pydantic_core/#pydantic_core.ErrorDetails.ctx) | An optional object which contains values required to render the error message.
[`input`](https://docs.pydantic.dev/latest/api/pydantic_core/#pydantic_core.ErrorDetails.input) | The input provided for validation.
[`loc`](https://docs.pydantic.dev/latest/api/pydantic_core/#pydantic_core.ErrorDetails.loc) | The error's location as a list.
[`msg`](https://docs.pydantic.dev/latest/api/pydantic_core/#pydantic_core.ErrorDetails.msg) | A human-readable explanation of the error.
[`type`](https://docs.pydantic.dev/latest/api/pydantic_core/#pydantic_core.ErrorDetails.type) | A computer-readable identifier of the error type.
[`url`](https://docs.pydantic.dev/latest/api/pydantic_core/#pydantic_core.ErrorDetails.url) | The documentation URL giving information about the error.
The first item in the [`loc`](https://docs.pydantic.dev/latest/api/pydantic_core/#pydantic_core.ErrorDetails.loc) list will be the field where the error occurred, and if the field is a [sub-model](https://docs.pydantic.dev/latest/concepts/models/#nested-models), subsequent items will be present to indicate the nested location of the error.
As a demonstration:
```
...
Pydantic attempts to provide useful default error messages for validation and usage errors, which can be found here:
  * [Validation Errors](https://docs.pydantic.dev/latest/errors/validation_errors/): Errors that happen during data validation.
  * [Usage Errors](https://docs.pydantic.dev/latest/errors/usage_errors/): Errors that happen when using Pydantic.
...
[Python 3.9 and above](https://docs.pydantic.dev/latest/errors/errors/#__tabbed_1_1)[Python 3.10 and above](https://docs.pydantic.dev/latest/errors/errors/#__tabbed_1_2)
```
...
try:
    ...
    print(e.errors())  [](https://docs.pydantic.dev/latest/errors/errors/#__code_2_annotation_1)
    """
    [
        {
            'type': 'missing',
    ...
    print(pretty_errors)  [](https://docs.pydantic.dev/latest/errors/errors/#__code_2_annotation_2)
    """
    [
        {
            'type': 'missing',
...
[](https://docs.pydantic.dev/latest/errors/errors/#__code_3_annotation_1)
    """
    [
        {
            'type': 'missing',
...
[](https://docs.pydantic.dev/latest/errors/errors/#__code_3_annotation_2)
    """
    [
        {
            'type': 'missing',
