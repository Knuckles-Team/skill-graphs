[ Skip to content ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment)
What's new — we've launched [Pydantic Logfire](https://pydantic.dev/articles/logfire-announcement) ![🔥](https://cdn.jsdelivr.net/gh/jdecked/twemoji@15.0.3/assets/svg/1f525.svg) to help you monitor and understand your [Pydantic valida](https://logfire.pydantic.dev/docs/integrations/pydantic/)
...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * API Documentation
    ...
    * Pydantic Extra Types
      ...
      * Payment  [ Payment  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/)
        * [ payment  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment)
        * [ PaymentCardBrand  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardBrand)
        * [ PaymentCardNumber  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber)
          * [ strip_whitespace  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber.strip_whitespace)
          * [ min_length  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber.min_length)
          * [ max_length  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber.max_length)
          * [ bin  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber.bin)
          * [ last4  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber.last4)
          * [ brand  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber.brand)
          * [ masked  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber.masked)
          * [ validate  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber.validate)
          * [ validate_digits  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber.validate_digits)
          * [ validate_luhn_check_digit  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber.validate_luhn_check_digit)
          * [ validate_brand  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber.validate_brand)
  ...
  * [ PaymentCardNumber  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber)
  ...
  2. [ Pydantic Extra Types  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_color/)


# Payment
The `pydantic_extra_types.payment` module provides the [`PaymentCardNumber`](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber) data type.
##  PaymentCardBrand [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardBrand)
Bases:
Payment card brands supported by the [`PaymentCardNumber`](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber).
##  PaymentCardNumber [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber)
```
...
---|---
###  strip_whitespace `class-attribute` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber.strip_whitespace)
```
...
###  min_length `class-attribute` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber.min_length)
```
min_length:  = 12
...
###  max_length `class-attribute` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber.max_length)
```
max_length:  = 19
...
###  bin `instance-attribute` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber.bin)
```
bin:  = card_number[:6]
...
###  last4 `instance-attribute` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber.last4)
```
last4:  = card_number[-4:]
...
###  brand `instance-attribute` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber.brand)
```
brand: PaymentCardBrand[](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardBrand) = validate_brand(card_number)

```

The brand of the card.
###  masked `property` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber.masked)
```
masked:
...
###  validate `classmethod` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber.validate)
```
validate(
    __input_value: , _: ValidationInfo[](https://docs.pydantic.dev/latest/api/pydantic_core_schema/#pydantic_core.core_schema.ValidationInfo)
) -> PaymentCardNumber[](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber)
...
---|---|---|---
`__input_value` |  |  The input value to validate. |  _required_
`_` |  `ValidationInfo[](https://docs.pydantic.dev/latest/api/pydantic_core_schema/#pydantic_core.core_schema.ValidationInfo)` |  The validation info. |  _required_
Returns:
Type | Description
---|---
`PaymentCardNumber[](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber)` |  The validated `PaymentCardNumber` instance.
Source code in `pydantic_extra_types/payment.py`
```
69
70
...
---|---
###  validate_digits `classmethod` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber.validate_digits)
```
...
Name | Type | Description | Default
---|---|---|---
`card_number` |  |  The card number to validate. |  _required_
Raises:
Type | Description
---|---
`PydanticCustomError[](https://docs.pydantic.dev/latest/api/pydantic_core/#pydantic_core.PydanticCustomError)` |  If the card number is not all digits.
Source code in `pydantic_extra_types/payment.py`
```
88
89
...
---|---
###  validate_luhn_check_digit `classmethod` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber.validate_luhn_check_digit)
```
validate_luhn_check_digit(card_number: ) ->

```

Validate the payment card number. Based on the
Parameters:
Name | Type | Description | Default
---|---|---|---
`card_number` |  |  The card number to validate. |  _required_
...
Type | Description
---|---
`PydanticCustomError[](https://docs.pydantic.dev/latest/api/pydantic_core/#pydantic_core.PydanticCustomError)` |  If the card number is not valid.
Source code in `pydantic_extra_types/payment.py`
```
101
102
...
---|---
###  validate_brand `staticmethod` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardNumber.validate_brand)
```
validate_brand(card_number: ) -> PaymentCardBrand[](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardBrand)
...
Type | Description
---|---
`PaymentCardBrand[](https://docs.pydantic.dev/latest/api/pydantic_extra_types_payment/#pydantic_extra_types.payment.PaymentCardBrand)` |  The validated card brand.
Raises:
Type | Description
---|---
`PydanticCustomError[](https://docs.pydantic.dev/latest/api/pydantic_core/#pydantic_core.PydanticCustomError)` |  If the card number is not valid.
