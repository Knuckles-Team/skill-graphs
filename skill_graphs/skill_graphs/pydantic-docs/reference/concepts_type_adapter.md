[ Skip to content ](https://docs.pydantic.dev/latest/concepts/type_adapter/#parsing-data-into-a-specified-type)
...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * Concepts
    ...
    * Type Adapter  [ Type Adapter  ](https://docs.pydantic.dev/latest/concepts/type_adapter/)
      * [ Parsing data into a specified type  ](https://docs.pydantic.dev/latest/concepts/type_adapter/#parsing-data-into-a-specified-type)
      * [ Rebuilding a TypeAdapter's schema  ](https://docs.pydantic.dev/latest/concepts/type_adapter/#rebuilding-a-typeadapters-schema)
...
[Python 3.9 and above](https://docs.pydantic.dev/latest/concepts/type_adapter/#__tabbed_1_1)[Python 3.13 and above](https://docs.pydantic.dev/latest/concepts/type_adapter/#__tabbed_1_2)
```
