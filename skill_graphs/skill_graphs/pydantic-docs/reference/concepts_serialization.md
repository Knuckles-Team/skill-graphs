...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * Concepts
    ...
    * Serialization  [ Serialization  ](https://docs.pydantic.dev/latest/concepts/serialization/)
...
[](https://docs.pydantic.dev/latest/concepts/serialization/#__code_8_annotation_1)
...
[](https://docs.pydantic.dev/latest/concepts/serialization/#__code_8_annotation_2)
#> {'number': 'invalid'}
...
class UserModel(BaseModel):
    ...
    def serialize_model(self) -> str:  [](https://docs.pydantic.dev/latest/concepts/serialization/#__code_13_annotation_2)
