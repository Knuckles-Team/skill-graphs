...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * API Documentation
    * Pydantic
      ...
      * Pydantic Dataclasses  [ Pydantic Dataclasses  ](https://docs.pydantic.dev/latest/api/dataclasses/)
        * [ dataclasses  ](https://docs.pydantic.dev/latest/api/dataclasses/#pydantic.dataclasses)
