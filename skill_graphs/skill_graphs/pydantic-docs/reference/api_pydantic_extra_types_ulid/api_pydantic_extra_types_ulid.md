[ Skip to content ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_ulid/#pydantic_extra_types.ulid)
...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * API Documentation
    ...
    * Pydantic Extra Types
      ...
      * ULID  [ ULID  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_ulid/)
        * [ ulid  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_ulid/#pydantic_extra_types.ulid)
        * [ ULID  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_ulid/#pydantic_extra_types.ulid.ULID)
  * Internals
