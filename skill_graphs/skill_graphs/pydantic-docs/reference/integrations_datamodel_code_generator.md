[ Skip to content ](https://docs.pydantic.dev/latest/integrations/datamodel_code_generator/#code-generation-with-datamodel-code-generator)
...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * Integrations
    ...
    * Dev Tools
      ...
      * datamodel-code-generator  [ datamodel-code-generator  ](https://docs.pydantic.dev/latest/integrations/datamodel_code_generator/)
        * [ Installation  ](https://docs.pydantic.dev/latest/integrations/datamodel_code_generator/#installation)
        * [ Example  ](https://docs.pydantic.dev/latest/integrations/datamodel_code_generator/#example)
...
# Code Generation with datamodel-code-generator[¶](https://docs.pydantic.dev/latest/integrations/datamodel_code_generator/#code-generation-with-datamodel-code-generator)
The
  * OpenAPI 3 (YAML/JSON)
  * JSON Schema
