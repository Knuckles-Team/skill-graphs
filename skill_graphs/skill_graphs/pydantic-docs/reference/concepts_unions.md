...
[](https://docs.pydantic.dev/latest/concepts/unions/#__code_3_annotation_1)
#> id=123
print(User(id='456'))  #

[](https://docs.pydantic.dev/latest/concepts/unions/#__code_3_annotation_2)
#> id=456
...
[](https://docs.pydantic.dev/latest/concepts/unions/#__code_11_annotation_1)
    """
    1 validation error for DiscriminatedModel
    value
      Unable to extract tag using discriminator model_x_discriminator() [type=union_tag_not_found, input_value='not an int or a model', input_type=str]
