[ Skip to main content ](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/#main)
...
[ Sign in ](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/)
  * [ Profile ](https://learn.microsoft.com/en-us/users/me/activity/)
  * [ Settings ](https://learn.microsoft.com/en-us/users/me/settings/)


[ Sign out ](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/)
...
Search
Suggestions will filter as you type
  * [Azure Managed Instance for Apache Cassandra documentation](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/)
...
Table of contents [ Read in English ](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/)
* * *
#### Share via
...
## About Azure Managed Instance for Apache Cassandra
  * [What is Azure Managed Instance for Apache Cassandra?](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/introduction)
  * [Management Operations](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/management-operations)


  * [Live migration](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/dual-write-proxy-migration)
  * [Offline migration](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/spark-migration)


## Create and deploy a cluster
  * [Create a cluster - Portal](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/create-cluster-portal)
  * [Create a cluster - CLI](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/create-cluster-cli)
  * [Create a multi-region cluster - CLI](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/create-multi-region-cluster)
  * [Deploy a Spark cluster with Azure Databricks](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/deploy-cluster-databricks)
  * [Search using Lucene Index](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/search-lucene-index)


  * [Security overview](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/security)
  * [Building resilient applications](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/resilient-applications)
  * [Frequently asked questions](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/faq)


## Configure and manage the cluster resources
  * [Configure a hybrid cluster](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/configure-hybrid-cluster)


  * [Best practices for optimal performance](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/best-practice-performance)
  * [Manage resources with Azure CLI](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/manage-resources-cli)
  * [Enable LDAP Authentication](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/ldap)
  * [Monitor cluster resources](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/monitor-clusters)
  * [Configure Customer-Managed Keys](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/customer-managed-keys)
  * [Visualize metrics in Prometheus with Grafana](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/visualize-prometheus-grafana)
  * [Networking Configuration](https://learn.microsoft.com/en-us/azure/managed-instance-apache-cassandra/network-rules)


[English (United States)](https://learn.microsoft.com/en-us/locale?target=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fazure%2Fmanaged-instance-apache-cassandra%2F)
Theme
  * Light
  * Dark
  * High contrast
