[ Skip to main content ](https://learn.microsoft.com/en-us/azure/automation/#main)
...
[ Sign in ](https://learn.microsoft.com/en-us/azure/automation/)
  * [ Profile ](https://learn.microsoft.com/en-us/users/me/activity/)
  * [ Settings ](https://learn.microsoft.com/en-us/users/me/settings/)


[ Sign out ](https://learn.microsoft.com/en-us/azure/automation/)
...
Table of contents [ Read in English ](https://learn.microsoft.com/en-us/azure/automation/)
* * *
#### Share via
# Azure Automation documentation
## Get started with Azure Automation
  * [What is Automation?](https://learn.microsoft.com/en-us/azure/automation/overview)


  * [Create an Automation account](https://learn.microsoft.com/en-us/azure/automation/quickstarts/create-azure-automation-account-portal)


  * [Create a runbook](https://learn.microsoft.com/en-us/azure/automation/learn/powershell-runbook-managed-identity)


  * [Change tracking and inventory using Azure Monitoring Agent](https://learn.microsoft.com/en-us/azure/automation/change-tracking/overview-monitoring-agent)
...
## Manage Updates for VMs
  ...
  * [Manage updates for multiple VMs](https://learn.microsoft.com/en-us/azure/automation/update-management/manage-updates-for-vm)


## Configure your VMs with Desired State Configuration
  * [State Configuration overview](https://learn.microsoft.com/en-us/azure/automation/automation-dsc-overview)


  * [PowerShell DSC](https://learn.microsoft.com/en-us/powershell/dsc/overview)


  * [Create a DSC Configuration from Group Policy](https://learn.microsoft.com/en-us/powershell/dsc/quickstarts/gpo-quickstart)


  * [Configure Servers and manage drift with State Configuration](https://learn.microsoft.com/en-us/azure/automation/tutorial-configure-servers-desired-state)
...
## Work with Hybrid Environments
  ...
  * [Deploy extension-based Windows or Linux Worker](https://learn.microsoft.com/en-us/azure/automation/extension-based-hybrid-runbook-worker-install)
  * [Deploy Windows Hybrid Runbook Worker](https://learn.microsoft.com/en-us/azure/automation/automation-windows-hrw-install)
  * [Deploy Linux Hybrid Runbook Worker](https://learn.microsoft.com/en-us/azure/automation/automation-linux-hrw-install)
  * [Start runbooks on a Hybrid Runbook Worker](https://learn.microsoft.com/en-us/azure/automation/automation-hrw-run-runbooks)


## Cross Service Automation
  * [Send an email from a Runbook using SendGrid](https://learn.microsoft.com/en-us/azure/automation/automation-send-email)


  * [Start a runbook from Azure alerts](https://learn.microsoft.com/en-us/azure/automation/automation-create-alert-triggered-runbook)


  * [Deploy a Resource Manager template in an Automation PowerShell runbook](https://learn.microsoft.com/en-us/azure/automation/automation-deploy-template-runbook)


## Architecture
  * [Recommendations to implement Automation](https://learn.microsoft.com/en-us/azure/well-architected/operational-excellence/automate-tasks#evaluate-tasks-to-automate)


[English (United States)](https://learn.microsoft.com/en-us/locale?target=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fazure%2Fautomation%2F)
Theme
  * Light
  * Dark
  * High contrast
