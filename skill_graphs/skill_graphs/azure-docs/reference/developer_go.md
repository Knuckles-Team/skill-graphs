[ Skip to main content ](https://learn.microsoft.com/en-us/azure/developer/go/#main)
...
[ Sign in ](https://learn.microsoft.com/en-us/azure/developer/go/)
  * [ Profile ](https://learn.microsoft.com/en-us/users/me/activity/)
  * [ Settings ](https://learn.microsoft.com/en-us/users/me/settings/)


[ Sign out ](https://learn.microsoft.com/en-us/azure/developer/go/)
...
Suggestions will filter as you type
  ...
  *     * [Key Azure services for Go developers](https://learn.microsoft.com/en-us/azure/developer/go/key-azure-services-for-go)
    * [Use Blob Storage](https://learn.microsoft.com/en-us/azure/storage/blobs/storage-quickstart-blobs-go?toc=/azure/developer/go/toc.json&bc=/azure/developer/go/breadcrumb/toc.json)
    * [Connect to an Azure Database for PostgreSQL](https://learn.microsoft.com/en-us/azure/postgresql/flexible-server/connect-go?toc=/azure/developer/go/toc.json&bc=/azure/developer/go/breadcrumb/toc.json)
    * [Connect to an Azure Database for MySQL](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/connect-go?toc=/azure/developer/go/toc.json&bc=/azure/developer/go/breadcrumb/toc.json)
    * [Query an Azure SQL database](https://learn.microsoft.com/en-us/azure/azure-sql/database/connect-query-go?toc=/azure/developer/go/toc.json&bc=/azure/developer/go/breadcrumb/toc.json)


Download PDF
  1. [ Learn ](https://learn.microsoft.com/en-us/)
  2. [ Azure ](https://learn.microsoft.com/en-us/azure/)
  3. [ Developer ](https://learn.microsoft.com/en-us/azure/developer/)
...
Table of contents [ Read in English ](https://learn.microsoft.com/en-us/azure/developer/go/)
* * *
#### Share via
...
## Get started
  * [What is the Azure SDK for Go?](https://learn.microsoft.com/en-us/azure/developer/go/overview)
  * [Key Azure services for Go developers](https://learn.microsoft.com/en-us/azure/developer/go/key-azure-services-for-go)
  * [Authenticate with the Azure Identity module for Go](https://learn.microsoft.com/en-us/azure/developer/go/azure-sdk-authentication)


  * [Build serverless apps with Go](https://learn.microsoft.com/en-us/training/modules/serverless-go)


## Data and storage
  * [Use Blob Storage with Go](https://learn.microsoft.com/en-us/azure/storage/blobs/storage-quickstart-blobs-go?toc=/azure/developer/go/toc.json&bc=/azure/developer/go/breadcrumb/toc.json)
  * [Connect to an Azure Database for PostgreSQL](https://learn.microsoft.com/en-us/azure/postgresql/flexible-server/connect-go?toc=/azure/developer/go/toc.json&bc=/azure/developer/go/breadcrumb/toc.json)
  * [Connect to an Azure Database for MySQL](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/connect-go?toc=/azure/developer/go/toc.json&bc=/azure/developer/go/breadcrumb/toc.json)
  * [Query an Azure SQL database](https://learn.microsoft.com/en-us/azure/azure-sql/database/connect-query-go?toc=/azure/developer/go/toc.json&bc=/azure/developer/go/breadcrumb/toc.json)
...
## Virtual Machines
  * [Authenticate with a managed identity](https://learn.microsoft.com/en-us/azure/developer/go/azure-sdk-authentication-managed-identity)


## Serverless functions
  * [Create a Go serverless function in Azure](https://learn.microsoft.com/en-us/azure/azure-functions/create-first-function-vs-code-other)


## Containers
  * [Build and containerize a Go app](https://learn.microsoft.com/en-us/azure/developer/go/deploy-container-apps)


## Open source
[English (United States)](https://learn.microsoft.com/en-us/locale?target=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fazure%2Fdeveloper%2Fgo%2F)
Theme
  * Light
  * Dark
  * High contrast
