[Skip to content](https://www.tecmint.com/nload-monitor-linux-network-traffic-bandwidth-usage/#content "Skip to content")
...
Menu
  ...
  * [Pro Courses](https://www.tecmint.com/nload-monitor-linux-network-traffic-bandwidth-usage/ "Linux Online Courses")
...
[Aaron Kili](https://www.tecmint.com/author/aaronkili/ "View all posts by Aaron Kili")Last Updated: May 25, 2017 Read Time: 2 minsCategories [Monitoring Tools](https://www.tecmint.com/category/monitoring-tools/) [1 Comment](https://www.tecmint.com/nload-monitor-linux-network-traffic-bandwidth-usage/#comments)
**nload** is a command-line tool to keep an eye on [network traffic and bandwidth usage](https://www.tecmint.com/bmon-network-bandwidth-monitoring-debugging-linux/) in real time. It helps you to monitor incoming and outgoing traffic using graphs and provides additional information such as the total amount of transferred data and min/max network usage.
In this guide, we will show you how to install and use **nload** to [monitor Linux network traffic and bandwidth utilization](https://www.tecmint.com/install-vnstat-and-vnstati-to-monitor-linux-network-traffic/) in real-time.
...
```
![Monitor Linux Network Bandwidth Usage](https://www.tecmint.com/wp-content/uploads/2017/05/Monitor-Linux-Network-Bandwidth-Usage.png)Monitor Linux Network Bandwidth Usage
...
```
![Monitor Linux Network Usage](https://www.tecmint.com/wp-content/uploads/2017/05/Monitor-Linux-Network-Usage.png)Monitor Linux Network Usage
...
You might also like:
  1. [Iftop – A Network Bandwidth Monitoring Tool for Linux](https://www.tecmint.com/install-iftop-bandwidth-monitoring-tool-in-rhel-centos-fedora/)
  2. [NetHogs – Monitor Per Process Network Bandwidth Usage in Linux](https://www.tecmint.com/nethogs-monitor-per-process-network-bandwidth-usage-in-real-time/)
  3. [VnStat — Monitor Real-Time Network Traffic in Linux](https://www.tecmint.com/install-vnstat-and-vnstati-to-monitor-linux-network-traffic/)
  4. [bmon – A Powerful Network Bandwidth Monitoring and Debugging Tool](https://www.tecmint.com/bmon-network-bandwidth-monitoring-debugging-linux/)
  5. [13 Linux Network Configuration and Troubleshooting Commands](https://www.tecmint.com/linux-network-configuration-and-troubleshooting-commands/)
...
Previous article:
[How to Exit a File in Vi / Vim Editor in Linux](https://www.tecmint.com/exit-file-in-vi-vim-editor-in-linux/)
Next article:
...
**Was this article helpful?** Please **[add a comment](https://www.tecmint.com/nload-monitor-linux-network-traffic-bandwidth-usage/#respond)** or
## Related Posts
...
### 1 Comment
[Leave a Reply](https://www.tecmint.com/nload-monitor-linux-network-traffic-bandwidth-usage/#reply-title)
  1. ![](https://secure.gravatar.com/avatar/d30f6e68dcedefd6678c019460c8de7696bab744375f48a0cb4221c9384f7c5b?s=50&d=blank&r=g)
João Rocha Braga Filho
[ August 1, 2022 at 12:15 am  ](https://www.tecmint.com/nload-monitor-linux-network-traffic-bandwidth-usage/#comment-1854445)
It also has it for **FreeBSD**. It’s in Ports Tree, and it’s easy to install.
[Reply](https://www.tecmint.com/nload-monitor-linux-network-traffic-bandwidth-usage/#comment-1854445)


### Got Something to Say? Join the Discussion... [Cancel reply](https://www.tecmint.com/nload-monitor-linux-network-traffic-bandwidth-usage/#respond)
...
[ ](https://www.tecmint.com/nload-monitor-linux-network-traffic-bandwidth-usage/ "Scroll back to top")
Search for:
