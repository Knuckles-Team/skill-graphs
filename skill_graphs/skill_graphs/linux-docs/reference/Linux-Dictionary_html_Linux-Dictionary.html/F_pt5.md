...
A full GNU/Linux Portuguese guide (Html Format) The Foca GNU/Linux is a Portuguese Linux guide that is split in three learning levels: Beginner, Intermediary and Advanced and is based in the Debian GNU/Linux distribution. This package contains the Html version of all learning levels of the guide: http://www.metainfo.org/focalinux From Debian 3.0r0 APT <http://www.tldp.org/LDP/Linux-Dictionary/html/index.html>
