[Skip to main content](https://docs.falkordb.com/udfs/flex/text/lpad.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/udfs/flex/text/lpad.html#textlpad) text.lpad
##  [](https://docs.falkordb.com/udfs/flex/text/lpad.html#description) Description
Pads the start (left side) of a string with a specified character until it reaches the desired length.
##  [](https://docs.falkordb.com/udfs/flex/text/lpad.html#syntax) Syntax
```
flex.text.lpad(string, length, padChar)

```

##  [](https://docs.falkordb.com/udfs/flex/text/lpad.html#parameters) Parameters
...
##  [](https://docs.falkordb.com/udfs/flex/text/lpad.html#returns) Returns
**Type:** string
...
##  [](https://docs.falkordb.com/udfs/flex/text/lpad.html#examples) Examples
###  [](https://docs.falkordb.com/udfs/flex/text/lpad.html#example-1-basic-left-padding) Example 1: Basic Left Padding
```
...
###  [](https://docs.falkordb.com/udfs/flex/text/lpad.html#example-2-formatting-numbers-with-leading-zeros) Example 2: Formatting Numbers with Leading Zeros
```
MATCH (o:Order)
...
###  [](https://docs.falkordb.com/udfs/flex/text/lpad.html#example-3-aligning-text) Example 3: Aligning Text
```
...
##  [](https://docs.falkordb.com/udfs/flex/text/lpad.html#notes) Notes
...
##  [](https://docs.falkordb.com/udfs/flex/text/lpad.html#see-also) See Also
  * [text.rpad](https://docs.falkordb.com/udfs/flex/text/rpad.html) - Pad the end (right side) of a string
  * [text.repeat](https://docs.falkordb.com/udfs/flex/text/repeat.html) - Repeat a string multiple times
  * [text.format](https://docs.falkordb.com/udfs/flex/text/format.html) - Format strings with placeholders
