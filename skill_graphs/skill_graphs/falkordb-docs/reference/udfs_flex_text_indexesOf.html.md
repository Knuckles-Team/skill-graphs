[Skip to main content](https://docs.falkordb.com/udfs/flex/text/#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/udfs/flex/text/#text-functions) Text Functions
FLEX text utilities.
* * *
## Table of contents
  * [text.camelCase](https://docs.falkordb.com/udfs/flex/text/camelCase.html)
