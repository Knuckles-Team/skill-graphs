[Skip to main content](https://docs.falkordb.com/udfs/flex/text/regexGroups.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
Search FalkorDB Docs
  ...
  3. [Text Functions](https://docs.falkordb.com/udfs/flex/text/)
  4. text.regexGroups


#  [](https://docs.falkordb.com/udfs/flex/text/regexGroups.html#textregexgroups) text.regexGroups
##  [](https://docs.falkordb.com/udfs/flex/text/regexGroups.html#description) Description
...
##  [](https://docs.falkordb.com/udfs/flex/text/regexGroups.html#syntax) Syntax
```
flex.text.regexGroups(string, regex)

```

##  [](https://docs.falkordb.com/udfs/flex/text/regexGroups.html#parameters) Parameters
Parameter | Type | Required | Description
---|---|---|---
`string` | string | Yes | The string to search in
`regex` | string | Yes | The regular expression pattern (applied globally)
##  [](https://docs.falkordb.com/udfs/flex/text/regexGroups.html#returns) Returns
**Type:** list of lists
...
##  [](https://docs.falkordb.com/udfs/flex/text/regexGroups.html#examples) Examples
###  [](https://docs.falkordb.com/udfs/flex/text/regexGroups.html#example-1-extract-email-components) Example 1: Extract Email Components
```
...
###  [](https://docs.falkordb.com/udfs/flex/text/regexGroups.html#example-2-parse-date-components) Example 2: Parse Date Components
```
...
###  [](https://docs.falkordb.com/udfs/flex/text/regexGroups.html#example-3-extract-urls-and-protocol) Example 3: Extract URLs and Protocol
```
MATCH (d:Document)
...
##  [](https://docs.falkordb.com/udfs/flex/text/regexGroups.html#notes) Notes
...
##  [](https://docs.falkordb.com/udfs/flex/text/regexGroups.html#see-also) See Also
  * [text.replace](https://docs.falkordb.com/udfs/flex/text/replace.html) - Replace text using regex
  * [text.indexOf](https://docs.falkordb.com/udfs/flex/text/indexOf.html) - Find simple substring position
  * [text.indexesOf](https://docs.falkordb.com/udfs/flex/text/indexesOf.html) - Find all substring positions
