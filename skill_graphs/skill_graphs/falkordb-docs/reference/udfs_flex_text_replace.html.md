[Skip to main content](https://docs.falkordb.com/udfs/flex/text/jaroWinkler.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/udfs/flex/text/jaroWinkler.html#textjarowinkler) text.jaroWinkler
##  [](https://docs.falkordb.com/udfs/flex/text/jaroWinkler.html#description) Description
...
##  [](https://docs.falkordb.com/udfs/flex/text/jaroWinkler.html#syntax) Syntax
```
flex.text.jaroWinkler(string1, string2)

```

##  [](https://docs.falkordb.com/udfs/flex/text/jaroWinkler.html#parameters) Parameters
Parameter | Type | Required | Description
---|---|---|---
`string1` | string | Yes | The first string to compare
`string2` | string | Yes | The second string to compare
##  [](https://docs.falkordb.com/udfs/flex/text/jaroWinkler.html#returns) Returns
**Type:** number (float)
...
##  [](https://docs.falkordb.com/udfs/flex/text/jaroWinkler.html#examples) Examples
###  [](https://docs.falkordb.com/udfs/flex/text/jaroWinkler.html#example-1-name-matching) Example 1: Name Matching
```
...
###  [](https://docs.falkordb.com/udfs/flex/text/jaroWinkler.html#example-2-fuzzy-name-search) Example 2: Fuzzy Name Search
```
...
###  [](https://docs.falkordb.com/udfs/flex/text/jaroWinkler.html#example-3-deduplication-by-company-name) Example 3: Deduplication by Company Name
```
...
##  [](https://docs.falkordb.com/udfs/flex/text/jaroWinkler.html#notes) Notes
...
##  [](https://docs.falkordb.com/udfs/flex/text/jaroWinkler.html#see-also) See Also
  * [text.levenshtein](https://docs.falkordb.com/udfs/flex/text/levenshtein.html) - Edit distance metric for string comparison
  * [sim.jaccard](https://docs.falkordb.com/udfs/flex/similarity/jaccard.html) - Set-based similarity
