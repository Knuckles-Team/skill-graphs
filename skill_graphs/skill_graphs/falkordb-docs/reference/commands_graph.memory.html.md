[Skip to main content](https://docs.falkordb.com/commands/graph.list.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/commands/graph.list.html#graphlist) GRAPH.LIST
Lists all graph keys in the keyspace.
##  [](https://docs.falkordb.com/commands/graph.list.html#examples) Examples
...
###  [](https://docs.falkordb.com/commands/graph.list.html#sample-output) Sample Output
```
