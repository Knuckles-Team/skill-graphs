[Skip to main content](https://docs.falkordb.com/commands/#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/commands/#commands) Commands
##  [](https://docs.falkordb.com/commands/#falkordb-features) FalkorDB Features
FalkorDB exposes graph database functionality within Redis using the
##  [](https://docs.falkordb.com/commands/#falkordb-api) FalkorDB API
Command details can be retrieved by filtering for the [module](https://docs.falkordb.com/commands/?group=graph) or for a specific command, e.g., `GRAPH.QUERY`. The details include the syntax for the commands, where:
