[Skip to main content](https://docs.falkordb.com/cypher/set.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/cypher/set.html#set) SET
The `SET` clause is used to create or update properties on nodes and relationships.
##  [](https://docs.falkordb.com/cypher/set.html#setting-a-single-property) Setting a Single Property
...
##  [](https://docs.falkordb.com/cypher/set.html#setting-multiple-properties) Setting Multiple Properties
...
##  [](https://docs.falkordb.com/cypher/set.html#setting-properties-from-a-map) Setting Properties from a Map
You can set properties using a map. There are two operators with different behaviors:
###  [](https://docs.falkordb.com/cypher/set.html#replace-all-properties-) Replace All Properties (`=`)
...
###  [](https://docs.falkordb.com/cypher/set.html#merge-properties-) Merge Properties (`+=`)
...
##  [](https://docs.falkordb.com/cypher/set.html#copying-properties-between-entities) Copying Properties Between Entities
...
##  [](https://docs.falkordb.com/cypher/set.html#removing-properties) Removing Properties
