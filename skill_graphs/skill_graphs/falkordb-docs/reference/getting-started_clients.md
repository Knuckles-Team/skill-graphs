[Skip to main content](https://docs.falkordb.com/getting-started/clients#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/getting-started/clients#official-clients) Official Clients
...
##  [](https://docs.falkordb.com/getting-started/clients#official-object-graph-mapping-ogm-libraries) Official Object-Graph Mapping (OGM) Libraries
...
##  [](https://docs.falkordb.com/getting-started/clients#additional-clients) Additional Clients
...
| C# | BSD |  |
| Julia | MIT |  |
##  [](https://docs.falkordb.com/getting-started/clients#implementing-a-client) Implementing a client
