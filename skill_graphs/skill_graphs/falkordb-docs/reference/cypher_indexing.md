[Skip to main content](https://docs.falkordb.com/cypher/unwind.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/cypher/unwind.html#unwind) UNWIND
The `UNWIND` clause transforms a list into individual rows, creating one row for each element in the list.
##  [](https://docs.falkordb.com/cypher/unwind.html#behavior) Behavior
...
##  [](https://docs.falkordb.com/cypher/unwind.html#basic-example) Basic Example
...
##  [](https://docs.falkordb.com/cypher/unwind.html#practical-examples) Practical Examples
###  [](https://docs.falkordb.com/cypher/unwind.html#create-multiple-nodes-from-a-list) Create Multiple Nodes from a List
```
...
###  [](https://docs.falkordb.com/cypher/unwind.html#process-nested-data) Process Nested Data
```
GRAPH.QUERY DEMO_GRAPH
...
###  [](https://docs.falkordb.com/cypher/unwind.html#combine-with-other-clauses) Combine with Other Clauses
```
GRAPH.QUERY DEMO_GRAPH
"MATCH (p:Person)
