[Skip to main content](https://docs.falkordb.com/commands/graph.query.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
Search FalkorDB Docs
  1. [Commands](https://docs.falkordb.com/commands/)
  2. GRAPH.QUERY


#  [](https://docs.falkordb.com/commands/graph.query.html#graphquery) GRAPH.QUERY
Executes the given query against a specified graph.
Arguments: `Graph name, Query, Timeout [optional]`
Returns: [Result set](https://docs.falkordb.com/design/result-structure)
###  [](https://docs.falkordb.com/commands/graph.query.html#queries-and-parameterized-queries) Queries and Parameterized Queries
The execution plans of queries, both regular and parameterized, are cached (up to [CACHE_SIZE](https://docs.falkordb.com/configuration#cache_size) unique queries are cached). Therefore, it is recommended to use parameterized queries when executing many queries with the same pattern but different constants.
Query-level timeouts can be set as described in [the configuration section](https://docs.falkordb.com/configuration#timeout).
####  [](https://docs.falkordb.com/commands/graph.query.html#command-structure) Command structure
...
####  [](https://docs.falkordb.com/commands/graph.query.html#parameterized-query-structure) Parameterized query structure:
...
###  [](https://docs.falkordb.com/commands/graph.query.html#query-language) Query language
The syntax is based on [Most](https://docs.falkordb.com/cypher/cypher-support) of the language is supported. See [Cypher documentation](https://docs.falkordb.com/cypher).
* * *
Hi. Need any help?
