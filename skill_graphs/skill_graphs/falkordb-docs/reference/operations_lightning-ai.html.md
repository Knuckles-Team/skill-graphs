[Skip to main content](https://docs.falkordb.com/operations/replication.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
Search FalkorDB Docs
  1. [Operations](https://docs.falkordb.com/operations/)
  2. Replication


#  [](https://docs.falkordb.com/operations/replication.html#configuring-falkordb-docker-for-replication) Configuring FalkorDB Docker for Replication
...
##  [](https://docs.falkordb.com/operations/replication.html#prerequisites) Prerequisites
...
##  [](https://docs.falkordb.com/operations/replication.html#step-1-configuring-replication) Step 1: Configuring Replication
...
###  [](https://docs.falkordb.com/operations/replication.html#11-creating-a-network) 1.1 Creating a Network
...
###  [](https://docs.falkordb.com/operations/replication.html#11-setting-up-the-master-instance) 1.1 Setting up the Master Instance
...
###  [](https://docs.falkordb.com/operations/replication.html#12-setting-up-the-replica-instance) 1.2 Setting up the Replica Instance
...
###  [](https://docs.falkordb.com/operations/replication.html#13-configuring-replication) 1.3 Configuring Replication
...
##  [](https://docs.falkordb.com/operations/replication.html#step-2-verifying-the-setup) Step 2: Verifying the Setup
To verify that replication is working correctly:
###  [](https://docs.falkordb.com/operations/replication.html#21-insert-data-on-master) 2.1 Insert Data on Master
```
...
###  [](https://docs.falkordb.com/operations/replication.html#22-verify-data-on-replica) 2.2 Verify Data on Replica
```
...
##  [](https://docs.falkordb.com/operations/replication.html#best-practices) Best Practices
...
##  [](https://docs.falkordb.com/operations/replication.html#troubleshooting) Troubleshooting
...
##  [](https://docs.falkordb.com/operations/replication.html#next-steps) Next Steps
...
For horizontal scalability and distributed graph operations, explore [Clustering](https://docs.falkordb.com/operations/cluster).
* * *
This site uses
