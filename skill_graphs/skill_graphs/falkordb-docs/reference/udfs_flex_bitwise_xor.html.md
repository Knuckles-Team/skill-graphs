[Skip to main content](https://docs.falkordb.com/udfs/flex/bitwise/#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/udfs/flex/bitwise/#bitwise-functions) Bitwise Functions
