...
Agent Tools are available on [Enterprise](https://vercel.com/docs/plans/enterprise) and [Pro](https://vercel.com/docs/plans/pro) plans
...
##  [What you can do with Agent Tools](https://vercel.com/docs/integrations/install-an-integration/agent-tools#what-you-can-do-with-agent-tools)[](https://vercel.com/docs/integrations/install-an-integration/agent-tools#what-you-can-do-with-agent-tools)
...
##  [Access Agent Tools](https://vercel.com/docs/integrations/install-an-integration/agent-tools#access-agent-tools)[](https://vercel.com/docs/integrations/install-an-integration/agent-tools#access-agent-tools)
To use Agent Tools:
  1. From the [Vercel Dashboard](https://vercel.com/dashboard), make sure you have at least one native integration installed. See [Add a Native Integration](https://vercel.com/docs/integrations/install-an-integration/product-integration) to install integrations.
...
##  [Read-Only Mode](https://vercel.com/docs/integrations/install-an-integration/agent-tools#read-only-mode)[](https://vercel.com/docs/integrations/install-an-integration/agent-tools#read-only-mode)
...
##  [Interact with your integrations](https://vercel.com/docs/integrations/install-an-integration/agent-tools#interact-with-your-integrations)[](https://vercel.com/docs/integrations/install-an-integration/agent-tools#interact-with-your-integrations)
...
##  [Supported integrations](https://vercel.com/docs/integrations/install-an-integration/agent-tools#supported-integrations)[](https://vercel.com/docs/integrations/install-an-integration/agent-tools#supported-integrations)
...
##  [Next steps](https://vercel.com/docs/integrations/install-an-integration/agent-tools#next-steps)[](https://vercel.com/docs/integrations/install-an-integration/agent-tools#next-steps)
  * [Learn how to add a native integration](https://vercel.com/docs/integrations/install-an-integration/product-integration) to your project


* * *
[ Previous Add a Connectable Account ](https://vercel.com/docs/integrations/install-an-integration/add-a-connectable-account)[ Next Permissions and Access ](https://vercel.com/docs/integrations/install-an-integration/manage-integrations-reference)
Was this helpful?
Send
