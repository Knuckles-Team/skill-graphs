...
##  [Query parameters](https://vercel.com/docs/rest-api/teams/request-access-to-a-team#query-parameters)[](https://vercel.com/docs/rest-api/teams/request-access-to-a-team#query-parameters)
slugstringOptional
