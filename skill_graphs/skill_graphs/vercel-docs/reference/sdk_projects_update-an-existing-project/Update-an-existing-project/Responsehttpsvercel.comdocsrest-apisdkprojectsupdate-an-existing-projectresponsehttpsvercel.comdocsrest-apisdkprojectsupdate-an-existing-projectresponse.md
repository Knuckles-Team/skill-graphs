##  [Response](https://vercel.com/docs/rest-api/sdk/projects/update-an-existing-project#response)[](https://vercel.com/docs/rest-api/sdk/projects/update-an-existing-project#response)
