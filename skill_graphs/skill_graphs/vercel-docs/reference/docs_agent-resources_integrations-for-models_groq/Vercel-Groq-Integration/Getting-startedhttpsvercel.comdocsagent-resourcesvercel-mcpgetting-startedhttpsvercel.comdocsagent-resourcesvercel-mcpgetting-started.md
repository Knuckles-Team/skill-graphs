##  [Getting started](https://vercel.com/docs/agent-resources/vercel-mcp#getting-started)[](https://vercel.com/docs/agent-resources/vercel-mcp#getting-started)
The Vercel Groq integration can be accessed through the AI tab on your [Vercel dashboard](https://vercel.com/dashboard).
###  [Prerequisites](https://vercel.com/docs/agent-resources/vercel-mcp#prerequisites)[](https://vercel.com/docs/agent-resources/vercel-mcp#prerequisites)
...
###  [Add the provider to your project](https://vercel.com/docs/agent-resources/vercel-mcp#add-the-provider-to-your-project)[](https://vercel.com/docs/agent-resources/vercel-mcp#add-the-provider-to-your-project)
####  [Using the dashboard](https://vercel.com/docs/agent-resources/vercel-mcp#using-the-dashboard)[](https://vercel.com/docs/agent-resources/vercel-mcp#using-the-dashboard)
...
```
import { groq } from '@ai-sdk/groq';import { streamText } from 'ai';import { NextApiRequest, NextApiResponse } from 'next';
// Allow streaming responses up to 30 secondsexport const maxDuration = 30;
...
```
import { groq } from '@ai-sdk/groq';import { streamText } from 'ai';import type { RequestHandler } from './$types';
...
```
import { groq } from '@ai-sdk/groq';import { generateText } from 'ai';
const { text } = await generateText({  model: groq('llama-3.1-8b-instant'),  prompt: 'Write a vegetarian lasagna recipe for 4 people.',});

```



####  [Using the CLI](https://vercel.com/docs/agent-resources/vercel-mcp#using-the-cli)[](https://vercel.com/docs/agent-resources/vercel-mcp#using-the-cli)
