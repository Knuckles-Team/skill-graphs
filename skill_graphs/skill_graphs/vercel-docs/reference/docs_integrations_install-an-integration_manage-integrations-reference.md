...
##  [View an integration's permissions](https://vercel.com/docs/integrations/install-an-integration/manage-integrations-reference#view-an-integration's-permissions)[](https://vercel.com/docs/integrations/install-an-integration/manage-integrations-reference#view-an-integration's-permissions)
...
##  [Permission Types](https://vercel.com/docs/integrations/install-an-integration/manage-integrations-reference#permission-types)[](https://vercel.com/docs/integrations/install-an-integration/manage-integrations-reference#permission-types)
...
##  [Confirming Permission Changes](https://vercel.com/docs/integrations/install-an-integration/manage-integrations-reference#confirming-permission-changes)[](https://vercel.com/docs/integrations/install-an-integration/manage-integrations-reference#confirming-permission-changes)
Integrations can request more permissions over time. Individual users and team owners are [notified](https://vercel.com/docs/notifications#notification-details) by Vercel when an integration installation has pending permission changes. You'll also be alerted to any new permissions on the [dashboard](https://vercel.com/dashboard/marketplace). The permission request contains information on which permissions are changing and the reasoning behind the changes.
...
##  [Manage project access](https://vercel.com/docs/integrations/install-an-integration/manage-integrations-reference#manage-project-access)[](https://vercel.com/docs/integrations/install-an-integration/manage-integrations-reference#manage-project-access)
...
###  [Disabled integrations](https://vercel.com/docs/integrations/install-an-integration/manage-integrations-reference#disabled-integrations)[](https://vercel.com/docs/integrations/install-an-integration/manage-integrations-reference#disabled-integrations)
...
##  [Invoice access](https://vercel.com/docs/integrations/install-an-integration/manage-integrations-reference#invoice-access)[](https://vercel.com/docs/integrations/install-an-integration/manage-integrations-reference#invoice-access)
Only users with Owner or Billing roles can view invoices for native integrations. See [Billing](https://vercel.com/docs/integrations/create-integration/billing) for more details on invoice lifecycle, pricing, and refunds.
* * *
[ Previous Agent Tools ](https://vercel.com/docs/integrations/install-an-integration/agent-tools)[ Next Create an Integration ](https://vercel.com/docs/integrations/create-integration)
Was this helpful?
Send
On this page
  ...
  * [Invoice access](https://vercel.com/docs/integrations/install-an-integration/manage-integrations-reference#invoice-access)
