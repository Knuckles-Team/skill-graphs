...
Connect your
##  [How it works](https://vercel.com/docs/integrations/ecommerce/stripe#how-it-works)[](https://vercel.com/docs/integrations/ecommerce/stripe#how-it-works)
...
##  [Use cases](https://vercel.com/docs/integrations/ecommerce/stripe#use-cases)[](https://vercel.com/docs/integrations/ecommerce/stripe#use-cases)
...
##  [Get started](https://vercel.com/docs/integrations/ecommerce/stripe#get-started)[](https://vercel.com/docs/integrations/ecommerce/stripe#get-started)
Start in Stripe sandbox mode, build and test your payment flows, then connect your live Stripe account when you're ready.
###  [Set up in Stripe sandbox mode](https://vercel.com/docs/integrations/ecommerce/stripe#set-up-in-stripe-sandbox-mode)[](https://vercel.com/docs/integrations/ecommerce/stripe#set-up-in-stripe-sandbox-mode)
  1. ###  [Create the integration](https://vercel.com/docs/integrations/ecommerce/stripe#create-the-integration)[](https://vercel.com/docs/integrations/ecommerce/stripe#create-the-integration)
Go to the [Stripe integration page](https://vercel.com/marketplace/stripe) in the Vercel Marketplace and create the integration in Stripe sandbox mode.
  ...
  2. ###  [Connect your project to the integration](https://vercel.com/docs/integrations/ecommerce/stripe#connect-your-project-to-the-integration)[](https://vercel.com/docs/integrations/ecommerce/stripe#connect-your-project-to-the-integration)
...
Click Projects, then Connect Project to connect your project to the integration.
  3. ###  [Build your store](https://vercel.com/docs/integrations/ecommerce/stripe#build-your-store)[](https://vercel.com/docs/integrations/ecommerce/stripe#build-your-store)
...
###  [Go live](https://vercel.com/docs/integrations/ecommerce/stripe#go-live)[](https://vercel.com/docs/integrations/ecommerce/stripe#go-live)
Once your store works in Stripe sandbox mode, connect your live Stripe account:
  1. ###  [Connect your Stripe account](https://vercel.com/docs/integrations/ecommerce/stripe#connect-your-stripe-account)[](https://vercel.com/docs/integrations/ecommerce/stripe#connect-your-stripe-account)
  ...
  2. ###  [Live keys](https://vercel.com/docs/integrations/ecommerce/stripe#live-keys)[](https://vercel.com/docs/integrations/ecommerce/stripe#live-keys)
The imported Stripe account's keys are already configured in Vercel. You can rotate them if needed on the Settings page of your Stripe resource in the Vercel Marketplace.
  3. ###  [Redeploy your app](https://vercel.com/docs/integrations/ecommerce/stripe#redeploy-your-app)[](https://vercel.com/docs/integrations/ecommerce/stripe#redeploy-your-app)
Redeploy your application so it picks up the new live keys. Your project can now accept real payments.


##  [Security](https://vercel.com/docs/integrations/ecommerce/stripe#security)[](https://vercel.com/docs/integrations/ecommerce/stripe#security)
When using the Stripe integration:
###  [Use keys correctly](https://vercel.com/docs/integrations/ecommerce/stripe#use-keys-correctly)[](https://vercel.com/docs/integrations/ecommerce/stripe#use-keys-correctly)
...
###  [Server-side operations](https://vercel.com/docs/integrations/ecommerce/stripe#server-side-operations)[](https://vercel.com/docs/integrations/ecommerce/stripe#server-side-operations)
...
##  [Next steps](https://vercel.com/docs/integrations/ecommerce/stripe#next-steps)[](https://vercel.com/docs/integrations/ecommerce/stripe#next-steps)
After connecting Stripe to your project, try these resources:
* * *
[ Previous Commerce and Payments ](https://vercel.com/docs/integrations/ecommerce)[ Next External Platforms/ Kubernetes ](https://vercel.com/docs/integrations/external-platforms/kubernetes)
Was this helpful?
Send
