##  [functions](https://vercel.com/docs/project-configuration/vercel-ts#functions)[](https://vercel.com/docs/project-configuration/vercel-ts#functions)
Type: `Object` of key `String` and value `Object`.
###  [Key definition](https://vercel.com/docs/project-configuration/vercel-ts#key-definition)[](https://vercel.com/docs/project-configuration/vercel-ts#key-definition)
A
...
###  [Description](https://vercel.com/docs/project-configuration/vercel-ts#description)[](https://vercel.com/docs/project-configuration/vercel-ts#description)
...
####  [`functions` property with Vercel functions](https://vercel.com/docs/project-configuration/vercel-ts#functions-property-with-vercel-functions)[](https://vercel.com/docs/project-configuration/vercel-ts#functions-property-with-vercel-functions)
vercel.ts
```
...
####  [`functions` property with ISR](https://vercel.com/docs/project-configuration/vercel-ts#functions-property-with-isr)[](https://vercel.com/docs/project-configuration/vercel-ts#functions-property-with-isr)
vercel.ts
```
import type { VercelConfig } from '@vercel/config/v1';
...
####  [Per-function `regions` and `functionFailoverRegions`](https://vercel.com/docs/project-configuration/vercel-ts#per-function-regions-and-functionfailoverregions)[](https://vercel.com/docs/project-configuration/vercel-ts#per-function-regions-and-functionfailoverregions)
...
###  [Using unsupported runtimes](https://vercel.com/docs/project-configuration/vercel-ts#using-unsupported-runtimes)[](https://vercel.com/docs/project-configuration/vercel-ts#using-unsupported-runtimes)
