##  [headers](https://vercel.com/docs/project-configuration/vercel-ts#headers)[](https://vercel.com/docs/project-configuration/vercel-ts#headers)
...
###  [Header object definition](https://vercel.com/docs/project-configuration/vercel-ts#header-object-definition)[](https://vercel.com/docs/project-configuration/vercel-ts#header-object-definition)
...
###  [Header `has` or `missing` object definition](https://vercel.com/docs/project-configuration/vercel-ts#header-has-or-missing-object-definition)[](https://vercel.com/docs/project-configuration/vercel-ts#header-has-or-missing-object-definition)
