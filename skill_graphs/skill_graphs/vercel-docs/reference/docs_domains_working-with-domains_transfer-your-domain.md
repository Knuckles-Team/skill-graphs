...
##  [Transfer a domain to another Vercel user or Team](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#transfer-a-domain-to-another-vercel-user-or-team)[](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#transfer-a-domain-to-another-vercel-user-or-team)
  1. ###  [Select the Domains tab](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#select-the-domains-tab)[](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#select-the-domains-tab)
You can move domains to another team using the [Domains section in your team dashboard sidebar](https://vercel.com/d?to=%2F%5Bteam%5D%2F%7E%2Fdomains&title=Go+to+team%27s+domains+page).
  2. ###  [Select the domain](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#select-the-domain)[](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#select-the-domain)
...
![Selecting which domains to move from the Domains tab.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fdomains%2Fmove-light.png&w=1920&q=75)![Selecting which domains to move from the Domains tab.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Ffront%2Fdocs%2Fdomains%2Fmove-dark.png&w=1920&q=75)Selecting which domains to move from the Domains tab.
  3. ###  [Select the team](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#select-the-team)[](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#select-the-team)
...
When moving domains to another team or user, all existing project domains associated with them will remain and not be moved to prevent service disruption. However, any [custom aliases](https://vercel.com/docs/cli/alias) that are not part of project domains will be removed immediately.
  4. ###  [Confirm the change](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#confirm-the-change)[](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#confirm-the-change)
To confirm the change, select Move. The domains will be transferred to the new profile of team immediately.


##  [Transferring domains between projects](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#transferring-domains-between-projects)[](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#transferring-domains-between-projects)
...
##  [Transferring domains out of Vercel](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#transferring-domains-out-of-vercel)[](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#transferring-domains-out-of-vercel)
  1. ###  [Verifying Transfer Eligibility](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#verifying-transfer-eligibility)[](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#verifying-transfer-eligibility)
Due to
You can verify that your domain has been registered with Vercel for at least 60 days by visiting the team's [Domains Dashboard](https://vercel.com/d?to=%2F%5Bteam%5D%2F%7E%2Fdomains&title=Go+to+team%27s+domains+page). If the registrar is Vercel and the age greater than 60 days, it is eligible to transfer.
  2. ###  [Select the **Domains** tab](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#select-the-domains-tab)[](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#select-the-domains-tab)
For domains that are registered with Vercel, you can retrieve an authorization code for transferring out to another registrar from **Domains** in the Dashboard sidebar.
  3. ###  [Select the "Transfer out" option](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#select-the-transfer-out-option)[](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#select-the-transfer-out-option)
...
If under a Team scope, only [Team Owners](https://vercel.com/docs/rbac/access-roles#owner-role) will see the menu-item button.
  4. ###  [Use the authorization code with the new registrar](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#use-the-authorization-code-with-the-new-registrar)[](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#use-the-authorization-code-with-the-new-registrar)
...
##  [Transfer a domain to Vercel](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#transfer-a-domain-to-vercel)[](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#transfer-a-domain-to-vercel)
...
If your domain is currently registered with Name.com, see [Transferring a domain from Name.com](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#transferring-a-domain-from-name.com) for the correct steps.
  1. ###  [Verifying Transfer Eligibility](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#verifying-transfer-eligibility)[](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#verifying-transfer-eligibility)
Due to
If the domain has not been registered with the current registrar for at least 60 days, the domain transfer will fail.
NOTE: To find further information on ICANN rules, visit the
  2. ###  [Unlock the Domain](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#unlock-the-domain)[](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#unlock-the-domain)
...
The domain lock feature appears in different forms across registrars. Sign into the host where your domain is registered and look for a Domain Lock or similar option to unlock your domain. If this option is not available, contact your registrar to change this.
  3. ###  [Obtain Authorization Code](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#obtain-authorization-code)[](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#obtain-authorization-code)
After unlocking the domain, you will need to obtain an authorization code. The code will be sent to the email address associated with your domain by your registrar. In some cases, your authorization code pops up on your dashboard. This may be available in the domain registrars dashboard. If it is not available, contact your registrar to obtain this.
  4. ###  [Transferring to Vercel](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#transferring-to-vercel)[](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#transferring-to-vercel)
...
In a case where your domain cannot be transferred, check that it has been over 60 days since the domain has been registered or previously transferred. If it still does not work, contact your registrar.
  5. ###  [Configure domain](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#configure-domain)[](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#configure-domain)
...
Once you have pre-generated the SSL certificates, you need to add the new TXT records to your DNS records in your domain registrar dashboard. Learn how to do that [here](https://vercel.com/docs/domains/managing-dns-records#migrating-dns-records-from-an-external-registrar).
  6. ###  [Deploy the domain](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#deploy-the-domain)[](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#deploy-the-domain)
...
##  [Transferring a domain from Name.com](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#transferring-a-domain-from-name.com)[](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#transferring-a-domain-from-name.com)
...
Instead, use Name.com's account transfer feature to move the domain directly to Vercel's Name.com account.
  1. ###  [Add the domain to your Vercel team](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#add-the-domain-to-your-vercel-team)[](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#add-the-domain-to-your-vercel-team)
...
If you skip this step, Vercel won't be able to automatically sync the domain to your account after the Name.com account transfer.
  2. ###  [Initiate the account transfer on Name.com](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#initiate-the-account-transfer-on-name.com)[](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#initiate-the-account-transfer-on-name.com)
  ...
  3. ###  [Wait for automatic sync](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#wait-for-automatic-sync)[](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#wait-for-automatic-sync)
Once the account transfer completes on Name.com, the domain will automatically be synced to Vercel's registrar.


* * *
[ Previous Renewing a Domain ](https://vercel.com/docs/domains/working-with-domains/renew-a-domain)[ Next Viewing & Searching Domains ](https://vercel.com/docs/domains/working-with-domains/view-and-search-domains)
Was this helpful?
Send
On this page
  ...
  * [Transferring a domain from Name.com](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#transferring-a-domain-from-name.com)
  * [Add the domain to your Vercel team](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#add-the-domain-to-your-vercel-team)
  * [Initiate the account transfer on Name.com](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#initiate-the-account-transfer-on-name.com)
  * [Wait for automatic sync](https://vercel.com/docs/domains/working-with-domains/transfer-your-domain#wait-for-automatic-sync)
