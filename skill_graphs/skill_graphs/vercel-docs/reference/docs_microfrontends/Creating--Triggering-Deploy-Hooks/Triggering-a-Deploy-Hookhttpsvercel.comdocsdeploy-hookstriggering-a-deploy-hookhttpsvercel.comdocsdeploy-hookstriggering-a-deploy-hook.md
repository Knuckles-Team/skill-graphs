##  [Triggering a Deploy Hook](https://vercel.com/docs/deploy-hooks#triggering-a-deploy-hook)[](https://vercel.com/docs/deploy-hooks#triggering-a-deploy-hook)
...
####  [Example Request](https://vercel.com/docs/deploy-hooks#example-request)[](https://vercel.com/docs/deploy-hooks#example-request)
example-request
```
curl -X POST https://api.vercel.com/v1/integrations/deploy/prj_98g22o5YUFVHlKOzj9vKPTyN2SDG/tKybBxqhQs
```

####  [Example Response](https://vercel.com/docs/deploy-hooks#example-response)[](https://vercel.com/docs/deploy-hooks#example-response)
example-response
```
{
  "job": {
...
You do not need to add an authorization header. See [Security](https://vercel.com/docs/deploy-hooks#security) to learn more.
