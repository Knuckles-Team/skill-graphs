...
##  [Benefits of using an `iframe`](https://vercel.com/docs/security/pci-dss#benefits-of-using-an-iframe)[](https://vercel.com/docs/security/pci-dss#benefits-of-using-an-iframe)
When you use an
...
##  [Integrate an `iframe` for payment processing](https://vercel.com/docs/security/pci-dss#integrate-an-iframe-for-payment-processing)[](https://vercel.com/docs/security/pci-dss#integrate-an-iframe-for-payment-processing)
  1. Select a
...
* * *
[ Previous Shared Responsibility Model ](https://vercel.com/docs/security/shared-responsibility)[ Next Reverse Proxy Servers and Vercel ](https://vercel.com/docs/security/reverse-proxy)
Was this helpful?
Send
