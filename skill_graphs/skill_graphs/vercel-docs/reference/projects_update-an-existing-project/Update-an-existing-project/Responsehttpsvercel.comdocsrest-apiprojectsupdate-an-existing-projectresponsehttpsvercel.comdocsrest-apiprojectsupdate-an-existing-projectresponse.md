##  [Response](https://vercel.com/docs/rest-api/projects/update-an-existing-project#response)[](https://vercel.com/docs/rest-api/projects/update-an-existing-project#response)
