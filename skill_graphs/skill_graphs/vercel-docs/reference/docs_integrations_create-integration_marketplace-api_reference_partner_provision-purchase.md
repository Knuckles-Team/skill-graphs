...
const response = await fetch('/v1/installations/installationId/billing/provision', {
...
##  [Authentication](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/provision-purchase#authentication)[](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/provision-purchase#authentication)
AuthorizationUser Authentication
Default authentication mechanism
AuthorizationSystem Authentication
Default authentication mechanism
##  [Path parameters](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/provision-purchase#path-parameters)[](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/provision-purchase#path-parameters)
installationIdstringRequired
##  [Header parameters](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/provision-purchase#header-parameters)[](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/provision-purchase#header-parameters)
...
##  [Request](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/provision-purchase#request)[](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/provision-purchase#request)
This endpoint expects an object.
invoiceIdstringRequired
ID of the invoice in Vercel proving the purchase of credits
##  [Response](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/provision-purchase#response)[](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/provision-purchase#response)
200Return a timestamp alongside a list of balances for the installation with the most up-to-date values
...
+Show 4 properties
##  [Errors](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/provision-purchase#errors)[](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/provision-purchase#errors)
