...
[ Skip to content ](https://laravel.com/docs/12.x/reverb#main-content)
  * ## Prologue
    * [Release Notes](https://laravel.com/docs/12.x/releases)
    * [Upgrade Guide](https://laravel.com/docs/12.x/upgrade)
    * [Contribution Guide](https://laravel.com/docs/12.x/contributions)
...
# Laravel Reverb
  * [Introduction](https://laravel.com/docs/12.x/reverb#introduction)
  * [Installation](https://laravel.com/docs/12.x/reverb#installation)
  * [Configuration](https://laravel.com/docs/12.x/reverb#configuration)
    * [Application Credentials](https://laravel.com/docs/12.x/reverb#application-credentials)
    * [Allowed Origins](https://laravel.com/docs/12.x/reverb#allowed-origins)
    * [Additional Applications](https://laravel.com/docs/12.x/reverb#additional-applications)
    * [SSL](https://laravel.com/docs/12.x/reverb#ssl)
  * [Running the Server](https://laravel.com/docs/12.x/reverb#running-server)
    * [Debugging](https://laravel.com/docs/12.x/reverb#debugging)
    * [Restarting](https://laravel.com/docs/12.x/reverb#restarting)
  * [Monitoring](https://laravel.com/docs/12.x/reverb#monitoring)
  * [Running Reverb in Production](https://laravel.com/docs/12.x/reverb#production)
    * [Open Files](https://laravel.com/docs/12.x/reverb#open-files)
    * [Event Loop](https://laravel.com/docs/12.x/reverb#event-loop)
    * [Web Server](https://laravel.com/docs/12.x/reverb#web-server)
    * [Ports](https://laravel.com/docs/12.x/reverb#ports)
    * [Process Management](https://laravel.com/docs/12.x/reverb#process-management)
    * [Scaling](https://laravel.com/docs/12.x/reverb#scaling)
  * [Events](https://laravel.com/docs/12.x/reverb#events)


## [Introduction](https://laravel.com/docs/12.x/reverb#introduction)
[event broadcasting tools](https://laravel.com/docs/12.x/broadcasting).
## [Installation](https://laravel.com/docs/12.x/reverb#installation)
...
You may also manually choose a certificate by defining `tls` options in your application's `config/reverb.php` configuration file. Within the array of `tls` options, you may provide any of the options supported by
```
...
## [Monitoring](https://laravel.com/docs/12.x/reverb#monitoring)
Reverb may be monitored via an integration with [Laravel Pulse](https://laravel.com/docs/12.x/pulse). By enabling Reverb's Pulse integration, you may track the number of connections and messages being handled by your server.
To enable the integration, you should first ensure you have [installed Pulse](https://laravel.com/docs/12.x/pulse#installation). Then, add any of Reverb's recorders to your application's `config/pulse.php` configuration file:
```
...
Next, add the Pulse cards for each recorder to your [Pulse dashboard](https://laravel.com/docs/12.x/pulse#dashboard-customization):
```
...
Connection activity is recorded by polling for new updates on a periodic basis. To ensure this information is rendered correctly on the Pulse dashboard, you must run the `pulse:check` daemon on your Reverb server. If you are running Reverb in a [horizontally scaled](https://laravel.com/docs/12.x/reverb#scaling) configuration, you should only run this daemon on one of your servers.
## [Running Reverb in Production](https://laravel.com/docs/12.x/reverb#production)
...
#### [Operating System](https://laravel.com/docs/12.x/reverb#operating-system)
...
Next, you should have a dedicated, central Redis server to which all of the Reverb servers will communicate. Reverb will use the [default Redis connection configured for your application](https://laravel.com/docs/12.x/redis#configuration) to publish messages to all of your Reverb servers.
...
## [Events](https://laravel.com/docs/12.x/reverb#events)
Reverb dispatches internal events during the lifecycle of a connection and message handling. You may [listen for these events](https://laravel.com/docs/12.x/events) to perform actions when connections are managed or messages are exchanged.
