...
[ Skip to content ](https://laravel.com/docs/12.x/sail#main-content)
  * ## Prologue
    * [Release Notes](https://laravel.com/docs/12.x/releases)
    * [Upgrade Guide](https://laravel.com/docs/12.x/upgrade)
    * [Contribution Guide](https://laravel.com/docs/12.x/contributions)
...
# Laravel Sail
  * [Introduction](https://laravel.com/docs/12.x/sail#introduction)
  * [Installation and Setup](https://laravel.com/docs/12.x/sail#installation)
    * [Installing Sail Into Existing Applications](https://laravel.com/docs/12.x/sail#installing-sail-into-existing-applications)
    * [Rebuilding Sail Images](https://laravel.com/docs/12.x/sail#rebuilding-sail-images)
    * [Configuring A Shell Alias](https://laravel.com/docs/12.x/sail#configuring-a-shell-alias)
  * [Starting and Stopping Sail](https://laravel.com/docs/12.x/sail#starting-and-stopping-sail)
  * [Executing Commands](https://laravel.com/docs/12.x/sail#executing-sail-commands)
    * [Executing PHP Commands](https://laravel.com/docs/12.x/sail#executing-php-commands)
    * [Executing Composer Commands](https://laravel.com/docs/12.x/sail#executing-composer-commands)
    * [Executing Artisan Commands](https://laravel.com/docs/12.x/sail#executing-artisan-commands)
    * [Executing Node / NPM Commands](https://laravel.com/docs/12.x/sail#executing-node-npm-commands)
  * [Interacting With Databases](https://laravel.com/docs/12.x/sail#interacting-with-sail-databases)
    * [MySQL](https://laravel.com/docs/12.x/sail#mysql)
    * [MongoDB](https://laravel.com/docs/12.x/sail#mongodb)
    * [Redis](https://laravel.com/docs/12.x/sail#redis)
    * [Valkey](https://laravel.com/docs/12.x/sail#valkey)
    * [Meilisearch](https://laravel.com/docs/12.x/sail#meilisearch)
    * [Typesense](https://laravel.com/docs/12.x/sail#typesense)
  * [File Storage](https://laravel.com/docs/12.x/sail#file-storage)
  * [Running Tests](https://laravel.com/docs/12.x/sail#running-tests)
    * [Laravel Dusk](https://laravel.com/docs/12.x/sail#laravel-dusk)
  * [Previewing Emails](https://laravel.com/docs/12.x/sail#previewing-emails)
  * [Container CLI](https://laravel.com/docs/12.x/sail#sail-container-cli)
  * [PHP Versions](https://laravel.com/docs/12.x/sail#sail-php-versions)
  * [Node Versions](https://laravel.com/docs/12.x/sail#sail-node-versions)
  * [Sharing Your Site](https://laravel.com/docs/12.x/sail#sharing-your-site)
  * [Debugging With Xdebug](https://laravel.com/docs/12.x/sail#debugging-with-xdebug)
    * [Xdebug CLI Usage](https://laravel.com/docs/12.x/sail#xdebug-cli-usage)
    * [Xdebug Browser Usage](https://laravel.com/docs/12.x/sail#xdebug-browser-usage)
  * [Customization](https://laravel.com/docs/12.x/sail#sail-customization)
...
#### [Adding Additional Services](https://laravel.com/docs/12.x/sail#adding-additional-services)
...
#### [Using Devcontainers](https://laravel.com/docs/12.x/sail#using-devcontainers)
If you would like to develop within a `--devcontainer` option to the `sail:install` command. The `--devcontainer` option will instruct the `sail:install` command to publish a default `.devcontainer/devcontainer.json ` file to the root of your application:
```
...
### [Executing PHP Commands](https://laravel.com/docs/12.x/sail#executing-php-commands)
PHP commands may be executed using the `php` command. Of course, these commands will execute using the PHP version that is configured for your application. To learn more about the PHP versions available to Laravel Sail, consult the [PHP version documentation](https://laravel.com/docs/12.x/sail#sail-php-versions):
```
...
## [Interacting With Databases](https://laravel.com/docs/12.x/sail#interacting-with-sail-databases)
### [MySQL](https://laravel.com/docs/12.x/sail#mysql)
As you may have noticed, your application's `compose.yaml` file contains an entry for a MySQL container. This container uses a
...
To connect to your application's MySQL database from your local machine, you may use a graphical database management application such as `localhost` port 3306 and the access credentials correspond to the values of your `DB_USERNAME` and `DB_PASSWORD` environment variables. Or, you may connect as the `root` user, which also utilizes the value of your `DB_PASSWORD` environment variable as its password.
### [MongoDB](https://laravel.com/docs/12.x/sail#mongodb)
If you chose to install the `compose.yaml` file contains an entry for a
...
To connect to your application's MongoDB database from your local machine, you may use a graphical interface such as `localhost` port `27017`.
### [Redis](https://laravel.com/docs/12.x/sail#redis)
Your application's `compose.yaml` file also contains an entry for a `REDIS_HOST` environment variable within your application's `.env` file to `redis`.
To connect to your application's Redis database from your local machine, you may use a graphical database management application such as `localhost` port 6379.
### [Valkey](https://laravel.com/docs/12.x/sail#valkey)
If you choose to install Valkey service when installing Sail, your application's `compose.yaml` file will contain an entry for `REDIS_HOST` environment variable within your application's `.env` file to `valkey`.
To connect to your application's Valkey database from your local machine, you may use a graphical database management application such as `localhost` port 6379.
### [Meilisearch](https://laravel.com/docs/12.x/sail#meilisearch)
If you chose to install the `compose.yaml` file will contain an entry for this powerful search engine that is integrated with [Laravel Scout](https://laravel.com/docs/12.x/scout). Once you have started your containers, you may connect to the Meilisearch instance within your application by setting your `MEILISEARCH_HOST` environment variable to `http://meilisearch:7700`.
...
### [Typesense](https://laravel.com/docs/12.x/sail#typesense)
If you chose to install the `compose.yaml` file will contain an entry for this lightning fast, open-source search engine that is natively integrated with [Laravel Scout](https://laravel.com/docs/12.x/scout#typesense). Once you have started your containers, you may connect to the Typesense instance within your application by setting the following environment variables:
```
...
## [Running Tests](https://laravel.com/docs/12.x/sail#running-tests)
Laravel provides amazing testing support out of the box, and you may use Sail's `test` command to run your applications [feature and unit tests](https://laravel.com/docs/12.x/testing). Any CLI options that are accepted by Pest / PHPUnit may also be passed to the `test` command:
```
...
#### [Selenium on Apple Silicon](https://laravel.com/docs/12.x/sail#selenium-on-apple-silicon)
...
## [Previewing Emails](https://laravel.com/docs/12.x/sail#previewing-emails)
Laravel Sail's default `compose.yaml` file contains a service entry for `mailpit` and is available via port 1025:
```
...
## [Debugging With Xdebug](https://laravel.com/docs/12.x/sail#debugging-with-xdebug)
Laravel Sail's Docker configuration includes support for [published your Sail configuration](https://laravel.com/docs/12.x/sail#sail-customization). Then, add the following variables to your application's `.env` file to configure Xdebug:
```
...
### [Xdebug Browser Usage](https://laravel.com/docs/12.x/sail#xdebug-browser-usage)
To debug your application while interacting with the application via a web browser, follow the
