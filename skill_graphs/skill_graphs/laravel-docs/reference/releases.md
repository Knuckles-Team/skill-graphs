...
[ Skip to content ](https://laravel.com/docs/12.x/releases#main-content)
# Release Notes
  * [Versioning Scheme](https://laravel.com/docs/12.x/releases#versioning-scheme)
  * [Support Policy](https://laravel.com/docs/12.x/releases#support-policy)
  * [Laravel 12](https://laravel.com/docs/12.x/releases#laravel-12)


## [Versioning Scheme](https://laravel.com/docs/12.x/releases#versioning-scheme)
Laravel and its other first-party packages follow **never** contain breaking changes.
...
#### [Named Arguments](https://laravel.com/docs/12.x/releases#named-arguments)
## [Support Policy](https://laravel.com/docs/12.x/releases#support-policy)
For all Laravel releases, bug fixes are provided for 18 months and security fixes are provided for 2 years. For all additional libraries, only the latest major release receives bug fixes. In addition, please review the database versions [supported by Laravel](https://laravel.com/docs/12.x/database#introduction).
...
## [Laravel 12](https://laravel.com/docs/12.x/releases#laravel-12)
Laravel 12 continues the improvements made in Laravel 11.x by updating upstream dependencies and introducing new starter kits for React, Svelte, Vue, and Livewire, including the option of using
### [Minimal Breaking Changes](https://laravel.com/docs/12.x/releases#minimal-breaking-changes)
...
### [New Application Starter Kits](https://laravel.com/docs/12.x/releases#new-application-starter-kits)
Laravel 12 introduces new [application starter kits](https://laravel.com/docs/12.x/starter-kits) for React, Svelte, Vue, and Livewire. The React, Svelte, and Vue starter kits utilize Inertia 2, TypeScript,
The React, Svelte, Vue, and Livewire starter kits all utilize Laravel's built-in authentication system to offer login, registration, password reset, email verification, and more. In addition, we are introducing a
...
To get started with our new starter kits, check out the [starter kit documentation](https://laravel.com/docs/12.x/starter-kits).
Copy as markdown
  * [ Versioning Scheme ](https://laravel.com/docs/12.x/releases#versioning-scheme)
  * [ Support Policy ](https://laravel.com/docs/12.x/releases#support-policy)
  * [ Laravel 12 ](https://laravel.com/docs/12.x/releases#laravel-12)
