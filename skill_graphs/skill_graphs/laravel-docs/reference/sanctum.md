...
[ Skip to content ](https://laravel.com/docs/12.x/sanctum#main-content)
  * ## Prologue
    * [Release Notes](https://laravel.com/docs/12.x/releases)
    * [Upgrade Guide](https://laravel.com/docs/12.x/upgrade)
    * [Contribution Guide](https://laravel.com/docs/12.x/contributions)
...
# Laravel Sanctum
  * [Introduction](https://laravel.com/docs/12.x/sanctum#introduction)
    * [How it Works](https://laravel.com/docs/12.x/sanctum#how-it-works)
  * [Installation](https://laravel.com/docs/12.x/sanctum#installation)
  * [Configuration](https://laravel.com/docs/12.x/sanctum#configuration)
    * [Overriding Default Models](https://laravel.com/docs/12.x/sanctum#overriding-default-models)
  * [API Token Authentication](https://laravel.com/docs/12.x/sanctum#api-token-authentication)
    ...
    * [Protecting Routes](https://laravel.com/docs/12.x/sanctum#protecting-routes)
    * [Revoking Tokens](https://laravel.com/docs/12.x/sanctum#revoking-tokens)
    * [Token Expiration](https://laravel.com/docs/12.x/sanctum#token-expiration)
  * [SPA Authentication](https://laravel.com/docs/12.x/sanctum#spa-authentication)
    * [Configuration](https://laravel.com/docs/12.x/sanctum#spa-configuration)
    * [Authenticating](https://laravel.com/docs/12.x/sanctum#spa-authenticating)
    * [Protecting Routes](https://laravel.com/docs/12.x/sanctum#protecting-spa-routes)
    * [Authorizing Private Broadcast Channels](https://laravel.com/docs/12.x/sanctum#authorizing-private-broadcast-channels)
  * [Mobile Application Authentication](https://laravel.com/docs/12.x/sanctum#mobile-application-authentication)
    * [Issuing API Tokens](https://laravel.com/docs/12.x/sanctum#issuing-mobile-api-tokens)
    * [Protecting Routes](https://laravel.com/docs/12.x/sanctum#protecting-mobile-api-routes)
    * [Revoking Tokens](https://laravel.com/docs/12.x/sanctum#revoking-mobile-api-tokens)
  * [Testing](https://laravel.com/docs/12.x/sanctum#testing)


## [Introduction](https://laravel.com/docs/12.x/sanctum#introduction)
### [How it Works](https://laravel.com/docs/12.x/sanctum#how-it-works)
Laravel Sanctum exists to solve two separate problems. Let's discuss each before digging deeper into the library.
#### [API Tokens](https://laravel.com/docs/12.x/sanctum#how-it-works-api-tokens)
...
#### [SPA Authentication](https://laravel.com/docs/12.x/sanctum#how-it-works-spa-authentication)
...
Next, if you plan to utilize Sanctum to authenticate an SPA, please refer to the [SPA Authentication](https://laravel.com/docs/12.x/sanctum#spa-authentication) section of this documentation.
## [Configuration](https://laravel.com/docs/12.x/sanctum#configuration)
### [Overriding Default Models](https://laravel.com/docs/12.x/sanctum#overriding-default-models)
...
## [API Token Authentication](https://laravel.com/docs/12.x/sanctum#api-token-authentication)
You should not use API tokens to authenticate your own first-party SPA. Instead, use Sanctum's built-in [SPA authentication features](https://laravel.com/docs/12.x/sanctum#spa-authentication).
### [Issuing API Tokens](https://laravel.com/docs/12.x/sanctum#issuing-api-tokens)
...
#### [Token Ability Middleware](https://laravel.com/docs/12.x/sanctum#token-ability-middleware)
...
#### [First-Party UI Initiated Requests](https://laravel.com/docs/12.x/sanctum#first-party-ui-initiated-requests)
For convenience, the `tokenCan` method will always return `true` if the incoming authenticated request was from your first-party SPA and you are using Sanctum's built-in [SPA authentication](https://laravel.com/docs/12.x/sanctum#spa-authentication).
However, this does not necessarily mean that your application has to allow the user to perform the action. Typically, your application's [authorization policies](https://laravel.com/docs/12.x/authorization#creating-policies) will determine if the token has been granted the permission to perform the abilities as well as check that the user instance itself should be allowed to perform the action.
...
If you have configured a token expiration time for your application, you may also wish to [schedule a task](https://laravel.com/docs/12.x/scheduling) to prune your application's expired tokens. Thankfully, Sanctum includes a `sanctum:prune-expired` Artisan command that you may use to accomplish this. For example, you may configure a scheduled task to delete all expired token database records that have been expired for at least 24 hours:
```
...
### [Configuration](https://laravel.com/docs/12.x/sanctum#spa-configuration)
#### [Configuring Your First-Party Domains](https://laravel.com/docs/12.x/sanctum#configuring-your-first-party-domains)
...
#### [Sanctum Middleware](https://laravel.com/docs/12.x/sanctum#sanctum-middleware)
...
#### [CORS and Cookies](https://laravel.com/docs/12.x/sanctum#cors-and-cookies)
...
### [Authenticating](https://laravel.com/docs/12.x/sanctum#spa-authenticating)
#### [CSRF Protection](https://laravel.com/docs/12.x/sanctum#csrf-protection)
...
#### [Logging In](https://laravel.com/docs/12.x/sanctum#logging-in)
Once CSRF protection has been initialized, you should make a `POST` request to your Laravel application's `/login` route. This `/login` route may be [implemented manually](https://laravel.com/docs/12.x/authentication#authenticating-users) or using a headless authentication package like [Laravel Fortify](https://laravel.com/docs/12.x/fortify).
...
You are free to write your own `/login` endpoint; however, you should ensure that it authenticates the user using the standard, [session based authentication services that Laravel provides](https://laravel.com/docs/12.x/authentication#authenticating-users). Typically, this means using the `web` authentication guard.
### [Protecting Routes](https://laravel.com/docs/12.x/sanctum#protecting-spa-routes)
...
Next, in order for Pusher's authorization requests to succeed, you will need to provide a custom Pusher `authorizer` when initializing [Laravel Echo](https://laravel.com/docs/12.x/broadcasting#client-side-installation). This allows your application to configure Pusher to use the `axios` instance that is [properly configured for cross-domain requests](https://laravel.com/docs/12.x/sanctum#cors-and-cookies):
```
...
When issuing tokens for a mobile application, you are also free to specify [token abilities](https://laravel.com/docs/12.x/sanctum#token-abilities).
### [Protecting Routes](https://laravel.com/docs/12.x/sanctum#protecting-mobile-api-routes)
