...
[ Skip to content ](https://laravel.com/docs/12.x/pint#main-content)
  * ## Prologue
    * [Release Notes](https://laravel.com/docs/12.x/releases)
    * [Upgrade Guide](https://laravel.com/docs/12.x/upgrade)
    * [Contribution Guide](https://laravel.com/docs/12.x/contributions)
...
# Laravel Pint
  * [Introduction](https://laravel.com/docs/12.x/pint#introduction)
  * [Installation](https://laravel.com/docs/12.x/pint#installation)
  * [Running Pint](https://laravel.com/docs/12.x/pint#running-pint)
  * [Configuring Pint](https://laravel.com/docs/12.x/pint#configuring-pint)
    * [Presets](https://laravel.com/docs/12.x/pint#presets)
    * [Rules](https://laravel.com/docs/12.x/pint#rules)
    * [Excluding Files / Folders](https://laravel.com/docs/12.x/pint#excluding-files-or-folders)
  * [Continuous Integration](https://laravel.com/docs/12.x/pint#continuous-integration)
    * [GitHub Actions](https://laravel.com/docs/12.x/pint#running-tests-on-github-actions)
...
## [Continuous Integration](https://laravel.com/docs/12.x/pint#continuous-integration)
### [GitHub Actions](https://laravel.com/docs/12.x/pint#running-tests-on-github-actions)
To automate linting your project with Laravel Pint, you can configure **Settings > Actions > General > Workflow permissions**. Then, create a `.github/workflows/lint.yml` file with the following content:
```
