...
[ Skip to content ](https://laravel.com/docs/12.x/socialite#main-content)
  * ## Prologue
    * [Release Notes](https://laravel.com/docs/12.x/releases)
    * [Upgrade Guide](https://laravel.com/docs/12.x/upgrade)
    * [Contribution Guide](https://laravel.com/docs/12.x/contributions)
...
# Laravel Socialite
  * [Introduction](https://laravel.com/docs/12.x/socialite#introduction)
  * [Installation](https://laravel.com/docs/12.x/socialite#installation)
  * [Upgrading Socialite](https://laravel.com/docs/12.x/socialite#upgrading-socialite)
  * [Configuration](https://laravel.com/docs/12.x/socialite#configuration)
  * [Authentication](https://laravel.com/docs/12.x/socialite#authentication)
    * [Routing](https://laravel.com/docs/12.x/socialite#routing)
    * [Authentication and Storage](https://laravel.com/docs/12.x/socialite#authentication-and-storage)
    * [Access Scopes](https://laravel.com/docs/12.x/socialite#access-scopes)
    * [Slack Bot Scopes](https://laravel.com/docs/12.x/socialite#slack-bot-scopes)
    * [Optional Parameters](https://laravel.com/docs/12.x/socialite#optional-parameters)
  * [Retrieving User Details](https://laravel.com/docs/12.x/socialite#retrieving-user-details)
  * [Testing](https://laravel.com/docs/12.x/socialite#testing)


## [Introduction](https://laravel.com/docs/12.x/socialite#introduction)
In addition to typical, form based authentication, Laravel also provides a simple, convenient way to authenticate with OAuth providers using
Adapters for other platforms are available via the community driven
## [Installation](https://laravel.com/docs/12.x/socialite#installation)
...
## [Upgrading Socialite](https://laravel.com/docs/12.x/socialite#upgrading-socialite)
When upgrading to a new major version of Socialite, it's important that you carefully review
## [Configuration](https://laravel.com/docs/12.x/socialite#configuration)
...
### [Authentication and Storage](https://laravel.com/docs/12.x/socialite#authentication-and-storage)
Once the user has been retrieved from the OAuth provider, you may determine if the user exists in your application's database and [authenticate the user](https://laravel.com/docs/12.x/authentication#authenticate-a-user-instance). If the user does not exist in your application's database, you will typically create a new record in your database to represent the user:
```
...
For more information regarding what user information is available from specific OAuth providers, please consult the documentation on [retrieving user details](https://laravel.com/docs/12.x/socialite#retrieving-user-details).
### [Access Scopes](https://laravel.com/docs/12.x/socialite#access-scopes)
...
#### [Retrieving User Details From a Token](https://laravel.com/docs/12.x/socialite#retrieving-user-details-from-a-token-oauth2)
...
#### [Stateless Authentication](https://laravel.com/docs/12.x/socialite#stateless-authentication)
...
#### [Faking the Redirect](https://laravel.com/docs/12.x/socialite#faking-the-redirect)
...
#### [Faking the Callback](https://laravel.com/docs/12.x/socialite#faking-the-callback)
