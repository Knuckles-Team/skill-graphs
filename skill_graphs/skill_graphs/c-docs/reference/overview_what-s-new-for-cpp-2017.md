[ Skip to main content ](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170#main) [ Skip to Ask Learn chat experience ](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170)
...
[ Sign in ](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170)
  * [ Profile ](https://learn.microsoft.com/en-us/users/me/activity/)
  * [ Settings ](https://learn.microsoft.com/en-us/users/me/settings/)


[ Sign out ](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170)
...
Version Visual Studio 2022
  * [2026](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-180)
  * [2022](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170)
  * [2019](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-160)
  * [2017](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-150)
  * [2015](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-140)
...
Suggestions will filter as you type
  *     * [C and C++ in Visual Studio](https://learn.microsoft.com/en-us/cpp/overview/visual-cpp-in-visual-studio?view=msvc-170)
    ...
    * [C/C++ conformance improvements in Microsoft C++ (MSVC) Build Tools](https://learn.microsoft.com/en-us/cpp/overview/msvc-conformance-improvements?view=msvc-170)
    ...
    * [C++ conformance improvements in Visual Studio 2019](https://learn.microsoft.com/en-us/cpp/overview/cpp-conformance-improvements-2019?view=msvc-170)
    * [C++ conformance improvements in Visual Studio 2017](https://learn.microsoft.com/en-us/cpp/overview/cpp-conformance-improvements-2017?view=msvc-170)
    ...
    * [Supported target platforms](https://learn.microsoft.com/en-us/cpp/overview/supported-platforms-visual-cpp?view=msvc-170)
    ...
    * [Install C11 and C17 support in Visual Studio](https://learn.microsoft.com/en-us/cpp/overview/install-c17-support?view=msvc-170)
    * [Samples](https://learn.microsoft.com/en-us/cpp/overview/visual-cpp-samples?view=msvc-170)
    * [Help and community](https://learn.microsoft.com/en-us/cpp/overview/visual-cpp-help-and-community?view=msvc-170)
    * [How to report a problem with the Microsoft C++ Build Tools](https://learn.microsoft.com/en-us/cpp/overview/how-to-report-a-problem-with-the-visual-cpp-toolset?view=msvc-170)
  * [Projects and build systems](https://learn.microsoft.com/en-us/cpp/build/projects-and-build-systems-cpp?view=msvc-170)
  * [Read and write code in Visual Studio](https://learn.microsoft.com/en-us/cpp/ide/read-and-understand-code-cpp?view=msvc-170)
  * [Windows desktop development](https://learn.microsoft.com/en-us/cpp/windows/overview-of-windows-programming-in-cpp?view=msvc-170)
  * [UWP development](https://learn.microsoft.com/en-us/cpp/cppcx/universal-windows-apps-cpp?view=msvc-170)
  * [Game development](https://learn.microsoft.com/en-us/cpp/overview/game-development-cpp?view=msvc-170)
  * [Linux development](https://learn.microsoft.com/en-us/cpp/linux/?view=msvc-170)
  * [Cross-platform mobile development](https://learn.microsoft.com/en-us/cpp/cross-platform/?view=msvc-170)
  * [.NET development with C++/CLI](https://learn.microsoft.com/en-us/cpp/dotnet/dotnet-programming-with-cpp-cli-visual-cpp?view=msvc-170)
  ...
  * [Port and upgrade C++ code](https://learn.microsoft.com/en-us/cpp/porting/visual-cpp-porting-and-upgrading-guide?view=msvc-170)
...
Table of contents [ Read in English ](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170) Add to Collections Add to plan
* * *
#### Share via
* * *
Copy Markdown Print
* * *
Note
Access to this page requires authorization. You can try [signing in](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170) or changing directories.
...
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170#visual-studio-2017-version-152)
...
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170#visual-studio-2017-version-155-10)
##### Visual Studio 2017 version 15.5
  ...
  * Support added for CMake. You can now work on your existing CMake code base without having to convert it to a Visual Studio project. For more information, see [Configure a Linux CMake Project](https://learn.microsoft.com/en-us/cpp/linux/cmake-linux-project?view=msvc-170).
  * Support added for running remote tasks. This capability allows you to run any command on a remote system that is defined in Visual Studio's Connection Manager. Remote tasks also provide the capability to copy files to the remote system. For more information, see [Configure a Linux CMake Project](https://learn.microsoft.com/en-us/cpp/linux/cmake-linux-project?view=msvc-170).


[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170#visual-studio-2017-version-157-4)
##### Visual Studio 2017 version 15.7
  ...
  * IntelliSense for headers on remote Linux connections. For more information, see [IntelliSense for Remote Linux Headers](https://devblogs.microsoft.com/cppblog/intellisense-for-remote-linux-headers/) and [Configure a Linux CMake Project](https://learn.microsoft.com/en-us/cpp/linux/cmake-linux-project?view=msvc-170).


[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170#game-development-with-c)
## Game development with C++
Use the full power of C++ to build professional games powered by DirectX or Cocos2d.
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170#mobile-development-with-c-for-android-and-ios)
...
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170#universal-windows-apps)
...
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170#new-options-for-c-on-universal-windows-platform-uwp)
...
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170#c-code-analysis)
## C++ code analysis
The C++ Core Checkers for enforcing the **Code Analysis Extensions** page in the project's property pages. The extensions are then included when you run code analysis. For more information, see [Using the C++ Core Guidelines checkers](https://learn.microsoft.com/en-us/cpp/code-quality/using-the-cpp-core-guidelines-checkers?view=msvc-170).
![Screenshot of the Property Pages dialog box showing Configuration Properties > Code Analysis > General selected and a number of Core Checks listed in the Run this rule set section.](https://learn.microsoft.com/en-us/cpp/overview/media/cppcorecheck.png?view=msvc-170)
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170#visual-studio-2017-version-153-8)
##### Visual Studio 2017 version 15.3
  * Support added for rules related to resource management.


[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170#visual-studio-2017-version-155-12)
##### Visual Studio 2017 version 15.5
...
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170#visual-studio-2017-version-156-1)
##### Visual Studio 2017 version 15.6
...
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170#visual-studio-2017-version-157-5)
##### Visual Studio 2017 version 15.7
  * Support added for [`/analyze:ruleset`](https://learn.microsoft.com/en-us/cpp/build/reference/analyze-code-analysis?view=msvc-170), which lets you specify the code analysis rules to run.
  * Support added for more C++ Core Guidelines rules. For more information, see [Using the C++ Core Guidelines checkers](https://learn.microsoft.com/en-us/cpp/code-quality/using-the-cpp-core-guidelines-checkers?view=msvc-170).


[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170#unit-testing-in-visual-studio-2017)
## Unit testing in Visual Studio 2017
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170#visual-studio-2017-version-155-13)
##### Visual Studio 2017 version 15.5
Google Test Adapter and Boost.Test Adapter are now available as components of the **Desktop Development with C++** workload. They're integrated with **Test Explorer**. CTest support is added for CMake projects (using Open Folder), although full integration with **Test Explorer** isn't available yet. For more information, see [Writing unit tests for C/C++](https://learn.microsoft.com/en-us/visualstudio/test/writing-unit-tests-for-c-cpp).
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170#visual-studio-2017-version-156-2)
##### Visual Studio 2017 version 15.6
...
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170#visual-studio-2017-version-157-6)
##### Visual Studio 2017 version 15.7
[CodeLens](https://learn.microsoft.com/en-us/visualstudio/ide/find-code-changes-and-other-history-with-codelens) support added for C++ unit test projects. For more information, see [Announcing CodeLens for C++ Unit Testing](https://devblogs.microsoft.com/cppblog/announcing-codelens-for-c-unit-testing/).
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170#visual-studio-graphics-diagnostics)
...
The new features and fixes in the Microsoft C/C++ compiler and tools in Visual Studio 2019.
  * [ C++ conformance improvements in Visual Studio 2022 ](https://learn.microsoft.com/en-us/cpp/overview/cpp-conformance-improvements?source=recommendations)
Microsoft C++ in Visual Studio is improving standards conformance and fixing bugs regularly.
...
Learn more about: Supported Platforms (Microsoft C++)
  * [ C++ Tools and Features in Visual Studio Editions ](https://learn.microsoft.com/en-us/cpp/overview/visual-cpp-tools-and-features-in-visual-studio-editions?source=recommendations)
Learn more about: C++ Tools and Features in Visual Studio Editions
  * [ C++ conformance improvements in Visual Studio 2017 ](https://learn.microsoft.com/en-us/cpp/overview/cpp-conformance-improvements-2017?source=recommendations)
Microsoft C/C++ in Visual Studio 2017 is progressing toward full conformance with the C++20 language standard.
  * [ Microsoft C/C++ language conformance ](https://learn.microsoft.com/en-us/cpp/overview/visual-cpp-language-conformance?source=recommendations)
Microsoft C and C++ conformance updates by Visual Studio version.
  * [ Microsoft C++ porting and upgrading guide ](https://learn.microsoft.com/en-us/cpp/porting/visual-cpp-porting-and-upgrading-guide?source=recommendations)
Your comprehensive hub for upgrading and modernizing Microsoft C++ code to the latest version of Visual Studio. Find tools, guides, success stories, and best practices.
...
[ Sign in ](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2017?view=msvc-170)
[English (United States)](https://learn.microsoft.com/en-us/locale?target=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fcpp%2Foverview%2Fwhat-s-new-for-cpp-2017%3Fview%3Dmsvc-170)
Theme
  * Light
  * Dark
  * High contrast
