...
[Blog](https://react.dev/blog)
Copy pageCopy
# React Conf 2025 Recap[](https://react.dev/blog/2025/10/16/react-conf-2025-recap#undefined "Link for this heading")
Oct 16, 2025 by
* * *
...
The entire [here](https://conf.react.dev/photos).
In this post, we’ll summarize the talks and announcements from the event.
## Day 1 Keynote [](https://react.dev/blog/2025/10/16/react-conf-2025-recap#day-1-keynote "Link for Day 1 Keynote ")
_Watch the full day 1 stream_
...
•Live
•
## Day 2 Keynote [](https://react.dev/blog/2025/10/16/react-conf-2025-recap#day-2-keynote "Link for Day 2 Keynote ")
_Watch the full day 2 stream_
...
•Live
•
## React team talks [](https://react.dev/blog/2025/10/16/react-conf-2025-recap#react-team-talks "Link for React team talks ")
Throughout the conference, there were talks from the React team including:
  * `<Activity />` and `<ViewTransition />` to build fast, native-feeling animations.


## React framework talks [](https://react.dev/blog/2025/10/16/react-conf-2025-recap#react-framework-talks "Link for React framework talks ")
The second half of day 2 had a series of talks from React Framework teams including:
## Q&A [](https://react.dev/blog/2025/10/16/react-conf-2025-recap#q-and-a "Link for Q&A ")
There were three Q&A panels during the conference:
## And more… [](https://react.dev/blog/2025/10/16/react-conf-2025-recap#and-more "Link for And more… ")
We also heard talks from the community including:
## Thanks [](https://react.dev/blog/2025/10/16/react-conf-2025-recap#thanks "Link for Thanks ")
...
Thank you to
Thank you to
Thank you to all the sponsors who made the event possible:
