...
[ Skip to Main Content ](https://go.dev/doc/asm#main-content)
  * [ Why Go _arrow_drop_down_ ](https://go.dev/doc/asm)
...
Press Enter to activate/deactivate dropdown
  * [ Docs _arrow_drop_down_ ](https://go.dev/doc/asm)
Press Enter to activate/deactivate dropdown
...
Press Enter to activate/deactivate dropdown
  * [ Community _arrow_drop_down_ ](https://go.dev/doc/asm)
Press Enter to activate/deactivate dropdown
...
[ ![Go.](https://go.dev/images/go-logo-blue.svg) ](https://go.dev/)
  * [Why Go _navigate_next_](https://go.dev/doc/asm)
[_navigate_before_ Why Go](https://go.dev/doc/asm)
    * [ Case Studies ](https://go.dev/solutions/case-studies)
    * [ Use Cases ](https://go.dev/solutions/use-cases)
    * [ Security ](https://go.dev/security/)
  * [Learn](https://go.dev/learn/)
  * [Docs _navigate_next_](https://go.dev/doc/asm)
[_navigate_before_ Docs](https://go.dev/doc/asm)
    * [ Go Spec ](https://go.dev/ref/spec)
    * [ Go User Manual ](https://go.dev/doc)
    * [ Standard library ](https://pkg.go.dev/std)
    * [ Release Notes ](https://go.dev/doc/devel/release)
    * [ Effective Go ](https://go.dev/doc/effective_go)
  * [Packages](https://pkg.go.dev)
  * [Community _navigate_next_](https://go.dev/doc/asm)
[_navigate_before_ Community](https://go.dev/doc/asm)
    * [ Recorded Talks ](https://go.dev/talks/)
    * [ Conferences _open_in_new_ ](https://go.dev/wiki/Conferences)
    * [ Go blog ](https://go.dev/blog)
    * [ Go project ](https://go.dev/help)
...
[A Quick Guide to Go's Assembler](https://go.dev/doc/asm#introduction)
    [Constants](https://go.dev/doc/asm#constants)     [Symbols](https://go.dev/doc/asm#symbols)     [Directives](https://go.dev/doc/asm#directives)     [Special instructions](https://go.dev/doc/asm#special-instructions)     [Interacting with Go types and constants](https://go.dev/doc/asm#data-offsets)     [Runtime Coordination](https://go.dev/doc/asm#runtime)

[Architecture-specific details](https://go.dev/doc/asm#architectures)
    [32-bit Intel 386](https://go.dev/doc/asm#x86)     [64-bit Intel 386 (a.k.a. amd64)](https://go.dev/doc/asm#amd64)     [ARM](https://go.dev/doc/asm#arm)     [ARM64](https://go.dev/doc/asm#arm64)     [PPC64](https://go.dev/doc/asm#ppc64)     [IBM z/Architecture, a.k.a. s390x](https://go.dev/doc/asm#s390x)     [MIPS, MIPS64](https://go.dev/doc/asm#mips)     [RISCV64](https://go.dev/doc/asm#riscv64)     [Unsupported opcodes](https://go.dev/doc/asm#unsupported_opcodes) |
## A Quick Guide to Go's Assembler[¶](https://go.dev/doc/asm#introduction)
...
### Constants[¶](https://go.dev/doc/asm#constants)
...
### Symbols[¶](https://go.dev/doc/asm#symbols)
...
### Directives[¶](https://go.dev/doc/asm#directives)
...
### Special instructions[¶](https://go.dev/doc/asm#special-instructions)
...
### Interacting with Go types and constants[¶](https://go.dev/doc/asm#data-offsets)
...
Field offsets are of the form `_type___field_`. Struct sizes are of the form` _type___size`. For example, consider the following Go definition:
```
type reader struct {
	buf [bufSize]byte
	r   int
...
### Runtime Coordination[¶](https://go.dev/doc/asm#runtime)
...
```
const (
	AND = obj.ABaseARM + obj.A_ARCHSPECIFIC + iota
	AEOR
	ASUB
	ARSB
	ADD
...
### 32-bit Intel 386[¶](https://go.dev/doc/asm#x86)
...
### 64-bit Intel 386 (a.k.a. amd64)[¶](https://go.dev/doc/asm#amd64)
...
### ARM64[¶](https://go.dev/doc/asm#arm64)
...
### PPC64[¶](https://go.dev/doc/asm#ppc64)
...
### MIPS, MIPS64[¶](https://go.dev/doc/asm#mips)
...
### RISCV64[¶](https://go.dev/doc/asm#riscv64)
Reference: [Go RISCV64 Assembly Instructions Reference Manual](https://go.dev/pkg/cmd/internal/obj/riscv)
### Unsupported opcodes[¶](https://go.dev/doc/asm#unsupported_opcodes)
