[Skip to main content](https://testing-library.com/docs/dom-testing-library/faq/)
...
All that said, if you really don't want to ship `data-testid` attributes, then you can use
...
Please refer to the [Guiding Principles](https://testing-library.com/docs/guiding-principles) of this testing library for more info.
[Previous Guiding Principles](https://testing-library.com/docs/guiding-principles)[Next About Queries](https://testing-library.com/docs/queries/about)
