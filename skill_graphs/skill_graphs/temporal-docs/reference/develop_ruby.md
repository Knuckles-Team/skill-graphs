...
Search
  ...
  * [Develop](https://docs.temporal.io/develop/)
    ...
    * [Ruby SDK](https://docs.temporal.io/develop/ruby/)
      * [Quickstart](https://docs.temporal.io/develop/ruby/set-up-local-ruby)
      * [Core application](https://docs.temporal.io/develop/ruby/core-application)
      * [Temporal Client](https://docs.temporal.io/develop/ruby/temporal-client)
      * [Testing](https://docs.temporal.io/develop/ruby/testing-suite)
      * [Failure detection](https://docs.temporal.io/develop/ruby/failure-detection)
      * [Messages](https://docs.temporal.io/develop/ruby/message-passing)
      * [Interrupt a Workflow](https://docs.temporal.io/develop/ruby/interrupt-workflow)
      * [Asynchronous Activity completion](https://docs.temporal.io/develop/ruby/asynchronous-activity)
      * [Versioning](https://docs.temporal.io/develop/ruby/versioning)
      * [Observability](https://docs.temporal.io/develop/ruby/observability)
      * [Benign exceptions](https://docs.temporal.io/develop/ruby/benign-exceptions)
      * [Enriching the UI](https://docs.temporal.io/develop/ruby/enriching-ui)
      * [Debugging](https://docs.temporal.io/develop/ruby/debugging)
      * [Schedules](https://docs.temporal.io/develop/ruby/schedules)
      * [Converters and encryption](https://docs.temporal.io/develop/ruby/converters-and-encryption)
      * [Rails integration](https://docs.temporal.io/develop/ruby/rails-integration)
      * [Durable Timers](https://docs.temporal.io/develop/ruby/durable-timers)
      * [Child Workflows](https://docs.temporal.io/develop/ruby/child-workflows)
      * [Continue-As-New](https://docs.temporal.io/develop/ruby/continue-as-new)
