...
On this page
In this example, we show you how to build a Durable Agent using the
...
The agent will determine which tools to use and provide intelligent responses based on the available tools. Use the
  * [Create the Activity](https://docs.temporal.io/ai-cookbook/openai-agents-sdk-python#create-the-activity)
  * [Create the Workflow](https://docs.temporal.io/ai-cookbook/openai-agents-sdk-python#create-the-workflow)
  * [Create the Worker](https://docs.temporal.io/ai-cookbook/openai-agents-sdk-python#create-the-worker)
  * [Create the Workflow Starter](https://docs.temporal.io/ai-cookbook/openai-agents-sdk-python#create-the-workflow-starter)
  * [Running](https://docs.temporal.io/ai-cookbook/openai-agents-sdk-python#running)
  * [Example Interactions](https://docs.temporal.io/ai-cookbook/openai-agents-sdk-python#example-interactions)
