...
[ ](https://fastapi.tiangolo.com/?q= "Share")
...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  * FastAPI  [ FastAPI  ](https://fastapi.tiangolo.com/)
    ...
    * [ FastAPI mini documentary  ](https://fastapi.tiangolo.com/#fastapi-mini-documentary)
...
Brian Okken - **[Python Bytes](https://pythonbytes.fm/episodes/show/123/time-to-right-the-py-wrongs?time_in_sec=855) podcast host**
* * *
...
The command `fastapi dev` reads your `main.py` file automatically, detects the **FastAPI** app in it, and starts a server using
...
[ Next  Features  ](https://fastapi.tiangolo.com/features/)
