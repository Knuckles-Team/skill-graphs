[ Skip to content ](https://fastapi.tiangolo.com/tutorial/encoder/#json-compatible-encoder)
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Tutorial - User Guide  ](https://fastapi.tiangolo.com/tutorial/)
      ...
      * JSON Compatible Encoder  [ JSON Compatible Encoder  ](https://fastapi.tiangolo.com/tutorial/encoder/)
        * [ Using the `jsonable_encoder` ](https://fastapi.tiangolo.com/tutorial/encoder/#using-the-jsonable-encoder)
