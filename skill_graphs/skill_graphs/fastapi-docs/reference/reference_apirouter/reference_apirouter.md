...
[ ](https://fastapi.tiangolo.com/reference/apirouter/?q= "Share")
...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Reference  ](https://fastapi.tiangolo.com/reference/)
    ...
    * `APIRouter` class  [ `APIRouter` class  ](https://fastapi.tiangolo.com/reference/apirouter/)
      * [ ](https://fastapi.tiangolo.com/reference/apirouter/#fastapi.APIRouter)
        ...
        * [ ](https://fastapi.tiangolo.com/reference/apirouter/#fastapi.APIRouter.websocket)
          * [ Example  ](https://fastapi.tiangolo.com/reference/apirouter/#fastapi.APIRouter.websocket--example)
        * [ ](https://fastapi.tiangolo.com/reference/apirouter/#fastapi.APIRouter.include_router)
