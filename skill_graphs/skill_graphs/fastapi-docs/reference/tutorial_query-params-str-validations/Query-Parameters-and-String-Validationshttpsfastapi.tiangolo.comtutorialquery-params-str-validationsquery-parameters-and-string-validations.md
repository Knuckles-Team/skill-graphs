...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_2_1)
```
...
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_3_1)
Tip
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_4_1)
```
from typing import Annotated
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_5_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import FastAPI, Query
...
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_6_1)
```
from fastapi import FastAPI, Query
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_8_1)
```
from typing import Annotated
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_10_1)
```
from typing import Annotated
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_11_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import FastAPI, Query
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_12_1)
```
from typing import Annotated
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_13_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import FastAPI, Query
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_14_1)
```
from typing import Annotated
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_15_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import FastAPI, Query
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_17_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import FastAPI, Query
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_18_1)
```
from typing import Annotated
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_19_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import FastAPI, Query
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_20_1)
```
from typing import Annotated
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_21_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import FastAPI, Query
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_23_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import FastAPI, Query
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_25_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import FastAPI, Query
...
And a `description`:
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_26_1)
```
from typing import Annotated
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_27_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import FastAPI, Query
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_28_1)
```
from typing import Annotated
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_29_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import FastAPI, Query
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_31_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import FastAPI, Query
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_33_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import FastAPI, Query
...
You can achieve that using `Annotated`.
Tip
Pydantic also has
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_35_1)
```
# Code above omitted 👆
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/query-params-str-validations/#__tabbed_37_1)
```
# Code above omitted 👆
