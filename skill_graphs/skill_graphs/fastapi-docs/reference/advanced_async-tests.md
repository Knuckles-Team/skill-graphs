...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Advanced User Guide  ](https://fastapi.tiangolo.com/advanced/)
      ...
      * Async Tests  [ Async Tests  ](https://fastapi.tiangolo.com/advanced/async-tests/)
        * [ pytest.mark.anyio  ](https://fastapi.tiangolo.com/advanced/async-tests/#pytest-mark-anyio)
        * [ HTTPX  ](https://fastapi.tiangolo.com/advanced/async-tests/#httpx)
        * [ Example  ](https://fastapi.tiangolo.com/advanced/async-tests/#example)
        * [ Run it  ](https://fastapi.tiangolo.com/advanced/async-tests/#run-it)
        * [ In Detail  ](https://fastapi.tiangolo.com/advanced/async-tests/#in-detail)
        * [ Other Asynchronous Function Calls  ](https://fastapi.tiangolo.com/advanced/async-tests/#other-asynchronous-function-calls)
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/async-tests/#__tabbed_1_1)
```
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/async-tests/#__tabbed_2_1)
```
import pytest
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/async-tests/#__tabbed_3_1)
```
import pytest
from httpx import ASGITransport, AsyncClient
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/async-tests/#__tabbed_4_1)
```
import pytest
from httpx import ASGITransport, AsyncClient
...
Warning
If your application relies on lifespan events, the `AsyncClient` won't trigger these events. To ensure they are triggered, use `LifespanManager` from
## Other Asynchronous Function Calls[¶](https://fastapi.tiangolo.com/advanced/async-tests/#other-asynchronous-function-calls)
As the testing function is now asynchronous, you can now also call (and `await`) other `async` functions apart from sending requests to your FastAPI application in your tests, exactly as you would call them anywhere else in your code.
Tip
If you encounter a `RuntimeError: Task attached to a different loop` when integrating asynchronous function calls in your tests (e.g. when using `@app.on_event("startup")` callback.
