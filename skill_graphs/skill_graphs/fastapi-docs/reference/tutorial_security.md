[ Skip to content ](https://fastapi.tiangolo.com/tutorial/security/#security)
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ In a hurry?  ](https://fastapi.tiangolo.com/tutorial/security/#in-a-hurry)
  * [ OAuth2  ](https://fastapi.tiangolo.com/tutorial/security/#oauth2)
    * [ OAuth 1  ](https://fastapi.tiangolo.com/tutorial/security/#oauth-1)
  * [ OpenID Connect  ](https://fastapi.tiangolo.com/tutorial/security/#openid-connect)
    * [ OpenID (not "OpenID Connect")  ](https://fastapi.tiangolo.com/tutorial/security/#openid-not-openid-connect)
  * [ OpenAPI  ](https://fastapi.tiangolo.com/tutorial/security/#openapi)
  * [ **FastAPI** utilities  ](https://fastapi.tiangolo.com/tutorial/security/#fastapi-utilities)
