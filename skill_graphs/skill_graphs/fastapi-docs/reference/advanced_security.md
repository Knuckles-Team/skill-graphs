[ Skip to content ](https://fastapi.tiangolo.com/advanced/security/#advanced-security)
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Additional Features  ](https://fastapi.tiangolo.com/advanced/security/#additional-features)
  * [ Read the Tutorial first  ](https://fastapi.tiangolo.com/advanced/security/#read-the-tutorial-first)
...
# Advanced Security[¶](https://fastapi.tiangolo.com/advanced/security/#advanced-security)
## Additional Features[¶](https://fastapi.tiangolo.com/advanced/security/#additional-features)
