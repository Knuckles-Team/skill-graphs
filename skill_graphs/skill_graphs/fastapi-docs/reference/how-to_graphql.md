...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ How To - Recipes  ](https://fastapi.tiangolo.com/how-to/)
      ...
      * GraphQL  [ GraphQL  ](https://fastapi.tiangolo.com/how-to/graphql/)
        * [ GraphQL Libraries  ](https://fastapi.tiangolo.com/how-to/graphql/#graphql-libraries)
        * [ GraphQL with Strawberry  ](https://fastapi.tiangolo.com/how-to/graphql/#graphql-with-strawberry)
        * [ Older `GraphQLApp` from Starlette  ](https://fastapi.tiangolo.com/how-to/graphql/#older-graphqlapp-from-starlette)
        * [ Learn More  ](https://fastapi.tiangolo.com/how-to/graphql/#learn-more)
...
# GraphQL[¶](https://fastapi.tiangolo.com/how-to/graphql/#graphql)
...
## GraphQL with Strawberry[¶](https://fastapi.tiangolo.com/how-to/graphql/#graphql-with-strawberry)
If you need or want to work with **GraphQL** , **recommended** library as it has the design closest to **FastAPI's** design, it's all based on **type annotations**.
Depending on your use case, you might prefer to use a different library, but if you asked me, I would probably suggest you try **Strawberry**.
Here's a small preview of how you could integrate Strawberry with FastAPI:
[Python 3.10+](https://fastapi.tiangolo.com/how-to/graphql/#__tabbed_1_1)
```
import strawberry
...
## Older `GraphQLApp` from Starlette[¶](https://fastapi.tiangolo.com/how-to/graphql/#older-graphqlapp-from-starlette)
Previous versions of Starlette included a `GraphQLApp` class to integrate with
It was deprecated from Starlette, but if you have code that used it, you can easily **migrate** to **almost identical interface**.
Tip
If you need GraphQL, I still would recommend you check out
## Learn More[¶](https://fastapi.tiangolo.com/how-to/graphql/#learn-more)
You can learn more about **GraphQL** in the
