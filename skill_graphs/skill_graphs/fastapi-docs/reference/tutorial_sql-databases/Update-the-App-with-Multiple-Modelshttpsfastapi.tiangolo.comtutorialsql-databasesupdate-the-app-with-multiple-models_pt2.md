...
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/sql-databases/#__tabbed_42_1)
Tip
...
### Create with `HeroCreate` and return a `HeroPublic`[¶](https://fastapi.tiangolo.com/tutorial/sql-databases/#create-with-herocreate-and-return-a-heropublic)
...
👀 Full file preview
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/sql-databases/#__tabbed_44_1)
```
from typing import Annotated
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/sql-databases/#__tabbed_45_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import Depends, FastAPI, HTTPException, Query
...
### Read Heroes with `HeroPublic`[¶](https://fastapi.tiangolo.com/tutorial/sql-databases/#read-heroes-with-heropublic)
...
👀 Full file preview
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/sql-databases/#__tabbed_47_1)
```
from typing import Annotated
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/sql-databases/#__tabbed_48_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import Depends, FastAPI, HTTPException, Query
...
### Read One Hero with `HeroPublic`[¶](https://fastapi.tiangolo.com/tutorial/sql-databases/#read-one-hero-with-heropublic)
...
👀 Full file preview
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/sql-databases/#__tabbed_50_1)
```
from typing import Annotated
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/sql-databases/#__tabbed_51_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import Depends, FastAPI, HTTPException, Query
