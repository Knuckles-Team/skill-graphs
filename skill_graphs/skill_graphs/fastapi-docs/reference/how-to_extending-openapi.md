...
[ ](https://fastapi.tiangolo.com/how-to/extending-openapi/?q= "Share")
...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ How To - Recipes  ](https://fastapi.tiangolo.com/how-to/)
      ...
      * Extending OpenAPI  [ Extending OpenAPI  ](https://fastapi.tiangolo.com/how-to/extending-openapi/)
...
# Extending OpenAPI[¶](https://fastapi.tiangolo.com/how-to/extending-openapi/#extending-openapi)
...
[Python 3.10+](https://fastapi.tiangolo.com/how-to/extending-openapi/#__tabbed_1_1)
```
...
[Python 3.10+](https://fastapi.tiangolo.com/how-to/extending-openapi/#__tabbed_2_1)
```
from fastapi import FastAPI
from fastapi.openapi.utils import get_openapi
...
[Python 3.10+](https://fastapi.tiangolo.com/how-to/extending-openapi/#__tabbed_3_1)
```
from fastapi import FastAPI
from fastapi.openapi.utils import get_openapi
...
[Python 3.10+](https://fastapi.tiangolo.com/how-to/extending-openapi/#__tabbed_4_1)
```
from fastapi import FastAPI
from fastapi.openapi.utils import get_openapi
...
[Python 3.10+](https://fastapi.tiangolo.com/how-to/extending-openapi/#__tabbed_5_1)
```
from fastapi import FastAPI
from fastapi.openapi.utils import get_openapi
...
### Check it[¶](https://fastapi.tiangolo.com/how-to/extending-openapi/#check-it)
Once you go to **FastAPI** 's logo):
![](https://fastapi.tiangolo.com/img/tutorial/extending-openapi/image01.png)
[ Previous  Conditional OpenAPI  ](https://fastapi.tiangolo.com/how-to/conditional-openapi/) [ Next  Separate OpenAPI Schemas for Input and Output or Not  ](https://fastapi.tiangolo.com/how-to/separate-openapi-schemas/)
