...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * Concurrency and async / await  [ Concurrency and async / await  ](https://fastapi.tiangolo.com/async/)
...
# Concurrency and async / await[¶](https://fastapi.tiangolo.com/async/#concurrency-and-async-await)
...
And even if you were not using FastAPI, you could also write your own async applications with _structured concurrency_).
...
[ Previous  Python Types Intro  ](https://fastapi.tiangolo.com/python-types/) [ Next  Environment Variables  ](https://fastapi.tiangolo.com/environment-variables/)
