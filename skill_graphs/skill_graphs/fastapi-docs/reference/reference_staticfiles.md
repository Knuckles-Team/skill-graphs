...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Reference  ](https://fastapi.tiangolo.com/reference/)
    ...
    * Static Files - `StaticFiles` [ Static Files - `StaticFiles` ](https://fastapi.tiangolo.com/reference/staticfiles/)
      * [ ](https://fastapi.tiangolo.com/reference/staticfiles/#fastapi.staticfiles.StaticFiles)
        * [ ](https://fastapi.tiangolo.com/reference/staticfiles/#fastapi.staticfiles.StaticFiles.directory)
        * [ ](https://fastapi.tiangolo.com/reference/staticfiles/#fastapi.staticfiles.StaticFiles.packages)
        * [ ](https://fastapi.tiangolo.com/reference/staticfiles/#fastapi.staticfiles.StaticFiles.all_directories)
        * [ ](https://fastapi.tiangolo.com/reference/staticfiles/#fastapi.staticfiles.StaticFiles.html)
        * [ ](https://fastapi.tiangolo.com/reference/staticfiles/#fastapi.staticfiles.StaticFiles.config_checked)
        * [ ](https://fastapi.tiangolo.com/reference/staticfiles/#fastapi.staticfiles.StaticFiles.follow_symlink)
        * [ ](https://fastapi.tiangolo.com/reference/staticfiles/#fastapi.staticfiles.StaticFiles.get_directories)
        * [ ](https://fastapi.tiangolo.com/reference/staticfiles/#fastapi.staticfiles.StaticFiles.get_path)
        * [ ](https://fastapi.tiangolo.com/reference/staticfiles/#fastapi.staticfiles.StaticFiles.get_response)
        * [ ](https://fastapi.tiangolo.com/reference/staticfiles/#fastapi.staticfiles.StaticFiles.lookup_path)
        * [ ](https://fastapi.tiangolo.com/reference/staticfiles/#fastapi.staticfiles.StaticFiles.file_response)
        * [ ](https://fastapi.tiangolo.com/reference/staticfiles/#fastapi.staticfiles.StaticFiles.check_config)
        * [ ](https://fastapi.tiangolo.com/reference/staticfiles/#fastapi.staticfiles.StaticFiles.is_not_modified)
...
# Static Files - `StaticFiles`[¶](https://fastapi.tiangolo.com/reference/staticfiles/#static-files-staticfiles)
...
###  all_directories `instance-attribute` [¶](https://fastapi.tiangolo.com/reference/staticfiles/#fastapi.staticfiles.StaticFiles.all_directories "Permanent link")
```
...
###  config_checked `instance-attribute` [¶](https://fastapi.tiangolo.com/reference/staticfiles/#fastapi.staticfiles.StaticFiles.config_checked "Permanent link")
```
config_checked = False

```

###  follow_symlink `instance-attribute` [¶](https://fastapi.tiangolo.com/reference/staticfiles/#fastapi.staticfiles.StaticFiles.follow_symlink "Permanent link")
```
follow_symlink = follow_symlink

```

###  get_directories [¶](https://fastapi.tiangolo.com/reference/staticfiles/#fastapi.staticfiles.StaticFiles.get_directories "Permanent link")
```
