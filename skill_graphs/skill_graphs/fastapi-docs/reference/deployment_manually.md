...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Deployment  ](https://fastapi.tiangolo.com/deployment/)
      ...
      * Run a Server Manually  [ Run a Server Manually  ](https://fastapi.tiangolo.com/deployment/manually/)
        * [ Use the `fastapi run` Command  ](https://fastapi.tiangolo.com/deployment/manually/#use-the-fastapi-run-command)
        * [ ASGI Servers  ](https://fastapi.tiangolo.com/deployment/manually/#asgi-servers)
        * [ Server Machine and Server Program  ](https://fastapi.tiangolo.com/deployment/manually/#server-machine-and-server-program)
        * [ Install the Server Program  ](https://fastapi.tiangolo.com/deployment/manually/#install-the-server-program)
        * [ Run the Server Program  ](https://fastapi.tiangolo.com/deployment/manually/#run-the-server-program)
        * [ Deployment Concepts  ](https://fastapi.tiangolo.com/deployment/manually/#deployment-concepts)
...
# Run a Server Manually[¶](https://fastapi.tiangolo.com/deployment/manually/#run-a-server-manually)
## Use the `fastapi run` Command[¶](https://fastapi.tiangolo.com/deployment/manually/#use-the-fastapi-run-command)
