[ Skip to content ](https://fastapi.tiangolo.com/tutorial/query-param-models/#query-parameter-models)
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Tutorial - User Guide  ](https://fastapi.tiangolo.com/tutorial/)
      ...
      * Query Parameter Models  [ Query Parameter Models  ](https://fastapi.tiangolo.com/tutorial/query-param-models/)
        ...
        * [ Summary  ](https://fastapi.tiangolo.com/tutorial/query-param-models/#summary)
...
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/query-param-models/#__tabbed_2_1)
Tip
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/query-param-models/#__tabbed_4_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from typing import Literal
