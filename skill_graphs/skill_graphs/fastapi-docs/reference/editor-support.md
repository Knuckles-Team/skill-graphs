...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * Editor Support  [ Editor Support  ](https://fastapi.tiangolo.com/editor-support/)
      * [ Setup and Installation  ](https://fastapi.tiangolo.com/editor-support/#setup-and-installation)
        * [ Application Discovery  ](https://fastapi.tiangolo.com/editor-support/#application-discovery)
      * [ Features  ](https://fastapi.tiangolo.com/editor-support/#features)
...
# Editor Support[¶](https://fastapi.tiangolo.com/editor-support/#editor-support)
The official _path operation_ discovery, navigation, as well as FastAPI Cloud deployment, and live log streaming.
For more details about the extension, refer to the README on the
## Setup and Installation[¶](https://fastapi.tiangolo.com/editor-support/#setup-and-installation)
The **FastAPI Extension** is available for both **FastAPI Labs**. The extension also works in browser-based editors such as
### Application Discovery[¶](https://fastapi.tiangolo.com/editor-support/#application-discovery)
...
## Features[¶](https://fastapi.tiangolo.com/editor-support/#features)
  ...
  * **Deploy to FastAPI Cloud** - One-click deployment of your app to
