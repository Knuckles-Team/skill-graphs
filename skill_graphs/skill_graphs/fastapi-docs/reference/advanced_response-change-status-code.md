...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Advanced User Guide  ](https://fastapi.tiangolo.com/advanced/)
      ...
      * Response - Change Status Code  [ Response - Change Status Code  ](https://fastapi.tiangolo.com/advanced/response-change-status-code/)
        * [ Use case  ](https://fastapi.tiangolo.com/advanced/response-change-status-code/#use-case)
        * [ Use a `Response` parameter  ](https://fastapi.tiangolo.com/advanced/response-change-status-code/#use-a-response-parameter)
...
# Response - Change Status Code[¶](https://fastapi.tiangolo.com/advanced/response-change-status-code/#response-change-status-code)
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/response-change-status-code/#__tabbed_1_1)
```
