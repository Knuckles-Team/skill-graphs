[ Skip to content ](https://fastapi.tiangolo.com/tutorial/header-params/#header-parameters)
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Tutorial - User Guide  ](https://fastapi.tiangolo.com/tutorial/)
      ...
      * Header Parameters  [ Header Parameters  ](https://fastapi.tiangolo.com/tutorial/header-params/)
        * [ Import `Header` ](https://fastapi.tiangolo.com/tutorial/header-params/#import-header)
        * [ Declare `Header` parameters  ](https://fastapi.tiangolo.com/tutorial/header-params/#declare-header-parameters)
        * [ Automatic conversion  ](https://fastapi.tiangolo.com/tutorial/header-params/#automatic-conversion)
        * [ Duplicate headers  ](https://fastapi.tiangolo.com/tutorial/header-params/#duplicate-headers)
        * [ Recap  ](https://fastapi.tiangolo.com/tutorial/header-params/#recap)
...
# Header Parameters[¶](https://fastapi.tiangolo.com/tutorial/header-params/#header-parameters)
...
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/header-params/#__tabbed_2_1)
Tip
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/header-params/#__tabbed_4_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import FastAPI, Header
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/header-params/#__tabbed_6_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import FastAPI, Header
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/header-params/#__tabbed_8_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import FastAPI, Header
