...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Advanced User Guide  ](https://fastapi.tiangolo.com/advanced/)
      ...
      * Sub Applications - Mounts  [ Sub Applications - Mounts  ](https://fastapi.tiangolo.com/advanced/sub-applications/)
        * [ Mounting a **FastAPI** application  ](https://fastapi.tiangolo.com/advanced/sub-applications/#mounting-a-fastapi-application)
          * [ Top-level application  ](https://fastapi.tiangolo.com/advanced/sub-applications/#top-level-application)
          * [ Sub-application  ](https://fastapi.tiangolo.com/advanced/sub-applications/#sub-application)
          * [ Mount the sub-application  ](https://fastapi.tiangolo.com/advanced/sub-applications/#mount-the-sub-application)
          * [ Check the automatic API docs  ](https://fastapi.tiangolo.com/advanced/sub-applications/#check-the-automatic-api-docs)
          * [ Technical Details: `root_path` ](https://fastapi.tiangolo.com/advanced/sub-applications/#technical-details-root-path)
...
# Sub Applications - Mounts[¶](https://fastapi.tiangolo.com/advanced/sub-applications/#sub-applications-mounts)
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/sub-applications/#__tabbed_1_1)
```
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/sub-applications/#__tabbed_2_1)
```
from fastapi import FastAPI
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/sub-applications/#__tabbed_3_1)
```
from fastapi import FastAPI
