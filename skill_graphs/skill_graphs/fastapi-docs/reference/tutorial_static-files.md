...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Tutorial - User Guide  ](https://fastapi.tiangolo.com/tutorial/)
      ...
      * Static Files  [ Static Files  ](https://fastapi.tiangolo.com/tutorial/static-files/)
...
# Static Files[¶](https://fastapi.tiangolo.com/tutorial/static-files/#static-files)
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/static-files/#__tabbed_1_1)
```
