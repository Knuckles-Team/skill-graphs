...
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/security/oauth2-jwt/#__tabbed_2_1)
Tip
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/security/oauth2-jwt/#__tabbed_4_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from datetime import datetime, timedelta, timezone
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/security/oauth2-jwt/#__tabbed_6_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from datetime import datetime, timedelta, timezone
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/security/oauth2-jwt/#__tabbed_8_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from datetime import datetime, timedelta, timezone
