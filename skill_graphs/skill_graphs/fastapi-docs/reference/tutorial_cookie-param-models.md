...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Tutorial - User Guide  ](https://fastapi.tiangolo.com/tutorial/)
      ...
      * Cookie Parameter Models  [ Cookie Parameter Models  ](https://fastapi.tiangolo.com/tutorial/cookie-param-models/)
        * [ Cookies with a Pydantic Model  ](https://fastapi.tiangolo.com/tutorial/cookie-param-models/#cookies-with-a-pydantic-model)
        * [ Check the Docs  ](https://fastapi.tiangolo.com/tutorial/cookie-param-models/#check-the-docs)
...
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/cookie-param-models/#__tabbed_2_1)
Tip
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/cookie-param-models/#__tabbed_3_1)
```
from typing import Annotated
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/cookie-param-models/#__tabbed_4_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import Cookie, FastAPI
