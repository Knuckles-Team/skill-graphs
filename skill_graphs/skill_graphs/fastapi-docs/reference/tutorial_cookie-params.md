...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Tutorial - User Guide  ](https://fastapi.tiangolo.com/tutorial/)
      ...
      * Cookie Parameters  [ Cookie Parameters  ](https://fastapi.tiangolo.com/tutorial/cookie-params/)
...
# Cookie Parameters[¶](https://fastapi.tiangolo.com/tutorial/cookie-params/#cookie-parameters)
...
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/cookie-params/#__tabbed_2_1)
Tip
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/cookie-params/#__tabbed_4_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import Cookie, FastAPI
