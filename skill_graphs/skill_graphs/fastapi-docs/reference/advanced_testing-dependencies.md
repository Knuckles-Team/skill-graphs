...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Advanced User Guide  ](https://fastapi.tiangolo.com/advanced/)
      ...
      * Testing Dependencies with Overrides  [ Testing Dependencies with Overrides  ](https://fastapi.tiangolo.com/advanced/testing-dependencies/)
        * [ Overriding dependencies during testing  ](https://fastapi.tiangolo.com/advanced/testing-dependencies/#overriding-dependencies-during-testing)
          * [ Use cases: external service  ](https://fastapi.tiangolo.com/advanced/testing-dependencies/#use-cases-external-service)
          * [ Use the `app.dependency_overrides` attribute  ](https://fastapi.tiangolo.com/advanced/testing-dependencies/#use-the-app-dependency-overrides-attribute)
...
# Testing Dependencies with Overrides[¶](https://fastapi.tiangolo.com/advanced/testing-dependencies/#testing-dependencies-with-overrides)
## Overriding dependencies during testing[¶](https://fastapi.tiangolo.com/advanced/testing-dependencies/#overriding-dependencies-during-testing)
...
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/advanced/testing-dependencies/#__tabbed_2_1)
Tip
