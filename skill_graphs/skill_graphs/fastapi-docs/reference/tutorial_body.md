[ Skip to content ](https://fastapi.tiangolo.com/tutorial/body/#request-body)
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Tutorial - User Guide  ](https://fastapi.tiangolo.com/tutorial/)
      ...
      * Request Body  [ Request Body  ](https://fastapi.tiangolo.com/tutorial/body/)
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/body/#__tabbed_2_1)
```
from fastapi import FastAPI
from pydantic import BaseModel
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/body/#__tabbed_4_1)
```
from fastapi import FastAPI
from pydantic import BaseModel
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/body/#__tabbed_6_1)
```
from fastapi import FastAPI
from pydantic import BaseModel
