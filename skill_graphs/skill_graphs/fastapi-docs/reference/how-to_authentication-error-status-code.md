[ Skip to content ](https://fastapi.tiangolo.com/how-to/authentication-error-status-code/#use-old-403-authentication-error-status-codes)
...
# Use Old 403 Authentication Error Status Codes[¶](https://fastapi.tiangolo.com/how-to/authentication-error-status-code/#use-old-403-authentication-error-status-codes)
...
Starting with FastAPI version `0.122.0`, they use the more appropriate HTTP status code `401 Unauthorized`, and return a sensible `WWW-Authenticate` header in the response, following the HTTP specifications,
...
[Python 3.10+](https://fastapi.tiangolo.com/how-to/authentication-error-status-code/#__tabbed_1_1)
```
