...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ How To - Recipes  ](https://fastapi.tiangolo.com/how-to/)
      ...
      * Conditional OpenAPI  [ Conditional OpenAPI  ](https://fastapi.tiangolo.com/how-to/conditional-openapi/)
        * [ About security, APIs, and docs  ](https://fastapi.tiangolo.com/how-to/conditional-openapi/#about-security-apis-and-docs)
        * [ Conditional OpenAPI from settings and env vars  ](https://fastapi.tiangolo.com/how-to/conditional-openapi/#conditional-openapi-from-settings-and-env-vars)
...
# Conditional OpenAPI[¶](https://fastapi.tiangolo.com/how-to/conditional-openapi/#conditional-openapi)
...
For example:
[Python 3.10+](https://fastapi.tiangolo.com/how-to/conditional-openapi/#__tabbed_1_1)
```
