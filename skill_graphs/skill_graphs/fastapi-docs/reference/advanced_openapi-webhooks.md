...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Advanced User Guide  ](https://fastapi.tiangolo.com/advanced/)
      ...
      * OpenAPI Webhooks  [ OpenAPI Webhooks  ](https://fastapi.tiangolo.com/advanced/openapi-webhooks/)
        * [ Webhooks steps  ](https://fastapi.tiangolo.com/advanced/openapi-webhooks/#webhooks-steps)
        * [ Documenting webhooks with **FastAPI** and OpenAPI  ](https://fastapi.tiangolo.com/advanced/openapi-webhooks/#documenting-webhooks-with-fastapi-and-openapi)
        * [ An app with webhooks  ](https://fastapi.tiangolo.com/advanced/openapi-webhooks/#an-app-with-webhooks)
          * [ Check the docs  ](https://fastapi.tiangolo.com/advanced/openapi-webhooks/#check-the-docs)
...
# OpenAPI Webhooks[¶](https://fastapi.tiangolo.com/advanced/openapi-webhooks/#openapi-webhooks)
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/openapi-webhooks/#__tabbed_1_1)
```
