...
[ ](https://fastapi.tiangolo.com/reference/templating/?q= "Share")
Initializing search
...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Reference  ](https://fastapi.tiangolo.com/reference/)
    ...
    * Templating - `Jinja2Templates` [ Templating - `Jinja2Templates` ](https://fastapi.tiangolo.com/reference/templating/)
      * [ ](https://fastapi.tiangolo.com/reference/templating/#fastapi.templating.Jinja2Templates)
        * [ ](https://fastapi.tiangolo.com/reference/templating/#fastapi.templating.Jinja2Templates.context_processors)
        * [ ](https://fastapi.tiangolo.com/reference/templating/#fastapi.templating.Jinja2Templates.env)
        * [ ](https://fastapi.tiangolo.com/reference/templating/#fastapi.templating.Jinja2Templates.get_template)
...
# Templating - `Jinja2Templates`[¶](https://fastapi.tiangolo.com/reference/templating/#templating-jinja2templates)
...
---|---
[ Previous  Static Files - StaticFiles  ](https://fastapi.tiangolo.com/reference/staticfiles/) [ Next  Test Client - TestClient  ](https://fastapi.tiangolo.com/reference/testclient/)
