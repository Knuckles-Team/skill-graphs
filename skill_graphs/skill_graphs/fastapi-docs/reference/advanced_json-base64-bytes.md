...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Advanced User Guide  ](https://fastapi.tiangolo.com/advanced/)
      ...
      * JSON with Bytes as Base64  [ JSON with Bytes as Base64  ](https://fastapi.tiangolo.com/advanced/json-base64-bytes/)
        ...
        * [ Pydantic `bytes` for Output Data  ](https://fastapi.tiangolo.com/advanced/json-base64-bytes/#pydantic-bytes-for-output-data)
        * [ Pydantic `bytes` for Input and Output Data  ](https://fastapi.tiangolo.com/advanced/json-base64-bytes/#pydantic-bytes-for-input-and-output-data)
...
## Base64 vs Files[¶](https://fastapi.tiangolo.com/advanced/json-base64-bytes/#base64-vs-files)
Consider first if you can use [Request Files](https://fastapi.tiangolo.com/tutorial/request-files/) for uploading binary data and [Custom Response - FileResponse](https://fastapi.tiangolo.com/advanced/custom-response/#fileresponse--fileresponse-) for sending binary data, instead of encoding it in JSON.
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/json-base64-bytes/#__tabbed_3_1)
```
from fastapi import FastAPI
from pydantic import BaseModel
...
👀 Full file preview
[Python 3.10+](https://fastapi.tiangolo.com/advanced/json-base64-bytes/#__tabbed_4_1)
```
from fastapi import FastAPI
from pydantic import BaseModel
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/json-base64-bytes/#__tabbed_5_1)
```
from fastapi import FastAPI
from pydantic import BaseModel
...
👀 Full file preview
[Python 3.10+](https://fastapi.tiangolo.com/advanced/json-base64-bytes/#__tabbed_6_1)
```
from fastapi import FastAPI
from pydantic import BaseModel
