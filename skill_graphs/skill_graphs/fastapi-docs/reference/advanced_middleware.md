...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Advanced User Guide  ](https://fastapi.tiangolo.com/advanced/)
      ...
      * Advanced Middleware  [ Advanced Middleware  ](https://fastapi.tiangolo.com/advanced/middleware/)
        * [ Adding ASGI middlewares  ](https://fastapi.tiangolo.com/advanced/middleware/#adding-asgi-middlewares)
        * [ Integrated middlewares  ](https://fastapi.tiangolo.com/advanced/middleware/#integrated-middlewares)
        * [ `HTTPSRedirectMiddleware` ](https://fastapi.tiangolo.com/advanced/middleware/#httpsredirectmiddleware)
        ...
        * [ Other middlewares  ](https://fastapi.tiangolo.com/advanced/middleware/#other-middlewares)
...
# Advanced Middleware[¶](https://fastapi.tiangolo.com/advanced/middleware/#advanced-middleware)
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/middleware/#__tabbed_1_1)
```
from fastapi import FastAPI
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/middleware/#__tabbed_2_1)
```
from fastapi import FastAPI
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/middleware/#__tabbed_3_1)
```
from fastapi import FastAPI
