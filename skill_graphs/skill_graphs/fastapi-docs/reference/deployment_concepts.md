...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Deployment  ](https://fastapi.tiangolo.com/deployment/)
      ...
      * Deployments Concepts  [ Deployments Concepts  ](https://fastapi.tiangolo.com/deployment/concepts/)
        * [ Security - HTTPS  ](https://fastapi.tiangolo.com/deployment/concepts/#security-https)
          * [ Example Tools for HTTPS  ](https://fastapi.tiangolo.com/deployment/concepts/#example-tools-for-https)
        * [ Program and Process  ](https://fastapi.tiangolo.com/deployment/concepts/#program-and-process)
          * [ What is a Program  ](https://fastapi.tiangolo.com/deployment/concepts/#what-is-a-program)
          * [ What is a Process  ](https://fastapi.tiangolo.com/deployment/concepts/#what-is-a-process)
        * [ Running on Startup  ](https://fastapi.tiangolo.com/deployment/concepts/#running-on-startup)
          * [ In a Remote Server  ](https://fastapi.tiangolo.com/deployment/concepts/#in-a-remote-server)
          * [ Run Automatically on Startup  ](https://fastapi.tiangolo.com/deployment/concepts/#run-automatically-on-startup)
...
# Deployments Concepts[¶](https://fastapi.tiangolo.com/deployment/concepts/#deployments-concepts)
...
![](https://fastapi.tiangolo.com/img/deployment/concepts/process-ram.drawio.svg)
