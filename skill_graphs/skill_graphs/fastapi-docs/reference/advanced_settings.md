...
[ ](https://fastapi.tiangolo.com/advanced/settings/?q= "Share")
...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Advanced User Guide  ](https://fastapi.tiangolo.com/advanced/)
      ...
      * Settings and Environment Variables  [ Settings and Environment Variables  ](https://fastapi.tiangolo.com/advanced/settings/)
        * [ Types and validation  ](https://fastapi.tiangolo.com/advanced/settings/#types-and-validation)
        * [ Pydantic `Settings` ](https://fastapi.tiangolo.com/advanced/settings/#pydantic-settings)
          * [ Install `pydantic-settings` ](https://fastapi.tiangolo.com/advanced/settings/#install-pydantic-settings)
          * [ Create the `Settings` object  ](https://fastapi.tiangolo.com/advanced/settings/#create-the-settings-object)
          * [ Use the `settings` ](https://fastapi.tiangolo.com/advanced/settings/#use-the-settings)
          * [ Run the server  ](https://fastapi.tiangolo.com/advanced/settings/#run-the-server)
        * [ Settings in another module  ](https://fastapi.tiangolo.com/advanced/settings/#settings-in-another-module)
        * [ Settings in a dependency  ](https://fastapi.tiangolo.com/advanced/settings/#settings-in-a-dependency)
          * [ The config file  ](https://fastapi.tiangolo.com/advanced/settings/#the-config-file)
          * [ The main app file  ](https://fastapi.tiangolo.com/advanced/settings/#the-main-app-file)
          * [ Settings and testing  ](https://fastapi.tiangolo.com/advanced/settings/#settings-and-testing)
        * [ Reading a `.env` file  ](https://fastapi.tiangolo.com/advanced/settings/#reading-a-env-file)
          * [ The `.env` file  ](https://fastapi.tiangolo.com/advanced/settings/#the-env-file)
          * [ Read settings from `.env` ](https://fastapi.tiangolo.com/advanced/settings/#read-settings-from-env)
          * [ Creating the `Settings` only once with `lru_cache` ](https://fastapi.tiangolo.com/advanced/settings/#creating-the-settings-only-once-with-lru-cache)
            * [ `lru_cache` Technical Details  ](https://fastapi.tiangolo.com/advanced/settings/#lru-cache-technical-details)
...
# Settings and Environment Variables[¶](https://fastapi.tiangolo.com/advanced/settings/#settings-and-environment-variables)
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/settings/#__tabbed_1_1)
```
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/settings/#__tabbed_2_1)
```
from fastapi import FastAPI
from pydantic_settings import BaseSettings
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/settings/#__tabbed_3_1)
```
from pydantic_settings import BaseSettings
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/settings/#__tabbed_4_1)
```
from fastapi import FastAPI
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/settings/#__tabbed_5_1)
```
from pydantic_settings import BaseSettings
...
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/advanced/settings/#__tabbed_6_1)
Tip
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/settings/#__tabbed_7_1)
```
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/advanced/settings/#__tabbed_8_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from functools import lru_cache
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/settings/#__tabbed_9_1)
```
from functools import lru_cache
from typing import Annotated
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/advanced/settings/#__tabbed_10_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from functools import lru_cache
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/settings/#__tabbed_11_1)
```
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/advanced/settings/#__tabbed_12_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi.testclient import TestClient
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/settings/#__tabbed_13_1)
```
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/advanced/settings/#__tabbed_14_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from pydantic_settings import BaseSettings, SettingsConfigDict
...
Tip
The `model_config` attribute is used just for Pydantic configuration. You can read more at
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/settings/#__tabbed_15_1)
```
from functools import lru_cache
from typing import Annotated
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/advanced/settings/#__tabbed_16_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from functools import lru_cache
...
[ Previous  Async Tests  ](https://fastapi.tiangolo.com/advanced/async-tests/) [ Next  OpenAPI Callbacks  ](https://fastapi.tiangolo.com/advanced/openapi-callbacks/)
