[ Skip to content ](https://fastapi.tiangolo.com/deployment/fastapicloud/#fastapi-cloud)
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Deployment  ](https://fastapi.tiangolo.com/deployment/)
      ...
      * FastAPI Cloud  [ FastAPI Cloud  ](https://fastapi.tiangolo.com/deployment/fastapicloud/)
        * [ Login  ](https://fastapi.tiangolo.com/deployment/fastapicloud/#login)
        * [ Deploy  ](https://fastapi.tiangolo.com/deployment/fastapicloud/#deploy)
        * [ About FastAPI Cloud  ](https://fastapi.tiangolo.com/deployment/fastapicloud/#about-fastapi-cloud)
        * [ Deploy to other cloud providers  ](https://fastapi.tiangolo.com/deployment/fastapicloud/#deploy-to-other-cloud-providers)
        * [ Deploy your own server  ](https://fastapi.tiangolo.com/deployment/fastapicloud/#deploy-your-own-server)
...
# FastAPI Cloud[¶](https://fastapi.tiangolo.com/deployment/fastapicloud/#fastapi-cloud)
You can deploy your FastAPI app to **one command** , go and join the waiting list if you haven't. 🚀
## Login[¶](https://fastapi.tiangolo.com/deployment/fastapicloud/#login)
