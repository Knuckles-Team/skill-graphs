...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Advanced User Guide  ](https://fastapi.tiangolo.com/advanced/)
      ...
      * Including WSGI - Flask, Django, others  [ Including WSGI - Flask, Django, others  ](https://fastapi.tiangolo.com/advanced/wsgi/)
        * [ Using `WSGIMiddleware` ](https://fastapi.tiangolo.com/advanced/wsgi/#using-wsgimiddleware)
        * [ Check it  ](https://fastapi.tiangolo.com/advanced/wsgi/#check-it)
...
# Including WSGI - Flask, Django, others[¶](https://fastapi.tiangolo.com/advanced/wsgi/#including-wsgi-flask-django-others)
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/wsgi/#__tabbed_1_1)
```
