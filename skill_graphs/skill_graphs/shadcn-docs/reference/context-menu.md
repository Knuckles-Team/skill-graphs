...
# Context Menu
[Previous](https://ui.shadcn.com/docs/components/radix/command)[Next](https://ui.shadcn.com/docs/components/radix/data-table)
Displays a menu of actions triggered by a right click.
[Radix UI](https://ui.shadcn.com/docs/components/radix/context-menu)[Base UI](https://ui.shadcn.com/docs/components/base/context-menu)
Radix UI
...
## API Reference
See the
[Command](https://ui.shadcn.com/docs/components/radix/command)[Data Table ](https://ui.shadcn.com/docs/components/radix/data-table)
On This Page
[Installation](https://ui.shadcn.com/docs/components/radix/context-menu#installation)[Usage](https://ui.shadcn.com/docs/components/radix/context-menu#usage)[Examples](https://ui.shadcn.com/docs/components/radix/context-menu#examples)[Basic](https://ui.shadcn.com/docs/components/radix/context-menu#basic)[Submenu](https://ui.shadcn.com/docs/components/radix/context-menu#submenu)[Shortcuts](https://ui.shadcn.com/docs/components/radix/context-menu#shortcuts)[Groups](https://ui.shadcn.com/docs/components/radix/context-menu#groups)[Icons](https://ui.shadcn.com/docs/components/radix/context-menu#icons)[Checkboxes](https://ui.shadcn.com/docs/components/radix/context-menu#checkboxes)[Radio](https://ui.shadcn.com/docs/components/radix/context-menu#radio)[Destructive](https://ui.shadcn.com/docs/components/radix/context-menu#destructive)[RTL](https://ui.shadcn.com/docs/components/radix/context-menu#rtl)[API Reference](https://ui.shadcn.com/docs/components/radix/context-menu#api-reference)
