...
# Label
[Previous](https://ui.shadcn.com/docs/components/radix/kbd)[Next](https://ui.shadcn.com/docs/components/radix/menubar)
Renders an accessible label associated with controls.
[Radix UI](https://ui.shadcn.com/docs/components/radix/label)[Base UI](https://ui.shadcn.com/docs/components/base/label)
Radix UI
...
View Code
For form fields, use the [Field](https://ui.shadcn.com/docs/components/radix/field) component which includes built-in label, description, and error handling.
## Installation
CommandManual
```
...
## Label in Field
For form fields, use the [Field](https://ui.shadcn.com/docs/components/radix/field) component which includes built-in `FieldLabel`, `FieldDescription`, and `FieldError` components.
```
Copy<Field>
...
MonthMM01 02 03 04 05 06 07 08 09 10 11 12
YearYYYY2024 2025 2026 2027 2028 2029
CVV
Billing Address
...
## API Reference
See the
[Kbd](https://ui.shadcn.com/docs/components/radix/kbd)[Menubar ](https://ui.shadcn.com/docs/components/radix/menubar)
On This Page
[Installation](https://ui.shadcn.com/docs/components/radix/label#installation)[Usage](https://ui.shadcn.com/docs/components/radix/label#usage)[Label in Field](https://ui.shadcn.com/docs/components/radix/label#label-in-field)[RTL](https://ui.shadcn.com/docs/components/radix/label#rtl)[API Reference](https://ui.shadcn.com/docs/components/radix/label#api-reference)
