...
# Toggle
[Previous](https://ui.shadcn.com/docs/components/radix/toast)[Next](https://ui.shadcn.com/docs/components/radix/toggle-group)
A two-state button that can be either on or off.
[Radix UI](https://ui.shadcn.com/docs/components/radix/toggle)[Base UI](https://ui.shadcn.com/docs/components/base/toggle)
Radix UI
Copy
```
...
## API Reference
See the
[Toast](https://ui.shadcn.com/docs/components/radix/toast)[Toggle Group ](https://ui.shadcn.com/docs/components/radix/toggle-group)
On This Page
[Installation](https://ui.shadcn.com/docs/components/radix/toggle#installation)[Usage](https://ui.shadcn.com/docs/components/radix/toggle#usage)[Examples](https://ui.shadcn.com/docs/components/radix/toggle#examples)[Outline](https://ui.shadcn.com/docs/components/radix/toggle#outline)[With Text](https://ui.shadcn.com/docs/components/radix/toggle#with-text)[Size](https://ui.shadcn.com/docs/components/radix/toggle#size)[Disabled](https://ui.shadcn.com/docs/components/radix/toggle#disabled)[RTL](https://ui.shadcn.com/docs/components/radix/toggle#rtl)[API Reference](https://ui.shadcn.com/docs/components/radix/toggle#api-reference)
