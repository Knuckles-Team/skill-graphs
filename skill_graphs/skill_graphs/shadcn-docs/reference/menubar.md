...
# Menubar
[Previous](https://ui.shadcn.com/docs/components/radix/label)[Next](https://ui.shadcn.com/docs/components/radix/native-select)
A visually persistent menu common in desktop applications that provides quick access to a consistent set of commands.
[Radix UI](https://ui.shadcn.com/docs/components/radix/menubar)[Base UI](https://ui.shadcn.com/docs/components/base/menubar)
Radix UI
...
## API Reference
See the
[Label](https://ui.shadcn.com/docs/components/radix/label)[Native Select ](https://ui.shadcn.com/docs/components/radix/native-select)
On This Page
[Installation](https://ui.shadcn.com/docs/components/radix/menubar#installation)[Usage](https://ui.shadcn.com/docs/components/radix/menubar#usage)[Examples](https://ui.shadcn.com/docs/components/radix/menubar#examples)[Checkbox](https://ui.shadcn.com/docs/components/radix/menubar#checkbox)[Radio](https://ui.shadcn.com/docs/components/radix/menubar#radio)[Submenu](https://ui.shadcn.com/docs/components/radix/menubar#submenu)[With Icons](https://ui.shadcn.com/docs/components/radix/menubar#with-icons)[RTL](https://ui.shadcn.com/docs/components/radix/menubar#rtl)[API Reference](https://ui.shadcn.com/docs/components/radix/menubar#api-reference)
