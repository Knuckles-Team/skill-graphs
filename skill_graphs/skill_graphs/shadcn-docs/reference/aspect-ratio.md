...
# Aspect Ratio
[Previous](https://ui.shadcn.com/docs/components/radix/alert-dialog)[Next](https://ui.shadcn.com/docs/components/radix/avatar)
Displays content within a desired ratio.
[Radix UI](https://ui.shadcn.com/docs/components/radix/aspect-ratio)[Base UI](https://ui.shadcn.com/docs/components/base/aspect-ratio)
Radix UI
...
[Alert Dialog](https://ui.shadcn.com/docs/components/radix/alert-dialog)[Avatar ](https://ui.shadcn.com/docs/components/radix/avatar)
On This Page
[Installation](https://ui.shadcn.com/docs/components/radix/aspect-ratio#installation)[Usage](https://ui.shadcn.com/docs/components/radix/aspect-ratio#usage)[Examples](https://ui.shadcn.com/docs/components/radix/aspect-ratio#examples)[Square](https://ui.shadcn.com/docs/components/radix/aspect-ratio#square)[Portrait](https://ui.shadcn.com/docs/components/radix/aspect-ratio#portrait)[RTL](https://ui.shadcn.com/docs/components/radix/aspect-ratio#rtl)[API Reference](https://ui.shadcn.com/docs/components/radix/aspect-ratio#api-reference)[AspectRatio](https://ui.shadcn.com/docs/components/radix/aspect-ratio#aspectratio)
