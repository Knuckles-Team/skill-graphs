...
# Collapsible
[Previous](https://ui.shadcn.com/docs/components/radix/checkbox)[Next](https://ui.shadcn.com/docs/components/radix/combobox)
An interactive component which expands/collapses a panel.
[Radix UI](https://ui.shadcn.com/docs/components/radix/collapsible)[Base UI](https://ui.shadcn.com/docs/components/base/collapsible)
Radix UI
#### Order #4189
Toggle details
StatusShipped
...
## API Reference
See the
[Checkbox](https://ui.shadcn.com/docs/components/radix/checkbox)[Combobox ](https://ui.shadcn.com/docs/components/radix/combobox)
On This Page
[Installation](https://ui.shadcn.com/docs/components/radix/collapsible#installation)[Usage](https://ui.shadcn.com/docs/components/radix/collapsible#usage)[Controlled State](https://ui.shadcn.com/docs/components/radix/collapsible#controlled-state)[Examples](https://ui.shadcn.com/docs/components/radix/collapsible#examples)[Basic](https://ui.shadcn.com/docs/components/radix/collapsible#basic)[Settings Panel](https://ui.shadcn.com/docs/components/radix/collapsible#settings-panel)[File Tree](https://ui.shadcn.com/docs/components/radix/collapsible#file-tree)[RTL](https://ui.shadcn.com/docs/components/radix/collapsible#rtl)[API Reference](https://ui.shadcn.com/docs/components/radix/collapsible#api-reference)
