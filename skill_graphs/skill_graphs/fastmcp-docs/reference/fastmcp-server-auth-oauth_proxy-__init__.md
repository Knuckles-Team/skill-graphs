[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-auth-oauth_proxy-__init__#content-area)
...
On this page
  * [fastmcp.server.auth.oauth_proxy](https://gofastmcp.com/python-sdk/fastmcp-server-auth-oauth_proxy-__init__#fastmcp-server-auth-oauth_proxy)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-oauth_proxy-__init__#fastmcp-server-auth-oauth_proxy)
`fastmcp.server.auth.oauth_proxy`
OAuth Proxy Provider for FastMCP. This package provides OAuth proxy functionality split across multiple modules:
...
[ middleware Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-middleware)[ consent Next ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-oauth_proxy-consent)
Ctrl+I
