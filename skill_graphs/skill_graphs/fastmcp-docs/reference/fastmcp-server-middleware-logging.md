[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-logging#content-area)
...
On this page
  ...
  * [Functions](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-logging#functions)
  * [default_serializer ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-logging#default_serializer)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-logging#classes)
  * [BaseLoggingMiddleware ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-logging#baseloggingmiddleware)
  * [on_message ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-logging#on_message)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-logging#fastmcp-server-middleware-logging)
`fastmcp.server.middleware.logging`
Comprehensive logging middleware for FastMCP servers.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-logging#functions)
Functions
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-logging#default_serializer)
`default_serializer`
Copy
```
...
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-logging#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-logging#baseloggingmiddleware)
`BaseLoggingMiddleware`
Base class for logging middleware. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-logging#on_message)
`on_message`
Copy
```
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-logging#loggingmiddleware)
`LoggingMiddleware`
Middleware that provides comprehensive request and response logging. Logs all MCP messages with configurable detail levels. Useful for debugging, monitoring, and understanding server usage patterns.
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-logging#structuredloggingmiddleware)
`StructuredLoggingMiddleware`
Middleware that provides structured JSON logging for better log analysis. Outputs structured logs that are easier to parse and analyze with log aggregation tools like ELK stack, Splunk, or cloud logging services.
[ error_handling Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-error_handling)[ middleware Next ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-middleware)
Ctrl+I
