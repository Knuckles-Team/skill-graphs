[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#content-area)
...
On this page
  * [fastmcp.prompts.function_prompt](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#fastmcp-prompts-function_prompt)
  * [Functions](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#functions)
  * [prompt ](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#prompt)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#classes)
  * [DecoratedPrompt ](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#decoratedprompt)
  * [PromptMeta ](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#promptmeta)
  * [FunctionPrompt ](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#functionprompt)
  * [from_function ](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#from_function)
  * [render ](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#render)
  * [register_with_docket ](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#register_with_docket)
  * [add_to_docket ](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#add_to_docket)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#fastmcp-prompts-function_prompt)
`fastmcp.prompts.function_prompt`
Standalone @prompt decorator for FastMCP.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#functions)
Functions
###
[​](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#prompt)
`prompt`
Copy
```
...
##
[​](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#decoratedprompt)
`DecoratedPrompt`
Protocol for functions decorated with @prompt.
###
[​](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#promptmeta)
`PromptMeta`
Metadata attached to functions by the @prompt decorator.
###
[​](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#functionprompt)
`FunctionPrompt`
A prompt that is a function. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#from_function)
`from_function`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#render)
`render`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#register_with_docket)
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-prompts-function_prompt#add_to_docket)
`add_to_docket`
Copy
```
...
[ __init__ Previous ](https://gofastmcp.com/python-sdk/fastmcp-prompts-__init__)[ prompt Next ](https://gofastmcp.com/python-sdk/fastmcp-prompts-prompt)
Ctrl+I
