[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-client-transports-sse#content-area)
...
On this page
  * [fastmcp.client.transports.sse](https://gofastmcp.com/python-sdk/fastmcp-client-transports-sse#fastmcp-client-transports-sse)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-client-transports-sse#classes)
  * [SSETransport ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-sse#ssetransport)
  * [connect_session ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-sse#connect_session)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-sse#fastmcp-client-transports-sse)
`fastmcp.client.transports.sse`
Server-Sent Events (SSE) transport for FastMCP Client.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-sse#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-sse#ssetransport)
`SSETransport`
Transport implementation that connects to an MCP server via Server-Sent Events. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-sse#connect_session)
`connect_session`
Copy
```
...
[ memory Previous ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-memory)[ stdio Next ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio)
Ctrl+I
