[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-__init__#content-area)
...
On this page
  * [fastmcp.client.sampling.handlers](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-__init__#fastmcp-client-sampling-handlers)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-__init__#fastmcp-client-sampling-handlers)
`fastmcp.client.sampling.handlers`
_This module is empty or contains only private/internal implementations._
[ __init__ Previous ](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-__init__)[ anthropic Next ](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-anthropic)
Ctrl+I
