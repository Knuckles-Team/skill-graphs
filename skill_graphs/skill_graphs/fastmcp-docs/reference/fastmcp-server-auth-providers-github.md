[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-github#content-area)
...
On this page
  * [fastmcp.server.auth.providers.github](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-github#fastmcp-server-auth-providers-github)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-github#classes)
  * [GitHubTokenVerifier ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-github#githubtokenverifier)
  * [verify_token ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-github#verify_token)
  * [GitHubProvider ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-github#githubprovider)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-github#fastmcp-server-auth-providers-github)
`fastmcp.server.auth.providers.github`
GitHub OAuth provider for FastMCP. This module provides a complete GitHub OAuth integration that’s ready to use with just a client ID and client secret. It handles all the complexity of GitHub’s OAuth flow, token validation, and user management. Example:
Copy
```
...
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-github#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-github#githubtokenverifier)
`GitHubTokenVerifier`
Token verifier for GitHub OAuth tokens. GitHub OAuth tokens are opaque (not JWTs), so we verify them by calling GitHub’s API to check if they’re valid and get user info. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-github#verify_token)
`verify_token`
Copy
```
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-github#githubprovider)
`GitHubProvider`
Complete GitHub OAuth provider for FastMCP. This provider makes it trivial to add GitHub OAuth protection to any FastMCP server. Just provide your GitHub OAuth app credentials and a base URL, and you’re ready to go. Features:
...
[ discord Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-discord)[ google Next ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-google)
Ctrl+I
