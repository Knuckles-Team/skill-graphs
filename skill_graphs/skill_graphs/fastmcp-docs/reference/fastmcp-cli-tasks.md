[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-cli-tasks#content-area)
...
On this page
  * [fastmcp.cli.tasks](https://gofastmcp.com/python-sdk/fastmcp-cli-tasks#fastmcp-cli-tasks)
  * [Functions](https://gofastmcp.com/python-sdk/fastmcp-cli-tasks#functions)
  * [check_distributed_backend ](https://gofastmcp.com/python-sdk/fastmcp-cli-tasks#check_distributed_backend)
  * [worker ](https://gofastmcp.com/python-sdk/fastmcp-cli-tasks#worker)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-tasks#fastmcp-cli-tasks)
`fastmcp.cli.tasks`
FastMCP tasks CLI for Docket task management.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-tasks#functions)
Functions
###
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-tasks#check_distributed_backend)
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-tasks#worker)
`worker`
Copy
```
...
[ run Previous ](https://gofastmcp.com/python-sdk/fastmcp-cli-run)[ __init__ Next ](https://gofastmcp.com/python-sdk/fastmcp-client-__init__)
Ctrl+I
