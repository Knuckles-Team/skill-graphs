[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-workos#content-area)
...
##### fastmcp.server
  ...
  * auth
    * [__init__](https://gofastmcp.com/python-sdk/fastmcp-server-auth-__init__)
    * [auth](https://gofastmcp.com/python-sdk/fastmcp-server-auth-auth)
    * [authorization](https://gofastmcp.com/python-sdk/fastmcp-server-auth-authorization)
    * [cimd](https://gofastmcp.com/python-sdk/fastmcp-server-auth-cimd)
    * [jwt_issuer](https://gofastmcp.com/python-sdk/fastmcp-server-auth-jwt_issuer)
    * [middleware](https://gofastmcp.com/python-sdk/fastmcp-server-auth-middleware)
    * oauth_proxy
    * [oidc_proxy](https://gofastmcp.com/python-sdk/fastmcp-server-auth-oidc_proxy)
    * providers
      * [__init__](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-__init__)
      * [auth0](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-auth0)
      * [aws](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-aws)
      * [azure](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-azure)
      * [debug](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-debug)
      * [descope](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-descope)
      * [discord](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-discord)
      * [github](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-github)
      * [google](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-google)
      * [in_memory](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-in_memory)
      * [introspection](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-introspection)
      * [jwt](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-jwt)
      * [oci](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-oci)
      * [propelauth](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-propelauth)
      * [scalekit](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-scalekit)
      * [supabase](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-supabase)
      * [workos](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-workos)
    * [redirect_validation](https://gofastmcp.com/python-sdk/fastmcp-server-auth-redirect_validation)
    * [ssrf](https://gofastmcp.com/python-sdk/fastmcp-server-auth-ssrf)
...
On this page
  * [fastmcp.server.auth.providers.workos](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-workos#fastmcp-server-auth-providers-workos)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-workos#classes)
  * [WorkOSTokenVerifier ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-workos#workostokenverifier)
  * [verify_token ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-workos#verify_token)
  * [WorkOSProvider ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-workos#workosprovider)
  * [AuthKitProvider ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-workos#authkitprovider)
  * [get_routes ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-workos#get_routes)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-workos#fastmcp-server-auth-providers-workos)
`fastmcp.server.auth.providers.workos`
WorkOS authentication providers for FastMCP. This module provides two WorkOS authentication strategies:
...
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-workos#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-workos#workostokenverifier)
`WorkOSTokenVerifier`
Token verifier for WorkOS OAuth tokens. WorkOS AuthKit tokens are opaque, so we verify them by calling the /oauth2/userinfo endpoint to check validity and get user info. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-workos#verify_token)
`verify_token`
Copy
```
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-workos#workosprovider)
`WorkOSProvider`
Complete WorkOS OAuth provider for FastMCP. This provider implements WorkOS AuthKit OAuth using the OAuth Proxy pattern. It provides OAuth2 authentication for users through WorkOS Connect applications. Features:
...
Setup Requirements:
  ...
  2. Note your AuthKit domain (e.g., “
  3. Configure redirect URI as:
  4. Note your Client ID and Client Secret


###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-workos#authkitprovider)
`AuthKitProvider`
...
For detailed setup instructions, see:  **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-workos#get_routes)
`get_routes`
Copy
```
...
Get OAuth routes including AuthKit authorization server metadata forwarding. This returns the standard protected resource routes plus an authorization server metadata endpoint that forwards AuthKit’s OAuth metadata to clients. **Args:**
  * `mcp_path`: The path where the MCP endpoint is mounted (e.g., “/mcp”) This is used to advertise the resource URL in metadata.


[ supabase Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-supabase)[ redirect_validation Next ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-redirect_validation)
Ctrl+I
