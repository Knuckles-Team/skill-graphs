[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-uv#content-area)
...
On this page
  * [fastmcp.utilities.mcp_server_config.v1.environments.uv](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-uv#fastmcp-utilities-mcp_server_config-v1-environments-uv)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-uv#classes)
  * [UVEnvironment ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-uv#uvenvironment)
  * [build_command ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-uv#build_command)
  * [prepare ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-uv#prepare)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-uv#fastmcp-utilities-mcp_server_config-v1-environments-uv)
`fastmcp.utilities.mcp_server_config.v1.environments.uv`
##
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-uv#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-uv#uvenvironment)
`UVEnvironment`
Configuration for Python environment setup. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-uv#build_command)
`build_command`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-uv#prepare)
`prepare`
Copy
```
...
[ base Previous ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-base)[ mcp_server_config Next ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config)
Ctrl+I
