[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-auth0#content-area)
...
On this page
  * [fastmcp.server.auth.providers.auth0](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-auth0#fastmcp-server-auth-providers-auth0)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-auth0#classes)
  * [Auth0Provider ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-auth0#auth0provider)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-auth0#fastmcp-server-auth-providers-auth0)
...
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-auth0#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-auth0#auth0provider)
`Auth0Provider`
...
[ __init__ Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-__init__)[ aws Next ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-aws)
Ctrl+I
