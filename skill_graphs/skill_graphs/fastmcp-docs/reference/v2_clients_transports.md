[Skip to main content](https://gofastmcp.com/v2/clients/transports#content-area)
...
On this page
  * [Choosing the Right Transport](https://gofastmcp.com/v2/clients/transports#choosing-the-right-transport)
  * [STDIO Transport](https://gofastmcp.com/v2/clients/transports#stdio-transport)
  * [The Client Runs the Server](https://gofastmcp.com/v2/clients/transports#the-client-runs-the-server)
  * [Environment Isolation](https://gofastmcp.com/v2/clients/transports#environment-isolation)
  * [Basic Usage](https://gofastmcp.com/v2/clients/transports#basic-usage)
  * [Environment Variables](https://gofastmcp.com/v2/clients/transports#environment-variables)
  * [Session Persistence](https://gofastmcp.com/v2/clients/transports#session-persistence)
  * [Specialized STDIO Transports](https://gofastmcp.com/v2/clients/transports#specialized-stdio-transports)
  * [Remote Transports](https://gofastmcp.com/v2/clients/transports#remote-transports)
  * [Streamable HTTP Transport](https://gofastmcp.com/v2/clients/transports#streamable-http-transport)
  * [SSE Transport (Legacy)](https://gofastmcp.com/v2/clients/transports#sse-transport-legacy)
  * [In-Memory Transport](https://gofastmcp.com/v2/clients/transports#in-memory-transport)
  * [MCP JSON Configuration Transport](https://gofastmcp.com/v2/clients/transports#mcp-json-configuration-transport)
  * [Tool Transformation with FastMCP and MCPConfig](https://gofastmcp.com/v2/clients/transports#tool-transformation-with-fastmcp-and-mcpconfig)
  * [Allowlisting and Blocklisting Tools](https://gofastmcp.com/v2/clients/transports#allowlisting-and-blocklisting-tools)
...
Copy page
`2.0.0` The FastMCP `Client` communicates with MCP servers through transport objects that handle the underlying connection mechanics. While the client can automatically select a transport based on what you pass to it, instantiating transports explicitly gives you full control over configuration—environment variables, authentication, session management, and more. Think of transports as configurable adapters between your client code and MCP servers. Each transport type handles a different communication pattern: subprocesses with pipes, HTTP connections, or direct in-memory calls.
##
[​](https://gofastmcp.com/v2/clients/transports#choosing-the-right-transport)
Choosing the Right Transport
  * **Use[STDIO Transport](https://gofastmcp.com/v2/clients/transports#stdio-transport)** when you need to run local MCP servers with full control over their environment and lifecycle
  * **Use[Remote Transports](https://gofastmcp.com/v2/clients/transports#remote-transports)** when connecting to production services or shared MCP servers running independently
  * **Use[In-Memory Transport](https://gofastmcp.com/v2/clients/transports#in-memory-transport)** for testing FastMCP servers without subprocess or network overhead
  * **Use[MCP JSON Configuration](https://gofastmcp.com/v2/clients/transports#mcp-json-configuration-transport)** when you need to connect to multiple servers defined in configuration files


##
[​](https://gofastmcp.com/v2/clients/transports#stdio-transport)
STDIO Transport
...
###
[​](https://gofastmcp.com/v2/clients/transports#the-client-runs-the-server)
...
###
[​](https://gofastmcp.com/v2/clients/transports#environment-isolation)
...
###
[​](https://gofastmcp.com/v2/clients/transports#basic-usage)
Basic Usage
...
###
[​](https://gofastmcp.com/v2/clients/transports#environment-variables)
...
###
[​](https://gofastmcp.com/v2/clients/transports#session-persistence)
Session Persistence
...
###
[​](https://gofastmcp.com/v2/clients/transports#specialized-stdio-transports)
...
##
[​](https://gofastmcp.com/v2/clients/transports#remote-transports)
Remote Transports
...
###
[​](https://gofastmcp.com/v2/clients/transports#streamable-http-transport)
Streamable HTTP Transport
`2.3.0` Streamable HTTP is the recommended transport for production deployments, providing efficient bidirectional streaming over HTTP connections.
...
###
[​](https://gofastmcp.com/v2/clients/transports#sse-transport-legacy)
...
##
[​](https://gofastmcp.com/v2/clients/transports#in-memory-transport)
In-Memory Transport
...
##
[​](https://gofastmcp.com/v2/clients/transports#mcp-json-configuration-transport)
MCP JSON Configuration Transport
`2.4.0` This transport supports the emerging MCP JSON configuration standard for defining multiple servers:
...
###
[​](https://gofastmcp.com/v2/clients/transports#tool-transformation-with-fastmcp-and-mcpconfig)
...
####
[​](https://gofastmcp.com/v2/clients/transports#allowlisting-and-blocklisting-tools)
...
[ The FastMCP Client Previous ](https://gofastmcp.com/v2/clients/client)[ Tool Operations Next ](https://gofastmcp.com/v2/clients/tools)
Ctrl+I
