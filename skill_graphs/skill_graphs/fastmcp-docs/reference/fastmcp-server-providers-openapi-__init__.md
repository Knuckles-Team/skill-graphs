[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-__init__#content-area)
...
On this page
  * [fastmcp.server.providers.openapi](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-__init__#fastmcp-server-providers-openapi)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-__init__#fastmcp-server-providers-openapi)
`fastmcp.server.providers.openapi`
OpenAPI provider for FastMCP. This module provides OpenAPI integration for FastMCP through the Provider pattern. Example:
Copy
```
...
[ local_provider Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-local_provider)[ components Next ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-components)
Ctrl+I
