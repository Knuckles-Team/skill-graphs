[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#content-area)
...
##### fastmcp.server
  ...
  * transforms
    * [__init__](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-__init__)
    * [catalog](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-catalog)
    * [namespace](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace)
    * [prompts_as_tools](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-prompts_as_tools)
    * [resources_as_tools](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-resources_as_tools)
    * search
    * [tool_transform](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-tool_transform)
    * [version_filter](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-version_filter)
    * [visibility](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-visibility)
...
On this page
  * [fastmcp.server.transforms.namespace](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#fastmcp-server-transforms-namespace)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#classes)
  * [Namespace ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#namespace)
  * [list_tools ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#list_tools)
  * [get_tool ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#get_tool)
  * [list_resources ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#list_resources)
  * [get_resource ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#get_resource)
  * [list_resource_templates ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#list_resource_templates)
  * [get_resource_template ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#get_resource_template)
  * [list_prompts ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#list_prompts)
  * [get_prompt ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#get_prompt)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#fastmcp-server-transforms-namespace)
`fastmcp.server.transforms.namespace`
Namespace transform for prefixing component names.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#namespace)
`Namespace`
...
**Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#list_tools)
`list_tools`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#get_tool)
`get_tool`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#list_resources)
`list_resources`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#get_resource)
`get_resource`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#list_resource_templates)
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#get_resource_template)
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#list_prompts)
`list_prompts`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace#get_prompt)
`get_prompt`
Copy
```
...
[ catalog Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-catalog)[ prompts_as_tools Next ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-prompts_as_tools)
Ctrl+I
