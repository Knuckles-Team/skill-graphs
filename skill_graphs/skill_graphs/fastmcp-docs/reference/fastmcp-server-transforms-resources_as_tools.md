[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-resources_as_tools#content-area)
...
On this page
  * [fastmcp.server.transforms.resources_as_tools](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-resources_as_tools#fastmcp-server-transforms-resources_as_tools)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-resources_as_tools#classes)
  * [ResourcesAsTools ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-resources_as_tools#resourcesastools)
  * [list_tools ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-resources_as_tools#list_tools)
  * [get_tool ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-resources_as_tools#get_tool)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-resources_as_tools#fastmcp-server-transforms-resources_as_tools)
...
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-resources_as_tools#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-resources_as_tools#resourcesastools)
`ResourcesAsTools`
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-resources_as_tools#list_tools)
`list_tools`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-resources_as_tools#get_tool)
`get_tool`
Copy
```
...
[ prompts_as_tools Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-prompts_as_tools)[ __init__ Next ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-search-__init__)
Ctrl+I
