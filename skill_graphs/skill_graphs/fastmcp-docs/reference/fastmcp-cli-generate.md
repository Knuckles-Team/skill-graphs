[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-cli-generate#content-area)
...
On this page
  * [fastmcp.cli.generate](https://gofastmcp.com/python-sdk/fastmcp-cli-generate#fastmcp-cli-generate)
  * [Functions](https://gofastmcp.com/python-sdk/fastmcp-cli-generate#functions)
  * [serialize_transport ](https://gofastmcp.com/python-sdk/fastmcp-cli-generate#serialize_transport)
  * [generate_cli_script ](https://gofastmcp.com/python-sdk/fastmcp-cli-generate#generate_cli_script)
  * [generate_skill_content ](https://gofastmcp.com/python-sdk/fastmcp-cli-generate#generate_skill_content)
  * [generate_cli_command ](https://gofastmcp.com/python-sdk/fastmcp-cli-generate#generate_cli_command)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-generate#fastmcp-cli-generate)
`fastmcp.cli.generate`
Generate a standalone CLI script and agent skill from an MCP server.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-generate#functions)
Functions
###
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-generate#serialize_transport)
`serialize_transport`
Copy
```
...
Serialize a resolved transport to a Python expression string. Returns `(expression, extra_imports)` where _extra_imports_ is a set of import lines needed by the expression.
###
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-generate#generate_cli_script)
`generate_cli_script`
Copy
```
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-generate#generate_skill_content)
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-generate#generate_cli_command)
...
Generate a standalone CLI script from an MCP server. Connects to the server, reads its tools/resources/prompts, and writes a Python script that can invoke them directly. Also generates a SKILL.md agent skill file unless —no-skill is passed. **Examples:** fastmcp generate-cli weather fastmcp generate-cli weather my_cli.py fastmcp generate-cli
[ discovery Previous ](https://gofastmcp.com/python-sdk/fastmcp-cli-discovery)[ __init__ Next ](https://gofastmcp.com/python-sdk/fastmcp-cli-install-__init__)
Ctrl+I
