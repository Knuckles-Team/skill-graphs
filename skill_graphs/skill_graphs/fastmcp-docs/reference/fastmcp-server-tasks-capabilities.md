[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-capabilities#content-area)
...
On this page
  * [fastmcp.server.tasks.capabilities](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-capabilities#fastmcp-server-tasks-capabilities)
  * [Functions](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-capabilities#functions)
  * [get_task_capabilities ](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-capabilities#get_task_capabilities)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-capabilities#fastmcp-server-tasks-capabilities)
`fastmcp.server.tasks.capabilities`
SEP-1686 task capabilities declaration.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-capabilities#functions)
Functions
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-capabilities#get_task_capabilities)
...
Return the SEP-1686 task capabilities. Returns task capabilities as a first-class ServerCapabilities field, declaring support for list, cancel, and request operations per SEP-1686. Returns None if pydocket is not installed (no task support). Note: prompts/resources are passed via extra_data since the SDK types don’t include them yet (FastMCP supports them ahead of the spec).
[ __init__ Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-__init__)[ config Next ](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-config)
Ctrl+I
