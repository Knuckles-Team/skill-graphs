[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-base#content-area)
...
##### fastmcp.utilities
  ...
  * mcp_server_config
    ...
    * v1
      ...
      * environments
        * [__init__](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-__init__)
        * [base](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-base)
        * [uv](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-uv)
...
On this page
  * [fastmcp.utilities.mcp_server_config.v1.environments.base](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-base#fastmcp-utilities-mcp_server_config-v1-environments-base)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-base#classes)
  * [Environment ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-base#environment)
  * [build_command ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-base#build_command)
  * [prepare ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-base#prepare)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-base#fastmcp-utilities-mcp_server_config-v1-environments-base)
`fastmcp.utilities.mcp_server_config.v1.environments.base`
##
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-base#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-base#environment)
`Environment`
Base class for environment configuration. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-base#build_command)
`build_command`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-base#prepare)
`prepare`
Copy
```
...
[ __init__ Previous ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-__init__)[ uv Next ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-uv)
Ctrl+I
