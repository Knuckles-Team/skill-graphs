...
On this page
  ...
  * [From FastMCP 2.0](https://gofastmcp.com/getting-started/installation#from-fastmcp-2-0)
  * [From the MCP SDK](https://gofastmcp.com/getting-started/installation#from-the-mcp-sdk)
  * [From FastMCP 1.0](https://gofastmcp.com/getting-started/installation#from-fastmcp-1-0)
...
Upgrading
###
[​](https://gofastmcp.com/getting-started/installation#from-fastmcp-2-0)
From FastMCP 2.0
...
###
[​](https://gofastmcp.com/getting-started/installation#from-the-mcp-sdk)
From the MCP SDK
####
[​](https://gofastmcp.com/getting-started/installation#from-fastmcp-1-0)
From FastMCP 1.0
If you’re using FastMCP 1.0 via the `mcp` package (meaning you import FastMCP as `from mcp.server.fastmcp import FastMCP`), upgrading is straightforward — for most servers, it’s a single import change. See the [full upgrade guide](https://gofastmcp.com/getting-started/upgrading/from-mcp-sdk) for details.
####
