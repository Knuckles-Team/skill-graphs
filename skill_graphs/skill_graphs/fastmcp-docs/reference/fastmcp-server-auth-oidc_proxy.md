[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-auth-oidc_proxy#content-area)
...
On this page
  * [fastmcp.server.auth.oidc_proxy](https://gofastmcp.com/python-sdk/fastmcp-server-auth-oidc_proxy#fastmcp-server-auth-oidc_proxy)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-auth-oidc_proxy#classes)
  * [OIDCConfiguration ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-oidc_proxy#oidcconfiguration)
  * [get_oidc_configuration ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-oidc_proxy#get_oidc_configuration)
  * [OIDCProxy ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-oidc_proxy#oidcproxy)
  * [get_oidc_configuration ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-oidc_proxy#get_oidc_configuration-2)
  * [get_token_verifier ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-oidc_proxy#get_token_verifier)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-oidc_proxy#fastmcp-server-auth-oidc_proxy)
`fastmcp.server.auth.oidc_proxy`
OIDC Proxy Provider for FastMCP. This provider acts as a transparent proxy to an upstream OIDC compliant Authorization Server. It leverages the OAuthProxy class to handle Dynamic Client Registration and forwarding of all OAuth flows. This implementation is based on: OpenID Connect Discovery 1.0 -
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-oidc_proxy#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-oidc_proxy#oidcconfiguration)
`OIDCConfiguration`
OIDC Configuration. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-oidc_proxy#get_oidc_configuration)
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-oidc_proxy#oidcproxy)
`OIDCProxy`
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-oidc_proxy#get_oidc_configuration-2)
`get_oidc_configuration`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-oidc_proxy#get_token_verifier)
`get_token_verifier`
Copy
```
...
[ ui Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-oauth_proxy-ui)[ __init__ Next ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-__init__)
Ctrl+I
