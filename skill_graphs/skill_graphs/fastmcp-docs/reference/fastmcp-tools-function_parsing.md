[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-tools-function_parsing#content-area)
...
On this page
  * [fastmcp.tools.function_parsing](https://gofastmcp.com/python-sdk/fastmcp-tools-function_parsing#fastmcp-tools-function_parsing)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-tools-function_parsing#classes)
  * [ParsedFunction ](https://gofastmcp.com/python-sdk/fastmcp-tools-function_parsing#parsedfunction)
  * [from_function ](https://gofastmcp.com/python-sdk/fastmcp-tools-function_parsing#from_function)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-function_parsing#fastmcp-tools-function_parsing)
`fastmcp.tools.function_parsing`
Function introspection and schema generation for FastMCP tools.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-function_parsing#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-function_parsing#parsedfunction)
`ParsedFunction`
**Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-function_parsing#from_function)
`from_function`
Copy
```
...
[ __init__ Previous ](https://gofastmcp.com/python-sdk/fastmcp-tools-__init__)[ function_tool Next ](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool)
Ctrl+I
