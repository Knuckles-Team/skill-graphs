[Skip to main content](https://gofastmcp.com/v2/integrations/claude-desktop#content-area)
...
On this page
  * [Requirements](https://gofastmcp.com/v2/integrations/claude-desktop#requirements)
  * [Create a Server](https://gofastmcp.com/v2/integrations/claude-desktop#create-a-server)
  * [Install the Server](https://gofastmcp.com/v2/integrations/claude-desktop#install-the-server)
  * [FastMCP CLI](https://gofastmcp.com/v2/integrations/claude-desktop#fastmcp-cli)
  * [Dependencies](https://gofastmcp.com/v2/integrations/claude-desktop#dependencies)
  * [Python Version and Project Directory](https://gofastmcp.com/v2/integrations/claude-desktop#python-version-and-project-directory)
  * [Environment Variables](https://gofastmcp.com/v2/integrations/claude-desktop#environment-variables)
  * [Manual Configuration](https://gofastmcp.com/v2/integrations/claude-desktop#manual-configuration)
  * [Dependencies](https://gofastmcp.com/v2/integrations/claude-desktop#dependencies-2)
  * [Environment Variables](https://gofastmcp.com/v2/integrations/claude-desktop#environment-variables-2)
  * [Remote Servers](https://gofastmcp.com/v2/integrations/claude-desktop#remote-servers)
  * [Authentication](https://gofastmcp.com/v2/integrations/claude-desktop#authentication)
...
##
[​](https://gofastmcp.com/v2/integrations/claude-desktop#requirements)
Requirements
...
If you don’t have access to remote server support or need to connect to remote servers, you can create a **proxy server** that runs locally via STDIO and forwards requests to remote HTTP servers. See the [Proxy Servers](https://gofastmcp.com/v2/integrations/claude-desktop#proxy-servers) section below.
##
[​](https://gofastmcp.com/v2/integrations/claude-desktop#create-a-server)
Create a Server
...
##
[​](https://gofastmcp.com/v2/integrations/claude-desktop#install-the-server)
Install the Server
###
[​](https://gofastmcp.com/v2/integrations/claude-desktop#fastmcp-cli)
FastMCP CLI
...
####
[​](https://gofastmcp.com/v2/integrations/claude-desktop#dependencies)
Dependencies
...
####
[​](https://gofastmcp.com/v2/integrations/claude-desktop#python-version-and-project-directory)
...
####
[​](https://gofastmcp.com/v2/integrations/claude-desktop#environment-variables)
...
###
[​](https://gofastmcp.com/v2/integrations/claude-desktop#manual-configuration)
...
####
[​](https://gofastmcp.com/v2/integrations/claude-desktop#dependencies-2)
Dependencies
...
####
[​](https://gofastmcp.com/v2/integrations/claude-desktop#environment-variables-2)
Environment Variables
...
Claude Desktop runs servers in a completely isolated environment with no access to your shell environment or locally installed applications. You must explicitly pass any environment variables your server needs.
##
[​](https://gofastmcp.com/v2/integrations/claude-desktop#remote-servers)
Remote Servers
...
###
[​](https://gofastmcp.com/v2/integrations/claude-desktop#authentication)
Authentication
For authenticated remote servers, create an authenticated client following the guidance in the [client auth documentation](https://gofastmcp.com/v2/clients/auth/bearer) and pass it to the proxy:
...
[ Claude Code 🤝 FastMCP Previous ](https://gofastmcp.com/v2/integrations/claude-code)[ Cursor 🤝 FastMCP Next ](https://gofastmcp.com/v2/integrations/cursor)
Ctrl+I
