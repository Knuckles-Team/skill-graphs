[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-providers-wrapped_provider#content-area)
...
On this page
  * [fastmcp.server.providers.wrapped_provider](https://gofastmcp.com/python-sdk/fastmcp-server-providers-wrapped_provider#fastmcp-server-providers-wrapped_provider)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-wrapped_provider#fastmcp-server-providers-wrapped_provider)
`fastmcp.server.providers.wrapped_provider`
WrappedProvider for immutable transform composition. This module provides `_WrappedProvider`, an internal class that wraps a provider with an additional transform. Created by `Provider.wrap_transform()`.
[ vendor_providers Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-vendor_providers)[ proxy Next ](https://gofastmcp.com/python-sdk/fastmcp-server-proxy)
Ctrl+I
