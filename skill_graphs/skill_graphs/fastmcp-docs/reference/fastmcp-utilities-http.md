[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-utilities-http#content-area)
...
On this page
  ...
  * [find_available_port ](https://gofastmcp.com/python-sdk/fastmcp-utilities-http#find_available_port)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-http#fastmcp-utilities-http)
`fastmcp.utilities.http`
##
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-http#functions)
Functions
###
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-http#find_available_port)
`find_available_port`
Copy
```
...
[ exceptions Previous ](https://gofastmcp.com/python-sdk/fastmcp-utilities-exceptions)[ inspect Next ](https://gofastmcp.com/python-sdk/fastmcp-utilities-inspect)
Ctrl+I
