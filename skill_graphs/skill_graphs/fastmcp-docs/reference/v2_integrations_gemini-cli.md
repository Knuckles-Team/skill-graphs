[Skip to main content](https://gofastmcp.com/v2/integrations/gemini-cli#content-area)
...
On this page
  * [Requirements](https://gofastmcp.com/v2/integrations/gemini-cli#requirements)
  * [Create a Server](https://gofastmcp.com/v2/integrations/gemini-cli#create-a-server)
  * [Install the Server](https://gofastmcp.com/v2/integrations/gemini-cli#install-the-server)
  * [FastMCP CLI](https://gofastmcp.com/v2/integrations/gemini-cli#fastmcp-cli)
  * [Dependencies](https://gofastmcp.com/v2/integrations/gemini-cli#dependencies)
  * [Python Version and Project Configuration](https://gofastmcp.com/v2/integrations/gemini-cli#python-version-and-project-configuration)
  * [Environment Variables](https://gofastmcp.com/v2/integrations/gemini-cli#environment-variables)
  * [Manual Configuration](https://gofastmcp.com/v2/integrations/gemini-cli#manual-configuration)
  * [Using the Server](https://gofastmcp.com/v2/integrations/gemini-cli#using-the-server)
...
##
[​](https://gofastmcp.com/v2/integrations/gemini-cli#requirements)
Requirements
...
##
[​](https://gofastmcp.com/v2/integrations/gemini-cli#create-a-server)
Create a Server
...
##
[​](https://gofastmcp.com/v2/integrations/gemini-cli#install-the-server)
Install the Server
###
[​](https://gofastmcp.com/v2/integrations/gemini-cli#fastmcp-cli)
FastMCP CLI
...
####
[​](https://gofastmcp.com/v2/integrations/gemini-cli#dependencies)
Dependencies
...
####
[​](https://gofastmcp.com/v2/integrations/gemini-cli#python-version-and-project-configuration)
...
####
[​](https://gofastmcp.com/v2/integrations/gemini-cli#environment-variables)
...
###
[​](https://gofastmcp.com/v2/integrations/gemini-cli#manual-configuration)
...
##
[​](https://gofastmcp.com/v2/integrations/gemini-cli#using-the-server)
Using the Server
...
[ Cursor 🤝 FastMCP Previous ](https://gofastmcp.com/v2/integrations/cursor)[ MCP JSON Configuration 🤝 FastMCP Next ](https://gofastmcp.com/v2/integrations/mcp-json-configuration)
Ctrl+I
