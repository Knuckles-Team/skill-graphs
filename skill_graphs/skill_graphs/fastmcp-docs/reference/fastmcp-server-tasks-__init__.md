[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-__init__#content-area)
...
On this page
  * [fastmcp.server.tasks](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-__init__#fastmcp-server-tasks)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-__init__#fastmcp-server-tasks)
`fastmcp.server.tasks`
MCP SEP-1686 background tasks support. This module implements protocol-level background task execution for MCP servers.
[ server Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-server)[ capabilities Next ](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-capabilities)
Ctrl+I
