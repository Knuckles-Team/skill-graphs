[Skip to main content](https://gofastmcp.com/v2/servers/tools#content-area)
...
##### Servers
  ...
  * Core Components
    * [Tools](https://gofastmcp.com/v2/servers/tools)
    * [Resources](https://gofastmcp.com/v2/servers/resources)
    * [Prompts](https://gofastmcp.com/v2/servers/prompts)
  * Advanced Features
  * Authentication
  * Deployment
...
On this page
  * [The @tool Decorator](https://gofastmcp.com/v2/servers/tools#the-%40tool-decorator)
  * [Decorator Arguments](https://gofastmcp.com/v2/servers/tools#decorator-arguments)
  * [Async Support](https://gofastmcp.com/v2/servers/tools#async-support)
  * [Arguments](https://gofastmcp.com/v2/servers/tools#arguments)
  * [Type Annotations](https://gofastmcp.com/v2/servers/tools#type-annotations)
  * [Optional Arguments](https://gofastmcp.com/v2/servers/tools#optional-arguments)
  * [Validation Modes](https://gofastmcp.com/v2/servers/tools#validation-modes)
  * [Parameter Metadata](https://gofastmcp.com/v2/servers/tools#parameter-metadata)
  * [Simple String Descriptions](https://gofastmcp.com/v2/servers/tools#simple-string-descriptions)
  * [Advanced Metadata with Field](https://gofastmcp.com/v2/servers/tools#advanced-metadata-with-field)
  * [Hiding Parameters from the LLM](https://gofastmcp.com/v2/servers/tools#hiding-parameters-from-the-llm)
  * [Return Values](https://gofastmcp.com/v2/servers/tools#return-values)
  * [Content Blocks](https://gofastmcp.com/v2/servers/tools#content-blocks)
  * [Media Helper Classes](https://gofastmcp.com/v2/servers/tools#media-helper-classes)
  * [Structured Output](https://gofastmcp.com/v2/servers/tools#structured-output)
  * [Dictionaries and Objects](https://gofastmcp.com/v2/servers/tools#dictionaries-and-objects)
  * [Primitives and Collections](https://gofastmcp.com/v2/servers/tools#primitives-and-collections)
  * [Typed Models](https://gofastmcp.com/v2/servers/tools#typed-models)
  * [Output Schemas](https://gofastmcp.com/v2/servers/tools#output-schemas)
  * [Primitive Type Wrapping](https://gofastmcp.com/v2/servers/tools#primitive-type-wrapping)
  * [Manual Schema Control](https://gofastmcp.com/v2/servers/tools#manual-schema-control)
  * [ToolResult and Metadata](https://gofastmcp.com/v2/servers/tools#toolresult-and-metadata)
  * [Error Handling](https://gofastmcp.com/v2/servers/tools#error-handling)
  * [Disabling Tools](https://gofastmcp.com/v2/servers/tools#disabling-tools)
  * [MCP Annotations](https://gofastmcp.com/v2/servers/tools#mcp-annotations)
  * [Using Annotation Hints](https://gofastmcp.com/v2/servers/tools#using-annotation-hints)
  * [Notifications](https://gofastmcp.com/v2/servers/tools#notifications)
  * [Accessing the MCP Context](https://gofastmcp.com/v2/servers/tools#accessing-the-mcp-context)
  * [Server Behavior](https://gofastmcp.com/v2/servers/tools#server-behavior)
  * [Duplicate Tools](https://gofastmcp.com/v2/servers/tools#duplicate-tools)
  * [Removing Tools](https://gofastmcp.com/v2/servers/tools#removing-tools)
...
##
[​](https://gofastmcp.com/v2/servers/tools#the-@tool-decorator)
The `@tool` Decorator
...
###
[​](https://gofastmcp.com/v2/servers/tools#decorator-arguments)
Decorator Arguments
...
[​](https://gofastmcp.com/v2/servers/tools#param-enabled)
enabled
bool
default:"True"
A boolean to enable or disable the tool. See [Disabling Tools](https://gofastmcp.com/v2/servers/tools#disabling-tools) for more information
[​](https://gofastmcp.com/v2/servers/tools#param-icons)
icons
list[Icon] | None
`2.13.0`Optional list of icon representations for this tool. See [Icons](https://gofastmcp.com/v2/servers/icons) for detailed examples
[​](https://gofastmcp.com/v2/servers/tools#param-annotations)
annotations
...
[​](https://gofastmcp.com/v2/servers/tools#param-title)
title
str | None
A human-readable title for the tool.
[​](https://gofastmcp.com/v2/servers/tools#param-read-only-hint)
readOnlyHint
bool | None
If true, the tool does not modify its environment.
[​](https://gofastmcp.com/v2/servers/tools#param-destructive-hint)
destructiveHint
bool | None
If true, the tool may perform destructive updates to its environment.
[​](https://gofastmcp.com/v2/servers/tools#param-idempotent-hint)
idempotentHint
bool | None
If true, calling the tool repeatedly with the same arguments will have no additional effect on the its environment.
[​](https://gofastmcp.com/v2/servers/tools#param-open-world-hint)
openWorldHint
bool | None
...
[​](https://gofastmcp.com/v2/servers/tools#param-meta)
meta
dict[str, Any] | None
`2.11.0`Optional meta information about the tool. This data is passed through to the MCP client as the `_meta` field of the client-side tool object and can be used for custom metadata, versioning, or other application-specific purposes.
###
[​](https://gofastmcp.com/v2/servers/tools#async-support)
Async Support
...
##
[​](https://gofastmcp.com/v2/servers/tools#arguments)
Arguments
...
###
[​](https://gofastmcp.com/v2/servers/tools#type-annotations)
Type Annotations
...
###
[​](https://gofastmcp.com/v2/servers/tools#optional-arguments)
Optional Arguments
...
###
[​](https://gofastmcp.com/v2/servers/tools#validation-modes)
Validation Modes
...
###
[​](https://gofastmcp.com/v2/servers/tools#parameter-metadata)
Parameter Metadata
You can provide additional metadata about parameters in several ways:
####
[​](https://gofastmcp.com/v2/servers/tools#simple-string-descriptions)
...
####
[​](https://gofastmcp.com/v2/servers/tools#advanced-metadata-with-field)
...
###
[​](https://gofastmcp.com/v2/servers/tools#hiding-parameters-from-the-llm)
...
See [Custom Dependencies](https://gofastmcp.com/v2/servers/context#custom-dependencies) for more details on dependency injection.
##
[​](https://gofastmcp.com/v2/servers/tools#return-values)
Return Values
...
###
[​](https://gofastmcp.com/v2/servers/tools#content-blocks)
Content Blocks
...
####
[​](https://gofastmcp.com/v2/servers/tools#media-helper-classes)
...
###
[​](https://gofastmcp.com/v2/servers/tools#structured-output)
Structured Output
...
####
[​](https://gofastmcp.com/v2/servers/tools#dictionaries-and-objects)
...
####
[​](https://gofastmcp.com/v2/servers/tools#primitives-and-collections)
...
####
[​](https://gofastmcp.com/v2/servers/tools#typed-models)
Typed Models
...
###
[​](https://gofastmcp.com/v2/servers/tools#output-schemas)
Output Schemas
...
####
[​](https://gofastmcp.com/v2/servers/tools#primitive-type-wrapping)
...
####
[​](https://gofastmcp.com/v2/servers/tools#manual-schema-control)
...
###
[​](https://gofastmcp.com/v2/servers/tools#toolresult-and-metadata)
...
##
[​](https://gofastmcp.com/v2/servers/tools#error-handling)
Error Handling
...
##
[​](https://gofastmcp.com/v2/servers/tools#disabling-tools)
Disabling Tools
...
##
[​](https://gofastmcp.com/v2/servers/tools#mcp-annotations)
MCP Annotations
...
###
[​](https://gofastmcp.com/v2/servers/tools#using-annotation-hints)
...
For tools that write to databases, send notifications, create/update/delete resources, or trigger workflows, omit `readOnlyHint` or set it to `False`. Use `destructiveHint=True` for operations that cannot be undone. Client-specific behavior:
  * **ChatGPT** : Skips confirmation prompts for read-only tools in Chat mode (see [ChatGPT integration](https://gofastmcp.com/v2/integrations/chatgpt))
  * **Claude** : Uses hints to understand tool safety profiles and make better execution decisions


##
[​](https://gofastmcp.com/v2/servers/tools#notifications)
Notifications
...
Notifications are only sent when these operations occur within an active MCP request context (e.g., when called from within a tool or other MCP operation). Operations performed during server initialization do not trigger notifications. Clients can handle these notifications using a [message handler](https://gofastmcp.com/v2/clients/messages) to automatically refresh their tool lists or update their interfaces.
##
[​](https://gofastmcp.com/v2/servers/tools#accessing-the-mcp-context)
...
For full documentation on the Context object and all its capabilities, see the [Context documentation](https://gofastmcp.com/v2/servers/context).
##
[​](https://gofastmcp.com/v2/servers/tools#server-behavior)
Server Behavior
###
[​](https://gofastmcp.com/v2/servers/tools#duplicate-tools)
Duplicate Tools
...
###
[​](https://gofastmcp.com/v2/servers/tools#removing-tools)
Removing Tools
`2.3.4` You can dynamically remove tools from a server using the `remove_tool` method:
Copy
```
from fastmcp import FastMCP
...
[ The FastMCP Server Previous ](https://gofastmcp.com/v2/servers/server)[ Resources & Templates Next ](https://gofastmcp.com/v2/servers/resources)
Ctrl+I
