[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-utilities-openapi-director#content-area)
...
On this page
  * [fastmcp.utilities.openapi.director](https://gofastmcp.com/python-sdk/fastmcp-utilities-openapi-director#fastmcp-utilities-openapi-director)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-utilities-openapi-director#classes)
  * [RequestDirector ](https://gofastmcp.com/python-sdk/fastmcp-utilities-openapi-director#requestdirector)
  * [build ](https://gofastmcp.com/python-sdk/fastmcp-utilities-openapi-director#build)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-openapi-director#fastmcp-utilities-openapi-director)
`fastmcp.utilities.openapi.director`
Request director using openapi-core for stateless HTTP request building.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-openapi-director#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-openapi-director#requestdirector)
`RequestDirector`
Builds httpx.Request objects from HTTPRoute and arguments using openapi-core. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-openapi-director#build)
`build`
Copy
```
...
Constructs a final httpx.Request object, handling all OpenAPI serialization. **Args:**
...
[ __init__ Previous ](https://gofastmcp.com/python-sdk/fastmcp-utilities-openapi-__init__)[ formatters Next ](https://gofastmcp.com/python-sdk/fastmcp-utilities-openapi-formatters)
Ctrl+I
