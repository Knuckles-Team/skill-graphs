[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#content-area)
...
##### fastmcp.utilities
  ...
  * mcp_server_config
    * [__init__](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-__init__)
    * v1
      * [__init__](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-__init__)
      * environments
      * [mcp_server_config](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config)
      * sources
  * openapi
...
On this page
  * [fastmcp.utilities.mcp_server_config.v1.mcp_server_config](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#fastmcp-utilities-mcp_server_config-v1-mcp_server_config)
  * [Functions](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#functions)
  * [generate_schema ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#generate_schema)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#classes)
  * [Deployment ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#deployment)
  * [apply_runtime_settings ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#apply_runtime_settings)
  * [MCPServerConfig ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#mcpserverconfig)
  * [validate_source ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#validate_source)
  * [validate_environment ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#validate_environment)
  * [validate_deployment ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#validate_deployment)
  * [from_file ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#from_file)
  * [from_cli_args ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#from_cli_args)
  * [find_config ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#find_config)
  * [prepare ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#prepare)
  * [prepare_environment ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#prepare_environment)
  * [prepare_source ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#prepare_source)
  * [run_server ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#run_server)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#fastmcp-utilities-mcp_server_config-v1-mcp_server_config)
`fastmcp.utilities.mcp_server_config.v1.mcp_server_config`
FastMCP Configuration File Support. This module provides support for fastmcp.json configuration files that allow users to specify server settings in a declarative format instead of using command-line arguments.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#functions)
Functions
###
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#generate_schema)
`generate_schema`
Copy
```
...
Generate JSON schema for fastmcp.json files. This is used to create the schema file that IDEs can use for validation and auto-completion. **Args:**
...
##
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#deployment)
`Deployment`
Configuration for server deployment and runtime settings. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#apply_runtime_settings)
...
`MCPServerConfig`
Configuration for a FastMCP server. This configuration file allows you to specify all settings needed to run a FastMCP server in a declarative format. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#validate_source)
`validate_source`
Copy
```
...
Validate and convert source to proper format. Supports:
  * Dict format: `{"path": "server.py", "entrypoint": "app"}`
  * FileSystemSource instance (passed through)

No string parsing happens here - that’s only at CLI boundaries. MCPServerConfig works only with properly typed objects.
####
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#validate_environment)
...
Ensure environment has a type field for discrimination. For backward compatibility, if no type is specified, default to “uv”.
####
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#validate_deployment)
`validate_deployment`
Copy
```
...
Validate and convert deployment to Deployment. Accepts:
  * Deployment instance
  * dict that can be converted to Deployment


####
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#from_file)
`from_file`
Copy
```
...
Load configuration from a JSON file. **Args:**
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#from_cli_args)
`from_cli_args`
Copy
```
...
Create a config from CLI arguments. This allows us to have a single code path where everything goes through a config object. **Args:**
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#find_config)
`find_config`
Copy
```
...
Find a fastmcp.json file in the specified directory. **Args:**
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#prepare)
`prepare`
Copy
```
...
Prepare environment and source for execution. When output_dir is provided, creates a persistent uv project. When output_dir is None, does ephemeral caching (for backwards compatibility). **Args:**
  * `skip_source`: Skip source preparation if True
  * `output_dir`: Directory to create the persistent uv project in (optional)


####
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#prepare_environment)
`prepare_environment`
Copy
```
...
Prepare the Python environment. **Args:**
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#prepare_source)
`prepare_source`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config#run_server)
`run_server`
Copy
```
...
Load and run the server with this configuration. **Args:**
  * `**kwargs`: Additional arguments to pass to server.run_async() These override config settings


[ uv Previous ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-uv)[ __init__ Next ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-sources-__init__)
Ctrl+I
