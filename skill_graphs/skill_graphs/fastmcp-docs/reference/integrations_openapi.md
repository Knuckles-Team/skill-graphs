...
Under the hood, OpenAPI integration uses OpenAPIProvider (v3.0.0+) to source tools from the specification. See [Providers](https://gofastmcp.com/servers/providers/overview) to understand how FastMCP sources components.
...
[ FastAPI 🤝 FastMCP Previous ](https://gofastmcp.com/integrations/fastapi)[ ChatGPT 🤝 FastMCP Next ](https://gofastmcp.com/integrations/chatgpt)
Ctrl+I
