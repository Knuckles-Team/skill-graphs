[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-sources-__init__#content-area)
...
On this page
  * [fastmcp.utilities.mcp_server_config.v1.sources](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-sources-__init__#fastmcp-utilities-mcp-server-config-v1-sources)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-sources-__init__#fastmcp-utilities-mcp-server-config-v1-sources)
`fastmcp.utilities.mcp_server_config.v1.sources`
_This module is empty or contains only private/internal implementations._
[ mcp_server_config Previous ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-mcp_server_config)[ base Next ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-sources-base)
Ctrl+I
