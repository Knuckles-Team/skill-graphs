[Skip to main content](https://gofastmcp.com/v2/integrations/chatgpt#content-area)
...
On this page
  * [Build a Server](https://gofastmcp.com/v2/integrations/chatgpt#build-a-server)
  * [Deploy Your Server](https://gofastmcp.com/v2/integrations/chatgpt#deploy-your-server)
  * [Chat Mode](https://gofastmcp.com/v2/integrations/chatgpt#chat-mode)
  * [Add to ChatGPT](https://gofastmcp.com/v2/integrations/chatgpt#add-to-chatgpt)
  * [1. Enable Developer Mode](https://gofastmcp.com/v2/integrations/chatgpt#1-enable-developer-mode)
  * [2. Create Connector](https://gofastmcp.com/v2/integrations/chatgpt#2-create-connector)
  * [3. Use in Chat](https://gofastmcp.com/v2/integrations/chatgpt#3-use-in-chat)
  * [Skip Confirmations](https://gofastmcp.com/v2/integrations/chatgpt#skip-confirmations)
  * [Deep Research Mode](https://gofastmcp.com/v2/integrations/chatgpt#deep-research-mode)
  * [Tool Implementation](https://gofastmcp.com/v2/integrations/chatgpt#tool-implementation)
  * [Using Deep Research](https://gofastmcp.com/v2/integrations/chatgpt#using-deep-research)
...
##
[​](https://gofastmcp.com/v2/integrations/chatgpt#build-a-server)
Build a Server
...
###
[​](https://gofastmcp.com/v2/integrations/chatgpt#deploy-your-server)
Deploy Your Server
...
##
[​](https://gofastmcp.com/v2/integrations/chatgpt#chat-mode)
Chat Mode
Chat mode lets you use MCP tools directly in ChatGPT conversations. See
###
[​](https://gofastmcp.com/v2/integrations/chatgpt#add-to-chatgpt)
Add to ChatGPT
####
[​](https://gofastmcp.com/v2/integrations/chatgpt#1-enable-developer-mode)
...
####
[​](https://gofastmcp.com/v2/integrations/chatgpt#2-create-connector)
2. Create Connector
...
####
[​](https://gofastmcp.com/v2/integrations/chatgpt#3-use-in-chat)
3. Use in Chat
  1. Start a new chat
...
###
[​](https://gofastmcp.com/v2/integrations/chatgpt#skip-confirmations)
Skip Confirmations
...
##
[​](https://gofastmcp.com/v2/integrations/chatgpt#deep-research-mode)
Deep Research Mode
...
###
[​](https://gofastmcp.com/v2/integrations/chatgpt#tool-implementation)
Tool Implementation
...
###
[​](https://gofastmcp.com/v2/integrations/chatgpt#using-deep-research)
Using Deep Research
...
[ Permit.io Authorization 🤝 FastMCP Previous ](https://gofastmcp.com/v2/integrations/permit)[ Claude Code 🤝 FastMCP Next ](https://gofastmcp.com/v2/integrations/claude-code)
Ctrl+I
