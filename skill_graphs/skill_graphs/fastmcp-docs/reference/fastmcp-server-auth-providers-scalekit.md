[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-scalekit#content-area)
...
On this page
  * [fastmcp.server.auth.providers.scalekit](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-scalekit#fastmcp-server-auth-providers-scalekit)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-scalekit#classes)
  * [ScalekitProvider ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-scalekit#scalekitprovider)
  * [get_routes ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-scalekit#get_routes)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-scalekit#fastmcp-server-auth-providers-scalekit)
...
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-scalekit#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-scalekit#scalekitprovider)
`ScalekitProvider`
Scalekit resource server provider for OAuth 2.1 authentication. This provider implements Scalekit integration using resource server pattern. FastMCP acts as a protected resource server that validates access tokens issued by Scalekit’s authorization server. IMPORTANT SETUP REQUIREMENTS:
  ...
  2. Environment Configuration:
     * Set SCALEKIT_ENVIRONMENT_URL (e.g.,
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-scalekit#get_routes)
`get_routes`
Copy
```
...
[ propelauth Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-propelauth)[ supabase Next ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-supabase)
Ctrl+I
