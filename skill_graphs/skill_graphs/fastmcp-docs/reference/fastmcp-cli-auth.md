[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-cli-auth#content-area)
...
On this page
  * [fastmcp.cli.auth](https://gofastmcp.com/python-sdk/fastmcp-cli-auth#fastmcp-cli-auth)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-auth#fastmcp-cli-auth)
`fastmcp.cli.auth`
Authentication-related CLI commands.
[ __init__ Previous ](https://gofastmcp.com/python-sdk/fastmcp-cli-__init__)[ cimd Next ](https://gofastmcp.com/python-sdk/fastmcp-cli-cimd)
Ctrl+I
