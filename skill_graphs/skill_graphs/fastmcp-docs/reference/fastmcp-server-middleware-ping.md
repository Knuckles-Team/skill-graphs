[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-ping#content-area)
...
On this page
  * [fastmcp.server.middleware.ping](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-ping#fastmcp-server-middleware-ping)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-ping#classes)
  * [PingMiddleware ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-ping#pingmiddleware)
  * [on_message ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-ping#on_message)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-ping#fastmcp-server-middleware-ping)
`fastmcp.server.middleware.ping`
Ping middleware for keeping client connections alive.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-ping#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-ping#pingmiddleware)
`PingMiddleware`
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-ping#on_message)
`on_message`
Copy
```
...
[ middleware Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-middleware)[ rate_limiting Next ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-rate_limiting)
Ctrl+I
