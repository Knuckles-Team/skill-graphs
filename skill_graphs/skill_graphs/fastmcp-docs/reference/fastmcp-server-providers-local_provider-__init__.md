[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-__init__#content-area)
...
On this page
  * [fastmcp.server.providers.local_provider](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-__init__#fastmcp-server-providers-local_provider)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-__init__#fastmcp-server-providers-local_provider)
`fastmcp.server.providers.local_provider`
LocalProvider for locally-defined MCP components. This module provides the `LocalProvider` class that manages tools, resources, templates, and prompts registered via decorators or direct methods.
[ filesystem_discovery Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-filesystem_discovery)[ __init__ Next ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-__init__)
Ctrl+I
