[Skip to main content](https://gofastmcp.com/servers/auth/token-verification#content-area)
...
On this page
  * [Understanding Token Verification](https://gofastmcp.com/servers/auth/token-verification#understanding-token-verification)
  * [The Token Verification Model](https://gofastmcp.com/servers/auth/token-verification#the-token-verification-model)
  * [Token Security Considerations](https://gofastmcp.com/servers/auth/token-verification#token-security-considerations)
  * [TokenVerifier Class](https://gofastmcp.com/servers/auth/token-verification#tokenverifier-class)
  * [JWT Token Verification](https://gofastmcp.com/servers/auth/token-verification#jwt-token-verification)
  * [JWKS Endpoint Integration](https://gofastmcp.com/servers/auth/token-verification#jwks-endpoint-integration)
  * [Symmetric Key Verification (HMAC)](https://gofastmcp.com/servers/auth/token-verification#symmetric-key-verification-hmac)
  * [Static Public Key Verification](https://gofastmcp.com/servers/auth/token-verification#static-public-key-verification)
  * [Opaque Token Verification](https://gofastmcp.com/servers/auth/token-verification#opaque-token-verification)
  * [Understanding Opaque Tokens](https://gofastmcp.com/servers/auth/token-verification#understanding-opaque-tokens)
  * [Token Introspection Protocol](https://gofastmcp.com/servers/auth/token-verification#token-introspection-protocol)
  * [Development and Testing](https://gofastmcp.com/servers/auth/token-verification#development-and-testing)
  * [Static Token Verification](https://gofastmcp.com/servers/auth/token-verification#static-token-verification)
  * [Debug/Custom Token Verification](https://gofastmcp.com/servers/auth/token-verification#debug%2Fcustom-token-verification)
  * [Test Token Generation](https://gofastmcp.com/servers/auth/token-verification#test-token-generation)
  * [HTTP Client Customization](https://gofastmcp.com/servers/auth/token-verification#http-client-customization)
  * [Connection Pooling](https://gofastmcp.com/servers/auth/token-verification#connection-pooling)
  * [Production Configuration](https://gofastmcp.com/servers/auth/token-verification#production-configuration)
...
##
[​](https://gofastmcp.com/servers/auth/token-verification#understanding-token-verification)
...
###
[​](https://gofastmcp.com/servers/auth/token-verification#the-token-verification-model)
...
###
[​](https://gofastmcp.com/servers/auth/token-verification#token-security-considerations)
...
###
[​](https://gofastmcp.com/servers/auth/token-verification#static-public-key-verification)
...
##
[​](https://gofastmcp.com/servers/auth/token-verification#opaque-token-verification)
...
###
[​](https://gofastmcp.com/servers/auth/token-verification#understanding-opaque-tokens)
...
###
[​](https://gofastmcp.com/servers/auth/token-verification#token-introspection-protocol)
Token Introspection Protocol
RFC 7662 standardizes how resource servers validate opaque tokens. The protocol defines an introspection endpoint where resource servers authenticate using client credentials and receive token metadata including active status, scopes, expiration, and subject identity. FastMCP implements this protocol through the `IntrospectionTokenVerifier` class, handling authentication, request formatting, and response parsing according to the specification.
Copy
```
from fastmcp import FastMCP
...
The verifier authenticates to the introspection endpoint using client credentials and queries it whenever a bearer token arrives. FastMCP checks whether the token is active and has sufficient scopes before allowing access. Two standard client authentication methods are supported, both defined in RFC 6749:
...
##
[​](https://gofastmcp.com/servers/auth/token-verification#development-and-testing)
...
###
[​](https://gofastmcp.com/servers/auth/token-verification#static-token-verification)
...
###
[​](https://gofastmcp.com/servers/auth/token-verification#debug/custom-token-verification)
Debug/Custom Token Verification
`2.13.1` The `DebugTokenVerifier` provides maximum flexibility for testing and special cases where standard token verification isn’t applicable. It delegates validation to a user-provided callable, making it useful for prototyping, testing scenarios, or handling opaque tokens without introspection endpoints.
Copy
```
from fastmcp import FastMCP
...
By default, `DebugTokenVerifier` accepts any non-empty token as valid. This eliminates authentication barriers during early development, allowing you to focus on core functionality before adding security. For more controlled testing, provide custom validation logic:
Copy
```
from fastmcp.server.auth.providers.debug import DebugTokenVerifier
...
###
[​](https://gofastmcp.com/servers/auth/token-verification#test-token-generation)
...
##
[​](https://gofastmcp.com/servers/auth/token-verification#http-client-customization)
HTTP Client Customization
`2.18.0` All token verifiers that make HTTP calls accept an optional `http_client` parameter. This lets you provide your own `httpx.AsyncClient` for connection pooling, custom TLS configuration, or proxy settings.
###
...
##
[​](https://gofastmcp.com/servers/auth/token-verification#production-configuration)
...
[ Authentication Previous ](https://gofastmcp.com/servers/auth/authentication)[ Remote OAuth Next ](https://gofastmcp.com/servers/auth/remote-oauth)
Ctrl+I
