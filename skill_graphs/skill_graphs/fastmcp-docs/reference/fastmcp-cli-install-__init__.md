[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-cli-install-__init__#content-area)
...
On this page
  * [fastmcp.cli.install](https://gofastmcp.com/python-sdk/fastmcp-cli-install-__init__#fastmcp-cli-install)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-__init__#fastmcp-cli-install)
`fastmcp.cli.install`
Install subcommands for FastMCP CLI using Cyclopts.
[ generate Previous ](https://gofastmcp.com/python-sdk/fastmcp-cli-generate)[ claude_code Next ](https://gofastmcp.com/python-sdk/fastmcp-cli-install-claude_code)
Ctrl+I
