[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-auth-redirect_validation#content-area)
...
On this page
  * [fastmcp.server.auth.redirect_validation](https://gofastmcp.com/python-sdk/fastmcp-server-auth-redirect_validation#fastmcp-server-auth-redirect_validation)
  * [Functions](https://gofastmcp.com/python-sdk/fastmcp-server-auth-redirect_validation#functions)
  * [matches_allowed_pattern ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-redirect_validation#matches_allowed_pattern)
  * [validate_redirect_uri ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-redirect_validation#validate_redirect_uri)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-redirect_validation#fastmcp-server-auth-redirect_validation)
`fastmcp.server.auth.redirect_validation`
Utilities for validating client redirect URIs in OAuth flows. This module provides secure redirect URI validation with wildcard support, protecting against userinfo-based bypass attacks like
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-redirect_validation#functions)
Functions
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-redirect_validation#matches_allowed_pattern)
...
Securely check if a URI matches an allowed pattern with wildcard support. This function parses both the URI and pattern as URLs, comparing each component separately to prevent bypass attacks like userinfo injection. Patterns support wildcards:
  * https://_.example.com/_ matches any subdomain of example.com

Security: Rejects URIs with userinfo (user:pass@host) which could bypass naive string matching (e.g.,  **Args:**
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-redirect_validation#validate_redirect_uri)
...
[ workos Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-workos)[ ssrf Next ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-ssrf)
Ctrl+I
