[Skip to main content](https://gofastmcp.com/v2/getting-started/installation#content-area)
...
On this page
  * [Install FastMCP](https://gofastmcp.com/v2/getting-started/installation#install-fastmcp)
  * [Verify Installation](https://gofastmcp.com/v2/getting-started/installation#verify-installation)
  * [Dependency Licensing](https://gofastmcp.com/v2/getting-started/installation#dependency-licensing)
  * [Upgrading from the Official MCP SDK](https://gofastmcp.com/v2/getting-started/installation#upgrading-from-the-official-mcp-sdk)
  * [Versioning Policy](https://gofastmcp.com/v2/getting-started/installation#versioning-policy)
  * [Contributing to FastMCP](https://gofastmcp.com/v2/getting-started/installation#contributing-to-fastmcp)
...
Copy page
##
[​](https://gofastmcp.com/v2/getting-started/installation#install-fastmcp)
Install FastMCP
We recommend using  If you plan to use FastMCP in your project, you can add it as a dependency with:
Copy
```
uv add fastmcp
...
###
[​](https://gofastmcp.com/v2/getting-started/installation#verify-installation)
Verify Installation
...
###
[​](https://gofastmcp.com/v2/getting-started/installation#dependency-licensing)
...
Alternatively, wait for the stable v5 release. See
##
[​](https://gofastmcp.com/v2/getting-started/installation#upgrading-from-the-official-mcp-sdk)
...
##
[​](https://gofastmcp.com/v2/getting-started/installation#versioning-policy)
Versioning Policy
...
##
[​](https://gofastmcp.com/v2/getting-started/installation#contributing-to-fastmcp)
...
[ Welcome to FastMCP 2.0! Previous ](https://gofastmcp.com/v2/getting-started/welcome)[ Quickstart Next ](https://gofastmcp.com/v2/getting-started/quickstart)
Ctrl+I
