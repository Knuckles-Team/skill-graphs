[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-descope#content-area)
...
On this page
  * [fastmcp.server.auth.providers.descope](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-descope#fastmcp-server-auth-providers-descope)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-descope#classes)
  * [DescopeProvider ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-descope#descopeprovider)
  * [get_routes ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-descope#get_routes)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-descope#fastmcp-server-auth-providers-descope)
...
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-descope#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-descope#descopeprovider)
`DescopeProvider`
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-descope#get_routes)
`get_routes`
Copy
```
...
[ debug Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-debug)[ discord Next ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-discord)
Ctrl+I
