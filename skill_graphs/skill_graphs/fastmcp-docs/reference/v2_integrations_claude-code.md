[Skip to main content](https://gofastmcp.com/v2/integrations/claude-code#content-area)
...
On this page
  * [Requirements](https://gofastmcp.com/v2/integrations/claude-code#requirements)
  * [Create a Server](https://gofastmcp.com/v2/integrations/claude-code#create-a-server)
  * [Install the Server](https://gofastmcp.com/v2/integrations/claude-code#install-the-server)
  * [FastMCP CLI](https://gofastmcp.com/v2/integrations/claude-code#fastmcp-cli)
  * [Dependencies](https://gofastmcp.com/v2/integrations/claude-code#dependencies)
  * [Python Version and Project Configuration](https://gofastmcp.com/v2/integrations/claude-code#python-version-and-project-configuration)
  * [Environment Variables](https://gofastmcp.com/v2/integrations/claude-code#environment-variables)
  * [Manual Configuration](https://gofastmcp.com/v2/integrations/claude-code#manual-configuration)
  * [Using the Server](https://gofastmcp.com/v2/integrations/claude-code#using-the-server)
...
##
[​](https://gofastmcp.com/v2/integrations/claude-code#requirements)
Requirements
...
##
[​](https://gofastmcp.com/v2/integrations/claude-code#create-a-server)
Create a Server
...
##
[​](https://gofastmcp.com/v2/integrations/claude-code#install-the-server)
Install the Server
###
[​](https://gofastmcp.com/v2/integrations/claude-code#fastmcp-cli)
FastMCP CLI
`2.10.3` The easiest way to install a FastMCP server in Claude Code is using the `fastmcp install claude-code` command. This automatically handles the configuration, dependency management, and calls Claude Code’s built-in MCP management system.
Copy
```
...
####
[​](https://gofastmcp.com/v2/integrations/claude-code#dependencies)
Dependencies
...
####
[​](https://gofastmcp.com/v2/integrations/claude-code#python-version-and-project-configuration)
...
####
[​](https://gofastmcp.com/v2/integrations/claude-code#environment-variables)
...
###
[​](https://gofastmcp.com/v2/integrations/claude-code#manual-configuration)
...
##
[​](https://gofastmcp.com/v2/integrations/claude-code#using-the-server)
Using the Server
...
[ ChatGPT 🤝 FastMCP Previous ](https://gofastmcp.com/v2/integrations/chatgpt)[ Claude Desktop 🤝 FastMCP Next ](https://gofastmcp.com/v2/integrations/claude-desktop)
Ctrl+I
