[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#content-area)
...
##### fastmcp.server
  ...
  * middleware
    * [__init__](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-__init__)
    * [authorization](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-authorization)
    * [caching](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-caching)
    * [dereference](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-dereference)
    * [error_handling](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-error_handling)
    ...
    * [ping](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-ping)
    * [rate_limiting](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-rate_limiting)
    * [response_limiting](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-response_limiting)
    * [timing](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-timing)
    * [tool_injection](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection)
  * mixins
  * openapi
  * providers
...
On this page
  * [fastmcp.server.middleware.tool_injection](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#fastmcp-server-middleware-tool_injection)
  * [Functions](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#functions)
  * [list_prompts ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#list_prompts)
  * [get_prompt ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#get_prompt)
  * [list_resources ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#list_resources)
  * [read_resource ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#read_resource)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#classes)
  * [ToolInjectionMiddleware ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#toolinjectionmiddleware)
  * [on_list_tools ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#on_list_tools)
  * [on_call_tool ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#on_call_tool)
  * [PromptToolMiddleware ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#prompttoolmiddleware)
  * [ResourceToolMiddleware ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#resourcetoolmiddleware)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#fastmcp-server-middleware-tool_injection)
`fastmcp.server.middleware.tool_injection`
A middleware for injecting tools into the MCP server context.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#functions)
Functions
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#list_prompts)
`list_prompts`
Copy
```
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#get_prompt)
`get_prompt`
Copy
```
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#list_resources)
`list_resources`
Copy
```
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#read_resource)
`read_resource`
Copy
```
...
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#toolinjectionmiddleware)
`ToolInjectionMiddleware`
A middleware for injecting tools into the context. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#on_list_tools)
`on_list_tools`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#on_call_tool)
`on_call_tool`
Copy
```
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#prompttoolmiddleware)
`PromptToolMiddleware`
A middleware for injecting prompts as tools into the context.
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection#resourcetoolmiddleware)
`ResourceToolMiddleware`
A middleware for injecting resources as tools into the context.
[ timing Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-timing)[ __init__ Next ](https://gofastmcp.com/python-sdk/fastmcp-server-mixins-__init__)
Ctrl+I
