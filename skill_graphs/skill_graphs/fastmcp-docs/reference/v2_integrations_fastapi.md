[Skip to main content](https://gofastmcp.com/v2/integrations/fastapi#content-area)
...
##### Integrations
  ...
  * AI SDKs
  * API Integration
    * [FastAPI](https://gofastmcp.com/v2/integrations/fastapi)
    * [OpenAPI](https://gofastmcp.com/v2/integrations/openapi)
...
On this page
  * [Example FastAPI Application](https://gofastmcp.com/v2/integrations/fastapi#example-fastapi-application)
  * [Generating an MCP Server](https://gofastmcp.com/v2/integrations/fastapi#generating-an-mcp-server)
  * [Basic Conversion](https://gofastmcp.com/v2/integrations/fastapi#basic-conversion)
  * [Adding Components](https://gofastmcp.com/v2/integrations/fastapi#adding-components)
  * [Interacting with the MCP Server](https://gofastmcp.com/v2/integrations/fastapi#interacting-with-the-mcp-server)
  * [Custom Route Mapping](https://gofastmcp.com/v2/integrations/fastapi#custom-route-mapping)
  * [Authentication and Headers](https://gofastmcp.com/v2/integrations/fastapi#authentication-and-headers)
  * [Mounting an MCP Server](https://gofastmcp.com/v2/integrations/fastapi#mounting-an-mcp-server)
  * [Basic Mounting](https://gofastmcp.com/v2/integrations/fastapi#basic-mounting)
  * [Offering an LLM-Friendly API](https://gofastmcp.com/v2/integrations/fastapi#offering-an-llm-friendly-api)
  * [Key Considerations](https://gofastmcp.com/v2/integrations/fastapi#key-considerations)
  * [Operation IDs](https://gofastmcp.com/v2/integrations/fastapi#operation-ids)
  * [Lifespan Management](https://gofastmcp.com/v2/integrations/fastapi#lifespan-management)
  * [CORS Middleware](https://gofastmcp.com/v2/integrations/fastapi#cors-middleware)
  * [Combining Lifespans](https://gofastmcp.com/v2/integrations/fastapi#combining-lifespans)
  * [Performance Tips](https://gofastmcp.com/v2/integrations/fastapi#performance-tips)
...
FastMCP provides two powerful ways to integrate with FastAPI applications:
  1. **[Generate an MCP server FROM your FastAPI app](https://gofastmcp.com/v2/integrations/fastapi#generating-an-mcp-server)** - Convert existing API endpoints into MCP tools
  2. **[Mount an MCP server INTO your FastAPI app](https://gofastmcp.com/v2/integrations/fastapi#mounting-an-mcp-server)** - Add MCP functionality to your web application
...
##
[​](https://gofastmcp.com/v2/integrations/fastapi#example-fastapi-application)
...
##
[​](https://gofastmcp.com/v2/integrations/fastapi#generating-an-mcp-server)
Generating an MCP Server
`2.0.0` One of the most common ways to bootstrap an MCP server is to generate it from an existing FastAPI application. FastMCP will expose your FastAPI endpoints as MCP components (tools, by default) in order to expose your API to LLM clients.
###
[​](https://gofastmcp.com/v2/integrations/fastapi#basic-conversion)
Basic Conversion
...
###
[​](https://gofastmcp.com/v2/integrations/fastapi#adding-components)
Adding Components
...
###
[​](https://gofastmcp.com/v2/integrations/fastapi#interacting-with-the-mcp-server)
...
To learn more about customizing the conversion process, see the [OpenAPI Integration guide](https://gofastmcp.com/v2/integrations/openapi).
###
[​](https://gofastmcp.com/v2/integrations/fastapi#authentication-and-headers)
...
##
[​](https://gofastmcp.com/v2/integrations/fastapi#mounting-an-mcp-server)
Mounting an MCP Server
`2.3.1` In addition to generating servers, FastMCP can facilitate adding MCP servers to your existing FastAPI application. You can do this by mounting the MCP ASGI application.
###
[​](https://gofastmcp.com/v2/integrations/fastapi#basic-mounting)
Basic Mounting
...
##
[​](https://gofastmcp.com/v2/integrations/fastapi#offering-an-llm-friendly-api)
...
##
[​](https://gofastmcp.com/v2/integrations/fastapi#key-considerations)
Key Considerations
###
[​](https://gofastmcp.com/v2/integrations/fastapi#operation-ids)
Operation IDs
...
###
[​](https://gofastmcp.com/v2/integrations/fastapi#lifespan-management)
Lifespan Management
...
If you’re mounting an authenticated MCP server under a path prefix, see [Mounting Authenticated Servers](https://gofastmcp.com/v2/deployment/http#mounting-authenticated-servers) for important OAuth routing considerations.
###
[​](https://gofastmcp.com/v2/integrations/fastapi#cors-middleware)
CORS Middleware
...
###
[​](https://gofastmcp.com/v2/integrations/fastapi#combining-lifespans)
Combining Lifespans
...
###
[​](https://gofastmcp.com/v2/integrations/fastapi#performance-tips)
Performance Tips
...
For more details on configuration options, see the [OpenAPI Integration guide](https://gofastmcp.com/v2/integrations/openapi).
[ OpenAI API 🤝 FastMCP Previous ](https://gofastmcp.com/v2/integrations/openai)[ OpenAPI 🤝 FastMCP Next ](https://gofastmcp.com/v2/integrations/openapi)
Ctrl+I
