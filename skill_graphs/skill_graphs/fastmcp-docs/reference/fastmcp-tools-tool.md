[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#content-area)
...
On this page
  ...
  * [default_serializer ](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#default_serializer)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#classes)
  * [ToolResult ](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#toolresult)
  * [to_mcp_result ](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#to_mcp_result)
  * [Tool ](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#tool)
  * [to_mcp_tool ](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#to_mcp_tool)
  * [from_function ](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#from_function)
  * [run ](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#run)
  * [convert_result ](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#convert_result)
  * [register_with_docket ](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#register_with_docket)
  * [add_to_docket ](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#add_to_docket)
  * [from_tool ](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#from_tool)
  * [get_span_attributes ](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#get_span_attributes)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#fastmcp-tools-tool)
`fastmcp.tools.tool`
##
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#functions)
Functions
###
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#default_serializer)
`default_serializer`
Copy
```
...
##
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#toolresult)
`ToolResult`
**Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#to_mcp_result)
`to_mcp_result`
Copy
```
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#tool)
`Tool`
Internal tool registration info. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#to_mcp_tool)
`to_mcp_tool`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#from_function)
`from_function`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#run)
`run`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#convert_result)
`convert_result`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#register_with_docket)
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#add_to_docket)
`add_to_docket`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#from_tool)
`from_tool`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-tool#get_span_attributes)
`get_span_attributes`
Copy
```
...
[ function_tool Previous ](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool)[ tool_transform Next ](https://gofastmcp.com/python-sdk/fastmcp-tools-tool_transform)
Ctrl+I
