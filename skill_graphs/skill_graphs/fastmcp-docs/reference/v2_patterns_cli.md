[Skip to main content](https://gofastmcp.com/v2/patterns/cli#content-area)
...
On this page
  * [Commands Overview](https://gofastmcp.com/v2/patterns/cli#commands-overview)
  * [fastmcp run](https://gofastmcp.com/v2/patterns/cli#fastmcp-run)
  * [Options](https://gofastmcp.com/v2/patterns/cli#options)
  * [Entrypoints](https://gofastmcp.com/v2/patterns/cli#entrypoints)
  * [Inferred Server Instance](https://gofastmcp.com/v2/patterns/cli#inferred-server-instance)
  * [Explicit Server Entrypoint](https://gofastmcp.com/v2/patterns/cli#explicit-server-entrypoint)
  * [Factory Function](https://gofastmcp.com/v2/patterns/cli#factory-function)
  * [Remote Server Proxy](https://gofastmcp.com/v2/patterns/cli#remote-server-proxy)
  * [FastMCP Configuration](https://gofastmcp.com/v2/patterns/cli#fastmcp-configuration)
  * [MCP Configuration](https://gofastmcp.com/v2/patterns/cli#mcp-configuration)
  * [fastmcp dev](https://gofastmcp.com/v2/patterns/cli#fastmcp-dev)
  * [Options](https://gofastmcp.com/v2/patterns/cli#options-2)
  * [Entrypoints](https://gofastmcp.com/v2/patterns/cli#entrypoints-2)
  * [fastmcp install](https://gofastmcp.com/v2/patterns/cli#fastmcp-install)
  * [Options](https://gofastmcp.com/v2/patterns/cli#options-3)
  * [Entrypoints](https://gofastmcp.com/v2/patterns/cli#entrypoints-3)
  * [MCP JSON Generation](https://gofastmcp.com/v2/patterns/cli#mcp-json-generation)
  * [fastmcp inspect](https://gofastmcp.com/v2/patterns/cli#fastmcp-inspect)
  * [Options](https://gofastmcp.com/v2/patterns/cli#options-4)
  * [Output Formats](https://gofastmcp.com/v2/patterns/cli#output-formats)
  * [FastMCP Format (--format fastmcp)](https://gofastmcp.com/v2/patterns/cli#fastmcp-format-format-fastmcp)
  * [MCP Protocol Format (--format mcp)](https://gofastmcp.com/v2/patterns/cli#mcp-protocol-format-format-mcp)
  * [Entrypoints](https://gofastmcp.com/v2/patterns/cli#entrypoints-4)
  * [Examples](https://gofastmcp.com/v2/patterns/cli#examples)
  * [fastmcp project prepare](https://gofastmcp.com/v2/patterns/cli#fastmcp-project-prepare)
  * [Options](https://gofastmcp.com/v2/patterns/cli#options-5)
  * [Usage Pattern](https://gofastmcp.com/v2/patterns/cli#usage-pattern)
  * [fastmcp version](https://gofastmcp.com/v2/patterns/cli#fastmcp-version)
  * [Options](https://gofastmcp.com/v2/patterns/cli#options-6)
...
##
[​](https://gofastmcp.com/v2/patterns/cli#commands-overview)
Commands Overview
...
##
[​](https://gofastmcp.com/v2/patterns/cli#fastmcp-run)
`fastmcp run`
...
###
[​](https://gofastmcp.com/v2/patterns/cli#options)
Options
...
###
[​](https://gofastmcp.com/v2/patterns/cli#entrypoints)
Entrypoints
`2.3.5` The `fastmcp run` command supports the following entrypoints:
  1. **[Inferred server instance](https://gofastmcp.com/v2/patterns/cli#inferred-server-instance)** : `server.py` - imports the module and looks for a FastMCP server instance named `mcp`, `server`, or `app`. Errors if no such object is found.
  2. **[Explicit server entrypoint](https://gofastmcp.com/v2/patterns/cli#explicit-server-entrypoint)** : `server.py:custom_name` - imports and uses the specified server entrypoint
  3. **[Factory function](https://gofastmcp.com/v2/patterns/cli#factory-function)** : `server.py:create_server` - calls the specified function (sync or async) to create a server instance
  4. **[Remote server proxy](https://gofastmcp.com/v2/patterns/cli#remote-server-proxy)** : `https://example.com/mcp-server` - connects to a remote server and creates a **local proxy server**
  5. **[FastMCP configuration file](https://gofastmcp.com/v2/patterns/cli#fastmcp-configuration)** : `fastmcp.json` - runs servers using FastMCP’s declarative configuration format (auto-detects files in current directory)
...
####
[​](https://gofastmcp.com/v2/patterns/cli#inferred-server-instance)
...
####
[​](https://gofastmcp.com/v2/patterns/cli#explicit-server-entrypoint)
...
####
[​](https://gofastmcp.com/v2/patterns/cli#factory-function)
Factory Function
`2.11.2` Since `fastmcp run` ignores the `if __name__ == "__main__"` block, you can use a factory function to run setup code before your server starts. Factory functions are called without any arguments and must return a FastMCP server instance. Both sync and async factory functions are supported. The syntax for using a factory function is the same as for an explicit server entrypoint: `fastmcp run server.py:factory_fn`. FastMCP will automatically detect that you have identified a function rather than a server Instance For example, if you have a file called `server.py` with the following content:
Copy
```
from fastmcp import FastMCP
...
####
[​](https://gofastmcp.com/v2/patterns/cli#remote-server-proxy)
Remote Server Proxy
...
####
[​](https://gofastmcp.com/v2/patterns/cli#fastmcp-configuration)
FastMCP Configuration
`2.11.4` FastMCP supports declarative configuration through `fastmcp.json` files. When you run `fastmcp run` without arguments, it automatically looks for a `fastmcp.json` file in the current directory:
Copy
```
...
See [Server Configuration](https://gofastmcp.com/v2/deployment/server-configuration) for detailed documentation on fastmcp.json.
####
[​](https://gofastmcp.com/v2/patterns/cli#mcp-configuration)
MCP Configuration
...
##
[​](https://gofastmcp.com/v2/patterns/cli#fastmcp-dev)
`fastmcp dev`
Run a MCP server with the
Copy
```
...
###
[​](https://gofastmcp.com/v2/patterns/cli#options-2)
Options
Option | Flag | Description
---|---|---
...
Requirements File | `--with-requirements` | Requirements file to install dependencies from
###
[​](https://gofastmcp.com/v2/patterns/cli#entrypoints-2)
Entrypoints
...
##
[​](https://gofastmcp.com/v2/patterns/cli#fastmcp-install)
`fastmcp install`
`2.10.3` Install a MCP server in MCP client applications. FastMCP currently supports the following clients:
...
###
[​](https://gofastmcp.com/v2/patterns/cli#options-3)
Options
Option | Flag | Description
---|---|---
...
Requirements File | `--with-requirements` | Requirements file to install dependencies from
###
[​](https://gofastmcp.com/v2/patterns/cli#entrypoints-3)
Entrypoints
...
###
[​](https://gofastmcp.com/v2/patterns/cli#mcp-json-generation)
MCP JSON Generation
...
##
[​](https://gofastmcp.com/v2/patterns/cli#fastmcp-inspect)
`fastmcp inspect`
`2.9.0` Inspect a FastMCP server to view summary information or generate a detailed JSON report.
Copy
```
# Show text summary
...
###
[​](https://gofastmcp.com/v2/patterns/cli#options-4)
Options
Option | Flag | Description
---|---|---
...
###
[​](https://gofastmcp.com/v2/patterns/cli#output-formats)
Output Formats
####
[​](https://gofastmcp.com/v2/patterns/cli#fastmcp-format-format-fastmcp)
...
####
[​](https://gofastmcp.com/v2/patterns/cli#mcp-protocol-format-format-mcp)
...
###
[​](https://gofastmcp.com/v2/patterns/cli#entrypoints-4)
Entrypoints
...
###
[​](https://gofastmcp.com/v2/patterns/cli#examples)
Examples
Copy
```
...
##
[​](https://gofastmcp.com/v2/patterns/cli#fastmcp-project-prepare)
...
###
[​](https://gofastmcp.com/v2/patterns/cli#options-5)
Options
Option | Flag | Description
---|---|---
Output Directory | `--output-dir` |  **Required.** Directory where the persistent uv project will be created
###
[​](https://gofastmcp.com/v2/patterns/cli#usage-pattern)
Usage Pattern
Copy
```
...
##
[​](https://gofastmcp.com/v2/patterns/cli#fastmcp-version)
`fastmcp version`
...
###
[​](https://gofastmcp.com/v2/patterns/cli#options-6)
Options
Option | Flag | Description
---|---|---
Copy to Clipboard | `--copy` | Copy version information to clipboard
[ Decorating Methods Previous ](https://gofastmcp.com/v2/patterns/decorating-methods)[ Contrib Modules Next ](https://gofastmcp.com/v2/patterns/contrib)
Ctrl+I
