[Skip to main content](https://gofastmcp.com/servers/resources#content-area)
...
On this page
  * [What Are Resources?](https://gofastmcp.com/servers/resources#what-are-resources)
  ...
  * [Using with Methods](https://gofastmcp.com/servers/resources#using-with-methods)
  * [Return Values](https://gofastmcp.com/servers/resources#return-values)
  * [ResourceResult](https://gofastmcp.com/servers/resources#resourceresult)
  * [Component Visibility](https://gofastmcp.com/servers/resources#component-visibility)
  ...
  * [Annotations](https://gofastmcp.com/servers/resources#annotations)
  * [Resource Templates](https://gofastmcp.com/servers/resources#resource-templates)
  * [RFC 6570 URI Templates](https://gofastmcp.com/servers/resources#rfc-6570-uri-templates)
  * [Wildcard Parameters](https://gofastmcp.com/servers/resources#wildcard-parameters)
  * [Query Parameters](https://gofastmcp.com/servers/resources#query-parameters)
  * [Template Parameter Rules](https://gofastmcp.com/servers/resources#template-parameter-rules)
  ...
  * [Versioning](https://gofastmcp.com/servers/resources#versioning)
...
##
[​](https://gofastmcp.com/servers/resources#what-are-resources)
What Are Resources?
...
##
[​](https://gofastmcp.com/servers/resources#resources)
Resources
###
[​](https://gofastmcp.com/servers/resources#the-@resource-decorator)
...
####
[​](https://gofastmcp.com/servers/resources#decorator-arguments)
Decorator Arguments
...
A boolean to enable or disable the resource. See [Component Visibility](https://gofastmcp.com/servers/resources#component-visibility) for the recommended approach.
[​](https://gofastmcp.com/servers/resources#param-icons)
icons
list[Icon] | None
`2.13.0`Optional list of icon representations for this resource or template. See [Icons](https://gofastmcp.com/servers/icons) for detailed examples
[​](https://gofastmcp.com/servers/resources#param-annotations)
annotations
...
[​](https://gofastmcp.com/servers/resources#param-read-only-hint)
readOnlyHint
bool | None
If true, the resource is read-only and does not modify its environment.
[​](https://gofastmcp.com/servers/resources#param-idempotent-hint)
idempotentHint
bool | None
...
meta
dict[str, Any] | None
`2.11.0`Optional meta information about the resource. This data is passed through to the MCP client as the `meta` field of the client-side resource object and can be used for custom metadata, versioning, or other application-specific purposes.
[​](https://gofastmcp.com/servers/resources#param-version)
version
str | int | None
`3.0.0`Optional version identifier for this resource. See [Versioning](https://gofastmcp.com/servers/versioning) for details.
####
[​](https://gofastmcp.com/servers/resources#using-with-methods)
Using with Methods
For decorating instance or class methods, use the standalone `@resource` decorator and register the bound method. See [Tools: Using with Methods](https://gofastmcp.com/servers/tools#using-with-methods) for the pattern.
###
[​](https://gofastmcp.com/servers/resources#return-values)
Return Values
Resource functions must return one of three types:
  * **`str`**: Sent as`TextResourceContents` (with `mime_type="text/plain"` by default).
  * **`bytes`**: Base64 encoded and sent as`BlobResourceContents`. You should specify an appropriate `mime_type` (e.g., `"image/png"`, `"application/octet-stream"`).
  * **`ResourceResult`**: Full control over contents, MIME types, and metadata. See[ResourceResult](https://gofastmcp.com/servers/resources#resourceresult) below.
...
ResourceResult
`3.0.0` `ResourceResult` gives you explicit control over resource responses: multiple content items, per-item MIME types, and metadata at both the item and result level.
Copy
```
from fastmcp import FastMCP
...
## ResourceResult
[​](https://gofastmcp.com/servers/resources#param-contents)
contents
...
[​](https://gofastmcp.com/servers/resources#param-meta-1)
meta
dict[str, Any] | None
Result-level metadata, included in the MCP response’s `_meta` field.
## ResourceContent
[​](https://gofastmcp.com/servers/resources#param-content)
content
Any
required
...
[​](https://gofastmcp.com/servers/resources#param-mime-type-1)
mime_type
str | None
MIME type. Defaults to `text/plain` for strings, `application/octet-stream` for bytes, `application/json` for serialized objects.
[​](https://gofastmcp.com/servers/resources#param-meta-2)
meta
dict[str, Any] | None
Item-level metadata for this specific content.
###
[​](https://gofastmcp.com/servers/resources#component-visibility)
Component Visibility
`3.0.0` You can control which resources are enabled for clients using server-level enabled control. Disabled resources don’t appear in `list_resources` and can’t be read.
Copy
```
from fastmcp import FastMCP
...
###
[​](https://gofastmcp.com/servers/resources#accessing-mcp-context)
...
###
[​](https://gofastmcp.com/servers/resources#async-resources)
Async Resources
...
###
[​](https://gofastmcp.com/servers/resources#resource-classes)
Resource Classes
...
###
[​](https://gofastmcp.com/servers/resources#notifications)
Notifications
...
Notifications are only sent when these operations occur within an active MCP request context (e.g., when called from within a tool or other MCP operation). Operations performed during server initialization do not trigger notifications. Clients can handle these notifications using a [message handler](https://gofastmcp.com/clients/notifications) to automatically refresh their resource lists or update their interfaces.
###
[​](https://gofastmcp.com/servers/resources#annotations)
Annotations
...
##
[​](https://gofastmcp.com/servers/resources#resource-templates)
Resource Templates
...
###
[​](https://gofastmcp.com/servers/resources#rfc-6570-uri-templates)
RFC 6570 URI Templates
FastMCP implements
####
[​](https://gofastmcp.com/servers/resources#wildcard-parameters)
Wildcard Parameters
...
####
[​](https://gofastmcp.com/servers/resources#query-parameters)
Query Parameters
...
###
[​](https://gofastmcp.com/servers/resources#template-parameter-rules)
...
##
[​](https://gofastmcp.com/servers/resources#error-handling)
Error Handling
...
##
[​](https://gofastmcp.com/servers/resources#server-behavior)
Server Behavior
###
[​](https://gofastmcp.com/servers/resources#duplicate-resources)
Duplicate Resources
...
##
[​](https://gofastmcp.com/servers/resources#versioning)
Versioning
`3.0.0` Resources and resource templates support versioning, allowing you to maintain multiple implementations under the same URI while clients automatically receive the highest version. See [Versioning](https://gofastmcp.com/servers/versioning) for complete documentation on version comparison, retrieval, and migration patterns.
[ Tools Previous ](https://gofastmcp.com/servers/tools)[ Prompts Next ](https://gofastmcp.com/servers/prompts)
Ctrl+I
