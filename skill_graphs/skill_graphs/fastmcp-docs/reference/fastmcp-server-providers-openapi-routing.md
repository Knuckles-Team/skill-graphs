[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-routing#content-area)
...
On this page
  * [fastmcp.server.providers.openapi.routing](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-routing#fastmcp-server-providers-openapi-routing)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-routing#classes)
  * [MCPType ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-routing#mcptype)
  * [RouteMap ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-routing#routemap)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-routing#fastmcp-server-providers-openapi-routing)
`fastmcp.server.providers.openapi.routing`
Route mapping logic for OpenAPI operations.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-routing#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-routing#mcptype)
`MCPType`
Type of FastMCP component to create from a route.
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-routing#routemap)
`RouteMap`
Mapping configuration for HTTP routes to FastMCP component types.
[ provider Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-provider)[ proxy Next ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-proxy)
Ctrl+I
