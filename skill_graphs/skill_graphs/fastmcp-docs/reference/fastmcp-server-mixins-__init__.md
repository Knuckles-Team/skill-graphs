[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-mixins-__init__#content-area)
...
On this page
  * [fastmcp.server.mixins](https://gofastmcp.com/python-sdk/fastmcp-server-mixins-__init__#fastmcp-server-mixins)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-mixins-__init__#fastmcp-server-mixins)
`fastmcp.server.mixins`
Server mixins for FastMCP.
[ tool_injection Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-tool_injection)[ lifespan Next ](https://gofastmcp.com/python-sdk/fastmcp-server-mixins-lifespan)
Ctrl+I
