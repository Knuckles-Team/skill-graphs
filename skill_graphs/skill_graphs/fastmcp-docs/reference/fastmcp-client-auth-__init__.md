[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-client-auth-__init__#content-area)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-client-auth-__init__#fastmcp-client-auth)
`fastmcp.client.auth`
_This module is empty or contains only private/internal implementations._
[ __init__ Previous ](https://gofastmcp.com/python-sdk/fastmcp-client-__init__)[ bearer Next ](https://gofastmcp.com/python-sdk/fastmcp-client-auth-bearer)
Ctrl+I
