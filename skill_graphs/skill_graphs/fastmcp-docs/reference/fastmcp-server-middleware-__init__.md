[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-__init__#content-area)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-__init__#fastmcp-server-middleware)
`fastmcp.server.middleware`
_This module is empty or contains only private/internal implementations._
[ low_level Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-low_level)[ authorization Next ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-authorization)
Ctrl+I
