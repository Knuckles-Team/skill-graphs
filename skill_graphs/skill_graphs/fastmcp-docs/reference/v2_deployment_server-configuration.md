[Skip to main content](https://gofastmcp.com/v2/deployment/server-configuration#content-area)
...
On this page
  * [Overview](https://gofastmcp.com/v2/deployment/server-configuration#overview)
  * [File Structure](https://gofastmcp.com/v2/deployment/server-configuration#file-structure)
  * [JSON Schema Support](https://gofastmcp.com/v2/deployment/server-configuration#json-schema-support)
  * [Source Configuration](https://gofastmcp.com/v2/deployment/server-configuration#source-configuration)
  * [Environment Configuration](https://gofastmcp.com/v2/deployment/server-configuration#environment-configuration)
  * [Deployment Configuration](https://gofastmcp.com/v2/deployment/server-configuration#deployment-configuration)
  * [Environment Variable Interpolation](https://gofastmcp.com/v2/deployment/server-configuration#environment-variable-interpolation)
  * [Usage with CLI Commands](https://gofastmcp.com/v2/deployment/server-configuration#usage-with-cli-commands)
  * [Pre-building Environments](https://gofastmcp.com/v2/deployment/server-configuration#pre-building-environments)
  * [Using an Existing Environment](https://gofastmcp.com/v2/deployment/server-configuration#using-an-existing-environment)
  * [Using an Existing Source](https://gofastmcp.com/v2/deployment/server-configuration#using-an-existing-source)
  * [CLI Override Behavior](https://gofastmcp.com/v2/deployment/server-configuration#cli-override-behavior)
  * [Custom Naming Patterns](https://gofastmcp.com/v2/deployment/server-configuration#custom-naming-patterns)
  * [Examples](https://gofastmcp.com/v2/deployment/server-configuration#examples)
  * [Migrating from CLI Arguments](https://gofastmcp.com/v2/deployment/server-configuration#migrating-from-cli-arguments)
...
##
[​](https://gofastmcp.com/v2/deployment/server-configuration#overview)
Overview
...
##
[​](https://gofastmcp.com/v2/deployment/server-configuration#file-structure)
File Structure
...
###
[​](https://gofastmcp.com/v2/deployment/server-configuration#json-schema-support)
JSON Schema Support
...
###
[​](https://gofastmcp.com/v2/deployment/server-configuration#source-configuration)
...
## Source
[​](https://gofastmcp.com/v2/deployment/server-configuration#param-source)
source
object
required
The server source configuration that determines where your server code lives.
[​](https://gofastmcp.com/v2/deployment/server-configuration#param-type)
type
string
default:"filesystem"
...
[​](https://gofastmcp.com/v2/deployment/server-configuration#param-path)
path
string
required
Path to the Python file containing your FastMCP server.
[​](https://gofastmcp.com/v2/deployment/server-configuration#param-entrypoint)
entrypoint
string
...
###
[​](https://gofastmcp.com/v2/deployment/server-configuration#environment-configuration)
...
## Environment
[​](https://gofastmcp.com/v2/deployment/server-configuration#param-environment)
environment
object
...
[​](https://gofastmcp.com/v2/deployment/server-configuration#param-type-1)
type
string
default:"uv"
...
[​](https://gofastmcp.com/v2/deployment/server-configuration#param-python)
python
string
...
[​](https://gofastmcp.com/v2/deployment/server-configuration#param-dependencies)
dependencies
list[str]
...
[​](https://gofastmcp.com/v2/deployment/server-configuration#param-requirements)
requirements
string
...
[​](https://gofastmcp.com/v2/deployment/server-configuration#param-project)
project
string
...
[​](https://gofastmcp.com/v2/deployment/server-configuration#param-editable)
editable
list[string]
...
###
[​](https://gofastmcp.com/v2/deployment/server-configuration#deployment-configuration)
...
## Deployment Fields
[​](https://gofastmcp.com/v2/deployment/server-configuration#param-deployment)
deployment
object
Optional runtime configuration for the server.
Show Deployment Fields
[​](https://gofastmcp.com/v2/deployment/server-configuration#param-transport)
transport
string
default:"stdio"
...
[​](https://gofastmcp.com/v2/deployment/server-configuration#param-host)
host
string
default:"127.0.0.1"
...
[​](https://gofastmcp.com/v2/deployment/server-configuration#param-port)
port
integer
default:"3000"
Port number for HTTP transport.
[​](https://gofastmcp.com/v2/deployment/server-configuration#param-path-1)
path
string
default:"/mcp/"
URL path for the MCP endpoint when using HTTP transport.
[​](https://gofastmcp.com/v2/deployment/server-configuration#param-log-level)
log_level
string
default:"INFO"
...
[​](https://gofastmcp.com/v2/deployment/server-configuration#param-env)
env
object
...
[​](https://gofastmcp.com/v2/deployment/server-configuration#param-cwd)
cwd
string
Working directory for the server process. Relative paths are resolved from the config file location.
[​](https://gofastmcp.com/v2/deployment/server-configuration#param-args)
args
list[str]
...
####
[​](https://gofastmcp.com/v2/deployment/server-configuration#environment-variable-interpolation)
...
##
[​](https://gofastmcp.com/v2/deployment/server-configuration#usage-with-cli-commands)
...
###
[​](https://gofastmcp.com/v2/deployment/server-configuration#pre-building-environments)
...
###
[​](https://gofastmcp.com/v2/deployment/server-configuration#using-an-existing-environment)
...
###
[​](https://gofastmcp.com/v2/deployment/server-configuration#using-an-existing-source)
...
###
[​](https://gofastmcp.com/v2/deployment/server-configuration#cli-override-behavior)
...
###
[​](https://gofastmcp.com/v2/deployment/server-configuration#custom-naming-patterns)
...
##
[​](https://gofastmcp.com/v2/deployment/server-configuration#examples)
Examples
  * Basic Configuration
...
##
[​](https://gofastmcp.com/v2/deployment/server-configuration#migrating-from-cli-arguments)
...
[ Prefect Horizon Previous ](https://gofastmcp.com/deployment/prefect-horizon)[ The FastMCP Client Next ](https://gofastmcp.com/v2/clients/client)
Ctrl+I
