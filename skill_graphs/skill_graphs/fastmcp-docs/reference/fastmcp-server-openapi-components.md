[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-components#content-area)
...
On this page
  * [fastmcp.server.openapi.components](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-components#fastmcp-server-openapi-components)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-components#fastmcp-server-openapi-components)
`fastmcp.server.openapi.components`
OpenAPI component implementations - backwards compatibility stub. This module is deprecated. Import from fastmcp.server.providers.openapi instead.
[ __init__ Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-__init__)[ routing Next ](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-routing)
Ctrl+I
