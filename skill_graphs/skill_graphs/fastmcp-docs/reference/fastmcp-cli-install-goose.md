[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-cli-install-goose#content-area)
...
On this page
  * [fastmcp.cli.install.goose](https://gofastmcp.com/python-sdk/fastmcp-cli-install-goose#fastmcp-cli-install-goose)
  * [Functions](https://gofastmcp.com/python-sdk/fastmcp-cli-install-goose#functions)
  * [generate_goose_deeplink ](https://gofastmcp.com/python-sdk/fastmcp-cli-install-goose#generate_goose_deeplink)
  * [install_goose ](https://gofastmcp.com/python-sdk/fastmcp-cli-install-goose#install_goose)
  * [goose_command ](https://gofastmcp.com/python-sdk/fastmcp-cli-install-goose#goose_command)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-goose#fastmcp-cli-install-goose)
`fastmcp.cli.install.goose`
Goose integration for FastMCP install using Cyclopts.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-goose#functions)
Functions
###
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-goose#generate_goose_deeplink)
...
Generate a Goose deeplink for installing an MCP extension. **Args:**
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-goose#install_goose)
`install_goose`
Copy
```
...
Install FastMCP server in Goose via deeplink. **Args:**
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-goose#goose_command)
`goose_command`
Copy
```
...
Install an MCP server in Goose. Uses uvx to run the server. Environment variables are not included in the deeplink; use `fastmcp install mcp-json` to generate a full config for manual installation. **Args:**
  * `server_spec`: Python file to install, optionally with :object suffix


[ gemini_cli Previous ](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli)[ mcp_json Next ](https://gofastmcp.com/python-sdk/fastmcp-cli-install-mcp_json)
Ctrl+I
