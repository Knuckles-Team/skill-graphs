[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-telemetry#content-area)
...
On this page
  * [fastmcp.server.telemetry](https://gofastmcp.com/python-sdk/fastmcp-server-telemetry#fastmcp-server-telemetry)
  * [Functions](https://gofastmcp.com/python-sdk/fastmcp-server-telemetry#functions)
  * [get_auth_span_attributes ](https://gofastmcp.com/python-sdk/fastmcp-server-telemetry#get_auth_span_attributes)
  * [get_session_span_attributes ](https://gofastmcp.com/python-sdk/fastmcp-server-telemetry#get_session_span_attributes)
  * [server_span ](https://gofastmcp.com/python-sdk/fastmcp-server-telemetry#server_span)
  * [delegate_span ](https://gofastmcp.com/python-sdk/fastmcp-server-telemetry#delegate_span)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-telemetry#fastmcp-server-telemetry)
`fastmcp.server.telemetry`
Server-side telemetry helpers.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-telemetry#functions)
Functions
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-telemetry#get_auth_span_attributes)
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-telemetry#get_session_span_attributes)
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-telemetry#server_span)
`server_span`
Copy
```
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-telemetry#delegate_span)
`delegate_span`
Copy
```
...
[ subscriptions Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-subscriptions)[ __init__ Next ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-__init__)
Ctrl+I
