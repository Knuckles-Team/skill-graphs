[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#content-area)
...
##### fastmcp.client
  ...
  * transports
    * [__init__](https://gofastmcp.com/python-sdk/fastmcp-client-transports-__init__)
    * [base](https://gofastmcp.com/python-sdk/fastmcp-client-transports-base)
    * [config](https://gofastmcp.com/python-sdk/fastmcp-client-transports-config)
    * [http](https://gofastmcp.com/python-sdk/fastmcp-client-transports-http)
    * [inference](https://gofastmcp.com/python-sdk/fastmcp-client-transports-inference)
    * [memory](https://gofastmcp.com/python-sdk/fastmcp-client-transports-memory)
    * [sse](https://gofastmcp.com/python-sdk/fastmcp-client-transports-sse)
    * [stdio](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio)
...
On this page
  * [fastmcp.client.transports.stdio](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#fastmcp-client-transports-stdio)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#classes)
  * [StdioTransport ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#stdiotransport)
  * [connect_session ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#connect_session)
  * [connect ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#connect)
  * [disconnect ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#disconnect)
  * [close ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#close)
  * [PythonStdioTransport ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#pythonstdiotransport)
  * [FastMCPStdioTransport ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#fastmcpstdiotransport)
  * [NodeStdioTransport ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#nodestdiotransport)
  * [UvStdioTransport ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#uvstdiotransport)
  * [UvxStdioTransport ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#uvxstdiotransport)
  * [NpxStdioTransport ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#npxstdiotransport)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#fastmcp-client-transports-stdio)
`fastmcp.client.transports.stdio`
##
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#stdiotransport)
`StdioTransport`
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#connect_session)
`connect_session`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#connect)
`connect`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#disconnect)
`disconnect`
Copy
```
disconnect(self)
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#close)
`close`
Copy
```
close(self)
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#pythonstdiotransport)
`PythonStdioTransport`
Transport for running Python scripts.
###
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#fastmcpstdiotransport)
`FastMCPStdioTransport`
Transport for running FastMCP servers using the FastMCP CLI.
###
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#nodestdiotransport)
`NodeStdioTransport`
Transport for running Node.js scripts.
###
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#uvstdiotransport)
`UvStdioTransport`
Transport for running commands via the uv tool.
###
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#uvxstdiotransport)
`UvxStdioTransport`
Transport for running commands via the uvx tool.
###
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-stdio#npxstdiotransport)
`NpxStdioTransport`
Transport for running commands via the npx tool.
[ sse Previous ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-sse)[ __init__ Next ](https://gofastmcp.com/python-sdk/fastmcp-experimental-__init__)
Ctrl+I
