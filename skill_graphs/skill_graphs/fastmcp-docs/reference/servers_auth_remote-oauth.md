[Skip to main content](https://gofastmcp.com/servers/auth/remote-oauth#content-area)
...
On this page
  * [DCR-Enabled Providers](https://gofastmcp.com/servers/auth/remote-oauth#dcr-enabled-providers)
  * [The Remote OAuth Challenge](https://gofastmcp.com/servers/auth/remote-oauth#the-remote-oauth-challenge)
  * [MCP Authentication Discovery](https://gofastmcp.com/servers/auth/remote-oauth#mcp-authentication-discovery)
  * [FastMCP Remote Authentication](https://gofastmcp.com/servers/auth/remote-oauth#fastmcp-remote-authentication)
  * [RemoteAuthProvider](https://gofastmcp.com/servers/auth/remote-oauth#remoteauthprovider)
  * [Basic Implementation](https://gofastmcp.com/servers/auth/remote-oauth#basic-implementation)
  * [Overriding Advertised Scopes](https://gofastmcp.com/servers/auth/remote-oauth#overriding-advertised-scopes)
  * [Custom Endpoints](https://gofastmcp.com/servers/auth/remote-oauth#custom-endpoints)
  * [WorkOS AuthKit Integration](https://gofastmcp.com/servers/auth/remote-oauth#workos-authkit-integration)
  * [Client Redirect URI Security](https://gofastmcp.com/servers/auth/remote-oauth#client-redirect-uri-security)
  * [Implementation Considerations](https://gofastmcp.com/servers/auth/remote-oauth#implementation-considerations)
...
##
[​](https://gofastmcp.com/servers/auth/remote-oauth#dcr-enabled-providers)
...
##
[​](https://gofastmcp.com/servers/auth/remote-oauth#the-remote-oauth-challenge)
...
##
[​](https://gofastmcp.com/servers/auth/remote-oauth#mcp-authentication-discovery)
...
##
[​](https://gofastmcp.com/servers/auth/remote-oauth#fastmcp-remote-authentication)
...
###
[​](https://gofastmcp.com/servers/auth/remote-oauth#remoteauthprovider)
RemoteAuthProvider
...
###
[​](https://gofastmcp.com/servers/auth/remote-oauth#basic-implementation)
...
###
[​](https://gofastmcp.com/servers/auth/remote-oauth#overriding-advertised-scopes)
...
When not set, `scopes_supported` defaults to the token verifier’s `required_scopes`. For Azure AD specifically, see the [AzureJWTVerifier](https://gofastmcp.com/integrations/azure#token-verification-only-managed-identity) which handles this automatically.
###
[​](https://gofastmcp.com/servers/auth/remote-oauth#custom-endpoints)
Custom Endpoints
...
##
[​](https://gofastmcp.com/servers/auth/remote-oauth#workos-authkit-integration)
...
##
[​](https://gofastmcp.com/servers/auth/remote-oauth#client-redirect-uri-security)
...
##
[​](https://gofastmcp.com/servers/auth/remote-oauth#implementation-considerations)
...
[ Token Verification Previous ](https://gofastmcp.com/servers/auth/token-verification)[ OAuth Proxy Next ](https://gofastmcp.com/servers/auth/oauth-proxy)
Ctrl+I
