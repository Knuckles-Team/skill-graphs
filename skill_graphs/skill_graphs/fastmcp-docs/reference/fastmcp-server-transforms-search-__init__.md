[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-search-__init__#content-area)
...
On this page
  * [fastmcp.server.transforms.search](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-search-__init__#fastmcp-server-transforms-search)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-search-__init__#fastmcp-server-transforms-search)
...
[ resources_as_tools Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-resources_as_tools)[ base Next ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-search-base)
Ctrl+I
