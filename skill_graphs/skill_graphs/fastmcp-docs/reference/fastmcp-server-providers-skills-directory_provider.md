[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-directory_provider#content-area)
...
On this page
  * [fastmcp.server.providers.skills.directory_provider](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-directory_provider#fastmcp-server-providers-skills-directory_provider)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-directory_provider#classes)
  * [SkillsDirectoryProvider ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-directory_provider#skillsdirectoryprovider)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-directory_provider#fastmcp-server-providers-skills-directory_provider)
`fastmcp.server.providers.skills.directory_provider`
Directory scanning provider for discovering multiple skills.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-directory_provider#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-directory_provider#skillsdirectoryprovider)
...
[ claude_provider Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-claude_provider)[ skill_provider Next ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-skill_provider)
Ctrl+I
