[Skip to main content](https://gofastmcp.com/v2/servers/auth/token-verification#content-area)
...
On this page
  * [Understanding Token Verification](https://gofastmcp.com/v2/servers/auth/token-verification#understanding-token-verification)
  * [The Token Verification Model](https://gofastmcp.com/v2/servers/auth/token-verification#the-token-verification-model)
  * [Token Security Considerations](https://gofastmcp.com/v2/servers/auth/token-verification#token-security-considerations)
  * [TokenVerifier Class](https://gofastmcp.com/v2/servers/auth/token-verification#tokenverifier-class)
  * [JWT Token Verification](https://gofastmcp.com/v2/servers/auth/token-verification#jwt-token-verification)
  * [JWKS Endpoint Integration](https://gofastmcp.com/v2/servers/auth/token-verification#jwks-endpoint-integration)
  * [Symmetric Key Verification (HMAC)](https://gofastmcp.com/v2/servers/auth/token-verification#symmetric-key-verification-hmac)
  * [Static Public Key Verification](https://gofastmcp.com/v2/servers/auth/token-verification#static-public-key-verification)
  * [Opaque Token Verification](https://gofastmcp.com/v2/servers/auth/token-verification#opaque-token-verification)
  * [Understanding Opaque Tokens](https://gofastmcp.com/v2/servers/auth/token-verification#understanding-opaque-tokens)
  * [Token Introspection Protocol](https://gofastmcp.com/v2/servers/auth/token-verification#token-introspection-protocol)
  * [Development and Testing](https://gofastmcp.com/v2/servers/auth/token-verification#development-and-testing)
  * [Static Token Verification](https://gofastmcp.com/v2/servers/auth/token-verification#static-token-verification)
  * [Debug/Custom Token Verification](https://gofastmcp.com/v2/servers/auth/token-verification#debug%2Fcustom-token-verification)
  * [Test Token Generation](https://gofastmcp.com/v2/servers/auth/token-verification#test-token-generation)
  * [Environment Configuration](https://gofastmcp.com/v2/servers/auth/token-verification#environment-configuration)
...
##
[​](https://gofastmcp.com/v2/servers/auth/token-verification#understanding-token-verification)
...
###
[​](https://gofastmcp.com/v2/servers/auth/token-verification#the-token-verification-model)
...
###
[​](https://gofastmcp.com/v2/servers/auth/token-verification#token-security-considerations)
...
##
[​](https://gofastmcp.com/v2/servers/auth/token-verification#tokenverifier-class)
TokenVerifier Class
...
##
[​](https://gofastmcp.com/v2/servers/auth/token-verification#jwt-token-verification)
...
###
[​](https://gofastmcp.com/v2/servers/auth/token-verification#jwks-endpoint-integration)
...
###
[​](https://gofastmcp.com/v2/servers/auth/token-verification#symmetric-key-verification-hmac)
...
###
[​](https://gofastmcp.com/v2/servers/auth/token-verification#static-public-key-verification)
...
##
[​](https://gofastmcp.com/v2/servers/auth/token-verification#opaque-token-verification)
...
###
[​](https://gofastmcp.com/v2/servers/auth/token-verification#understanding-opaque-tokens)
...
###
[​](https://gofastmcp.com/v2/servers/auth/token-verification#token-introspection-protocol)
...
##
[​](https://gofastmcp.com/v2/servers/auth/token-verification#development-and-testing)
...
###
[​](https://gofastmcp.com/v2/servers/auth/token-verification#static-token-verification)
...
###
[​](https://gofastmcp.com/v2/servers/auth/token-verification#debug/custom-token-verification)
...
###
[​](https://gofastmcp.com/v2/servers/auth/token-verification#test-token-generation)
...
##
[​](https://gofastmcp.com/v2/servers/auth/token-verification#environment-configuration)
Environment Configuration
`2.12.1` FastMCP supports both programmatic and environment-based configuration for token verification, enabling flexible deployment across different environments. Environment-based configuration separates authentication settings from application code, following twelve-factor app principles and simplifying deployment pipelines.
Copy
```
...
[ Authentication Previous ](https://gofastmcp.com/v2/servers/auth/authentication)[ Remote OAuth Next ](https://gofastmcp.com/v2/servers/auth/remote-oauth)
Ctrl+I
