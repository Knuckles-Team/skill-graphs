[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-client-telemetry#content-area)
...
On this page
  * [fastmcp.client.telemetry](https://gofastmcp.com/python-sdk/fastmcp-client-telemetry#fastmcp-client-telemetry)
  * [Functions](https://gofastmcp.com/python-sdk/fastmcp-client-telemetry#functions)
  * [client_span ](https://gofastmcp.com/python-sdk/fastmcp-client-telemetry#client_span)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-client-telemetry#fastmcp-client-telemetry)
`fastmcp.client.telemetry`
Client-side telemetry helpers.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-client-telemetry#functions)
Functions
###
[​](https://gofastmcp.com/python-sdk/fastmcp-client-telemetry#client_span)
`client_span`
Copy
```
...
[ tasks Previous ](https://gofastmcp.com/python-sdk/fastmcp-client-tasks)[ __init__ Next ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-__init__)
Ctrl+I
