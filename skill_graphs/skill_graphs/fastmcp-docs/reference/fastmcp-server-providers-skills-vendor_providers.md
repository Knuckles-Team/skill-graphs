[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-vendor_providers#content-area)
...
##### fastmcp.server
  ...
  * providers
    ...
    * skills
      * [__init__](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-__init__)
      * [claude_provider](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-claude_provider)
      * [directory_provider](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-directory_provider)
      * [skill_provider](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-skill_provider)
      * [vendor_providers](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-vendor_providers)
...
On this page
  * [fastmcp.server.providers.skills.vendor_providers](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-vendor_providers#fastmcp-server-providers-skills-vendor_providers)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-vendor_providers#classes)
  * [CursorSkillsProvider ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-vendor_providers#cursorskillsprovider)
  * [VSCodeSkillsProvider ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-vendor_providers#vscodeskillsprovider)
  * [CodexSkillsProvider ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-vendor_providers#codexskillsprovider)
  * [GeminiSkillsProvider ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-vendor_providers#geminiskillsprovider)
  * [GooseSkillsProvider ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-vendor_providers#gooseskillsprovider)
  * [CopilotSkillsProvider ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-vendor_providers#copilotskillsprovider)
  * [OpenCodeSkillsProvider ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-vendor_providers#opencodeskillsprovider)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-vendor_providers#fastmcp-server-providers-skills-vendor_providers)
`fastmcp.server.providers.skills.vendor_providers`
Vendor-specific skills providers for various AI coding platforms.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-vendor_providers#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-vendor_providers#cursorskillsprovider)
`CursorSkillsProvider`
Cursor skills from ~/.cursor/skills/.
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-vendor_providers#vscodeskillsprovider)
`VSCodeSkillsProvider`
VS Code skills from ~/.copilot/skills/.
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-vendor_providers#codexskillsprovider)
`CodexSkillsProvider`
Codex skills from /etc/codex/skills/ and ~/.codex/skills/. Scans both system-level and user-level directories. System skills take precedence if duplicates exist.
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-vendor_providers#geminiskillsprovider)
`GeminiSkillsProvider`
Gemini skills from ~/.gemini/skills/.
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-vendor_providers#gooseskillsprovider)
`GooseSkillsProvider`
Goose skills from ~/.config/agents/skills/.
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-vendor_providers#copilotskillsprovider)
`CopilotSkillsProvider`
GitHub Copilot skills from ~/.copilot/skills/.
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-vendor_providers#opencodeskillsprovider)
`OpenCodeSkillsProvider`
OpenCode skills from ~/.config/opencode/skills/.
[ skill_provider Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-skill_provider)[ wrapped_provider Next ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-wrapped_provider)
Ctrl+I
