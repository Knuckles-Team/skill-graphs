[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#content-area)
...
On this page
  * [fastmcp.tools.function_tool](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#fastmcp-tools-function_tool)
  * [Functions](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#functions)
  * [tool ](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#tool)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#classes)
  * [DecoratedTool ](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#decoratedtool)
  * [ToolMeta ](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#toolmeta)
  * [FunctionTool ](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#functiontool)
  * [to_mcp_tool ](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#to_mcp_tool)
  * [from_function ](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#from_function)
  * [run ](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#run)
  * [register_with_docket ](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#register_with_docket)
  * [add_to_docket ](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#add_to_docket)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#fastmcp-tools-function_tool)
`fastmcp.tools.function_tool`
Standalone @tool decorator for FastMCP.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#functions)
Functions
###
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#tool)
`tool`
Copy
```
...
##
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#decoratedtool)
`DecoratedTool`
Protocol for functions decorated with @tool.
###
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#toolmeta)
`ToolMeta`
Metadata attached to functions by the @tool decorator.
###
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#functiontool)
`FunctionTool`
**Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#to_mcp_tool)
`to_mcp_tool`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#from_function)
`from_function`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#run)
`run`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#register_with_docket)
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-tools-function_tool#add_to_docket)
`add_to_docket`
Copy
```
...
[ function_parsing Previous ](https://gofastmcp.com/python-sdk/fastmcp-tools-function_parsing)[ tool Next ](https://gofastmcp.com/python-sdk/fastmcp-tools-tool)
Ctrl+I
