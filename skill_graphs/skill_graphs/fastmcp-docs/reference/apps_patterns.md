[Skip to main content](https://gofastmcp.com/apps/patterns#content-area)
...
On this page
  * [Charts](https://gofastmcp.com/apps/patterns#charts)
  * [Bar Chart](https://gofastmcp.com/apps/patterns#bar-chart)
  * [Area Chart](https://gofastmcp.com/apps/patterns#area-chart)
  * [Pie and Donut Charts](https://gofastmcp.com/apps/patterns#pie-and-donut-charts)
  * [Data Tables](https://gofastmcp.com/apps/patterns#data-tables)
  * [Forms](https://gofastmcp.com/apps/patterns#forms)
  * [Pydantic Model Forms](https://gofastmcp.com/apps/patterns#pydantic-model-forms)
  * [Status Displays](https://gofastmcp.com/apps/patterns#status-displays)
  * [Conditional Content](https://gofastmcp.com/apps/patterns#conditional-content)
  * [Tabs](https://gofastmcp.com/apps/patterns#tabs)
  * [Accordion](https://gofastmcp.com/apps/patterns#accordion)
  * [Next Steps](https://gofastmcp.com/apps/patterns#next-steps)
...
Copy page
`3.1.0`
`prefab-ui` to a specific version in your dependencies.
...
##
[​](https://gofastmcp.com/apps/patterns#charts)
Charts
Prefab includes
###
[​](https://gofastmcp.com/apps/patterns#bar-chart)
Bar Chart
Copy
```
...
###
[​](https://gofastmcp.com/apps/patterns#area-chart)
Area Chart
...
###
[​](https://gofastmcp.com/apps/patterns#pie-and-donut-charts)
...
##
[​](https://gofastmcp.com/apps/patterns#data-tables)
Data Tables
Copy
```
...
##
[​](https://gofastmcp.com/apps/patterns#forms)
Forms
A form collects input, but it needs somewhere to send that input. The
Copy
```
...
###
[​](https://gofastmcp.com/apps/patterns#pydantic-model-forms)
...
##
[​](https://gofastmcp.com/apps/patterns#status-displays)
Status Displays
Cards, badges, progress bars, and grids combine naturally for dashboards. See the
Copy
```
from prefab_ui.components import (
...
##
[​](https://gofastmcp.com/apps/patterns#conditional-content)
Conditional Content
Copy
```
...
##
[​](https://gofastmcp.com/apps/patterns#tabs)
Tabs
Copy
```
from prefab_ui.components import (
...
##
[​](https://gofastmcp.com/apps/patterns#accordion)
Accordion
...
##
[​](https://gofastmcp.com/apps/patterns#next-steps)
Next Steps
  * **[Custom HTML Apps](https://gofastmcp.com/apps/low-level)** — When you need your own HTML, CSS, and JavaScript


[ Prefab Apps Previous ](https://gofastmcp.com/apps/prefab)[ Custom HTML Apps Next ](https://gofastmcp.com/apps/low-level)
Ctrl+I
