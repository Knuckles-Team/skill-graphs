[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-cli-install-mcp_json#content-area)
...
On this page
  * [fastmcp.cli.install.mcp_json](https://gofastmcp.com/python-sdk/fastmcp-cli-install-mcp_json#fastmcp-cli-install-mcp_json)
  * [Functions](https://gofastmcp.com/python-sdk/fastmcp-cli-install-mcp_json#functions)
  * [install_mcp_json ](https://gofastmcp.com/python-sdk/fastmcp-cli-install-mcp_json#install_mcp_json)
  * [mcp_json_command ](https://gofastmcp.com/python-sdk/fastmcp-cli-install-mcp_json#mcp_json_command)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-mcp_json#fastmcp-cli-install-mcp_json)
`fastmcp.cli.install.mcp_json`
MCP configuration JSON generation for FastMCP install using Cyclopts.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-mcp_json#functions)
Functions
###
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-mcp_json#install_mcp_json)
`install_mcp_json`
Copy
```
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-mcp_json#mcp_json_command)
`mcp_json_command`
Copy
```
...
[ goose Previous ](https://gofastmcp.com/python-sdk/fastmcp-cli-install-goose)[ shared Next ](https://gofastmcp.com/python-sdk/fastmcp-cli-install-shared)
Ctrl+I
