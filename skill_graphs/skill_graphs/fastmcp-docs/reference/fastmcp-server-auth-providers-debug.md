[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-debug#content-area)
...
On this page
  * [fastmcp.server.auth.providers.debug](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-debug#fastmcp-server-auth-providers-debug)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-debug#classes)
  * [DebugTokenVerifier ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-debug#debugtokenverifier)
  * [verify_token ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-debug#verify_token)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-debug#fastmcp-server-auth-providers-debug)
`fastmcp.server.auth.providers.debug`
Debug token verifier for testing and special cases. This module provides a flexible token verifier that delegates validation to a custom callable. Useful for testing, development, or scenarios where standard verification isn’t possible (like opaque tokens without introspection). Example:
Copy
```
...
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-debug#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-debug#debugtokenverifier)
`DebugTokenVerifier`
Token verifier with custom validation logic. This verifier delegates token validation to a user-provided callable. By default, it accepts all non-empty tokens (useful for testing). Use cases:
...
WARNING: This bypasses standard security checks. Only use in controlled environments or when you understand the security implications. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-debug#verify_token)
`verify_token`
Copy
```
...
Verify token using custom validation logic. **Args:**
...
[ azure Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-azure)[ descope Next ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-descope)
Ctrl+I
