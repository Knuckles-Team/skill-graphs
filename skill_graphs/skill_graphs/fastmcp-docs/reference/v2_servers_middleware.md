[Skip to main content](https://gofastmcp.com/v2/servers/middleware#content-area)
...
On this page
  * [What is MCP Middleware?](https://gofastmcp.com/v2/servers/middleware#what-is-mcp-middleware)
  * [How Middleware Works](https://gofastmcp.com/v2/servers/middleware#how-middleware-works)
  * [Middleware Hooks](https://gofastmcp.com/v2/servers/middleware#middleware-hooks)
  * [Hook Hierarchy and Execution Order](https://gofastmcp.com/v2/servers/middleware#hook-hierarchy-and-execution-order)
  * [Available Hooks](https://gofastmcp.com/v2/servers/middleware#available-hooks)
  * [MCP Session Availability in Middleware](https://gofastmcp.com/v2/servers/middleware#mcp-session-availability-in-middleware)
  * [Component Access in Middleware](https://gofastmcp.com/v2/servers/middleware#component-access-in-middleware)
  * [Listing Operations vs Execution Operations](https://gofastmcp.com/v2/servers/middleware#listing-operations-vs-execution-operations)
  * [Accessing Component Metadata During Execution](https://gofastmcp.com/v2/servers/middleware#accessing-component-metadata-during-execution)
  * [Working with Listing Results](https://gofastmcp.com/v2/servers/middleware#working-with-listing-results)
  * [Tool Call Denial](https://gofastmcp.com/v2/servers/middleware#tool-call-denial)
  * [Tool Call Modification](https://gofastmcp.com/v2/servers/middleware#tool-call-modification)
  * [Anatomy of a Hook](https://gofastmcp.com/v2/servers/middleware#anatomy-of-a-hook)
  * [Hook Parameters](https://gofastmcp.com/v2/servers/middleware#hook-parameters)
  * [Control Flow](https://gofastmcp.com/v2/servers/middleware#control-flow)
  * [State Management](https://gofastmcp.com/v2/servers/middleware#state-management)
  * [Creating Middleware](https://gofastmcp.com/v2/servers/middleware#creating-middleware)
  * [Adding Middleware to Your Server](https://gofastmcp.com/v2/servers/middleware#adding-middleware-to-your-server)
  * [Single Middleware](https://gofastmcp.com/v2/servers/middleware#single-middleware)
  * [Multiple Middleware](https://gofastmcp.com/v2/servers/middleware#multiple-middleware)
  * [Server Composition and Middleware](https://gofastmcp.com/v2/servers/middleware#server-composition-and-middleware)
  * [Built-in Middleware Examples](https://gofastmcp.com/v2/servers/middleware#built-in-middleware-examples)
  * [Timing Middleware](https://gofastmcp.com/v2/servers/middleware#timing-middleware)
  * [Tool Injection Middleware](https://gofastmcp.com/v2/servers/middleware#tool-injection-middleware)
  * [Prompt Tool Middleware](https://gofastmcp.com/v2/servers/middleware#prompt-tool-middleware)
  * [Resource Tool Middleware](https://gofastmcp.com/v2/servers/middleware#resource-tool-middleware)
  * [Caching Middleware](https://gofastmcp.com/v2/servers/middleware#caching-middleware)
  * [Storage Backends](https://gofastmcp.com/v2/servers/middleware#storage-backends)
  * [Cache Statistics](https://gofastmcp.com/v2/servers/middleware#cache-statistics)
  * [Logging Middleware](https://gofastmcp.com/v2/servers/middleware#logging-middleware)
  * [Rate Limiting Middleware](https://gofastmcp.com/v2/servers/middleware#rate-limiting-middleware)
  * [Error Handling Middleware](https://gofastmcp.com/v2/servers/middleware#error-handling-middleware)
  * [Combining Middleware](https://gofastmcp.com/v2/servers/middleware#combining-middleware)
  * [Custom Middleware Example](https://gofastmcp.com/v2/servers/middleware#custom-middleware-example)
...
##
[​](https://gofastmcp.com/v2/servers/middleware#what-is-mcp-middleware)
...
##
[​](https://gofastmcp.com/v2/servers/middleware#how-middleware-works)
...
##
[​](https://gofastmcp.com/v2/servers/middleware#middleware-hooks)
Middleware Hooks
...
###
[​](https://gofastmcp.com/v2/servers/middleware#hook-hierarchy-and-execution-order)
...
###
[​](https://gofastmcp.com/v2/servers/middleware#available-hooks)
Available Hooks
`2.9.0`
...
###
[​](https://gofastmcp.com/v2/servers/middleware#mcp-session-availability-in-middleware)
MCP Session Availability in Middleware
`2.13.1` The MCP session and request context are not available during certain phases like initialization. When middleware runs during these phases, `context.fastmcp_context.request_context` returns `None` rather than the full MCP request context. This typically occurs when:
...
For HTTP request data (headers, client IP, etc.) when using HTTP transports, use `get_http_request()` or `get_http_headers()` from `fastmcp.server.dependencies`, which work regardless of MCP session availability. See [HTTP Requests](https://gofastmcp.com/v2/servers/context#http-requests) for details.
##
[​](https://gofastmcp.com/v2/servers/middleware#component-access-in-middleware)
...
###
[​](https://gofastmcp.com/v2/servers/middleware#listing-operations-vs-execution-operations)
...
###
[​](https://gofastmcp.com/v2/servers/middleware#accessing-component-metadata-during-execution)
...
###
[​](https://gofastmcp.com/v2/servers/middleware#working-with-listing-results)
...
###
[​](https://gofastmcp.com/v2/servers/middleware#tool-call-denial)
Tool Call Denial
...
###
[​](https://gofastmcp.com/v2/servers/middleware#tool-call-modification)
...
For more complex tool rewriting scenarios, consider using [Tool Transformation](https://gofastmcp.com/v2/patterns/tool-transformation) patterns which provide a more structured approach to creating modified tool variants.
###
[​](https://gofastmcp.com/v2/servers/middleware#anatomy-of-a-hook)
Anatomy of a Hook
...
###
[​](https://gofastmcp.com/v2/servers/middleware#hook-parameters)
Hook Parameters
...
###
[​](https://gofastmcp.com/v2/servers/middleware#control-flow)
Control Flow
...
####
[​](https://gofastmcp.com/v2/servers/middleware#state-management)
State Management
`2.11.0` In addition to modifying the request and response, you can also store state data that your tools can (optionally) access later. To do so, use the FastMCP Context to either `set_state` or `get_state` as appropriate. For more information, see the [Context State Management](https://gofastmcp.com/v2/servers/context#state-management) docs.
##
[​](https://gofastmcp.com/v2/servers/middleware#creating-middleware)
Creating Middleware
...
##
[​](https://gofastmcp.com/v2/servers/middleware#adding-middleware-to-your-server)
Adding Middleware to Your Server
###
[​](https://gofastmcp.com/v2/servers/middleware#single-middleware)
Single Middleware
...
###
[​](https://gofastmcp.com/v2/servers/middleware#multiple-middleware)
Multiple Middleware
...
##
[​](https://gofastmcp.com/v2/servers/middleware#server-composition-and-middleware)
Server Composition and Middleware
When using [Server Composition](https://gofastmcp.com/v2/servers/composition) with `mount` or `import_server`, middleware behavior follows these rules:
...
##
[​](https://gofastmcp.com/v2/servers/middleware#built-in-middleware-examples)
...
###
[​](https://gofastmcp.com/v2/servers/middleware#timing-middleware)
Timing Middleware
...
###
[​](https://gofastmcp.com/v2/servers/middleware#tool-injection-middleware)
...
###
[​](https://gofastmcp.com/v2/servers/middleware#prompt-tool-middleware)
...
###
[​](https://gofastmcp.com/v2/servers/middleware#resource-tool-middleware)
...
###
[​](https://gofastmcp.com/v2/servers/middleware#caching-middleware)
Caching Middleware
...
####
[​](https://gofastmcp.com/v2/servers/middleware#storage-backends)
Storage Backends
By default, caching uses in-memory storage, which is fast but doesn’t persist across restarts. For production or persistent caching across server restarts, configure a different storage backend. See [Storage Backends](https://gofastmcp.com/v2/servers/storage-backends) for complete options including disk, Redis, DynamoDB, and custom implementations. Disk-based caching example:
Copy
```
from fastmcp.server.middleware.caching import ResponseCachingMiddleware
...
####
[​](https://gofastmcp.com/v2/servers/middleware#cache-statistics)
Cache Statistics
...
###
[​](https://gofastmcp.com/v2/servers/middleware#logging-middleware)
Logging Middleware
...
###
[​](https://gofastmcp.com/v2/servers/middleware#rate-limiting-middleware)
...
###
[​](https://gofastmcp.com/v2/servers/middleware#error-handling-middleware)
...
###
[​](https://gofastmcp.com/v2/servers/middleware#combining-middleware)
...
###
[​](https://gofastmcp.com/v2/servers/middleware#custom-middleware-example)
...
[ Client Logging Previous ](https://gofastmcp.com/v2/servers/logging)[ Progress Reporting Next ](https://gofastmcp.com/v2/servers/progress)
Ctrl+I
