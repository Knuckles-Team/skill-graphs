[Skip to content](https://vuejs.org/guide/extras/composition-api-faq.html#VPContent)
...
[简体中文 ](https://cn.vuejs.org/guide/extras/composition-api-faq)
[日本語 ](https://ja.vuejs.org/guide/extras/composition-api-faq)
[Українська ](https://ua.vuejs.org/guide/extras/composition-api-faq)
[Français ](https://fr.vuejs.org/guide/extras/composition-api-faq)
[한국어 ](https://ko.vuejs.org/guide/extras/composition-api-faq)
[Português ](https://pt.vuejs.org/guide/extras/composition-api-faq)
[বাংলা ](https://bn.vuejs.org/guide/extras/composition-api-faq)
[Italiano ](https://it.vuejs.org/guide/extras/composition-api-faq)
[فارسی ](https://fa.vuejs.org/guide/extras/composition-api-faq)
[Русский ](https://ru.vuejs.org/guide/extras/composition-api-faq)
[Čeština ](https://cs.vuejs.org/guide/extras/composition-api-faq)
[繁體中文 ](https://zh-hk.vuejs.org/guide/extras/composition-api-faq)
[Polski ](https://pl.vuejs.org/guide/extras/composition-api-faq)
Help Us Translate!
Appearance
Menu
On this page
...
Table of Contents for current page
  ...
  * [Why Composition API?](https://vuejs.org/guide/extras/composition-api-faq.html#why-composition-api)
    * [Better Logic Reuse](https://vuejs.org/guide/extras/composition-api-faq.html#better-logic-reuse)
    * [More Flexible Code Organization](https://vuejs.org/guide/extras/composition-api-faq.html#more-flexible-code-organization)
    * [Better Type Inference](https://vuejs.org/guide/extras/composition-api-faq.html#better-type-inference)
    * [Smaller Production Bundle and Less Overhead](https://vuejs.org/guide/extras/composition-api-faq.html#smaller-production-bundle-and-less-overhead)
  * [Relationship with Options API](https://vuejs.org/guide/extras/composition-api-faq.html#relationship-with-options-api)
    * [Trade-offs](https://vuejs.org/guide/extras/composition-api-faq.html#trade-offs)
    * [Does Composition API cover all use cases?](https://vuejs.org/guide/extras/composition-api-faq.html#does-composition-api-cover-all-use-cases)
    * [Can I use both APIs in the same component?](https://vuejs.org/guide/extras/composition-api-faq.html#can-i-use-both-apis-in-the-same-component)
    * [Will Options API be deprecated?](https://vuejs.org/guide/extras/composition-api-faq.html#will-options-api-be-deprecated)
  * [Relationship with Class API](https://vuejs.org/guide/extras/composition-api-faq.html#relationship-with-class-api)
  * [Comparison with React Hooks](https://vuejs.org/guide/extras/composition-api-faq.html#comparison-with-react-hooks)
...
# Composition API FAQ [​](https://vuejs.org/guide/extras/composition-api-faq.html#composition-api-faq)
TIP
...
Composition API's logic reuse capability has given rise to impressive community projects such as [immutable data](https://vuejs.org/guide/extras/reactivity-in-depth#immutable-data), [state machines](https://vuejs.org/guide/extras/reactivity-in-depth#state-machines), and [RxJS](https://vuejs.org/guide/extras/reactivity-in-depth#rxjs).
### More Flexible Code Organization [​](https://vuejs.org/guide/extras/composition-api-faq.html#more-flexible-code-organization)
...
> Note: some of the above issues that are related to memoization can be resolved by the upcoming
...
[Ways of Using Vue](https://vuejs.org/guide/extras/ways-of-using-vue)[Next Reactivity in Depth](https://vuejs.org/guide/extras/reactivity-in-depth)
