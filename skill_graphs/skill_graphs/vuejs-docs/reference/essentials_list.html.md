[Skip to content](https://vuejs.org/guide/essentials/list.html#VPContent)
...
[简体中文 ](https://cn.vuejs.org/guide/essentials/list)
[日本語 ](https://ja.vuejs.org/guide/essentials/list)
[Українська ](https://ua.vuejs.org/guide/essentials/list)
[Français ](https://fr.vuejs.org/guide/essentials/list)
[한국어 ](https://ko.vuejs.org/guide/essentials/list)
[Português ](https://pt.vuejs.org/guide/essentials/list)
[বাংলা ](https://bn.vuejs.org/guide/essentials/list)
[Italiano ](https://it.vuejs.org/guide/essentials/list)
[فارسی ](https://fa.vuejs.org/guide/essentials/list)
[Русский ](https://ru.vuejs.org/guide/essentials/list)
[Čeština ](https://cs.vuejs.org/guide/essentials/list)
[繁體中文 ](https://zh-hk.vuejs.org/guide/essentials/list)
[Polski ](https://pl.vuejs.org/guide/essentials/list)
Help Us Translate!
Appearance
Menu
On this page
...
Table of Contents for current page
  ...
  * [v-for with a Range](https://vuejs.org/guide/essentials/list.html#v-for-with-a-range)
  * [v-for on <template>](https://vuejs.org/guide/essentials/list.html#v-for-on-template)
  ...
  * [Array Change Detection](https://vuejs.org/guide/essentials/list.html#array-change-detection)
  * [Displaying Filtered/Sorted Results](https://vuejs.org/guide/essentials/list.html#displaying-filtered-sorted-results)
...
## Array Change Detection [​](https://vuejs.org/guide/essentials/list.html#array-change-detection)
### Mutation Methods [​](https://vuejs.org/guide/essentials/list.html#mutation-methods)
...
### Replacing an Array [​](https://vuejs.org/guide/essentials/list.html#replacing-an-array)
...
[Conditional Rendering](https://vuejs.org/guide/essentials/conditional)[Next Event Handling](https://vuejs.org/guide/essentials/event-handling)
