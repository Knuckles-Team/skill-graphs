[Skip to content](https://vuejs.org/guide/essentials/template-syntax.html#VPContent)
...
[简体中文 ](https://cn.vuejs.org/guide/essentials/template-syntax)
[日本語 ](https://ja.vuejs.org/guide/essentials/template-syntax)
[Українська ](https://ua.vuejs.org/guide/essentials/template-syntax)
[Français ](https://fr.vuejs.org/guide/essentials/template-syntax)
[한국어 ](https://ko.vuejs.org/guide/essentials/template-syntax)
[Português ](https://pt.vuejs.org/guide/essentials/template-syntax)
[বাংলা ](https://bn.vuejs.org/guide/essentials/template-syntax)
[Italiano ](https://it.vuejs.org/guide/essentials/template-syntax)
[فارسی ](https://fa.vuejs.org/guide/essentials/template-syntax)
[Русский ](https://ru.vuejs.org/guide/essentials/template-syntax)
[Čeština ](https://cs.vuejs.org/guide/essentials/template-syntax)
[繁體中文 ](https://zh-hk.vuejs.org/guide/essentials/template-syntax)
[Polski ](https://pl.vuejs.org/guide/essentials/template-syntax)
Help Us Translate!
Appearance
Menu
On this page
...
Table of Contents for current page
  ...
  * [Using JavaScript Expressions](https://vuejs.org/guide/essentials/template-syntax.html#using-javascript-expressions)
...
# Template Syntax [​](https://vuejs.org/guide/essentials/template-syntax.html#template-syntax)
...
Security Warning
Dynamically rendering arbitrary HTML on your website can be very dangerous because it can easily lead to `v-html` on trusted content and **never** on user-provided content.
## Attribute Bindings [​](https://vuejs.org/guide/essentials/template-syntax.html#attribute-bindings)
...
### Boolean Attributes [​](https://vuejs.org/guide/essentials/template-syntax.html#boolean-attributes)
`v-bind` works a bit differently in this case:
template```
<button :disabled="isButtonDisabled">Button</button>
```

The `disabled` attribute will be included if `isButtonDisabled` has a `<button disabled="">`. For other
...
### Expressions Only [​](https://vuejs.org/guide/essentials/template-syntax.html#expressions-only)
...
Template expressions are sandboxed and only have access to a `Math` and `Date`.
...
### Arguments [​](https://vuejs.org/guide/essentials/template-syntax.html#arguments)
...
### Dynamic Arguments [​](https://vuejs.org/guide/essentials/template-syntax.html#dynamic-arguments)
...
#### Dynamic Argument Value Constraints [​](https://vuejs.org/guide/essentials/template-syntax.html#dynamic-argument-value-constraints)
Dynamic arguments are expected to evaluate to a string, with the exception of `null`. The special value `null` can be used to explicitly remove the binding. Any other non-string value will trigger a warning.
#### Dynamic Argument Syntax Constraints [​](https://vuejs.org/guide/essentials/template-syntax.html#dynamic-argument-syntax-constraints)
...
### Modifiers [​](https://vuejs.org/guide/essentials/template-syntax.html#modifiers)
...
[Creating an Application](https://vuejs.org/guide/essentials/application)[Next Reactivity Fundamentals](https://vuejs.org/guide/essentials/reactivity-fundamentals)
