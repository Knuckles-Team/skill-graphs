...
[简体中文 ](https://cn.vuejs.org/guide/reusability/custom-directives)
[日本語 ](https://ja.vuejs.org/guide/reusability/custom-directives)
[Українська ](https://ua.vuejs.org/guide/reusability/custom-directives)
[Français ](https://fr.vuejs.org/guide/reusability/custom-directives)
[한국어 ](https://ko.vuejs.org/guide/reusability/custom-directives)
[Português ](https://pt.vuejs.org/guide/reusability/custom-directives)
[বাংলা ](https://bn.vuejs.org/guide/reusability/custom-directives)
[Italiano ](https://it.vuejs.org/guide/reusability/custom-directives)
[فارسی ](https://fa.vuejs.org/guide/reusability/custom-directives)
[Русский ](https://ru.vuejs.org/guide/reusability/custom-directives)
[Čeština ](https://cs.vuejs.org/guide/reusability/custom-directives)
[繁體中文 ](https://zh-hk.vuejs.org/guide/reusability/custom-directives)
[Polski ](https://pl.vuejs.org/guide/reusability/custom-directives)
Help Us Translate!
Appearance
Menu
On this page
...
Note
Apart from `el`, you should treat these arguments as read-only and never modify them. If you need to share information across hooks, it is recommended to do so through element's
## Function Shorthand [​](https://vuejs.org/guide/reusability/custom-directives.html#function-shorthand)
...
[Composables](https://vuejs.org/guide/reusability/composables)[Next Plugins](https://vuejs.org/guide/reusability/plugins)
