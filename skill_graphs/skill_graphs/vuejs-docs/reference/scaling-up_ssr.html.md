[Skip to content](https://vuejs.org/guide/scaling-up/ssr.html#VPContent)
...
[简体中文 ](https://cn.vuejs.org/guide/scaling-up/ssr)
[日本語 ](https://ja.vuejs.org/guide/scaling-up/ssr)
[Українська ](https://ua.vuejs.org/guide/scaling-up/ssr)
[Français ](https://fr.vuejs.org/guide/scaling-up/ssr)
[한국어 ](https://ko.vuejs.org/guide/scaling-up/ssr)
[Português ](https://pt.vuejs.org/guide/scaling-up/ssr)
[বাংলা ](https://bn.vuejs.org/guide/scaling-up/ssr)
[Italiano ](https://it.vuejs.org/guide/scaling-up/ssr)
[فارسی ](https://fa.vuejs.org/guide/scaling-up/ssr)
[Русский ](https://ru.vuejs.org/guide/scaling-up/ssr)
[Čeština ](https://cs.vuejs.org/guide/scaling-up/ssr)
[繁體中文 ](https://zh-hk.vuejs.org/guide/scaling-up/ssr)
[Polski ](https://pl.vuejs.org/guide/scaling-up/ssr)
Help Us Translate!
Appearance
Menu
On this page
...
Table of Contents for current page
  * [Overview](https://vuejs.org/guide/scaling-up/ssr.html#overview)
    * [What is SSR?](https://vuejs.org/guide/scaling-up/ssr.html#what-is-ssr)
    * [Why SSR?](https://vuejs.org/guide/scaling-up/ssr.html#why-ssr)
    * [SSR vs. SSG](https://vuejs.org/guide/scaling-up/ssr.html#ssr-vs-ssg)
  * [Basic Tutorial](https://vuejs.org/guide/scaling-up/ssr.html#basic-tutorial)
    * [Rendering an App](https://vuejs.org/guide/scaling-up/ssr.html#rendering-an-app)
    * [Client Hydration](https://vuejs.org/guide/scaling-up/ssr.html#client-hydration)
    * [Code Structure](https://vuejs.org/guide/scaling-up/ssr.html#code-structure)
  * [Higher Level Solutions](https://vuejs.org/guide/scaling-up/ssr.html#higher-level-solutions)
    * [Nuxt](https://vuejs.org/guide/scaling-up/ssr.html#nuxt)
    * [Quasar](https://vuejs.org/guide/scaling-up/ssr.html#quasar)
    * [Vite SSR](https://vuejs.org/guide/scaling-up/ssr.html#vite-ssr)
  * [Writing SSR-friendly Code](https://vuejs.org/guide/scaling-up/ssr.html#writing-ssr-friendly-code)
    * [Reactivity on the Server](https://vuejs.org/guide/scaling-up/ssr.html#reactivity-on-the-server)
    * [Component Lifecycle Hooks](https://vuejs.org/guide/scaling-up/ssr.html#component-lifecycle-hooks)
    * [Access to Platform-Specific APIs](https://vuejs.org/guide/scaling-up/ssr.html#access-to-platform-specific-apis)
    ...
    * [Custom Directives](https://vuejs.org/guide/scaling-up/ssr.html#custom-directives)
    * [Teleports](https://vuejs.org/guide/scaling-up/ssr.html#teleports)
...
# Server-Side Rendering (SSR) [​](https://vuejs.org/guide/scaling-up/ssr.html#server-side-rendering-ssr)
## Overview [​](https://vuejs.org/guide/scaling-up/ssr.html#overview)
### What is SSR? [​](https://vuejs.org/guide/scaling-up/ssr.html#what-is-ssr)
...
[`renderToString()`](https://vuejs.org/api/ssr#rendertostring) takes a Vue app instance and returns a Promise that resolves to the rendered HTML of the app. It is also possible to stream rendering using the [SSR API Reference](https://vuejs.org/api/ssr) for full details.
We can then move the Vue SSR code into a server request handler, which wraps the application markup with the full page HTML. We will be using
...
This file and its dependencies are shared between the server and the client - we call them **universal code**. There are a number of things you need to pay attention to when writing universal code, as we will [discuss below](https://vuejs.org/guide/scaling-up/ssr.html#writing-ssr-friendly-code).
...
In addition, in order to load the client files in the browser, we also need to:
  ...
  3. Support usage like `import * from 'vue'` in the browser by adding an
...
For tasks that are shared between server and client but with different platform APIs, it's recommended to wrap the platform-specific implementations inside a universal API, or use libraries that do this for you. For example, you can use
...
If the DOM structure of the pre-rendered HTML does not match the expected output of the client-side app, there will be a hydration mismatch error. Hydration mismatch is most commonly introduced by the following causes:
  1. The template contains invalid HTML nesting structure, and the rendered HTML got "corrected" by the browser's native HTML parsing behavior. For example, a common gotcha is that
html```
<p><div>hi</div></p>
```
...
#### Suppressing Hydration Mismatches [​](https://vuejs.org/guide/scaling-up/ssr.html#suppressing-hydration-mismatches)
...
[Testing](https://vuejs.org/guide/scaling-up/testing)[Next Production Deployment](https://vuejs.org/guide/best-practices/production-deployment)
