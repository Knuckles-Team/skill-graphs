...
Press `Esc` to hide this help
  ...
  19. [**16.** Fearless Concurrency](https://doc.rust-lang.org/book/ch16-00-concurrency.html)
    ...
    4. [**16.4.** Extensible Concurrency with Send and Sync](https://doc.rust-lang.org/book/ch16-04-extensible-concurrency-sync-and-send.html)
      1. [Extensible Concurrency with `Send` and `Sync`](https://doc.rust-lang.org/book/ch16-04-extensible-concurrency-sync-and-send.html#extensible-concurrency-with-send-and-sync)
        1. [Transferring Ownership Between Threads](https://doc.rust-lang.org/book/ch16-04-extensible-concurrency-sync-and-send.html#transferring-ownership-between-threads)
        2. [Accessing from Multiple Threads](https://doc.rust-lang.org/book/ch16-04-extensible-concurrency-sync-and-send.html#accessing-from-multiple-threads)
        3. [Implementing `Send` and `Sync` Manually Is Unsafe](https://doc.rust-lang.org/book/ch16-04-extensible-concurrency-sync-and-send.html#implementing-send-and-sync-manually-is-unsafe)
      2. [Summary](https://doc.rust-lang.org/book/ch16-04-extensible-concurrency-sync-and-send.html#summary)
...
## [Extensible Concurrency with `Send` and `Sync`](https://doc.rust-lang.org/book/ch16-04-extensible-concurrency-sync-and-send.html#extensible-concurrency-with-send-and-sync)
...
### [Transferring Ownership Between Threads](https://doc.rust-lang.org/book/ch16-04-extensible-concurrency-sync-and-send.html#transferring-ownership-between-threads)
...
### [Accessing from Multiple Threads](https://doc.rust-lang.org/book/ch16-04-extensible-concurrency-sync-and-send.html#accessing-from-multiple-threads)
...
[ ](https://doc.rust-lang.org/book/ch16-03-shared-state.html "Previous chapter") [ ](https://doc.rust-lang.org/book/ch17-00-async-await.html "Next chapter")
[ ](https://doc.rust-lang.org/book/ch16-03-shared-state.html "Previous chapter") [ ](https://doc.rust-lang.org/book/ch17-00-async-await.html "Next chapter")
