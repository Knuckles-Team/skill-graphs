[Skip to main content](https://docs.falkordb.com/browser/ui/style-panel.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/browser/ui/style-panel.html#style-panel) Style Panel
The Style panel (“Style Settings”) customizes how nodes of a specific label appear in the graph.
##  [](https://docs.falkordb.com/browser/ui/style-panel.html#how-to-open) How to open
  1. Open **Graph Info**.
  2. Click the palette icon next to a node label.


##  [](https://docs.falkordb.com/browser/ui/style-panel.html#what-you-can-change) What you can change
  * **Color**
    * Preset colors
...
##  [](https://docs.falkordb.com/browser/ui/style-panel.html#save-vs-cancel) Save vs Cancel
  * **Save**
    * Closes the panel.
...
##  [](https://docs.falkordb.com/browser/ui/style-panel.html#tutorial-note) Tutorial note
