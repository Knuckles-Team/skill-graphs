[Skip to main content](https://docs.falkordb.com/browser/#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/browser/#falkordb-graph-visualization-tool-browser) FalkorDB Graph Visualization Tool (Browser)
...
* * *
##  [](https://docs.falkordb.com/browser/#ui-elements) UI elements
...
* * *
##  [](https://docs.falkordb.com/browser/#main-features) Main Features
###  [](https://docs.falkordb.com/browser/#graph-exploration-graph-page) Graph exploration (Graph page)
Feature | Description
---|---
...
###  [](https://docs.falkordb.com/browser/#querying) Querying
Feature | Description
---|---
...
###  [](https://docs.falkordb.com/browser/#query-history) Query history
Feature | Description
---|---
...
###  [](https://docs.falkordb.com/browser/#data-manipulation-nodesrelationships) Data manipulation (nodes/relationships)
Feature | Description
---|---
...
###  [](https://docs.falkordb.com/browser/#graph-management) Graph management
Feature | Description
---|---
...
###  [](https://docs.falkordb.com/browser/#graph-info-panel) Graph Info panel
Feature | Description
---|---
...
![falkordb-browser-eye-candy](https://github.com/user-attachments/assets/74375cd1-c704-40a9-9339-f1f885135a75)
* * *
###  [](https://docs.falkordb.com/browser/#api-documentation) API Documentation
Feature | Description
---|---
...
![browser-api-doc-eye-candy](https://github.com/user-attachments/assets/35b0ca72-83f7-4f16-927c-413bf5f65593)
###  [](https://docs.falkordb.com/browser/#authentication--access-control) Authentication & access control
Feature | Description
---|---
...
###  [](https://docs.falkordb.com/browser/#settings) Settings
Section | Description
---|---
...
* * *
##  [](https://docs.falkordb.com/browser/#common-workflows) Common Workflows
###  [](https://docs.falkordb.com/browser/#running-and-visualizing-queries) Running and visualizing queries
Step | Action
---|---
...
###  [](https://docs.falkordb.com/browser/#inspecting-and-editing-elements) Inspecting and editing elements
Step | Action
---|---
1 | Click a node or edge in the canvas.
2 | Use the Data panel to inspect properties and apply actions.
###  [](https://docs.falkordb.com/browser/#working-with-query-history) Working with query history
Step | Action
---|---
1 | Open Query History and filter by graph or search text.
2 | Select a query and review Metadata, Explain, or Profile.
###  [](https://docs.falkordb.com/browser/#exporting-graph-data) Exporting graph data
Step | Action
---|---
