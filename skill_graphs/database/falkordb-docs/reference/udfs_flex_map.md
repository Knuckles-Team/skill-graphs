[Skip to main content](https://docs.falkordb.com/udfs/#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/udfs/#udfs) UDFs
...
##  [](https://docs.falkordb.com/udfs/#practical-example) Practical Example
...
##  [](https://docs.falkordb.com/udfs/#commands-specification) Commands Specification
...
###  [](https://docs.falkordb.com/udfs/#graphudf-load-replace--) GRAPH.UDF LOAD [REPLACE]
...
###  [](https://docs.falkordb.com/udfs/#graphudf-list-lib-withcode) GRAPH.UDF LIST [Lib] [WITHCODE]
...
For example: Calling the command: `GRAPH.UDF LIST WITHCODE` will generate the following output:
```
1) 1) library_name
   2) Shapes
   3) functions
...
###  [](https://docs.falkordb.com/udfs/#graphudf-delete-) GRAPH.UDF DELETE
...
###  [](https://docs.falkordb.com/udfs/#graphudf-flush) GRAPH.UDF FLUSH
...
##  [](https://docs.falkordb.com/udfs/#datatypes) Datatypes
Any datatype available in FalkorDB is accessible within UDFs, these include: Scalar, Node, Edge & Path objects.
###  [](https://docs.falkordb.com/udfs/#node) Node
...
###  [](https://docs.falkordb.com/udfs/#edge) Edge
...
###  [](https://docs.falkordb.com/udfs/#path) Path
...
##  [](https://docs.falkordb.com/udfs/#global-objects) Global objects
###  [](https://docs.falkordb.com/udfs/#graph) Graph
UDFs have access to a global `graph` object which represents the current graph executing the UDF. The object exposes a single function `traverse` which is similar to the node’s `getNeighbors` function (see docs above) but can perform multi-source traversal, which can be faster than performing multiple individual calls to getNeighbors.
```
...
###  [](https://docs.falkordb.com/udfs/#falkor) Falkor
...
####  [](https://docs.falkordb.com/udfs/#falkorlog) falkor.log
#####  [](https://docs.falkordb.com/udfs/#description) Description
Logs a message to the database stdout
#####  [](https://docs.falkordb.com/udfs/#syntax) Syntax
```
falkor.log(msg)

```

#####  [](https://docs.falkordb.com/udfs/#parameters) Parameters
Parameter | Type | Required | Description
---|---|---|---
`message` | string | Yes | message to log
####  [](https://docs.falkordb.com/udfs/#falkorregister) falkor.register
#####  [](https://docs.falkordb.com/udfs/#description-1) Description
Register a function to the database
#####  [](https://docs.falkordb.com/udfs/#syntax-1) Syntax
```
falkor.register(name, function)

```

#####  [](https://docs.falkordb.com/udfs/#parameters-1) Parameters
Parameter | Type | Required | Description
---|---|---|---
`name` | string | Yes | expose function under this name
`function` | function pointer | Yes | function to expose
#####  [](https://docs.falkordb.com/udfs/#example) Example
```
function add(a,b) {
    return a + b;
}
...
##  [](https://docs.falkordb.com/udfs/#advanced-examples) Advanced examples
In this example, we’ll implement Jaccard similarity for nodes. Jaccard’s formula is: J(A,B) = |A ∩ B| / |A ∪ B| = |A ∩ B| / (|A| + |B| - |A ∩ B|)
...
###  [](https://docs.falkordb.com/udfs/#custom-traversals) Custom Traversals
...
##  [](https://docs.falkordb.com/udfs/#flex) FLEX
FLEX (FalkorDB Library of Extensions) is FalkorDB’s open source community UDF package, available at
...
##  [](https://docs.falkordb.com/udfs/#limitations) Limitations
