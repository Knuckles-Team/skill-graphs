[Skip to main content](https://docs.falkordb.com/getting-started/clients.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
Search FalkorDB Docs
  1. [Getting Started](https://docs.falkordb.com/getting-started/)
  2. Client Libraries


#  [](https://docs.falkordb.com/getting-started/clients.html#official-clients) Official Clients
Project | Docs | Language | License | Author | Package
---|---|---|---|---|---
|  | Python | MIT | [FalkorDB](https://www.falkordb.com) |
|  | Node.JS | MIT | [FalkorDB](https://www.falkordb.com) |
|  | Java | BSD | [FalkorDB](https://www.falkordb.com) |
|  | Rust | MIT | [FalkorDB](https://www.falkordb.com) |
|  | Go | BSD | [FalkorDB](https://www.falkordb.com) |
|  | C# | Apache-2.0 | [FalkorDB](https://www.falkordb.com) |
##  [](https://docs.falkordb.com/getting-started/clients.html#official-object-graph-mapping-ogm-libraries) Official Object-Graph Mapping (OGM) Libraries
...
---|---|---|---|---|---
|  | Python | MIT | [FalkorDB](https://www.falkordb.com) |
|  | Go | MIT | [FalkorDB](https://www.falkordb.com) |
|  | Java | Apache-2.0 | [FalkorDB](https://www.falkordb.com) |
##  [](https://docs.falkordb.com/getting-started/clients.html#additional-clients) Additional Clients
...
| C# | BSD |  |
| Julia | MIT |  |
##  [](https://docs.falkordb.com/getting-started/clients.html#implementing-a-client) Implementing a client
Information on some of the tasks involved in writing a FalkorDB client can be found in the [Client Specification](https://docs.falkordb.com/design/client-spec).
* * *
Hi. Need any help?
