[Skip to main content](https://docs.falkordb.com/cypher/limit.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/cypher/limit.html#limit) LIMIT
