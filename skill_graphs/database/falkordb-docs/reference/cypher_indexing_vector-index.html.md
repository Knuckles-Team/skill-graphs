[Skip to main content](https://docs.falkordb.com/cypher/load-csv.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
Search FalkorDB Docs
  1. [Cypher Language](https://docs.falkordb.com/cypher/)
  2. LOAD CSV


#  [](https://docs.falkordb.com/cypher/load-csv.html#load-csv) LOAD CSV
```
...
##  [](https://docs.falkordb.com/cypher/load-csv.html#field-delimiter) FIELD DELIMITER
...
##  [](https://docs.falkordb.com/cypher/load-csv.html#importing-data) IMPORTING DATA
###  [](https://docs.falkordb.com/cypher/load-csv.html#importing-local-files) Importing local files
FalkorDB defines a data directory [see configuration](https://docs.falkordb.com/configuration#import_folder) Under which local CSV files should be stored. All `file://` URIs are resolved relative to that directory.
In the following example we’ll load the `actors.csv` file into FalkorDB.
###  [](https://docs.falkordb.com/cypher/load-csv.html#actorscsv) actors.csv
|
---|---
Lee Pace | 1979
Vin Diesel | 1967
...
###  [](https://docs.falkordb.com/cypher/load-csv.html#actorscsv-1) actors.csv
name | birthyear
---|---
Lee Pace | 1979
Vin Diesel | 1967
...
###  [](https://docs.falkordb.com/cypher/load-csv.html#importing-data-from-multiple-csvs) Importing data from multiple CSVs
Building on the previous example, we’ll introduce a second CSV file, `acted_in.csv`, which connects actors to movies.
###  [](https://docs.falkordb.com/cypher/load-csv.html#acted_incsv) acted_in.csv
actor | movie
---|---
Lee Pace | The Fall
...
###  [](https://docs.falkordb.com/cypher/load-csv.html#importing-remote-files) Importing remote files
...
###  [](https://docs.falkordb.com/cypher/load-csv.html#dealing-with-a-large-number-of-columns-or-missing-entries) Dealing with a large number of columns or missing entries
...
###  [](https://docs.falkordb.com/cypher/load-csv.html#missing_entriescsv) missing_entries.csv
name | birthyear
---|---
Lee Pace | 1979
Vin Diesel |
