[Skip to main content](https://docs.falkordb.com/cypher/return.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/cypher/return.html#return) RETURN
The `RETURN` clause defines which properties and values the result-set will contain.
##  [](https://docs.falkordb.com/cypher/return.html#basic-usage) Basic Usage
...
##  [](https://docs.falkordb.com/cypher/return.html#removing-duplicates) Removing Duplicates
...
##  [](https://docs.falkordb.com/cypher/return.html#aggregations) Aggregations
...
###  [](https://docs.falkordb.com/cypher/return.html#supported-aggregation-functions) Supported Aggregation Functions
...
For detailed information on aggregation functions, see the [Functions documentation](https://docs.falkordb.com/cypher/functions#aggregating-functions).
* * *
This site uses
Hi. Need any help?
