[Skip to main content](https://docs.falkordb.com/udfs/flex/text/indexesOf.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/udfs/flex/text/indexesOf.html#textindexesof) text.indexesOf
##  [](https://docs.falkordb.com/udfs/flex/text/indexesOf.html#description) Description
...
##  [](https://docs.falkordb.com/udfs/flex/text/indexesOf.html#syntax) Syntax
```
flex.text.indexesOf(string, substring, from, to)

```

##  [](https://docs.falkordb.com/udfs/flex/text/indexesOf.html#parameters) Parameters
...
##  [](https://docs.falkordb.com/udfs/flex/text/indexesOf.html#returns) Returns
...
##  [](https://docs.falkordb.com/udfs/flex/text/indexesOf.html#examples) Examples
###  [](https://docs.falkordb.com/udfs/flex/text/indexesOf.html#example-1-find-all-occurrences) Example 1: Find All Occurrences
```
...
###  [](https://docs.falkordb.com/udfs/flex/text/indexesOf.html#example-2-find-occurrences-in-range) Example 2: Find Occurrences in Range
```
...
###  [](https://docs.falkordb.com/udfs/flex/text/indexesOf.html#example-3-count-keyword-occurrences) Example 3: Count Keyword Occurrences
```
MATCH (d:Document)
...
##  [](https://docs.falkordb.com/udfs/flex/text/indexesOf.html#notes) Notes
...
##  [](https://docs.falkordb.com/udfs/flex/text/indexesOf.html#see-also) See Also
  * [text.indexOf](https://docs.falkordb.com/udfs/flex/text/indexOf.html) - Find first occurrence only
  * [text.replace](https://docs.falkordb.com/udfs/flex/text/replace.html) - Replace substring occurrences
  * [text.regexGroups](https://docs.falkordb.com/udfs/flex/text/regexGroups.html) - Find matches using regex patterns
