[Skip to main content](https://docs.falkordb.com/commands/graph.explain.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/commands/graph.explain.html#graphexplain) GRAPH.EXPLAIN
