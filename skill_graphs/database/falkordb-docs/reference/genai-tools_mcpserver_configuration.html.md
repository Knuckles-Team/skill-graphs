[Skip to main content](https://docs.falkordb.com/genai-tools/langchain.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
Search FalkorDB Docs
  1. [GenAI Tools](https://docs.falkordb.com/genai-tools/)
  2. LangChain


#  [](https://docs.falkordb.com/genai-tools/langchain.html#langchain) LangChain
FalkorDB is integrated with
...
##  [](https://docs.falkordb.com/genai-tools/langchain.html#resources) Resources
  * 🔗
  * 📦
  * 💻
...
* * *
##  [](https://docs.falkordb.com/genai-tools/langchain.html#python-integration) Python Integration
###  [](https://docs.falkordb.com/genai-tools/langchain.html#installation) Installation
...
###  [](https://docs.falkordb.com/genai-tools/langchain.html#quick-start) Quick Start
####  [](https://docs.falkordb.com/genai-tools/langchain.html#1-connect-to-falkordb) 1. Connect to FalkorDB
```
...
####  [](https://docs.falkordb.com/genai-tools/langchain.html#2-create-a-knowledge-graph-from-text) 2. Create a Knowledge Graph from Text
```
...
####  [](https://docs.falkordb.com/genai-tools/langchain.html#3-query-the-graph) 3. Query the Graph
```
...
###  [](https://docs.falkordb.com/genai-tools/langchain.html#advanced-usage) Advanced Usage
####  [](https://docs.falkordb.com/genai-tools/langchain.html#using-graph-memory-for-conversational-ai) Using Graph Memory for Conversational AI
```
...
####  [](https://docs.falkordb.com/genai-tools/langchain.html#custom-cypher-generation) Custom Cypher Generation
```
...
####  [](https://docs.falkordb.com/genai-tools/langchain.html#loading-data-into-the-graph) Loading Data into the Graph
```
...
####  [](https://docs.falkordb.com/genai-tools/langchain.html#graph-rag-pattern) Graph RAG Pattern
```
...
* * *
##  [](https://docs.falkordb.com/genai-tools/langchain.html#javascripttypescript-integration) JavaScript/TypeScript Integration
FalkorDB also provides a JavaScript/TypeScript integration for LangChain applications through the
###  [](https://docs.falkordb.com/genai-tools/langchain.html#installation-1) Installation
```
npm install @falkordb/langchain-ts falkordb langchain @langchain/openai

```

###  [](https://docs.falkordb.com/genai-tools/langchain.html#quick-start-jsts) Quick Start (JS/TS)
```
...
###  [](https://docs.falkordb.com/genai-tools/langchain.html#key-features-jsts) Key Features (JS/TS)
...
###  [](https://docs.falkordb.com/genai-tools/langchain.html#api-reference-jsts) API Reference (JS/TS)
####  [](https://docs.falkordb.com/genai-tools/langchain.html#falkordbgraphinitializeconfig) `FalkorDBGraph.initialize(config)`
...
####  [](https://docs.falkordb.com/genai-tools/langchain.html#queryquery-string) `query(query: string)`
...
####  [](https://docs.falkordb.com/genai-tools/langchain.html#refreshschema) `refreshSchema()`
...
###  [](https://docs.falkordb.com/genai-tools/langchain.html#advanced-usage-jsts) Advanced Usage (JS/TS)
####  [](https://docs.falkordb.com/genai-tools/langchain.html#custom-cypher-queries) Custom Cypher Queries
```
const graph = await FalkorDBGraph.initialize({
  host: "localhost",
  port: 6379,
...
####  [](https://docs.falkordb.com/genai-tools/langchain.html#working-with-schema-jsts) Working with Schema (JS/TS)
```
await graph.refreshSchema();
...
For more examples and source code, see the
* * *
##  [](https://docs.falkordb.com/genai-tools/langchain.html#use-cases) Use Cases
...
##  [](https://docs.falkordb.com/genai-tools/langchain.html#best-practices) Best Practices
...
##  [](https://docs.falkordb.com/genai-tools/langchain.html#resources-1) Resources
