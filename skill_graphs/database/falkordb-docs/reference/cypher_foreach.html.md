[Skip to main content](https://docs.falkordb.com/cypher/delete.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/cypher/delete.html#delete) DELETE
The `DELETE` clause is used to remove nodes and relationships from the graph.
##  [](https://docs.falkordb.com/cypher/delete.html#important-behavior) Important Behavior
...
##  [](https://docs.falkordb.com/cypher/delete.html#deleting-nodes) Deleting Nodes
...
##  [](https://docs.falkordb.com/cypher/delete.html#deleting-relationships) Deleting Relationships
...
##  [](https://docs.falkordb.com/cypher/delete.html#common-patterns) Common Patterns
###  [](https://docs.falkordb.com/cypher/delete.html#delete-all-nodes-and-relationships-in-a-graph) Delete all nodes and relationships in a graph
```
...
###  [](https://docs.falkordb.com/cypher/delete.html#conditional-deletion) Conditional deletion
```
