[Skip to main content](https://docs.falkordb.com/udfs/flex/similarity/#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/udfs/flex/similarity/#similarity-functions) Similarity Functions
