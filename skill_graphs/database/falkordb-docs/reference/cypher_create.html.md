[Skip to main content](https://docs.falkordb.com/cypher/optional-match.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/cypher/optional-match.html#optional-match) OPTIONAL MATCH
