[Skip to main content](https://docs.falkordb.com/cypher/where.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/cypher/where.html#where) WHERE
The `WHERE` clause is optional and is used to filter results based on predicates (conditions).
##  [](https://docs.falkordb.com/cypher/where.html#supported-comparison-operators) Supported Comparison Operators
...
##  [](https://docs.falkordb.com/cypher/where.html#combining-predicates) Combining Predicates
...
###  [](https://docs.falkordb.com/cypher/where.html#examples) Examples:
```
...
##  [](https://docs.falkordb.com/cypher/where.html#inline-property-filters) Inline Property Filters
...
##  [](https://docs.falkordb.com/cypher/where.html#pattern-predicates) Pattern Predicates
...
##  [](https://docs.falkordb.com/cypher/where.html#label-filtering) Label Filtering
