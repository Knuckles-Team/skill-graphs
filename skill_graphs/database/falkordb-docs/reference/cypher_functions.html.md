[Skip to main content](https://docs.falkordb.com/cypher/with.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/cypher/with.html#with) WITH
...
##  [](https://docs.falkordb.com/cypher/with.html#use-cases) Use Cases
`WITH` is useful for:
...
##  [](https://docs.falkordb.com/cypher/with.html#example-filtering-by-aggregated-values) Example: Filtering by Aggregated Values
...
##  [](https://docs.falkordb.com/cypher/with.html#example-using-modifiers-mid-query) Example: Using Modifiers Mid-Query
...
##  [](https://docs.falkordb.com/cypher/with.html#key-points) Key Points
