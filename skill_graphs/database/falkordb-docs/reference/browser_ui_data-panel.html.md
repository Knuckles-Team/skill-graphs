[Skip to main content](https://docs.falkordb.com/browser/ui/navigation.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/browser/ui/navigation.html#navigation--header) Navigation & Header
FalkorDB Browser uses a left sidebar (header) for navigation and global actions.
##  [](https://docs.falkordb.com/browser/ui/navigation.html#main-navigation-buttons) Main navigation buttons
Located in the sidebar under the user name/version block:
  * **SETTINGS** → opens `/settings`
  * **GRAPHS** → opens `/graph`


##  [](https://docs.falkordb.com/browser/ui/navigation.html#contextual-graph-controls-graphs-page) Contextual graph controls (Graphs page)
...
##  [](https://docs.falkordb.com/browser/ui/navigation.html#create-graph) Create graph
For non–Read-Only users, the sidebar can expose **Create Graph** (depending on the current route).
##  [](https://docs.falkordb.com/browser/ui/navigation.html#help-menu) Help menu
...
##  [](https://docs.falkordb.com/browser/ui/navigation.html#theme-toggle) Theme toggle
The theme toggle cycles through:
  * Dark → Light → System → Dark


##  [](https://docs.falkordb.com/browser/ui/navigation.html#connection-indicators) Connection indicators
...
##  [](https://docs.falkordb.com/browser/ui/navigation.html#logout) Logout
