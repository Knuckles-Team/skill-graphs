[Skip to main content](https://docs.falkordb.com/udfs/flex/json/#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/udfs/flex/json/#json-functions) JSON Functions
FLEX json utilities.
* * *
## Table of contents
  * [json.fromJsonList](https://docs.falkordb.com/udfs/flex/json/fromJsonList.html)
