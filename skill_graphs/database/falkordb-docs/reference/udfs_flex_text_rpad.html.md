[Skip to main content](https://docs.falkordb.com/udfs/flex/text/join.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/udfs/flex/text/join.html#textjoin) text.join
##  [](https://docs.falkordb.com/udfs/flex/text/join.html#description) Description
Joins an array of strings into a single string using a specified delimiter.
##  [](https://docs.falkordb.com/udfs/flex/text/join.html#syntax) Syntax
```
flex.text.join(array, delimiter)

```

##  [](https://docs.falkordb.com/udfs/flex/text/join.html#parameters) Parameters
Parameter | Type | Required | Description
---|---|---|---
`array` | list | Yes | The array of strings to join
`delimiter` | string | Yes | The separator to insert between elements
##  [](https://docs.falkordb.com/udfs/flex/text/join.html#returns) Returns
**Type:** string
...
##  [](https://docs.falkordb.com/udfs/flex/text/join.html#examples) Examples
###  [](https://docs.falkordb.com/udfs/flex/text/join.html#example-1-basic-string-joining) Example 1: Basic String Joining
```
...
###  [](https://docs.falkordb.com/udfs/flex/text/join.html#example-2-building-csv-lines) Example 2: Building CSV Lines
```
MATCH (u:User)
...
###  [](https://docs.falkordb.com/udfs/flex/text/join.html#example-3-creating-tags-string) Example 3: Creating Tags String
```
MATCH (p:Post)
...
###  [](https://docs.falkordb.com/udfs/flex/text/join.html#example-4-building-paths) Example 4: Building Paths
```
...
##  [](https://docs.falkordb.com/udfs/flex/text/join.html#notes) Notes
...
##  [](https://docs.falkordb.com/udfs/flex/text/join.html#see-also) See Also
  * [text.format](https://docs.falkordb.com/udfs/flex/text/format.html) - Format strings with placeholders
  * [coll.zip](https://docs.falkordb.com/udfs/flex/collections/zip.html) - Combine two lists
