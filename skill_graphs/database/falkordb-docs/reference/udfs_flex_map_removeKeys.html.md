[Skip to main content](https://docs.falkordb.com/udfs/flex/date/#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/udfs/flex/date/#date-functions) Date Functions
FLEX date utilities.
* * *
## Table of contents
  * [date.format](https://docs.falkordb.com/udfs/flex/date/format.html)
