[Skip to main content](https://docs.falkordb.com/commands/graph.info.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/commands/graph.info.html#graphinfo) GRAPH.INFO
Returns information and statistics about currently running and waiting queries.
##  [](https://docs.falkordb.com/commands/graph.info.html#syntax) Syntax
```
...
##  [](https://docs.falkordb.com/commands/graph.info.html#examples) Examples
```
