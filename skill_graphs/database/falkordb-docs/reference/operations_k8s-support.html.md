[Skip to main content](https://docs.falkordb.com/cloud/#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/cloud/#falkordb-cloud-dbaas) FalkorDB Cloud DBaaS
...
##  [](https://docs.falkordb.com/cloud/#features--services) Features & Services
Group | Features
---|---
...
* * *
###  [](https://docs.falkordb.com/cloud/#billing--setup) Billing & Setup
...
##  [](https://docs.falkordb.com/cloud/#free-tier) Free Tier
...
##  [](https://docs.falkordb.com/cloud/#startup-tier) Startup Tier
