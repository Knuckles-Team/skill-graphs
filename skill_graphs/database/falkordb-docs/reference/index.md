[Skip to main content](https://docs.falkordb.com/#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/#falkordb) FalkorDB
###  [](https://docs.falkordb.com/#the-graph-platform-developers-use-to-achieve-accurate-graphrag-for-enterprise-genai) The Graph platform developers use to achieve accurate GraphRAG for enterprise GenAI
###  [](https://docs.falkordb.com/#about-falkordb) About FalkorDB
...
###  [](https://docs.falkordb.com/#choose-your-path) Choose Your Path
  ...
  * **GraphRAG Path:** If you’re aiming to implement advanced graph reasoning and generative AI tasks, explore our [GenAI Tools](https://docs.falkordb.com/genai-tools) section, starting with the [GraphRAG SDK](https://docs.falkordb.com/genai-tools/graphrag-sdk).


##  [](https://docs.falkordb.com/#primary-features) Primary Features
  * Adopts the
  * Supports
  * Offers [Full-Text Search](https://docs.falkordb.com/cypher/indexing/fulltext-index), [Vector Similarity](https://docs.falkordb.com/cypher/indexing/vector-index), and [Range indexing](https://docs.falkordb.com/cypher/indexing/range-index) for efficient querying
  * Supports both
  * Uses sparse adjacency matrix representation for efficient graph storage
  * Provides GraphRAG capabilities through the [GraphRAG SDK](https://docs.falkordb.com/genai-tools/graphrag-sdk) for advanced graph reasoning and generative AI tasks


##  [](https://docs.falkordb.com/#get-started) Get Started
Launch an instance using Docker, or use
```
docker run -p 6379:6379 -p 3000:3000 -it --rm falkordb/falkordb:latest

```

###  [](https://docs.falkordb.com/#ports-exposed) Ports Exposed
...
Once loaded, you can interact with FalkorDB using any of the supported [client libraries](https://docs.falkordb.com/getting-started/clients)
Here we’ll use
...
For additional demos please visit
##  [](https://docs.falkordb.com/#client-libraries) Client libraries
Language-specific clients have been written by the community and the FalkorDB team. The full list and links can be found on the [Client Libraries](https://docs.falkordb.com/getting-started/clients) page.
##  [](https://docs.falkordb.com/#data-import) Data import
When loading large graphs from CSV files, we recommend using
##  [](https://docs.falkordb.com/#github-discussions) GitHub Discussions
Got questions? Please contact us at the
##  [](https://docs.falkordb.com/#license) License
FalkorDB is licensed under the
* * *
This site uses
Hi. Need any help?
