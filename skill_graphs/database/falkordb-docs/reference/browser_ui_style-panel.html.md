[Skip to main content](https://docs.falkordb.com/browser/ui/login.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/browser/ui/login.html#login-screen) Login Screen
The login screen configures the connection to a FalkorDB server and authenticates the user.
##  [](https://docs.falkordb.com/browser/ui/login.html#login-modes) Login modes
The UI supports two ways to provide connection details:
###  [](https://docs.falkordb.com/browser/ui/login.html#1-manual-configuration) 1) Manual configuration
...
###  [](https://docs.falkordb.com/browser/ui/login.html#2-falkordb-url) 2) FalkorDB URL
...
##  [](https://docs.falkordb.com/browser/ui/login.html#what-happens-on-successful-login) What happens on successful login
On success, the browser navigates to the **Graphs** workspace (`/graph`).
##  [](https://docs.falkordb.com/browser/ui/login.html#troubleshooting) Troubleshooting
