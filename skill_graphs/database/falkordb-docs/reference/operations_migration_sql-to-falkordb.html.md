[Skip to main content](https://docs.falkordb.com/operations/#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/operations/#operations) Operations
...
Table of Contents
##  [](https://docs.falkordb.com/operations/#1-docker-and-docker-compose) 1. [Docker and Docker Compose](https://docs.falkordb.com/operations/docker)
...
##  [](https://docs.falkordb.com/operations/#2-data-durability) 2. [Data Durability](https://docs.falkordb.com/operations/durability)
...
##  [](https://docs.falkordb.com/operations/#3-configuring-replication) 3. [Configuring Replication](https://docs.falkordb.com/operations/replication)
Set up replication in FalkorDB to achieve high availability and data redundancy across multiple nodes.
##  [](https://docs.falkordb.com/operations/#4-setting-up-a-cluster) 4. [Setting Up a Cluster](https://docs.falkordb.com/operations/cluster)
...
##  [](https://docs.falkordb.com/operations/#5-deploy-falkordb-to-kubernetes) 5. [Deploy FalkorDB to Kubernetes](https://docs.falkordb.com/operations/k8s_support)
Learn how falkorDB can be deployed on Kubernetes using Helm charts and Docker images.
##  [](https://docs.falkordb.com/operations/#6-deploy-falkordb-with-kubeblocks) 6. [Deploy FalkorDB with KubeBlocks](https://docs.falkordb.com/operations/kubeblocks)
...
##  [](https://docs.falkordb.com/operations/#7-deploy-falkordb-on-railway) 7. [Deploy FalkorDB on Railway](https://docs.falkordb.com/operations/railway)
...
##  [](https://docs.falkordb.com/operations/#8-opentelemetry-integration-with-falkordb-py) 8. [OpenTelemetry Integration with FalkorDB-py](https://docs.falkordb.com/operations/opentelemetry)
Comprehensive guide for setting up OpenTelemetry observability and tracing with FalkorDB Python applications.
##  [](https://docs.falkordb.com/operations/#9-falkordblite) 9. [FalkorDBLite](https://docs.falkordb.com/operations/falkordblite)
Embedded FalkorDB runtime for local development with guides for [Python](https://docs.falkordb.com/operations/falkordblite/falkordblite-py) and [TypeScript](https://docs.falkordb.com/operations/falkordblite/falkordblite-ts).
##  [](https://docs.falkordb.com/operations/#10-deploy-falkordb-on-lightningai) 10. [Deploy FalkorDB on Lightning.AI](https://docs.falkordb.com/operations/lightning-ai)
Deploy FalkorDB on Lightning.AI to build fast, accurate GenAI applications using advanced RAG with graph databases.
##  [](https://docs.falkordb.com/operations/#11-building-docker) 11. [Building Docker](https://docs.falkordb.com/operations/building-docker)
