[Skip to main content](https://docs.falkordb.com/udfs/flex/text/indexOf.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/udfs/flex/text/indexOf.html#textindexof) text.indexOf
##  [](https://docs.falkordb.com/udfs/flex/text/indexOf.html#description) Description
...
##  [](https://docs.falkordb.com/udfs/flex/text/indexOf.html#syntax) Syntax
```
flex.text.indexOf(string, substring, offset, to)

```

##  [](https://docs.falkordb.com/udfs/flex/text/indexOf.html#parameters) Parameters
...
##  [](https://docs.falkordb.com/udfs/flex/text/indexOf.html#returns) Returns
**Type:** number (integer)
The zero-based index of the first occurrence of the substring, or `-1` if not found. Returns `null` if the input string is `null`.
##  [](https://docs.falkordb.com/udfs/flex/text/indexOf.html#examples) Examples
###  [](https://docs.falkordb.com/udfs/flex/text/indexOf.html#example-1-basic-search) Example 1: Basic Search
```
...
###  [](https://docs.falkordb.com/udfs/flex/text/indexOf.html#example-2-search-with-offset) Example 2: Search with Offset
```
...
###  [](https://docs.falkordb.com/udfs/flex/text/indexOf.html#example-3-filtering-nodes-by-substring-position) Example 3: Filtering Nodes by Substring Position
```
MATCH (p:Product)
...
##  [](https://docs.falkordb.com/udfs/flex/text/indexOf.html#notes) Notes
...
##  [](https://docs.falkordb.com/udfs/flex/text/indexOf.html#see-also) See Also
  * [text.indexesOf](https://docs.falkordb.com/udfs/flex/text/indexesOf.html) - Find all occurrences of a substring
