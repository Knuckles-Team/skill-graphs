[Skip to main content](https://docs.falkordb.com/commands/graph.config-set.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/commands/graph.config-set.html#graphconfig-set) GRAPH.CONFIG-SET
...
FalkorDB configuration parameters are detailed [here](https://docs.falkordb.com/configuration).
