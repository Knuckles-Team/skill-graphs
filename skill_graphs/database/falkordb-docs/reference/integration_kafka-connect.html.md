[Skip to main content](https://docs.falkordb.com/getting-started/#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/getting-started/#getting-started-with-falkordb) Getting Started with FalkorDB
This guide will walk you through setting up FalkorDB, modeling a social network as a graph, and accessing it using one of the [FalkorDB client libraries](https://docs.falkordb.com/getting-started/clients) with the [Cypher](https://docs.falkordb.com/cypher) query language.
* * *
##  [](https://docs.falkordb.com/getting-started/#prerequisites) Prerequisites
...
* * *
##  [](https://docs.falkordb.com/getting-started/#step-1-model-a-social-network-as-a-graph) Step 1: Model a Social Network as a Graph
...
###  [](https://docs.falkordb.com/getting-started/#graph-schema) Graph Schema
**Node Types:**
...
* * *
##  [](https://docs.falkordb.com/getting-started/#step-2-load-data-into-falkordb) Step 2: Load Data into FalkorDB
Here’s how you can model and load the data.
###  [](https://docs.falkordb.com/getting-started/#cypher-query-to-create-the-data) Cypher Query to Create the Data
```
...
* * *
##  [](https://docs.falkordb.com/getting-started/#step-3-access-your-data) Step 3: Access Your Data
###  [](https://docs.falkordb.com/getting-started/#connect-to-falkordb) Connect to FalkorDB
python javascript rust java
Copy```
...
###  [](https://docs.falkordb.com/getting-started/#execute-cypher-queries) Execute Cypher Queries
####  [](https://docs.falkordb.com/getting-started/#create-the-graph) Create the Graph
python javascript rust java
Copy```
...
####  [](https://docs.falkordb.com/getting-started/#query-the-graph) Query the Graph
python javascript rust java
Copy```
...
####  [](https://docs.falkordb.com/getting-started/#query-relationships) Query Relationships
python javascript rust java
Copy```
...
* * *
##  [](https://docs.falkordb.com/getting-started/#step-4-explore-further) Step 4: Explore Further
...
Next, dive deeper into FalkorDB’s powerful features:
  * [Advanced Cypher](https://docs.falkordb.com/cypher)
  * [Database Operations](https://docs.falkordb.com/operations)
  * [GenAI Tools](https://docs.falkordb.com/genai-tools)
  * [Agentic Memory](https://docs.falkordb.com/agentic-memory)
