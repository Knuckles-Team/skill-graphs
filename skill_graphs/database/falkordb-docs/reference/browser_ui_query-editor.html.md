[Skip to main content](https://docs.falkordb.com/browser/ui/settings.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
Search FalkorDB Docs
  1. [Browser](https://docs.falkordb.com/browser/)
  2. [UI Elements](https://docs.falkordb.com/browser/ui/)
  3. Settings Page


#  [](https://docs.falkordb.com/browser/ui/settings.html#settings-page) Settings Page
The Settings page (`/settings`) is where you configure Browser behavior and manage security/admin features.
##  [](https://docs.falkordb.com/browser/ui/settings.html#tabs--sections) Tabs / sections
...
##  [](https://docs.falkordb.com/browser/ui/settings.html#browser-settings) Browser Settings
...
###  [](https://docs.falkordb.com/browser/ui/settings.html#replay-tutorial) Replay Tutorial
Browser Settings includes a **Replay Tutorial** action, which re-runs the guided tour overlay.
##  [](https://docs.falkordb.com/browser/ui/settings.html#personal-access-tokens) Personal Access Tokens
The Tokens section provides a UI to:
  * Create tokens (often with optional expiry)
  * View/revoke existing tokens


##  [](https://docs.falkordb.com/browser/ui/settings.html#admin-only-sections) Admin-only sections
###  [](https://docs.falkordb.com/browser/ui/settings.html#db-configurations-admin) DB Configurations (Admin)
Allows viewing/updating database configuration values via the server API.
###  [](https://docs.falkordb.com/browser/ui/settings.html#users-admin) Users (Admin)
Allows:
  * Viewing users
  * Changing roles
...
##  [](https://docs.falkordb.com/browser/ui/settings.html#keyboard-shortcut) Keyboard shortcut
