[Skip to main content](https://docs.falkordb.com/cypher/merge.html#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/cypher/merge.html#merge) MERGE
...
##  [](https://docs.falkordb.com/cypher/merge.html#merging-nodes) Merging nodes
...
##  [](https://docs.falkordb.com/cypher/merge.html#merging-paths) Merging paths
...
##  [](https://docs.falkordb.com/cypher/merge.html#on-match-and-on-create-directives) On Match and On Create directives
