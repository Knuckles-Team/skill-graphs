[Skip to main content](https://docs.falkordb.com/integration/#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/integration/#integration) Integration
...
##  [](https://docs.falkordb.com/integration/#topics-in-this-section) Topics in This Section
  * [REST API](https://docs.falkordb.com/integration/rest.html): Learn how to interact with FalkorDB using its REST API for seamless integration with your applications.
  * [Kafka Connect](https://docs.falkordb.com/integration/kafka-connect.html): Learn how to interact with FalkorDB using Kafka Connect sink to replicate data from third-party applications.
  * [Apache Jena](https://docs.falkordb.com/integration/jena.html): Learn how to use FalkorDB with Apache Jena via the jena-falkordb-adapter.
  * [BOLT protocol support](https://docs.falkordb.com/integration/bolt-support.html): Learn how to connect to FalkorDB using the BOLT protocol.
  * [Spring Data FalkorDB](https://docs.falkordb.com/integration/spring-data-falkordb.html): Learn how to use FalkorDB with Spring Data for JPA-style object-graph mapping.
  * [Snowflake Integration](https://docs.falkordb.com/integration/snowflake.html): Learn how to run graph database operations directly within your Snowflake environment using the FalkorDB Native App.
