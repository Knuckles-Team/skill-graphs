[Skip to main content](https://docs.falkordb.com/udfs/flex/collections/#main-content) Link Menu Expand (external link) Document Search Copy Copied
...
#  [](https://docs.falkordb.com/udfs/flex/collections/#collection-functions) Collection Functions
