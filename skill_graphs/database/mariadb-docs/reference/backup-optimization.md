...
{% tabs %}
{% tab title="Current" %}
MariaDB Server includes [advanced backup](/docs/server/server-usage/backup-and-restore/mariadb-enterprise-backup#non-blocking-backups) functionality to reduce the impact of backup operations:
