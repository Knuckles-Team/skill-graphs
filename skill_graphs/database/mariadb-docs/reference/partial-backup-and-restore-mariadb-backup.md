...
* To tell it which tables to back up, you can use [the `--tables` option](/docs/server/server-usage/backup-and-restore/mariadb-backup/mariadb-backup-options#tables).
...
6. Change the owner of the newly copied files to the system user running MariaDB Server:
   ...
   ```
7. In the MariaDB Command-Line Client, import the copied tablespace:
