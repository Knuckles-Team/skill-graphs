...
See [CREATE TABLE](/docs/server/server-usage/tables/create-table) for more.
...
See [INSERT](/docs/server/reference/sql-statements/data-manipulation/inserting-loading-data/insert) for more.
...
See [AUTO\_INCREMENT](/docs/server/reference/data-types/auto_increment) for more.
...
This kind of query is called a join - see [JOINS](/docs/server/reference/sql-statements/data-manipulation/selecting-data/joins) for more.
...
See the [MAX() function](/docs/server/reference/sql-functions/aggregate-functions/max) for more, as well as [Finding the maximum value and grouping the results](#finding-the-maximum-value-and-grouping-the-results) below for a more practical example.
...
See the [MIN() function](/docs/server/reference/sql-functions/aggregate-functions/min) for more.
...
See the [AVG() function](/docs/server/reference/sql-functions/aggregate-functions/avg) for more.
...
See the [MAX() function](/docs/server/reference/sql-functions/aggregate-functions/max) for more.
...
See [ORDER BY](/docs/server/reference/sql-statements/data-manipulation/selecting-data/order-by) for more.
...
The [TIMESTAMPDIFF](/docs/server/reference/sql-functions/date-time-functions/timestampdiff) function can be used to calculate someone's age:
...
See [TIMESTAMPDIFF()](/docs/server/reference/sql-functions/date-time-functions/timestampdiff) for more.

## Using User-defined Variables

This example sets a [user-defined variable](/docs/server/reference/sql-structure/sql-language-structure/user-defined-variables) with the average test score, and then uses it in a later query to return all results above the average.
...
See [User-defined Variables](/docs/server/reference/sql-structure/sql-language-structure/user-defined-variables) for more.
