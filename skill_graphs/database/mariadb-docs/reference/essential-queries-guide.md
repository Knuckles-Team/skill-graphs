...
For more details, see the official [CREATE TABLE](/docs/server/server-usage/tables/create-table) documentation.
...
For more details, see the [AUTO\_INCREMENT](/docs/server/reference/data-types/auto_increment) documentation.
...
This type of query is a join. For more details, consult the documentation on [JOINS](/docs/server/reference/sql-statements/data-manipulation/selecting-data/joins).
...
See the [MAX() function](/docs/server/reference/sql-functions/aggregate-functions/max) documentation. For a grouped example, refer to *Finding the Maximum Value and Grouping the Results* below.
...
See the [AVG() function](/docs/server/reference/sql-functions/aggregate-functions/avg) documentation.
...
For more options, see the [ORDER BY](/docs/server/reference/sql-statements/data-manipulation/selecting-data/order-by) documentation.
...
See the [TIMESTAMPDIFF()](/docs/server/reference/sql-functions/date-time-functions/timestampdiff) documentation for more.

### Using User-defined Variables

[User-defined variables ](/docs/server/reference/sql-structure/sql-language-structure/user-defined-variables)can store values for use in subsequent queries within the same session.
