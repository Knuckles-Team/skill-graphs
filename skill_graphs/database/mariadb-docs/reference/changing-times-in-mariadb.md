...
*(For foundational knowledge on date and time data types and basic retrieval, please refer to the "*[*Date and Time Handling Guide*](/docs/server/mariadb-quickstart-guides/mariadb-datetime-guide)*".)*
