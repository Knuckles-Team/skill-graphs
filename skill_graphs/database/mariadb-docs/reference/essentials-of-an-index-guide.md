...
See [CREATE INDEX](/docs/server/reference/sql-statements/data-definition/create/create-index) and [Getting Started with Indexes](/docs/server/mariadb-quickstart-guides/mariadb-indexes-guide) for more information.
