...
* **Restoration:** To learn how to restore data from these dump files, see the "[Data Restoration Guide](/docs/server/mariadb-quickstart-guides/mariadb-restore-guide)".
