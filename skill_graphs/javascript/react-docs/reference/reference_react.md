...
### react@19.2
  ...
  * [Hooks ](https://react.dev/reference/react/hooks "Hooks")
    ...
    * [useEffectEvent ](https://react.dev/reference/react/useEffectEvent "useEffectEvent")
  ...
  * [Components ](https://react.dev/reference/react/components "Components")
    ...
    * [<ViewTransition> - This feature is available in the latest Canary version of React ](https://react.dev/reference/react/ViewTransition "<ViewTransition>")
  * [APIs ](https://react.dev/reference/react/apis "APIs")
    * [act ](https://react.dev/reference/react/act "act")
    * [addTransitionType - This feature is available in the latest Canary version of React ](https://react.dev/reference/react/addTransitionType "addTransitionType")
...
### react-dom@19.2
  ...
  * [Server APIs ](https://react.dev/reference/react-dom/server "Server APIs")
    ...
    * [resume ](https://react.dev/reference/react-dom/server/resume "resume")
    * [resumeToPipeableStream ](https://react.dev/reference/react-dom/server/resumeToPipeableStream "resumeToPipeableStream")
  * [Static APIs ](https://react.dev/reference/react-dom/static "Static APIs")
    * [prerender ](https://react.dev/reference/react-dom/static/prerender "prerender")
    * [prerenderToNodeStream ](https://react.dev/reference/react-dom/static/prerenderToNodeStream "prerenderToNodeStream")
    * [resumeAndPrerender ](https://react.dev/reference/react-dom/static/resumeAndPrerender "resumeAndPrerender")
    * [resumeAndPrerenderToNodeStream ](https://react.dev/reference/react-dom/static/resumeAndPrerenderToNodeStream "resumeAndPrerenderToNodeStream")
### React Compiler
...
### React DevTools
  * [React Performance tracks ](https://react.dev/reference/dev-tools/react-performance-tracks "React Performance tracks")
### eslint-plugin-react-hooks
  * [Lints ](https://react.dev/reference/eslint-plugin-react-hooks "Lints")
    * [exhaustive-deps ](https://react.dev/reference/eslint-plugin-react-hooks/lints/exhaustive-deps "exhaustive-deps")
    * [rules-of-hooks ](https://react.dev/reference/eslint-plugin-react-hooks/lints/rules-of-hooks "rules-of-hooks")
    * [component-hook-factories ](https://react.dev/reference/eslint-plugin-react-hooks/lints/component-hook-factories "component-hook-factories")
    * [config ](https://react.dev/reference/eslint-plugin-react-hooks/lints/config "config")
    * [error-boundaries ](https://react.dev/reference/eslint-plugin-react-hooks/lints/error-boundaries "error-boundaries")
    * [gating ](https://react.dev/reference/eslint-plugin-react-hooks/lints/gating "gating")
    * [globals ](https://react.dev/reference/eslint-plugin-react-hooks/lints/globals "globals")
    * [immutability ](https://react.dev/reference/eslint-plugin-react-hooks/lints/immutability "immutability")
    * [incompatible-library ](https://react.dev/reference/eslint-plugin-react-hooks/lints/incompatible-library "incompatible-library")
    * [preserve-manual-memoization ](https://react.dev/reference/eslint-plugin-react-hooks/lints/preserve-manual-memoization "preserve-manual-memoization")
    * [purity ](https://react.dev/reference/eslint-plugin-react-hooks/lints/purity "purity")
    * [refs ](https://react.dev/reference/eslint-plugin-react-hooks/lints/refs "refs")
    * [set-state-in-effect ](https://react.dev/reference/eslint-plugin-react-hooks/lints/set-state-in-effect "set-state-in-effect")
    * [set-state-in-render ](https://react.dev/reference/eslint-plugin-react-hooks/lints/set-state-in-render "set-state-in-render")
    * [static-components ](https://react.dev/reference/eslint-plugin-react-hooks/lints/static-components "static-components")
    * [unsupported-syntax ](https://react.dev/reference/eslint-plugin-react-hooks/lints/unsupported-syntax "unsupported-syntax")
    * [use-memo ](https://react.dev/reference/eslint-plugin-react-hooks/lints/use-memo "use-memo")
### Rules of React
...
## React Compiler [](https://react.dev/reference/react#react-compiler "Link for React Compiler ")
...
## ESLint Plugin React Hooks [](https://react.dev/reference/react#eslint-plugin-react-hooks "Link for ESLint Plugin React Hooks ")
...
## On this page
  ...
  * [React Compiler ](https://react.dev/reference/react#react-compiler)
  * [ESLint Plugin React Hooks ](https://react.dev/reference/react#eslint-plugin-react-hooks)
