[Skip to content](https://vuejs.org/guide/essentials/application.html#VPContent)
...
[简体中文 ](https://cn.vuejs.org/guide/essentials/application)
[日本語 ](https://ja.vuejs.org/guide/essentials/application)
[Українська ](https://ua.vuejs.org/guide/essentials/application)
[Français ](https://fr.vuejs.org/guide/essentials/application)
[한국어 ](https://ko.vuejs.org/guide/essentials/application)
[Português ](https://pt.vuejs.org/guide/essentials/application)
[বাংলা ](https://bn.vuejs.org/guide/essentials/application)
[Italiano ](https://it.vuejs.org/guide/essentials/application)
[فارسی ](https://fa.vuejs.org/guide/essentials/application)
[Русский ](https://ru.vuejs.org/guide/essentials/application)
[Čeština ](https://cs.vuejs.org/guide/essentials/application)
[繁體中文 ](https://zh-hk.vuejs.org/guide/essentials/application)
[Polski ](https://pl.vuejs.org/guide/essentials/application)
Help Us Translate!
Appearance
Menu
On this page
...
Table of Contents for current page
  ...
  * [Mounting the App](https://vuejs.org/guide/essentials/application.html#mounting-the-app)
...
# Creating a Vue Application [​](https://vuejs.org/guide/essentials/application.html#creating-a-vue-application)
## The Application Instance [​](https://vuejs.org/guide/essentials/application.html#the-application-instance)
...
### In-DOM Root Component Template [​](https://vuejs.org/guide/essentials/application.html#in-dom-root-component-template)
...
[Quick Start](https://vuejs.org/guide/quick-start)[Next Template Syntax](https://vuejs.org/guide/essentials/template-syntax)
