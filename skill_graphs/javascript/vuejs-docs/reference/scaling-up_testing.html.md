[Skip to content](https://vuejs.org/guide/scaling-up/testing.html#VPContent)
...
[简体中文 ](https://cn.vuejs.org/guide/scaling-up/testing)
[日本語 ](https://ja.vuejs.org/guide/scaling-up/testing)
[Українська ](https://ua.vuejs.org/guide/scaling-up/testing)
[Français ](https://fr.vuejs.org/guide/scaling-up/testing)
[한국어 ](https://ko.vuejs.org/guide/scaling-up/testing)
[Português ](https://pt.vuejs.org/guide/scaling-up/testing)
[বাংলা ](https://bn.vuejs.org/guide/scaling-up/testing)
[Italiano ](https://it.vuejs.org/guide/scaling-up/testing)
[فارسی ](https://fa.vuejs.org/guide/scaling-up/testing)
[Русский ](https://ru.vuejs.org/guide/scaling-up/testing)
[Čeština ](https://cs.vuejs.org/guide/scaling-up/testing)
[繁體中文 ](https://zh-hk.vuejs.org/guide/scaling-up/testing)
[Polski ](https://pl.vuejs.org/guide/scaling-up/testing)
Help Us Translate!
Appearance
Menu
On this page
...
Table of Contents for current page
  * [Why Test?](https://vuejs.org/guide/scaling-up/testing.html#why-test)
  * [When to Test](https://vuejs.org/guide/scaling-up/testing.html#when-to-test)
  * [Testing Types](https://vuejs.org/guide/scaling-up/testing.html#testing-types)
  * [Overview](https://vuejs.org/guide/scaling-up/testing.html#overview)
  * [Unit Testing](https://vuejs.org/guide/scaling-up/testing.html#unit-testing)
  * [Component Testing](https://vuejs.org/guide/scaling-up/testing.html#component-testing)
  * [E2E Testing](https://vuejs.org/guide/scaling-up/testing.html#e2e-testing)
  * [Recipes](https://vuejs.org/guide/scaling-up/testing.html#recipes)
...
# Testing [​](https://vuejs.org/guide/scaling-up/testing.html#testing)
## Why Test? [​](https://vuejs.org/guide/scaling-up/testing.html#why-test)
...
There is one Vue-specific section covering composables. See [Testing Composables](https://vuejs.org/guide/scaling-up/testing.html#testing-composables) below for more details.
## When to Test [​](https://vuejs.org/guide/scaling-up/testing.html#when-to-test)
...
### Composables [​](https://vuejs.org/guide/scaling-up/testing.html#composables)
One category of functions specific to Vue applications is [Composables](https://vuejs.org/guide/reusability/composables), which may require special handling during tests. See [Testing Composables](https://vuejs.org/guide/scaling-up/testing.html#testing-composables) below for more details.
### Unit Testing Components [​](https://vuejs.org/guide/scaling-up/testing.html#unit-testing-components)
...
Tests that are "Blackbox tests" are unaware of the implementation details of a component. These tests mock as little as possible to test the integration of your component and the entire system. They usually render all child components and are considered more of an "integration test". See the [Component Testing recommendations](https://vuejs.org/guide/scaling-up/testing.html#component-testing) below.


### Recommendation [​](https://vuejs.org/guide/scaling-up/testing.html#recommendation)
  * Since the official setup created by `create-vue` is based on


### Other Options [​](https://vuejs.org/guide/scaling-up/testing.html#other-options)
## Component Testing [​](https://vuejs.org/guide/scaling-up/testing.html#component-testing)
...
### Recommendation [​](https://vuejs.org/guide/scaling-up/testing.html#recommendation-1)
The main differences between Vitest and browser-based runners are speed and execution context. In short, browser-based runners, like Cypress, can catch issues that node-based runners, like Vitest, cannot (e.g. style issues, real native DOM events, cookies, local storage, and network failures), but browser-based runners are _orders of magnitude slower than Vitest_ because they do open a browser, compile your stylesheets, and more. Cypress is a browser-based runner that supports component testing. Please read
### Mounting Libraries [​](https://vuejs.org/guide/scaling-up/testing.html#mounting-libraries)
Component testing often involves mounting the component being tested in isolation, triggering simulated user input events, and asserting on the rendered DOM output. There are dedicated utility libraries that make these tasks simpler.
  * `@testing-library/vue` is built on top of.
...
### Other Options [​](https://vuejs.org/guide/scaling-up/testing.html#other-options-1)
## E2E Testing [​](https://vuejs.org/guide/scaling-up/testing.html#e2e-testing)
...
### Choosing an E2E Testing Solution [​](https://vuejs.org/guide/scaling-up/testing.html#choosing-an-e2e-testing-solution)
...
#### Cross-browser testing [​](https://vuejs.org/guide/scaling-up/testing.html#cross-browser-testing)
...
#### Faster feedback loops [​](https://vuejs.org/guide/scaling-up/testing.html#faster-feedback-loops)
...
#### First-class debugging experience [​](https://vuejs.org/guide/scaling-up/testing.html#first-class-debugging-experience)
...
#### Visibility in headless mode [​](https://vuejs.org/guide/scaling-up/testing.html#visibility-in-headless-mode)
...
### Recommendation [​](https://vuejs.org/guide/scaling-up/testing.html#recommendation-2)
### Other Options [​](https://vuejs.org/guide/scaling-up/testing.html#other-options-2)
## Recipes [​](https://vuejs.org/guide/scaling-up/testing.html#recipes)
### Adding Vitest to a Project [​](https://vuejs.org/guide/scaling-up/testing.html#adding-vitest-to-a-project)
...
For more complex composables, it could also be easier to test it by writing tests against the wrapper component using [Component Testing](https://vuejs.org/guide/scaling-up/testing.html#component-testing) techniques.
[State Management](https://vuejs.org/guide/scaling-up/state-management)[Next Server-Side Rendering (SSR)](https://vuejs.org/guide/scaling-up/ssr)
Testing has loaded
