[Skip to content](https://vuejs.org/guide/extras/ways-of-using-vue.html#VPContent)
...
[简体中文 ](https://cn.vuejs.org/guide/extras/ways-of-using-vue)
[日本語 ](https://ja.vuejs.org/guide/extras/ways-of-using-vue)
[Українська ](https://ua.vuejs.org/guide/extras/ways-of-using-vue)
[Français ](https://fr.vuejs.org/guide/extras/ways-of-using-vue)
[한국어 ](https://ko.vuejs.org/guide/extras/ways-of-using-vue)
[Português ](https://pt.vuejs.org/guide/extras/ways-of-using-vue)
[বাংলা ](https://bn.vuejs.org/guide/extras/ways-of-using-vue)
[Italiano ](https://it.vuejs.org/guide/extras/ways-of-using-vue)
[فارسی ](https://fa.vuejs.org/guide/extras/ways-of-using-vue)
[Русский ](https://ru.vuejs.org/guide/extras/ways-of-using-vue)
[Čeština ](https://cs.vuejs.org/guide/extras/ways-of-using-vue)
[繁體中文 ](https://zh-hk.vuejs.org/guide/extras/ways-of-using-vue)
[Polski ](https://pl.vuejs.org/guide/extras/ways-of-using-vue)
Help Us Translate!
Appearance
Menu
On this page
...
Table of Contents for current page
  * [Standalone Script](https://vuejs.org/guide/extras/ways-of-using-vue.html#standalone-script)
  * [Embedded Web Components](https://vuejs.org/guide/extras/ways-of-using-vue.html#embedded-web-components)
  * [Single-Page Application (SPA)](https://vuejs.org/guide/extras/ways-of-using-vue.html#single-page-application-spa)
  * [Fullstack / SSR](https://vuejs.org/guide/extras/ways-of-using-vue.html#fullstack-ssr)
  * [JAMStack / SSG](https://vuejs.org/guide/extras/ways-of-using-vue.html#jamstack-ssg)
  * [Beyond the Web](https://vuejs.org/guide/extras/ways-of-using-vue.html#beyond-the-web)
...
# Ways of Using Vue [​](https://vuejs.org/guide/extras/ways-of-using-vue.html#ways-of-using-vue)
...
We previously provided an alternative distribution called
## Embedded Web Components [​](https://vuejs.org/guide/extras/ways-of-using-vue.html#embedded-web-components)
...
There are two flavors of SSG: single-page and multi-page. Both flavors pre-render the site into static HTML, the difference is that:
  ...
  * A multi-page SSG loads a new page on every navigation. The upside is that it can ship minimal JS - or no JS at all if the page requires no interaction! Some multi-page SSG frameworks such as
...
Although Vue is primarily designed for building web applications, it is by no means limited to just the browser. You can:
  ...
  * Build 3D WebGL experiences with
  * Use Vue's [Custom Renderer API](https://vuejs.org/api/custom-renderer) to build custom renderers, like those for


[TS with Options API](https://vuejs.org/guide/typescript/options-api)[Next Composition API FAQ](https://vuejs.org/guide/extras/composition-api-faq)
