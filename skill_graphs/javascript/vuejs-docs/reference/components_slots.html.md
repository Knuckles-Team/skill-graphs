[Skip to content](https://vuejs.org/guide/components/slots.html#VPContent)
...
[简体中文 ](https://cn.vuejs.org/guide/components/slots)
[日本語 ](https://ja.vuejs.org/guide/components/slots)
[Українська ](https://ua.vuejs.org/guide/components/slots)
[Français ](https://fr.vuejs.org/guide/components/slots)
[한국어 ](https://ko.vuejs.org/guide/components/slots)
[Português ](https://pt.vuejs.org/guide/components/slots)
[বাংলা ](https://bn.vuejs.org/guide/components/slots)
[Italiano ](https://it.vuejs.org/guide/components/slots)
[فارسی ](https://fa.vuejs.org/guide/components/slots)
[Русский ](https://ru.vuejs.org/guide/components/slots)
[Čeština ](https://cs.vuejs.org/guide/components/slots)
[繁體中文 ](https://zh-hk.vuejs.org/guide/components/slots)
[Polski ](https://pl.vuejs.org/guide/components/slots)
Help Us Translate!
Appearance
Menu
On this page
...
Table of Contents for current page
  * [Slot Content and Outlet](https://vuejs.org/guide/components/slots.html#slot-content-and-outlet)
  ...
  * [Conditional Slots](https://vuejs.org/guide/components/slots.html#conditional-slots)
...
### Named Scoped Slots [​](https://vuejs.org/guide/components/slots.html#named-scoped-slots)
...
### Fancy List Example [​](https://vuejs.org/guide/components/slots.html#fancy-list-example)
...
### Renderless Components [​](https://vuejs.org/guide/components/slots.html#renderless-components)
...
[Fallthrough Attributes](https://vuejs.org/guide/components/attrs)[Next Provide / inject](https://vuejs.org/guide/components/provide-inject)
Slots has loaded
