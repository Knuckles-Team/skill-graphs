...
[简体中文 ](https://cn.vuejs.org/guide/essentials/forms)
[日本語 ](https://ja.vuejs.org/guide/essentials/forms)
[Українська ](https://ua.vuejs.org/guide/essentials/forms)
[Français ](https://fr.vuejs.org/guide/essentials/forms)
[한국어 ](https://ko.vuejs.org/guide/essentials/forms)
[Português ](https://pt.vuejs.org/guide/essentials/forms)
[বাংলা ](https://bn.vuejs.org/guide/essentials/forms)
[Italiano ](https://it.vuejs.org/guide/essentials/forms)
[فارسی ](https://fa.vuejs.org/guide/essentials/forms)
[Русский ](https://ru.vuejs.org/guide/essentials/forms)
[Čeština ](https://cs.vuejs.org/guide/essentials/forms)
[繁體中文 ](https://zh-hk.vuejs.org/guide/essentials/forms)
[Polski ](https://pl.vuejs.org/guide/essentials/forms)
Help Us Translate!
Appearance
Menu
On this page
...
Note
For languages that require an `v-model` doesn't get updated during IME composition. If you want to respond to these updates as well, use your own `input` event listener and `value` binding instead of using `v-model`.
### Multiline Text [​](https://vuejs.org/guide/essentials/forms.html#multiline-text)
template```
...
If the value cannot be parsed with `parseFloat()`, then the original (string) value is used instead. In particular, if the input is empty (for instance after the user clearing the input field), an empty string is returned. This behavior differs from the
...
[Event Handling](https://vuejs.org/guide/essentials/event-handling)[Next Watchers](https://vuejs.org/guide/essentials/watchers)
