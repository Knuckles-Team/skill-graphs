[Skip to content](https://vuejs.org/guide/extras/reactivity-in-depth.html#VPContent)
...
[简体中文 ](https://cn.vuejs.org/guide/extras/reactivity-in-depth)
[日本語 ](https://ja.vuejs.org/guide/extras/reactivity-in-depth)
[Українська ](https://ua.vuejs.org/guide/extras/reactivity-in-depth)
[Français ](https://fr.vuejs.org/guide/extras/reactivity-in-depth)
[한국어 ](https://ko.vuejs.org/guide/extras/reactivity-in-depth)
[Português ](https://pt.vuejs.org/guide/extras/reactivity-in-depth)
[বাংলা ](https://bn.vuejs.org/guide/extras/reactivity-in-depth)
[Italiano ](https://it.vuejs.org/guide/extras/reactivity-in-depth)
[فارسی ](https://fa.vuejs.org/guide/extras/reactivity-in-depth)
[Русский ](https://ru.vuejs.org/guide/extras/reactivity-in-depth)
[Čeština ](https://cs.vuejs.org/guide/extras/reactivity-in-depth)
[繁體中文 ](https://zh-hk.vuejs.org/guide/extras/reactivity-in-depth)
[Polski ](https://pl.vuejs.org/guide/extras/reactivity-in-depth)
Help Us Translate!
Appearance
Menu
On this page
...
Table of Contents for current page
  * [What is Reactivity?](https://vuejs.org/guide/extras/reactivity-in-depth.html#what-is-reactivity)
  * [How Reactivity Works in Vue](https://vuejs.org/guide/extras/reactivity-in-depth.html#how-reactivity-works-in-vue)
  * [Runtime vs. Compile-time Reactivity](https://vuejs.org/guide/extras/reactivity-in-depth.html#runtime-vs-compile-time-reactivity)
  * [Reactivity Debugging](https://vuejs.org/guide/extras/reactivity-in-depth.html#reactivity-debugging)
    * [Component Debugging Hooks](https://vuejs.org/guide/extras/reactivity-in-depth.html#component-debugging-hooks)
    * [Computed Debugging](https://vuejs.org/guide/extras/reactivity-in-depth.html#computed-debugging)
    * [Watcher Debugging](https://vuejs.org/guide/extras/reactivity-in-depth.html#watcher-debugging)
  * [Integration with External State Systems](https://vuejs.org/guide/extras/reactivity-in-depth.html#integration-with-external-state-systems)
    ...
    * [RxJS](https://vuejs.org/guide/extras/reactivity-in-depth.html#rxjs)
  * [Connection to Signals](https://vuejs.org/guide/extras/reactivity-in-depth.html#connection-to-signals)
    * [API Design Trade-Offs](https://vuejs.org/guide/extras/reactivity-in-depth.html#api-design-trade-offs)
...
# Reactivity in Depth [​](https://vuejs.org/guide/extras/reactivity-in-depth.html#reactivity-in-depth)
...
The Vue team did explore this direction via an experimental feature called [Reactivity Transform](https://vuejs.org/guide/extras/reactivity-transform), but in the end we have decided that it would not be a good fit for the project due to
## Reactivity Debugging [​](https://vuejs.org/guide/extras/reactivity-in-depth.html#reactivity-debugging)
...
#### Solid Signals [​](https://vuejs.org/guide/extras/reactivity-in-depth.html#solid-signals)
...
#### Angular Signals [​](https://vuejs.org/guide/extras/reactivity-in-depth.html#angular-signals)
...
[Composition API FAQ](https://vuejs.org/guide/extras/composition-api-faq)[Next Rendering Mechanism](https://vuejs.org/guide/extras/rendering-mechanism)
