[Skip to content](https://vuejs.org/guide/extras/animation.html#VPContent)
...
[简体中文 ](https://cn.vuejs.org/guide/extras/animation)
[日本語 ](https://ja.vuejs.org/guide/extras/animation)
[Українська ](https://ua.vuejs.org/guide/extras/animation)
[Français ](https://fr.vuejs.org/guide/extras/animation)
[한국어 ](https://ko.vuejs.org/guide/extras/animation)
[Português ](https://pt.vuejs.org/guide/extras/animation)
[বাংলা ](https://bn.vuejs.org/guide/extras/animation)
[Italiano ](https://it.vuejs.org/guide/extras/animation)
[فارسی ](https://fa.vuejs.org/guide/extras/animation)
[Русский ](https://ru.vuejs.org/guide/extras/animation)
[Čeština ](https://cs.vuejs.org/guide/extras/animation)
[繁體中文 ](https://zh-hk.vuejs.org/guide/extras/animation)
[Polski ](https://pl.vuejs.org/guide/extras/animation)
Help Us Translate!
Appearance
Menu
On this page
...
Table of Contents for current page
  * [Class-based Animations](https://vuejs.org/guide/extras/animation.html#class-based-animations)
  * [State-driven Animations](https://vuejs.org/guide/extras/animation.html#state-driven-animations)
  * [Animating with Watchers](https://vuejs.org/guide/extras/animation.html#animating-with-watchers)
...
# Animation Techniques [​](https://vuejs.org/guide/extras/animation.html#animation-techniques)
