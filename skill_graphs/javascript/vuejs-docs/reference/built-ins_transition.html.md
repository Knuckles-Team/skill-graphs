[Skip to content](https://vuejs.org/guide/built-ins/transition.html#VPContent)
...
[简体中文 ](https://cn.vuejs.org/guide/built-ins/transition)
[日本語 ](https://ja.vuejs.org/guide/built-ins/transition)
[Українська ](https://ua.vuejs.org/guide/built-ins/transition)
[Français ](https://fr.vuejs.org/guide/built-ins/transition)
[한국어 ](https://ko.vuejs.org/guide/built-ins/transition)
[Português ](https://pt.vuejs.org/guide/built-ins/transition)
[বাংলা ](https://bn.vuejs.org/guide/built-ins/transition)
[Italiano ](https://it.vuejs.org/guide/built-ins/transition)
[فارسی ](https://fa.vuejs.org/guide/built-ins/transition)
[Русский ](https://ru.vuejs.org/guide/built-ins/transition)
[Čeština ](https://cs.vuejs.org/guide/built-ins/transition)
[繁體中文 ](https://zh-hk.vuejs.org/guide/built-ins/transition)
[Polski ](https://pl.vuejs.org/guide/built-ins/transition)
Help Us Translate!
Appearance
Menu
On this page
...
Table of Contents for current page
  * [The <Transition> Component](https://vuejs.org/guide/built-ins/transition.html#the-transition-component)
  * [CSS-Based Transitions](https://vuejs.org/guide/built-ins/transition.html#css-based-transitions)
  * [JavaScript Hooks](https://vuejs.org/guide/built-ins/transition.html#javascript-hooks)
  * [Reusable Transitions](https://vuejs.org/guide/built-ins/transition.html#reusable-transitions)
  * [Transition on Appear](https://vuejs.org/guide/built-ins/transition.html#transition-on-appear)
  * [Transition Between Elements](https://vuejs.org/guide/built-ins/transition.html#transition-between-elements)
  * [Transition Modes](https://vuejs.org/guide/built-ins/transition.html#transition-modes)
  * [Transition Between Components](https://vuejs.org/guide/built-ins/transition.html#transition-between-components)
  * [Dynamic Transitions](https://vuejs.org/guide/built-ins/transition.html#dynamic-transitions)
  * [Transitions with the Key Attribute](https://vuejs.org/guide/built-ins/transition.html#transitions-with-the-key-attribute)
...
## CSS-Based Transitions [​](https://vuejs.org/guide/built-ins/transition.html#css-based-transitions)
### Transition Classes [​](https://vuejs.org/guide/built-ins/transition.html#transition-classes)
...
### Named Transitions [​](https://vuejs.org/guide/built-ins/transition.html#named-transitions)
...
### CSS Transitions [​](https://vuejs.org/guide/built-ins/transition.html#css-transitions)
`<Transition>` is most commonly used in combination with `transition` CSS property is a shorthand that allows us to specify multiple aspects of a transition, including properties that should be animated, duration of the transition, and
...
### CSS Animations [​](https://vuejs.org/guide/built-ins/transition.html#css-animations)
`*-enter-from` is not removed immediately after the element is inserted, but on an `animationend` event.
...
### Using Transitions and Animations Together [​](https://vuejs.org/guide/built-ins/transition.html#using-transitions-and-animations-together)
...
### Nested Transitions and Explicit Transition Durations [​](https://vuejs.org/guide/built-ins/transition.html#nested-transitions-and-explicit-transition-durations)
...
### Performance Considerations [​](https://vuejs.org/guide/built-ins/transition.html#performance-considerations)
...
[Plugins](https://vuejs.org/guide/reusability/plugins)[Next TransitionGroup](https://vuejs.org/guide/built-ins/transition-group)
