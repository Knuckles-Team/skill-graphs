[Skip to content](https://vuejs.org/guide/extras/web-components.html#VPContent)
...
[简体中文 ](https://cn.vuejs.org/guide/extras/web-components)
[日本語 ](https://ja.vuejs.org/guide/extras/web-components)
[Українська ](https://ua.vuejs.org/guide/extras/web-components)
[Français ](https://fr.vuejs.org/guide/extras/web-components)
[한국어 ](https://ko.vuejs.org/guide/extras/web-components)
[Português ](https://pt.vuejs.org/guide/extras/web-components)
[বাংলা ](https://bn.vuejs.org/guide/extras/web-components)
[Italiano ](https://it.vuejs.org/guide/extras/web-components)
[فارسی ](https://fa.vuejs.org/guide/extras/web-components)
[Русский ](https://ru.vuejs.org/guide/extras/web-components)
[Čeština ](https://cs.vuejs.org/guide/extras/web-components)
[繁體中文 ](https://zh-hk.vuejs.org/guide/extras/web-components)
[Polski ](https://pl.vuejs.org/guide/extras/web-components)
Help Us Translate!
Appearance
Menu
On this page
...
Table of Contents for current page
  ...
  * [Building Custom Elements with Vue](https://vuejs.org/guide/extras/web-components.html#building-custom-elements-with-vue)
  * [Non-Vue Web Components and TypeScript](https://vuejs.org/guide/extras/web-components.html#non-vue-web-components-and-typescript)
  * [Web Components vs. Vue Components](https://vuejs.org/guide/extras/web-components.html#web-components-vs-vue-components)
...
# Vue and Web Components [​](https://vuejs.org/guide/extras/web-components.html#vue-and-web-components)
...
#### Example In-Browser Config [​](https://vuejs.org/guide/extras/web-components.html#example-in-browser-config)
js```
...
#### Example Vite Config [​](https://vuejs.org/guide/extras/web-components.html#example-vite-config)
vite.config.js
js```
...
#### Example Vue CLI Config [​](https://vuejs.org/guide/extras/web-components.html#example-vue-cli-config)
vue.config.js
js```
module.exports = {
  chainWebpack: (config) => {
...
### Passing DOM Properties [​](https://vuejs.org/guide/extras/web-components.html#passing-dom-properties)
Since DOM attributes can only be strings, we need to pass complex data to custom elements as DOM properties. When setting props on a custom element, Vue 3 automatically checks DOM-property presence using the `in` operator and will prefer setting the value as a DOM property if the key is present. This means that, in most cases, you won't need to think about this if the custom element follows the
...
### defineCustomElement [​](https://vuejs.org/guide/extras/web-components.html#definecustomelement)
...
#### Lifecycle [​](https://vuejs.org/guide/extras/web-components.html#lifecycle)
...
#### Props [​](https://vuejs.org/guide/extras/web-components.html#props)
...
#### Events [​](https://vuejs.org/guide/extras/web-components.html#events)
Events emitted via `this.$emit` or setup `emit` are dispatched as native `detail` property.
#### Slots [​](https://vuejs.org/guide/extras/web-components.html#slots)
Inside the component, slots can be rendered using the `<slot/>` element as usual. However, when consuming the resulting element, it only accepts
...
#### Provide / Inject [​](https://vuejs.org/guide/extras/web-components.html#provide-inject)
...
#### App Level Config [​](https://vuejs.org/guide/extras/web-components.html#app-level-config)
...
### SFC as Custom Element [​](https://vuejs.org/guide/extras/web-components.html#sfc-as-custom-element)
...
### Tips for a Vue Custom Elements Library [​](https://vuejs.org/guide/extras/web-components.html#tips-for-a-vue-custom-elements-library)
When building custom elements with Vue, the elements will rely on Vue's runtime. There is a ~16kb baseline size cost depending on how many features are being used. This means it is not ideal to use Vue if you are shipping a single custom element - you may want to use vanilla JavaScript,
...
### Vue-based Web Components and TypeScript [​](https://vuejs.org/guide/extras/web-components.html#web-components-and-typescript)
...
ts```
// We can reuse this type helper per each element we need to define.
...
There is indeed a certain level of feature overlap between Custom Elements and Vue Components: they both allow us to define reusable components with data passing, event emitting, and lifecycle management. However, Web Components APIs are relatively low-level and bare-bones. To build an actual application, we need quite a few additional capabilities which the platform does not cover:
  ...
  * A performant way to render the components on the server and hydrate them on the client (SSR), which is important for SEO and
...
There are also some areas where we find custom elements to be limiting:
  ...
  * Shipping custom elements with shadow DOM scoped CSS today requires embedding the CSS inside JavaScript so that they can be injected into shadow roots at runtime. They also result in duplicated styles in markup in SSR scenarios. There are [CSS scoping mechanisms](https://vuejs.org/api/sfc-css-features) that support extracting the styles into plain CSS files.
...
[Render Functions & JSX](https://vuejs.org/guide/extras/render-function)[Next Animation Techniques](https://vuejs.org/guide/extras/animation)
