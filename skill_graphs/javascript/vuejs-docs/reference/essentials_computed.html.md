[Skip to content](https://vuejs.org/guide/essentials/computed.html#VPContent)
...
[简体中文 ](https://cn.vuejs.org/guide/essentials/computed)
[日本語 ](https://ja.vuejs.org/guide/essentials/computed)
[Українська ](https://ua.vuejs.org/guide/essentials/computed)
[Français ](https://fr.vuejs.org/guide/essentials/computed)
[한국어 ](https://ko.vuejs.org/guide/essentials/computed)
[Português ](https://pt.vuejs.org/guide/essentials/computed)
[বাংলা ](https://bn.vuejs.org/guide/essentials/computed)
[Italiano ](https://it.vuejs.org/guide/essentials/computed)
[فارسی ](https://fa.vuejs.org/guide/essentials/computed)
[Русский ](https://ru.vuejs.org/guide/essentials/computed)
[Čeština ](https://cs.vuejs.org/guide/essentials/computed)
[繁體中文 ](https://zh-hk.vuejs.org/guide/essentials/computed)
[Polski ](https://pl.vuejs.org/guide/essentials/computed)
Help Us Translate!
Appearance
Menu
On this page
...
Table of Contents for current page
  * [Basic Example](https://vuejs.org/guide/essentials/computed.html#basic-example)
  * [Computed Caching vs. Methods](https://vuejs.org/guide/essentials/computed.html#computed-caching-vs-methods)
  * [Writable Computed](https://vuejs.org/guide/essentials/computed.html#writable-computed)
  * [Getting the Previous Value](https://vuejs.org/guide/essentials/computed.html#previous)
  * [Best Practices](https://vuejs.org/guide/essentials/computed.html#best-practices)
...
Here we have declared a computed property `publishedBooksMessage`. The `computed()` function expects to be passed a **computed ref**. Similar to normal refs, you can access the computed result as `publishedBooksMessage.value`. Computed refs are also auto-unwrapped in templates so you can reference them without `.value` in template expressions.
...
## Best Practices [​](https://vuejs.org/guide/essentials/computed.html#best-practices)
### Getters should be side-effect free [​](https://vuejs.org/guide/essentials/computed.html#getters-should-be-side-effect-free)
...
[Reactivity Fundamentals](https://vuejs.org/guide/essentials/reactivity-fundamentals)[Next Class and Style Bindings](https://vuejs.org/guide/essentials/class-and-style)
