...
# Popover
[Previous](https://ui.shadcn.com/docs/components/radix/pagination)[Next](https://ui.shadcn.com/docs/components/radix/progress)
Displays rich content in a portal, triggered by a button.
[Radix UI](https://ui.shadcn.com/docs/components/radix/popover)[Base UI](https://ui.shadcn.com/docs/components/base/popover)
Radix UI
Open popover
Copy
```
...
## API Reference
See the
[Pagination](https://ui.shadcn.com/docs/components/radix/pagination)[Progress ](https://ui.shadcn.com/docs/components/radix/progress)
On This Page
[Installation](https://ui.shadcn.com/docs/components/radix/popover#installation)[Usage](https://ui.shadcn.com/docs/components/radix/popover#usage)[Examples](https://ui.shadcn.com/docs/components/radix/popover#examples)[Basic](https://ui.shadcn.com/docs/components/radix/popover#basic)[Align](https://ui.shadcn.com/docs/components/radix/popover#align)[With Form](https://ui.shadcn.com/docs/components/radix/popover#with-form)[RTL](https://ui.shadcn.com/docs/components/radix/popover#rtl)[API Reference](https://ui.shadcn.com/docs/components/radix/popover#api-reference)
