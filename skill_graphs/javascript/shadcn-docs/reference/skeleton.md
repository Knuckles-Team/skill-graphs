...
# Skeleton
[Previous](https://ui.shadcn.com/docs/components/radix/sidebar)[Next](https://ui.shadcn.com/docs/components/radix/slider)
Use to show a placeholder while content is loading.
[Radix UI](https://ui.shadcn.com/docs/components/radix/skeleton)[Base UI](https://ui.shadcn.com/docs/components/base/skeleton)
Radix UI
Copy
```
...
View Code
[Sidebar](https://ui.shadcn.com/docs/components/radix/sidebar)[Slider ](https://ui.shadcn.com/docs/components/radix/slider)
On This Page
[Installation](https://ui.shadcn.com/docs/components/radix/skeleton#installation)[Usage](https://ui.shadcn.com/docs/components/radix/skeleton#usage)[Examples](https://ui.shadcn.com/docs/components/radix/skeleton#examples)[Avatar](https://ui.shadcn.com/docs/components/radix/skeleton#avatar)[Card](https://ui.shadcn.com/docs/components/radix/skeleton#card)[Text](https://ui.shadcn.com/docs/components/radix/skeleton#text)[Form](https://ui.shadcn.com/docs/components/radix/skeleton#form)[Table](https://ui.shadcn.com/docs/components/radix/skeleton#table)[RTL](https://ui.shadcn.com/docs/components/radix/skeleton#rtl)
