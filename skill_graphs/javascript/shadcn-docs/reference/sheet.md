...
# Sheet
[Previous](https://ui.shadcn.com/docs/components/radix/separator)[Next](https://ui.shadcn.com/docs/components/radix/sidebar)
Extends the Dialog component to display content that complements the main content of the screen.
[Radix UI](https://ui.shadcn.com/docs/components/radix/sheet)[Base UI](https://ui.shadcn.com/docs/components/base/sheet)
Radix UI
Open
Copy
```
...
## API Reference
See the
[Separator](https://ui.shadcn.com/docs/components/radix/separator)[Sidebar ](https://ui.shadcn.com/docs/components/radix/sidebar)
On This Page
[Installation](https://ui.shadcn.com/docs/components/radix/sheet#installation)[Usage](https://ui.shadcn.com/docs/components/radix/sheet#usage)[Examples](https://ui.shadcn.com/docs/components/radix/sheet#examples)[Side](https://ui.shadcn.com/docs/components/radix/sheet#side)[No Close Button](https://ui.shadcn.com/docs/components/radix/sheet#no-close-button)[RTL](https://ui.shadcn.com/docs/components/radix/sheet#rtl)[API Reference](https://ui.shadcn.com/docs/components/radix/sheet#api-reference)
