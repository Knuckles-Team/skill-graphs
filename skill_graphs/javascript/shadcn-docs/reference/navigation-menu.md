...
# Navigation Menu
[Previous](https://ui.shadcn.com/docs/components/radix/native-select)[Next](https://ui.shadcn.com/docs/components/radix/pagination)
A collection of links for navigating websites.
[Radix UI](https://ui.shadcn.com/docs/components/radix/navigation-menu)[Base UI](https://ui.shadcn.com/docs/components/base/navigation-menu)
Radix UI
  * Getting started
  * Components
...
Arabic (العربية)Toggle
  * البدء
  * المكونات
  * [الوثائق](https://ui.shadcn.com/docs)
...
## API Reference
See the
[Native Select](https://ui.shadcn.com/docs/components/radix/native-select)[Pagination ](https://ui.shadcn.com/docs/components/radix/pagination)
On This Page
[Installation](https://ui.shadcn.com/docs/components/radix/navigation-menu#installation)[Usage](https://ui.shadcn.com/docs/components/radix/navigation-menu#usage)[Link Component](https://ui.shadcn.com/docs/components/radix/navigation-menu#link-component)[RTL](https://ui.shadcn.com/docs/components/radix/navigation-menu#rtl)[API Reference](https://ui.shadcn.com/docs/components/radix/navigation-menu#api-reference)
