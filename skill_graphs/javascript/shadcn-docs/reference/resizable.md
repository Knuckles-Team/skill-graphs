...
# Resizable
[Previous](https://ui.shadcn.com/docs/components/radix/radio-group)[Next](https://ui.shadcn.com/docs/components/radix/scroll-area)
Accessible resizable panel groups and layouts with keyboard support.
[Radix UI](https://ui.shadcn.com/docs/components/radix/resizable)[Base UI](https://ui.shadcn.com/docs/components/base/resizable)
Radix UI
One
Two
Three
...
[Radio Group](https://ui.shadcn.com/docs/components/radix/radio-group)[Scroll Area ](https://ui.shadcn.com/docs/components/radix/scroll-area)
On This Page
[About](https://ui.shadcn.com/docs/components/radix/resizable#about)[Installation](https://ui.shadcn.com/docs/components/radix/resizable#installation)[Usage](https://ui.shadcn.com/docs/components/radix/resizable#usage)[Examples](https://ui.shadcn.com/docs/components/radix/resizable#examples)[Vertical](https://ui.shadcn.com/docs/components/radix/resizable#vertical)[Handle](https://ui.shadcn.com/docs/components/radix/resizable#handle)[RTL](https://ui.shadcn.com/docs/components/radix/resizable#rtl)[API Reference](https://ui.shadcn.com/docs/components/radix/resizable#api-reference)[Changelog](https://ui.shadcn.com/docs/components/radix/resizable#changelog)[2025-02-02 `react-resizable-panels` v4](https://ui.shadcn.com/docs/components/radix/resizable#2025-02-02-react-resizable-panels-v4)
