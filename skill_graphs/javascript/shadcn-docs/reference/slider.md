...
# Slider
[Previous](https://ui.shadcn.com/docs/components/radix/skeleton)[Next](https://ui.shadcn.com/docs/components/radix/sonner)
An input where the user selects a value from within a given range.
[Radix UI](https://ui.shadcn.com/docs/components/radix/slider)[Base UI](https://ui.shadcn.com/docs/components/base/slider)
Radix UI
Copy
```
...
## API Reference
See the
[Skeleton](https://ui.shadcn.com/docs/components/radix/skeleton)[Sonner ](https://ui.shadcn.com/docs/components/radix/sonner)
On This Page
[Installation](https://ui.shadcn.com/docs/components/radix/slider#installation)[Usage](https://ui.shadcn.com/docs/components/radix/slider#usage)[Examples](https://ui.shadcn.com/docs/components/radix/slider#examples)[Range](https://ui.shadcn.com/docs/components/radix/slider#range)[Multiple Thumbs](https://ui.shadcn.com/docs/components/radix/slider#multiple-thumbs)[Vertical](https://ui.shadcn.com/docs/components/radix/slider#vertical)[Controlled](https://ui.shadcn.com/docs/components/radix/slider#controlled)[Disabled](https://ui.shadcn.com/docs/components/radix/slider#disabled)[RTL](https://ui.shadcn.com/docs/components/radix/slider#rtl)[API Reference](https://ui.shadcn.com/docs/components/radix/slider#api-reference)
