...
# Separator
[Previous](https://ui.shadcn.com/docs/components/radix/select)[Next](https://ui.shadcn.com/docs/components/radix/sheet)
Visually or semantically separates content.
[Radix UI](https://ui.shadcn.com/docs/components/radix/separator)[Base UI](https://ui.shadcn.com/docs/components/base/separator)
Radix UI
shadcn/ui
...
## API Reference
See the
[Select](https://ui.shadcn.com/docs/components/radix/select)[Sheet ](https://ui.shadcn.com/docs/components/radix/sheet)
On This Page
[Installation](https://ui.shadcn.com/docs/components/radix/separator#installation)[Usage](https://ui.shadcn.com/docs/components/radix/separator#usage)[Examples](https://ui.shadcn.com/docs/components/radix/separator#examples)[Vertical](https://ui.shadcn.com/docs/components/radix/separator#vertical)[Menu](https://ui.shadcn.com/docs/components/radix/separator#menu)[List](https://ui.shadcn.com/docs/components/radix/separator#list)[RTL](https://ui.shadcn.com/docs/components/radix/separator#rtl)[API Reference](https://ui.shadcn.com/docs/components/radix/separator#api-reference)
