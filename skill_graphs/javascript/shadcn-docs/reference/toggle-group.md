...
# Toggle Group
[Previous](https://ui.shadcn.com/docs/components/radix/toggle)[Next](https://ui.shadcn.com/docs/components/radix/tooltip)
A set of two-state buttons that can be toggled on or off.
[Radix UI](https://ui.shadcn.com/docs/components/radix/toggle-group)[Base UI](https://ui.shadcn.com/docs/components/base/toggle-group)
Radix UI
Copy
```
...
## API Reference
See the
[Toggle](https://ui.shadcn.com/docs/components/radix/toggle)[Tooltip ](https://ui.shadcn.com/docs/components/radix/tooltip)
On This Page
[Installation](https://ui.shadcn.com/docs/components/radix/toggle-group#installation)[Usage](https://ui.shadcn.com/docs/components/radix/toggle-group#usage)[Examples](https://ui.shadcn.com/docs/components/radix/toggle-group#examples)[Outline](https://ui.shadcn.com/docs/components/radix/toggle-group#outline)[Size](https://ui.shadcn.com/docs/components/radix/toggle-group#size)[Spacing](https://ui.shadcn.com/docs/components/radix/toggle-group#spacing)[Vertical](https://ui.shadcn.com/docs/components/radix/toggle-group#vertical)[Disabled](https://ui.shadcn.com/docs/components/radix/toggle-group#disabled)[Custom](https://ui.shadcn.com/docs/components/radix/toggle-group#custom)[RTL](https://ui.shadcn.com/docs/components/radix/toggle-group#rtl)[API Reference](https://ui.shadcn.com/docs/components/radix/toggle-group#api-reference)
