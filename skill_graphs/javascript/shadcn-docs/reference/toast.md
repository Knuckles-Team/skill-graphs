...
# Toast
[Previous](https://ui.shadcn.com/docs/components/radix/textarea)[Next](https://ui.shadcn.com/docs/components/radix/toggle)
A succinct message that is displayed temporarily.
[Radix UI](https://ui.shadcn.com/docs/components/radix/toast)[Base UI](https://ui.shadcn.com/docs/components/base/toast)
Radix UI
The toast component has been deprecated. Use the [sonner](https://ui.shadcn.com/docs/components/sonner) component instead.
[Textarea](https://ui.shadcn.com/docs/components/radix/textarea)[Toggle ](https://ui.shadcn.com/docs/components/radix/toggle)
