...
# Progress
[Previous](https://ui.shadcn.com/docs/components/radix/popover)[Next](https://ui.shadcn.com/docs/components/radix/radio-group)
Displays an indicator showing the completion progress of a task, typically displayed as a progress bar.
[Radix UI](https://ui.shadcn.com/docs/components/radix/progress)[Base UI](https://ui.shadcn.com/docs/components/base/progress)
Radix UI
Copy
```
"use client"
...
## API Reference
See the
[Popover](https://ui.shadcn.com/docs/components/radix/popover)[Radio Group ](https://ui.shadcn.com/docs/components/radix/radio-group)
On This Page
[Installation](https://ui.shadcn.com/docs/components/radix/progress#installation)[Usage](https://ui.shadcn.com/docs/components/radix/progress#usage)[Examples](https://ui.shadcn.com/docs/components/radix/progress#examples)[Label](https://ui.shadcn.com/docs/components/radix/progress#label)[Controlled](https://ui.shadcn.com/docs/components/radix/progress#controlled)[RTL](https://ui.shadcn.com/docs/components/radix/progress#rtl)[API Reference](https://ui.shadcn.com/docs/components/radix/progress#api-reference)
