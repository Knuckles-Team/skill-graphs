...
# Open in v0
[Previous](https://ui.shadcn.com/docs/registry/registry-index)[Next](https://ui.shadcn.com/docs/registry/registry-json)
...
[Add a Registry](https://ui.shadcn.com/docs/registry/registry-index)[registry.json ](https://ui.shadcn.com/docs/registry/registry-json)
On This Page
[Button](https://ui.shadcn.com/docs/registry/open-in-v0#button)[Authentication](https://ui.shadcn.com/docs/registry/open-in-v0#authentication)[Using Query Parameter Authentication](https://ui.shadcn.com/docs/registry/open-in-v0#using-query-parameter-authentication)[Example Implementation](https://ui.shadcn.com/docs/registry/open-in-v0#example-implementation)
