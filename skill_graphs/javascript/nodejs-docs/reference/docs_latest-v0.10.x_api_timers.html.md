![node.js](https://nodejs.org/docs/latest-v0.10.x/api/assets/logo.svg)
...
[Index](https://nodejs.org/docs/latest-v0.10.x/api/index.html) | [View on single page](https://nodejs.org/docs/latest-v0.10.x/api/all.html) | [View as JSON](https://nodejs.org/docs/latest-v0.10.x/api/timers.json)
* * *
## Table of Contents
  * [Timers](https://nodejs.org/docs/latest-v0.10.x/api/timers.html#timers_timers)
    * [setTimeout(callback, delay, [arg], [...])](https://nodejs.org/docs/latest-v0.10.x/api/timers.html#timers_settimeout_callback_delay_arg)
    * [clearTimeout(timeoutObject)](https://nodejs.org/docs/latest-v0.10.x/api/timers.html#timers_cleartimeout_timeoutobject)
    * [setInterval(callback, delay, [arg], [...])](https://nodejs.org/docs/latest-v0.10.x/api/timers.html#timers_setinterval_callback_delay_arg)
    * [clearInterval(intervalObject)](https://nodejs.org/docs/latest-v0.10.x/api/timers.html#timers_clearinterval_intervalobject)
    * [unref()](https://nodejs.org/docs/latest-v0.10.x/api/timers.html#timers_unref)
    * [ref()](https://nodejs.org/docs/latest-v0.10.x/api/timers.html#timers_ref)
    * [setImmediate(callback, [arg], [...])](https://nodejs.org/docs/latest-v0.10.x/api/timers.html#timers_setimmediate_callback_arg)
    * [clearImmediate(immediateObject)](https://nodejs.org/docs/latest-v0.10.x/api/timers.html#timers_clearimmediate_immediateobject)
