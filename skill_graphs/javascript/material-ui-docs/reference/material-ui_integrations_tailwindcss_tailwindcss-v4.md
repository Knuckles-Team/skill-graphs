[Skip to content](https://mui.com/material-ui/integrations/tailwindcss/tailwindcss-v4/#main-content)
[](https://mui.com/)
Search…`Ctrl+K`3
...
## [Overview](https://mui.com/material-ui/integrations/tailwindcss/tailwindcss-v4/#overview)
...
### [Next.js App Router](https://mui.com/material-ui/integrations/tailwindcss/tailwindcss-v4/#next-js-app-router)
To integrate Tailwind CSS v4 with Material UI in a Next.js App Router project, start by configuring Material UI with Next.js in the [App Router integration guide](https://mui.com/material-ui/integrations/nextjs/#app-router). Then follow these steps:
  1. Enable the [CSS layer feature](https://mui.com/material-ui/integrations/nextjs/#using-other-styling-solutions) in the root layout:
...
```
CopyCopied(or Ctrl + C)
### [Next.js Pages Router](https://mui.com/material-ui/integrations/tailwindcss/tailwindcss-v4/#next-js-pages-router)
To integrate Tailwind CSS v4 with Material UI in a Next.js Pages Router project, start by configuring Material UI with Next.js in the [Pages Router integration guide](https://mui.com/material-ui/integrations/nextjs/#pages-router). Then follow these steps:
...
> `enableCssLayer: true` ensures Material UI styles are wrapped in `@layer mui`, which allows Tailwind CSS v4 utilities to override them predictably.
  2. Enable the [CSS layer feature](https://mui.com/material-ui/integrations/nextjs/#configuration-2) in a custom `_document`:
...
```
CopyCopied(or Ctrl + C)
### [Vite.js or any other SPA](https://mui.com/material-ui/integrations/tailwindcss/tailwindcss-v4/#vite-js-or-any-other-spa)
...
```
CopyCopied(or Ctrl + C)
## [Tailwind CSS IntelliSense for VS Code](https://mui.com/material-ui/integrations/tailwindcss/tailwindcss-v4/#tailwind-css-intellisense-for-vs-code)
The official
```
{
  // ...config
...
![A preview of Tailwind CSS Intellisense](https://mui.com/static/material-ui/tailwind-intellisense.jpg)
## [Usage](https://mui.com/material-ui/integrations/tailwindcss/tailwindcss-v4/#usage)
  * Use the `className` prop to apply Tailwind CSS classes to the root element of the component.
  * Use `slotProps.{slotName}.className` to apply Tailwind CSS classes to a component's [interior slots](https://mui.com/material-ui/customization/overriding-component-structure/#interior-slots).
...
JSTS
Show code
## [Extend Material UI classes](https://mui.com/material-ui/integrations/tailwindcss/tailwindcss-v4/#extend-material-ui-classes)
...
```
CopyCopied(or Ctrl + C)
### [Playground](https://mui.com/material-ui/integrations/tailwindcss/tailwindcss-v4/#playground)
Visit the
## [Troubleshooting](https://mui.com/material-ui/integrations/tailwindcss/tailwindcss-v4/#troubleshooting)
If the Tailwind CSS classes are not overriding Material UI components, make sure that:
  * You are using Tailwind CSS >= v4.
  * You have configured the layer order correctly by checking the `mui` layer should come before the `utilities` layer.


Was this page helpful?
* * *
[](https://mui.com/material-ui/guides/content-security-policy/)[Next.js integration](https://mui.com/material-ui/integrations/nextjs/)
* * *
[](https://mui.com/)
•
...
Material UIv7.3.9
  ...
  * [](https://mui.com/material-ui/integrations/tailwindcss/tailwindcss-v4/)
    * [Tailwind CSS v4 integrationNew](https://mui.com/material-ui/integrations/tailwindcss/tailwindcss-v4/)
    * [Next.js integrationNew](https://mui.com/material-ui/integrations/nextjs/)
    * [Routing libraries](https://mui.com/material-ui/integrations/routing/)
    * [Usage with styled-components](https://mui.com/material-ui/integrations/styled-components/)
    * [Style library interoperability](https://mui.com/material-ui/integrations/interoperability/)
    * [Theme scoping](https://mui.com/material-ui/integrations/theme-scoping/)
