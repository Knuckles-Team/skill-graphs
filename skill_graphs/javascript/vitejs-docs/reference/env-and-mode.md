...
[Skip to content](https://vite.dev/guide/env-and-mode#VPContent)
...
Search`⌘``Ctrl``K`
English
[简体中文](https://cn.vite.dev/guide/env-and-mode)
[日本語](https://ja.vite.dev/guide/env-and-mode)
[Español](https://es.vite.dev/guide/env-and-mode)
[Português](https://pt.vite.dev/guide/env-and-mode)
[한국어](https://ko.vite.dev/guide/env-and-mode)
[Deutsch](https://de.vite.dev/guide/env-and-mode)
[فارسی](https://fa.vite.dev/guide/env-and-mode)
Appearance
[](https://chat.vite.dev)
English
[简体中文](https://cn.vite.dev/guide/env-and-mode)
...
On this page
  * [Built-in Constants](https://vite.dev/guide/env-and-mode#built-in-constants "Built-in Constants")
  * [Env Variables](https://vite.dev/guide/env-and-mode#env-variables "Env Variables")
    * [.env Files](https://vite.dev/guide/env-and-mode#env-files ".env Files")
  * [IntelliSense for TypeScript](https://vite.dev/guide/env-and-mode#intellisense-for-typescript "IntelliSense for TypeScript")
  * [HTML Constant Replacement](https://vite.dev/guide/env-and-mode#html-constant-replacement "HTML Constant Replacement")
  * [Modes](https://vite.dev/guide/env-and-mode#modes "Modes")
    * [NODE_ENV and Modes](https://vite.dev/guide/env-and-mode#node-env-and-modes "NODE_ENV and Modes")

Are you an LLM? You can read better optimized documentation at /guide/env-and-mode.md for this page in Markdown format
# Env Variables and Modes [​](https://vite.dev/guide/env-and-mode#env-variables-and-modes)
...
## Env Variables [​](https://vite.dev/guide/env-and-mode#env-variables)
...
###  `.env` Files [​](https://vite.dev/guide/env-and-mode#env-files)
Vite uses [environment directory](https://vite.dev/config/shared-options#envdir):
...
Bun users
When using `.env` files before your script runs. This built-in behavior loads environment variables directly into `process.env` and can interfere with Vite's feature, as it respects existing `process.env` values. See
Also, Vite uses
...
## IntelliSense for TypeScript [​](https://vite.dev/guide/env-and-mode#intellisense-for-typescript)
By default, Vite provides type definitions for `import.meta.env` in `.env.[mode]` files, you may want to get TypeScript IntelliSense for user-defined env variables that are prefixed with `VITE_`.
...
If your code relies on types from browser environments such as `tsconfig.json`.
tsconfig.json
json
```
{
...
If the `ImportMetaEnv` augmentation does not work, make sure you do not have any `import` statements in `vite-env.d.ts`. See the
## HTML Constant Replacement [​](https://vite.dev/guide/env-and-mode#html-constant-replacement)
...
Given that Vite is used by many frameworks, it is intentionally unopinionated about complex replacements like conditionals. Vite can be extended using [`transformIndexHtml` hook](https://vite.dev/guide/api-plugin#transformindexhtml).
## Modes [​](https://vite.dev/guide/env-and-mode#modes)
...
### NODE_ENV and Modes [​](https://vite.dev/guide/env-and-mode#node-env-and-modes)
...
Pager
[Previous pageDeploying a Static Site](https://vite.dev/guide/static-deploy)
[Next pageServer-Side Rendering (SSR)](https://vite.dev/guide/ssr)
