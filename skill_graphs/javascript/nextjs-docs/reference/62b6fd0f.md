## Migration to Proxy[](https://nextjs.org/docs/pages/api-reference/file-conventions/proxy#migration-to-proxy)
### Why the Change[](https://nextjs.org/docs/pages/api-reference/file-conventions/proxy#why-the-change)
...
### Why "Proxy"[](https://nextjs.org/docs/pages/api-reference/file-conventions/proxy#why-proxy)
...
### How to Migrate[](https://nextjs.org/docs/pages/api-reference/file-conventions/proxy#how-to-migrate)
