...
[Previousexperimental.adapterPath](https://nextjs.org/docs/app/api-reference/config/next-config-js/adapterPath)[NextappDir](https://nextjs.org/docs/app/api-reference/config/next-config-js/appDir)
Was this helpful?
Send
* * *
* * *
