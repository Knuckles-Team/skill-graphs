## Creating an Adapter[](https://nextjs.org/docs/pages/api-reference/config/next-config-js/adapterPath#creating-an-adapter)
...
### Basic Adapter Structure[](https://nextjs.org/docs/pages/api-reference/config/next-config-js/adapterPath#basic-adapter-structure)
