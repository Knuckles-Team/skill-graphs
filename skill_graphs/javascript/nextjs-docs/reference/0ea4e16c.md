## Before going to production[](https://nextjs.org/docs/pages/guides/production-checklist#before-going-to-production)
...
### Core Web Vitals[](https://nextjs.org/docs/pages/guides/production-checklist#core-web-vitals)
### Analyzing bundles[](https://nextjs.org/docs/pages/guides/production-checklist#analyzing-bundles)
