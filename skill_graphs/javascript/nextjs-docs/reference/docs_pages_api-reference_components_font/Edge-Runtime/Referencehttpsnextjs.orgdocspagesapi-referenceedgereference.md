...
### Network APIs[](https://nextjs.org/docs/pages/api-reference/edge#network-apis)
API | Description
---|---
| Represents a blob
| Fetches a resource
...
### Encoding APIs[](https://nextjs.org/docs/pages/api-reference/edge#encoding-apis)
API | Description
---|---
...
### Stream APIs[](https://nextjs.org/docs/pages/api-reference/edge#stream-apis)
API | Description
---|---
...
### Crypto APIs[](https://nextjs.org/docs/pages/api-reference/edge#crypto-apis)
API | Description
---|---
...
### Web Standard APIs[](https://nextjs.org/docs/pages/api-reference/edge#web-standard-apis)
API | Description
---|---
...
### Next.js Specific Polyfills[](https://nextjs.org/docs/pages/api-reference/edge#nextjs-specific-polyfills)
### Environment Variables[](https://nextjs.org/docs/pages/api-reference/edge#environment-variables)
...
### Unsupported APIs[](https://nextjs.org/docs/pages/api-reference/edge#unsupported-apis)
...
On this page
  ...
  * [Version Changes](https://nextjs.org/docs/pages/api-reference/edge#version-changes)
