...
[PrevioususeSelectedLayoutSegments](https://nextjs.org/docs/app/api-reference/functions/use-selected-layout-segments)[NextConfiguration](https://nextjs.org/docs/app/api-reference/config)
Was this helpful?
Send
* * *
* * *
