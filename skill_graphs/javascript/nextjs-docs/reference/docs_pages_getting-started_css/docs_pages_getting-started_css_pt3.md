...
On this page
  ...
  * [Next Steps](https://nextjs.org/docs/pages/getting-started/css#next-steps)


Scroll to top
[Pages Router](https://nextjs.org/docs/pages)[Getting Started](https://nextjs.org/docs/pages/getting-started)CSS
Copy page
