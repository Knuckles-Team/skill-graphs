...
Scroll to top
[Building Your Application](https://nextjs.org/docs/pages/building-your-application)[Rendering](https://nextjs.org/docs/pages/building-your-application/rendering)Client-side Rendering (CSR)
Copy page
