...
[PreviousdeploymentId](https://nextjs.org/docs/app/api-reference/config/next-config-js/deploymentId)[NextdistDir](https://nextjs.org/docs/app/api-reference/config/next-config-js/distDir)
Was this helpful?
Send
* * *
* * *
