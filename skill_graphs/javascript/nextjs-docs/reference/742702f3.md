...
[PreviousImage Component](https://nextjs.org/docs/app/api-reference/components/image)[NextScript Component](https://nextjs.org/docs/app/api-reference/components/script)
Was this helpful?
Send
* * *
* * *
