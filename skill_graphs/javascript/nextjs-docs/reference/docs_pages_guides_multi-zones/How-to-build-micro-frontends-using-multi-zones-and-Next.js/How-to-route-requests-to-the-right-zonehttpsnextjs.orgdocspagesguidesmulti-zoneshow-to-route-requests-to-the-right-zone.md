## How to route requests to the right zone[](https://nextjs.org/docs/pages/guides/multi-zones#how-to-route-requests-to-the-right-zone)
...
### Routing requests using proxy[](https://nextjs.org/docs/pages/guides/multi-zones#routing-requests-using-proxy)
