...
On this page
  ...
  * [Manual setup](https://nextjs.org/docs/pages/guides/testing/playwright#manual-setup)
...
Scroll to top
[Guides](https://nextjs.org/docs/pages/guides)[Testing](https://nextjs.org/docs/pages/guides/testing)Playwright
Copy page
