...
In Next.js, there are two ways you can implement client-side rendering:
  ...
  2. Using a data fetching library like
...
### [Server-side Rendering (SSR) Use Server-side Rendering to render pages on each request.](https://nextjs.org/docs/pages/building-your-application/rendering/server-side-rendering)### [Static Site Generation (SSG) Use Static Site Generation (SSG) to pre-render pages at build time.](https://nextjs.org/docs/pages/building-your-application/rendering/static-site-generation)### [ISR Learn how to create or update static pages at runtime with Incremental Static Regeneration.](https://nextjs.org/docs/pages/guides/incremental-static-regeneration)
Was this helpful?
Send
* * *
* * *
