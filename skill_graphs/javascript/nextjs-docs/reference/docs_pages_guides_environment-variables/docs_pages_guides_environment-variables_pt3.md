...
On this page
  ...
  * [Good to know](https://nextjs.org/docs/pages/guides/environment-variables#good-to-know)
  * [Version History](https://nextjs.org/docs/pages/guides/environment-variables#version-history)


Scroll to top
[Pages Router](https://nextjs.org/docs/pages)[Guides](https://nextjs.org/docs/pages/guides)Environment Variables
Copy page
