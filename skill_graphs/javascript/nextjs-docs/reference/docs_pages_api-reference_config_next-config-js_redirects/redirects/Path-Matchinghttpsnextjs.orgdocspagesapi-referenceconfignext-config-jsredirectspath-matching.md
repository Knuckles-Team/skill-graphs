## Path Matching[](https://nextjs.org/docs/pages/api-reference/config/next-config-js/redirects#path-matching)
...
### Wildcard Path Matching[](https://nextjs.org/docs/pages/api-reference/config/next-config-js/redirects#wildcard-path-matching)
...
### Regex Path Matching[](https://nextjs.org/docs/pages/api-reference/config/next-config-js/redirects#regex-path-matching)
