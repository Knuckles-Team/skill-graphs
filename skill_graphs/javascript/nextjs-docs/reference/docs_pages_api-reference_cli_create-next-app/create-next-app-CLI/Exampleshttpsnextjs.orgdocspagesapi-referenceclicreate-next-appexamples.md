...
### With the default template[](https://nextjs.org/docs/pages/api-reference/cli/create-next-app#with-the-default-template)
...
### Linter Options[](https://nextjs.org/docs/pages/api-reference/cli/create-next-app#linter-options)
...
### With an official Next.js example[](https://nextjs.org/docs/pages/api-reference/cli/create-next-app#with-an-official-nextjs-example)
...
### With any public GitHub example[](https://nextjs.org/docs/pages/api-reference/cli/create-next-app#with-any-public-github-example)
