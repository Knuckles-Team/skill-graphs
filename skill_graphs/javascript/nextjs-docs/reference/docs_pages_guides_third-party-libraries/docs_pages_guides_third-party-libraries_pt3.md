...
On this page
  * [Getting Started](https://nextjs.org/docs/pages/guides/third-party-libraries#getting-started)
...
Scroll to top
[Pages Router](https://nextjs.org/docs/pages)[Guides](https://nextjs.org/docs/pages/guides)Third Party Libraries
Copy page
