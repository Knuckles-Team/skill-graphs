## Google Third-Parties[](https://nextjs.org/docs/pages/guides/third-party-libraries#google-third-parties)
...
#### Sending Events[](https://nextjs.org/docs/pages/guides/third-party-libraries#sending-events)
...
#### Server-side Tagging[](https://nextjs.org/docs/pages/guides/third-party-libraries#server-side-tagging)
...
#### Options[](https://nextjs.org/docs/pages/guides/third-party-libraries#options)
...
#### Sending Events[](https://nextjs.org/docs/pages/guides/third-party-libraries#sending-events-1)
...
#### Tracking Pageviews[](https://nextjs.org/docs/pages/guides/third-party-libraries#tracking-pageviews)
...
#### Options[](https://nextjs.org/docs/pages/guides/third-party-libraries#options-1)
...
#### Options[](https://nextjs.org/docs/pages/guides/third-party-libraries#options-2)
...
#### Options[](https://nextjs.org/docs/pages/guides/third-party-libraries#options-3)
Name | Type | Description
---|---|---
