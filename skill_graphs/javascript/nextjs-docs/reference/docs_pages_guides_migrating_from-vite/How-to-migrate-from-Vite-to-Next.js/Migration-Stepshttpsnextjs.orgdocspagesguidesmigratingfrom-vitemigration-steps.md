## Migration Steps[](https://nextjs.org/docs/pages/guides/migrating/from-vite#migration-steps)
...
### Step 1: Install the Next.js Dependency[](https://nextjs.org/docs/pages/guides/migrating/from-vite#step-1-install-the-nextjs-dependency)
...
### Step 2: Create the Next.js Configuration File[](https://nextjs.org/docs/pages/guides/migrating/from-vite#step-2-create-the-nextjs-configuration-file)
...
### Step 3: Update TypeScript Configuration[](https://nextjs.org/docs/pages/guides/migrating/from-vite#step-3-update-typescript-configuration)
...
### Step 4: Create the Root Layout[](https://nextjs.org/docs/pages/guides/migrating/from-vite#step-4-create-the-root-layout)
