## Migrating from `pages` to `app`[](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#migrating-from-pages-to-app)
...
We recommend reducing the combined complexity of these updates by breaking down your migration into smaller steps. The `app` directory is intentionally designed to work simultaneously with the `pages` directory to allow for incremental page-by-page migration.
  ...
  * Use nested folders to define routes and a special `page.js` file to make a route segment publicly accessible. [Learn more](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#step-4-migrating-pages).
...
### Step 1: Creating the `app` directory[](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#step-1-creating-the-app-directory)
...
### Step 2: Creating a Root Layout[](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#step-2-creating-a-root-layout)
...
#### Migrating `_document.js` and `_app.js`[](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#migrating-_documentjs-and-_appjs)
...
#### Migrating the `getLayout()` pattern to Layouts (Optional)[](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#migrating-the-getlayout-pattern-to-layouts-optional)
...
**After**
  * Remove the `Page.getLayout` property from `pages/dashboard/index.js` and follow the [steps for migrating pages](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#step-4-migrating-pages) to the `app` directory.
...
### Step 3: Migrating `next/head`[](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#step-3-migrating-nexthead)
...
### Step 4: Migrating Pages[](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#step-4-migrating-pages)
...
### Step 5: Migrating Routing Hooks[](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#step-5-migrating-routing-hooks)
...
In addition, the new `useRouter` hook has the following changes:
  * `isFallback` has been removed because `fallback` has [been replaced](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#replacing-fallback).
...
#### Sharing components between `pages` and `app`[](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#sharing-components-between-pages-and-app)
...
### Step 6: Migrating Data Fetching Methods[](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#step-6-migrating-data-fetching-methods)
...
#### Server-side Rendering (`getServerSideProps`)[](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#server-side-rendering-getserversideprops)
...
#### Accessing Request Object[](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#accessing-request-object)
...
#### Static Site Generation (`getStaticProps`)[](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#static-site-generation-getstaticprops)
...
#### Dynamic paths (`getStaticPaths`)[](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#dynamic-paths-getstaticpaths)
...
* * *
#### Replacing `fallback`[](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#replacing-fallback)
...
#### Incremental Static Regeneration (`getStaticProps` with `revalidate`)[](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#incremental-static-regeneration-getstaticprops-with-revalidate)
...
#### API Routes[](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#api-routes)
...
#### Single-Page Applications[](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#single-page-applications)
...
### Step 7: Styling[](https://nextjs.org/docs/pages/guides/migrating/app-router-migration#step-7-styling)
