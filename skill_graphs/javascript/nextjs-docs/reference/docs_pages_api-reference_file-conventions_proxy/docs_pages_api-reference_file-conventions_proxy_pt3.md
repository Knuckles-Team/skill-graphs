...
On this page
  ...
  * [Platform support](https://nextjs.org/docs/pages/api-reference/file-conventions/proxy#platform-support)
  ...
  * [Version history](https://nextjs.org/docs/pages/api-reference/file-conventions/proxy#version-history)


Scroll to top
[API Reference](https://nextjs.org/docs/pages/api-reference)[File-system conventions](https://nextjs.org/docs/pages/api-reference/file-conventions)Proxy
Copy page
