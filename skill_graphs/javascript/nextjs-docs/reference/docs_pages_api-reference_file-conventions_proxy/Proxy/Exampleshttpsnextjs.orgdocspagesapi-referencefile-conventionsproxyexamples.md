...
### Setting Headers[](https://nextjs.org/docs/pages/api-reference/file-conventions/proxy#setting-headers)
...
### Producing a response[](https://nextjs.org/docs/pages/api-reference/file-conventions/proxy#producing-a-response)
...
### Negative matching[](https://nextjs.org/docs/pages/api-reference/file-conventions/proxy#negative-matching)
...
###  `waitUntil` and `NextFetchEvent`[](https://nextjs.org/docs/pages/api-reference/file-conventions/proxy#waituntil-and-nextfetchevent)
...
### Unit testing (experimental)[](https://nextjs.org/docs/pages/api-reference/file-conventions/proxy#unit-testing-experimental)
