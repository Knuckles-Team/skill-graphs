## Debugging with Browser DevTools[](https://nextjs.org/docs/pages/guides/debugging#debugging-with-browser-devtools)
### Client-side code[](https://nextjs.org/docs/pages/guides/debugging#client-side-code)
...
### Server-side code[](https://nextjs.org/docs/pages/guides/debugging#server-side-code)
...
### Inspect Server Errors with Browser DevTools[](https://nextjs.org/docs/pages/guides/debugging#inspect-server-errors-with-browser-devtools)
...
### Debugging on Windows[](https://nextjs.org/docs/pages/guides/debugging#debugging-on-windows)
