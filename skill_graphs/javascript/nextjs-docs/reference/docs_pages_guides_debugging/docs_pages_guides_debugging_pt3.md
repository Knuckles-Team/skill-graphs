...
On this page
  ...
  * [Using the Debugger in Jetbrains WebStorm](https://nextjs.org/docs/pages/guides/debugging#using-the-debugger-in-jetbrains-webstorm)
...
Scroll to top
[Pages Router](https://nextjs.org/docs/pages)[Guides](https://nextjs.org/docs/pages/guides)Debugging
Copy page
