...
The `src` property can be a [local](https://nextjs.org/docs/pages/getting-started/images#local-images) or [remote](https://nextjs.org/docs/pages/getting-started/images#remote-images) image.
