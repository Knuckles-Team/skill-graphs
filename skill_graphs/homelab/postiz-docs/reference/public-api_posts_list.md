[Skip to main content](https://docs.postiz.com/public-api/posts/list#content-area)
...
#### Authorizations
[​](https://docs.postiz.com/public-api/posts/list#authorization-authorization)
Authorization
string
header
required
Your Postiz API key
#### Query Parameters
[​](https://docs.postiz.com/public-api/posts/list#parameter-start-date)
startDate
string<date-time>
required
Start date in UTC ISO format
[​](https://docs.postiz.com/public-api/posts/list#parameter-end-date)
endDate
string<date-time>
required
End date in UTC ISO format
[​](https://docs.postiz.com/public-api/posts/list#parameter-customer)
customer
string
...
List of posts
[​](https://docs.postiz.com/public-api/posts/list#response-posts)
posts
object[]
Show child attributes
Was this page helpful?
YesNo
[Previous](https://docs.postiz.com/public-api/integrations/find-slot)[ Create PostCreate or schedule a new post. Each social media platform has its own settings schema. Next ](https://docs.postiz.com/public-api/posts/create)
Ctrl+I
[discord](https://discord.postiz.com)
List posts
cURL
