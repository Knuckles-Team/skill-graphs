[Skip to main content](https://docs.postiz.com/public-api/integrations/is-connected#content-area)
...
#### Authorizations
[​](https://docs.postiz.com/public-api/integrations/is-connected#authorization-authorization)
Authorization
string
header
required
...
Connection status
[​](https://docs.postiz.com/public-api/integrations/is-connected#response-connected)
connected
boolean
Was this page helpful?
YesNo
[Previous](https://docs.postiz.com/public-api/integrations/delete)[ Find Available SlotGet the next available time slot for posting to a specific channel. Next ](https://docs.postiz.com/public-api/integrations/find-slot)
Ctrl+I
[discord](https://discord.postiz.com)
Check connection status
cURL
...
QUICK QUESTIONS
Check Connection - Postiz Documentation
