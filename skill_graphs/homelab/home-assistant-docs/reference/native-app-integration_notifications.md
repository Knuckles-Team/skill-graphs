[Skip to main content](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/#__docusaurus_skipToContent_fallback)
[![Home Assistant](https://developers.home-assistant.io/img/logo.svg) **Developers**](https://developers.home-assistant.io/)
[Home Assistant](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/)
...
`⌘``K`
  ...
  * [Architecture](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/)
  * [Development Workflow](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/)
  * [Building Integrations](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/)
  * [Development Checklist](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/)
  * [Integration Quality Scale](https://developers.home-assistant.io/docs/core/integration-quality-scale/)
  * [The `hash` object](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/)
  * [Entities](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/)
  * [Areas, Devices and Entities](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/)
  * [Authentication](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/)
  ...
  * [Device Automations](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/)
  * [Intents](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/)
  * [Conversation](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/)
  * [LLM API](https://developers.home-assistant.io/docs/core/llm/)
  * [Native App Integration](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/)
  ...
  * [External APIs](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/)
  * [Misc](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/)
...
## Enabling websocket push notifications[​](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/#enabling-websocket-push-notifications "Direct link to Enabling websocket push notifications")
...
## Enabling cloud push notifications[​](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/#enabling-cloud-push-notifications "Direct link to Enabling cloud push notifications")
...
### Deploying a server component[​](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/#deploying-a-server-component "Direct link to Deploying a server component")
...
### Errors[​](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/#errors "Direct link to Errors")
...
### Rate limits[​](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/#rate-limits "Direct link to Rate limits")
...
### Example server implementation[​](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/#example-server-implementation "Direct link to Example server implementation")
...
[ Previous Sensors](https://developers.home-assistant.io/docs/api/native-app-integration/sensors)[Next Authenticated WebView](https://developers.home-assistant.io/docs/api/native-app-integration/webview)
  * [Enabling websocket push notifications](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/#enabling-websocket-push-notifications)
  * [Enabling cloud push notifications](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/#enabling-cloud-push-notifications)
    * [Deploying a server component](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/#deploying-a-server-component)
    * [Errors](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/#errors)
    * [Rate limits](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/#rate-limits)
    * [Example server implementation](https://developers.home-assistant.io/docs/api/native-app-integration/notifications/#example-server-implementation)
