[Skip to main content](https://docs.postiz.com/public-api/analytics/post#content-area)
...
#### Authorizations
[​](https://docs.postiz.com/public-api/analytics/post#authorization-authorization)
Authorization
string
header
required
Your Postiz API key
#### Path Parameters
[​](https://docs.postiz.com/public-api/analytics/post#parameter-post-id)
postId
string
required
Post ID
#### Query Parameters
[​](https://docs.postiz.com/public-api/analytics/post#parameter-date)
date
string
required
...
[​](https://docs.postiz.com/public-api/analytics/post#response-items-label)
label
string
Metric label (e.g. Followers, Impressions, Likes)
[​](https://docs.postiz.com/public-api/analytics/post#response-items-data)
data
object[]
Show child attributes
[​](https://docs.postiz.com/public-api/analytics/post#response-items-percentage-change)
percentageChange
number
Percentage change over the selected period
Was this page helpful?
YesNo
[Previous](https://docs.postiz.com/public-api/analytics/platform)[ List NotificationsGet paginated notifications for your organization, sorted by most recent first. Returns 100 notifications per page. Next ](https://docs.postiz.com/public-api/notifications/list)
Ctrl+I
[discord](https://discord.postiz.com)
Get post analytics
cURL
