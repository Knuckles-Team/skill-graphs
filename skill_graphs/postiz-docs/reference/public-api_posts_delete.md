[Skip to main content](https://docs.postiz.com/public-api/integrations/find-slot#content-area)
...
#### Authorizations
[​](https://docs.postiz.com/public-api/integrations/find-slot#authorization-authorization)
Authorization
string
header
required
Your Postiz API key
#### Path Parameters
[​](https://docs.postiz.com/public-api/integrations/find-slot#parameter-id)
id
string
required
Integration ID
...
Next available slot
[​](https://docs.postiz.com/public-api/integrations/find-slot#response-date)
date
string<date-time>
Was this page helpful?
YesNo
[Previous](https://docs.postiz.com/public-api/integrations/is-connected)[ List PostsGet posts within a date range. Next ](https://docs.postiz.com/public-api/posts/list)
Ctrl+I
[discord](https://discord.postiz.com)
Find next available slot
cURL
...
QUICK QUESTIONS
Delete Post - Postiz Documentation
