[Skip to main content](https://docs.postiz.com/public-api/uploads/upload-from-url#content-area)
...
#### Authorizations
[​](https://docs.postiz.com/public-api/uploads/upload-from-url#authorization-authorization)
Authorization
string
header
required
...
#### Body
application/json
[​](https://docs.postiz.com/public-api/uploads/upload-from-url#body-url)
url
string<uri>
required
...
[​](https://docs.postiz.com/public-api/uploads/upload-from-url#response-id)
id
string
Unique file ID
[​](https://docs.postiz.com/public-api/uploads/upload-from-url#response-name)
name
string
File name
[​](https://docs.postiz.com/public-api/uploads/upload-from-url#response-path)
path
string
File URL
[​](https://docs.postiz.com/public-api/uploads/upload-from-url#response-organization-id)
organizationId
string
[​](https://docs.postiz.com/public-api/uploads/upload-from-url#response-created-at)
createdAt
string<date-time>
[​](https://docs.postiz.com/public-api/uploads/upload-from-url#response-updated-at)
updatedAt
string<date-time>
Was this page helpful?
YesNo
[Previous](https://docs.postiz.com/public-api/uploads/upload-file)[ Generate VideoCreate AI-generated videos for your posts. Next ](https://docs.postiz.com/public-api/video/generate)
Ctrl+I
[discord](https://discord.postiz.com)
Upload from URL
cURL
