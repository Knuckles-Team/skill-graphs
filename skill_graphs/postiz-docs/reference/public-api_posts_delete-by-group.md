[Skip to main content](https://docs.postiz.com/public-api/posts/delete-by-group#content-area)
...
#### Authorizations
[​](https://docs.postiz.com/public-api/posts/delete-by-group#authorization-authorization)
Authorization
string
header
required
Your Postiz API key
#### Path Parameters
[​](https://docs.postiz.com/public-api/posts/delete-by-group#parameter-group)
group
string
required
...
Posts deleted
[​](https://docs.postiz.com/public-api/posts/delete-by-group#response-id)
id
string
Was this page helpful?
YesNo
[Previous](https://docs.postiz.com/public-api/posts/delete)[ Get Missing ContentWhen a post has been published but the platform did not return a usable post ID (the `releaseId` is set to `"missing"`), this endpoint fetches recent content from the provider so you can match and connect the correct one to the post. The provider must implement the optional `missing` method. If the provider does not support it, an empty array is returned. Next ](https://docs.postiz.com/public-api/posts/missing-content)
Ctrl+I
[discord](https://discord.postiz.com)
Delete a post by group
cURL
...
QUICK QUESTIONS
Delete Post by Group - Postiz Documentation
