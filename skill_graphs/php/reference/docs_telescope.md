...
[ Skip to content ](https://laravel.com/docs/12.x/telescope#main-content)
  * ## Prologue
    * [Release Notes](https://laravel.com/docs/12.x/releases)
    * [Upgrade Guide](https://laravel.com/docs/12.x/upgrade)
    * [Contribution Guide](https://laravel.com/docs/12.x/contributions)
...
# Laravel Telescope
  * [Introduction](https://laravel.com/docs/12.x/telescope#introduction)
  * [Installation](https://laravel.com/docs/12.x/telescope#installation)
    * [Local Only Installation](https://laravel.com/docs/12.x/telescope#local-only-installation)
    * [Configuration](https://laravel.com/docs/12.x/telescope#configuration)
    * [Data Pruning](https://laravel.com/docs/12.x/telescope#data-pruning)
    * [Dashboard Authorization](https://laravel.com/docs/12.x/telescope#dashboard-authorization)
  * [Upgrading Telescope](https://laravel.com/docs/12.x/telescope#upgrading-telescope)
  * [Filtering](https://laravel.com/docs/12.x/telescope#filtering)
    * [Entries](https://laravel.com/docs/12.x/telescope#filtering-entries)
    * [Batches](https://laravel.com/docs/12.x/telescope#filtering-batches)
  * [Tagging](https://laravel.com/docs/12.x/telescope#tagging)
  * [Available Watchers](https://laravel.com/docs/12.x/telescope#available-watchers)
    * [Batch Watcher](https://laravel.com/docs/12.x/telescope#batch-watcher)
    * [Cache Watcher](https://laravel.com/docs/12.x/telescope#cache-watcher)
    * [Command Watcher](https://laravel.com/docs/12.x/telescope#command-watcher)
    * [Dump Watcher](https://laravel.com/docs/12.x/telescope#dump-watcher)
    * [Event Watcher](https://laravel.com/docs/12.x/telescope#event-watcher)
    * [Exception Watcher](https://laravel.com/docs/12.x/telescope#exception-watcher)
    * [Gate Watcher](https://laravel.com/docs/12.x/telescope#gate-watcher)
    * [HTTP Client Watcher](https://laravel.com/docs/12.x/telescope#http-client-watcher)
    * [Job Watcher](https://laravel.com/docs/12.x/telescope#job-watcher)
    * [Log Watcher](https://laravel.com/docs/12.x/telescope#log-watcher)
    * [Mail Watcher](https://laravel.com/docs/12.x/telescope#mail-watcher)
    * [Model Watcher](https://laravel.com/docs/12.x/telescope#model-watcher)
    * [Notification Watcher](https://laravel.com/docs/12.x/telescope#notification-watcher)
    * [Query Watcher](https://laravel.com/docs/12.x/telescope#query-watcher)
    * [Redis Watcher](https://laravel.com/docs/12.x/telescope#redis-watcher)
    * [Request Watcher](https://laravel.com/docs/12.x/telescope#request-watcher)
    * [Schedule Watcher](https://laravel.com/docs/12.x/telescope#schedule-watcher)
    * [View Watcher](https://laravel.com/docs/12.x/telescope#view-watcher)
  * [Displaying User Avatars](https://laravel.com/docs/12.x/telescope#displaying-user-avatars)
...
Finally, you should also prevent the Telescope package from being [auto-discovered](https://laravel.com/docs/12.x/packages#package-discovery) by adding the following to your `composer.json` file:
```
...
### [Configuration](https://laravel.com/docs/12.x/telescope#configuration)
After publishing Telescope's assets, its primary configuration file will be located at `config/telescope.php`. This configuration file allows you to configure your [watcher options](https://laravel.com/docs/12.x/telescope#available-watchers). Each configuration option includes a description of its purpose, so be sure to thoroughly explore this file.
...
### [Data Pruning](https://laravel.com/docs/12.x/telescope#data-pruning)
Without pruning, the `telescope_entries` table can accumulate records very quickly. To mitigate this, you should [schedule](https://laravel.com/docs/12.x/scheduling) the `telescope:prune` Artisan command to run daily:
```
...
## [Upgrading Telescope](https://laravel.com/docs/12.x/telescope#upgrading-telescope)
When upgrading to a new major version of Telescope, it's important that you carefully review
...
### [Batch Watcher](https://laravel.com/docs/12.x/telescope#batch-watcher)
The batch watcher records information about queued [batches](https://laravel.com/docs/12.x/queues#job-batching), including the job and connection information.
### [Cache Watcher](https://laravel.com/docs/12.x/telescope#cache-watcher)
...
### [Event Watcher](https://laravel.com/docs/12.x/telescope#event-watcher)
The event watcher records the payload, listeners, and broadcast data for any [events](https://laravel.com/docs/12.x/events) dispatched by your application. The Laravel framework's internal events are ignored by the Event watcher.
### [Exception Watcher](https://laravel.com/docs/12.x/telescope#exception-watcher)
The exception watcher records the data and stack trace for any reportable exceptions that are thrown by your application.
### [Gate Watcher](https://laravel.com/docs/12.x/telescope#gate-watcher)
The gate watcher records the data and result of [gate and policy](https://laravel.com/docs/12.x/authorization) checks by your application. If you would like to exclude certain abilities from being recorded by the watcher, you may specify those in the `ignore_abilities` option in your `config/telescope.php` file:
```
...
### [HTTP Client Watcher](https://laravel.com/docs/12.x/telescope#http-client-watcher)
The HTTP client watcher records outgoing [HTTP client requests](https://laravel.com/docs/12.x/http-client) made by your application.
### [Job Watcher](https://laravel.com/docs/12.x/telescope#job-watcher)
The job watcher records the data and status of any [jobs](https://laravel.com/docs/12.x/queues) dispatched by your application.
### [Log Watcher](https://laravel.com/docs/12.x/telescope#log-watcher)
The log watcher records the [log data](https://laravel.com/docs/12.x/logging) for any logs written by your application.
...
### [Mail Watcher](https://laravel.com/docs/12.x/telescope#mail-watcher)
The mail watcher allows you to view an in-browser preview of [emails](https://laravel.com/docs/12.x/mail) sent by your application along with their associated data. You may also download the email as an `.eml` file.
### [Model Watcher](https://laravel.com/docs/12.x/telescope#model-watcher)
The model watcher records model changes whenever an Eloquent [model event](https://laravel.com/docs/12.x/eloquent#events) is dispatched. You may specify which model events should be recorded via the watcher's `events` option:
```
...
### [Notification Watcher](https://laravel.com/docs/12.x/telescope#notification-watcher)
The notification watcher records all [notifications](https://laravel.com/docs/12.x/notifications) sent by your application. If the notification triggers an email and you have the mail watcher enabled, the email will also be available for preview on the mail watcher screen.
### [Query Watcher](https://laravel.com/docs/12.x/telescope#query-watcher)
...
### [Redis Watcher](https://laravel.com/docs/12.x/telescope#redis-watcher)
The Redis watcher records all [Redis](https://laravel.com/docs/12.x/redis) commands executed by your application. If you are using Redis for caching, cache commands will also be recorded by the Redis watcher.
### [Request Watcher](https://laravel.com/docs/12.x/telescope#request-watcher)
...
### [Schedule Watcher](https://laravel.com/docs/12.x/telescope#schedule-watcher)
The schedule watcher records the command and output of any [scheduled tasks](https://laravel.com/docs/12.x/scheduling) run by your application.
### [View Watcher](https://laravel.com/docs/12.x/telescope#view-watcher)
The view watcher records the [view](https://laravel.com/docs/12.x/views) name, path, data, and "composers" used when rendering views.
## [Displaying User Avatars](https://laravel.com/docs/12.x/telescope#displaying-user-avatars)
