...
[ Skip to content ](https://laravel.com/docs/12.x/configuration#main-content)
  * ## Prologue
    * [Release Notes](https://laravel.com/docs/12.x/releases)
    * [Upgrade Guide](https://laravel.com/docs/12.x/upgrade)
    * [Contribution Guide](https://laravel.com/docs/12.x/contributions)
...
# Configuration
  * [Introduction](https://laravel.com/docs/12.x/configuration#introduction)
  * [Environment Configuration](https://laravel.com/docs/12.x/configuration#environment-configuration)
    ...
    * [Determining the Current Environment](https://laravel.com/docs/12.x/configuration#determining-the-current-environment)
    * [Encrypting Environment Files](https://laravel.com/docs/12.x/configuration#encrypting-environment-files)
  * [Accessing Configuration Values](https://laravel.com/docs/12.x/configuration#accessing-configuration-values)
  * [Configuration Caching](https://laravel.com/docs/12.x/configuration#configuration-caching)
  * [Configuration Publishing](https://laravel.com/docs/12.x/configuration#configuration-publishing)
  * [Debug Mode](https://laravel.com/docs/12.x/configuration#debug-mode)
  * [Maintenance Mode](https://laravel.com/docs/12.x/configuration#maintenance-mode)
...
#### [The `about` Command](https://laravel.com/docs/12.x/configuration#the-about-command)
...
To make this a cinch, Laravel utilizes the `.env.example` file that defines many common environment variables. During the Laravel installation process, this file will automatically be copied to `.env`.
...
#### [Environment File Security](https://laravel.com/docs/12.x/configuration#environment-file-security)
Your `.env` file should not be committed to your application's source control, since each developer / server using your application could require a different environment configuration. Furthermore, this would be a security risk in the event an intruder gains access to your source control repository, since any sensitive credentials would get exposed.
However, it is possible to encrypt your environment file using Laravel's built-in [environment encryption](https://laravel.com/docs/12.x/configuration#encrypting-environment-files). Encrypted environment files may be placed in source control safely.
#### [Additional Environment Files](https://laravel.com/docs/12.x/configuration#additional-environment-files)
...
### [Determining the Current Environment](https://laravel.com/docs/12.x/configuration#determining-the-current-environment)
The current application environment is determined via the `APP_ENV` variable from your `.env` file. You may access this value via the `environment` method on the `App` [facade](https://laravel.com/docs/12.x/facades):
```
...
#### [Encryption](https://laravel.com/docs/12.x/configuration#encryption)
...
#### [Readable Variable Names](https://laravel.com/docs/12.x/configuration#readable-variable-names)
...
#### [Decryption](https://laravel.com/docs/12.x/configuration#decryption)
...
#### [Bypassing Maintenance Mode](https://laravel.com/docs/12.x/configuration#bypassing-maintenance-mode)
...
Your maintenance mode secret should typically consist of alphanumeric characters and, optionally, dashes. You should avoid using characters that have special meaning in URLs such as `?` or `&`.
#### [Maintenance Mode on Multiple Servers](https://laravel.com/docs/12.x/configuration#maintenance-mode-on-multiple-servers)
...
#### [Pre-Rendering the Maintenance Mode View](https://laravel.com/docs/12.x/configuration#pre-rendering-the-maintenance-mode-view)
...
#### [Redirecting Maintenance Mode Requests](https://laravel.com/docs/12.x/configuration#redirecting-maintenance-mode-requests)
...
#### [Disabling Maintenance Mode](https://laravel.com/docs/12.x/configuration#disabling-maintenance-mode)
...
#### [Maintenance Mode and Queues](https://laravel.com/docs/12.x/configuration#maintenance-mode-queues)
While your application is in maintenance mode, no [queued jobs](https://laravel.com/docs/12.x/queues) will be handled. The jobs will continue to be handled as normal once the application is out of maintenance mode.
#### [Alternatives to Maintenance Mode](https://laravel.com/docs/12.x/configuration#alternatives-to-maintenance-mode)
