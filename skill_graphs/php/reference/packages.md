...
[ Skip to content ](https://laravel.com/docs/12.x/packages#main-content)
  * ## Prologue
    * [Release Notes](https://laravel.com/docs/12.x/releases)
    * [Upgrade Guide](https://laravel.com/docs/12.x/upgrade)
    * [Contribution Guide](https://laravel.com/docs/12.x/contributions)
...
# Package Development
  * [Introduction](https://laravel.com/docs/12.x/packages#introduction)
    * [A Note on Facades](https://laravel.com/docs/12.x/packages#a-note-on-facades)
  * [Package Discovery](https://laravel.com/docs/12.x/packages#package-discovery)
  * [Service Providers](https://laravel.com/docs/12.x/packages#service-providers)
  * [Resources](https://laravel.com/docs/12.x/packages#resources)
    * [Configuration](https://laravel.com/docs/12.x/packages#configuration)
    * [Routes](https://laravel.com/docs/12.x/packages#routes)
    * [Migrations](https://laravel.com/docs/12.x/packages#migrations)
    * [Language Files](https://laravel.com/docs/12.x/packages#language-files)
    * [Views](https://laravel.com/docs/12.x/packages#views)
    * [View Components](https://laravel.com/docs/12.x/packages#view-components)
    * ["About" Artisan Command](https://laravel.com/docs/12.x/packages#about-artisan-command)
  * [Commands](https://laravel.com/docs/12.x/packages#commands)
    * [Optimize Commands](https://laravel.com/docs/12.x/packages#optimize-commands)
    * [Reload Commands](https://laravel.com/docs/12.x/packages#reload-commands)
  * [Public Assets](https://laravel.com/docs/12.x/packages#public-assets)
  * [Publishing File Groups](https://laravel.com/docs/12.x/packages#publishing-file-groups)
...
## [Package Discovery](https://laravel.com/docs/12.x/packages#package-discovery)
A Laravel application's `bootstrap/providers.php` file contains the list of service providers that should be loaded by Laravel. However, instead of requiring users to manually add your service provider to the list, you may define the provider in the `extra` section of your package's `composer.json` file so that it is automatically loaded by Laravel. In addition to service providers, you may also list any [facades](https://laravel.com/docs/12.x/facades) you would like to be registered:
```
...
#### [Opting Out of Package Discovery](https://laravel.com/docs/12.x/packages#opting-out-of-package-discovery)
...
## [Service Providers](https://laravel.com/docs/12.x/packages#service-providers)
[Service providers](https://laravel.com/docs/12.x/providers) are the connection point between your package and Laravel. A service provider is responsible for binding things into Laravel's [service container](https://laravel.com/docs/12.x/container) and informing Laravel where to load package resources such as views, configuration, and language files.
...
#### [Default Package Configuration](https://laravel.com/docs/12.x/packages#default-package-configuration)
...
### [Migrations](https://laravel.com/docs/12.x/packages#migrations)
If your package contains [database migrations](https://laravel.com/docs/12.x/migrations), you may use the `publishesMigrations` method to inform Laravel that the given directory or file contains migrations. When Laravel publishes the migrations, it will automatically update the timestamp within their filename to reflect the current date and time:
```
...
### [Language Files](https://laravel.com/docs/12.x/packages#language-files)
If your package contains [language files](https://laravel.com/docs/12.x/localization), you may use the `loadTranslationsFrom` method to inform Laravel how to load them. For example, if your package is named `courier`, you should add the following to your service provider's `boot` method:
```
...
#### [Publishing Language Files](https://laravel.com/docs/12.x/packages#publishing-language-files)
...
#### [Overriding Package Views](https://laravel.com/docs/12.x/packages#overriding-package-views)
...
#### [Publishing Views](https://laravel.com/docs/12.x/packages#publishing-views)
...
#### [Autoloading Package Components](https://laravel.com/docs/12.x/packages#autoloading-package-components)
...
#### [Anonymous Components](https://laravel.com/docs/12.x/packages#anonymous-components)
If your package contains anonymous components, they must be placed within a `components` directory of your package's "views" directory (as specified by the [loadViewsFrom method](https://laravel.com/docs/12.x/packages#views)). Then, you may render them by prefixing the component name with the package's view namespace:
```
...
## [Commands](https://laravel.com/docs/12.x/packages#commands)
To register your package's Artisan commands with Laravel, you may use the `commands` method. This method expects an array of command class names. Once the commands have been registered, you may execute them using the [Artisan CLI](https://laravel.com/docs/12.x/artisan):
```
...
### [Optimize Commands](https://laravel.com/docs/12.x/packages#optimize-commands)
Laravel's [optimize command](https://laravel.com/docs/12.x/deployment#optimization) caches the application's configuration, events, routes, and views. Using the `optimizes` method, you may register your package's own Artisan commands that should be invoked when the `optimize` and `optimize:clear` commands are executed:
```
