[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-anthropic#content-area)
...
On this page
  * [fastmcp.client.sampling.handlers.anthropic](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-anthropic#fastmcp-client-sampling-handlers-anthropic)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-anthropic#classes)
  * [AnthropicSamplingHandler ](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-anthropic#anthropicsamplinghandler)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-anthropic#fastmcp-client-sampling-handlers-anthropic)
`fastmcp.client.sampling.handlers.anthropic`
Anthropic sampling handler for FastMCP.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-anthropic#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-anthropic#anthropicsamplinghandler)
`AnthropicSamplingHandler`
Sampling handler that uses the Anthropic API.
[ __init__ Previous ](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-__init__)[ google_genai Next ](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-google_genai)
Ctrl+I
