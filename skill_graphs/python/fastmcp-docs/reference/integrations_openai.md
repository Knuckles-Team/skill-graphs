...
[ Gemini SDK 🤝 FastMCP Previous ](https://gofastmcp.com/integrations/gemini)[ MCP JSON Configuration 🤝 FastMCP Next ](https://gofastmcp.com/integrations/mcp-json-configuration)
Ctrl+I
