[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-components#content-area)
...
##### fastmcp.server
  ...
  * providers
    ...
    * local_provider
    * openapi
      * [__init__](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-__init__)
      * [components](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-components)
      * [provider](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-provider)
      * [routing](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-routing)
...
On this page
  * [fastmcp.server.providers.openapi.components](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-components#fastmcp-server-providers-openapi-components)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-components#classes)
  * [OpenAPITool ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-components#openapitool)
  * [run ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-components#run)
  * [OpenAPIResource ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-components#openapiresource)
  * [read ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-components#read)
  * [OpenAPIResourceTemplate ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-components#openapiresourcetemplate)
  * [create_resource ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-components#create_resource)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-components#fastmcp-server-providers-openapi-components)
`fastmcp.server.providers.openapi.components`
OpenAPI component classes: Tool, Resource, and ResourceTemplate.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-components#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-components#openapitool)
`OpenAPITool`
Tool implementation for OpenAPI endpoints. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-components#run)
`run`
Copy
```
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-components#openapiresource)
`OpenAPIResource`
Resource implementation for OpenAPI endpoints. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-components#read)
`read`
Copy
```
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-components#openapiresourcetemplate)
`OpenAPIResourceTemplate`
Resource template implementation for OpenAPI endpoints. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-components#create_resource)
`create_resource`
Copy
```
...
[ __init__ Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-__init__)[ provider Next ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-provider)
Ctrl+I
