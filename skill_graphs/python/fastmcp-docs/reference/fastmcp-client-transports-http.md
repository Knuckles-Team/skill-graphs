[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-client-transports-http#content-area)
...
On this page
  * [fastmcp.client.transports.http](https://gofastmcp.com/python-sdk/fastmcp-client-transports-http#fastmcp-client-transports-http)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-client-transports-http#classes)
  * [StreamableHttpTransport ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-http#streamablehttptransport)
  * [connect_session ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-http#connect_session)
  * [get_session_id ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-http#get_session_id)
  * [close ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-http#close)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-http#fastmcp-client-transports-http)
`fastmcp.client.transports.http`
Streamable HTTP transport for FastMCP Client.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-http#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-http#streamablehttptransport)
`StreamableHttpTransport`
Transport implementation that connects to an MCP server via Streamable HTTP Requests. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-http#connect_session)
`connect_session`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-http#get_session_id)
`get_session_id`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-client-transports-http#close)
`close`
Copy
```
close(self)
...
[ config Previous ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-config)[ inference Next ](https://gofastmcp.com/python-sdk/fastmcp-client-transports-inference)
Ctrl+I
