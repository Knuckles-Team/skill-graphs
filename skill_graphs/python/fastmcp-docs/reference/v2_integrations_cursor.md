[Skip to main content](https://gofastmcp.com/v2/integrations/cursor#content-area)
...
On this page
  * [Requirements](https://gofastmcp.com/v2/integrations/cursor#requirements)
  * [Create a Server](https://gofastmcp.com/v2/integrations/cursor#create-a-server)
  * [Install the Server](https://gofastmcp.com/v2/integrations/cursor#install-the-server)
  * [FastMCP CLI](https://gofastmcp.com/v2/integrations/cursor#fastmcp-cli)
  * [Workspace Installation](https://gofastmcp.com/v2/integrations/cursor#workspace-installation)
  * [Dependencies](https://gofastmcp.com/v2/integrations/cursor#dependencies)
  * [Python Version and Project Configuration](https://gofastmcp.com/v2/integrations/cursor#python-version-and-project-configuration)
  * [Environment Variables](https://gofastmcp.com/v2/integrations/cursor#environment-variables)
  * [Generate MCP JSON](https://gofastmcp.com/v2/integrations/cursor#generate-mcp-json)
  * [Manual Configuration](https://gofastmcp.com/v2/integrations/cursor#manual-configuration)
  * [Dependencies](https://gofastmcp.com/v2/integrations/cursor#dependencies-2)
  * [Environment Variables](https://gofastmcp.com/v2/integrations/cursor#environment-variables-2)
  * [Using the Server](https://gofastmcp.com/v2/integrations/cursor#using-the-server)
...
##
[​](https://gofastmcp.com/v2/integrations/cursor#requirements)
Requirements
...
##
[​](https://gofastmcp.com/v2/integrations/cursor#create-a-server)
Create a Server
...
##
[​](https://gofastmcp.com/v2/integrations/cursor#install-the-server)
Install the Server
###
[​](https://gofastmcp.com/v2/integrations/cursor#fastmcp-cli)
FastMCP CLI
`2.10.3` The easiest way to install a FastMCP server in Cursor is using the `fastmcp install cursor` command. This automatically handles the configuration, dependency management, and opens Cursor with a deeplink to install the server.
Copy
```
...
####
[​](https://gofastmcp.com/v2/integrations/cursor#workspace-installation)
Workspace Installation
`2.12.0` By default, FastMCP installs servers globally for Cursor. You can also install servers to project-specific workspaces using the `--workspace` flag:
Copy
```
...
####
[​](https://gofastmcp.com/v2/integrations/cursor#python-version-and-project-configuration)
...
####
[​](https://gofastmcp.com/v2/integrations/cursor#environment-variables)
...
###
[​](https://gofastmcp.com/v2/integrations/cursor#generate-mcp-json)
Generate MCP JSON
...
###
[​](https://gofastmcp.com/v2/integrations/cursor#manual-configuration)
...
####
[​](https://gofastmcp.com/v2/integrations/cursor#dependencies-2)
Dependencies
...
**`uv`must be installed and available in your system PATH**. Cursor runs in its own isolated environment and needs `uv` to manage dependencies.
####
[​](https://gofastmcp.com/v2/integrations/cursor#environment-variables-2)
Environment Variables
...
Cursor runs servers in a completely isolated environment with no access to your shell environment or locally installed applications. You must explicitly pass any environment variables your server needs.
##
[​](https://gofastmcp.com/v2/integrations/cursor#using-the-server)
Using the Server
...
[ Claude Desktop 🤝 FastMCP Previous ](https://gofastmcp.com/v2/integrations/claude-desktop)[ Gemini CLI 🤝 FastMCP Next ](https://gofastmcp.com/v2/integrations/gemini-cli)
Ctrl+I
![Cursor install prompt](https://mintcdn.com/fastmcp/o8HRaJqencnEFg3N/v2/integrations/cursor-install-mcp.png?w=840&fit=max&auto=format&n=o8HRaJqencnEFg3N&q=85&s=7cb9cdedaddc5b6038d2bc345492fb97)
