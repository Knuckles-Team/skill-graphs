[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-mixins-lifespan#content-area)
...
On this page
  * [fastmcp.server.mixins.lifespan](https://gofastmcp.com/python-sdk/fastmcp-server-mixins-lifespan#fastmcp-server-mixins-lifespan)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-mixins-lifespan#classes)
  * [LifespanMixin ](https://gofastmcp.com/python-sdk/fastmcp-server-mixins-lifespan#lifespanmixin)
  * [docket ](https://gofastmcp.com/python-sdk/fastmcp-server-mixins-lifespan#docket)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-mixins-lifespan#fastmcp-server-mixins-lifespan)
`fastmcp.server.mixins.lifespan`
Lifespan and Docket task infrastructure for FastMCP Server.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-mixins-lifespan#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-mixins-lifespan#lifespanmixin)
`LifespanMixin`
Mixin providing lifespan and Docket task infrastructure for FastMCP. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-mixins-lifespan#docket)
`docket`
Copy
```
...
[ __init__ Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-mixins-__init__)[ mcp_operations Next ](https://gofastmcp.com/python-sdk/fastmcp-server-mixins-mcp_operations)
Ctrl+I
