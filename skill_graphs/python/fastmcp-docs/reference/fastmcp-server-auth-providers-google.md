[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-google#content-area)
...
On this page
  * [fastmcp.server.auth.providers.google](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-google#fastmcp-server-auth-providers-google)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-google#classes)
  * [GoogleTokenVerifier ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-google#googletokenverifier)
  * [verify_token ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-google#verify_token)
  * [GoogleProvider ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-google#googleprovider)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-google#fastmcp-server-auth-providers-google)
...
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-google#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-google#googletokenverifier)
`GoogleTokenVerifier`
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-google#verify_token)
`verify_token`
Copy
```
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-google#googleprovider)
`GoogleProvider`
...
[ github Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-github)[ in_memory Next ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-in_memory)
Ctrl+I
