[Skip to main content](https://gofastmcp.com/v2/deployment/running-server#content-area)
...
On this page
  * [The run() Method](https://gofastmcp.com/v2/deployment/running-server#the-run-method)
  * [Transport Protocols](https://gofastmcp.com/v2/deployment/running-server#transport-protocols)
  * [STDIO Transport (Default)](https://gofastmcp.com/v2/deployment/running-server#stdio-transport-default)
  * [HTTP Transport (Streamable)](https://gofastmcp.com/v2/deployment/running-server#http-transport-streamable)
  * [SSE Transport (Legacy)](https://gofastmcp.com/v2/deployment/running-server#sse-transport-legacy)
  * [Choosing the Right Transport](https://gofastmcp.com/v2/deployment/running-server#choosing-the-right-transport)
  * [The FastMCP CLI](https://gofastmcp.com/v2/deployment/running-server#the-fastmcp-cli)
  * [Dependency Management](https://gofastmcp.com/v2/deployment/running-server#dependency-management)
  * [Passing Arguments to Servers](https://gofastmcp.com/v2/deployment/running-server#passing-arguments-to-servers)
  * [Async Usage](https://gofastmcp.com/v2/deployment/running-server#async-usage)
  * [Custom Routes](https://gofastmcp.com/v2/deployment/running-server#custom-routes)
  * [Alternative Initialization Patterns](https://gofastmcp.com/v2/deployment/running-server#alternative-initialization-patterns)
  * [CLI-Only Servers](https://gofastmcp.com/v2/deployment/running-server#cli-only-servers)
  * [ASGI Applications](https://gofastmcp.com/v2/deployment/running-server#asgi-applications)
...
Copy page
FastMCP servers can be run in different ways depending on your needs. This guide focuses on running servers locally for development and testing. For production deployment to a URL, see the [HTTP Deployment](https://gofastmcp.com/v2/deployment/http) guide.
##
[​](https://gofastmcp.com/v2/deployment/running-server#the-run-method)
The `run()` Method
...
##
[​](https://gofastmcp.com/v2/deployment/running-server#transport-protocols)
Transport Protocols
...
###
[​](https://gofastmcp.com/v2/deployment/running-server#stdio-transport-default)
...
###
[​](https://gofastmcp.com/v2/deployment/running-server#http-transport-streamable)
...
For production HTTP deployment with authentication and advanced configuration, see the [HTTP Deployment](https://gofastmcp.com/v2/deployment/http) guide.
###
[​](https://gofastmcp.com/v2/deployment/running-server#sse-transport-legacy)
...
###
[​](https://gofastmcp.com/v2/deployment/running-server#choosing-the-right-transport)
...
##
[​](https://gofastmcp.com/v2/deployment/running-server#the-fastmcp-cli)
The FastMCP CLI
...
###
[​](https://gofastmcp.com/v2/deployment/running-server#dependency-management)
...
###
[​](https://gofastmcp.com/v2/deployment/running-server#passing-arguments-to-servers)
...
This is useful for servers that need configuration files, database paths, API keys, or other runtime options. For more CLI features including development mode with the MCP Inspector, see the [CLI documentation](https://gofastmcp.com/v2/patterns/cli).
###
[​](https://gofastmcp.com/v2/deployment/running-server#async-usage)
Async Usage
...
##
[​](https://gofastmcp.com/v2/deployment/running-server#custom-routes)
Custom Routes
...
###
[​](https://gofastmcp.com/v2/deployment/running-server#cli-only-servers)
CLI-Only Servers
...
###
[​](https://gofastmcp.com/v2/deployment/running-server#asgi-applications)
ASGI Applications
...
See the [HTTP Deployment](https://gofastmcp.com/v2/deployment/http) guide for more ASGI deployment patterns.
[ Full OAuth Server Previous ](https://gofastmcp.com/v2/servers/auth/full-oauth-server)[ HTTP Deployment Next ](https://gofastmcp.com/v2/deployment/http)
Ctrl+I
