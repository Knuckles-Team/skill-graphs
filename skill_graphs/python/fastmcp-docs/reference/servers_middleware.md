...
On this page
  * [Overview](https://gofastmcp.com/servers/middleware#overview)
  * [Execution Order](https://gofastmcp.com/servers/middleware#execution-order)
  * [Server Composition](https://gofastmcp.com/servers/middleware#server-composition)
  * [Hooks](https://gofastmcp.com/servers/middleware#hooks)
  * [Hook Signature](https://gofastmcp.com/servers/middleware#hook-signature)
  * [MiddlewareContext](https://gofastmcp.com/servers/middleware#middlewarecontext)
  * [Message Hooks](https://gofastmcp.com/servers/middleware#message-hooks)
  * [on_message](https://gofastmcp.com/servers/middleware#on_message)
  * [on_request](https://gofastmcp.com/servers/middleware#on_request)
  * [on_notification](https://gofastmcp.com/servers/middleware#on_notification)
  * [Operation Hooks](https://gofastmcp.com/servers/middleware#operation-hooks)
  * [on_call_tool](https://gofastmcp.com/servers/middleware#on_call_tool)
  * [on_read_resource](https://gofastmcp.com/servers/middleware#on_read_resource)
  * [on_get_prompt](https://gofastmcp.com/servers/middleware#on_get_prompt)
  * [on_list_tools](https://gofastmcp.com/servers/middleware#on_list_tools)
  * [on_list_resources](https://gofastmcp.com/servers/middleware#on_list_resources)
  * [on_list_resource_templates](https://gofastmcp.com/servers/middleware#on_list_resource_templates)
  * [on_list_prompts](https://gofastmcp.com/servers/middleware#on_list_prompts)
  * [on_initialize](https://gofastmcp.com/servers/middleware#on_initialize)
  * [Raw Handler](https://gofastmcp.com/servers/middleware#raw-handler)
  * [Session Availability](https://gofastmcp.com/servers/middleware#session-availability)
  * [Built-in Middleware](https://gofastmcp.com/servers/middleware#built-in-middleware)
  * [Logging](https://gofastmcp.com/servers/middleware#logging)
  * [Timing](https://gofastmcp.com/servers/middleware#timing)
  * [Caching](https://gofastmcp.com/servers/middleware#caching)
  * [Rate Limiting](https://gofastmcp.com/servers/middleware#rate-limiting)
  * [Error Handling](https://gofastmcp.com/servers/middleware#error-handling)
  * [Ping](https://gofastmcp.com/servers/middleware#ping)
  * [Tool Injection](https://gofastmcp.com/servers/middleware#tool-injection)
  * [Response Limiting](https://gofastmcp.com/servers/middleware#response-limiting)
  * [Combining Middleware](https://gofastmcp.com/servers/middleware#combining-middleware)
  * [Custom Middleware](https://gofastmcp.com/servers/middleware#custom-middleware)
  * [Denying Requests](https://gofastmcp.com/servers/middleware#denying-requests)
  * [Modifying Requests](https://gofastmcp.com/servers/middleware#modifying-requests)
  * [Modifying Responses](https://gofastmcp.com/servers/middleware#modifying-responses)
  * [Filtering Lists](https://gofastmcp.com/servers/middleware#filtering-lists)
  * [Accessing Component Metadata](https://gofastmcp.com/servers/middleware#accessing-component-metadata)
  * [Storing State](https://gofastmcp.com/servers/middleware#storing-state)
  * [Constructor Parameters](https://gofastmcp.com/servers/middleware#constructor-parameters)
  * [Error Handling in Custom Middleware](https://gofastmcp.com/servers/middleware#error-handling-in-custom-middleware)
  * [Complete Example](https://gofastmcp.com/servers/middleware#complete-example)
...
Copy page
`2.9.0` Middleware adds behavior that applies across multiple operations—authentication, logging, rate limiting, or request transformation—without modifying individual tools or resources.
MCP middleware is a FastMCP-specific concept and is not part of the official MCP protocol specification.
##
[​](https://gofastmcp.com/servers/middleware#overview)
Overview
...
###
[​](https://gofastmcp.com/servers/middleware#execution-order)
Execution Order
...
###
[​](https://gofastmcp.com/servers/middleware#server-composition)
Server Composition
When using [mounted servers](https://gofastmcp.com/servers/composition), middleware behavior follows a clear hierarchy:
...
##
[​](https://gofastmcp.com/servers/middleware#hooks)
Hooks
...
###
[​](https://gofastmcp.com/servers/middleware#hook-signature)
Hook Signature
...
###
[​](https://gofastmcp.com/servers/middleware#middlewarecontext)
MiddlewareContext
...
###
[​](https://gofastmcp.com/servers/middleware#message-hooks)
Message Hooks
####
[​](https://gofastmcp.com/servers/middleware#on_message)
on_message
...
####
[​](https://gofastmcp.com/servers/middleware#on_request)
on_request
...
####
[​](https://gofastmcp.com/servers/middleware#on_notification)
on_notification
...
###
[​](https://gofastmcp.com/servers/middleware#operation-hooks)
Operation Hooks
####
[​](https://gofastmcp.com/servers/middleware#on_call_tool)
on_call_tool
...
####
[​](https://gofastmcp.com/servers/middleware#on_read_resource)
on_read_resource
...
####
[​](https://gofastmcp.com/servers/middleware#on_get_prompt)
on_get_prompt
...
####
[​](https://gofastmcp.com/servers/middleware#on_list_tools)
on_list_tools
...
####
[​](https://gofastmcp.com/servers/middleware#on_list_resources)
on_list_resources
...
####
[​](https://gofastmcp.com/servers/middleware#on_list_resource_templates)
...
####
[​](https://gofastmcp.com/servers/middleware#on_list_prompts)
on_list_prompts
...
**Returns:** `list[Prompt]`
####
[​](https://gofastmcp.com/servers/middleware#on_initialize)
on_initialize
`2.13.0` Called when a client connects and initializes the session. This hook cannot modify the initialization response.
Copy
```
...
###
[​](https://gofastmcp.com/servers/middleware#raw-handler)
Raw Handler
...
###
[​](https://gofastmcp.com/servers/middleware#session-availability)
Session Availability
`2.13.1` The MCP session may not be available during certain phases like initialization. Check before accessing session-specific attributes:
Copy
```
async def on_request(self, context: MiddlewareContext, call_next):
...
For HTTP-specific data (headers, client IP) when using HTTP transports, see [HTTP Requests](https://gofastmcp.com/servers/context#http-requests).
##
[​](https://gofastmcp.com/servers/middleware#built-in-middleware)
Built-in Middleware
FastMCP includes production-ready middleware for common server concerns.
###
[​](https://gofastmcp.com/servers/middleware#logging)
Logging
Copy
```
...
###
[​](https://gofastmcp.com/servers/middleware#timing)
Timing
Copy
```
...
###
[​](https://gofastmcp.com/servers/middleware#caching)
Caching
Copy
```
...
See [Storage Backends](https://gofastmcp.com/servers/storage-backends) for complete options.
...
###
[​](https://gofastmcp.com/servers/middleware#rate-limiting)
Rate Limiting
Copy
```
...
###
[​](https://gofastmcp.com/servers/middleware#error-handling)
Error Handling
Copy
```
...
###
[​](https://gofastmcp.com/servers/middleware#ping)
Ping
`3.0.0`
Copy
```
...
###
[​](https://gofastmcp.com/servers/middleware#tool-injection)
Tool Injection
Copy
```
...
###
[​](https://gofastmcp.com/servers/middleware#response-limiting)
Response Limiting
`3.0.0`
Copy
```
...
##
[​](https://gofastmcp.com/servers/middleware#custom-middleware)
Custom Middleware
...
###
[​](https://gofastmcp.com/servers/middleware#denying-requests)
Denying Requests
...
###
[​](https://gofastmcp.com/servers/middleware#modifying-responses)
Modifying Responses
...
For more complex tool transformations, consider [Transforms](https://gofastmcp.com/servers/transforms/transforms) instead.
###
[​](https://gofastmcp.com/servers/middleware#filtering-lists)
Filtering Lists
...
###
[​](https://gofastmcp.com/servers/middleware#accessing-component-metadata)
...
###
[​](https://gofastmcp.com/servers/middleware#storing-state)
Storing State
`2.11.0` Middleware can store state that tools access later through the FastMCP context.
Copy
```
from fastmcp.server.middleware import Middleware, MiddlewareContext
...
See [Context State Management](https://gofastmcp.com/servers/context#state-management) for details.
###
[​](https://gofastmcp.com/servers/middleware#constructor-parameters)
...
###
[​](https://gofastmcp.com/servers/middleware#error-handling-in-custom-middleware)
...
###
[​](https://gofastmcp.com/servers/middleware#complete-example)
Complete Example
...
[ Client Logging Previous ](https://gofastmcp.com/servers/logging)[ Pagination Next ](https://gofastmcp.com/servers/pagination)
Ctrl+I
