[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-client-__init__#content-area)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-client-__init__#fastmcp-client)
`fastmcp.client`
_This module is empty or contains only private/internal implementations._
[ tasks Previous ](https://gofastmcp.com/python-sdk/fastmcp-cli-tasks)[ __init__ Next ](https://gofastmcp.com/python-sdk/fastmcp-client-auth-__init__)
Ctrl+I
