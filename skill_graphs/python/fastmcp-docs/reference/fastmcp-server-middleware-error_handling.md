[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-error_handling#content-area)
...
On this page
  * [fastmcp.server.middleware.error_handling](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-error_handling#fastmcp-server-middleware-error_handling)
  ...
  * [on_message ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-error_handling#on_message)
  * [get_error_stats ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-error_handling#get_error_stats)
  * [RetryMiddleware ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-error_handling#retrymiddleware)
  * [on_request ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-error_handling#on_request)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-error_handling#fastmcp-server-middleware-error_handling)
`fastmcp.server.middleware.error_handling`
Error handling middleware for consistent error responses and tracking.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-error_handling#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-error_handling#errorhandlingmiddleware)
`ErrorHandlingMiddleware`
Middleware that provides consistent error handling and logging. Catches exceptions, logs them appropriately, and converts them to proper MCP error responses. Also tracks error patterns for monitoring. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-error_handling#on_message)
`on_message`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-error_handling#get_error_stats)
`get_error_stats`
Copy
```
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-error_handling#retrymiddleware)
`RetryMiddleware`
Middleware that implements automatic retry logic for failed requests. Retries requests that fail with transient errors, using exponential backoff to avoid overwhelming the server or external dependencies. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-error_handling#on_request)
`on_request`
Copy
```
...
[ dereference Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-dereference)[ logging Next ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-logging)
Ctrl+I
