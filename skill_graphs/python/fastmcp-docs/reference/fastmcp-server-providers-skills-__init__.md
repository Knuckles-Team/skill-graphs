[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-__init__#content-area)
...
On this page
  * [fastmcp.server.providers.skills](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-__init__#fastmcp-server-providers-skills)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-__init__#fastmcp-server-providers-skills)
...
[ proxy Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-proxy)[ claude_provider Next ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-skills-claude_provider)
Ctrl+I
