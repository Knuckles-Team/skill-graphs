[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-sampling-__init__#content-area)
...
##### fastmcp.server
  ...
  * sampling
    * [__init__](https://gofastmcp.com/python-sdk/fastmcp-server-sampling-__init__)
    * [run](https://gofastmcp.com/python-sdk/fastmcp-server-sampling-run)
    * [sampling_tool](https://gofastmcp.com/python-sdk/fastmcp-server-sampling-sampling_tool)
...
On this page
  * [fastmcp.server.sampling](https://gofastmcp.com/python-sdk/fastmcp-server-sampling-__init__#fastmcp-server-sampling)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-sampling-__init__#fastmcp-server-sampling)
`fastmcp.server.sampling`
Sampling module for FastMCP servers.
[ proxy Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-proxy)[ run Next ](https://gofastmcp.com/python-sdk/fastmcp-server-sampling-run)
Ctrl+I
