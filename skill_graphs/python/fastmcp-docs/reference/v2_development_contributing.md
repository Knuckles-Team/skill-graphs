[Skip to main content](https://gofastmcp.com/v2/development/contributing#content-area)
...
On this page
  * [Issues](https://gofastmcp.com/v2/development/contributing#issues)
  * [Issue First, Code Second](https://gofastmcp.com/v2/development/contributing#issue-first-code-second)
  * [Writing Good Issues](https://gofastmcp.com/v2/development/contributing#writing-good-issues)
  * [Pull Requests](https://gofastmcp.com/v2/development/contributing#pull-requests)
  * [Development Environment](https://gofastmcp.com/v2/development/contributing#development-environment)
  * [Installation](https://gofastmcp.com/v2/development/contributing#installation)
  * [Development Standards](https://gofastmcp.com/v2/development/contributing#development-standards)
  * [Scope](https://gofastmcp.com/v2/development/contributing#scope)
  * [Code Quality](https://gofastmcp.com/v2/development/contributing#code-quality)
  * [Required Practices](https://gofastmcp.com/v2/development/contributing#required-practices)
  * [Anti-Patterns to Avoid](https://gofastmcp.com/v2/development/contributing#anti-patterns-to-avoid)
  * [Prek Checks](https://gofastmcp.com/v2/development/contributing#prek-checks)
  * [Testing](https://gofastmcp.com/v2/development/contributing#testing)
  * [Documentation](https://gofastmcp.com/v2/development/contributing#documentation)
  * [SDK Documentation](https://gofastmcp.com/v2/development/contributing#sdk-documentation)
  * [Submitting Your PR](https://gofastmcp.com/v2/development/contributing#submitting-your-pr)
  * [Before Submitting](https://gofastmcp.com/v2/development/contributing#before-submitting)
  * [PR Description](https://gofastmcp.com/v2/development/contributing#pr-description)
  * [What We Look For](https://gofastmcp.com/v2/development/contributing#what-we-look-for)
  * [Special Modules](https://gofastmcp.com/v2/development/contributing#special-modules)
...
##
[​](https://gofastmcp.com/v2/development/contributing#issues)
Issues
###
[​](https://gofastmcp.com/v2/development/contributing#issue-first-code-second)
...
###
[​](https://gofastmcp.com/v2/development/contributing#writing-good-issues)
Writing Good Issues
...
##
[​](https://gofastmcp.com/v2/development/contributing#pull-requests)
Pull Requests
...
###
[​](https://gofastmcp.com/v2/development/contributing#development-environment)
Development Environment
####
[​](https://gofastmcp.com/v2/development/contributing#installation)
Installation
...
In addition, some development commands require  Prek hooks will run automatically on every commit to catch issues before they reach CI. If you see failures, fix them before committing - never commit broken code expecting to fix it later.
###
[​](https://gofastmcp.com/v2/development/contributing#development-standards)
Development Standards
####
[​](https://gofastmcp.com/v2/development/contributing#scope)
Scope
...
####
[​](https://gofastmcp.com/v2/development/contributing#code-quality)
Code Quality
...
####
[​](https://gofastmcp.com/v2/development/contributing#required-practices)
Required Practices
...
####
[​](https://gofastmcp.com/v2/development/contributing#anti-patterns-to-avoid)
...
###
[​](https://gofastmcp.com/v2/development/contributing#prek-checks)
Prek Checks
Copy
```
...
###
[​](https://gofastmcp.com/v2/development/contributing#testing)
Testing
...
Every new feature needs tests. See the [Testing Guide](https://gofastmcp.com/v2/development/tests) for patterns and requirements.
###
[​](https://gofastmcp.com/v2/development/contributing#documentation)
Documentation
...
####
[​](https://gofastmcp.com/v2/development/contributing#sdk-documentation)
SDK Documentation
...
###
[​](https://gofastmcp.com/v2/development/contributing#submitting-your-pr)
Submitting Your PR
####
[​](https://gofastmcp.com/v2/development/contributing#before-submitting)
Before Submitting
...
####
[​](https://gofastmcp.com/v2/development/contributing#pr-description)
PR Description
...
####
[​](https://gofastmcp.com/v2/development/contributing#what-we-look-for)
What We Look For
**Framework Philosophy** : FastMCP is NOT trying to do all things or provide all shortcuts. Features are rejected when they don’t align with the framework’s vision, even if perfectly implemented. The burden of proof is on the PR to demonstrate value. **Code Quality** : We verify code follows existing patterns. Consistency reduces cognitive load. When every module works similarly, developers understand new code quickly. **Test Coverage** : Not every line needs testing, but every behavior does. Tests document intent and protect against regressions. **Breaking Changes** : May be acceptable in minor versions but must be clearly documented. See the [versioning policy](https://gofastmcp.com/v2/development/releases#versioning-policy).
##
[​](https://gofastmcp.com/v2/development/contributing#special-modules)
Special Modules
...
[ Testing your FastMCP Server Previous ](https://gofastmcp.com/v2/patterns/testing)[ Tests Next ](https://gofastmcp.com/v2/development/tests)
Ctrl+I
