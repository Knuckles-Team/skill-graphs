[Skip to main content](https://gofastmcp.com/v2/patterns/tool-transformation#content-area)
...
On this page
  * [Why Transform Tools?](https://gofastmcp.com/v2/patterns/tool-transformation#why-transform-tools)
  * [Basic Transformation](https://gofastmcp.com/v2/patterns/tool-transformation#basic-transformation)
  * [Parameters](https://gofastmcp.com/v2/patterns/tool-transformation#parameters)
  * [Modifying Arguments](https://gofastmcp.com/v2/patterns/tool-transformation#modifying-arguments)
  * [The ArgTransform Class](https://gofastmcp.com/v2/patterns/tool-transformation#the-argtransform-class)
  * [Descriptions](https://gofastmcp.com/v2/patterns/tool-transformation#descriptions)
  * [Names](https://gofastmcp.com/v2/patterns/tool-transformation#names)
  * [Default Values](https://gofastmcp.com/v2/patterns/tool-transformation#default-values)
  * [Hiding Arguments](https://gofastmcp.com/v2/patterns/tool-transformation#hiding-arguments)
  * [Meta Information](https://gofastmcp.com/v2/patterns/tool-transformation#meta-information)
  * [Required Values](https://gofastmcp.com/v2/patterns/tool-transformation#required-values)
  * [Modifying Tool Behavior](https://gofastmcp.com/v2/patterns/tool-transformation#modifying-tool-behavior)
  * [The Transform Function](https://gofastmcp.com/v2/patterns/tool-transformation#the-transform-function)
  * [Calling the Parent Tool](https://gofastmcp.com/v2/patterns/tool-transformation#calling-the-parent-tool)
  * [Passing Arguments with **kwargs](https://gofastmcp.com/v2/patterns/tool-transformation#passing-arguments-with-kwargs)
  * [Modifying MCP Tools with MCPConfig](https://gofastmcp.com/v2/patterns/tool-transformation#modifying-mcp-tools-with-mcpconfig)
  * [Output Schema Control](https://gofastmcp.com/v2/patterns/tool-transformation#output-schema-control)
  * [Common Patterns](https://gofastmcp.com/v2/patterns/tool-transformation#common-patterns)
  * [Exposing Client Methods as Tools](https://gofastmcp.com/v2/patterns/tool-transformation#exposing-client-methods-as-tools)
  * [Hiding Client-Specific Arguments](https://gofastmcp.com/v2/patterns/tool-transformation#hiding-client-specific-arguments)
  * [Reusable Argument Patterns](https://gofastmcp.com/v2/patterns/tool-transformation#reusable-argument-patterns)
  * [Adapting Remote or Generated Tools](https://gofastmcp.com/v2/patterns/tool-transformation#adapting-remote-or-generated-tools)
  * [Chaining Transformations](https://gofastmcp.com/v2/patterns/tool-transformation#chaining-transformations)
  * [Context-Aware Tool Factories](https://gofastmcp.com/v2/patterns/tool-transformation#context-aware-tool-factories)
...
Copy page
`2.8.0` Tool transformation allows you to create new, enhanced tools from existing ones. This powerful feature enables you to adapt tools for different contexts, simplify complex interfaces, or add custom logic without duplicating code.
##
[​](https://gofastmcp.com/v2/patterns/tool-transformation#why-transform-tools)
Why Transform Tools?
...
##
[​](https://gofastmcp.com/v2/patterns/tool-transformation#basic-transformation)
...
###
[​](https://gofastmcp.com/v2/patterns/tool-transformation#parameters)
Parameters
The `Tool.from_tool()` class method is the primary way to create a transformed tool. It takes the following parameters:
  ...
  * `output_schema`: Control output schema and structured outputs (see [Output Schema Control](https://gofastmcp.com/v2/patterns/tool-transformation#output-schema-control)).
...
##
[​](https://gofastmcp.com/v2/patterns/tool-transformation#modifying-arguments)
Modifying Arguments
...
###
[​](https://gofastmcp.com/v2/patterns/tool-transformation#the-argtransform-class)
...
###
[​](https://gofastmcp.com/v2/patterns/tool-transformation#descriptions)
Descriptions
...
###
[​](https://gofastmcp.com/v2/patterns/tool-transformation#names)
Names
...
###
[​](https://gofastmcp.com/v2/patterns/tool-transformation#default-values)
Default Values
...
###
[​](https://gofastmcp.com/v2/patterns/tool-transformation#hiding-arguments)
Hiding Arguments
...
###
[​](https://gofastmcp.com/v2/patterns/tool-transformation#meta-information)
Meta Information
`2.11.0` You can control meta information on transformed tools using the `meta` parameter. Meta information is additional data about the tool that doesn’t affect its functionality but can be used by clients for categorization, routing, or other purposes.
Copy
```
from fastmcp import FastMCP
from fastmcp.tools import Tool
...
###
[​](https://gofastmcp.com/v2/patterns/tool-transformation#required-values)
Required Values
...
##
[​](https://gofastmcp.com/v2/patterns/tool-transformation#modifying-tool-behavior)
...
###
[​](https://gofastmcp.com/v2/patterns/tool-transformation#the-transform-function)
...
###
[​](https://gofastmcp.com/v2/patterns/tool-transformation#calling-the-parent-tool)
...
###
[​](https://gofastmcp.com/v2/patterns/tool-transformation#passing-arguments-with-kwargs)
...
##
[​](https://gofastmcp.com/v2/patterns/tool-transformation#modifying-mcp-tools-with-mcpconfig)
...
The `tools` section is a dictionary of tool names to tool configurations. Each tool configuration is a dictionary of tool properties. See the [MCPConfigTransport](https://gofastmcp.com/v2/clients/transports#tool-transformation-with-fastmcp-and-mcpconfig) documentation for more details.
##
[​](https://gofastmcp.com/v2/patterns/tool-transformation#output-schema-control)
Output Schema Control
`2.10.0` Transformed tools inherit output schemas from their parent by default, but you can control this behavior: **Inherit from Parent (Default)**
Copy
```
...
##
[​](https://gofastmcp.com/v2/patterns/tool-transformation#common-patterns)
Common Patterns
...
###
[​](https://gofastmcp.com/v2/patterns/tool-transformation#exposing-client-methods-as-tools)
...
####
[​](https://gofastmcp.com/v2/patterns/tool-transformation#hiding-client-specific-arguments)
...
####
[​](https://gofastmcp.com/v2/patterns/tool-transformation#reusable-argument-patterns)
...
###
[​](https://gofastmcp.com/v2/patterns/tool-transformation#adapting-remote-or-generated-tools)
Adapting Remote or Generated Tools
This is one of the most common reasons to use tool transformation. Tools from remote MCP servers (via a [proxy](https://gofastmcp.com/v2/servers/proxy)) or generated from an [OpenAPI spec](https://gofastmcp.com/v2/integrations/openapi) are often too generic for direct use by an LLM. You can use transformation to create a simpler, more intuitive version for your specific needs.
###
[​](https://gofastmcp.com/v2/patterns/tool-transformation#chaining-transformations)
...
###
[​](https://gofastmcp.com/v2/patterns/tool-transformation#context-aware-tool-factories)
...
[ OpenAPI 🤝 FastMCP Previous ](https://gofastmcp.com/v2/integrations/openapi)[ Decorating Methods Next ](https://gofastmcp.com/v2/patterns/decorating-methods)
Ctrl+I
