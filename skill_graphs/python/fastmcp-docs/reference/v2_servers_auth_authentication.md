[Skip to main content](https://gofastmcp.com/v2/servers/auth/authentication#content-area)
...
On this page
  * [MCP Authentication Challenges](https://gofastmcp.com/v2/servers/auth/authentication#mcp-authentication-challenges)
  * [Authentication Responsibility](https://gofastmcp.com/v2/servers/auth/authentication#authentication-responsibility)
  * [Token Validation](https://gofastmcp.com/v2/servers/auth/authentication#token-validation)
  * [External Identity Providers](https://gofastmcp.com/v2/servers/auth/authentication#external-identity-providers)
  * [Full OAuth Implementation](https://gofastmcp.com/v2/servers/auth/authentication#full-oauth-implementation)
  * [FastMCP Authentication Providers](https://gofastmcp.com/v2/servers/auth/authentication#fastmcp-authentication-providers)
  * [TokenVerifier](https://gofastmcp.com/v2/servers/auth/authentication#tokenverifier)
  * [RemoteAuthProvider](https://gofastmcp.com/v2/servers/auth/authentication#remoteauthprovider)
  * [OAuthProxy](https://gofastmcp.com/v2/servers/auth/authentication#oauthproxy)
  * [OAuthProvider](https://gofastmcp.com/v2/servers/auth/authentication#oauthprovider)
  * [Configuration Approaches](https://gofastmcp.com/v2/servers/auth/authentication#configuration-approaches)
  * [Programmatic Configuration](https://gofastmcp.com/v2/servers/auth/authentication#programmatic-configuration)
  * [Environment Configuration](https://gofastmcp.com/v2/servers/auth/authentication#environment-configuration)
  * [Provider Configuration](https://gofastmcp.com/v2/servers/auth/authentication#provider-configuration)
  * [Provider-Specific Configuration](https://gofastmcp.com/v2/servers/auth/authentication#provider-specific-configuration)
  * [Choosing Your Implementation](https://gofastmcp.com/v2/servers/auth/authentication#choosing-your-implementation)
...
##
[​](https://gofastmcp.com/v2/servers/auth/authentication#mcp-authentication-challenges)
...
##
[​](https://gofastmcp.com/v2/servers/auth/authentication#authentication-responsibility)
...
###
[​](https://gofastmcp.com/v2/servers/auth/authentication#token-validation)
Token Validation
...
###
[​](https://gofastmcp.com/v2/servers/auth/authentication#external-identity-providers)
...
###
[​](https://gofastmcp.com/v2/servers/auth/authentication#full-oauth-implementation)
...
##
[​](https://gofastmcp.com/v2/servers/auth/authentication#fastmcp-authentication-providers)
...
###
[​](https://gofastmcp.com/v2/servers/auth/authentication#tokenverifier)
TokenVerifier
...
This example configures token validation against a JWT issuer. The `JWTVerifier` will fetch public keys from the JWKS endpoint and validate incoming tokens against those keys. Only tokens with the correct issuer and audience claims will be accepted. `TokenVerifier` works well when you control both the token issuer and your MCP server, or when integrating with existing JWT-based infrastructure. → **Complete guide** : [Token Verification](https://gofastmcp.com/v2/servers/auth/token-verification)
###
[​](https://gofastmcp.com/v2/servers/auth/authentication#remoteauthprovider)
RemoteAuthProvider
`RemoteAuthProvider` enables authentication with identity providers that **support Dynamic Client Registration (DCR)** , such as Descope and WorkOS AuthKit. With DCR, MCP clients can automatically register themselves with the identity provider and obtain credentials without any manual configuration. This class combines token validation with OAuth discovery metadata. It extends `TokenVerifier` functionality by adding OAuth 2.0 protected resource endpoints that advertise your authentication requirements. MCP clients examine these endpoints to understand which identity providers you trust and how to obtain valid tokens. The key requirement is that your identity provider must support DCR - the ability for clients to dynamically register and obtain credentials. This is what enables the seamless, automated authentication flow that MCP requires. For example, the built-in `AuthKitProvider` uses WorkOS AuthKit, which fully supports DCR:
Copy
```
from fastmcp import FastMCP
...
This example shows the basic structure of a custom OAuth provider. The actual implementation requires significant additional configuration for user management, client registration, and security policies. `OAuthProvider` should be used only when you have specific requirements that external providers cannot meet and the expertise to implement OAuth securely. → **Complete guide** : [Full OAuth Server](https://gofastmcp.com/v2/servers/auth/full-oauth-server)
##
[​](https://gofastmcp.com/v2/servers/auth/authentication#configuration-approaches)
...
###
[​](https://gofastmcp.com/v2/servers/auth/authentication#programmatic-configuration)
...
####
[​](https://gofastmcp.com/v2/servers/auth/authentication#provider-specific-configuration)
...
##
[​](https://gofastmcp.com/v2/servers/auth/authentication#choosing-your-implementation)
...
[ Background Tasks Previous ](https://gofastmcp.com/v2/servers/tasks)[ Token Verification Next ](https://gofastmcp.com/v2/servers/auth/token-verification)
Ctrl+I
