[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-providers-__init__#content-area)
...
On this page
  * [fastmcp.server.providers](https://gofastmcp.com/python-sdk/fastmcp-server-providers-__init__#fastmcp-server-providers)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-__init__#fastmcp-server-providers)
`fastmcp.server.providers`
Providers for dynamic MCP components. This module provides the `Provider` abstraction for providing tools, resources, and prompts dynamically at runtime. Example:
Copy
```
...
[ server Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-server)[ aggregate Next ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-aggregate)
Ctrl+I
