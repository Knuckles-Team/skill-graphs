[Skip to main content](https://gofastmcp.com/v2/servers/prompts#content-area)
...
On this page
  * [What Are Prompts?](https://gofastmcp.com/v2/servers/prompts#what-are-prompts)
  * [Prompts](https://gofastmcp.com/v2/servers/prompts#prompts)
  * [The @prompt Decorator](https://gofastmcp.com/v2/servers/prompts#the-%40prompt-decorator)
  * [Decorator Arguments](https://gofastmcp.com/v2/servers/prompts#decorator-arguments)
  * [Argument Types](https://gofastmcp.com/v2/servers/prompts#argument-types)
  * [Return Values](https://gofastmcp.com/v2/servers/prompts#return-values)
  * [Required vs. Optional Parameters](https://gofastmcp.com/v2/servers/prompts#required-vs-optional-parameters)
  * [Disabling Prompts](https://gofastmcp.com/v2/servers/prompts#disabling-prompts)
  * [Async Prompts](https://gofastmcp.com/v2/servers/prompts#async-prompts)
  * [Accessing MCP Context](https://gofastmcp.com/v2/servers/prompts#accessing-mcp-context)
  * [Notifications](https://gofastmcp.com/v2/servers/prompts#notifications)
  * [Server Behavior](https://gofastmcp.com/v2/servers/prompts#server-behavior)
  * [Duplicate Prompts](https://gofastmcp.com/v2/servers/prompts#duplicate-prompts)
...
##
[​](https://gofastmcp.com/v2/servers/prompts#what-are-prompts)
What Are Prompts?
...
##
[​](https://gofastmcp.com/v2/servers/prompts#prompts)
Prompts
###
[​](https://gofastmcp.com/v2/servers/prompts#the-@prompt-decorator)
...
####
[​](https://gofastmcp.com/v2/servers/prompts#decorator-arguments)
Decorator Arguments
...
[​](https://gofastmcp.com/v2/servers/prompts#param-enabled)
enabled
bool
default:"True"
A boolean to enable or disable the prompt. See [Disabling Prompts](https://gofastmcp.com/v2/servers/prompts#disabling-prompts) for more information
[​](https://gofastmcp.com/v2/servers/prompts#param-icons)
icons
list[Icon] | None
`2.13.0`Optional list of icon representations for this prompt. See [Icons](https://gofastmcp.com/v2/servers/icons) for detailed examples
[​](https://gofastmcp.com/v2/servers/prompts#param-meta)
meta
dict[str, Any] | None
`2.11.0`Optional meta information about the prompt. This data is passed through to the MCP client as the `_meta` field of the client-side prompt object and can be used for custom metadata, versioning, or other application-specific purposes.
###
[​](https://gofastmcp.com/v2/servers/prompts#argument-types)
Argument Types
...
###
[​](https://gofastmcp.com/v2/servers/prompts#return-values)
Return Values
...
###
[​](https://gofastmcp.com/v2/servers/prompts#required-vs-optional-parameters)
...
###
[​](https://gofastmcp.com/v2/servers/prompts#disabling-prompts)
Disabling Prompts
...
###
[​](https://gofastmcp.com/v2/servers/prompts#async-prompts)
Async Prompts
...
###
[​](https://gofastmcp.com/v2/servers/prompts#accessing-mcp-context)
...
###
[​](https://gofastmcp.com/v2/servers/prompts#notifications)
Notifications
...
Notifications are only sent when these operations occur within an active MCP request context (e.g., when called from within a tool or other MCP operation). Operations performed during server initialization do not trigger notifications. Clients can handle these notifications using a [message handler](https://gofastmcp.com/v2/clients/messages) to automatically refresh their prompt lists or update their interfaces.
##
[​](https://gofastmcp.com/v2/servers/prompts#server-behavior)
Server Behavior
###
[​](https://gofastmcp.com/v2/servers/prompts#duplicate-prompts)
Duplicate Prompts
...
[ Resources & Templates Previous ](https://gofastmcp.com/v2/servers/resources)[ Server Composition Next ](https://gofastmcp.com/v2/servers/composition)
Ctrl+I
