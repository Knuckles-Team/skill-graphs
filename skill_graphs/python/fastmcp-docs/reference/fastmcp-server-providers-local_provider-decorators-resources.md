[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-resources#content-area)
...
##### fastmcp.server
  ...
  * providers
    ...
    * local_provider
      * [__init__](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-__init__)
      * decorators
        * [__init__](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-__init__)
        * [prompts](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-prompts)
        * [resources](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-resources)
        * [tools](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-tools)
      * [local_provider](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-local_provider)
    * openapi
...
On this page
  * [fastmcp.server.providers.local_provider.decorators.resources](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-resources#fastmcp-server-providers-local_provider-decorators-resources)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-resources#classes)
  * [ResourceDecoratorMixin ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-resources#resourcedecoratormixin)
  * [add_resource ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-resources#add_resource)
  * [add_template ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-resources#add_template)
  * [resource ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-resources#resource)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-resources#fastmcp-server-providers-local_provider-decorators-resources)
...
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-resources#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-resources#resourcedecoratormixin)
...
**Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-resources#add_resource)
`add_resource`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-resources#add_template)
`add_template`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-resources#resource)
`resource`
Copy
```
...
[ prompts Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-prompts)[ tools Next ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-tools)
Ctrl+I
