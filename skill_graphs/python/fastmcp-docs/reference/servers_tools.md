[Skip to main content](https://gofastmcp.com/servers/tools#content-area)
...
On this page
  * [The @tool Decorator](https://gofastmcp.com/servers/tools#the-%40tool-decorator)
  * [Decorator Arguments](https://gofastmcp.com/servers/tools#decorator-arguments)
  * [Using with Methods](https://gofastmcp.com/servers/tools#using-with-methods)
  * [Async Support](https://gofastmcp.com/servers/tools#async-support)
  * [Arguments](https://gofastmcp.com/servers/tools#arguments)
  * [Type Annotations](https://gofastmcp.com/servers/tools#type-annotations)
  * [Optional Arguments](https://gofastmcp.com/servers/tools#optional-arguments)
  * [Validation Modes](https://gofastmcp.com/servers/tools#validation-modes)
  * [Parameter Metadata](https://gofastmcp.com/servers/tools#parameter-metadata)
  * [Simple String Descriptions](https://gofastmcp.com/servers/tools#simple-string-descriptions)
  * [Advanced Metadata with Field](https://gofastmcp.com/servers/tools#advanced-metadata-with-field)
  * [Hiding Parameters from the LLM](https://gofastmcp.com/servers/tools#hiding-parameters-from-the-llm)
  * [Return Values](https://gofastmcp.com/servers/tools#return-values)
  * [Content Blocks](https://gofastmcp.com/servers/tools#content-blocks)
  * [Media Helper Classes](https://gofastmcp.com/servers/tools#media-helper-classes)
  * [Structured Output](https://gofastmcp.com/servers/tools#structured-output)
  * [Dictionaries and Objects](https://gofastmcp.com/servers/tools#dictionaries-and-objects)
  * [Primitives and Collections](https://gofastmcp.com/servers/tools#primitives-and-collections)
  * [Typed Models](https://gofastmcp.com/servers/tools#typed-models)
  * [Output Schemas](https://gofastmcp.com/servers/tools#output-schemas)
  * [Primitive Type Wrapping](https://gofastmcp.com/servers/tools#primitive-type-wrapping)
  * [Manual Schema Control](https://gofastmcp.com/servers/tools#manual-schema-control)
  * [ToolResult and Metadata](https://gofastmcp.com/servers/tools#toolresult-and-metadata)
  * [Custom Serialization](https://gofastmcp.com/servers/tools#custom-serialization)
  * [Error Handling](https://gofastmcp.com/servers/tools#error-handling)
  * [Timeouts](https://gofastmcp.com/servers/tools#timeouts)
  * [Timeouts vs Background Tasks](https://gofastmcp.com/servers/tools#timeouts-vs-background-tasks)
  * [Component Visibility](https://gofastmcp.com/servers/tools#component-visibility)
  * [MCP Annotations](https://gofastmcp.com/servers/tools#mcp-annotations)
  * [Using Annotation Hints](https://gofastmcp.com/servers/tools#using-annotation-hints)
  * [Notifications](https://gofastmcp.com/servers/tools#notifications)
  * [Accessing the MCP Context](https://gofastmcp.com/servers/tools#accessing-the-mcp-context)
  * [Server Behavior](https://gofastmcp.com/servers/tools#server-behavior)
  * [Duplicate Tools](https://gofastmcp.com/servers/tools#duplicate-tools)
  * [Removing Tools](https://gofastmcp.com/servers/tools#removing-tools)
  * [Versioning](https://gofastmcp.com/servers/tools#versioning)
...
##
[​](https://gofastmcp.com/servers/tools#the-@tool-decorator)
The `@tool` Decorator
...
[​](https://gofastmcp.com/servers/tools#param-enabled)
enabled
bool
default:"True"
Deprecated in v3.0.0. Use `mcp.enable()` / `mcp.disable()` at the server level instead.
A boolean to enable or disable the tool. See [Component Visibility](https://gofastmcp.com/servers/tools#component-visibility) for the recommended approach.
[​](https://gofastmcp.com/servers/tools#param-icons)
icons
list[Icon] | None
`2.13.0`Optional list of icon representations for this tool. See [Icons](https://gofastmcp.com/servers/icons) for detailed examples
...
[​](https://gofastmcp.com/servers/tools#param-title)
title
str | None
A human-readable title for the tool.
[​](https://gofastmcp.com/servers/tools#param-read-only-hint)
readOnlyHint
bool | None
If true, the tool does not modify its environment.
[​](https://gofastmcp.com/servers/tools#param-destructive-hint)
destructiveHint
bool | None
If true, the tool may perform destructive updates to its environment.
[​](https://gofastmcp.com/servers/tools#param-idempotent-hint)
idempotentHint
bool | None
If true, calling the tool repeatedly with the same arguments will have no additional effect on the its environment.
[​](https://gofastmcp.com/servers/tools#param-open-world-hint)
openWorldHint
bool | None
...
meta
dict[str, Any] | None
`2.11.0`Optional meta information about the tool. This data is passed through to the MCP client as the `meta` field of the client-side tool object and can be used for custom metadata, versioning, or other application-specific purposes.
[​](https://gofastmcp.com/servers/tools#param-timeout)
timeout
float | None
`3.0.0`Execution timeout in seconds. If the tool takes longer than this to complete, an MCP error is returned to the client. See [Timeouts](https://gofastmcp.com/servers/tools#timeouts) for details.
[​](https://gofastmcp.com/servers/tools#param-version)
version
str | int | None
`3.0.0`Optional version identifier for this tool. See [Versioning](https://gofastmcp.com/servers/versioning) for details.
[​](https://gofastmcp.com/servers/tools#param-output-schema)
output_schema
dict[str, Any] | None
`2.10.0`Optional JSON schema for the tool’s output. When provided, the tool must return structured output matching this schema. If not provided, FastMCP automatically generates a schema from the function’s return type annotation. See [Output Schemas](https://gofastmcp.com/servers/tools#output-schemas) for details.
###
[​](https://gofastmcp.com/servers/tools#using-with-methods)
Using with Methods
...
###
[​](https://gofastmcp.com/servers/tools#async-support)
Async Support
...
##
[​](https://gofastmcp.com/servers/tools#arguments)
Arguments
...
`2.11.0` For basic parameter descriptions, you can use a convenient shorthand with `Annotated`:
Copy
```
...
####
[​](https://gofastmcp.com/servers/tools#advanced-metadata-with-field)
...
###
[​](https://gofastmcp.com/servers/tools#hiding-parameters-from-the-llm)
Hiding Parameters from the LLM
`2.14.0` To inject values at runtime without exposing them to the LLM (such as `user_id`, credentials, or database connections), use dependency injection with `Depends()`. Parameters using `Depends()` are automatically excluded from the tool schema:
Copy
```
from fastmcp import FastMCP
...
See [Custom Dependencies](https://gofastmcp.com/servers/context#custom-dependencies) for more details on dependency injection.
##
[​](https://gofastmcp.com/servers/tools#return-values)
Return Values
...
###
[​](https://gofastmcp.com/servers/tools#content-blocks)
Content Blocks
...
####
[​](https://gofastmcp.com/servers/tools#media-helper-classes)
...
Structured Output
`2.10.0` The 6/18/2025 MCP spec update  **Automatic Structured Content Rules:**
...
####
[​](https://gofastmcp.com/servers/tools#dictionaries-and-objects)
...
####
[​](https://gofastmcp.com/servers/tools#primitives-and-collections)
...
####
[​](https://gofastmcp.com/servers/tools#typed-models)
Typed Models
...
Output Schemas
`2.10.0` The 6/18/2025 MCP spec update _must_ return structured output that matches the schema. When you add return type annotations to your functions, FastMCP automatically generates JSON schemas that describe the expected output format. These schemas help MCP clients understand and validate the structured data they receive.
####
[​](https://gofastmcp.com/servers/tools#primitive-type-wrapping)
...
####
[​](https://gofastmcp.com/servers/tools#manual-schema-control)
...
###
[​](https://gofastmcp.com/servers/tools#toolresult-and-metadata)
...
**`meta`**`2.13.1` Runtime metadata about the tool execution. Use this for performance metrics, debugging information, or any client-specific data that doesn’t belong in the content or structured output.
Copy
```
ToolResult(
...
###
[​](https://gofastmcp.com/servers/tools#custom-serialization)
...
For reusable serialization across multiple tools, create a wrapper decorator that returns `ToolResult`. This lets you compose serializers with other behaviors (logging, validation, caching) and keeps the serialization visible at the tool definition. See
##
[​](https://gofastmcp.com/servers/tools#error-handling)
Error Handling
...
##
[​](https://gofastmcp.com/servers/tools#timeouts)
Timeouts
`3.0.0` Tools can specify a `timeout` parameter to limit how long execution can take. When the timeout is exceeded, the client receives an MCP error and the tool stops processing. This protects your server from unexpectedly slow operations that could block resources or leave clients waiting indefinitely.
Copy
```
from fastmcp import FastMCP
...
###
[​](https://gofastmcp.com/servers/tools#timeouts-vs-background-tasks)
...
##
[​](https://gofastmcp.com/servers/tools#component-visibility)
Component Visibility
`3.0.0` You can control which tools are enabled for clients using server-level enabled control. Disabled tools don’t appear in `list_tools` and can’t be called.
Copy
```
from fastmcp import FastMCP
...
MCP Annotations
`2.2.7` FastMCP allows you to add specialized metadata to your tools through annotations. These annotations communicate how tools behave to client applications without consuming token context in LLM prompts. Annotations serve several purposes in client applications:
...
###
[​](https://gofastmcp.com/servers/tools#using-annotation-hints)
Using Annotation Hints
MCP clients like Claude and ChatGPT use annotation hints to determine when to skip confirmation prompts and how to present tools to users. The most commonly used hint is `readOnlyHint`, which signals that a tool only reads data without making changes. **Read-only tools** improve user experience by:
...
For tools that write to databases, send notifications, create/update/delete resources, or trigger workflows, omit `readOnlyHint` or set it to `False`. Use `destructiveHint=True` for operations that cannot be undone. Client-specific behavior:
  * **ChatGPT** : Skips confirmation prompts for read-only tools in Chat mode (see [ChatGPT integration](https://gofastmcp.com/integrations/chatgpt))
  * **Claude** : Uses hints to understand tool safety profiles and make better execution decisions


##
[​](https://gofastmcp.com/servers/tools#notifications)
Notifications
`2.9.1` FastMCP automatically sends `notifications/tools/list_changed` notifications to connected clients when tools are added, removed, enabled, or disabled. This allows clients to stay up-to-date with the current tool set without manually polling for changes.
Copy
```
@mcp.tool
...
Notifications are only sent when these operations occur within an active MCP request context (e.g., when called from within a tool or other MCP operation). Operations performed during server initialization do not trigger notifications. Clients can handle these notifications using a [message handler](https://gofastmcp.com/clients/notifications) to automatically refresh their tool lists or update their interfaces.
##
[​](https://gofastmcp.com/servers/tools#accessing-the-mcp-context)
...
##
[​](https://gofastmcp.com/servers/tools#server-behavior)
Server Behavior
###
[​](https://gofastmcp.com/servers/tools#duplicate-tools)
Duplicate Tools
`2.1.0` You can control how the FastMCP server behaves if you try to register multiple tools with the same name. This is configured using the `on_duplicate_tools` argument when creating the `FastMCP` instance.
Copy
```
from fastmcp import FastMCP
...
###
[​](https://gofastmcp.com/servers/tools#removing-tools)
Removing Tools
`2.3.4` You can dynamically remove tools from a server through its [local provider](https://gofastmcp.com/servers/providers/local):
Copy
```
from fastmcp import FastMCP
...
##
[​](https://gofastmcp.com/servers/tools#versioning)
Versioning
`3.0.0` Tools support versioning, allowing you to maintain multiple implementations under the same name while clients automatically receive the highest version. See [Versioning](https://gofastmcp.com/servers/versioning) for complete documentation on version comparison, retrieval, and migration patterns.
[ The FastMCP Server Previous ](https://gofastmcp.com/servers/server)[ Resources & Templates Next ](https://gofastmcp.com/servers/resources)
Ctrl+I
