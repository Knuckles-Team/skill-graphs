[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-dereference#content-area)
...
On this page
  * [fastmcp.server.middleware.dereference](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-dereference#fastmcp-server-middleware-dereference)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-dereference#classes)
  * [DereferenceRefsMiddleware ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-dereference#dereferencerefsmiddleware)
  * [on_list_tools ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-dereference#on_list_tools)
  * [on_list_resource_templates ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-dereference#on_list_resource_templates)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-dereference#fastmcp-server-middleware-dereference)
`fastmcp.server.middleware.dereference`
Middleware that dereferences $ref in JSON schemas before sending to clients.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-dereference#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-dereference#dereferencerefsmiddleware)
`DereferenceRefsMiddleware`
Dereferences $ref in component schemas before sending to clients. Some MCP clients (e.g., VS Code Copilot) don’t handle JSON Schema refproperly.Thismiddlewareinlinesallref properly. This middleware inlines all refproperly.Thismiddlewareinlinesallref definitions so schemas are self-contained. Enabled by default via `FastMCP(dereference_schemas=True)`. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-dereference#on_list_tools)
`on_list_tools`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-dereference#on_list_resource_templates)
...
[ caching Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-caching)[ error_handling Next ](https://gofastmcp.com/python-sdk/fastmcp-server-middleware-error_handling)
Ctrl+I
