[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-search-bm25#content-area)
...
##### fastmcp.server
  ...
  * transforms
    ...
    * search
      * [__init__](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-search-__init__)
      * [base](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-search-base)
      * [bm25](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-search-bm25)
      * [regex](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-search-regex)
...
On this page
  * [fastmcp.server.transforms.search.bm25](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-search-bm25#fastmcp-server-transforms-search-bm25)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-search-bm25#classes)
  * [BM25SearchTransform ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-search-bm25#bm25searchtransform)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-search-bm25#fastmcp-server-transforms-search-bm25)
`fastmcp.server.transforms.search.bm25`
BM25-based search transform.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-search-bm25#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-search-bm25#bm25searchtransform)
`BM25SearchTransform`
Search transform using BM25 Okapi relevance ranking. Maintains an in-memory index that is lazily rebuilt when the tool catalog changes (detected via a hash of tool names).
[ base Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-search-base)[ regex Next ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-search-regex)
Ctrl+I
