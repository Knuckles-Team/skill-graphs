[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-oci#content-area)
...
On this page
  * [fastmcp.server.auth.providers.oci](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-oci#fastmcp-server-auth-providers-oci)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-oci#classes)
  * [OCIProvider ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-oci#ociprovider)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-oci#fastmcp-server-auth-providers-oci)
...
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-oci#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-oci#ociprovider)
`OCIProvider`
...
[ jwt Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-jwt)[ propelauth Next ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-propelauth)
Ctrl+I
