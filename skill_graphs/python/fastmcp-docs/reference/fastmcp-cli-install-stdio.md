[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-cli-install-stdio#content-area)
...
On this page
  * [fastmcp.cli.install.stdio](https://gofastmcp.com/python-sdk/fastmcp-cli-install-stdio#fastmcp-cli-install-stdio)
  * [Functions](https://gofastmcp.com/python-sdk/fastmcp-cli-install-stdio#functions)
  * [install_stdio ](https://gofastmcp.com/python-sdk/fastmcp-cli-install-stdio#install_stdio)
  * [stdio_command ](https://gofastmcp.com/python-sdk/fastmcp-cli-install-stdio#stdio_command)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-stdio#fastmcp-cli-install-stdio)
`fastmcp.cli.install.stdio`
Stdio command generation for FastMCP install using Cyclopts.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-stdio#functions)
Functions
###
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-stdio#install_stdio)
`install_stdio`
Copy
```
...
Generate the stdio command for running a FastMCP server. **Args:**
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-stdio#stdio_command)
`stdio_command`
Copy
```
...
Generate the stdio command for running a FastMCP server. Outputs the shell command that an MCP host would use to start this server over stdio transport. Useful for manual configuration or debugging. **Args:**
  * `server_spec`: Python file to run, optionally with :object suffix


[ shared Previous ](https://gofastmcp.com/python-sdk/fastmcp-cli-install-shared)[ run Next ](https://gofastmcp.com/python-sdk/fastmcp-cli-run)
Ctrl+I
