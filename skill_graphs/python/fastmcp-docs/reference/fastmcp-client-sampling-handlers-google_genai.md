[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-google_genai#content-area)
...
##### fastmcp.client
  ...
  * sampling
    * [__init__](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-__init__)
    * handlers
      * [__init__](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-__init__)
      * [anthropic](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-anthropic)
      * [google_genai](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-google_genai)
      * [openai](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-openai)
...
On this page
  * [fastmcp.client.sampling.handlers.google_genai](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-google_genai#fastmcp-client-sampling-handlers-google_genai)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-google_genai#classes)
  * [GoogleGenaiSamplingHandler ](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-google_genai#googlegenaisamplinghandler)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-google_genai#fastmcp-client-sampling-handlers-google_genai)
`fastmcp.client.sampling.handlers.google_genai`
Google GenAI sampling handler with tool support for FastMCP 3.0.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-google_genai#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-google_genai#googlegenaisamplinghandler)
`GoogleGenaiSamplingHandler`
Sampling handler that uses the Google GenAI API with tool support.
[ anthropic Previous ](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-anthropic)[ openai Next ](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-openai)
Ctrl+I
