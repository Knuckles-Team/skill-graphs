[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#content-area)
...
##### fastmcp.cli
  ...
  * install
    * [__init__](https://gofastmcp.com/python-sdk/fastmcp-cli-install-__init__)
    * [claude_code](https://gofastmcp.com/python-sdk/fastmcp-cli-install-claude_code)
    * [claude_desktop](https://gofastmcp.com/python-sdk/fastmcp-cli-install-claude_desktop)
    * [cursor](https://gofastmcp.com/python-sdk/fastmcp-cli-install-cursor)
    * [gemini_cli](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli)
    * [goose](https://gofastmcp.com/python-sdk/fastmcp-cli-install-goose)
    * [mcp_json](https://gofastmcp.com/python-sdk/fastmcp-cli-install-mcp_json)
    * [shared](https://gofastmcp.com/python-sdk/fastmcp-cli-install-shared)
    * [stdio](https://gofastmcp.com/python-sdk/fastmcp-cli-install-stdio)
...
On this page
  * [fastmcp.cli.install.gemini_cli](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#fastmcp-cli-install-gemini_cli)
  * [Functions](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#functions)
  * [find_gemini_command ](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#find_gemini_command)
  * [check_gemini_cli_available ](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#check_gemini_cli_available)
  * [install_gemini_cli ](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#install_gemini_cli)
  * [gemini_cli_command ](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#gemini_cli_command)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#fastmcp-cli-install-gemini_cli)
`fastmcp.cli.install.gemini_cli`
Gemini CLI integration for FastMCP install using Cyclopts.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#functions)
Functions
###
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#find_gemini_command)
`find_gemini_command`
Copy
```
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#check_gemini_cli_available)
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#install_gemini_cli)
`install_gemini_cli`
Copy
```
...
Install FastMCP server in Gemini CLI. **Args:**
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-install-gemini_cli#gemini_cli_command)
`gemini_cli_command`
Copy
```
...
Install an MCP server in Gemini CLI. **Args:**
  * `server_spec`: Python file to install, optionally with :object suffix


[ cursor Previous ](https://gofastmcp.com/python-sdk/fastmcp-cli-install-cursor)[ goose Next ](https://gofastmcp.com/python-sdk/fastmcp-cli-install-goose)
Ctrl+I
