[Skip to main content](https://gofastmcp.com/v2/development/releases#content-area)
...
On this page
  * [Versioning Policy](https://gofastmcp.com/v2/development/releases#versioning-policy)
  * [Semantic Versioning](https://gofastmcp.com/v2/development/releases#semantic-versioning)
  * [Breaking Changes](https://gofastmcp.com/v2/development/releases#breaking-changes)
  * [Production Use](https://gofastmcp.com/v2/development/releases#production-use)
  * [Creating Releases](https://gofastmcp.com/v2/development/releases#creating-releases)
  * [Release Cadence](https://gofastmcp.com/v2/development/releases#release-cadence)
...
##
[​](https://gofastmcp.com/v2/development/releases#versioning-policy)
Versioning Policy
###
[​](https://gofastmcp.com/v2/development/releases#semantic-versioning)
Semantic Versioning
...
Unlike traditional semantic versioning, minor versions **may** include [breaking changes](https://gofastmcp.com/v2/development/releases#breaking-changes) when necessary for the ecosystem’s evolution. This flexibility is essential in a young ecosystem where perfect backwards compatibility would prevent important improvements.
...
###
[​](https://gofastmcp.com/v2/development/releases#breaking-changes)
Breaking Changes
...
###
[​](https://gofastmcp.com/v2/development/releases#production-use)
Production Use
...
##
[​](https://gofastmcp.com/v2/development/releases#creating-releases)
Creating Releases
...
###
[​](https://gofastmcp.com/v2/development/releases#release-cadence)
Release Cadence
...
[ Tests Previous ](https://gofastmcp.com/v2/development/tests)[ Upgrade Guide Next ](https://gofastmcp.com/v2/development/upgrade-guide)
Ctrl+I
