[Skip to main content](https://gofastmcp.com/v2/servers/resources#content-area)
...
On this page
  * [What Are Resources?](https://gofastmcp.com/v2/servers/resources#what-are-resources)
  * [Resources](https://gofastmcp.com/v2/servers/resources#resources)
  * [The @resource Decorator](https://gofastmcp.com/v2/servers/resources#the-%40resource-decorator)
  * [Decorator Arguments](https://gofastmcp.com/v2/servers/resources#decorator-arguments)
  * [Return Values](https://gofastmcp.com/v2/servers/resources#return-values)
  * [Disabling Resources](https://gofastmcp.com/v2/servers/resources#disabling-resources)
  * [Accessing MCP Context](https://gofastmcp.com/v2/servers/resources#accessing-mcp-context)
  * [Async Resources](https://gofastmcp.com/v2/servers/resources#async-resources)
  * [Resource Classes](https://gofastmcp.com/v2/servers/resources#resource-classes)
  * [Notifications](https://gofastmcp.com/v2/servers/resources#notifications)
  * [Annotations](https://gofastmcp.com/v2/servers/resources#annotations)
  * [Resource Templates](https://gofastmcp.com/v2/servers/resources#resource-templates)
  * [RFC 6570 URI Templates](https://gofastmcp.com/v2/servers/resources#rfc-6570-uri-templates)
  * [Wildcard Parameters](https://gofastmcp.com/v2/servers/resources#wildcard-parameters)
  * [Query Parameters](https://gofastmcp.com/v2/servers/resources#query-parameters)
  * [Template Parameter Rules](https://gofastmcp.com/v2/servers/resources#template-parameter-rules)
  * [Error Handling](https://gofastmcp.com/v2/servers/resources#error-handling)
  * [Server Behavior](https://gofastmcp.com/v2/servers/resources#server-behavior)
  * [Duplicate Resources](https://gofastmcp.com/v2/servers/resources#duplicate-resources)
...
##
[​](https://gofastmcp.com/v2/servers/resources#what-are-resources)
What Are Resources?
...
##
[​](https://gofastmcp.com/v2/servers/resources#resources)
Resources
###
[​](https://gofastmcp.com/v2/servers/resources#the-@resource-decorator)
...
####
[​](https://gofastmcp.com/v2/servers/resources#decorator-arguments)
Decorator Arguments
...
[​](https://gofastmcp.com/v2/servers/resources#param-uri)
uri
str
required
The unique identifier for the resource
[​](https://gofastmcp.com/v2/servers/resources#param-name)
name
str | None
A human-readable name. If not provided, defaults to function name
[​](https://gofastmcp.com/v2/servers/resources#param-description)
description
str | None
Explanation of the resource. If not provided, defaults to docstring
[​](https://gofastmcp.com/v2/servers/resources#param-mime-type)
mime_type
str | None
...
[​](https://gofastmcp.com/v2/servers/resources#param-tags)
tags
set[str] | None
...
[​](https://gofastmcp.com/v2/servers/resources#param-enabled)
enabled
bool
default:"True"
A boolean to enable or disable the resource. See [Disabling Resources](https://gofastmcp.com/v2/servers/resources#disabling-resources) for more information
[​](https://gofastmcp.com/v2/servers/resources#param-icons)
icons
list[Icon] | None
`2.13.0`Optional list of icon representations for this resource or template. See [Icons](https://gofastmcp.com/v2/servers/icons) for detailed examples
[​](https://gofastmcp.com/v2/servers/resources#param-annotations)
annotations
...
[​](https://gofastmcp.com/v2/servers/resources#param-read-only-hint)
readOnlyHint
bool | None
If true, the resource is read-only and does not modify its environment.
[​](https://gofastmcp.com/v2/servers/resources#param-idempotent-hint)
idempotentHint
bool | None
If true, reading the resource repeatedly will have no additional effect on its environment.
[​](https://gofastmcp.com/v2/servers/resources#param-meta)
meta
dict[str, Any] | None
`2.11.0`Optional meta information about the resource. This data is passed through to the MCP client as the `_meta` field of the client-side resource object and can be used for custom metadata, versioning, or other application-specific purposes.
###
[​](https://gofastmcp.com/v2/servers/resources#return-values)
Return Values
...
###
[​](https://gofastmcp.com/v2/servers/resources#disabling-resources)
Disabling Resources
`2.8.0` You can control the visibility and availability of resources and templates by enabling or disabling them. Disabled resources will not appear in the list of available resources or templates, and attempting to read a disabled resource will result in an “Unknown resource” error. By default, all resources are enabled. You can disable a resource upon creation using the `enabled` parameter in the decorator:
Copy
```
...
###
[​](https://gofastmcp.com/v2/servers/resources#accessing-mcp-context)
Accessing MCP Context
`2.2.5` Resources and resource templates can access additional MCP information and features through the `Context` object. To access it, add a parameter to your resource function with a type annotation of `Context`:
Copy
```
...
###
[​](https://gofastmcp.com/v2/servers/resources#async-resources)
Async Resources
...
###
[​](https://gofastmcp.com/v2/servers/resources#resource-classes)
Resource Classes
...
###
[​](https://gofastmcp.com/v2/servers/resources#notifications)
Notifications
`2.9.1` FastMCP automatically sends `notifications/resources/list_changed` notifications to connected clients when resources or templates are added, enabled, or disabled. This allows clients to stay up-to-date with the current resource set without manually polling for changes.
Copy
```
...
Notifications are only sent when these operations occur within an active MCP request context (e.g., when called from within a tool or other MCP operation). Operations performed during server initialization do not trigger notifications. Clients can handle these notifications using a [message handler](https://gofastmcp.com/v2/clients/messages) to automatically refresh their resource lists or update their interfaces.
###
[​](https://gofastmcp.com/v2/servers/resources#annotations)
Annotations
`2.11.0` FastMCP allows you to add specialized metadata to your resources through annotations. These annotations communicate how resources behave to client applications without consuming token context in LLM prompts. Annotations serve several purposes in client applications:
...
##
[​](https://gofastmcp.com/v2/servers/resources#resource-templates)
Resource Templates
...
###
[​](https://gofastmcp.com/v2/servers/resources#rfc-6570-uri-templates)
RFC 6570 URI Templates
FastMCP implements
####
[​](https://gofastmcp.com/v2/servers/resources#wildcard-parameters)
Wildcard Parameters
...
####
[​](https://gofastmcp.com/v2/servers/resources#query-parameters)
Query Parameters
...
###
[​](https://gofastmcp.com/v2/servers/resources#template-parameter-rules)
Template Parameter Rules
`2.2.0` FastMCP enforces these validation rules when creating resource templates:
...
##
[​](https://gofastmcp.com/v2/servers/resources#error-handling)
Error Handling
...
##
[​](https://gofastmcp.com/v2/servers/resources#server-behavior)
Server Behavior
###
[​](https://gofastmcp.com/v2/servers/resources#duplicate-resources)
Duplicate Resources
`2.1.0` You can configure how the FastMCP server handles attempts to register multiple resources or templates with the same URI. Use the `on_duplicate_resources` setting during `FastMCP` initialization.
Copy
```
from fastmcp import FastMCP
...
[ Tools Previous ](https://gofastmcp.com/v2/servers/tools)[ Prompts Next ](https://gofastmcp.com/v2/servers/prompts)
Ctrl+I
