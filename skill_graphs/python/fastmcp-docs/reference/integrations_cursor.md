[Skip to main content](https://gofastmcp.com/integrations/cursor#content-area)
...
On this page
  * [Requirements](https://gofastmcp.com/integrations/cursor#requirements)
  * [Create a Server](https://gofastmcp.com/integrations/cursor#create-a-server)
  * [Install the Server](https://gofastmcp.com/integrations/cursor#install-the-server)
  * [FastMCP CLI](https://gofastmcp.com/integrations/cursor#fastmcp-cli)
  * [Workspace Installation](https://gofastmcp.com/integrations/cursor#workspace-installation)
  * [Dependencies](https://gofastmcp.com/integrations/cursor#dependencies)
  * [Python Version and Project Configuration](https://gofastmcp.com/integrations/cursor#python-version-and-project-configuration)
  * [Environment Variables](https://gofastmcp.com/integrations/cursor#environment-variables)
  * [Generate MCP JSON](https://gofastmcp.com/integrations/cursor#generate-mcp-json)
  * [Manual Configuration](https://gofastmcp.com/integrations/cursor#manual-configuration)
  * [Dependencies](https://gofastmcp.com/integrations/cursor#dependencies-2)
  * [Environment Variables](https://gofastmcp.com/integrations/cursor#environment-variables-2)
  * [Using the Server](https://gofastmcp.com/integrations/cursor#using-the-server)
...
##
[​](https://gofastmcp.com/integrations/cursor#requirements)
Requirements
...
##
[​](https://gofastmcp.com/integrations/cursor#create-a-server)
Create a Server
...
##
[​](https://gofastmcp.com/integrations/cursor#install-the-server)
Install the Server
###
[​](https://gofastmcp.com/integrations/cursor#fastmcp-cli)
FastMCP CLI
...
####
[​](https://gofastmcp.com/integrations/cursor#workspace-installation)
...
####
[​](https://gofastmcp.com/integrations/cursor#python-version-and-project-configuration)
...
####
[​](https://gofastmcp.com/integrations/cursor#environment-variables)
...
###
[​](https://gofastmcp.com/integrations/cursor#generate-mcp-json)
Generate MCP JSON
...
###
[​](https://gofastmcp.com/integrations/cursor#manual-configuration)
...
####
[​](https://gofastmcp.com/integrations/cursor#dependencies-2)
Dependencies
...
**`uv`must be installed and available in your system PATH**. Cursor runs in its own isolated environment and needs `uv` to manage dependencies.
####
[​](https://gofastmcp.com/integrations/cursor#environment-variables-2)
Environment Variables
...
Cursor runs servers in a completely isolated environment with no access to your shell environment or locally installed applications. You must explicitly pass any environment variables your server needs.
##
[​](https://gofastmcp.com/integrations/cursor#using-the-server)
Using the Server
...
[ Claude Desktop 🤝 FastMCP Previous ](https://gofastmcp.com/integrations/claude-desktop)[ Gemini CLI 🤝 FastMCP Next ](https://gofastmcp.com/integrations/gemini-cli)
Ctrl+I
![Cursor install prompt](https://mintcdn.com/fastmcp/hUosZw7ujHZFemrG/integrations/cursor-install-mcp.png?w=840&fit=max&auto=format&n=hUosZw7ujHZFemrG&q=85&s=668b24b85af77d5a7a3f9b2ef0bf37a3)
