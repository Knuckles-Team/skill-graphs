[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-cli-cimd#content-area)
...
On this page
  * [fastmcp.cli.cimd](https://gofastmcp.com/python-sdk/fastmcp-cli-cimd#fastmcp-cli-cimd)
  * [Functions](https://gofastmcp.com/python-sdk/fastmcp-cli-cimd#functions)
  * [create_command ](https://gofastmcp.com/python-sdk/fastmcp-cli-cimd#create_command)
  * [validate_command ](https://gofastmcp.com/python-sdk/fastmcp-cli-cimd#validate_command)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-cimd#fastmcp-cli-cimd)
`fastmcp.cli.cimd`
CIMD (Client ID Metadata Document) CLI commands.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-cimd#functions)
Functions
###
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-cimd#create_command)
`create_command`
Copy
```
create_command() -> None
...
Generate a CIMD document for hosting. Create a Client ID Metadata Document that you can host at an HTTPS URL. The URL where you host this document becomes your client_id. After creating the document, host it at an HTTPS URL with a non-root path, for example:
###
[​](https://gofastmcp.com/python-sdk/fastmcp-cli-cimd#validate_command)
`validate_command`
Copy
```
...
Validate a hosted CIMD document. Fetches the document from the given URL and validates:
...
[ auth Previous ](https://gofastmcp.com/python-sdk/fastmcp-cli-auth)[ cli Next ](https://gofastmcp.com/python-sdk/fastmcp-cli-cli)
Ctrl+I
