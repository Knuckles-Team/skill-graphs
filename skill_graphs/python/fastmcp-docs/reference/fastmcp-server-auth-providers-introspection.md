[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-introspection#content-area)
...
On this page
  * [fastmcp.server.auth.providers.introspection](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-introspection#fastmcp-server-auth-providers-introspection)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-introspection#classes)
  * [IntrospectionTokenVerifier ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-introspection#introspectiontokenverifier)
  * [verify_token ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-introspection#verify_token)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-introspection#fastmcp-server-auth-providers-introspection)
`fastmcp.server.auth.providers.introspection`
OAuth 2.0 Token Introspection (RFC 7662) provider for FastMCP. This module provides token verification for opaque tokens using the OAuth 2.0 Token Introspection protocol defined in RFC 7662. It allows FastMCP servers to validate tokens issued by authorization servers that don’t use JWT format. Example:
Copy
```
...
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-introspection#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-introspection#introspectiontokenverifier)
`IntrospectionTokenVerifier`
OAuth 2.0 Token Introspection verifier (RFC 7662). This verifier validates opaque tokens by calling an OAuth 2.0 token introspection endpoint. Unlike JWT verification which is stateless, token introspection requires a network call to the authorization server for each token validation. The verifier authenticates to the introspection endpoint using either:
...
Both methods are specified in RFC 6749 (OAuth 2.0) and RFC 7662 (Token Introspection). Use this when:
...
Caching is disabled by default to preserve real-time revocation semantics. Set `cache_ttl_seconds` to enable caching and reduce load on the introspection endpoint (e.g., `cache_ttl_seconds=300` for 5 minutes). **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-introspection#verify_token)
`verify_token`
Copy
```
...
[ in_memory Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-in_memory)[ jwt Next ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-jwt)
Ctrl+I
