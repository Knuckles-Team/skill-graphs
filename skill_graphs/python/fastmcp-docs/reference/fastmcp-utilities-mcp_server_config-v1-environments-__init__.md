[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-__init__#content-area)
...
On this page
  * [fastmcp.utilities.mcp_server_config.v1.environments](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-__init__#fastmcp-utilities-mcp-server-config-v1-environments)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-__init__#fastmcp-utilities-mcp-server-config-v1-environments)
`fastmcp.utilities.mcp_server_config.v1.environments`
Environment configuration for MCP servers.
[ __init__ Previous ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-__init__)[ base Next ](https://gofastmcp.com/python-sdk/fastmcp-utilities-mcp_server_config-v1-environments-base)
Ctrl+I
