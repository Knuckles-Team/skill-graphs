[Skip to main content](https://gofastmcp.com/v2/servers/auth/oauth-proxy#content-area)
...
On this page
  * [Implementation](https://gofastmcp.com/v2/servers/auth/oauth-proxy#implementation)
  * [Provider Setup Requirements](https://gofastmcp.com/v2/servers/auth/oauth-proxy#provider-setup-requirements)
  * [Basic Setup](https://gofastmcp.com/v2/servers/auth/oauth-proxy#basic-setup)
  * [Configuration Parameters](https://gofastmcp.com/v2/servers/auth/oauth-proxy#configuration-parameters)
  * [Using Built-in Providers](https://gofastmcp.com/v2/servers/auth/oauth-proxy#using-built-in-providers)
  * [Token Verification](https://gofastmcp.com/v2/servers/auth/oauth-proxy#token-verification)
  * [Scope Configuration](https://gofastmcp.com/v2/servers/auth/oauth-proxy#scope-configuration)
  * [Custom Parameters](https://gofastmcp.com/v2/servers/auth/oauth-proxy#custom-parameters)
  * [OAuth Flow](https://gofastmcp.com/v2/servers/auth/oauth-proxy#oauth-flow)
  * [Registration Phase](https://gofastmcp.com/v2/servers/auth/oauth-proxy#registration-phase)
  * [Authorization Phase](https://gofastmcp.com/v2/servers/auth/oauth-proxy#authorization-phase)
  * [Callback Phase](https://gofastmcp.com/v2/servers/auth/oauth-proxy#callback-phase)
  * [Token Exchange Phase](https://gofastmcp.com/v2/servers/auth/oauth-proxy#token-exchange-phase)
  * [Token Architecture](https://gofastmcp.com/v2/servers/auth/oauth-proxy#token-architecture)
  * [PKCE Forwarding](https://gofastmcp.com/v2/servers/auth/oauth-proxy#pkce-forwarding)
  * [Redirect URI Validation](https://gofastmcp.com/v2/servers/auth/oauth-proxy#redirect-uri-validation)
  * [Security](https://gofastmcp.com/v2/servers/auth/oauth-proxy#security)
  * [Key and Storage Management](https://gofastmcp.com/v2/servers/auth/oauth-proxy#key-and-storage-management)
  * [Confused Deputy Attacks](https://gofastmcp.com/v2/servers/auth/oauth-proxy#confused-deputy-attacks)
  * [Mitigation](https://gofastmcp.com/v2/servers/auth/oauth-proxy#mitigation)
  * [Environment Configuration](https://gofastmcp.com/v2/servers/auth/oauth-proxy#environment-configuration)
...
###
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#basic-setup)
Basic Setup
...
###
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#configuration-parameters)
Configuration Parameters
## OAuthProxy Parameters
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#param-upstream-authorization-endpoint)
upstream_authorization_endpoint
str
required
URL of your OAuth provider’s authorization endpoint (e.g., `https://github.com/login/oauth/authorize`)
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#param-upstream-token-endpoint)
upstream_token_endpoint
str
required
URL of your OAuth provider’s token endpoint (e.g., `https://github.com/login/oauth/access_token`)
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#param-upstream-client-id)
upstream_client_id
str
required
Client ID from your registered OAuth application
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#param-upstream-client-secret)
upstream_client_secret
str
required
Client secret from your registered OAuth application
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#param-token-verifier)
token_verifier
TokenVerifier
required
A [`TokenVerifier`](https://gofastmcp.com/v2/servers/auth/token-verification) instance to validate the provider’s tokens
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#param-base-url)
base_url
AnyHttpUrl | str
required
...
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#param-redirect-path)
redirect_path
str
default:"/auth/callback"
Path for OAuth callbacks. Must match the redirect URI configured in your OAuth application
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#param-upstream-revocation-endpoint)
upstream_revocation_endpoint
str | None
Optional URL of provider’s token revocation endpoint
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#param-issuer-url)
issuer_url
AnyHttpUrl | str | None
...
See the [HTTP Deployment guide](https://gofastmcp.com/v2/deployment/http#mounting-authenticated-servers) for complete mounting examples.
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#param-service-documentation-url)
service_documentation_url
AnyHttpUrl | str | None
Optional URL to your service documentation
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#param-forward-pkce)
forward_pkce
bool
default:"True"
...
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#param-token-endpoint-auth-method)
...
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#param-allowed-client-redirect-uris)
...
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#param-valid-scopes)
valid_scopes
list[str] | None
...
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#param-extra-authorize-params)
...
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#param-extra-token-params)
extra_token_params
dict[str, str] | None
...
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#param-jwt-signing-key)
jwt_signing_key
str | bytes | None
...
See [HTTP Deployment - OAuth Token Security](https://gofastmcp.com/v2/deployment/http#oauth-token-security) for complete production setup.
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#param-require-authorization-consent)
...
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#param-consent-csp-policy)
consent_csp_policy
str | None
default:"None"
...
###
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#using-built-in-providers)
...
###
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#token-verification)
Token Verification
...
See the [Token Verification guide](https://gofastmcp.com/v2/servers/auth/token-verification) for detailed setup instructions for your provider.
###
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#scope-configuration)
Scope Configuration
...
Dynamic clients created by the proxy will automatically include these scopes in their authorization requests. See the [Token Verification](https://gofastmcp.com/v2/servers/auth/oauth-proxy#token-verification) section below for detailed setup.
###
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#custom-parameters)
Custom Parameters
...
##
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#oauth-flow)
OAuth Flow
OAuth Provider(GitHub, etc.)FastMCP OAuth Proxy(server:8000)UserMCP Client(localhost:random)OAuth Provider(GitHub, etc.)FastMCP OAuth Proxy(server:8000)UserMCP Client(localhost:random)Dynamic Registration (Local)Authorization with User ConsentStore transaction with client PKCEGenerate proxy PKCE pairProvider CallbackClient Callback ForwardingToken Exchange1. POST /registerredirect_uri: localhost:54321/callback2. Returns fixed upstream credentials3. GET /authorizeredirect_uri=localhost:54321/callbackcode_challenge=CLIENT_CHALLENGE4. Show consent page(client details, redirect URI, scopes)5. Approve/deny consent6. Redirect to providerredirect_uri=server:8000/auth/callbackcode_challenge=PROXY_CHALLENGE7. GET /auth/callbackwith authorization code8. Exchange code for tokenscode_verifier=PROXY_VERIFIER9. Access & refresh tokens10. Redirect to localhost:54321/callbackwith new authorization code11. POST /token with codecode_verifier=CLIENT_VERIFIER12. Returns stored provider tokens
The flow diagram above illustrates the complete OAuth proxy pattern. Let’s understand each phase:
###
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#registration-phase)
Registration Phase
...
###
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#authorization-phase)
Authorization Phase
...
###
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#callback-phase)
Callback Phase
...
###
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#token-exchange-phase)
...
###
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#token-architecture)
Token Architecture
...
###
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#redirect-uri-validation)
...
##
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#security)
Security
###
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#key-and-storage-management)
...
####
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#mitigation)
Mitigation
...
##
[​](https://gofastmcp.com/v2/servers/auth/oauth-proxy#environment-configuration)
Environment Configuration
`2.12.1` For production deployments, configure the OAuth proxy through environment variables instead of hardcoding credentials:
Copy
```
...
[ Remote OAuth Previous ](https://gofastmcp.com/v2/servers/auth/remote-oauth)[ OIDC Proxy Next ](https://gofastmcp.com/v2/servers/auth/oidc-proxy)
Ctrl+I
