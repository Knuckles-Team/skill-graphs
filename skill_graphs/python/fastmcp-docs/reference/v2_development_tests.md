[Skip to main content](https://gofastmcp.com/v2/development/tests#content-area)
...
On this page
  * [FastMCP Tests](https://gofastmcp.com/v2/development/tests#fastmcp-tests)
  * [Running Tests](https://gofastmcp.com/v2/development/tests#running-tests)
  * [Test Organization](https://gofastmcp.com/v2/development/tests#test-organization)
  * [Test Markers](https://gofastmcp.com/v2/development/tests#test-markers)
  * [Writing Tests](https://gofastmcp.com/v2/development/tests#writing-tests)
  * [Test Requirements](https://gofastmcp.com/v2/development/tests#test-requirements)
  * [Single Behavior Per Test](https://gofastmcp.com/v2/development/tests#single-behavior-per-test)
  * [Self-Contained Setup](https://gofastmcp.com/v2/development/tests#self-contained-setup)
  * [Clear Intent](https://gofastmcp.com/v2/development/tests#clear-intent)
  * [Using Fixtures](https://gofastmcp.com/v2/development/tests#using-fixtures)
  * [Effective Assertions](https://gofastmcp.com/v2/development/tests#effective-assertions)
  * [Inline Snapshots](https://gofastmcp.com/v2/development/tests#inline-snapshots)
  * [In-Memory Testing](https://gofastmcp.com/v2/development/tests#in-memory-testing)
  * [Mocking External Dependencies](https://gofastmcp.com/v2/development/tests#mocking-external-dependencies)
  * [Testing Network Transports](https://gofastmcp.com/v2/development/tests#testing-network-transports)
  * [In-Process Network Testing (Preferred)](https://gofastmcp.com/v2/development/tests#in-process-network-testing-preferred)
  * [Subprocess Testing (Special Cases)](https://gofastmcp.com/v2/development/tests#subprocess-testing-special-cases)
  * [Documentation Testing](https://gofastmcp.com/v2/development/tests#documentation-testing)
...
##
[​](https://gofastmcp.com/v2/development/tests#fastmcp-tests)
FastMCP Tests
###
[​](https://gofastmcp.com/v2/development/tests#running-tests)
Running Tests
Copy
```
# Run all tests
...
###
[​](https://gofastmcp.com/v2/development/tests#test-organization)
Test Organization
...
###
[​](https://gofastmcp.com/v2/development/tests#test-markers)
Test Markers
...
##
[​](https://gofastmcp.com/v2/development/tests#writing-tests)
Writing Tests
###
[​](https://gofastmcp.com/v2/development/tests#test-requirements)
Test Requirements
...
####
[​](https://gofastmcp.com/v2/development/tests#single-behavior-per-test)
...
####
[​](https://gofastmcp.com/v2/development/tests#self-contained-setup)
...
####
[​](https://gofastmcp.com/v2/development/tests#clear-intent)
Clear Intent
...
####
[​](https://gofastmcp.com/v2/development/tests#using-fixtures)
Using Fixtures
...
####
[​](https://gofastmcp.com/v2/development/tests#effective-assertions)
...
####
[​](https://gofastmcp.com/v2/development/tests#inline-snapshots)
Inline Snapshots
...
###
[​](https://gofastmcp.com/v2/development/tests#in-memory-testing)
In-Memory Testing
...
###
[​](https://gofastmcp.com/v2/development/tests#mocking-external-dependencies)
...
###
[​](https://gofastmcp.com/v2/development/tests#testing-network-transports)
...
####
[​](https://gofastmcp.com/v2/development/tests#in-process-network-testing-preferred)
...
####
[​](https://gofastmcp.com/v2/development/tests#subprocess-testing-special-cases)
...
###
[​](https://gofastmcp.com/v2/development/tests#documentation-testing)
...
[ Contributing Previous ](https://gofastmcp.com/v2/development/contributing)[ Releases Next ](https://gofastmcp.com/v2/development/releases)
Ctrl+I
