[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-provider#content-area)
...
On this page
  * [fastmcp.server.providers.openapi.provider](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-provider#fastmcp-server-providers-openapi-provider)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-provider#classes)
  * [OpenAPIProvider ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-provider#openapiprovider)
  * [lifespan ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-provider#lifespan)
  * [get_tasks ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-provider#get_tasks)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-provider#fastmcp-server-providers-openapi-provider)
`fastmcp.server.providers.openapi.provider`
OpenAPIProvider for creating MCP components from OpenAPI specifications.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-provider#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-provider#openapiprovider)
`OpenAPIProvider`
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-provider#lifespan)
`lifespan`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-provider#get_tasks)
`get_tasks`
Copy
```
...
[ components Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-components)[ routing Next ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-openapi-routing)
Ctrl+I
