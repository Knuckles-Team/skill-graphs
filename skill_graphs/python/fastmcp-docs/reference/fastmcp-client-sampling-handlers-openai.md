[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-openai#content-area)
...
On this page
  * [fastmcp.client.sampling.handlers.openai](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-openai#fastmcp-client-sampling-handlers-openai)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-openai#classes)
  * [OpenAISamplingHandler ](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-openai#openaisamplinghandler)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-openai#fastmcp-client-sampling-handlers-openai)
`fastmcp.client.sampling.handlers.openai`
OpenAI sampling handler for FastMCP.
##
[​](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-openai#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-openai#openaisamplinghandler)
`OpenAISamplingHandler`
Sampling handler that uses the OpenAI API.
[ google_genai Previous ](https://gofastmcp.com/python-sdk/fastmcp-client-sampling-handlers-google_genai)[ tasks Next ](https://gofastmcp.com/python-sdk/fastmcp-client-tasks)
Ctrl+I
