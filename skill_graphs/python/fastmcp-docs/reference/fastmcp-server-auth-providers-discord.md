[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-discord#content-area)
...
On this page
  * [fastmcp.server.auth.providers.discord](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-discord#fastmcp-server-auth-providers-discord)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-discord#classes)
  * [DiscordTokenVerifier ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-discord#discordtokenverifier)
  * [verify_token ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-discord#verify_token)
  * [DiscordProvider ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-discord#discordprovider)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-discord#fastmcp-server-auth-providers-discord)
`fastmcp.server.auth.providers.discord`
Discord OAuth provider for FastMCP. This module provides a complete Discord OAuth integration that’s ready to use with just a client ID and client secret. It handles all the complexity of Discord’s OAuth flow, token validation, and user management. Example:
Copy
```
...
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-discord#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-discord#discordtokenverifier)
`DiscordTokenVerifier`
Token verifier for Discord OAuth tokens. Discord OAuth tokens are opaque (not JWTs), so we verify them by calling Discord’s tokeninfo API to check if they’re valid and get user info. **Methods:**
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-discord#verify_token)
`verify_token`
Copy
```
...
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-discord#discordprovider)
`DiscordProvider`
Complete Discord OAuth provider for FastMCP. This provider makes it trivial to add Discord OAuth protection to any FastMCP server. Just provide your Discord OAuth app credentials and a base URL, and you’re ready to go. Features:
...
[ descope Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-descope)[ github Next ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-providers-github)
Ctrl+I
