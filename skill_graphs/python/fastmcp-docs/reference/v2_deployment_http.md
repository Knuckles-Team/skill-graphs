[Skip to main content](https://gofastmcp.com/v2/deployment/http#content-area)
...
##### Servers
  ...
  * Authentication
  * Deployment
    * [Running Your Server](https://gofastmcp.com/v2/deployment/running-server)
    * [ HTTP Deployment NEW ](https://gofastmcp.com/v2/deployment/http)
    * [Prefect Horizon](https://gofastmcp.com/deployment/prefect-horizon)
    * [Project Configuration](https://gofastmcp.com/v2/deployment/server-configuration)
...
On this page
  * [Choosing Your Approach](https://gofastmcp.com/v2/deployment/http#choosing-your-approach)
  * [Direct HTTP Server](https://gofastmcp.com/v2/deployment/http#direct-http-server)
  * [ASGI Application](https://gofastmcp.com/v2/deployment/http#asgi-application)
  * [Configuring Your Server](https://gofastmcp.com/v2/deployment/http#configuring-your-server)
  * [Custom Path](https://gofastmcp.com/v2/deployment/http#custom-path)
  * [Authentication](https://gofastmcp.com/v2/deployment/http#authentication)
  * [Health Checks](https://gofastmcp.com/v2/deployment/http#health-checks)
  * [Custom Middleware](https://gofastmcp.com/v2/deployment/http#custom-middleware)
  * [CORS for Browser-Based Clients](https://gofastmcp.com/v2/deployment/http#cors-for-browser-based-clients)
  * [SSE Polling for Long-Running Operations](https://gofastmcp.com/v2/deployment/http#sse-polling-for-long-running-operations)
  * [Custom Storage Backends](https://gofastmcp.com/v2/deployment/http#custom-storage-backends)
  * [Integration with Web Frameworks](https://gofastmcp.com/v2/deployment/http#integration-with-web-frameworks)
  * [Mounting in Starlette](https://gofastmcp.com/v2/deployment/http#mounting-in-starlette)
  * [Nested Mounts](https://gofastmcp.com/v2/deployment/http#nested-mounts)
  * [FastAPI Integration](https://gofastmcp.com/v2/deployment/http#fastapi-integration)
  * [Mounting Authenticated Servers](https://gofastmcp.com/v2/deployment/http#mounting-authenticated-servers)
  * [Route Types](https://gofastmcp.com/v2/deployment/http#route-types)
  * [Configuration Parameters](https://gofastmcp.com/v2/deployment/http#configuration-parameters)
  * [Mounting Strategy](https://gofastmcp.com/v2/deployment/http#mounting-strategy)
  * [Complete Example](https://gofastmcp.com/v2/deployment/http#complete-example)
  * [Production Deployment](https://gofastmcp.com/v2/deployment/http#production-deployment)
  * [Running with Uvicorn](https://gofastmcp.com/v2/deployment/http#running-with-uvicorn)
  * [Horizontal Scaling](https://gofastmcp.com/v2/deployment/http#horizontal-scaling)
  * [Understanding Sessions](https://gofastmcp.com/v2/deployment/http#understanding-sessions)
  * [Without Stateless Mode](https://gofastmcp.com/v2/deployment/http#without-stateless-mode)
  * [Enabling Stateless Mode](https://gofastmcp.com/v2/deployment/http#enabling-stateless-mode)
  * [Environment Variables](https://gofastmcp.com/v2/deployment/http#environment-variables)
  * [OAuth Token Security](https://gofastmcp.com/v2/deployment/http#oauth-token-security)
  * [Reverse Proxy (nginx)](https://gofastmcp.com/v2/deployment/http#reverse-proxy-nginx)
  * [Running FastMCP as a Linux Service](https://gofastmcp.com/v2/deployment/http#running-fastmcp-as-a-linux-service)
  * [nginx Configuration](https://gofastmcp.com/v2/deployment/http#nginx-configuration)
  * [Key Considerations](https://gofastmcp.com/v2/deployment/http#key-considerations)
  * [Mounting Under a Path Prefix](https://gofastmcp.com/v2/deployment/http#mounting-under-a-path-prefix)
  * [Testing Your Deployment](https://gofastmcp.com/v2/deployment/http#testing-your-deployment)
  * [Hosting Your Server](https://gofastmcp.com/v2/deployment/http#hosting-your-server)
...
##
[​](https://gofastmcp.com/v2/deployment/http#choosing-your-approach)
...
###
[​](https://gofastmcp.com/v2/deployment/http#direct-http-server)
Direct HTTP Server
...
###
[​](https://gofastmcp.com/v2/deployment/http#asgi-application)
ASGI Application
...
##
[​](https://gofastmcp.com/v2/deployment/http#configuring-your-server)
Configuring Your Server
###
[​](https://gofastmcp.com/v2/deployment/http#custom-path)
Custom Path
...
###
[​](https://gofastmcp.com/v2/deployment/http#authentication)
Authentication
...
FastMCP supports multiple authentication methods to secure your remote server. See the [Authentication Overview](https://gofastmcp.com/v2/servers/auth/authentication) for complete configuration options including Bearer tokens, JWT, and OAuth. If you’re mounting an authenticated server under a path prefix, see [Mounting Authenticated Servers](https://gofastmcp.com/v2/deployment/http#mounting-authenticated-servers) below for important routing considerations.
###
...
###
[​](https://gofastmcp.com/v2/deployment/http#custom-middleware)
Custom Middleware
`2.3.2` Add custom Starlette middleware to your FastMCP ASGI apps:
Copy
```
from fastmcp import FastMCP
...
###
[​](https://gofastmcp.com/v2/deployment/http#cors-for-browser-based-clients)
...
###
[​](https://gofastmcp.com/v2/deployment/http#sse-polling-for-long-running-operations)
...
When running tools that take a long time to complete, you may encounter issues with load balancers or proxies terminating connections that stay idle too long.  To enable SSE polling, configure an `EventStore` when creating your HTTP application:
Copy
```
...
####
[​](https://gofastmcp.com/v2/deployment/http#custom-storage-backends)
...
##
[​](https://gofastmcp.com/v2/deployment/http#integration-with-web-frameworks)
...
###
[​](https://gofastmcp.com/v2/deployment/http#mounting-in-starlette)
...
####
[​](https://gofastmcp.com/v2/deployment/http#nested-mounts)
Nested Mounts
...
FastAPI Integration
For FastAPI-specific integration patterns including both mounting MCP servers into FastAPI apps and generating MCP servers from FastAPI apps, see the [FastAPI Integration guide](https://gofastmcp.com/v2/integrations/fastapi). Here’s a quick example showing how to add MCP to an existing FastAPI application:
Copy
```
...
##
[​](https://gofastmcp.com/v2/deployment/http#mounting-authenticated-servers)
...
###
[​](https://gofastmcp.com/v2/deployment/http#route-types)
Route Types
...
###
[​](https://gofastmcp.com/v2/deployment/http#configuration-parameters)
...
###
[​](https://gofastmcp.com/v2/deployment/http#mounting-strategy)
Mounting Strategy
...
###
[​](https://gofastmcp.com/v2/deployment/http#complete-example)
Complete Example
...
For more details on OAuth authentication, see the [Authentication guide](https://gofastmcp.com/v2/servers/auth).
##
[​](https://gofastmcp.com/v2/deployment/http#production-deployment)
Production Deployment
###
[​](https://gofastmcp.com/v2/deployment/http#running-with-uvicorn)
...
###
[​](https://gofastmcp.com/v2/deployment/http#horizontal-scaling)
Horizontal Scaling
`2.10.2` When deploying FastMCP behind a load balancer or running multiple server instances, you need to understand how the HTTP transport handles sessions and configure your server appropriately.
####
[​](https://gofastmcp.com/v2/deployment/http#understanding-sessions)
Understanding Sessions
By default, FastMCP’s Streamable HTTP transport maintains server-side sessions. Sessions enable stateful MCP features like [elicitation](https://gofastmcp.com/v2/servers/elicitation) and [sampling](https://gofastmcp.com/v2/servers/sampling), where the server needs to maintain context across multiple requests from the same client. This works perfectly for single-instance deployments. However, sessions are stored in memory on each server instance, which creates challenges when scaling horizontally.
####
[​](https://gofastmcp.com/v2/deployment/http#without-stateless-mode)
...
####
[​](https://gofastmcp.com/v2/deployment/http#enabling-stateless-mode)
Enabling Stateless Mode
For horizontally scaled deployments, enable stateless HTTP mode. In stateless mode, each request creates a fresh transport context, eliminating the need for session affinity entirely. **Option 1: Via constructor**
Copy
```
from fastmcp import FastMCP
...
###
[​](https://gofastmcp.com/v2/deployment/http#environment-variables)
...
###
[​](https://gofastmcp.com/v2/deployment/http#oauth-token-security)
OAuth Token Security
`2.13.0` If you’re using the [OAuth Proxy](https://gofastmcp.com/v2/servers/auth/oauth-proxy), FastMCP issues its own JWT tokens to clients instead of forwarding upstream provider tokens. This maintains proper OAuth 2.0 token boundaries. **Default Behavior (Development Only):** By default, FastMCP automatically manages cryptographic keys:
...
Both parameters are required for production. Without an explicit signing key, keys are signed using a key derived from the client_secret, which will cause invalidation upon rotation of the client secret. Without persistent storage, tokens are local to the server and won’t be trusted across hosts. **Wrap your storage backend in`FernetEncryptionWrapper` to encrypt sensitive OAuth tokens at rest** - without encryption, tokens are stored in plaintext. For more details on the token architecture and key management, see [OAuth Proxy Key and Storage Management](https://gofastmcp.com/v2/servers/auth/oauth-proxy#key-and-storage-management).
##
[​](https://gofastmcp.com/v2/deployment/http#reverse-proxy-nginx)
Reverse Proxy (nginx)
...
###
[​](https://gofastmcp.com/v2/deployment/http#running-fastmcp-as-a-linux-service)
...
###
[​](https://gofastmcp.com/v2/deployment/http#nginx-configuration)
nginx Configuration
...
###
[​](https://gofastmcp.com/v2/deployment/http#key-considerations)
Key Considerations
When deploying FastMCP behind a reverse proxy, keep these points in mind:
  ...
  * **Increase timeouts** : The default nginx `proxy_read_timeout` is 60 seconds. Long-running MCP tools will cause the connection to drop. Set timeouts to at least 300 seconds, or higher if your tools run longer. For tools that may exceed any timeout, use [SSE Polling](https://gofastmcp.com/v2/deployment/http#sse-polling-for-long-running-operations) to gracefully handle proxy disconnections.
...
###
[​](https://gofastmcp.com/v2/deployment/http#mounting-under-a-path-prefix)
...
Note the trailing `/` on both `location /api/` and `proxy_pass http://127.0.0.1:8000/` — this ensures nginx strips the `/api` prefix before forwarding to your server. If you’re using OAuth authentication with a mount prefix, see [Mounting Authenticated Servers](https://gofastmcp.com/v2/deployment/http#mounting-authenticated-servers) for additional configuration.
##
[​](https://gofastmcp.com/v2/deployment/http#testing-your-deployment)
Testing Your Deployment
Once your server is deployed, you’ll need to verify it’s accessible and functioning correctly. For comprehensive testing strategies including connectivity tests, client testing, and authentication testing, see the [Testing Your Server](https://gofastmcp.com/v2/development/tests) guide.
##
[​](https://gofastmcp.com/v2/deployment/http#hosting-your-server)
Hosting Your Server
...
The key requirements are Python 3.10+ support and the ability to expose an HTTP port. Most providers will require you to package your server (requirements.txt, Dockerfile, etc.) according to their deployment format. For managed, zero-configuration deployment, see [Prefect Horizon](https://gofastmcp.com/deployment/prefect-horizon).
[ Running Your Server Previous ](https://gofastmcp.com/v2/deployment/running-server)[ Prefect Horizon Next ](https://gofastmcp.com/deployment/prefect-horizon)
Ctrl+I
