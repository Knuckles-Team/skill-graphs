[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-auth-__init__#content-area)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-auth-__init__#fastmcp-server-auth)
`fastmcp.server.auth`
_This module is empty or contains only private/internal implementations._
[ apps Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-apps)[ auth Next ](https://gofastmcp.com/python-sdk/fastmcp-server-auth-auth)
Ctrl+I
