...
auth_provider = GitHubProvider(
    ...
    client_secret="github_pat_...",     # Your GitHub OAuth App Client Secret # sanitizer:ignore # sanitizer:ignore
...
auth_provider = GitHubProvider(
    ...
    client_secret="github_pat_...", # sanitizer:ignore # sanitizer:ignore
