[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-prompts_as_tools#content-area)
...
On this page
  * [fastmcp.server.transforms.prompts_as_tools](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-prompts_as_tools#fastmcp-server-transforms-prompts_as_tools)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-prompts_as_tools#classes)
  * [PromptsAsTools ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-prompts_as_tools#promptsastools)
  * [list_tools ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-prompts_as_tools#list_tools)
  * [get_tool ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-prompts_as_tools#get_tool)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-prompts_as_tools#fastmcp-server-transforms-prompts_as_tools)
...
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-prompts_as_tools#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-prompts_as_tools#promptsastools)
`PromptsAsTools`
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-prompts_as_tools#list_tools)
`list_tools`
Copy
```
...
####
[​](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-prompts_as_tools#get_tool)
`get_tool`
Copy
```
...
[ namespace Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-namespace)[ resources_as_tools Next ](https://gofastmcp.com/python-sdk/fastmcp-server-transforms-resources_as_tools)
Ctrl+I
