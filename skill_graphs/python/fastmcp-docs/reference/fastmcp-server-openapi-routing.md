[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-routing#content-area)
...
On this page
  * [fastmcp.server.openapi.routing](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-routing#fastmcp-server-openapi-routing)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-routing#fastmcp-server-openapi-routing)
`fastmcp.server.openapi.routing`
Route mapping logic for OpenAPI operations. .. deprecated:: This module is deprecated. Import from fastmcp.server.providers.openapi instead.
[ components Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-components)[ server Next ](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-server)
Ctrl+I
