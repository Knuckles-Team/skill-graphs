[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-__init__#content-area)
...
On this page
  * [fastmcp.server.providers.local_provider.decorators](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-__init__#fastmcp-server-providers-local_provider-decorators)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-__init__#fastmcp-server-providers-local_provider-decorators)
`fastmcp.server.providers.local_provider.decorators`
Decorator mixins for LocalProvider. This module provides mixin classes that add decorator functionality to LocalProvider for tools, resources, templates, and prompts.
[ __init__ Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-__init__)[ prompts Next ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-local_provider-decorators-prompts)
Ctrl+I
