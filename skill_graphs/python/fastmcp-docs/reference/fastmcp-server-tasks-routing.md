[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-routing#content-area)
...
On this page
  * [fastmcp.server.tasks.routing](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-routing#fastmcp-server-tasks-routing)
  * [Functions](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-routing#functions)
  * [check_background_task ](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-routing#check_background_task)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-routing#fastmcp-server-tasks-routing)
...
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-routing#functions)
Functions
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-routing#check_background_task)
...
[ requests Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-requests)[ subscriptions Next ](https://gofastmcp.com/python-sdk/fastmcp-server-tasks-subscriptions)
Ctrl+I
