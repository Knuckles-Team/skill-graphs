[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-__init__#content-area)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-__init__#fastmcp-server)
`fastmcp.server`
_This module is empty or contains only private/internal implementations._
[ types Previous ](https://gofastmcp.com/python-sdk/fastmcp-resources-types)[ apps Next ](https://gofastmcp.com/python-sdk/fastmcp-server-apps)
Ctrl+I
