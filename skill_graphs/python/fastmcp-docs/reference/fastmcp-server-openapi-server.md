[Skip to main content](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-server#content-area)
...
##### fastmcp.server
  ...
  * mixins
  * openapi
    * [__init__](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-__init__)
    * [components](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-components)
    * [routing](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-routing)
    * [server](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-server)
  * providers
...
On this page
  * [fastmcp.server.openapi.server](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-server#fastmcp-server-openapi-server)
  * [Classes](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-server#classes)
  * [FastMCPOpenAPI ](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-server#fastmcpopenapi)
...
Copy page
#
[​](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-server#fastmcp-server-openapi-server)
`fastmcp.server.openapi.server`
FastMCPOpenAPI - backwards compatibility wrapper. This class is deprecated. Use FastMCP with OpenAPIProvider instead: from fastmcp import FastMCP from fastmcp.server.providers.openapi import OpenAPIProvider import httpx client = httpx.AsyncClient(base_url=“
##
[​](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-server#classes)
Classes
###
[​](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-server#fastmcpopenapi)
`FastMCPOpenAPI`
...
[ routing Previous ](https://gofastmcp.com/python-sdk/fastmcp-server-openapi-routing)[ __init__ Next ](https://gofastmcp.com/python-sdk/fastmcp-server-providers-__init__)
Ctrl+I
