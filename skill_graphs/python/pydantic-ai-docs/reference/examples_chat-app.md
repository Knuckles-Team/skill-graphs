...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * Examples
    ...
    * Conversational Agents
      * Chat App with FastAPI  [ Chat App with FastAPI  ](https://ai.pydantic.dev/examples/chat-app/)
  ...
  * [ Example Code  ](https://ai.pydantic.dev/examples/chat-app/#example-code)
  ...
  3. [ Conversational Agents  ](https://ai.pydantic.dev/examples/chat-app/)
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/examples/chat-app/#__tabbed_2_1)[Directly to Provider API](https://ai.pydantic.dev/examples/chat-app/#__tabbed_2_2)
