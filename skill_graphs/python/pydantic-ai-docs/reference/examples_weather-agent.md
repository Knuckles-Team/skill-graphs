...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * [ UI Code  ](https://ai.pydantic.dev/examples/weather-agent/#ui-code)
  ...
  3. [ Getting Started  ](https://ai.pydantic.dev/examples/pydantic-model/)
...
To run this example properly, you might want to add two extra API keys **(Note if either key is missing, the code will fall back to dummy data, so they're not required)** :
  * A weather API key from `WEATHER_API_KEY`
  * A geocoding API key from `GEO_API_KEY`
...
## Example Code
[With Pydantic AI Gateway](https://ai.pydantic.dev/examples/weather-agent/#__tabbed_2_1)[Directly to Provider API](https://ai.pydantic.dev/examples/weather-agent/#__tabbed_2_2)
