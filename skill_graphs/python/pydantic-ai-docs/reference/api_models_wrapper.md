...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * API Reference
    * pydantic_ai
      ...
      * pydantic_ai.models.wrapper  [ pydantic_ai.models.wrapper  ](https://ai.pydantic.dev/api/models/wrapper/)
        * [ wrapper  ](https://ai.pydantic.dev/api/models/wrapper/#pydantic_ai.models.wrapper)
        * [ CompletedStreamedResponse  ](https://ai.pydantic.dev/api/models/wrapper/#pydantic_ai.models.wrapper.CompletedStreamedResponse)
        * [ WrapperModel  ](https://ai.pydantic.dev/api/models/wrapper/#pydantic_ai.models.wrapper.WrapperModel)
          * [ wrapped  ](https://ai.pydantic.dev/api/models/wrapper/#pydantic_ai.models.wrapper.WrapperModel.wrapped)
          * [ settings  ](https://ai.pydantic.dev/api/models/wrapper/#pydantic_ai.models.wrapper.WrapperModel.settings)
...
```
wrapped: Model[](https://ai.pydantic.dev/api/models/base/#pydantic_ai.models.Model "Model \(pydantic_ai.models.Model\)") = infer_model(wrapped)
