...
###  EndMarker `dataclass`
Bases: `OutputT[](https://ai.pydantic.dev/api/pydantic_graph/beta_graph/#pydantic_graph.beta.graph.OutputT "OutputT
...
---|---|---|---
`OutputT` |  |  The type of the final output value |  _required_
