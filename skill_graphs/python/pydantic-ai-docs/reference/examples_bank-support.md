...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * Examples
    ...
    * Conversational Agents
      ...
      * Bank support  [ Bank support  ](https://ai.pydantic.dev/examples/bank-support/)
...
## Example Code
[With Pydantic AI Gateway](https://ai.pydantic.dev/examples/bank-support/#__tabbed_2_1)[Directly to Provider API](https://ai.pydantic.dev/examples/bank-support/#__tabbed_2_2)
