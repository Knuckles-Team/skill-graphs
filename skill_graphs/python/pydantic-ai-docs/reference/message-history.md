...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * [ Examples  ](https://ai.pydantic.dev/message-history/#examples)
  ...
  3. [ Core Concepts  ](https://ai.pydantic.dev/agent/)
...
Both [`RunResult`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.AgentRunResult "AgentRunResult



      dataclass
  ") (returned by [`Agent.run`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.AbstractAgent.run "run



      async
  "), [`Agent.run_sync`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.AbstractAgent.run_sync "run_sync")) and [`StreamedRunResult`](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResult "StreamedRunResult



      dataclass
  ") (returned by [`Agent.run_stream`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.AbstractAgent.run_stream "run_stream



      async
  ")) have the following methods:
  * [`all_messages()`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.AgentRunResult.all_messages "all_messages"): returns all messages, including messages from prior runs. There's also a variant that returns JSON bytes, [`all_messages_json()`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.AgentRunResult.all_messages_json "all_messages_json").
  * [`new_messages()`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.AgentRunResult.new_messages "new_messages"): returns only the messages from the current run. There's also a variant that returns JSON bytes, [`new_messages_json()`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.AgentRunResult.new_messages_json "new_messages_json").


StreamedRunResult and complete messages
On [`StreamedRunResult`](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResult "StreamedRunResult
...
E.g. you've awaited one of the following coroutines:
  * [`StreamedRunResult.stream_output()`](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResult.stream_output "stream_output



      async
  ")
  * [`StreamedRunResult.stream_text()`](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResult.stream_text "stream_text



      async
  ")
  * [`StreamedRunResult.stream_responses()`](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResult.stream_responses "stream_responses



      async
  ")
  * [`StreamedRunResult.get_output()`](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResult.get_output "get_output
...
**Note:** The final result message will NOT be added to result messages if you use [`.stream_text(delta=True)`](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResult.stream_text "stream_text



      async
  ") since in this case the result content is never built as one string.
Example of accessing methods on a [`RunResult`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.AgentRunResult "AgentRunResult



      dataclass
  ") :
[With Pydantic AI Gateway](https://ai.pydantic.dev/message-history/#__tabbed_1_1)[Directly to Provider API](https://ai.pydantic.dev/message-history/#__tabbed_1_2)
...
Example of accessing methods on a [`StreamedRunResult`](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResult "StreamedRunResult



      dataclass
  ") :
[With Pydantic AI Gateway](https://ai.pydantic.dev/message-history/#__tabbed_2_1)[Directly to Provider API](https://ai.pydantic.dev/message-history/#__tabbed_2_2)
...
To use existing messages in a run, pass them to the `message_history` parameter of [`Agent.run`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.AbstractAgent.run "run



      async
  "), [`Agent.run_sync`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.AbstractAgent.run_sync "run_sync") or [`Agent.run_stream`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.AbstractAgent.run_stream "run_stream
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/message-history/#__tabbed_3_1)[Directly to Provider API](https://ai.pydantic.dev/message-history/#__tabbed_3_2)
...
We export [`ModelMessagesTypeAdapter`](https://ai.pydantic.dev/api/messages/#pydantic_ai.messages.ModelMessagesTypeAdapter "ModelMessagesTypeAdapter
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/message-history/#__tabbed_4_1)[Directly to Provider API](https://ai.pydantic.dev/message-history/#__tabbed_4_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway) serialize messages to json```
from pydantic_core import to_jsonable_python

from pydantic_ai import (
    Agent,
    ModelMessagesTypeAdapter,  [](https://ai.pydantic.dev/message-history/#__code_6_annotation_1)
)
...
as_python_objects = to_jsonable_python(history_step_1)  [](https://ai.pydantic.dev/message-history/#__code_6_annotation_2)
same_history_as_step_1 = ModelMessagesTypeAdapter.validate_python(as_python_objects)

result2 = agent.run_sync(  [](https://ai.pydantic.dev/message-history/#__code_6_annotation_3)
...
[](https://ai.pydantic.dev/message-history/#__code_7_annotation_1)
)
...
[](https://ai.pydantic.dev/message-history/#__code_7_annotation_2)
same_history_as_step_1 = ModelMessagesTypeAdapter.validate_python(as_python_objects)

result2 = agent.run_sync(

[](https://ai.pydantic.dev/message-history/#__code_7_annotation_3)
    'Tell me a different joke.', message_history=same_history_as_step_1
)
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/message-history/#__tabbed_5_1)[Directly to Provider API](https://ai.pydantic.dev/message-history/#__tabbed_5_2)
...
[`new_messages()`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.AgentRunResult.new_messages "new_messages") determines which messages belong to the current run after all history processors have been applied. If your processor reorders, inserts, or removes messages, the set of messages returned by `new_messages()` may differ from what you expect.
To avoid surprises:
  * Preserve `run_id` on existing messages.
  * When creating new messages in a processor that should be part of the current run, use a [context-aware processor](https://ai.pydantic.dev/message-history/#runcontext-parameter) and set `run_id=ctx.run_id` on the new message.
  * Reordering or removing messages may shift the boundary between "old" and "new" messages, test with [`new_messages()`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.AgentRunResult.new_messages "new_messages") to verify the behavior matches your expectations.


### Usage
The `history_processors` is a list of callables that take a list of [`ModelMessage`](https://ai.pydantic.dev/api/messages/#pydantic_ai.messages.ModelMessage "ModelMessage
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/message-history/#__tabbed_6_1)[Directly to Provider API](https://ai.pydantic.dev/message-history/#__tabbed_6_2)
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/message-history/#__tabbed_7_1)[Directly to Provider API](https://ai.pydantic.dev/message-history/#__tabbed_7_2)
...
When slicing the message history, you need to make sure that tool calls and returns are paired, otherwise the LLM may return an error. For more details, refer to
####  `RunContext` parameter
History processors can optionally accept a [`RunContext`](https://ai.pydantic.dev/api/tools/#pydantic_ai.tools.RunContext "RunContext
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/message-history/#__tabbed_8_1)[Directly to Provider API](https://ai.pydantic.dev/message-history/#__tabbed_8_2)
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/message-history/#__tabbed_9_1)[Directly to Provider API](https://ai.pydantic.dev/message-history/#__tabbed_9_2)
...
When summarizing the message history, you need to make sure that tool calls and returns are paired, otherwise the LLM may return an error. For more details, refer to
### Testing History Processors
You can test what messages are actually sent to the model provider using [`FunctionModel`](https://ai.pydantic.dev/api/models/function/#pydantic_ai.models.function.FunctionModel "FunctionModel
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/message-history/#__tabbed_10_1)[Directly to Provider API](https://ai.pydantic.dev/message-history/#__tabbed_10_2)
