[ Skip to content ](https://ai.pydantic.dev/thinking/#thinking)
...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * Documentation
    ...
    * Advanced Features
      ...
      * Thinking  [ Thinking  ](https://ai.pydantic.dev/thinking/)
        * [ OpenAI  ](https://ai.pydantic.dev/thinking/#openai)
          * [ OpenAI Responses  ](https://ai.pydantic.dev/thinking/#openai-responses)
        * [ Anthropic  ](https://ai.pydantic.dev/thinking/#anthropic)
          * [ Interleaved Thinking  ](https://ai.pydantic.dev/thinking/#interleaved-thinking)
          * [ Adaptive Thinking & Effort  ](https://ai.pydantic.dev/thinking/#adaptive-thinking-effort)
        * [ Google  ](https://ai.pydantic.dev/thinking/#google)
        * [ xAI  ](https://ai.pydantic.dev/thinking/#xai)
        * [ Bedrock  ](https://ai.pydantic.dev/thinking/#bedrock)
        * [ Groq  ](https://ai.pydantic.dev/thinking/#groq)
        * [ OpenRouter  ](https://ai.pydantic.dev/thinking/#openrouter)
        * [ Mistral  ](https://ai.pydantic.dev/thinking/#mistral)
        * [ Cohere  ](https://ai.pydantic.dev/thinking/#cohere)
        * [ Hugging Face  ](https://ai.pydantic.dev/thinking/#hugging-face)
        * [ Outlines  ](https://ai.pydantic.dev/thinking/#outlines)
...
## OpenAI
When using the [`OpenAIChatModel`](https://ai.pydantic.dev/api/models/openai/#pydantic_ai.models.openai.OpenAIChatModel "OpenAIChatModel



      dataclass
  "), text output inside `<think>` tags are converted to [`ThinkingPart`](https://ai.pydantic.dev/api/messages/#pydantic_ai.messages.ThinkingPart "ThinkingPart



      dataclass
  ") objects. You can customize the tags using the [`thinking_tags`](https://ai.pydantic.dev/api/profiles/#pydantic_ai.profiles.ModelProfile.thinking_tags "thinking_tags



      class-attribute
      instance-attribute
  ") field on the [model profile](https://ai.pydantic.dev/models/openai/#model-profile).
Some [OpenAI-compatible model providers](https://ai.pydantic.dev/models/openai/#openai-compatible-models) might also support native thinking parts that are not delimited by tags. Instead, they are sent and received as separate, custom fields in the API. Typically, if you are calling the model via the `<provider>:<model>` shorthand, Pydantic AI handles it for you. Nonetheless, you can still configure the fields with [`openai_chat_thinking_field`](https://ai.pydantic.dev/api/profiles/#pydantic_ai.profiles.openai.OpenAIModelProfile.openai_chat_thinking_field "openai_chat_thinking_field
      ...
      instance-attribute
  ").
If your provider recommends to send back these custom fields not changed, for caching or interleaved thinking benefits, you can also achieve this with [`openai_chat_send_back_thinking_parts`](https://ai.pydantic.dev/api/profiles/#pydantic_ai.profiles.openai.OpenAIModelProfile.openai_chat_send_back_thinking_parts "openai_chat_send_back_thinking_parts
  ...
  ").
### OpenAI Responses
The [`OpenAIResponsesModel`](https://ai.pydantic.dev/api/models/openai/#pydantic_ai.models.openai.OpenAIResponsesModel "OpenAIResponsesModel



      dataclass
  ") can generate native thinking parts. To enable this functionality, you need to set the [`OpenAIResponsesModelSettings.openai_reasoning_effort`](https://ai.pydantic.dev/api/models/openai/#pydantic_ai.models.openai.OpenAIChatModelSettings.openai_reasoning_effort "openai_reasoning_effort



      instance-attribute
  ") and [`OpenAIResponsesModelSettings.openai_reasoning_summary`](https://ai.pydantic.dev/api/models/openai/#pydantic_ai.models.openai.OpenAIResponsesModelSettings.openai_reasoning_summary "openai_reasoning_summary



      instance-attribute
  ") [model settings](https://ai.pydantic.dev/agent/#model-run-settings).
...
Some OpenAI-compatible APIs (such as LM Studio, vLLM, or OpenRouter with gpt-oss models) may return raw reasoning content without reasoning summaries. In this case, [`ThinkingPart.content`](https://ai.pydantic.dev/api/messages/#pydantic_ai.messages.ThinkingPart.content "content



      instance-attribute
  ") will be empty, but the raw reasoning is available in `provider_details['raw_content']`. Following `provider_details` rather than in the main `content` field.
## Anthropic
To enable thinking, use the [`AnthropicModelSettings.anthropic_thinking`](https://ai.pydantic.dev/api/models/anthropic/#pydantic_ai.models.anthropic.AnthropicModelSettings.anthropic_thinking "anthropic_thinking
  ...
  ") [model setting](https://ai.pydantic.dev/agent/#model-run-settings).
Note
Extended thinking (`type: 'enabled'` with `budget_tokens`) is deprecated on `claude-opus-4-6`+. For those models, use [adaptive thinking](https://ai.pydantic.dev/thinking/#adaptive-thinking--effort) instead.
...
Starting with `claude-opus-4-6`, Anthropic supports `type: 'enabled'` with `budget_tokens`) which is deprecated on Opus 4.6. Adaptive thinking also automatically enables interleaved thinking.
...
The [`anthropic_effort`](https://ai.pydantic.dev/api/models/anthropic/#pydantic_ai.models.anthropic.AnthropicModelSettings.anthropic_effort "anthropic_effort



      instance-attribute
  ") setting controls how much effort the model puts into its response (independent of thinking). See the
Note
Older models (`claude-sonnet-4-5`, `claude-opus-4-5`, etc.) do not support adaptive thinking and require `{'type': 'enabled', 'budget_tokens': N}` as shown [above](https://ai.pydantic.dev/thinking/#anthropic).
## Google
To enable thinking, use the [`GoogleModelSettings.google_thinking_config`](https://ai.pydantic.dev/api/models/google/#pydantic_ai.models.google.GoogleModelSettings.google_thinking_config "google_thinking_config
...
Although Bedrock Converse doesn't provide a unified API to enable thinking, you can still use [`BedrockModelSettings.bedrock_additional_model_requests_fields`](https://ai.pydantic.dev/api/models/bedrock/#pydantic_ai.models.bedrock.BedrockModelSettings.bedrock_additional_model_requests_fields "bedrock_additional_model_requests_fields
      ...
      instance-attribute
  ") [model setting](https://ai.pydantic.dev/agent/#model-run-settings) to pass provider-specific configuration:
[Claude](https://ai.pydantic.dev/thinking/#__tabbed_1_1)[OpenAI](https://ai.pydantic.dev/thinking/#__tabbed_1_2)[Qwen](https://ai.pydantic.dev/thinking/#__tabbed_1_3)[Deepseek](https://ai.pydantic.dev/thinking/#__tabbed_1_4)
...
Groq supports different formats to receive thinking parts:
  * `"raw"`: The thinking part is included in the text content inside `<think>` tags, which are automatically converted to [`ThinkingPart`](https://ai.pydantic.dev/api/messages/#pydantic_ai.messages.ThinkingPart "ThinkingPart
  ...
  * `"parsed"`: The thinking part has its own structured part in the response which is converted into a [`ThinkingPart`](https://ai.pydantic.dev/api/messages/#pydantic_ai.messages.ThinkingPart "ThinkingPart
...
To enable thinking, use the [`GroqModelSettings.groq_reasoning_format`](https://ai.pydantic.dev/api/models/groq/#pydantic_ai.models.groq.GroqModelSettings.groq_reasoning_format "groq_reasoning_format
...
## OpenRouter
To enable thinking, use the [`OpenRouterModelSettings.openrouter_reasoning`](https://ai.pydantic.dev/api/models/openrouter/#pydantic_ai.models.openrouter.OpenRouterModelSettings.openrouter_reasoning "openrouter_reasoning
...
## Hugging Face
Text output inside `<think>` tags is automatically converted to [`ThinkingPart`](https://ai.pydantic.dev/api/messages/#pydantic_ai.messages.ThinkingPart "ThinkingPart
