[ Skip to content ](https://ai.pydantic.dev/api/ext/#pydantic_aiext)
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * API Reference
    * pydantic_ai
      ...
      * pydantic_ai.ext  [ pydantic_ai.ext  ](https://ai.pydantic.dev/api/ext/)
...
###  tool_from_langchain
```
tool_from_langchain(langchain_tool: LangChainTool) -> Tool[](https://ai.pydantic.dev/api/tools/#pydantic_ai.tools.Tool "Tool
...
```
tool_from_aci(
    aci_function: , linked_account_owner_id:
) -> Tool[](https://ai.pydantic.dev/api/tools/#pydantic_ai.tools.Tool "Tool
