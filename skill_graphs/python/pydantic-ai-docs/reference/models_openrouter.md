[ Skip to content ](https://ai.pydantic.dev/models/openrouter/#openrouter)
...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * Documentation
    ...
    * Models & Providers
      ...
      * OpenRouter  [ OpenRouter  ](https://ai.pydantic.dev/models/openrouter/)
        * [ Install  ](https://ai.pydantic.dev/models/openrouter/#install)
        * [ Configuration  ](https://ai.pydantic.dev/models/openrouter/#configuration)
        * [ App Attribution  ](https://ai.pydantic.dev/models/openrouter/#app-attribution)
        * [ Model Settings  ](https://ai.pydantic.dev/models/openrouter/#model-settings)
        * [ Web Search  ](https://ai.pydantic.dev/models/openrouter/#web-search)
          * [ Web Search Parameters  ](https://ai.pydantic.dev/models/openrouter/#web-search-parameters)
...
[pip](https://ai.pydantic.dev/models/openrouter/#__tabbed_1_1)[uv](https://ai.pydantic.dev/models/openrouter/#__tabbed_1_2)
```
...
## Web Search
OpenRouter supports web search via its [`WebSearchTool`](https://ai.pydantic.dev/api/builtin_tools/#pydantic_ai.builtin_tools.WebSearchTool "WebSearchTool
...
You can customize the web search behavior using the `search_context_size` parameter on [`WebSearchTool`](https://ai.pydantic.dev/api/builtin_tools/#pydantic_ai.builtin_tools.WebSearchTool "WebSearchTool
