[ Skip to content ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#metrics-attributes)
...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * Pydantic Evals
    ...
    * How-To Guides
      ...
      * Metrics & Attributes  [ Metrics & Attributes  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/)
        * [ Overview  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#overview)
        * [ Recording Metrics  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#recording-metrics)
        * [ Recording Attributes  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#recording-attributes)
        * [ Accessing in Evaluators  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#accessing-in-evaluators)
        * [ Viewing in Reports  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#viewing-in-reports)
        * [ Automatic Metrics  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#automatic-metrics)
        * [ Practical Examples  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#practical-examples)
          * [ API Usage Tracking  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#api-usage-tracking)
          * [ Tool Usage Tracking  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#tool-usage-tracking)
          * [ Performance Tracking  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#performance-tracking)
          * [ Quality Tracking  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#quality-tracking)
        * [ Experiment-Level Metadata  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#experiment-level-metadata)
          * [ When to Use Experiment Metadata  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#when-to-use-experiment-metadata)
          * [ Viewing in Reports  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#viewing-in-reports_1)
        * [ Synchronization between Tasks and Experiment Metadata  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#synchronization-between-tasks-and-experiment-metadata)
          * [ Pattern 1: Shared Module Constants  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#pattern-1-shared-module-constants)
          * [ Pattern 2: Configuration Object (Recommended)  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#pattern-2-configuration-object-recommended)
          * [ Anti-Pattern: Duplicate Configuration  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#anti-pattern-duplicate-configuration)
        * [ Metrics vs Attributes vs Metadata  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#metrics-vs-attributes-vs-metadata)
        * [ Troubleshooting  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#troubleshooting)
          * [ "Metrics/attributes not appearing"  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#metricsattributes-not-appearing)
          * [ "Metrics not incrementing"  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#metrics-not-incrementing)
          * [ "Too much data in attributes"  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#too-much-data-in-attributes)
        * [ Next Steps  ](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#next-steps)
    * Examples
...
## Recording Metrics
Use [`increment_eval_metric`](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.increment_eval_metric "increment_eval_metric") to track numeric values:
```
...
Use [`set_eval_attribute`](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.set_eval_attribute "set_eval_attribute") to store any data:
```
...
Metrics and attributes are available in the [`EvaluatorContext`](https://ai.pydantic.dev/api/pydantic_evals/evaluators/#pydantic_evals.evaluators.EvaluatorContext "EvaluatorContext
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#__tabbed_1_1)[Directly to Provider API](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#__tabbed_1_2)
...
### Tool Usage Tracking
[With Pydantic AI Gateway](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#__tabbed_2_1)[Directly to Provider API](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#__tabbed_2_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway)```
from dataclasses import dataclass
...
In addition to case-level metadata, you can also pass experiment-level metadata when calling [`evaluate()`](https://ai.pydantic.dev/api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset.evaluate "evaluate
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#__tabbed_3_1)[Directly to Provider API](https://ai.pydantic.dev/evals/how-to/metrics-attributes/#__tabbed_3_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway)```
from pydantic_ai import Agent
from pydantic_evals import Case, Dataset
...
## Next Steps
  * **[Custom Evaluators](https://ai.pydantic.dev/evals/evaluators/custom/)** - Use metrics/attributes in evaluators
  * **[Logfire Integration](https://ai.pydantic.dev/evals/how-to/logfire-integration/)** - View metrics in Logfire
