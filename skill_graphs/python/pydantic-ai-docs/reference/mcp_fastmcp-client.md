[ Skip to content ](https://ai.pydantic.dev/mcp/fastmcp-client/#fastmcp-client)
...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * Documentation
    ...
    * MCP
      ...
      * FastMCP Client  [ FastMCP Client  ](https://ai.pydantic.dev/mcp/fastmcp-client/)
        * [ Install  ](https://ai.pydantic.dev/mcp/fastmcp-client/#install)
        * [ Usage  ](https://ai.pydantic.dev/mcp/fastmcp-client/#usage)
...
# FastMCP Client
As an alternative to Pydantic AI's standard [`MCPServer` MCP client](https://ai.pydantic.dev/mcp/client/) built on the [`FastMCPToolset`](https://ai.pydantic.dev/api/toolsets/#pydantic_ai.toolsets.fastmcp.FastMCPToolset "FastMCPToolset



      dataclass
  ") [toolset](https://ai.pydantic.dev/toolsets/) that leverages the
Note that it does not yet support integration elicitation or sampling, which are supported by the [standard `MCPServer` client](https://ai.pydantic.dev/mcp/client/).
## Install
...
[pip](https://ai.pydantic.dev/mcp/fastmcp-client/#__tabbed_1_1)[uv](https://ai.pydantic.dev/mcp/fastmcp-client/#__tabbed_1_2)
```
...
If you already have a `FastMCPToolset` directly from it and save agent a network round trip:
[With Pydantic AI Gateway](https://ai.pydantic.dev/mcp/fastmcp-client/#__tabbed_2_1)[Directly to Provider API](https://ai.pydantic.dev/mcp/fastmcp-client/#__tabbed_2_2)
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/mcp/fastmcp-client/#__tabbed_3_1)[Directly to Provider API](https://ai.pydantic.dev/mcp/fastmcp-client/#__tabbed_3_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway)```
from pydantic_ai import Agent
from pydantic_ai.toolsets.fastmcp import FastMCPToolset
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/mcp/fastmcp-client/#__tabbed_4_1)[Directly to Provider API](https://ai.pydantic.dev/mcp/fastmcp-client/#__tabbed_4_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway)```
from pydantic_ai import Agent
from pydantic_ai.toolsets.fastmcp import FastMCPToolset
