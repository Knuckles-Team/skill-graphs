...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * Examples
    ...
    * Streaming
      * Stream markdown  [ Stream markdown  ](https://ai.pydantic.dev/examples/stream-markdown/)
...
## Example Code
[With Pydantic AI Gateway](https://ai.pydantic.dev/examples/stream-markdown/#__tabbed_2_1)[Directly to Provider API](https://ai.pydantic.dev/examples/stream-markdown/#__tabbed_2_2)
