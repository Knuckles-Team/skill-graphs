...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * Documentation
    ...
    * Testing  [ Testing  ](https://ai.pydantic.dev/testing/)
...
Unless you're really sure you know better, you'll probably want to follow roughly this strategy:
  ...
  * Similarly,
  * Use [`TestModel`](https://ai.pydantic.dev/api/models/test/#pydantic_ai.models.test.TestModel "TestModel



      dataclass
  ") or [`FunctionModel`](https://ai.pydantic.dev/api/models/function/#pydantic_ai.models.function.FunctionModel "FunctionModel



      dataclass
  ") in place of your actual model to avoid the usage, latency and variability of real LLM calls
  * Use [`Agent.override`](https://ai.pydantic.dev/api/agent/#pydantic_ai.agent.Agent.override "override") to replace an agent's model, dependencies, or toolsets inside your application logic
  * Set [`ALLOW_MODEL_REQUESTS=False`](https://ai.pydantic.dev/api/models/base/#pydantic_ai.models.ALLOW_MODEL_REQUESTS "ALLOW_MODEL_REQUESTS
...
The simplest and fastest way to exercise most of your application code is using [`TestModel`](https://ai.pydantic.dev/api/models/test/#pydantic_ai.models.test.TestModel "TestModel
...
The resulting data won't look pretty or relevant, but it should pass Pydantic's validation in most cases. If you want something more sophisticated, use [`FunctionModel`](https://ai.pydantic.dev/api/models/function/#pydantic_ai.models.function.FunctionModel "FunctionModel
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/testing/#__tabbed_1_1)[Directly to Provider API](https://ai.pydantic.dev/testing/#__tabbed_1_2)
...
from fake_database import DatabaseConn  [](https://ai.pydantic.dev/testing/#__code_0_annotation_1)
from weather_service import WeatherService  [](https://ai.pydantic.dev/testing/#__code_0_annotation_2)
...
async def run_weather_forecast(  [](https://ai.pydantic.dev/testing/#__code_0_annotation_4)
...
Here's how we would write tests using [`TestModel`](https://ai.pydantic.dev/api/models/test/#pydantic_ai.models.test.TestModel "TestModel
...
pytestmark = pytest.mark.anyio  [](https://ai.pydantic.dev/testing/#__code_2_annotation_1)
models.ALLOW_MODEL_REQUESTS = False  [](https://ai.pydantic.dev/testing/#__code_2_annotation_2)
...
async def test_forecast():
    ...
    with capture_run_messages() as messages:
        with weather_agent.override(model=TestModel()):  [](https://ai.pydantic.dev/testing/#__code_2_annotation_3)
            prompt = 'What will the weather be like in London on 2024-11-28?'
            await run_weather_forecast([(prompt, user_id)], conn)  [](https://ai.pydantic.dev/testing/#__code_2_annotation_4)

    forecast = await conn.get_forecast(user_id)
    assert forecast == '{"weather_forecast":"Sunny with a chance of rain"}'  [](https://ai.pydantic.dev/testing/#__code_2_annotation_5)

    assert messages == [  [](https://ai.pydantic.dev/testing/#__code_2_annotation_6)
        ModelRequest(
            parts=[
                UserPromptPart(
                    content='What will the weather be like in London on 2024-11-28?',
                    timestamp=IsNow(tz=timezone.utc),  [](https://ai.pydantic.dev/testing/#__code_2_annotation_7)
                ),
            ],
            instructions='Providing a weather forecast at the locations the user provides.',
        ...
        ModelResponse(
            parts=[
                ToolCallPart(
                    ...
                    args={
                        'location': 'a',
                        'forecast_date': '2024-01-01',  [](https://ai.pydantic.dev/testing/#__code_2_annotation_8)
                    },
                    tool_call_id=IsStr(),
                )
            ],
...
To fully exercise `weather_forecast`, we need to use [`FunctionModel`](https://ai.pydantic.dev/api/models/function/#pydantic_ai.models.function.FunctionModel "FunctionModel
...
def call_weather_forecast(  [](https://ai.pydantic.dev/testing/#__code_3_annotation_1)
    ...
    if len(messages) == 1:
        ...
        args = {'location': 'London', 'forecast_date': m.group()}  [](https://ai.pydantic.dev/testing/#__code_3_annotation_2)
...
async def test_forecast_future():
    conn = DatabaseConn()
    user_id = 1
    with weather_agent.override(model=FunctionModel(call_weather_forecast)):  [](https://ai.pydantic.dev/testing/#__code_3_annotation_3)
...
If you're writing lots of tests that all require model to be overridden, you can use [`TestModel`](https://ai.pydantic.dev/api/models/test/#pydantic_ai.models.test.TestModel "TestModel
