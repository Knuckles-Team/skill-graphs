...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * API Reference
    * pydantic_ai
      ...
      * pydantic_ai.result  [ pydantic_ai.result  ](https://ai.pydantic.dev/api/result/)
        ...
        * [ StreamedRunResult  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResult)
          ...
          * [ stream_output  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResult.stream_output)
          ...
          * [ stream_responses  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResult.stream_responses)
          * [ get_output  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResult.get_output)
          * [ response  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResult.response)
          * [ metadata  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResult.metadata)
          ...
          * [ run_id  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResult.run_id)
          ...
          * [ validate_response_output  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResult.validate_response_output)
        * [ StreamedRunResultSync  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResultSync)
          * [ all_messages  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResultSync.all_messages)
          * [ all_messages_json  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResultSync.all_messages_json)
          * [ new_messages  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResultSync.new_messages)
          * [ new_messages_json  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResultSync.new_messages_json)
          * [ stream_output  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResultSync.stream_output)
          * [ stream_text  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResultSync.stream_text)
          * [ stream_responses  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResultSync.stream_responses)
          * [ get_output  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResultSync.get_output)
          * [ response  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResultSync.response)
          * [ usage  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResultSync.usage)
          * [ timestamp  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResultSync.timestamp)
          * [ run_id  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResultSync.run_id)
          * [ metadata  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResultSync.metadata)
          * [ validate_response_output  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResultSync.validate_response_output)
          * [ is_complete  ](https://ai.pydantic.dev/api/result/#pydantic_ai.result.StreamedRunResultSync.is_complete)
