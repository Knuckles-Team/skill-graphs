[ Skip to content ](https://ai.pydantic.dev/evals/how-to/concurrency/#concurrency-performance)
...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * Pydantic Evals
    ...
    * How-To Guides
      ...
      * Concurrency & Performance  [ Concurrency & Performance  ](https://ai.pydantic.dev/evals/how-to/concurrency/)
        * [ Overview  ](https://ai.pydantic.dev/evals/how-to/concurrency/#overview)
        * [ Basic Usage  ](https://ai.pydantic.dev/evals/how-to/concurrency/#basic-usage)
        * [ When to Limit Concurrency  ](https://ai.pydantic.dev/evals/how-to/concurrency/#when-to-limit-concurrency)
          * [ Rate Limiting  ](https://ai.pydantic.dev/evals/how-to/concurrency/#rate-limiting)
          * [ Resource Constraints  ](https://ai.pydantic.dev/evals/how-to/concurrency/#resource-constraints)
          * [ Debugging  ](https://ai.pydantic.dev/evals/how-to/concurrency/#debugging)
        * [ Performance Comparison  ](https://ai.pydantic.dev/evals/how-to/concurrency/#performance-comparison)
        * [ Concurrency with Evaluators  ](https://ai.pydantic.dev/evals/how-to/concurrency/#concurrency-with-evaluators)
        * [ Async vs Sync  ](https://ai.pydantic.dev/evals/how-to/concurrency/#async-vs-sync)
          * [ Sync API  ](https://ai.pydantic.dev/evals/how-to/concurrency/#sync-api)
          * [ Async API  ](https://ai.pydantic.dev/evals/how-to/concurrency/#async-api)
        * [ Monitoring Concurrency  ](https://ai.pydantic.dev/evals/how-to/concurrency/#monitoring-concurrency)
        * [ Handling Rate Limits  ](https://ai.pydantic.dev/evals/how-to/concurrency/#handling-rate-limits)
        * [ Next Steps  ](https://ai.pydantic.dev/evals/how-to/concurrency/#next-steps)
...
If your evaluators are expensive (e.g., [`LLMJudge`](https://ai.pydantic.dev/api/pydantic_evals/evaluators/#pydantic_evals.evaluators.LLMJudge "LLMJudge
...
See [Retry Strategies](https://ai.pydantic.dev/evals/how-to/retry-strategies/) for handling transient failures.
## Next Steps
  * **[Retry Strategies](https://ai.pydantic.dev/evals/how-to/retry-strategies/)** - Handle transient failures
  * **[Dataset Management](https://ai.pydantic.dev/evals/how-to/dataset-management/)** - Work with large datasets
  * **[Logfire Integration](https://ai.pydantic.dev/evals/how-to/logfire-integration/)** - Monitor performance
