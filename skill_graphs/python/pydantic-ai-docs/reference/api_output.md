[ Skip to content ](https://ai.pydantic.dev/api/output/#pydantic_aioutput)
...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * API Reference
    * pydantic_ai
      ...
      * pydantic_ai.output  [ pydantic_ai.output  ](https://ai.pydantic.dev/api/output/)
        * [ output  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output)
        * [ OutputDataT  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.OutputDataT)
        * [ ToolOutput  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.ToolOutput)
          * [ output  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.ToolOutput.output)
          * [ name  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.ToolOutput.name)
          * [ description  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.ToolOutput.description)
          * [ max_retries  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.ToolOutput.max_retries)
          * [ strict  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.ToolOutput.strict)
        * [ NativeOutput  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.NativeOutput)
          * [ outputs  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.NativeOutput.outputs)
          * [ name  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.NativeOutput.name)
          * [ description  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.NativeOutput.description)
          * [ strict  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.NativeOutput.strict)
          * [ template  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.NativeOutput.template)
        * [ PromptedOutput  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.PromptedOutput)
          * [ outputs  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.PromptedOutput.outputs)
          * [ name  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.PromptedOutput.name)
          * [ description  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.PromptedOutput.description)
          * [ template  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.PromptedOutput.template)
        * [ TextOutput  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.TextOutput)
          * [ output_function  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.TextOutput.output_function)
        * [ StructuredDict  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.StructuredDict)
        * [ DeferredToolRequests  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.DeferredToolRequests)
          * [ calls  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.DeferredToolRequests.calls)
          * [ approvals  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.DeferredToolRequests.approvals)
          * [ metadata  ](https://ai.pydantic.dev/api/output/#pydantic_ai.output.DeferredToolRequests.metadata)
...
```
OutputDataT = TypeVar(
    "OutputDataT", default=, covariant=True
)
...
```
output: OutputTypeOrFunction[OutputDataT[](https://ai.pydantic.dev/api/output/#pydantic_ai.output.OutputDataT "OutputDataT



      module-attribute
   \(pydantic_ai.output.OutputDataT\)")] = type_
...
```
outputs: (
    OutputTypeOrFunction[OutputDataT[](https://ai.pydantic.dev/api/output/#pydantic_ai.output.OutputDataT "OutputDataT
...
```
output_function: TextOutputFunc[OutputDataT[](https://ai.pydantic.dev/api/output/#pydantic_ai.output.OutputDataT "OutputDataT
...
`name` |  |  Optional name of the structured output. If not provided, the `title` field of the JSON schema will be used if it's present. |  `None`
`description` |  |  Optional description of the structured output. If not provided, the `description` field of the JSON schema will be used if it's present. |  `None`
Example:
structured_dict.py```
