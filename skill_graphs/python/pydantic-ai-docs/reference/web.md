[ Skip to content ](https://ai.pydantic.dev/web/#web-chat-ui)
...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * Documentation
    ...
    * Web Chat UI  [ Web Chat UI  ](https://ai.pydantic.dev/web/)
      * [ Installation  ](https://ai.pydantic.dev/web/#installation)
      * [ Basic Usage  ](https://ai.pydantic.dev/web/#basic-usage)
      * [ Configuring Models  ](https://ai.pydantic.dev/web/#configuring-models)
      * [ Builtin Tool Support  ](https://ai.pydantic.dev/web/#builtin-tool-support)
      * [ Extra Instructions  ](https://ai.pydantic.dev/web/#extra-instructions)
      * [ Reserved Routes  ](https://ai.pydantic.dev/web/#reserved-routes)
      * [ Custom HTML Source  ](https://ai.pydantic.dev/web/#custom-html-source)
...
Note
The web UI is meant for local development and debugging. In production, you can use one of the [UI Event Stream integrations](https://ai.pydantic.dev/ui/overview/) to connect your agent to a custom frontend.
## Installation
Install the `web` extra (installs Starlette and Uvicorn):
[pip](https://ai.pydantic.dev/web/#__tabbed_1_1)[uv](https://ai.pydantic.dev/web/#__tabbed_1_2)
```
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/web/#__tabbed_2_1)[Directly to Provider API](https://ai.pydantic.dev/web/#__tabbed_2_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway)```
from pydantic_ai import Agent

agent = Agent('gateway/openai:gpt-5.2', instructions='You are a helpful assistant.')
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/web/#__tabbed_3_1)[Directly to Provider API](https://ai.pydantic.dev/web/#__tabbed_3_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway)```
from pydantic_ai import Agent
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/web/#__tabbed_4_1)[Directly to Provider API](https://ai.pydantic.dev/web/#__tabbed_4_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway)```
from pydantic_ai import Agent
...
Memory Tool
The `memory` builtin tool is not supported via `to_web()` or `clai web`. If your agent needs memory, configure the [`MemoryTool`](https://ai.pydantic.dev/api/builtin_tools/#pydantic_ai.builtin_tools.MemoryTool "MemoryTool
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/web/#__tabbed_5_1)[Directly to Provider API](https://ai.pydantic.dev/web/#__tabbed_5_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway)```
from pydantic_ai import Agent
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/web/#__tabbed_6_1)[Directly to Provider API](https://ai.pydantic.dev/web/#__tabbed_6_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway)```
from pydantic_ai import Agent
