...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * Examples
    ...
    * Streaming
      ...
      * Stream whales  [ Stream whales  ](https://ai.pydantic.dev/examples/stream-whales/)
  ...
  * [ Example Code  ](https://ai.pydantic.dev/examples/stream-whales/#example-code)
  ...
  3. [ Streaming  ](https://ai.pydantic.dev/examples/stream-markdown/)
...
This script streams structured responses about whales, validates the data and displays it as a dynamic table using
## Running the Example
...
## Example Code
[With Pydantic AI Gateway](https://ai.pydantic.dev/examples/stream-whales/#__tabbed_2_1)[Directly to Provider API](https://ai.pydantic.dev/examples/stream-whales/#__tabbed_2_2)
