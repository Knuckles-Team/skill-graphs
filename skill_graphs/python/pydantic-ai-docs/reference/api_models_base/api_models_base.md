...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * API Reference
    * pydantic_ai
      ...
      * pydantic_ai.models  [ pydantic_ai.models  ](https://ai.pydantic.dev/api/models/base/)
        ...
        * [ Model  ](https://ai.pydantic.dev/api/models/base/#pydantic_ai.models.Model)
          * [ __init__  ](https://ai.pydantic.dev/api/models/base/#pydantic_ai.models.Model.__init__)
          * [ settings  ](https://ai.pydantic.dev/api/models/base/#pydantic_ai.models.Model.settings)
          * [ request  ](https://ai.pydantic.dev/api/models/base/#pydantic_ai.models.Model.request)
          * [ count_tokens  ](https://ai.pydantic.dev/api/models/base/#pydantic_ai.models.Model.count_tokens)
          * [ request_stream  ](https://ai.pydantic.dev/api/models/base/#pydantic_ai.models.Model.request_stream)
          * [ customize_request_parameters  ](https://ai.pydantic.dev/api/models/base/#pydantic_ai.models.Model.customize_request_parameters)
          * [ prepare_request  ](https://ai.pydantic.dev/api/models/base/#pydantic_ai.models.Model.prepare_request)
          * [ model_name  ](https://ai.pydantic.dev/api/models/base/#pydantic_ai.models.Model.model_name)
          * [ model_id  ](https://ai.pydantic.dev/api/models/base/#pydantic_ai.models.Model.model_id)
          * [ label  ](https://ai.pydantic.dev/api/models/base/#pydantic_ai.models.Model.label)
          * [ supported_builtin_tools  ](https://ai.pydantic.dev/api/models/base/#pydantic_ai.models.Model.supported_builtin_tools)
          * [ profile  ](https://ai.pydantic.dev/api/models/base/#pydantic_ai.models.Model.profile)
        ...
        * [ StreamedResponse  ](https://ai.pydantic.dev/api/models/base/#pydantic_ai.models.StreamedResponse)
          ...
          * [ provider_name  ](https://ai.pydantic.dev/api/models/base/#pydantic_ai.models.StreamedResponse.provider_name)
          * [ provider_url  ](https://ai.pydantic.dev/api/models/base/#pydantic_ai.models.StreamedResponse.provider_url)
