[ Skip to content ](https://ai.pydantic.dev/models/xai/#xai)
...
[ ![logo](https://ai.pydantic.dev/img/logo-white.svg) ](https://ai.pydantic.dev/ "Pydantic AI") Pydantic AI
  ...
  * Documentation
    ...
    * Models & Providers
      ...
      * xAI  [ xAI  ](https://ai.pydantic.dev/models/xai/)
        * [ Install  ](https://ai.pydantic.dev/models/xai/#install)
        * [ Configuration  ](https://ai.pydantic.dev/models/xai/#configuration)
        * [ Environment variable  ](https://ai.pydantic.dev/models/xai/#environment-variable)
...
[pip](https://ai.pydantic.dev/models/xai/#__tabbed_1_1)[uv](https://ai.pydantic.dev/models/xai/#__tabbed_1_2)
```
