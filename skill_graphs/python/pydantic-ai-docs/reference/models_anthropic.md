  ...
  * Documentation
    ...
    * Models & Providers
      ...
      * Anthropic  [ Anthropic  ](https://ai.pydantic.dev/models/anthropic/)
        ...
        * [ Cloud Platform Integrations  ](https://ai.pydantic.dev/models/anthropic/#cloud-platform-integrations)
          * [ AWS Bedrock  ](https://ai.pydantic.dev/models/anthropic/#aws-bedrock)
          * [ Google Vertex AI  ](https://ai.pydantic.dev/models/anthropic/#google-vertex-ai)
          * [ Microsoft Foundry  ](https://ai.pydantic.dev/models/anthropic/#microsoft-foundry)
        * [ Prompt Caching  ](https://ai.pydantic.dev/models/anthropic/#prompt-caching)
          * [ Example 1: Automatic Message Caching  ](https://ai.pydantic.dev/models/anthropic/#example-1-automatic-message-caching)
          * [ Example 2: Comprehensive Caching Strategy  ](https://ai.pydantic.dev/models/anthropic/#example-2-comprehensive-caching-strategy)
          * [ Example 3: Fine-Grained Control with CachePoint  ](https://ai.pydantic.dev/models/anthropic/#example-3-fine-grained-control-with-cachepoint)
          * [ Accessing Cache Usage Statistics  ](https://ai.pydantic.dev/models/anthropic/#accessing-cache-usage-statistics)
          * [ Cache Point Limits  ](https://ai.pydantic.dev/models/anthropic/#cache-point-limits)
            * [ How Cache Points Are Allocated  ](https://ai.pydantic.dev/models/anthropic/#how-cache-points-are-allocated)
            * [ Example: Using All 3 Cache Point Sources  ](https://ai.pydantic.dev/models/anthropic/#example-using-all-3-cache-point-sources)
            * [ Automatic Cache Point Limiting  ](https://ai.pydantic.dev/models/anthropic/#automatic-cache-point-limiting)
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/models/anthropic/#__tabbed_2_1)[Directly to Provider API](https://ai.pydantic.dev/models/anthropic/#__tabbed_2_2)
...
### AWS Bedrock
To use Claude models via `AsyncAnthropicBedrock` client and then pass it to `AnthropicProvider`:
```
...
### Google Vertex AI
To use Claude models via `AsyncAnthropicVertex` client and then pass it to `AnthropicProvider`:
```
...
### Microsoft Foundry
To use Claude models via `AsyncAnthropicFoundry` client and then pass it to `AnthropicProvider`:
```
...
Anthropic supports
  ...
  2. **Cache System Instructions** : Set [`AnthropicModelSettings.anthropic_cache_instructions`](https://ai.pydantic.dev/api/models/anthropic/#pydantic_ai.models.anthropic.AnthropicModelSettings.anthropic_cache_instructions "anthropic_cache_instructions



      instance-attribute
  ") to `True` (uses 5m TTL by default) or specify `'5m'` / `'1h'` directly
  3. **Cache Tool Definitions** : Set [`AnthropicModelSettings.anthropic_cache_tool_definitions`](https://ai.pydantic.dev/api/models/anthropic/#pydantic_ai.models.anthropic.AnthropicModelSettings.anthropic_cache_tool_definitions "anthropic_cache_tool_definitions



      instance-attribute
  ") to `True` (uses 5m TTL by default) or specify `'5m'` / `'1h'` directly
  4. **Cache All Messages** : Set [`AnthropicModelSettings.anthropic_cache_messages`](https://ai.pydantic.dev/api/models/anthropic/#pydantic_ai.models.anthropic.AnthropicModelSettings.anthropic_cache_messages "anthropic_cache_messages
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/models/anthropic/#__tabbed_3_1)[Directly to Provider API](https://ai.pydantic.dev/models/anthropic/#__tabbed_3_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway)```
from pydantic_ai import Agent
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/models/anthropic/#__tabbed_4_1)[Directly to Provider API](https://ai.pydantic.dev/models/anthropic/#__tabbed_4_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway)```
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/models/anthropic/#__tabbed_5_1)[Directly to Provider API](https://ai.pydantic.dev/models/anthropic/#__tabbed_5_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway)```
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/models/anthropic/#__tabbed_6_1)[Directly to Provider API](https://ai.pydantic.dev/models/anthropic/#__tabbed_6_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway)```
from pydantic_ai import Agent
from pydantic_ai.models.anthropic import AnthropicModelSettings
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/models/anthropic/#__tabbed_7_1)[Directly to Provider API](https://ai.pydantic.dev/models/anthropic/#__tabbed_7_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway)```
from pydantic_ai import Agent, CachePoint
from pydantic_ai.models.anthropic import AnthropicModelSettings
...
[With Pydantic AI Gateway](https://ai.pydantic.dev/models/anthropic/#__tabbed_8_1)[Directly to Provider API](https://ai.pydantic.dev/models/anthropic/#__tabbed_8_2)
[Learn about Gateway](https://ai.pydantic.dev/gateway)```
from pydantic_ai import Agent, CachePoint
from pydantic_ai.models.anthropic import AnthropicModelSettings
