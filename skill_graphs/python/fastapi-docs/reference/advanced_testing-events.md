...
# Testing Events: lifespan and startup - shutdown[¶](https://fastapi.tiangolo.com/advanced/testing-events/#testing-events-lifespan-and-startup-shutdown)
When you need `lifespan` to run in your tests, you can use the `TestClient` with a `with` statement:
[Python 3.10+](https://fastapi.tiangolo.com/advanced/testing-events/#__tabbed_1_1)
```
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/testing-events/#__tabbed_2_1)
```
from fastapi import FastAPI
from fastapi.testclient import TestClient
