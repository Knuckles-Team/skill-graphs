...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Advanced User Guide  ](https://fastapi.tiangolo.com/advanced/)
      ...
      * Response Headers  [ Response Headers  ](https://fastapi.tiangolo.com/advanced/response-headers/)
...
# Response Headers[¶](https://fastapi.tiangolo.com/advanced/response-headers/#response-headers)
## Use a `Response` parameter[¶](https://fastapi.tiangolo.com/advanced/response-headers/#use-a-response-parameter)
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/response-headers/#__tabbed_1_1)
```
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/response-headers/#__tabbed_2_1)
```
...
But if you have custom headers that you want a client in a browser to be able to see, you need to add them to your CORS configurations (read more in [CORS (Cross-Origin Resource Sharing)](https://fastapi.tiangolo.com/tutorial/cors/)), using the parameter `expose_headers` documented in
