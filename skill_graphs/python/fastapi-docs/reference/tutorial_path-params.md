...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Tutorial - User Guide  ](https://fastapi.tiangolo.com/tutorial/)
      ...
      * Path Parameters  [ Path Parameters  ](https://fastapi.tiangolo.com/tutorial/path-params/)
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/path-params/#__tabbed_1_1)
```
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/path-params/#__tabbed_2_1)
```
from fastapi import FastAPI
...
Because of this, **FastAPI** itself provides an alternative API documentation (using ReDoc), which you can access at
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/path-params/#__tabbed_3_1)
```
from fastapi import FastAPI
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/path-params/#__tabbed_4_1)
```
from fastapi import FastAPI
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/path-params/#__tabbed_5_1)
```
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/path-params/#__tabbed_6_1)
```
from enum import Enum
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/path-params/#__tabbed_7_1)
```
from enum import Enum
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/path-params/#__tabbed_8_1)
```
from enum import Enum
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/path-params/#__tabbed_9_1)
```
from enum import Enum
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/path-params/#__tabbed_10_1)
```
from fastapi import FastAPI
