...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Reference  ](https://fastapi.tiangolo.com/reference/)
    ...
    * Dependencies - `Depends()` and `Security()` [ Dependencies - `Depends()` and `Security()` ](https://fastapi.tiangolo.com/reference/dependencies/)
      * [ `Depends()` ](https://fastapi.tiangolo.com/reference/dependencies/#depends)
      * [ ](https://fastapi.tiangolo.com/reference/dependencies/#fastapi.Depends)
      * [ `Security()` ](https://fastapi.tiangolo.com/reference/dependencies/#security)
      * [ ](https://fastapi.tiangolo.com/reference/dependencies/#fastapi.Security)
...
# Dependencies - `Depends()` and `Security()`[¶](https://fastapi.tiangolo.com/reference/dependencies/#dependencies-depends-and-security)
##  `Depends()`[¶](https://fastapi.tiangolo.com/reference/dependencies/#depends)
