...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Advanced User Guide  ](https://fastapi.tiangolo.com/advanced/)
      ...
      * Templates  [ Templates  ](https://fastapi.tiangolo.com/advanced/templates/)
        * [ Install dependencies  ](https://fastapi.tiangolo.com/advanced/templates/#install-dependencies)
        * [ Using `Jinja2Templates` ](https://fastapi.tiangolo.com/advanced/templates/#using-jinja2templates)
        * [ Writing templates  ](https://fastapi.tiangolo.com/advanced/templates/#writing-templates)
          * [ Template Context Values  ](https://fastapi.tiangolo.com/advanced/templates/#template-context-values)
          * [ Template `url_for` Arguments  ](https://fastapi.tiangolo.com/advanced/templates/#template-url-for-arguments)
        * [ Templates and static files  ](https://fastapi.tiangolo.com/advanced/templates/#templates-and-static-files)
        * [ More details  ](https://fastapi.tiangolo.com/advanced/templates/#more-details)
...
# Templates[¶](https://fastapi.tiangolo.com/advanced/templates/#templates)
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/templates/#__tabbed_1_1)
```
