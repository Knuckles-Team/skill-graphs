...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Advanced User Guide  ](https://fastapi.tiangolo.com/advanced/)
      ...
      * Response Cookies  [ Response Cookies  ](https://fastapi.tiangolo.com/advanced/response-cookies/)
...
# Response Cookies[¶](https://fastapi.tiangolo.com/advanced/response-cookies/#response-cookies)
## Use a `Response` parameter[¶](https://fastapi.tiangolo.com/advanced/response-cookies/#use-a-response-parameter)
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/response-cookies/#__tabbed_1_1)
```
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/response-cookies/#__tabbed_2_1)
```
