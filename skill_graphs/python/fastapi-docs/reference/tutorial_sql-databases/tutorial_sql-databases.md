[ Skip to content ](https://fastapi.tiangolo.com/tutorial/sql-databases/#sql-relational-databases)
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Tutorial - User Guide  ](https://fastapi.tiangolo.com/tutorial/)
      ...
      * SQL (Relational) Databases  [ SQL (Relational) Databases  ](https://fastapi.tiangolo.com/tutorial/sql-databases/)
        * [ Install `SQLModel` ](https://fastapi.tiangolo.com/tutorial/sql-databases/#install-sqlmodel)
        ...
        * [ Recap  ](https://fastapi.tiangolo.com/tutorial/sql-databases/#recap)
