[ Skip to content ](https://fastapi.tiangolo.com/tutorial/request-forms/#form-data)
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Tutorial - User Guide  ](https://fastapi.tiangolo.com/tutorial/)
      ...
      * Form Data  [ Form Data  ](https://fastapi.tiangolo.com/tutorial/request-forms/)
        * [ Import `Form` ](https://fastapi.tiangolo.com/tutorial/request-forms/#import-form)
        * [ Define `Form` parameters  ](https://fastapi.tiangolo.com/tutorial/request-forms/#define-form-parameters)
        * [ About "Form Fields"  ](https://fastapi.tiangolo.com/tutorial/request-forms/#about-form-fields)
        * [ Recap  ](https://fastapi.tiangolo.com/tutorial/request-forms/#recap)
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/request-forms/#__tabbed_1_1)
```
...
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/request-forms/#__tabbed_2_1)
Tip
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/request-forms/#__tabbed_3_1)
```
from typing import Annotated
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/request-forms/#__tabbed_4_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import FastAPI, Form
