[ Skip to content ](https://fastapi.tiangolo.com/tutorial/body-updates/#body-updates)
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Tutorial - User Guide  ](https://fastapi.tiangolo.com/tutorial/)
      ...
      * Body - Updates  [ Body - Updates  ](https://fastapi.tiangolo.com/tutorial/body-updates/)
        ...
        * [ Partial updates with `PATCH` ](https://fastapi.tiangolo.com/tutorial/body-updates/#partial-updates-with-patch)
          * [ Using Pydantic's `exclude_unset` parameter  ](https://fastapi.tiangolo.com/tutorial/body-updates/#using-pydantics-exclude-unset-parameter)
...
## Partial updates with `PATCH`[¶](https://fastapi.tiangolo.com/tutorial/body-updates/#partial-updates-with-patch)
You can also use the _partially_ update data.
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/body-updates/#__tabbed_2_1)
```
from fastapi import FastAPI
from fastapi.encoders import jsonable_encoder
from pydantic import BaseModel
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/body-updates/#__tabbed_4_1)
```
from fastapi import FastAPI
from fastapi.encoders import jsonable_encoder
from pydantic import BaseModel
