...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Advanced User Guide  ](https://fastapi.tiangolo.com/advanced/)
      ...
      * Using the Request Directly  [ Using the Request Directly  ](https://fastapi.tiangolo.com/advanced/using-request-directly/)
        * [ Details about the `Request` object  ](https://fastapi.tiangolo.com/advanced/using-request-directly/#details-about-the-request-object)
        * [ Use the `Request` object directly  ](https://fastapi.tiangolo.com/advanced/using-request-directly/#use-the-request-object-directly)
        * [ `Request` documentation  ](https://fastapi.tiangolo.com/advanced/using-request-directly/#request-documentation)
...
# Using the Request Directly[¶](https://fastapi.tiangolo.com/advanced/using-request-directly/#using-the-request-directly)
...
[Python 3.10+](https://fastapi.tiangolo.com/advanced/using-request-directly/#__tabbed_1_1)
```
