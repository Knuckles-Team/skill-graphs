[ Skip to content ](https://fastapi.tiangolo.com/tutorial/debugging/#debugging)
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Tutorial - User Guide  ](https://fastapi.tiangolo.com/tutorial/)
      ...
      * Debugging  [ Debugging  ](https://fastapi.tiangolo.com/tutorial/debugging/)
        * [ Call `uvicorn` ](https://fastapi.tiangolo.com/tutorial/debugging/#call-uvicorn)
          * [ About `__name__ == "__main__"` ](https://fastapi.tiangolo.com/tutorial/debugging/#about-name-main)
            * [ More details  ](https://fastapi.tiangolo.com/tutorial/debugging/#more-details)
        * [ Run your code with your debugger  ](https://fastapi.tiangolo.com/tutorial/debugging/#run-your-code-with-your-debugger)
...
# Debugging[¶](https://fastapi.tiangolo.com/tutorial/debugging/#debugging)
You can connect the debugger in your editor, for example with Visual Studio Code or PyCharm.
## Call `uvicorn`[¶](https://fastapi.tiangolo.com/tutorial/debugging/#call-uvicorn)
In your FastAPI application, import and run `uvicorn` directly:
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/debugging/#__tabbed_1_1)
```
import uvicorn
