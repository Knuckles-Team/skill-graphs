[ Skip to content ](https://fastapi.tiangolo.com/tutorial/request-form-models/#form-models)
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Tutorial - User Guide  ](https://fastapi.tiangolo.com/tutorial/)
      ...
      * Form Models  [ Form Models  ](https://fastapi.tiangolo.com/tutorial/request-form-models/)
        * [ Pydantic Models for Forms  ](https://fastapi.tiangolo.com/tutorial/request-form-models/#pydantic-models-for-forms)
        * [ Check the Docs  ](https://fastapi.tiangolo.com/tutorial/request-form-models/#check-the-docs)
        * [ Forbid Extra Form Fields  ](https://fastapi.tiangolo.com/tutorial/request-form-models/#forbid-extra-form-fields)
        * [ Summary  ](https://fastapi.tiangolo.com/tutorial/request-form-models/#summary)
...
# Form Models[¶](https://fastapi.tiangolo.com/tutorial/request-form-models/#form-models)
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/request-form-models/#__tabbed_1_1)
```
...
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/request-form-models/#__tabbed_2_1)
Tip
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/request-form-models/#__tabbed_3_1)
```
from typing import Annotated
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/request-form-models/#__tabbed_4_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import FastAPI, Form
