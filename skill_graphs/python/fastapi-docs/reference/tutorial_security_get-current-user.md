[ Skip to content ](https://fastapi.tiangolo.com/tutorial/security/get-current-user/#get-current-user)
    ...
    * [ Tutorial - User Guide  ](https://fastapi.tiangolo.com/tutorial/)
      ...
      * [ Security  ](https://fastapi.tiangolo.com/tutorial/security/)
        ...
        * Get Current User  [ Get Current User  ](https://fastapi.tiangolo.com/tutorial/security/get-current-user/)
          ...
          * [ Create a `get_current_user` dependency  ](https://fastapi.tiangolo.com/tutorial/security/get-current-user/#create-a-get-current-user-dependency)
...
# Get Current User[¶](https://fastapi.tiangolo.com/tutorial/security/get-current-user/#get-current-user)
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/security/get-current-user/#__tabbed_1_1)
```
...
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/security/get-current-user/#__tabbed_2_1)
Tip
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/security/get-current-user/#__tabbed_4_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import Depends, FastAPI
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/security/get-current-user/#__tabbed_6_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import Depends, FastAPI
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/security/get-current-user/#__tabbed_8_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import Depends, FastAPI
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/security/get-current-user/#__tabbed_10_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import Depends, FastAPI
...
🤓 Other versions and variants
[Python 3.10+ - non-Annotated](https://fastapi.tiangolo.com/tutorial/security/get-current-user/#__tabbed_12_1)
Tip
Prefer to use the `Annotated` version if possible.
```
from fastapi import Depends, FastAPI
