...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Code snippets  ](https://fastapi.tiangolo.com/_llm-test/#code-snippets)
  * [ Quotes  ](https://fastapi.tiangolo.com/_llm-test/#quotes)
  * [ Quotes in code snippets  ](https://fastapi.tiangolo.com/_llm-test/#quotes-in-code-snippets)
  * [ code blocks  ](https://fastapi.tiangolo.com/_llm-test/#code-blocks)
  * [ Tabs and colored boxes  ](https://fastapi.tiangolo.com/_llm-test/#tabs-and-colored-boxes)
  * [ Web- and internal links  ](https://fastapi.tiangolo.com/_llm-test/#web-and-internal-links)
  * [ HTML "abbr" elements  ](https://fastapi.tiangolo.com/_llm-test/#html-abbr-elements)
    * [ The abbr gives a full phrase  ](https://fastapi.tiangolo.com/_llm-test/#the-abbr-gives-a-full-phrase)
    * [ The abbr gives a full phrase and an explanation  ](https://fastapi.tiangolo.com/_llm-test/#the-abbr-gives-a-full-phrase-and-an-explanation)
  * [ HTML "dfn" elements  ](https://fastapi.tiangolo.com/_llm-test/#html-dfn-elements)
  * [ Headings  ](https://fastapi.tiangolo.com/_llm-test/#headings)
    * [ Develop a webapp - a tutorial  ](https://fastapi.tiangolo.com/_llm-test/#develop-a-webapp-a-tutorial)
    * [ Type hints and -annotations  ](https://fastapi.tiangolo.com/_llm-test/#type-hints-and-annotations)
    * [ Super- and subclasses  ](https://fastapi.tiangolo.com/_llm-test/#super-and-subclasses)
  * [ Terms used in the docs  ](https://fastapi.tiangolo.com/_llm-test/#terms-used-in-the-docs)


# LLM test file[¶](https://fastapi.tiangolo.com/_llm-test/#llm-test-file)
...
Use as follows:
  ...
  * Retranslate, having the good translation in place. The ideal result would be that the LLM makes no changes anymore to the translation. That means that the general prompt and your language specific prompt are as good as they can be (It will sometimes make a few seemingly random changes, the reason is that


The tests:
## Code snippets[¶](https://fastapi.tiangolo.com/_llm-test/#code-snippets)
[Test](https://fastapi.tiangolo.com/_llm-test/#__tabbed_1_1)[Info](https://fastapi.tiangolo.com/_llm-test/#__tabbed_1_2)
...
## Quotes[¶](https://fastapi.tiangolo.com/_llm-test/#quotes)
[Test](https://fastapi.tiangolo.com/_llm-test/#__tabbed_2_1)[Info](https://fastapi.tiangolo.com/_llm-test/#__tabbed_2_2)
...
## Quotes in code snippets[¶](https://fastapi.tiangolo.com/_llm-test/#quotes-in-code-snippets)
[Test](https://fastapi.tiangolo.com/_llm-test/#__tabbed_3_1)[Info](https://fastapi.tiangolo.com/_llm-test/#__tabbed_3_2)
`pip install "foo[bar]"`
...
## code blocks[¶](https://fastapi.tiangolo.com/_llm-test/#code-blocks)
[Test](https://fastapi.tiangolo.com/_llm-test/#__tabbed_4_1)[Info](https://fastapi.tiangolo.com/_llm-test/#__tabbed_4_2)
A Bash code example...
```
...
## Tabs and colored boxes[¶](https://fastapi.tiangolo.com/_llm-test/#tabs-and-colored-boxes)
[Test](https://fastapi.tiangolo.com/_llm-test/#__tabbed_5_1)[Info](https://fastapi.tiangolo.com/_llm-test/#__tabbed_5_2)
Info
Some text
Note
Some text
...
## Web- and internal links[¶](https://fastapi.tiangolo.com/_llm-test/#web-and-internal-links)
[Test](https://fastapi.tiangolo.com/_llm-test/#__tabbed_6_1)[Info](https://fastapi.tiangolo.com/_llm-test/#__tabbed_6_2)
The link text should get translated, the link address should remain unchanged:
  * [Link to heading above](https://fastapi.tiangolo.com/_llm-test/#code-snippets)
  * [Internal link](https://fastapi.tiangolo.com/#installation)
...
## HTML "abbr" elements[¶](https://fastapi.tiangolo.com/_llm-test/#html-abbr-elements)
[Test](https://fastapi.tiangolo.com/_llm-test/#__tabbed_7_1)[Info](https://fastapi.tiangolo.com/_llm-test/#__tabbed_7_2)
...
## Headings[¶](https://fastapi.tiangolo.com/_llm-test/#headings)
[Test](https://fastapi.tiangolo.com/_llm-test/#__tabbed_8_1)[Info](https://fastapi.tiangolo.com/_llm-test/#__tabbed_8_2)
### Develop a webapp - a tutorial[¶](https://fastapi.tiangolo.com/_llm-test/#develop-a-webapp-a-tutorial)
Hello.
### Type hints and -annotations[¶](https://fastapi.tiangolo.com/_llm-test/#type-hints-and-annotations)
Hello again.
...
## Terms used in the docs[¶](https://fastapi.tiangolo.com/_llm-test/#terms-used-in-the-docs)
[Test](https://fastapi.tiangolo.com/_llm-test/#__tabbed_9_1)[Info](https://fastapi.tiangolo.com/_llm-test/#__tabbed_9_2)
  * you
  * your
  * e.g.
  * etc.
