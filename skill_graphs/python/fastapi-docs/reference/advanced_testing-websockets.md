...
# Testing WebSockets[¶](https://fastapi.tiangolo.com/advanced/testing-websockets/#testing-websockets)
You can use the same `TestClient` to test WebSockets.
For this, you use the `TestClient` in a `with` statement, connecting to the WebSocket:
[Python 3.10+](https://fastapi.tiangolo.com/advanced/testing-websockets/#__tabbed_1_1)
```
