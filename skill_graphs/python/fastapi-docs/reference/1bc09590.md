...
[ ](https://fastapi.tiangolo.com/reference/fastapi/?q= "Share")
Initializing search
...
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Reference  ](https://fastapi.tiangolo.com/reference/)
    * `FastAPI` class  [ `FastAPI` class  ](https://fastapi.tiangolo.com/reference/fastapi/)
      * [ ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI)
        ...
        * [ ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.openapi_version)
        * [ ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.webhooks)
        * [ ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.state)
        * [ ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.dependency_overrides)
        * [ ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.openapi)
        * [ ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.websocket)
        * [ ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.include_router)
          * [ Example  ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.include_router--example)
        * [ ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.get)
          * [ Example  ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.get--example)
        * [ ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.put)
          * [ Example  ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.put--example)
        * [ ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.post)
          * [ Example  ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.post--example)
        * [ ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.delete)
          * [ Example  ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.delete--example)
        * [ ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.options)
          * [ Example  ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.options--example)
        * [ ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.head)
          * [ Example  ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.head--example)
        * [ ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.patch)
          * [ Example  ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.patch--example)
        * [ ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.trace)
          * [ Example  ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.trace--example)
        * [ ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.on_event)
        * [ ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.middleware)
          * [ Example  ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.middleware--example)
        * [ ](https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI.exception_handler)
