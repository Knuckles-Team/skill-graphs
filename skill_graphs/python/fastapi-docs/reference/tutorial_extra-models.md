[ Skip to content ](https://fastapi.tiangolo.com/tutorial/extra-models/#extra-models)
[ ![logo](https://fastapi.tiangolo.com/img/icon-white.svg) ](https://fastapi.tiangolo.com/ "FastAPI") FastAPI
  ...
  * [ Learn  ](https://fastapi.tiangolo.com/learn/)
    ...
    * [ Tutorial - User Guide  ](https://fastapi.tiangolo.com/tutorial/)
      ...
      * Extra Models  [ Extra Models  ](https://fastapi.tiangolo.com/tutorial/extra-models/)
        * [ Multiple models  ](https://fastapi.tiangolo.com/tutorial/extra-models/#multiple-models)
          * [ About `**user_in.model_dump()` ](https://fastapi.tiangolo.com/tutorial/extra-models/#about-user-in-model-dump)
            * [ Pydantic's `.model_dump()` ](https://fastapi.tiangolo.com/tutorial/extra-models/#pydantics-model-dump)
        ...
        * [ `Union` or `anyOf` ](https://fastapi.tiangolo.com/tutorial/extra-models/#union-or-anyof)
          * [ `Union` in Python 3.10  ](https://fastapi.tiangolo.com/tutorial/extra-models/#union-in-python-3-10)
...
# Extra Models[¶](https://fastapi.tiangolo.com/tutorial/extra-models/#extra-models)
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/extra-models/#__tabbed_2_1)
```
from fastapi import FastAPI
from pydantic import BaseModel, EmailStr
...
Note
When defining a `PlaneItem` comes before `CarItem` in `Union[PlaneItem, CarItem]`.
...
[Python 3.10+](https://fastapi.tiangolo.com/tutorial/extra-models/#__tabbed_4_1)
```
from fastapi import FastAPI
from pydantic import BaseModel
