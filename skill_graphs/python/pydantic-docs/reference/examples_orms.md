[ Skip to content ](https://docs.pydantic.dev/latest/examples/orms/#sqlalchemy)
...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * Examples
    ...
    * Databases  [ Databases  ](https://docs.pydantic.dev/latest/examples/orms/)
      * [ SQLAlchemy  ](https://docs.pydantic.dev/latest/examples/orms/#sqlalchemy)
...
Code Duplication
If you use Pydantic with SQLAlchemy, you might experience some frustration with code duplication. If you find yourself experiencing this difficulty, you might also consider
