[ Skip to content ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_semantic_version/#pydantic_extra_types.semantic_version)
...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * API Documentation
    ...
    * Pydantic Extra Types
      ...
      * Semantic Version  [ Semantic Version  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_semantic_version/)
        * [ semantic_version  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_semantic_version/#pydantic_extra_types.semantic_version)
        * [ SemanticVersion  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_semantic_version/#pydantic_extra_types.semantic_version.SemanticVersion)
