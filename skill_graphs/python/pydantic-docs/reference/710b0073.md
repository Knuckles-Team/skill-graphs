...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * API Documentation
    * Pydantic
      ...
      * Configuration  [ Configuration  ](https://docs.pydantic.dev/latest/api/config/)
        * [ config  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config)
        * [ ConfigDict  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict)
          ...
          * [ str_to_lower  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.str_to_lower)
          * [ str_to_upper  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.str_to_upper)
          * [ str_strip_whitespace  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.str_strip_whitespace)
          * [ str_min_length  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.str_min_length)
          * [ str_max_length  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.str_max_length)
          * [ extra  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.extra)
          * [ frozen  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.frozen)
          * [ populate_by_name  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.populate_by_name)
          * [ use_enum_values  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.use_enum_values)
          * [ validate_assignment  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.validate_assignment)
          * [ arbitrary_types_allowed  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.arbitrary_types_allowed)
          * [ from_attributes  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.from_attributes)
          * [ loc_by_alias  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.loc_by_alias)
          * [ alias_generator  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.alias_generator)
          * [ ignored_types  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.ignored_types)
          * [ allow_inf_nan  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.allow_inf_nan)
          * [ json_schema_extra  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.json_schema_extra)
          * [ json_encoders  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.json_encoders)
          * [ strict  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.strict)
          * [ revalidate_instances  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.revalidate_instances)
          * [ ser_json_timedelta  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.ser_json_timedelta)
          * [ ser_json_temporal  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.ser_json_temporal)
          * [ val_temporal_unit  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.val_temporal_unit)
          * [ ser_json_bytes  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.ser_json_bytes)
          * [ val_json_bytes  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.val_json_bytes)
          * [ ser_json_inf_nan  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.ser_json_inf_nan)
          * [ validate_default  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.validate_default)
          * [ validate_return  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.validate_return)
          * [ protected_namespaces  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.protected_namespaces)
          * [ hide_input_in_errors  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.hide_input_in_errors)
          * [ defer_build  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.defer_build)
          * [ plugin_settings  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.plugin_settings)
          * [ schema_generator  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.schema_generator)
          * [ json_schema_serialization_defaults_required  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.json_schema_serialization_defaults_required)
          * [ json_schema_mode_override  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.json_schema_mode_override)
          * [ coerce_numbers_to_str  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.coerce_numbers_to_str)
          * [ regex_engine  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.regex_engine)
          * [ validation_error_cause  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.validation_error_cause)
          * [ use_attribute_docstrings  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.use_attribute_docstrings)
          * [ cache_strings  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.cache_strings)
          * [ validate_by_alias  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.validate_by_alias)
          * [ validate_by_name  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.validate_by_name)
          * [ serialize_by_alias  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.serialize_by_alias)
          * [ url_preserve_empty_path  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.url_preserve_empty_path)
        * [ with_config  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.with_config)
        * [ ExtraValues  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ExtraValues)
        * [ alias_generators  ](https://docs.pydantic.dev/latest/api/config/#pydantic.alias_generators)
  ...
  * [ ConfigDict  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict)
    ...
    * [ plugin_settings  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.plugin_settings)
    * [ schema_generator  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.schema_generator)
    * [ json_schema_serialization_defaults_required  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.json_schema_serialization_defaults_required "json_schema_serialization_defaults_required")
    * [ json_schema_mode_override  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.json_schema_mode_override)
    * [ coerce_numbers_to_str  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.coerce_numbers_to_str)
    * [ regex_engine  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.regex_engine)
    * [ validation_error_cause  ](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict.validation_error_cause)
