[ Skip to content ](https://docs.pydantic.dev/latest/examples/queues/#redis-queue)
...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * Examples
    ...
    * Queues  [ Queues  ](https://docs.pydantic.dev/latest/examples/queues/)
      * [ Redis queue  ](https://docs.pydantic.dev/latest/examples/queues/#redis-queue)
      * [ RabbitMQ  ](https://docs.pydantic.dev/latest/examples/queues/#rabbitmq)
      * [ ARQ  ](https://docs.pydantic.dev/latest/examples/queues/#arq)
...
In order to run this example locally, you'll first need to
...
In order to run this example locally, you’ll need to
