[ Skip to content ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country)
...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * API Documentation
    ...
    * Pydantic Extra Types
      ...
      * Country  [ Country  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/)
        * [ country  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country)
        * [ CountryAlpha2  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryAlpha2)
          * [ alpha3  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryAlpha2.alpha3)
          * [ numeric_code  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryAlpha2.numeric_code)
          * [ short_name  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryAlpha2.short_name)
        * [ CountryAlpha3  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryAlpha3)
          * [ alpha2  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryAlpha3.alpha2)
          * [ numeric_code  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryAlpha3.numeric_code)
          * [ short_name  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryAlpha3.short_name)
        * [ CountryNumericCode  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryNumericCode)
          * [ alpha2  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryNumericCode.alpha2)
          * [ alpha3  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryNumericCode.alpha3)
          * [ short_name  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryNumericCode.short_name)
        * [ CountryShortName  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryShortName)
          * [ alpha2  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryShortName.alpha2)
          * [ alpha3  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryShortName.alpha3)
          * [ numeric_code  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryShortName.numeric_code)
...
###  alpha3 `property` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryAlpha2.alpha3)
```
alpha3:
...
###  numeric_code `property` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryAlpha2.numeric_code)
```
numeric_code:
...
The country code in the
###  short_name `property` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryAlpha2.short_name)
```
short_name:
...
###  alpha2 `property` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryAlpha3.alpha2)
```
alpha2:
...
The country code in the
###  numeric_code `property` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryAlpha3.numeric_code)
```
numeric_code:
...
The country code in the
###  short_name `property` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryAlpha3.short_name)
```
short_name:
...
###  alpha2 `property` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryNumericCode.alpha2)
```
alpha2:
...
The country code in the
###  alpha3 `property` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryNumericCode.alpha3)
```
alpha3:
...
The country code in the
###  short_name `property` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryNumericCode.short_name)
```
short_name:
...
###  alpha2 `property` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryShortName.alpha2)
```
alpha2:
...
The country code in the
###  alpha3 `property` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryShortName.alpha3)
```
alpha3:
...
The country code in the
###  numeric_code `property` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_country/#pydantic_extra_types.country.CountryShortName.numeric_code)
```
numeric_code:
