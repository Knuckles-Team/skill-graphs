...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * API Documentation
    * Pydantic
      ...
      * TypeAdapter  [ TypeAdapter  ](https://docs.pydantic.dev/latest/api/type_adapter/)
        ...
        * [ json_schemas  ](https://docs.pydantic.dev/latest/api/type_adapter/#pydantic.type_adapter.TypeAdapter.json_schemas)
