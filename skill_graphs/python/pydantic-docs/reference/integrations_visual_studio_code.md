[ Skip to content ](https://docs.pydantic.dev/latest/integrations/visual_studio_code/#configure-vs-code)
What's new — we've launched [Pydantic Logfire](https://pydantic.dev/articles/logfire-announcement) ![🔥](https://cdn.jsdelivr.net/gh/jdecked/twemoji@15.0.3/assets/svg/1f525.svg) to help you monitor and understand your [Pydantic validati](https://logfire.pydantic.dev/docs/integrations/pydantic/)
...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * Integrations
    ...
    * Dev Tools
      ...
      * Visual Studio Code  [ Visual Studio Code  ](https://docs.pydantic.dev/latest/integrations/visual_studio_code/)
        * [ Configure VS Code  ](https://docs.pydantic.dev/latest/integrations/visual_studio_code/#configure-vs-code)
          * [ Install Pylance  ](https://docs.pydantic.dev/latest/integrations/visual_studio_code/#install-pylance)
          * [ Configure your environment  ](https://docs.pydantic.dev/latest/integrations/visual_studio_code/#configure-your-environment)
          * [ Configure Pylance  ](https://docs.pydantic.dev/latest/integrations/visual_studio_code/#configure-pylance)
          * [ Configure mypy  ](https://docs.pydantic.dev/latest/integrations/visual_studio_code/#configure-mypy)
        * [ Tips and tricks  ](https://docs.pydantic.dev/latest/integrations/visual_studio_code/#tips-and-tricks)
          * [ Strict errors  ](https://docs.pydantic.dev/latest/integrations/visual_studio_code/#strict-errors)
            * [ Disable type checks in a line  ](https://docs.pydantic.dev/latest/integrations/visual_studio_code/#disable-type-checks-in-a-line)
            * [ Override the type of a variable  ](https://docs.pydantic.dev/latest/integrations/visual_studio_code/#override-the-type-of-a-variable)
            * [ Override the type of a value with cast  ](https://docs.pydantic.dev/latest/integrations/visual_studio_code/#override-the-type-of-a-value-with-cast)
          * [ Config in class arguments  ](https://docs.pydantic.dev/latest/integrations/visual_studio_code/#config-in-class-arguments)
        * [ Adding a default with Field  ](https://docs.pydantic.dev/latest/integrations/visual_studio_code/#adding-a-default-with-field)
        * [ Technical Details  ](https://docs.pydantic.dev/latest/integrations/visual_studio_code/#technical-details)
...
When using **additional editor features** supported, comparable to the ones provided by the [PyCharm plugin](https://docs.pydantic.dev/latest/integrations/pycharm/).
...
### Install Pylance[¶](https://docs.pydantic.dev/latest/integrations/visual_studio_code/#install-pylance)
You should use the
Pylance is installed as part of the
### Configure your environment[¶](https://docs.pydantic.dev/latest/integrations/visual_studio_code/#configure-your-environment)
Then you need to make sure your editor knows the
...
Technical Details
Pylance is the VS Code extension, it's closed source, but free to use. Underneath, Pylance uses an open source tool (also from Microsoft) called
...
This would include the errors detected by the [Pydantic mypy plugin](https://docs.pydantic.dev/latest/integrations/mypy/), if you configured it.
...
### Config in class arguments[¶](https://docs.pydantic.dev/latest/integrations/visual_studio_code/#config-in-class-arguments)
Pydantic has a rich set of [Model Configurations](https://docs.pydantic.dev/latest/api/config/#pydantic.config.ConfigDict) available.
...
This additional editor support works by making use of the
The standard provides a way for libraries like Pydantic and others to tell editors and tools that they (the editors) should treat these libraries (e.g. Pydantic) as if they were
