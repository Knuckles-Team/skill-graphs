...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * Concepts
    ...
    * Validation Decorator  [ Validation Decorator  ](https://docs.pydantic.dev/latest/concepts/validation_decorator/)
      ...
      * [ Using the Field() function to describe function parameters  ](https://docs.pydantic.dev/latest/concepts/validation_decorator/#using-the-field-function-to-describe-function-parameters)
...
@validate_call
def greater_than(d1: date, d2: date, *, include_equal=False) -> date:  [](https://docs.pydantic.dev/latest/concepts/validation_decorator/#__code_1_annotation_1)
    if include_equal:
        return d1 >= d2
    else:
        return d1 > d2
