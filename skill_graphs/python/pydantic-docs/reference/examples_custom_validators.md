[ Skip to content ](https://docs.pydantic.dev/latest/examples/custom_validators/#custom-datetime-validator-via-annotated-metadata)
...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * Examples
    ...
    * Custom Validators  [ Custom Validators  ](https://docs.pydantic.dev/latest/examples/custom_validators/)
      * [ Custom datetime Validator via Annotated Metadata  ](https://docs.pydantic.dev/latest/examples/custom_validators/#custom-datetime-validator-via-annotated-metadata)
      * [ Validating Nested Model Fields  ](https://docs.pydantic.dev/latest/examples/custom_validators/#validating-nested-model-fields)
...
## Custom `datetime` Validator via [¶](https://docs.pydantic.dev/latest/examples/custom_validators/#custom-datetime-validator-via-annotated-metadata)
In this example, we'll construct a custom validator, attached to an
The custom validator supports string specification of the timezone, and will raise an error if the
We use `__get_pydantic_core_schema__` in the validator to customize the schema of the annotated type (in this case, `wrap` validator function so that we can perform operations both before and after the default `pydantic` validation of a
[Python 3.9 and above](https://docs.pydantic.dev/latest/examples/custom_validators/#__tabbed_1_1)[Python 3.10 and above](https://docs.pydantic.dev/latest/examples/custom_validators/#__tabbed_1_2)
```
...
class MyDatetimeValidator:
    ...
    def tz_constraint_validator(
        self,
        value: dt.datetime,
        handler: Callable,  [](https://docs.pydantic.dev/latest/examples/custom_validators/#__code_0_annotation_1)
    ):
        ...
        result = handler(value)  [](https://docs.pydantic.dev/latest/examples/custom_validators/#__code_0_annotation_2)
...
[](https://docs.pydantic.dev/latest/examples/custom_validators/#__code_1_annotation_1)
    ):
        """Validate tz_constraint and tz_info."""
        # handle naive datetimes
        if self.tz_constraint is None:
...
[](https://docs.pydantic.dev/latest/examples/custom_validators/#__code_1_annotation_2)
        assert self.tz_constraint == str(
            result.tzinfo
        ), f'Invalid tzinfo: {str(result.tzinfo)}, expected: {self.tz_constraint}'
...
[Python 3.9 and above](https://docs.pydantic.dev/latest/examples/custom_validators/#__tabbed_2_1)[Python 3.10 and above](https://docs.pydantic.dev/latest/examples/custom_validators/#__tabbed_2_2)
```
import datetime as dt
from dataclasses import dataclass
from pprint import pprint
...
[Python 3.9 and above](https://docs.pydantic.dev/latest/examples/custom_validators/#__tabbed_3_1)[Python 3.11 and above](https://docs.pydantic.dev/latest/examples/custom_validators/#__tabbed_3_2)
```
...
More details about validation context can be found in the [validators documentation](https://docs.pydantic.dev/latest/concepts/validators/#validation-context).
