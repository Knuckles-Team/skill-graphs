...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * API Documentation
    * Pydantic
      ...
      * RootModel  [ RootModel  ](https://docs.pydantic.dev/latest/api/root_model/)
        * [ root_model  ](https://docs.pydantic.dev/latest/api/root_model/#pydantic.root_model)
        * [ RootModel  ](https://docs.pydantic.dev/latest/api/root_model/#pydantic.root_model.RootModel)
          * [ model_construct  ](https://docs.pydantic.dev/latest/api/root_model/#pydantic.root_model.RootModel.model_construct)
