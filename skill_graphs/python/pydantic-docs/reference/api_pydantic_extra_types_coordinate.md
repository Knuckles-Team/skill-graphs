[ Skip to content ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_coordinate/#pydantic_extra_types.coordinate)
...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * API Documentation
    ...
    * Pydantic Extra Types
      ...
      * Coordinate  [ Coordinate  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_coordinate/)
        * [ coordinate  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_coordinate/#pydantic_extra_types.coordinate)
        * [ Latitude  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_coordinate/#pydantic_extra_types.coordinate.Latitude)
        * [ Longitude  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_coordinate/#pydantic_extra_types.coordinate.Longitude)
        * [ Coordinate  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_coordinate/#pydantic_extra_types.coordinate.Coordinate)
...
# Coordinate
The `pydantic_extra_types.coordinate` module provides the [`Latitude`](https://docs.pydantic.dev/latest/api/pydantic_extra_types_coordinate/#pydantic_extra_types.coordinate.Latitude), [`Longitude`](https://docs.pydantic.dev/latest/api/pydantic_extra_types_coordinate/#pydantic_extra_types.coordinate.Longitude), and [`Coordinate`](https://docs.pydantic.dev/latest/api/pydantic_extra_types_coordinate/#pydantic_extra_types.coordinate.Coordinate) data types.
##  Latitude [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_coordinate/#pydantic_extra_types.coordinate.Latitude)
Bases:
...
##  Coordinate `dataclass` [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_coordinate/#pydantic_extra_types.coordinate.Coordinate)
```
Coordinate(latitude: Latitude[](https://docs.pydantic.dev/latest/api/pydantic_extra_types_coordinate/#pydantic_extra_types.coordinate.Latitude), longitude: Longitude[](https://docs.pydantic.dev/latest/api/pydantic_extra_types_coordinate/#pydantic_extra_types.coordinate.Longitude))
