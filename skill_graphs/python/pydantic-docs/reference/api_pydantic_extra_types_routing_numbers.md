[ Skip to content ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_routing_numbers/#pydantic_extra_types.routing_number)
...
[ ![logo](https://docs.pydantic.dev/latest/logo-white.svg) ](https://docs.pydantic.dev/latest/ "Pydantic Validation") Pydantic Validation
  ...
  * API Documentation
    ...
    * Pydantic Extra Types
      ...
      * Routing Numbers  [ Routing Numbers  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_routing_numbers/)
        * [ routing_number  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_routing_numbers/#pydantic_extra_types.routing_number)
        * [ ABARoutingNumber  ](https://docs.pydantic.dev/latest/api/pydantic_extra_types_routing_numbers/#pydantic_extra_types.routing_number.ABARoutingNumber)
...
# Routing Numbers
The `pydantic_extra_types.routing_number` module provides the [`ABARoutingNumber`](https://docs.pydantic.dev/latest/api/pydantic_extra_types_routing_numbers/#pydantic_extra_types.routing_number.ABARoutingNumber) data type.
##  ABARoutingNumber [¶](https://docs.pydantic.dev/latest/api/pydantic_extra_types_routing_numbers/#pydantic_extra_types.routing_number.ABARoutingNumber)
```
