...
Warning
We are temporarily removing the Hypothesis plugin in favor of studying a different mechanism. For more information, see the issue
The Hypothesis plugin may be back in a future release. Subscribe to
