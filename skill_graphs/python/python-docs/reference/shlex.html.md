...
#### Previous topic
[Unix-specific services](https://docs.python.org/3/library/unix.html "previous chapter")
#### Next topic
[`posix` — The most common POSIX system calls](https://docs.python.org/3/library/posix.html "next chapter")
### This page
  * [Report a bug](https://docs.python.org/3/bugs.html)
  * [Improve this page](https://docs.python.org/3/improve-page.html?pagetitle=shlex+%E2%80%94+Simple+lexical+analysis&pageurl=https%3A%2F%2Fdocs.python.org%2F3%2Flibrary%2Fshlex.html&pagesource=library%2Fshlex.rst)


### Navigation
  * [index](https://docs.python.org/3/genindex.html "General Index")
  * [modules](https://docs.python.org/3/py-modindex.html "Python Module Index") |
  * [next](https://docs.python.org/3/library/posix.html "posix — The most common POSIX system calls") |
  * [previous](https://docs.python.org/3/library/unix.html "Unix-specific services") |
...
#  `shlex` — Simple lexical analysis[¶](https://docs.python.org/3/library/shlex.html#module-shlex "Link to this heading")
**Source code:**
* * *
The [`shlex`](https://docs.python.org/3/library/shlex.html#shlex.shlex "shlex.shlex") class makes it easy to write lexical analyzers for simple syntaxes resembling that of the Unix shell. This will often be useful for writing minilanguages, (for example, in run control files for Python applications) or for parsing quoted strings.
The `shlex` module defines the following functions:

shlex.split(_s_ , _comments =False_, _posix =True_)[¶](https://docs.python.org/3/library/shlex.html#shlex.split "Link to this definition")

Split the string _s_ using shell-like syntax. If _comments_ is [`False`](https://docs.python.org/3/library/constants.html#False "False") (the default), the parsing of comments in the given string will be disabled (setting the [`commenters`](https://docs.python.org/3/library/shlex.html#shlex.shlex.commenters "shlex.shlex.commenters") attribute of the [`shlex`](https://docs.python.org/3/library/shlex.html#shlex.shlex "shlex.shlex") instance to the empty string). This function operates in POSIX mode by default, but uses non-POSIX mode if the _posix_ argument is false.
Changed in version 3.12: Passing `None` for _s_ argument now raises an exception, rather than reading [`sys.stdin`](https://docs.python.org/3/library/sys.html#sys.stdin "sys.stdin").

shlex.join(_split_command_)[¶](https://docs.python.org/3/library/shlex.html#shlex.join "Link to this definition")

Concatenate the tokens of the list _split_command_ and return a string. This function is the inverse of [`split()`](https://docs.python.org/3/library/shlex.html#shlex.split "shlex.split").
Copy```
...
shlex.quote(_s_)[¶](https://docs.python.org/3/library/shlex.html#shlex.quote "Link to this definition")
...
shlex.whitespace[¶](https://docs.python.org/3/library/shlex.html#shlex.shlex.whitespace "Link to this definition")
...
shlex.escape[¶](https://docs.python.org/3/library/shlex.html#shlex.shlex.escape "Link to this definition")

Characters that will be considered as escape. This will be only used in POSIX mode, and includes just `'\'` by default.

shlex.quotes[¶](https://docs.python.org/3/library/shlex.html#shlex.shlex.quotes "Link to this definition")
...
shlex.escapedquotes[¶](https://docs.python.org/3/library/shlex.html#shlex.shlex.escapedquotes "Link to this definition")

Characters in [`quotes`](https://docs.python.org/3/library/shlex.html#shlex.shlex.quotes "shlex.shlex.quotes") that will interpret escape characters defined in [`escape`](https://docs.python.org/3/library/shlex.html#shlex.shlex.escape "shlex.shlex.escape"). This is only used in POSIX mode, and includes just `'"'` by default.

shlex.whitespace_split[¶](https://docs.python.org/3/library/shlex.html#shlex.shlex.whitespace_split "Link to this definition")

If `True`, tokens will only be split in whitespaces. This is useful, for example, for parsing command lines with [`shlex`](https://docs.python.org/3/library/shlex.html#shlex.shlex "shlex.shlex"), getting tokens in a similar way to shell arguments. When used in combination with [`punctuation_chars`](https://docs.python.org/3/library/shlex.html#shlex.shlex.punctuation_chars "shlex.shlex.punctuation_chars"), tokens will be split on whitespace in addition to those characters.
Changed in version 3.8: The [`punctuation_chars`](https://docs.python.org/3/library/shlex.html#shlex.shlex.punctuation_chars "shlex.shlex.punctuation_chars") attribute was made compatible with the [`whitespace_split`](https://docs.python.org/3/library/shlex.html#shlex.shlex.whitespace_split "shlex.shlex.whitespace_split") attribute.

shlex.infile[¶](https://docs.python.org/3/library/shlex.html#shlex.shlex.infile "Link to this definition")
...
shlex.instream[¶](https://docs.python.org/3/library/shlex.html#shlex.shlex.instream "Link to this definition")

The input stream from which this [`shlex`](https://docs.python.org/3/library/shlex.html#shlex.shlex "shlex.shlex") instance is reading characters.

shlex.source[¶](https://docs.python.org/3/library/shlex.html#shlex.shlex.source "Link to this definition")

This attribute is `None` by default. If you assign a string to it, that string will be recognized as a lexical-level inclusion request similar to the `source` keyword in various shells. That is, the immediately following token will be opened as a filename and input will be taken from that stream until EOF, at which point the [`close()`](https://docs.python.org/3/library/io.html#io.IOBase.close "io.IOBase.close") method of that stream will be called and the input source will again become the original input stream. Source requests may be stacked any number of levels deep.

shlex.debug[¶](https://docs.python.org/3/library/shlex.html#shlex.shlex.debug "Link to this definition")

If this attribute is numeric and `1` or more, a [`shlex`](https://docs.python.org/3/library/shlex.html#shlex.shlex "shlex.shlex") instance will print verbose progress output on its behavior. If you need to use this, you can read the module source code to learn the details.

shlex.lineno[¶](https://docs.python.org/3/library/shlex.html#shlex.shlex.lineno "Link to this definition")

Source line number (count of newlines seen so far plus one).

shlex.token[¶](https://docs.python.org/3/library/shlex.html#shlex.shlex.token "Link to this definition")

The token buffer. It may be useful to examine this when catching exceptions.

shlex.eof[¶](https://docs.python.org/3/library/shlex.html#shlex.shlex.eof "Link to this definition")
...
When operating in non-POSIX mode, [`shlex`](https://docs.python.org/3/library/shlex.html#shlex.shlex "shlex.shlex") will try to obey the following rules.
...
When operating in POSIX mode, [`shlex`](https://docs.python.org/3/library/shlex.html#shlex.shlex "shlex.shlex") will try to obey the following parsing rules.
...
Note
When `punctuation_chars` is specified, the [`wordchars`](https://docs.python.org/3/library/shlex.html#shlex.shlex.wordchars "shlex.shlex.wordchars") attribute is augmented with the characters `~-./*?=`. That is because these characters can appear in file names (including wildcards) and command-line arguments (e.g. `--color=auto`). Hence:
Copy```
>>> import shlex
...
However, to match the shell as closely as possible, it is recommended to always use `posix` and [`whitespace_split`](https://docs.python.org/3/library/shlex.html#shlex.shlex.whitespace_split "shlex.shlex.whitespace_split") when using [`punctuation_chars`](https://docs.python.org/3/library/shlex.html#shlex.shlex.punctuation_chars "shlex.shlex.punctuation_chars"), which will negate [`wordchars`](https://docs.python.org/3/library/shlex.html#shlex.shlex.wordchars "shlex.shlex.wordchars") entirely.
For best effect, `punctuation_chars` should be set in conjunction with `posix=True`. (Note that `posix=False` is the default for [`shlex`](https://docs.python.org/3/library/shlex.html#shlex.shlex "shlex.shlex").)
### [Table of Contents](https://docs.python.org/3/contents.html)
  * [`shlex` — Simple lexical analysis](https://docs.python.org/3/library/shlex.html)
    * [shlex Objects](https://docs.python.org/3/library/shlex.html#shlex-objects)
    * [Parsing Rules](https://docs.python.org/3/library/shlex.html#parsing-rules)
