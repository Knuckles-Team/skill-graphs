# IDLE — Python editor and shell[¶](https://docs.python.org/3/library/idle.html#idle "Link to this heading")
**Source code:**
* * *
...
The IDLE application is implemented in the [`idlelib`](https://docs.python.org/3/library/idle.html#module-idlelib "idlelib: Implementation package for the IDLE shell/editor.") package.
...
## Menus[¶](https://docs.python.org/3/library/idle.html#menus "Link to this heading")
...
### File menu (Shell and Editor)[¶](https://docs.python.org/3/library/idle.html#file-menu-shell-and-editor "Link to this heading")
...
### Edit menu (Shell and Editor)[¶](https://docs.python.org/3/library/idle.html#edit-menu-shell-and-editor "Link to this heading")
...
Rewrap the text block containing the text insert cursor. Avoid code lines. See [Format block](https://docs.python.org/3/library/idle.html#format-block) in the Editing and Navigation section below.
...
Remove trailing space and other whitespace characters after the last non-whitespace character of a line by applying [`str.rstrip()`](https://docs.python.org/3/library/stdtypes.html#str.rstrip "str.rstrip") to each line, including lines within multiline strings. Except for Shell windows, remove extra newlines at the end of the file.
...
## Editing and Navigation[¶](https://docs.python.org/3/library/idle.html#editing-and-navigation "Link to this heading")
### Editor windows[¶](https://docs.python.org/3/library/idle.html#editor-windows "Link to this heading")
...
### Key bindings[¶](https://docs.python.org/3/library/idle.html#key-bindings "Link to this heading")
...
### Format block[¶](https://docs.python.org/3/library/idle.html#format-block "Link to this heading")
...
### Text colors[¶](https://docs.python.org/3/library/idle.html#text-colors "Link to this heading")
...
## Startup and Code Execution[¶](https://docs.python.org/3/library/idle.html#startup-and-code-execution "Link to this heading")
...
### Command-line usage[¶](https://docs.python.org/3/library/idle.html#command-line-usage "Link to this heading")
...
-c <command>[¶](https://docs.python.org/3/library/idle.html#cmdoption-idle-c "Link to this definition")
...
-d[¶](https://docs.python.org/3/library/idle.html#cmdoption-idle-d "Link to this definition")

Enable the debugger and open the shell window.

-e[¶](https://docs.python.org/3/library/idle.html#cmdoption-idle-e "Link to this definition")

Open an editor window.

-h[¶](https://docs.python.org/3/library/idle.html#cmdoption-idle-h "Link to this definition")

Print a help message with legal combinations of options and exit.

-i[¶](https://docs.python.org/3/library/idle.html#cmdoption-idle-i "Link to this definition")

Open a shell window.

-r <file>[¶](https://docs.python.org/3/library/idle.html#cmdoption-idle-r "Link to this definition")

Run the specified file in the shell window.

-s[¶](https://docs.python.org/3/library/idle.html#cmdoption-idle-s "Link to this definition")

Run the startup file (as defined by the environment variables `IDLESTARTUP` or [`PYTHONSTARTUP`](https://docs.python.org/3/using/cmdline.html#envvar-PYTHONSTARTUP)) before opening the shell window.

-t <title>[¶](https://docs.python.org/3/library/idle.html#cmdoption-idle-t "Link to this definition")

Set the title of the shell window.

-[¶](https://docs.python.org/3/library/idle.html#cmdoption-idle-0 "Link to this definition")

Read and execute standard input in the shell window. This option must be the last one before any arguments.
If arguments are provided:
  * If `-`, `-c`, or `-r` is used, all arguments are placed in `sys.argv[1:]`, and `sys.argv[0]` is set to `''`, `'-c'`, or `'-r'` respectively. No editor window is opened, even if that is the default set in the _Options_ dialog.
...
### Setting preferences[¶](https://docs.python.org/3/library/idle.html#setting-preferences "Link to this heading")
...
### IDLE on macOS[¶](https://docs.python.org/3/library/idle.html#idle-on-macos "Link to this heading")
...
### Extensions[¶](https://docs.python.org/3/library/idle.html#extensions "Link to this heading")
...
## idlelib — implementation of IDLE application[¶](https://docs.python.org/3/library/idle.html#module-idlelib "Link to this heading")
**Source code:**
* * *
...
#### Previous topic
[`tkinter.ttk` — Tk themed widgets](https://docs.python.org/3/library/tkinter.ttk.html "previous chapter")
#### Next topic
[`turtle` — Turtle graphics](https://docs.python.org/3/library/turtle.html "next chapter")
### This page
  * [Report a bug](https://docs.python.org/3/bugs.html)
  * [Improve this page](https://docs.python.org/3/improve-page.html?pagetitle=IDLE+%E2%80%94+Python+editor+and+shell&pageurl=https%3A%2F%2Fdocs.python.org%2F3%2Flibrary%2Fidle.html&pagesource=library%2Fidle.rst)
...
### Navigation
  ...
  * [next](https://docs.python.org/3/library/turtle.html "turtle — Turtle graphics") |
  * [previous](https://docs.python.org/3/library/tkinter.ttk.html "tkinter.ttk — Tk themed widgets") |
...
3.16 dev (3.15) 3.14.3 3.13 3.12 3.11 3.10 3.9 3.8 3.7 3.6 3.5 3.4 3.3 3.2 3.1 3.0 2.7 2.6
  ...
  * [IDLE — Python editor and shell](https://docs.python.org/3/library/idle.html#window-menu-shell-and-editor)
  * |
