...
#### Previous topic
[Graphical user interfaces with Tk](https://docs.python.org/3/library/tk.html "previous chapter")
#### Next topic
[`tkinter.colorchooser` — Color choosing dialog](https://docs.python.org/3/library/tkinter.colorchooser.html "next chapter")
### This page
  * [Report a bug](https://docs.python.org/3/bugs.html)
  * [Improve this page](https://docs.python.org/3/improve-page.html?pagetitle=tkinter+%E2%80%94+Python+interface+to+Tcl%2FTk&pageurl=https%3A%2F%2Fdocs.python.org%2F3%2Flibrary%2Ftkinter.html&pagesource=library%2Ftkinter.rst)


### Navigation
  * [index](https://docs.python.org/3/genindex.html "General Index")
  * [modules](https://docs.python.org/3/py-modindex.html "Python Module Index") |
  * [next](https://docs.python.org/3/library/tkinter.colorchooser.html "tkinter.colorchooser — Color choosing dialog") |
  * [previous](https://docs.python.org/3/library/tk.html "Graphical user interfaces with Tk") |
...
### Tk Option Data Types[¶](https://docs.python.org/3/library/tkinter.html#tk-option-data-types "Link to this heading")
...
### Bindings and Events[¶](https://docs.python.org/3/library/tkinter.html#bindings-and-events "Link to this heading")
...
is a string that denotes the target kind of event. (See the Tcl and the Tk Toolkit (2nd edition), for details).

func

is a Python function, taking one argument, to be invoked when the event occurs. An Event instance will be passed as the argument. (Functions deployed this way are commonly known as _callbacks_.)
...
Widget.tk.deletefilehandler(_file_)[¶](https://docs.python.org/3/library/tkinter.html#tkinter.Widget.tk.deletefilehandler "Link to this definition")

Unregisters a file handler.

_tkinter.READABLE[¶](https://docs.python.org/3/library/tkinter.html#tkinter.READABLE "Link to this definition")


_tkinter.WRITABLE[¶](https://docs.python.org/3/library/tkinter.html#tkinter.WRITABLE "Link to this definition")


_tkinter.EXCEPTION[¶](https://docs.python.org/3/library/tkinter.html#tkinter.EXCEPTION "Link to this definition")
