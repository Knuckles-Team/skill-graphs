...
For a summary of new features and bug fixes in Visual Studio version 16.0, see [What's New in Visual Studio 2019 version 16.0](https://learn.microsoft.com/en-us/visualstudio/releases/2019/release-notes-v16.0).
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2019?view=msvc-170&source=recommendations#c-compiler-1)
### C++ compiler
  * Enhanced support for C++17 features and correctness fixes, plus experimental support for C++20 features such as modules and coroutines. For detailed information, see [C++ Conformance Improvements in Visual Studio 2019](https://learn.microsoft.com/en-us/cpp/overview/cpp-conformance-improvements?view=msvc-170).
  * The [`/std:c++latest`](https://learn.microsoft.com/en-us/cpp/build/reference/std-specify-language-standard-version?view=msvc-170) option now includes C++20 features that aren't necessarily complete, including initial support for the C++20 operator **`<=>`**("spaceship") for three-way comparison.
  * The C++ compiler switch [`/Gm`](https://learn.microsoft.com/en-us/cpp/build/reference/gm-enable-minimal-rebuild?view=msvc-170) is now deprecated. Consider disabling the **`/Gm`**switch in your build scripts if it's explicitly defined. However, you can also safely ignore the deprecation warning for**`/Gm`**, because it's not treated as an error when using "Treat warnings as errors" ([`/WX`](https://learn.microsoft.com/en-us/cpp/build/reference/compiler-option-warning-level?view=msvc-170)).
...
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2019?view=msvc-170&source=recommendations#codegen-security-diagnostics-and-versioning)
#### Codegen, security, diagnostics, and versioning
Improved analysis with [`/Qspectre`](https://learn.microsoft.com/en-us/cpp/build/reference/qspectre?view=msvc-170) for providing mitigation assistance for Spectre Variant 1 ([Spectre Mitigations in MSVC](https://devblogs.microsoft.com/cppblog/spectre-mitigations-in-msvc/).
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2019?view=msvc-170&source=recommendations#c-standard-library-improvements-1)
### C++ standard library improvements
  * Implementation of additional C++17 and C++20 library features and correctness fixes. For detailed information, see [C++ Conformance Improvements in Visual Studio 2019](https://learn.microsoft.com/en-us/cpp/overview/cpp-conformance-improvements?view=msvc-170).
...
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2019?view=msvc-170&source=recommendations#performancethroughput-improvements-in-the-compiler-and-standard-library)
### Performance/throughput improvements in the compiler and standard library
  ...
  * We've added support for Short Vector Math Library (SVML) intrinsic functions. These functions compute the 128-bit, 256-bit, or 512-bit vector equivalents. We added them to support hand vectorization of loops with calls to math library functions, and certain other operations like integer division. See the
...
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2019?view=msvc-170&source=recommendations#c-ide-1)
### C++ IDE
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2019?view=msvc-170&source=recommendations#live-share-c-support)
#### Live Share C++ support
[Live Share](https://learn.microsoft.com/en-us/visualstudio/liveshare/) now supports C++, allowing developers using Visual Studio or Visual Studio Code to collaborate in real time. For more information, see [Announcing Live Share for C++: Real-Time Sharing and Collaboration](https://devblogs.microsoft.com/cppblog/cppliveshare/)
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2019?view=msvc-170&source=recommendations#template-intellisense)
...
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2019?view=msvc-170&source=recommendations#new-start-window-experience)
...
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2019?view=msvc-170&source=recommendations#new-names-for-some-project-templates)
...
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2019?view=msvc-170&source=recommendations#various-productivity-improvements)
...
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2019?view=msvc-170&source=recommendations#cmake-support-1)
### CMake support
...
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2019?view=msvc-170&source=recommendations#incredibuild-integration)
...
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2019?view=msvc-170&source=recommendations#debugging)
### Debugging
...
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2019?view=msvc-170&source=recommendations#windows-desktop-development-with-c)
...
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2019?view=msvc-170&source=recommendations#mobile-development-with-c-android-and-ios)
### Mobile development with C++ (Android and iOS)
The C++ Android experience now defaults to Android SDK 25 and Android NDK 16b.
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2019?view=msvc-170&source=recommendations#clangc2-platform-toolset)
...
[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2019?view=msvc-170&source=recommendations#code-analysis-1)
### Code analysis
  ...
  * An updated partial implementation of the [Lifetime Profile Update in Visual Studio 2019 Preview 2](https://devblogs.microsoft.com/cppblog/lifetime-profile-update-in-visual-studio-2019-preview-2/).
  * More coroutine-related checks, including [C26138](https://learn.microsoft.com/en-us/cpp/code-quality/c26138?view=msvc-170), [C26810](https://learn.microsoft.com/en-us/cpp/code-quality/c26810?view=msvc-170), [C26811](https://learn.microsoft.com/en-us/cpp/code-quality/c26811?view=msvc-170), and the experimental rule [C26800](https://learn.microsoft.com/en-us/cpp/code-quality/c26800?view=msvc-170). For more information, see [New Code Analysis Checks in Visual Studio 2019: use-after-move and coroutine](https://devblogs.microsoft.com/cppblog/new-code-analysis-checks-in-visual-studio-2019-use-after-move-and-coroutine/).


[](https://learn.microsoft.com/en-us/cpp/overview/what-s-new-for-cpp-2019?view=msvc-170&source=recommendations#unit-testing)
### Unit testing
