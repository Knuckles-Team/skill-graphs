...
[ Sign out ](https://learn.microsoft.com/en-us/cpp/overview/visual-cpp-in-visual-studio?view=msvc-170)
...
Version Visual Studio 2022
  * [2026](https://learn.microsoft.com/en-us/cpp/overview/visual-cpp-in-visual-studio?view=msvc-180)
  * [2022](https://learn.microsoft.com/en-us/cpp/overview/visual-cpp-in-visual-studio?view=msvc-170)
  * [2019](https://learn.microsoft.com/en-us/cpp/overview/visual-cpp-in-visual-studio?view=msvc-160)
  * [2017](https://learn.microsoft.com/en-us/cpp/overview/visual-cpp-in-visual-studio?view=msvc-150)
  * [2015](https://learn.microsoft.com/en-us/cpp/overview/visual-cpp-in-visual-studio?view=msvc-140)
...
Table of contents [ Read in English ](https://learn.microsoft.com/en-us/cpp/overview/visual-cpp-in-visual-studio?view=msvc-170) Add to Collections Add to plan
* * *
#### Share via
* * *
Copy Markdown Print
...
##  In this article
  ...
  4. [Visual Studio C/C++ development tools](https://learn.microsoft.com/en-us/cpp/overview/visual-cpp-in-visual-studio?view=msvc-170#visual-studio-cc-development-tools)
  5. [Write C/C++ applications using Visual Studio](https://learn.microsoft.com/en-us/cpp/overview/visual-cpp-in-visual-studio?view=msvc-170#write-cc-applications-using-visual-studio)
  6. [C/C++ language reference](https://learn.microsoft.com/en-us/cpp/overview/visual-cpp-in-visual-studio?view=msvc-170#cc-language-reference)
  7. [C/C++ libraries available in Visual Studio](https://learn.microsoft.com/en-us/cpp/overview/visual-cpp-in-visual-studio?view=msvc-170#cc-libraries-available-in-visual-studio)
  8. [Third-party open source C++ libraries in Visual Studio](https://learn.microsoft.com/en-us/cpp/overview/visual-cpp-in-visual-studio?view=msvc-170#third-party-open-source-c-libraries-in-visual-studio)
  9. [Visual Studio C++ feedback and community](https://learn.microsoft.com/en-us/cpp/overview/visual-cpp-in-visual-studio?view=msvc-170#visual-studio-c-feedback-and-community)
...
If you're looking for a Microsoft Visual C++ Redistributable package so that you can run a program, see the [latest supported Visual C++ downloads](https://learn.microsoft.com/en-us/cpp/windows/latest-supported-vc-redist?view=msvc-170).
