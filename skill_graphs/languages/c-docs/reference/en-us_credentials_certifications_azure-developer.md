[ Skip to main content ](https://learn.microsoft.com/en-us/credentials/certifications/azure-developer/?source=recommendations&practice-assessment-type=certification#main)
...
[ Sign in ](https://learn.microsoft.com/en-us/credentials/certifications/azure-developer/?source=recommendations&practice-assessment-type=certification)
  * [ Profile ](https://learn.microsoft.com/en-us/users/me/activity/)
  * [ Settings ](https://learn.microsoft.com/en-us/users/me/settings/)


[ Sign out ](https://learn.microsoft.com/en-us/credentials/certifications/azure-developer/?source=recommendations&practice-assessment-type=certification)
...
[ Read in English ](https://learn.microsoft.com/en-us/credentials/certifications/azure-developer/?source=recommendations) Add to Collections Add to plan
...
* * *
[View my credential](https://learn.microsoft.com/en-us/credentials/certifications/azure-developer/?source=recommendations&practice-assessment-type=certification)
##  At a glance
  * Level
...
[Azure](https://learn.microsoft.com/en-us/credentials/browse/?products=azure&credential_types=certification)
  * Role
[Developer](https://learn.microsoft.com/en-us/credentials/browse/?roles=developer&credential_types=certification)
  * Subject
[Application development](https://learn.microsoft.com/en-us/credentials/browse/?subjects=app-development&credential_types=certification)
  * Renewal Frequency
12 months
  * Last Updated
01/14/2026
...
## Jump to
[Prepare for the exam](https://learn.microsoft.com/en-us/credentials/certifications/azure-developer/?source=recommendations&practice-assessment-type=certification#certification-prepare-for-the-exam)
[Practice for the exam](https://learn.microsoft.com/en-us/credentials/certifications/azure-developer/?source=recommendations&practice-assessment-type=certification#certification-practice-for-the-exam)
[Take the exam](https://learn.microsoft.com/en-us/credentials/certifications/azure-developer/?source=recommendations&practice-assessment-type=certification#certification-take-the-exam)
[Renew your certification](https://learn.microsoft.com/en-us/credentials/certifications/azure-developer/?source=recommendations&practice-assessment-type=certification#certification-renew-your-certification)
[Certification resources](https://learn.microsoft.com/en-us/credentials/certifications/azure-developer/?source=recommendations&practice-assessment-type=certification#certification-resources)
Show more
## Overview
...
###  Skills earned upon completion
  * [ Implement user authentication and authorization in Azure ](https://learn.microsoft.com/en-us/credentials/certifications/azure-developer/?source=recommendations&practice-assessment-type=certification#list-card-ax-9)
...
Course
[Develop Solutions for Microsoft Azure](https://learn.microsoft.com/en-us/training/courses/az-204t00/)
[ Continue course ](https://learn.microsoft.com/en-us/training/courses/az-204t00/)
Training in this course
    * ![](https://learn.microsoft.com/training/achievements/azure-app-service-create-web-apps.svg)
[Implement Azure App Service web apps](https://learn.microsoft.com/training/paths/create-azure-app-service-web-apps/)
      * Learning Path
      * 4 modules
    * ![](https://learn.microsoft.com/training/achievements/az-204-implement-azure-functions.svg)
[Implement Azure Functions](https://learn.microsoft.com/training/paths/implement-azure-functions/)
      * Learning Path
      * 2 modules
    * ![](https://learn.microsoft.com/training/achievements/develop-solutions-that-use-blob-storage.svg)
[Develop solutions that use Blob storage](https://learn.microsoft.com/training/paths/develop-solutions-that-use-blob-storage/)
      * Learning Path
      * 3 modules
    * ![](https://learn.microsoft.com/training/achievements/az-204-develop-solutions-that-use-azure-cosmos-db.svg)
[Develop solutions that use Azure Cosmos DB](https://learn.microsoft.com/training/paths/az-204-develop-solutions-that-use-azure-cosmos-db/)
      * Learning Path
      * 2 modules
    * ![](https://learn.microsoft.com/training/achievements/iaas-implement-solutions.svg)
[Implement containerized solutions](https://learn.microsoft.com/training/paths/az-204-implement-iaas-solutions/)
      * Learning Path
      * 3 modules
    * ![](https://learn.microsoft.com/training/achievements/authentication-authorization.svg)
...
Implement user authentication and authorization in Azure
    * ![](https://learn.microsoft.com/training/achievements/cloud-solutions-implement.svg)
[Implement secure Azure solutions](https://learn.microsoft.com/training/paths/az-204-implement-secure-cloud-solutions/)
      * Learning Path
      * 3 modules
    * ![](https://learn.microsoft.com/training/achievements/az-204-implement-api-management.svg)
[Implement API Management](https://learn.microsoft.com/training/paths/az-204-implement-api-management/)
      * Learning Path
      * 1 module
    * ![](https://learn.microsoft.com/training/achievements/az-204-develop-event-based-solutions.svg)
[Develop event-based solutions](https://learn.microsoft.com/training/paths/az-204-develop-event-based-solutions/)
      * Learning Path
      * 2 modules
    * ![](https://learn.microsoft.com/training/achievements/message-develop-solutions.svg)
[Develop message-based solutions](https://learn.microsoft.com/training/paths/az-204-develop-message-based-solutions/)
      * Learning Path
      * 1 module
    * ![](https://learn.microsoft.com/training/achievements/monitoring-instrument-solutions.svg)
[Troubleshoot solutions by using Application Insights](https://learn.microsoft.com/training/paths/az-204-instrument-solutions-support-monitoring-logging/)
      * Learning Path
      * 1 module
See more
Add
...
[Take the practice assessment](https://learn.microsoft.com/en-us/credentials/certifications/azure-developer/practice/assessment?assessment-type=practice&assessmentId=35&practice-assessment-type=certification)
Previous attempts
...
![](https://learn.microsoft.com/en-us/media/learn/certification/icons/video.svg?branch=main)
Video
Exam AZ-204 prep videos
Join our experts as they provide tips, tricks, and strategies for preparing for this Microsoft Certification exam.
[Watch video](https://learn.microsoft.com/en-us/shows/exam-readiness-zone/preparing-for-az-204-develop-azure-compute-solutions-1-of-5/)
## Take the exam
...
[ Schedule exam ](https://learn.microsoft.com/en-us/credentials/certifications/schedule-through-pearson-vue?examUid=exam.AZ-204&examUrl=https://learn.microsoft.com/credentials/certifications)
...
[Learn more about renewing ](https://learn.microsoft.com/en-us/credentials/certifications/azure-developer/renew/)
...
[English (United States)](https://learn.microsoft.com/en-us/locale?target=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fcredentials%2Fcertifications%2Fazure-developer%2F%3Fsource%3Drecommendations)
Theme
  * Light
  * Dark
  * High contrast
