...
[ Skip to Main Content ](https://go.dev/doc/tutorial/generics#main-content)
  * [ Why Go _arrow_drop_down_ ](https://go.dev/doc/tutorial/generics)
...
Press Enter to activate/deactivate dropdown
  * [ Docs _arrow_drop_down_ ](https://go.dev/doc/tutorial/generics)
Press Enter to activate/deactivate dropdown
...
Press Enter to activate/deactivate dropdown
  * [ Community _arrow_drop_down_ ](https://go.dev/doc/tutorial/generics)
Press Enter to activate/deactivate dropdown
...
[ ![Go.](https://go.dev/images/go-logo-blue.svg) ](https://go.dev/)
  * [Why Go _navigate_next_](https://go.dev/doc/tutorial/generics)
[_navigate_before_ Why Go](https://go.dev/doc/tutorial/generics)
    * [ Case Studies ](https://go.dev/solutions/case-studies)
    * [ Use Cases ](https://go.dev/solutions/use-cases)
    * [ Security ](https://go.dev/security/)
  * [Learn](https://go.dev/learn/)
  * [Docs _navigate_next_](https://go.dev/doc/tutorial/generics)
[_navigate_before_ Docs](https://go.dev/doc/tutorial/generics)
    * [ Go Spec ](https://go.dev/ref/spec)
    * [ Go User Manual ](https://go.dev/doc)
    * [ Standard library ](https://pkg.go.dev/std)
    * [ Release Notes ](https://go.dev/doc/devel/release)
    * [ Effective Go ](https://go.dev/doc/effective_go)
  * [Packages](https://pkg.go.dev)
  * [Community _navigate_next_](https://go.dev/doc/tutorial/generics)
[_navigate_before_ Community](https://go.dev/doc/tutorial/generics)
    * [ Recorded Talks ](https://go.dev/talks/)
    * [ Conferences _open_in_new_ ](https://go.dev/wiki/Conferences)
    * [ Go blog ](https://go.dev/blog)
    * [ Go project ](https://go.dev/help)
