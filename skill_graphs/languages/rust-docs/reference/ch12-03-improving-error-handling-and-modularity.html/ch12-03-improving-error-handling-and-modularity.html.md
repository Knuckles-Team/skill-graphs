...
Press `Esc` to hide this help
  ...
  14. [**11.** Writing Automated Tests](https://doc.rust-lang.org/book/ch11-00-testing.html)
    1. [**11.1.** How to Write Tests](https://doc.rust-lang.org/book/ch11-01-writing-tests.html)
      1. [How to Write Tests](https://doc.rust-lang.org/book/ch11-01-writing-tests.html#how-to-write-tests)
        1. [Structuring Test Functions](https://doc.rust-lang.org/book/ch11-01-writing-tests.html#structuring-test-functions)
        2. [Checking Results with `assert!`](https://doc.rust-lang.org/book/ch11-01-writing-tests.html#checking-results-with-assert)
        3. [Testing Equality with `assert_eq!` and `assert_ne!`](https://doc.rust-lang.org/book/ch11-01-writing-tests.html#testing-equality-with-assert_eq-and-assert_ne)
        4. [Adding Custom Failure Messages](https://doc.rust-lang.org/book/ch11-01-writing-tests.html#adding-custom-failure-messages)
        5. [Checking for Panics with `should_panic`](https://doc.rust-lang.org/book/ch11-01-writing-tests.html#checking-for-panics-with-should_panic)
        6. [Using `Result<T, E>` in Tests](https://doc.rust-lang.org/book/ch11-01-writing-tests.html#using-resultt-e-in-tests)
