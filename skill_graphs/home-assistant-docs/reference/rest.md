[Skip to main content](https://developers.home-assistant.io/docs/api/rest/#__docusaurus_skipToContent_fallback)
...
`⌘``K`
  ...
  * [Architecture](https://developers.home-assistant.io/docs/api/rest/)
  * [Development Workflow](https://developers.home-assistant.io/docs/api/rest/)
  * [Building Integrations](https://developers.home-assistant.io/docs/api/rest/)
  * [Development Checklist](https://developers.home-assistant.io/docs/api/rest/)
  * [Integration Quality Scale](https://developers.home-assistant.io/docs/core/integration-quality-scale/)
  * [The `hash` object](https://developers.home-assistant.io/docs/api/rest/)
  * [Entities](https://developers.home-assistant.io/docs/api/rest/)
  * [Areas, Devices and Entities](https://developers.home-assistant.io/docs/api/rest/)
  * [Authentication](https://developers.home-assistant.io/docs/api/rest/)
  ...
  * [Device Automations](https://developers.home-assistant.io/docs/api/rest/)
  * [Intents](https://developers.home-assistant.io/docs/api/rest/)
  * [Conversation](https://developers.home-assistant.io/docs/api/rest/)
  * [LLM API](https://developers.home-assistant.io/docs/core/llm/)
  * [Native App Integration](https://developers.home-assistant.io/docs/api/rest/)
  ...
  * [External APIs](https://developers.home-assistant.io/docs/api/rest/)
    * [WebSocket API](https://developers.home-assistant.io/docs/api/websocket)
    * [REST API](https://developers.home-assistant.io/docs/api/rest)
  * [Misc](https://developers.home-assistant.io/docs/api/rest/)
...
Another option is to use Python and the
```
...
### Actions[​](https://developers.home-assistant.io/docs/api/rest/#actions "Direct link to Actions")
...
This endpoint sets the representation of a device within Home Assistant and will not communicate with the actual device. To communicate with the device, use the [POST /api/services/<domain>/<service>](https://developers.home-assistant.io/docs/api/rest/#post-apiservicesltdomainltservice) endpoint.
...
Sample `python` command using the
```
...
[ Previous WebSocket API](https://developers.home-assistant.io/docs/api/websocket)[Next Validate the input](https://developers.home-assistant.io/docs/development_validation)
  * [Actions](https://developers.home-assistant.io/docs/api/rest/#actions)
