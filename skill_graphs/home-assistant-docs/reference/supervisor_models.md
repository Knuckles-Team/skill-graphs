[Skip to main content](https://developers.home-assistant.io/docs/api/supervisor/models/#__docusaurus_skipToContent_fallback)
[![Home Assistant](https://developers.home-assistant.io/img/logo.svg) **Developers**](https://developers.home-assistant.io/)
[Home Assistant](https://developers.home-assistant.io/docs/api/supervisor/models/)
...
`⌘``K`
  * [Introduction](https://developers.home-assistant.io/docs/supervisor)
  * [Development](https://developers.home-assistant.io/docs/supervisor/development)
  * [Debugging](https://developers.home-assistant.io/docs/supervisor/debugging)
  * [Supervisor API](https://developers.home-assistant.io/docs/api/supervisor/models/)
...
## App (formerly known as an add-on)[​](https://developers.home-assistant.io/docs/api/supervisor/models/#app-formerly-known-as-an-add-on "Direct link to App \(formerly known as an add-on\)")
...
## Application[​](https://developers.home-assistant.io/docs/api/supervisor/models/#application "Direct link to Application")
key | type | description  
---|---|---  
...
## Audio[​](https://developers.home-assistant.io/docs/api/supervisor/models/#audio "Direct link to Audio")
key | type | description  
---|---|---  
card | list | A list of [Card models](https://developers.home-assistant.io/docs/api/supervisor/models/#card)  
input | list | A list of [Audio device models](https://developers.home-assistant.io/docs/api/supervisor/models/#audio-device)  
output | list | A list of [Output device models](https://developers.home-assistant.io/docs/api/supervisor/models/#audio-device)  
application | list | A list of [Application models](https://developers.home-assistant.io/docs/api/supervisor/models/#application)  
## Audio device[​](https://developers.home-assistant.io/docs/api/supervisor/models/#audio-device "Direct link to Audio device")
key | type | description  
---|---|---  
...
applications | string | A list of [Application models](https://developers.home-assistant.io/docs/api/supervisor/models/#application)  
## Audio profile[​](https://developers.home-assistant.io/docs/api/supervisor/models/#audio-profile "Direct link to Audio profile")
key | type | description  
---|---|---  
name | string | The name of the profile  
description | string | The description of the profile  
active | boolean |  `true` if the profile is active  
## Card[​](https://developers.home-assistant.io/docs/api/supervisor/models/#card "Direct link to Card")
key | type | description  
---|---|---  
name | string | The name of the card  
index | int | TODO: What is this?  
driver | string | The name of the card driver  
profiles | list | A list of [Audio profile models](https://developers.home-assistant.io/docs/api/supervisor/models/#audio-profile)  
## Discovery[​](https://developers.home-assistant.io/docs/api/supervisor/models/#discovery "Direct link to Discovery")
key | type | description  
---|---|---  
addon | string | The app slug  
...
## Host service[​](https://developers.home-assistant.io/docs/api/supervisor/models/#host-service "Direct link to Host service")
key | type | description  
---|---|---  
name | string | The service name  
description | string | The service description  
state | string | The service state  
## Network interface[​](https://developers.home-assistant.io/docs/api/supervisor/models/#network-interface "Direct link to Network interface")
key | type | description  
---|---|---  
...
ipv6 | struct or null | An [IPv6 configuration](https://developers.home-assistant.io/docs/api/supervisor/models/#ipv6-configuration) struct with IPv6 connection details.  
ipv4 | struct or null | An [IPv4 configuration](https://developers.home-assistant.io/docs/api/supervisor/models/#ipv4-configuration) struct with IPv4 connection details.  
wifi | struct or null | A [Wifi configuration](https://developers.home-assistant.io/docs/api/supervisor/models/#wifi-configuration) struct with wireless connection details.  
vlan | struct or null | A [VLAN configuration](https://developers.home-assistant.io/docs/api/supervisor/models/#vlan-configuration) struct with details about the vlan.  
### IPv6 configuration[​](https://developers.home-assistant.io/docs/api/supervisor/models/#ipv6-configuration "Direct link to IPv6 configuration")
key | type | description  
---|---|---  
...
### IPv4 configuration[​](https://developers.home-assistant.io/docs/api/supervisor/models/#ipv4-configuration "Direct link to IPv4 configuration")
key | type | description  
---|---|---  
method | string | The method used to set the IP can be `static`, `auto` or `disabled`.  
...
### Wifi configuration[​](https://developers.home-assistant.io/docs/api/supervisor/models/#wifi-configuration "Direct link to Wifi configuration")
key | type | description  
---|---|---  
...
### VLAN configuration[​](https://developers.home-assistant.io/docs/api/supervisor/models/#vlan-configuration "Direct link to VLAN configuration")
key | type | description  
---|---|---  
id | integer | The VLAN ID.  
parent | string | Parent interface which is the vlan attached.  
## Access-points[​](https://developers.home-assistant.io/docs/api/supervisor/models/#access-points "Direct link to Access-points")
key | type | description  
---|---|---  
...
## Panel[​](https://developers.home-assistant.io/docs/api/supervisor/models/#panel "Direct link to Panel")
key | type | description  
---|---|---  
...
## Repository[​](https://developers.home-assistant.io/docs/api/supervisor/models/#repository "Direct link to Repository")
key | type | description  
---|---|---  
...
## Service[​](https://developers.home-assistant.io/docs/api/supervisor/models/#service "Direct link to Service")
key | type | description  
---|---|---  
...
## Backup[​](https://developers.home-assistant.io/docs/api/supervisor/models/#backup "Direct link to Backup")
key | type | description  
---|---|---  
...
content | dictionary | Details of the backup content. See [Backup -> content](https://developers.home-assistant.io/docs/api/supervisor/models/#backup---content)  
compressed | boolean |  `true` if the backup is saved in a compressed archive  
### Backup -> content[​](https://developers.home-assistant.io/docs/api/supervisor/models/#backup---content "Direct link to Backup -> content")
...
## Backup details[​](https://developers.home-assistant.io/docs/api/supervisor/models/#backup-details "Direct link to Backup details")
key | type | description  
---|---|---  
slug | string | A generated slug for the backup  
type | string | The type of backup (full, partial)  
...
## Stats[​](https://developers.home-assistant.io/docs/api/supervisor/models/#stats "Direct link to Stats")
key | type | description  
---|---|---  
...
## Issue[​](https://developers.home-assistant.io/docs/api/supervisor/models/#issue "Direct link to Issue")
key | type | description  
---|---|---  
...
## Suggestion[​](https://developers.home-assistant.io/docs/api/supervisor/models/#suggestion "Direct link to Suggestion")
key | type | description  
---|---|---  
...
## Check[​](https://developers.home-assistant.io/docs/api/supervisor/models/#check "Direct link to Check")
key | type | description  
---|---|---  
slug | str | A generated slug for the check  
enable | bool | The enabled state of the check  
## Device[​](https://developers.home-assistant.io/docs/api/supervisor/models/#device "Direct link to Device")
key | type | description  
---|---|---  
...
## Disk[​](https://developers.home-assistant.io/docs/api/supervisor/models/#disk "Direct link to Disk")
key | type | description  
---|---|---  
...
## Mount[​](https://developers.home-assistant.io/docs/api/supervisor/models/#mount "Direct link to Mount")
...
## Job[​](https://developers.home-assistant.io/docs/api/supervisor/models/#job "Direct link to Job")
key | type | description  
---|---|---  
...
child_jobs | list | A list of child [jobs](https://developers.home-assistant.io/docs/api/supervisor/models/#job) started by this one  
errors | list | A list of [errors](https://developers.home-assistant.io/docs/api/supervisor/models/#job-error) that occurred during execution  
extra | dictionary or null | Additional metadata relevant to the job or stage (if applicable)  
## Job error[​](https://developers.home-assistant.io/docs/api/supervisor/models/#job-error "Direct link to Job error")
key | type | description  
---|---|---  
...
## Boot slot[​](https://developers.home-assistant.io/docs/api/supervisor/models/#boot-slot "Direct link to Boot slot")
key | type | description  
---|---|---  
...
## User[​](https://developers.home-assistant.io/docs/api/supervisor/models/#user "Direct link to User")
key | type | description  
---|---|---  
...
## Drive[​](https://developers.home-assistant.io/docs/api/supervisor/models/#drive "Direct link to Drive")
key | type | description  
---|---|---  
...
filesystems | list | A list of [filesystem partitions](https://developers.home-assistant.io/docs/api/supervisor/models/#filesystem) on the drive  
## Filesystem[​](https://developers.home-assistant.io/docs/api/supervisor/models/#filesystem "Direct link to Filesystem")
key | type | description  
---|---|---  
...
[ Previous Endpoints](https://developers.home-assistant.io/docs/api/supervisor/endpoints)[Next Examples](https://developers.home-assistant.io/docs/api/supervisor/examples)
  * [App (formerly known as an add-on)](https://developers.home-assistant.io/docs/api/supervisor/models/#app-formerly-known-as-an-add-on)
  * [Application](https://developers.home-assistant.io/docs/api/supervisor/models/#application)
  * [Audio](https://developers.home-assistant.io/docs/api/supervisor/models/#audio)
  * [Audio device](https://developers.home-assistant.io/docs/api/supervisor/models/#audio-device)
  * [Audio profile](https://developers.home-assistant.io/docs/api/supervisor/models/#audio-profile)
  * [Card](https://developers.home-assistant.io/docs/api/supervisor/models/#card)
  * [Discovery](https://developers.home-assistant.io/docs/api/supervisor/models/#discovery)
  * [Host service](https://developers.home-assistant.io/docs/api/supervisor/models/#host-service)
  * [Network interface](https://developers.home-assistant.io/docs/api/supervisor/models/#network-interface)
    * [IPv6 configuration](https://developers.home-assistant.io/docs/api/supervisor/models/#ipv6-configuration)
    * [IPv4 configuration](https://developers.home-assistant.io/docs/api/supervisor/models/#ipv4-configuration)
    * [Wifi configuration](https://developers.home-assistant.io/docs/api/supervisor/models/#wifi-configuration)
    * [VLAN configuration](https://developers.home-assistant.io/docs/api/supervisor/models/#vlan-configuration)
  * [Access-points](https://developers.home-assistant.io/docs/api/supervisor/models/#access-points)
  * [Panel](https://developers.home-assistant.io/docs/api/supervisor/models/#panel)
  * [Repository](https://developers.home-assistant.io/docs/api/supervisor/models/#repository)
  * [Service](https://developers.home-assistant.io/docs/api/supervisor/models/#service)
  * [Backup](https://developers.home-assistant.io/docs/api/supervisor/models/#backup)
    * [Backup -> content](https://developers.home-assistant.io/docs/api/supervisor/models/#backup---content)
  * [Backup details](https://developers.home-assistant.io/docs/api/supervisor/models/#backup-details)
  * [Stats](https://developers.home-assistant.io/docs/api/supervisor/models/#stats)
  * [Issue](https://developers.home-assistant.io/docs/api/supervisor/models/#issue)
  * [Suggestion](https://developers.home-assistant.io/docs/api/supervisor/models/#suggestion)
  * [Check](https://developers.home-assistant.io/docs/api/supervisor/models/#check)
  * [Device](https://developers.home-assistant.io/docs/api/supervisor/models/#device)
  * [Disk](https://developers.home-assistant.io/docs/api/supervisor/models/#disk)
  * [Mount](https://developers.home-assistant.io/docs/api/supervisor/models/#mount)
  * [Job](https://developers.home-assistant.io/docs/api/supervisor/models/#job)
  * [Job error](https://developers.home-assistant.io/docs/api/supervisor/models/#job-error)
  * [Boot slot](https://developers.home-assistant.io/docs/api/supervisor/models/#boot-slot)
  * [User](https://developers.home-assistant.io/docs/api/supervisor/models/#user)
  * [Drive](https://developers.home-assistant.io/docs/api/supervisor/models/#drive)
  * [Filesystem](https://developers.home-assistant.io/docs/api/supervisor/models/#filesystem)
