...
vermagic:       2.6.11 preempt PENTIUMII 4KSTACKS gcc-3.3
depends:
param:           myintArray:An array of integers (array of int)
param:           mystring:A character string (charp)
param:           mylong:A long integer (long)
param:           myint:An integer (int)
param:           myshort:A short integer (short)
hostname:~/lkmpg-examples/02-HelloWorld#
```
