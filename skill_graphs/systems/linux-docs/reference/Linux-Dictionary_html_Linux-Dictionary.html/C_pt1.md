...
Common CA Certificates PEM files It includes the following PEM files of CA certificates * Mozilla builtin CA certificates * db.debian.org certificate This is useful for any openssl applications to verify SSL connection. From Debian 3.0r0 APT <http://www.tldp.org/LDP/Linux-Dictionary/html/index.html>
