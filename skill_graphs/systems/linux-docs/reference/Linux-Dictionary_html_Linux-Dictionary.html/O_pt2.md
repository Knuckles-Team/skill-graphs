...
Outgoing InterFace (PIM, IF, Multicast) From VERA <http://www.tldp.org/LDP/Linux-Dictionary/html/index.html>
...
OSI Implementers Workshop (OSI) From VERA <http://www.tldp.org/LDP/Linux-Dictionary/html/index.html>
