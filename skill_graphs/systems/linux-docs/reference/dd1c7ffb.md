...
---
For 2.4 kernels the devices is names using the device's major and minor number. In this case the device listed is` /dev/had`. To have **iostat** print this out for you, use the `-x`. ```
`#` `**iostat -x**`
`Linux 2.4.20-24.9 (myhost)       12/23/2003
