...
# Search Linux From Scratch
## Firefox / Mozilla Plugin
This plugin allows you to search the LFS mailing list archives directly from the Firefox / Mozilla search bar.
## Google search
Choose the domain: |  linuxfromscratch.org  |  WWW
---|---|---
Search with google: |  |
