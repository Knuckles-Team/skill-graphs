[ Skip to main content ](https://learn.microsoft.com/en-us/azure/mysql/#main)
...
[ Sign in ](https://learn.microsoft.com/en-us/azure/mysql/)
  * [ Profile ](https://learn.microsoft.com/en-us/users/me/activity/)
  * [ Settings ](https://learn.microsoft.com/en-us/users/me/settings/)


[ Sign out ](https://learn.microsoft.com/en-us/azure/mysql/)
...
Suggestions will filter as you type
  ...
  *     * [What is Azure Database for MySQL?](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/overview)
    * [Try for free](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/how-to-deploy-on-azure-free-account)
...
Table of contents [ Read in English ](https://learn.microsoft.com/en-us/azure/mysql/)
* * *
#### Share via
...
## About Azure Database for MySQL
  * [What is Azure Database for MySQL?](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/overview)
  * [Get started for free with an Azure free account](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/how-to-deploy-on-azure-free-account)


  * [Check out our blog](https://techcommunity.microsoft.com/t5/Azure-Database-for-MySQL/bg-p/ADforMySQL)


## Azure Database for MySQL deployment model
  * [Azure Database for MySQL deployment model](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/overview)


  * [What's new in Azure Database for MySQL?](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/whats-new)


  * [Server concepts](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/concept-servers)
  * [Understand compute and storage](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/concepts-compute-storage)
  * [Limitations](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/concepts-limitations)


  * [Create a server using the portal](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/quickstart-create-server-portal)
  * [Create a server using Azure CLI](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/quickstart-create-server-cli)


## Connect and query
  * [Connect and query reference guide](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/security-tls-how-to-connect)


  * [Connect using MySQL Workbench](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/connect-workbench)
  * [Connect using PHP](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/connect-php)
  * [Connect using Python](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/connect-python)


## Migrations
  * [Azure Database for MySQL migration guide](https://learn.microsoft.com/en-us/azure/mysql/migrate/mysql-on-premises-azure-db/01-mysql-migration-guide-intro)
  * [Dump and restore](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/concepts-migrate-dump-restore)
  * [Import and export](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/concepts-migrate-import-export)
  ...
  * [Minimal-downtime migration](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/how-to-migrate-online)
  * [Common errors during or post migration](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/how-to-troubleshoot-common-errors)


## Manage and migrate data
  * [Manage Azure Database for MySQL using Azure portal](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/how-to-manage-server-portal)
  * [Migrate using dump and restore](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/concepts-migrate-dump-restore)
  * [Migrate using import and export](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/concepts-migrate-import-export)


  * [Migrate using Data Migration Service](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/how-to-migrate-online)
  * [Azure Data migration guide](https://learn.microsoft.com/en-us/azure/mysql/migrate/mysql-on-premises-azure-db/01-mysql-migration-guide-intro)
  * [Troubleshoot migration errors](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/how-to-troubleshoot-common-errors)


## Application Development
  * [Build a PHP (Laravel) web app with Azure Database for MySQL](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/tutorial-php-database-app)
  * [Create a Web App with Azure Database for MySQL in virtual network](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/tutorial-webapp-server-vnet)
  * [Deploy Java Spring Boot app on ASK with Azure Database for MySQL](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/tutorial-deploy-springboot-on-aks-vnet)
  * [Deploy WordPress on App Service with Azure Database for MySQL](https://learn.microsoft.com/en-us/azure/app-service/quickstart-wordpress)


## Troubleshoot
  * [Troubleshoot migration errors](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/how-to-troubleshoot-common-errors)
  * [Troubleshoot query performance](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/how-to-troubleshoot-query-performance-new)
  * [Troubleshoot low memory issues](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/how-to-troubleshoot-low-memory-issues)
  ...
  * [Troubleshoot replication latency](https://learn.microsoft.com/en-us/azure/mysql/how-to-troubleshoot-replication-latency)
  * [Troubleshoot database corruption](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/how-to-fix-corrupt-database)
  * [Troubleshoot connectivity issues](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/how-to-troubleshoot-connectivity-issues)
  * [Tune performance using the sys_schema](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/how-to-troubleshoot-sys-schema)
  * [Troubleshooting best practices](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/concepts-troubleshooting-best-practices)


## Reference
  * [Azure CLI Samples - Azure Database for MySQL](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/sample-scripts-azure-cli)
  * [Azure CLI Samples - Azure Database for MySQL - Single Server](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/sample-scripts-azure-cli)
  * [Azure Resource Manager templates](https://learn.microsoft.com/en-us/azure/templates/microsoft.dbformysql/allversions)


  * [Azure CLI developer reference](https://learn.microsoft.com/en-us/cli/azure/mysql)
  * [REST API developer reference](https://learn.microsoft.com/en-us/rest/api/mysql/)
  * [PowerShell](https://learn.microsoft.com/en-us/powershell/module/az.mysql)


[English (United States)](https://learn.microsoft.com/en-us/locale?target=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fazure%2Fmysql%2F)
Theme
  * Light
  * Dark
  * High contrast
