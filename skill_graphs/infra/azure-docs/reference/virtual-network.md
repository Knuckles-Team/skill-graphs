[ Skip to main content ](https://learn.microsoft.com/en-us/azure/virtual-network/#main)
...
[ Sign in ](https://learn.microsoft.com/en-us/azure/virtual-network/)
  * [ Profile ](https://learn.microsoft.com/en-us/users/me/activity/)
  * [ Settings ](https://learn.microsoft.com/en-us/users/me/settings/)


[ Sign out ](https://learn.microsoft.com/en-us/azure/virtual-network/)
...
Suggestions will filter as you type
  ...
  *     * [What is Azure Virtual Network?](https://learn.microsoft.com/en-us/azure/virtual-network/virtual-networks-overview)
    ...
    * [What is network foundations?](https://learn.microsoft.com/en-us/azure/networking/foundations/network-foundations-overview)
...
Table of contents [ Read in English ](https://learn.microsoft.com/en-us/azure/virtual-network/)
* * *
#### Share via
...
## Learn about Azure Virtual Network
  * [What is Azure Virtual Network?](https://learn.microsoft.com/en-us/azure/virtual-network/virtual-networks-overview)
  * [Networking Architecture](https://learn.microsoft.com/en-us/azure/architecture/networking/)
...
## Concepts and Architecture
  ...
  * [Route network traffic](https://learn.microsoft.com/en-us/azure/virtual-network/virtual-networks-udr-overview)
...
## Plan and design
  ...
  * [Connect to an on-premises network](https://learn.microsoft.com/en-us/azure/architecture/reference-architectures/hybrid-networking/)
  * [IPv6](https://learn.microsoft.com/en-us/azure/virtual-network/ip-services/ipv6-overview)
  * [IP address types and allocation](https://learn.microsoft.com/en-us/azure/virtual-network/ip-services/public-ip-addresses)
...
## Deployment
  ...
  * [Create a virtual network peer](https://learn.microsoft.com/en-us/azure/virtual-network/tutorial-connect-virtual-networks-portal)
  * [Route network traffic](https://learn.microsoft.com/en-us/azure/virtual-network/tutorial-create-route-table-portal)


## Manage and monitor
  * [Manage virtual networks](https://learn.microsoft.com/en-us/azure/virtual-network/manage-virtual-network)
  * [Manage subnets](https://learn.microsoft.com/en-us/azure/virtual-network/virtual-network-manage-subnet)
  * [Monitor virtual networks](https://learn.microsoft.com/en-us/azure/virtual-network/monitor-virtual-network)
  * [Manage network interfaces](https://learn.microsoft.com/en-us/azure/virtual-network/virtual-network-network-interface)


## Reliability and availability
  * [Highly available hybrid architecture](https://learn.microsoft.com/en-us/azure/architecture/reference-architectures/hybrid-networking/expressroute-vpn-failover)
  * [DHCP server on an Azure Virtual Machine](https://learn.microsoft.com/en-us/azure/virtual-network/how-to-dhcp-azure)
  * [Azure VM TCP/IP performance tuning](https://learn.microsoft.com/en-us/azure/virtual-network/virtual-network-tcpip-performance-tuning)


## Security and compliance
  * [Virtual network encryption](https://learn.microsoft.com/en-us/azure/virtual-network/virtual-network-encryption-overview)
  * [Network security groups](https://learn.microsoft.com/en-us/azure/virtual-network/network-security-groups-overview)
  * [Application security groups](https://learn.microsoft.com/en-us/azure/virtual-network/network-security-groups-overview#application-security-groups)


  * [Secure and isolate access to Azure resources](https://learn.microsoft.com/en-us/training/modules/secure-and-isolate-with-nsg-and-service-endpoints/)


## Troubleshoot
  * [Troubleshoot peering issues](https://learn.microsoft.com/en-us/azure/virtual-network/virtual-network-troubleshoot-peering-issues)
  * [Can't delete virtual network](https://learn.microsoft.com/en-us/azure/virtual-network/virtual-network-troubleshoot-cannot-delete-vnet)
  * [IP address 168.63.129.16](https://learn.microsoft.com/en-us/azure/virtual-network/what-is-ip-address-168-63-129-16)
  * [Outbound SMTP connectivity](https://learn.microsoft.com/en-us/azure/virtual-network/troubleshoot-outbound-smtp-connectivity)
...
## How-to guidance
  ...
  * [Update address space for a virtual network peer](https://learn.microsoft.com/en-us/azure/virtual-network/update-virtual-network-peering-address-space)
  * [Configure subnet peering](https://learn.microsoft.com/en-us/azure/virtual-network/how-to-configure-subnet-peering)


## Related network foundations services
  * [What is network foundations?](https://learn.microsoft.com/en-us/azure/networking/foundations/network-foundations-overview)
  * [Learn more about network foundations](https://learn.microsoft.com/en-us/azure/networking/foundations/)
...
[English (United States)](https://learn.microsoft.com/en-us/locale?target=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fazure%2Fvirtual-network%2F)
Theme
  * Light
  * Dark
  * High contrast
