[ Skip to main content ](https://learn.microsoft.com/en-us/azure/developer/jenkins/#main)
...
[ Sign in ](https://learn.microsoft.com/en-us/azure/developer/jenkins/)
  * [ Profile ](https://learn.microsoft.com/en-us/users/me/activity/)
  * [ Settings ](https://learn.microsoft.com/en-us/users/me/settings/)


[ Sign out ](https://learn.microsoft.com/en-us/azure/developer/jenkins/)
...
Search
Suggestions will filter as you type
  * [Jenkins on Azure](https://learn.microsoft.com/en-us/azure/developer/jenkins/)
...
Table of contents [ Read in English ](https://learn.microsoft.com/en-us/azure/developer/jenkins/)
* * *
#### Share via
...
## About Jenkins on Azure
  ...
  * [Jenkins plug-ins for Azure](https://learn.microsoft.com/en-us/azure/developer/jenkins/plug-ins-for-azure)


  * [Jenkins architecture](https://learn.microsoft.com/en-us/azure/architecture/reference-architectures/jenkins/)


## Install and configure Jenkins
  * [Configure Jenkins using Azure CLI](https://learn.microsoft.com/en-us/azure/developer/jenkins/configure-on-linux-vm)
...
## CI/CD to ASK
  * [Deploy from GitHub to ASK](https://learn.microsoft.com/en-us/azure/developer/jenkins/deploy-from-github-to-aks)
...
## CI/CD to Azure DevOps
  * [Deploy to a Linux VM using Azure DevOps Services](https://learn.microsoft.com/en-us/azure/developer/jenkins/deploy-to-linux-vm-using-azure-devops-services)


## CI/CD to Azure Storage
  * [Using Azure Storage with a Jenkins C/I solution](https://learn.microsoft.com/en-us/azure/developer/jenkins/azure-storage-blobs-as-build-artifact-repository)


## CI/CD to Linux VMs
  * [Create a dev infrastructure on a Linux VM](https://learn.microsoft.com/en-us/azure/developer/jenkins/pipeline-with-github-and-docker)


## CI/CD to Service Fabric
  * [Build and deploy an Azure Service Fabric app](https://learn.microsoft.com/en-us/azure/developer/jenkins/deploy-to-service-fabric-cluster)
...
[English (United States)](https://learn.microsoft.com/en-us/locale?target=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fazure%2Fdeveloper%2Fjenkins%2F)
Theme
  * Light
  * Dark
  * High contrast
