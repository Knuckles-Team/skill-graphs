[ Skip to main content ](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#main) [ Skip to Ask Learn chat experience ](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api)
...
[ Sign in ](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api)
  * [ Profile ](https://learn.microsoft.com/en-us/users/me/activity/)
  * [ Settings ](https://learn.microsoft.com/en-us/users/me/settings/)


[ Sign out ](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api)
...
[ Return to main site ](https://learn.microsoft.com)
Dismiss alert
Search
Suggestions will filter as you type
  * [Media Services Documentation](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/)
  *     * [Stream live - .NET](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api)
    * [Use Azure Functions - .NET](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/integrate-azure-functions-dotnet-how-to)
    * [Enable trusted storage - CLI](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/security-trusted-storage-rest-tutorial)
    * [Encode and stream a remote file - CLI](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-files-cli-quickstart)
    * [Use a Key Vault key to encrypt data - CLI](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/security-encrypt-data-managed-identity-cli-tutorial)
    * [Access storage with a Managed Identity - CLI](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/security-access-storage-managed-identity-cli-tutorial)
    * [Give a Function App access to Media Services account - CLI](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/security-function-app-managed-identity-cli-tutorial)
    * [Stream live - Node.js](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-nodejs)
    * [Customer managed keys or BYOK tutorial - Portal](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/security-customer-managed-keys-portal-tutorial)
    * [Store AMS events in Azure Log Analytics - Portal](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/monitoring/integrate-event-grid-log-analytics-tutorial)


Table of contents  Exit editor mode
  1. [ Learn ](https://learn.microsoft.com/en-us/)
  2. [ Previous Versions ](https://learn.microsoft.com/en-us/previous-versions/)
...
Table of contents [ Read in English ](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api) Add to Collections Add to plan
* * *
#### Share via
* * *
Copy Markdown Print
* * *
Note
Access to this page requires authorization. You can try [signing in](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api) or changing directories.
Access to this page requires authorization. You can try changing directories.
# Tutorial: Stream live with Media Services by using .NET 7.0
Feedback
Summarize this article for me
##  In this article
  1. [Prerequisites](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#prerequisites)
  2. [Download and configure the sample](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#download-and-configure-the-sample)
  3. [Start using Media Services APIs with the .NET SDK](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#start-using-media-services-apis-with-the-net-sdk)
  4. [Create a live event](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#create-a-live-event)
  5. [Get ingest URLs](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#get-ingest-urls)
  6. [Get the preview URL](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#get-the-preview-url)
  7. [Create and manage live events and live outputs](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#create-and-manage-live-events-and-live-outputs)
  8. [Create a streaming locator](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#create-a-streaming-locator)
  9. [Watch the event](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#watch-the-event)
  10. [Monitoring Live Events using Event Grid and Event Hubs](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#monitoring-live-events-using-event-grid-and-event-hubs)
  11. [Clean up resources in your Media Services account](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#clean-up-resources-in-your-media-services-account)
  12. [Clean up remaining resources](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#clean-up-remaining-resources)
  13. [Get help and support](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#get-help-and-support)

Show 9 more
![Media Services logo v3](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/media/media-services-api-logo/azure-media-services-logo-v3.svg)
...
In this tutorial, you will:
  ...
  * Watch the event with Azure Media Player on the
  * Set up Event Grid to monitor the live event.
  * Clean up resources.


[](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#prerequisites)
## Prerequisites
You need the following items to complete the tutorial:
  * Install [Visual Studio 2022 for Windows or Mac](https://visualstudio.microsoft.com/).
...
The live-streaming sample is in the
...
[](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#start-using-media-services-apis-with-the-net-sdk)
...
[](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#create-a-live-event)
## Create a live event
...
[](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#get-ingest-urls)
## Get ingest URLs
...
[](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#get-the-preview-url)
## Get the preview URL
...
[](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#create-and-manage-live-events-and-live-outputs)
...
[](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#create-an-asset)
### Create an asset
...
[](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#create-a-live-output)
...
[](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#create-a-streaming-locator)
...
[](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#watch-the-event)
## Watch the event
Run the code. Use the output streaming URLs to watch your live event. Copy the streaming locator URL. You can use a media player of your choice. You can use the **Update player**.
[](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#monitoring-live-events-using-event-grid-and-event-hubs)
...
[](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#clean-up-resources-in-your-media-services-account)
...
[](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#clean-up-remaining-resources)
...
[](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api#get-help-and-support)
...
[ Sign in ](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/stream-live-tutorial-with-api)
[English (United States)](https://learn.microsoft.com/en-us/locale?target=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fprevious-versions%2Fazure%2Fmedia-services%2Flatest%2Fstream-live-tutorial-with-api)
Theme
  * Light
  * Dark
  * High contrast
