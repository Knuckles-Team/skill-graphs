[ Skip to main content ](https://learn.microsoft.com/en-us/azure/expressroute/#main)
...
[ Sign in ](https://learn.microsoft.com/en-us/azure/expressroute/)
  * [ Profile ](https://learn.microsoft.com/en-us/users/me/activity/)
  * [ Settings ](https://learn.microsoft.com/en-us/users/me/settings/)


[ Sign out ](https://learn.microsoft.com/en-us/azure/expressroute/)
...
Suggestions will filter as you type
  ...
  *     * [What is ExpressRoute?](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-introduction)
    * [Architecture best practices for Azure ExpressRoute](https://learn.microsoft.com/en-us/azure/well-architected/service-guides/azure-expressroute?toc=/azure/expressroute/toc.json)
    ...
    * [Service limitations](https://learn.microsoft.com/en-us/azure/azure-resource-manager/management/azure-subscription-service-limits?toc=/azure/expressroute/toc.json#azure-expressroute-limits)
...
Download PDF
  ...
  3. [ Networking ](https://learn.microsoft.com/en-us/azure/networking/)
...
Table of contents [ Read in English ](https://learn.microsoft.com/en-us/azure/expressroute/)
* * *
#### Share via
...
## About ExpressRoute
  * [What is ExpressRoute?](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-introduction)
  * [Well-Architected Framework](https://learn.microsoft.com/en-us/azure/well-architected/service-guides/azure-expressroute)


  * [Introduction to Azure ExpressRoute](https://learn.microsoft.com/en-us/training/modules/intro-to-azure-expressroute)
  * [Connect your on-premises network to the Microsoft global network using ExpressRoute](https://learn.microsoft.com/en-us/training/modules/connect-on-premises-network-with-expressroute/)


  * [Create and modify a circuit](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-howto-circuit-portal-resource-manager)
  * [Create and modify peering for a circuit](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-howto-routing-portal-resource-manager)
  * [Connect a VNet to a circuit](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-howto-linkvnet-portal-resource-manager)
  * [Configure route filters](https://learn.microsoft.com/en-us/azure/expressroute/how-to-routefilter-portal)


  * [FAQ](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-faqs)
  * [Pricing](https://azure.microsoft.com/en-us/pricing/details/expressroute/)
  * [SLA agreement](https://azure.microsoft.com/en-us/support/legal/sla/)
...
## Reliability
  ...
  * [Design for Disaster Recovery with private peering](https://learn.microsoft.com/en-us/azure/expressroute/designing-for-disaster-recovery-with-expressroute-privatepeering)
  * [BFD over ExpressRoute](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-bfd)
  * [Site-to-site VPN over a Microsoft peering](https://learn.microsoft.com/en-us/azure/expressroute/site-to-site-vpn-over-microsoft-peering)


  * [Create Maximum resiliency with ExpressRoute circuits](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-howto-circuit-portal-resource-manager?pivots=expressroute-preview)
  * [Create Maximum resiliency with ExpressRoute gateways](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-howto-linkvnet-portal-resource-manager?pivots=expressroute-preview)
  * [Create a zone-redundant ExpressRoute gateway](https://learn.microsoft.com/en-us/azure/vpn-gateway/create-zone-redundant-vnet-gateway)


## Security
  * [Azure security baseline for ExpressRoute](https://learn.microsoft.com/en-us/security/benchmark/azure/baselines/expressroute-security-baseline)
  * [Encryption for ExpressRoute](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-about-encryption)
  * [IPsec transport mode for private peering](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-howto-ipsec-transport-private-windows)


  * [Configure site-to-site VPN over a Microsoft peering](https://learn.microsoft.com/en-us/azure/expressroute/site-to-site-vpn-over-microsoft-peering)
  * [Configure IPsec transport mode for private peering](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-howto-ipsec-transport-private-windows)
  * [Configure MACSec on ExpressRoute Direct](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-howto-macsec)


## Cost Optimization
  * [Plan and manage costs for ExpressRoute](https://learn.microsoft.com/en-us/azure/expressroute/plan-manage-cost)
...
## Operational excellence
  * [Prerequisites and checklist](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-prerequisites)
  * [Providers organized by location](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-locations-providers)
  * [Locations organized by provider](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-locations)
  * [Monitor Azure ExpressRoute](https://learn.microsoft.com/en-us/azure/expressroute/monitor-expressroute)
  * [Traffic Collector](https://learn.microsoft.com/en-us/azure/expressroute/traffic-collector)
  * [Planned maintenance](https://learn.microsoft.com/en-us/azure/expressroute/planned-maintenance)
  * [QOS requirements](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-qos)
  * [About Global Reach](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-global-reach)


  * [Architecture best practices for Azure ExpressRoute](https://learn.microsoft.com/en-us/azure/well-architected/service-guides/azure-expressroute)
  * [Extend an on-premises network using ExpressRoute](https://learn.microsoft.com/en-us/azure/architecture/reference-architectures/hybrid-networking/expressroute)
  * [Connect an on-premises network to Azure using ExpressRoute](https://learn.microsoft.com/en-us/azure/architecture/reference-architectures/hybrid-networking/expressroute-vpn-failover)


  * [Configure monitoring, metrics, and alerts](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-monitoring-metrics-alerts)


## Performance efficiency
  * [Scalable ExpressRoute gateway](https://learn.microsoft.com/en-us/azure/expressroute/scalable-gateway)
  ...
  * [ExpressRoute limitations](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-faqs#limits)


  * [Configure ExpressRoute Direct](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-howto-erdirect)


## Troubleshoot
  * [Troubleshoot network performance](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-troubleshooting-network-performance)
  * [Get operation correlation ID](https://learn.microsoft.com/en-us/azure/expressroute/get-correlation-id)
  * [Verify connectivity](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-troubleshooting-expressroute-overview)


## Related hybrid connectivity services
  * [What is hybrid connectivity?](https://learn.microsoft.com/en-us/azure/networking/hybrid-connectivity/hybrid-connectivity)
  * [Learn more about hybrid connectivity](https://learn.microsoft.com/en-us/azure/networking/hybrid-connectivity/)
...
[English (United States)](https://learn.microsoft.com/en-us/locale?target=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fazure%2Fexpressroute%2F)
Theme
  * Light
  * Dark
  * High contrast
