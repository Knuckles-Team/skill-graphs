[ Skip to main content ](https://learn.microsoft.com/en-us/azure/azure-arc/#main)
...
[ Sign in ](https://learn.microsoft.com/en-us/azure/azure-arc/)
  * [ Profile ](https://learn.microsoft.com/en-us/users/me/activity/)
  * [ Settings ](https://learn.microsoft.com/en-us/users/me/settings/)


[ Sign out ](https://learn.microsoft.com/en-us/azure/azure-arc/)
...
Overview
[About Azure Arc](https://learn.microsoft.com/en-us/azure/azure-arc/overview)
![](https://learn.microsoft.com/en-us/media/hubs/shared/icon-sample.svg?branch=main)
sample
![](https://learn.microsoft.com/en-us/media/hubs/shared/icon-overview.svg?branch=main)
Overview
...
### Azure Arc-enabled servers
  * [Connect hybrid machines](https://learn.microsoft.com/en-us/azure/azure-arc/servers/learn/quick-enable-hybrid-vm)
  * [Plan and deploy](https://learn.microsoft.com/en-us/azure/azure-arc/servers/plan-at-scale-deployment)
  * [ESU for Windows Server 2012](https://learn.microsoft.com/en-us/azure/azure-arc/servers/prepare-extended-security-updates)
  * [ See more ](https://learn.microsoft.com/en-us/azure/azure-arc/servers/)
...
### Azure Arc-enabled Kubernetes
  ...
  * [Apply configurations on clusters using GitOps](https://learn.microsoft.com/en-us/azure/azure-arc/kubernetes/use-azure-policy-flux-2)
  * [Access connected clusters from anywhere](https://learn.microsoft.com/en-us/azure/azure-arc/kubernetes/cluster-connect)
  * [ See more ](https://learn.microsoft.com/en-us/azure/azure-arc/kubernetes/)


### Azure Arc-enabled data services
  * [Plan deployment](https://learn.microsoft.com/en-us/azure/azure-arc/data/plan-azure-arc-data-services)
  * [Connectivity modes](https://learn.microsoft.com/en-us/azure/azure-arc/data/connectivity)
  * [Create SQL Managed Instance](https://learn.microsoft.com/en-us/azure/azure-arc/data/create-sql-managed-instance)
  * [ See more ](https://learn.microsoft.com/en-us/azure/azure-arc/data/)


### SQL Server enabled by Azure Arc
  * [Connect SQL Server to Azure Arc](https://learn.microsoft.com/en-us/sql/sql-server/azure-arc/connect)
  * [Assess instance](https://learn.microsoft.com/en-us/sql/sql-server/azure-arc/assess)
  * [Configure advanced data security](https://learn.microsoft.com/en-us/sql/sql-server/azure-arc/configure-advanced-data-security)
  * [ See more ](https://learn.microsoft.com/en-us/sql/sql-server/azure-arc/)


### Azure Arc-enabled private clouds
  * [Azure Arc resource bridge](https://learn.microsoft.com/en-us/azure/azure-arc/resource-bridge/overview)
  ...
  * [Azure Arc VM management on Azure Local](https://learn.microsoft.com/en-us/azure/azure-local/manage/azure-arc-vm-management-overview)
...
### Training modules
  ...
  * [Secure hybrid and multicloud machines](https://learn.microsoft.com/en-us/training/modules/secure-azure-arc-enabled-servers/)
  * [Monitor hybrid and multicloud machines](https://learn.microsoft.com/en-us/training/modules/monitor-azure-arc-enabled-servers/)


[](https://learn.microsoft.com/en-us/azure/azure-arc/#explore-more)
## Explore more
...
###  [Azure Kubernetes Service (ASK) enabled by Azure Arc](https://learn.microsoft.com/en-us/azure/ask/aksarc/ask-overview)
Extend ASK to your on-premises environment.
...
###  [Azure Container Apps on Azure Arc](https://learn.microsoft.com/en-us/azure/container-apps/azure-arc-overview)
Run Container Apps on Azure Arc-enabled Kubernetes clusters.
###  [Azure IoT Operations Preview – enabled by Azure Arc](https://learn.microsoft.com/en-us/azure/iot-operations/)
Azure IoT Operations is a unified data plane for the edge that helps organizations deploy the industrial metaverse.
###  [Azure Arc site manager (preview)](https://learn.microsoft.com/en-us/azure/azure-arc/site-manager/)
...
###  [Edge RAG Preview enabled by Azure Arc](https://learn.microsoft.com/en-us/azure/azure-arc/edge-rag/)
Search on-premises data with generative AI, using Retrieval Augmented Generation.
###  [Azure Container Storage enabled by Azure Arc](https://learn.microsoft.com/en-us/azure/azure-arc/container-storage/)
A first-party storage system designed for Arc-connected Kubernetes clusters
[English (United States)](https://learn.microsoft.com/en-us/locale?target=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fazure%2Fazure-arc%2F)
Theme
  * Light
  * Dark
  * High contrast
