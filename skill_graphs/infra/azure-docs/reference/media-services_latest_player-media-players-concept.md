[ Skip to main content ](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/player-media-players-concept#main) [ Skip to Ask Learn chat experience ](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/player-media-players-concept)
...
[ Sign in ](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/player-media-players-concept)
  * [ Profile ](https://learn.microsoft.com/en-us/users/me/activity/)
  * [ Settings ](https://learn.microsoft.com/en-us/users/me/settings/)


[ Sign out ](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/player-media-players-concept)
...
Suggestions will filter as you type
  ...
  *     * [Overview](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/concepts-overview)
    * [Assets](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/assets-concept)
    * [Media players](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/player-media-players-concept)
    * [Transforms and jobs](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/transform-jobs-concept)
    * [Architectures](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/architecture-concept)


Table of contents  Exit editor mode
  1. [ Learn ](https://learn.microsoft.com/en-us/)
  2. [ Previous Versions ](https://learn.microsoft.com/en-us/previous-versions/)
  3. [ Concepts ](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/concepts-overview)
...
Table of contents [ Read in English ](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/player-media-players-concept) Add to Collections Add to plan
* * *
#### Share via
* * *
Copy Markdown Print
* * *
Note
Access to this page requires authorization. You can try [signing in](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/player-media-players-concept) or changing directories.
Access to this page requires authorization. You can try changing directories.
# Media players for Media Services
Feedback
Summarize this article for me
##  In this article
  1. [List of players](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/player-media-players-concept#list-of-players)
  2. [Samples](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/player-media-players-concept#samples)
  3. [Get help and support](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/player-media-players-concept#get-help-and-support)


You can use several media players with Media Services.
[](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/player-media-players-concept#list-of-players)
## List of players
  * [Azure Media Player](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/azure-media-player/azure-media-player-overview)


[](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/player-media-players-concept#samples)
## Samples
To get started with streaming videos with these players, see the
[](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/player-media-players-concept#get-help-and-support)
...
[ Sign in ](https://learn.microsoft.com/en-us/previous-versions/azure/media-services/latest/player-media-players-concept)
[English (United States)](https://learn.microsoft.com/en-us/locale?target=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fprevious-versions%2Fazure%2Fmedia-services%2Flatest%2Fplayer-media-players-concept)
Theme
  * Light
  * Dark
  * High contrast
