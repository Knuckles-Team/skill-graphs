...
Use one of the following methods to capture the configuration of each cluster.
...
Create your cloud-side Namespaces noting current [naming requirements](/cloud/namespaces#temporal-cloud-namespace-name).

Apply any required custom Search Attributes and adjust the [rate limits](/cloud/capacity-modes) as needed.
