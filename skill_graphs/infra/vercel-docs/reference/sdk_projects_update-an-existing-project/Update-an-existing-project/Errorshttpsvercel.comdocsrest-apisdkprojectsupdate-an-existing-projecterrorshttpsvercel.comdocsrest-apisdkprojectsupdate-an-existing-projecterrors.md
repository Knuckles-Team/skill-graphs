##  [Errors](https://vercel.com/docs/rest-api/sdk/projects/update-an-existing-project#errors)[](https://vercel.com/docs/rest-api/sdk/projects/update-an-existing-project#errors)
400One of the provided values in the request body is invalid. One of the provided values in the request query is invalid. Trusted IPs is only accessible for enterprise customers
...
404Error
409The provided name for the project is already being used The project is currently being transferred.
