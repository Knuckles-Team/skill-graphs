...
##  [Exploring models](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#exploring-models)[](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#exploring-models)
To explore models:
...
###  [Using the model playground](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#using-the-model-playground)[](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#using-the-model-playground)
...
###  [Adding a model to your project](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#adding-a-model-to-your-project)[](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#adding-a-model-to-your-project)
...
##  [Featured AI integrations](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#featured-ai-integrations)[](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#featured-ai-integrations)
...
* * *
[ Previous Adding a Provider ](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-provider)[ Next xAI ](https://vercel.com/docs/agent-resources/integrations-for-models/xai)
Was this helpful?
Send
On this page
  * [Exploring models](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#exploring-models)
  * [Using the model playground](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#using-the-model-playground)
  * [Adding a model to your project](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#adding-a-model-to-your-project)
  * [Featured AI integrations](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#featured-ai-integrations)
...
Vercel integrates with [AI applications](https://vercel.com/ai).
...
##  [Building chat interfaces with the AI SDK](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#building-chat-interfaces-with-the-ai-sdk)[](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#building-chat-interfaces-with-the-ai-sdk)
Integrating OpenAI into your Vercel project is seamless with the
...
You can use the SDK to build AI applications with
##  [Using OpenAI Functions with Vercel](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#using-openai-functions-with-vercel)[](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#using-openai-functions-with-vercel)
The AI SDK also has full support for
...
Send
On this page
  * [Getting started](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#getting-started)
  * [Getting Your OpenAI API Key](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#getting-your-openai-api-key)
  * [Navigate to API Keys](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#navigate-to-api-keys)
  * [Generate API Key](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#generate-api-key)
  * [Set Environment Variable](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#set-environment-variable)
  * [Building chat interfaces with the AI SDK](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#building-chat-interfaces-with-the-ai-sdk)
  * [Using OpenAI Functions with Vercel](https://vercel.com/docs/agent-resources/integrations-for-models/adding-a-model#using-openai-functions-with-vercel)
