...
##  [2. Rules on central visual assets](https://vercel.com/docs/integrations/create-integration/integration-image-guidelines#2.-rules-on-central-visual-assets)[](https://vercel.com/docs/integrations/create-integration/integration-image-guidelines#2.-rules-on-central-visual-assets)
...
##  [3. Rules on descriptions](https://vercel.com/docs/integrations/create-integration/integration-image-guidelines#3.-rules-on-descriptions)[](https://vercel.com/docs/integrations/create-integration/integration-image-guidelines#3.-rules-on-descriptions)
...
##  [4. Rules on image design](https://vercel.com/docs/integrations/create-integration/integration-image-guidelines#4.-rules-on-image-design)[](https://vercel.com/docs/integrations/create-integration/integration-image-guidelines#4.-rules-on-image-design)
...
* * *
[ Previous Billing and Refunds ](https://vercel.com/docs/integrations/create-integration/billing)[ Next Requirements for listing an Integration ](https://vercel.com/docs/integrations/create-integration/submit-integration)
Was this helpful?
Send
On this page
