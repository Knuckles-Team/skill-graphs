...
##  [Adding utility files to the `/api` directory](https://vercel.com/docs/functions/configuring-functions/advanced-configuration#adding-utility-files-to-the-/api-directory)[](https://vercel.com/docs/functions/configuring-functions/advanced-configuration#adding-utility-files-to-the-/api-directory)
...
##  [Bundling Vercel Functions](https://vercel.com/docs/functions/configuring-functions/advanced-configuration#bundling-vercel-functions)[](https://vercel.com/docs/functions/configuring-functions/advanced-configuration#bundling-vercel-functions)
...
* * *
[ Previous Region ](https://vercel.com/docs/functions/configuring-functions/region)[ Next API Reference ](https://vercel.com/docs/functions/functions-api-reference)
Was this helpful?
Send
Next.js (/app)
Choose a framework to optimize documentation to:
