...
##  [Automatically expose system environment variables](https://vercel.com/docs/environment-variables/system-environment-variables#automatically-expose-system-environment-variables)[](https://vercel.com/docs/environment-variables/system-environment-variables#automatically-expose-system-environment-variables)
...
##  [System environment variables](https://vercel.com/docs/environment-variables/system-environment-variables#system-environment-variables)[](https://vercel.com/docs/environment-variables/system-environment-variables#system-environment-variables)
If you are using a framework for your project, Vercel provides the following prefixed environment variables:
When you choose to automatically expose system environment variables, some React warnings, such as those in a `create-react-app` will display as build errors. For more information on this error, see [How do I resolve a `process.env.CI = true` error?](https://vercel.com/kb/guide/how-do-i-resolve-a-process-env-ci-true-error)
###  [VERCEL](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL)
...
###  [CI](https://vercel.com/docs/environment-variables/system-environment-variables#CI)[](https://vercel.com/docs/environment-variables/system-environment-variables#CI)
**Available at:** Build time
An indicator that the code is running in a environment.
.env
```
...
###  [VERCEL_ENV](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_ENV)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_ENV)
**Available at:** Both build and runtime
...
###  [VERCEL_TARGET_ENV](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_TARGET_ENV)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_TARGET_ENV)
**Available at:** Both build and runtime
...
###  [VERCEL_URL](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_URL)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_URL)
**Available at:** Both build and runtime
...
###  [VERCEL_BRANCH_URL](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_BRANCH_URL)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_BRANCH_URL)
**Available at:** Both build and runtime
...
###  [VERCEL_PROJECT_PRODUCTION_URL](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_PROJECT_PRODUCTION_URL)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_PROJECT_PRODUCTION_URL)
**Available at:** Both build and runtime
...
###  [VERCEL_REGION](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_REGION)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_REGION)
...
###  [VERCEL_DEPLOYMENT_ID](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_DEPLOYMENT_ID)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_DEPLOYMENT_ID)
**Available at:** Both build and runtime
...
###  [VERCEL_PROJECT_ID](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_PROJECT_ID)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_PROJECT_ID)
**Available at:** Both build and runtime
...
###  [VERCEL_SKEW_PROTECTION_ENABLED](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_SKEW_PROTECTION_ENABLED)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_SKEW_PROTECTION_ENABLED)
**Available at:** Both build and runtime
...
###  [VERCEL_AUTOMATION_BYPASS_SECRET](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_AUTOMATION_BYPASS_SECRET)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_AUTOMATION_BYPASS_SECRET)
**Available at:** Both build and runtime
...
###  [VERCEL_OIDC_TOKEN](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_OIDC_TOKEN)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_OIDC_TOKEN)
**Available at:** Build time
...
###  [VERCEL_GIT_PROVIDER](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_PROVIDER)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_PROVIDER)
**Available at:** Both build and runtime
...
###  [VERCEL_GIT_REPO_SLUG](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_REPO_SLUG)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_REPO_SLUG)
**Available at:** Both build and runtime
...
###  [VERCEL_GIT_REPO_OWNER](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_REPO_OWNER)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_REPO_OWNER)
**Available at:** Both build and runtime
...
###  [VERCEL_GIT_REPO_ID](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_REPO_ID)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_REPO_ID)
**Available at:** Both build and runtime
...
###  [VERCEL_GIT_COMMIT_REF](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_COMMIT_REF)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_COMMIT_REF)
**Available at:** Both build and runtime
...
###  [VERCEL_GIT_COMMIT_SHA](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_COMMIT_SHA)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_COMMIT_SHA)
**Available at:** Both build and runtime
The git of the commit the deployment was triggered by.
.env
```
...
###  [VERCEL_GIT_COMMIT_MESSAGE](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_COMMIT_MESSAGE)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_COMMIT_MESSAGE)
**Available at:** Both build and runtime
...
###  [VERCEL_GIT_COMMIT_AUTHOR_LOGIN](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_COMMIT_AUTHOR_LOGIN)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_COMMIT_AUTHOR_LOGIN)
**Available at:** Both build and runtime
...
###  [VERCEL_GIT_COMMIT_AUTHOR_NAME](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_COMMIT_AUTHOR_NAME)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_COMMIT_AUTHOR_NAME)
**Available at:** Both build and runtime
...
###  [VERCEL_GIT_PREVIOUS_SHA](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_PREVIOUS_SHA)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_PREVIOUS_SHA)
**Available at:** Build time
The git of the last successful deployment for the project and branch.
.env
```
...
###  [VERCEL_GIT_PULL_REQUEST_ID](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_PULL_REQUEST_ID)[](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_PULL_REQUEST_ID)
**Available at:** Both build and runtime
...
* * *
[ Previous Shared Environment Variables ](https://vercel.com/docs/environment-variables/shared-environment-variables)[ Next Git Integrations ](https://vercel.com/docs/git)
Was this helpful?
Send
On this page
  ...
  * [VERCEL_ENV](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_ENV)
  * [VERCEL_TARGET_ENV](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_TARGET_ENV)
  ...
  * [VERCEL_REGION](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_REGION)
  * [VERCEL_DEPLOYMENT_ID](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_DEPLOYMENT_ID)
  * [VERCEL_PROJECT_ID](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_PROJECT_ID)
  * [VERCEL_SKEW_PROTECTION_ENABLED](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_SKEW_PROTECTION_ENABLED)
  * [VERCEL_AUTOMATION_BYPASS_SECRET](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_AUTOMATION_BYPASS_SECRET)
  * [VERCEL_OIDC_TOKEN](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_OIDC_TOKEN)
  * [VERCEL_GIT_PROVIDER](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_PROVIDER)
  * [VERCEL_GIT_REPO_SLUG](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_REPO_SLUG)
  * [VERCEL_GIT_REPO_OWNER](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_REPO_OWNER)
  * [VERCEL_GIT_REPO_ID](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_REPO_ID)
  * [VERCEL_GIT_COMMIT_REF](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_COMMIT_REF)
  * [VERCEL_GIT_COMMIT_SHA](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_COMMIT_SHA)
  * [VERCEL_GIT_COMMIT_MESSAGE](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_COMMIT_MESSAGE)
  * [VERCEL_GIT_COMMIT_AUTHOR_LOGIN](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_COMMIT_AUTHOR_LOGIN)
  * [VERCEL_GIT_COMMIT_AUTHOR_NAME](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_COMMIT_AUTHOR_NAME)
  * [VERCEL_GIT_PREVIOUS_SHA](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_PREVIOUS_SHA)
  * [VERCEL_GIT_PULL_REQUEST_ID](https://vercel.com/docs/environment-variables/system-environment-variables#VERCEL_GIT_PULL_REQUEST_ID)
