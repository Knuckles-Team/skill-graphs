##  [Login methods and connections](https://vercel.com/docs/accounts#login-methods-and-connections)[](https://vercel.com/docs/accounts#login-methods-and-connections)
...
![The Authentication section of your account settings.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Faccounts%2Fauthentication-page-light.png&w=1920&q=75)![The Authentication section of your account settings.](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Faccounts%2Fauthentication-page-dark.png&w=1920&q=75)The Authentication section of your account settings.
###  [Login with passkeys](https://vercel.com/docs/accounts#login-with-passkeys)[](https://vercel.com/docs/accounts#login-with-passkeys)
...
###  [Logging in with SAML Single Sign-On](https://vercel.com/docs/accounts#logging-in-with-saml-single-sign-on)[](https://vercel.com/docs/accounts#logging-in-with-saml-single-sign-on)
...
###  [Choosing a connection when creating a project](https://vercel.com/docs/accounts#choosing-a-connection-when-creating-a-project)[](https://vercel.com/docs/accounts#choosing-a-connection-when-creating-a-project)
...
###  [Using an existing login connection](https://vercel.com/docs/accounts#using-an-existing-login-connection)[](https://vercel.com/docs/accounts#using-an-existing-login-connection)
