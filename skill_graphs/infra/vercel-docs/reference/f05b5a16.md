...
##  [Body](https://vercel.com/docs/rest-api/sdk/deployments/create-a-new-deployment#body)[](https://vercel.com/docs/rest-api/sdk/deployments/create-a-new-deployment#body)
application/json
