...
##  [Logs Schema](https://vercel.com/docs/drains/reference/logs#logs-schema)[](https://vercel.com/docs/drains/reference/logs#logs-schema)
...
##  [Format](https://vercel.com/docs/drains/reference/logs#format)[](https://vercel.com/docs/drains/reference/logs#format)
...
###  [JSON](https://vercel.com/docs/drains/reference/logs#json)[](https://vercel.com/docs/drains/reference/logs#json)
...
###  [NDJSON](https://vercel.com/docs/drains/reference/logs#ndjson)[](https://vercel.com/docs/drains/reference/logs#ndjson)
...
##  [Log Sources](https://vercel.com/docs/drains/reference/logs#log-sources)[](https://vercel.com/docs/drains/reference/logs#log-sources)
...
##  [Log Environments](https://vercel.com/docs/drains/reference/logs#log-environments)[](https://vercel.com/docs/drains/reference/logs#log-environments)
...
##  [Sampling Rate](https://vercel.com/docs/drains/reference/logs#sampling-rate)[](https://vercel.com/docs/drains/reference/logs#sampling-rate)
...
##  [More resources](https://vercel.com/docs/drains/reference/logs#more-resources)[](https://vercel.com/docs/drains/reference/logs#more-resources)
...
* * *
[ Previous Using Drains ](https://vercel.com/docs/drains/using-drains)[ Next Traces ](https://vercel.com/docs/drains/reference/traces)
Was this helpful?
Send
