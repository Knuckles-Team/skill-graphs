...
##  [Configuring your project with a vercel.json file](https://vercel.com/docs/project-configuration/project-settings#configuring-your-project-with-a-vercel.json-file)[](https://vercel.com/docs/project-configuration/project-settings#configuring-your-project-with-a-vercel.json-file)
...
##  [General settings](https://vercel.com/docs/project-configuration/project-settings#general-settings)[](https://vercel.com/docs/project-configuration/project-settings#general-settings)
...
##  [Build and deployment settings](https://vercel.com/docs/project-configuration/project-settings#build-and-deployment-settings)[](https://vercel.com/docs/project-configuration/project-settings#build-and-deployment-settings)
...
###  [Ignored Build Step](https://vercel.com/docs/project-configuration/project-settings#ignored-build-step)[](https://vercel.com/docs/project-configuration/project-settings#ignored-build-step)
...
####  [Ignore Build Step on redeploy](https://vercel.com/docs/project-configuration/project-settings#ignore-build-step-on-redeploy)[](https://vercel.com/docs/project-configuration/project-settings#ignore-build-step-on-redeploy)
...
##  [Custom domains](https://vercel.com/docs/project-configuration/project-settings#custom-domains)[](https://vercel.com/docs/project-configuration/project-settings#custom-domains)
...
##  [Environment Variables](https://vercel.com/docs/project-configuration/project-settings#environment-variables)[](https://vercel.com/docs/project-configuration/project-settings#environment-variables)
...
##  [Git](https://vercel.com/docs/project-configuration/project-settings#git)[](https://vercel.com/docs/project-configuration/project-settings#git)
...
##  [Integrations](https://vercel.com/docs/project-configuration/project-settings#integrations)[](https://vercel.com/docs/project-configuration/project-settings#integrations)
...
##  [Deployment Protection](https://vercel.com/docs/project-configuration/project-settings#deployment-protection)[](https://vercel.com/docs/project-configuration/project-settings#deployment-protection)
...
##  [Functions](https://vercel.com/docs/project-configuration/project-settings#functions)[](https://vercel.com/docs/project-configuration/project-settings#functions)
...
##  [Cron Jobs](https://vercel.com/docs/project-configuration/project-settings#cron-jobs)[](https://vercel.com/docs/project-configuration/project-settings#cron-jobs)
...
##  [Project members](https://vercel.com/docs/project-configuration/project-settings#project-members)[](https://vercel.com/docs/project-configuration/project-settings#project-members)
...
##  [Webhooks](https://vercel.com/docs/project-configuration/project-settings#webhooks)[](https://vercel.com/docs/project-configuration/project-settings#webhooks)
...
##  [Drains](https://vercel.com/docs/project-configuration/project-settings#drains)[](https://vercel.com/docs/project-configuration/project-settings#drains)
...
##  [Security settings](https://vercel.com/docs/project-configuration/project-settings#security-settings)[](https://vercel.com/docs/project-configuration/project-settings#security-settings)
...
##  [Advanced](https://vercel.com/docs/project-configuration/project-settings#advanced)[](https://vercel.com/docs/project-configuration/project-settings#advanced)
...
* * *
[ Previous General Settings ](https://vercel.com/docs/project-configuration/general-settings)[ Next Git Configuration ](https://vercel.com/docs/project-configuration/git-configuration)
Was this helpful?
Send
On this page
  ...
  * [Ignore Build Step on redeploy](https://vercel.com/docs/project-configuration/project-settings#ignore-build-step-on-redeploy)
