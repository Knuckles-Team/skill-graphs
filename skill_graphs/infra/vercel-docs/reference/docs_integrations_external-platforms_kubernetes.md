...
Let’s look at key Kubernetes concepts and how Vercel’s [managed infrastructure](https://vercel.com/products/managed-infrastructure) handles them:
  * [Server management and provisioning](https://vercel.com/docs/integrations/external-platforms/kubernetes#server-management-and-provisioning)
  * [Scaling and redundancy](https://vercel.com/docs/integrations/external-platforms/kubernetes#scaling-and-redundancy)
  * [Managing environments and deployments](https://vercel.com/docs/integrations/external-platforms/kubernetes#managing-environments-and-deployments)
  * [Managing access and security](https://vercel.com/docs/integrations/external-platforms/kubernetes#managing-access-and-security)
  * [Observability](https://vercel.com/docs/integrations/external-platforms/kubernetes#observability)
  * [Integrating Vercel with your Kubernetes backend](https://vercel.com/docs/integrations/external-platforms/kubernetes#integrating-vercel-with-your-kubernetes-backend)
  * [Before/after comparison: Kubernetes vs. Vercel](https://vercel.com/docs/integrations/external-platforms/kubernetes#before/after-comparison:-kubernetes-vs.-vercel)
  * [Migrating from Kubernetes to Vercel](https://vercel.com/docs/integrations/external-platforms/kubernetes#migrating-from-kubernetes-to-vercel)
...
##  [Integrating Vercel with your Kubernetes backend](https://vercel.com/docs/integrations/external-platforms/kubernetes#integrating-vercel-with-your-kubernetes-backend)[](https://vercel.com/docs/integrations/external-platforms/kubernetes#integrating-vercel-with-your-kubernetes-backend)
If you’re running backend services on Kubernetes (e.g., APIs, RPC layers, data processing jobs), you can continue doing so while offloading your frontend to Vercel’s managed infrastructure:
  * Networking: Vercel can securely connect to your Kubernetes-hosted backend services. You can keep your APIs behind load balancers or private networks. For stricter environments, [Vercel Secure Compute](https://vercel.com/docs/secure-compute) (available on Enterprise plans) ensures secure, private connectivity to internal services.
  * Environment Variables and Secrets: Your application’s environment variables (e.g., API keys, database credentials) can be configured securely in the [Vercel dashboard](https://vercel.com/docs/environment-variables).
...
##  [Before/after comparison: Kubernetes vs. Vercel](https://vercel.com/docs/integrations/external-platforms/kubernetes#before/after-comparison:-kubernetes-vs.-vercel)[](https://vercel.com/docs/integrations/external-platforms/kubernetes#before/after-comparison:-kubernetes-vs.-vercel)
...
##  [Migrating from Kubernetes to Vercel](https://vercel.com/docs/integrations/external-platforms/kubernetes#migrating-from-kubernetes-to-vercel)[](https://vercel.com/docs/integrations/external-platforms/kubernetes#migrating-from-kubernetes-to-vercel)
To incrementally move your frontend applications to Vercel:
  1. ###  [Create a Vercel account and team](https://vercel.com/docs/integrations/external-platforms/kubernetes#create-a-vercel-account-and-team)[](https://vercel.com/docs/integrations/external-platforms/kubernetes#create-a-vercel-account-and-team)
Start by [creating a Vercel account](https://vercel.com/signup) and [team](https://vercel.com/docs/accounts/create-a-team), if needed.
  2. ###  [Create two versions of your frontend codebase](https://vercel.com/docs/integrations/external-platforms/kubernetes#create-two-versions-of-your-frontend-codebase)[](https://vercel.com/docs/integrations/external-platforms/kubernetes#create-two-versions-of-your-frontend-codebase)
Keep your current frontend running in Kubernetes for now. Create a fork or a branch of your frontend codebase and connect it to a [new Vercel project](https://vercel.com/docs/projects/overview#creating-a-project).
Once connected, Vercel will automatically build and deploy your application. It’s okay if the first deployment fails. [View the build logs](https://vercel.com/docs/deployments/logs) and [troubleshoot the build](https://vercel.com/docs/deployments/troubleshoot-a-build) failures. Changes might include:
     ...
     * Changes to the [project configuration](https://vercel.com/docs/project-configuration)
     * Missing [environment variables](https://vercel.com/docs/environment-variables)
Continue addressing errors until you get a successful Preview Deployment.
Depending on how you have your Kubernetes environment configured, you may need to adjust firewall and security policies to allow the applications to talk to each other. Vercel [provides some options](https://vercel.com/kb/guide/how-to-allowlist-deployment-ip-address), including [Vercel Secure Compute](https://vercel.com/docs/secure-compute) for Enterprise teams, which allows you to establish secure connections between Vercel and backend environments.
The goal is to use the Preview Deployment to test the integration with your Kubernetes-hosted backends, ensuring that API calls and data flow work as expected.
  3. ###  [Set up users and integrations](https://vercel.com/docs/integrations/external-platforms/kubernetes#set-up-users-and-integrations)[](https://vercel.com/docs/integrations/external-platforms/kubernetes#set-up-users-and-integrations)
Use [Vercel’s dashboard](https://vercel.com/dashboard) to securely manage [user access, roles, and permissions](https://vercel.com/docs/accounts/team-members-and-roles), so your team can collaborate on the project.
     * [Add team members and assign roles](https://vercel.com/docs/rbac/managing-team-members#adding-team-members-and-assigning-roles) ([SAML SSO](https://vercel.com/docs/saml) is available on [Enterprise plans](https://vercel.com/docs/plans/enterprise))
     * [Add integrations](https://vercel.com/integrations) to any existing services and tools your team uses
  4. ###  [Begin a full or gradual rollout](https://vercel.com/docs/integrations/external-platforms/kubernetes#begin-a-full-or-gradual-rollout)[](https://vercel.com/docs/integrations/external-platforms/kubernetes#begin-a-full-or-gradual-rollout)
...
Some other tools or strategies you may want to use:
     * [Feature Flags on Vercel](https://vercel.com/docs/feature-flags)
     ...
     * [How to migrate a site to Vercel without downtime](https://vercel.com/kb/guide/zero-downtime-migration)
  5. ###  [Maintain the backend on Kubernetes](https://vercel.com/docs/integrations/external-platforms/kubernetes#maintain-the-backend-on-kubernetes)[](https://vercel.com/docs/integrations/external-platforms/kubernetes#maintain-the-backend-on-kubernetes)
...
Over time, you can evaluate whether specific backend services could also benefit from a serverless architecture and be migrated to Vercel.
  6. ###  [Accelerate frontend iteration velocity on Vercel](https://vercel.com/docs/integrations/external-platforms/kubernetes#accelerate-frontend-iteration-velocity-on-vercel)[](https://vercel.com/docs/integrations/external-platforms/kubernetes#accelerate-frontend-iteration-velocity-on-vercel)
...
* * *
[ Previous Commerce and Payments/ Stripe ](https://vercel.com/docs/integrations/ecommerce/stripe)[ Next Multi-tenant ](https://vercel.com/docs/multi-tenant)
Was this helpful?
Send
On this page
  * [Server management and provisioning](https://vercel.com/docs/integrations/external-platforms/kubernetes#server-management-and-provisioning)
  ...
  * [Before/after comparison: Kubernetes vs. Vercel](https://vercel.com/docs/integrations/external-platforms/kubernetes#before/after-comparison:-kubernetes-vs.-vercel)
  * [Migrating from Kubernetes to Vercel](https://vercel.com/docs/integrations/external-platforms/kubernetes#migrating-from-kubernetes-to-vercel)
  * [Create a Vercel account and team](https://vercel.com/docs/integrations/external-platforms/kubernetes#create-a-vercel-account-and-team)
  * [Create two versions of your frontend codebase](https://vercel.com/docs/integrations/external-platforms/kubernetes#create-two-versions-of-your-frontend-codebase)
  * [Set up users and integrations](https://vercel.com/docs/integrations/external-platforms/kubernetes#set-up-users-and-integrations)
  * [Begin a full or gradual rollout](https://vercel.com/docs/integrations/external-platforms/kubernetes#begin-a-full-or-gradual-rollout)
  * [Maintain the backend on Kubernetes](https://vercel.com/docs/integrations/external-platforms/kubernetes#maintain-the-backend-on-kubernetes)
  * [Accelerate frontend iteration velocity on Vercel](https://vercel.com/docs/integrations/external-platforms/kubernetes#accelerate-frontend-iteration-velocity-on-vercel)
