##  [High level overview](https://vercel.com/docs/sign-in-with-vercel#high-level-overview)[](https://vercel.com/docs/sign-in-with-vercel#high-level-overview)
...
###  [Tokens](https://vercel.com/docs/sign-in-with-vercel#tokens)[](https://vercel.com/docs/sign-in-with-vercel#tokens)
...
###  [Scopes and permissions](https://vercel.com/docs/sign-in-with-vercel#scopes-and-permissions)[](https://vercel.com/docs/sign-in-with-vercel#scopes-and-permissions)
...
###  [Consent page](https://vercel.com/docs/sign-in-with-vercel#consent-page)[](https://vercel.com/docs/sign-in-with-vercel#consent-page)
