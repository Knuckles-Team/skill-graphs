##  [Prerequisites](https://vercel.com/docs/logs#prerequisites)[](https://vercel.com/docs/logs#prerequisites)
...
```
  ...
  1. ###  [Enable Web Analytics in Vercel](https://vercel.com/docs/logs#enable-web-analytics-in-vercel)[](https://vercel.com/docs/logs#enable-web-analytics-in-vercel)
...
Enabling Web Analytics will add new routes (scoped at `/_vercel/insights/*`) after your next deployment.
  2. ###  [Add `@vercel/analytics` to your project](https://vercel.com/docs/logs#add-@vercel/analytics-to-your-project)[](https://vercel.com/docs/logs#add-@vercel/analytics-to-your-project)
...
```
  ...
  3. ###  [Add the `Analytics` component to your app](https://vercel.com/docs/logs#add-the-analytics-component-to-your-app)[](https://vercel.com/docs/logs#add-the-analytics-component-to-your-app)
...
```
  ...
  4. ###  [Deploy your app to Vercel](https://vercel.com/docs/logs#deploy-your-app-to-vercel)[](https://vercel.com/docs/logs#deploy-your-app-to-vercel)
...
If everything is set up properly, you should be able to see a Fetch/XHR request in your browser's Network tab from `/_vercel/insights/view` when you visit any page.
  5. ###  [View your data in the dashboard](https://vercel.com/docs/logs#view-your-data-in-the-dashboard)[](https://vercel.com/docs/logs#view-your-data-in-the-dashboard)
