...
##  [Authentication](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/delete-resource#authentication)[](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/delete-resource#authentication)
AuthorizationUser Authentication
Default authentication mechanism
AuthorizationSystem Authentication
Default authentication mechanism
##  [Path parameters](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/delete-resource#path-parameters)[](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/delete-resource#path-parameters)
installationIdstringRequired
resourceIdstringRequired
##  [Header parameters](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/delete-resource#header-parameters)[](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/delete-resource#header-parameters)
...
##  [Response](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/delete-resource#response)[](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/delete-resource#response)
204Resource deleted successfully
##  [Errors](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/delete-resource#errors)[](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/delete-resource#errors)
...
const response = await fetch('/v1/installations/installationId/resources/resourceId/plans?metadata=string', {
...
installationIdstringRequired
resourceIdstringRequired
##  [Query parameters](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/delete-resource#query-parameters)[](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/delete-resource#query-parameters)
metadatastringOptional
##  [Header parameters](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/delete-resource#header-parameters)[](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/delete-resource#header-parameters)
X-Vercel-AuthstringOptional
The auth style used in the request (system, user, etc)
##  [Response](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/delete-resource#response)[](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/delete-resource#response)
200Return a list of billing plans for a resource
plansarrayRequired
+Show 17 properties
##  [Errors](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/delete-resource#errors)[](https://vercel.com/docs/integrations/create-integration/marketplace-api/reference/partner/delete-resource#errors)
