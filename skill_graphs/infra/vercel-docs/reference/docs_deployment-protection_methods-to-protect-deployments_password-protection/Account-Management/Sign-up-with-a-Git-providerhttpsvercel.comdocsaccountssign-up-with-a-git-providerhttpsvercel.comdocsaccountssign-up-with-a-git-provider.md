##  [Sign up with a Git provider](https://vercel.com/docs/accounts#sign-up-with-a-git-provider)[](https://vercel.com/docs/accounts#sign-up-with-a-git-provider)
...
Once signed up you can manage your login connections in the [authentication section](https://vercel.com/account/authentication) of your dashboard.
