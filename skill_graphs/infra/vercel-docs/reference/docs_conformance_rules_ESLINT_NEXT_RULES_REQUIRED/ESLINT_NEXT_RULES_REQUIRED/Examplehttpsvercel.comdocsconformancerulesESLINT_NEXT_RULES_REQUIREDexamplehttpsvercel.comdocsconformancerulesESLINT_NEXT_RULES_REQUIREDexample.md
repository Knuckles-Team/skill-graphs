##  [Example](https://vercel.com/docs/conformance/rules/ESLINT_NEXT_RULES_REQUIRED#example)[](https://vercel.com/docs/conformance/rules/ESLINT_NEXT_RULES_REQUIRED#example)
```
