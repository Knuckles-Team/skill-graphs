##  [bulkRedirectsPath](https://vercel.com/docs/project-configuration/vercel-json#bulkredirectspath)[](https://vercel.com/docs/project-configuration/vercel-json#bulkredirectspath)
...
###  [CSV](https://vercel.com/docs/project-configuration/vercel-json#csv)[](https://vercel.com/docs/project-configuration/vercel-json#csv)
...
###  [JSON](https://vercel.com/docs/project-configuration/vercel-json#json)[](https://vercel.com/docs/project-configuration/vercel-json#json)
redirects.json
```
[
    {
...
###  [JSONL](https://vercel.com/docs/project-configuration/vercel-json#jsonl)[](https://vercel.com/docs/project-configuration/vercel-json#jsonl)
redirects.jsonl
```
...
###  [Bulk redirect field definition](https://vercel.com/docs/project-configuration/vercel-json#bulk-redirect-field-definition)[](https://vercel.com/docs/project-configuration/vercel-json#bulk-redirect-field-definition)
