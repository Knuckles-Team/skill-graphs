##  [installCommand](https://vercel.com/docs/project-configuration/vercel-json#installcommand)[](https://vercel.com/docs/project-configuration/vercel-json#installcommand)
