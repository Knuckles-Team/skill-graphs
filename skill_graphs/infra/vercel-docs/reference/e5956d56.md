...
const response = await fetch('https://api.vercel.com/v6/deployments?app=string&from=123&limit=123&projectId=string&projectIds=[]&target=string&to=123&users=string&since=123&until=123&state=string&rollbackCandidate=true&branch=string&sha=string&teamId=string&slug=string', {
...
##  [Authentication](https://vercel.com/docs/rest-api/deployments/list-deployments#authentication)[](https://vercel.com/docs/rest-api/deployments/list-deployments#authentication)
AuthorizationbearerToken
Default authentication mechanism
##  [Query parameters](https://vercel.com/docs/rest-api/deployments/list-deployments#query-parameters)[](https://vercel.com/docs/rest-api/deployments/list-deployments#query-parameters)
appstringOptional
...
##  [Response](https://vercel.com/docs/rest-api/deployments/list-deployments#response)[](https://vercel.com/docs/rest-api/deployments/list-deployments#response)
200Success
...
+Show 40 properties
##  [Errors](https://vercel.com/docs/rest-api/deployments/list-deployments#errors)[](https://vercel.com/docs/rest-api/deployments/list-deployments#errors)
